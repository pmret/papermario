...
#define PM_CC_1F        NOISE, 0, SHADE_ALPHA, 0, 0, 0, 0, 1

#define PM_CC_1A        TEXEL0, 0, PRIMITIVE_ALPHA, PRIMITIVE, 0, 0, 0, TEXEL0
#define PM_CC_1C        SHADE, 0, PRIMITIVE_ALPHA, PRIMITIVE, 0, 0, 0, SHADE
#define PM_CC_1D        SHADE, 0, PRIMITIVE, ENVIRONMENT, 0, 0, 0, SHADE
...
#define PM_CC_24        1, TEXEL0, PRIMITIVE, TEXEL0, 1, TEXEL0, TEXEL1, TEXEL0
#define PM_CC_25        1, TEXEL1, TEXEL0, COMBINED, 0, 0, 0, COMBINED
#define PM_CC_26        0, 0, 0, 0, TEXEL0, TEXEL1, SHADE
#define PM_CC_27        0, 0, 0, 0, SHADE, 0, 0, 0, COMBINED
#define PM_CC_28        0, SHADE, 0, PRIMITIVE, ENVIRONMENT, 0, 0, 0, COMBINED
