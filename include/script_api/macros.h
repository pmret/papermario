...
#define EVT_BIND_TRIGGER(EVT_SOURCE, TRIGGER, COLLIDER_ID_OR_VEC3F, UNK_A3, TRIGGER_PTR_OUTVAR) \
    EVT_CMD(EVT_OP_BIND_TRIGGER, (Bytecode) EVT_SOURCE, TRIGGER, (Bytecode) COLLIDER_ID_OR_VEC3F, UNK_A3, TRIGGER_PTR_OUTVAR),
#define EVT_BIND_PADLOCK(EVT_SOURCE, ...)       EVT_CMD(EVT_OP_BIND_PADLOCK, (Bytecode) EVT_SOURCE, __VA_ARGS__),
