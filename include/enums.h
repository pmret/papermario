...
enum EncounterCreateSubStates {
    ENCOUNTER_SUBSTATE_CREATE_0 = 0,
    ENCOUNTER_SUBSTATE_CREATE_1 = 1,
    ENCOUNTER_SUBSTATE_CREATE_2 = 2,
};

enum EncounterNeutralSubStates {
    ENCOUNTER_SUBSTATE_NEUTRAL_0 = 0,
};

enum EncounterPreBattleSubStates {
    ENCOUNTER_SUBSTATE_PRE_BATTLE_0 = 0,
    ENCOUNTER_SUBSTATE_PRE_BATTLE_1 = 1,
    ENCOUNTER_SUBSTATE_PRE_BATTLE_2 = 2,
    ENCOUNTER_SUBSTATE_PRE_BATTLE_3 = 3,
};

enum EncounterConversationSubStates {
    ENCOUNTER_SUBSTATE_CONVERSATION_0 = 0,
    ENCOUNTER_SUBSTATE_CONVERSATION_1 = 1,
};

enum EncounterPostBattleSubStates {
    ENCOUNTER_SUBSTATE_POST_BATTLE_0 = 0,
    ENCOUNTER_SUBSTATE_POST_BATTLE_2 = 2,
    ENCOUNTER_SUBSTATE_POST_BATTLE_3 = 3,
    ENCOUNTER_SUBSTATE_POST_BATTLE_4 = 4,
    ENCOUNTER_SUBSTATE_POST_BATTLE_10 = 10,
    ENCOUNTER_SUBSTATE_POST_BATTLE_11 = 11,
    ENCOUNTER_SUBSTATE_POST_BATTLE_100 = 100,
    ENCOUNTER_SUBSTATE_POST_BATTLE_101 = 101,
    ENCOUNTER_SUBSTATE_POST_BATTLE_102 = 102,
    ENCOUNTER_SUBSTATE_POST_BATTLE_103 = 103,
    ENCOUNTER_SUBSTATE_POST_BATTLE_200 = 200,
    ENCOUNTER_SUBSTATE_POST_BATTLE_201 = 201,
    ENCOUNTER_SUBSTATE_POST_BATTLE_202 = 202,
    ENCOUNTER_SUBSTATE_POST_BATTLE_203 = 203,
    ENCOUNTER_SUBSTATE_POST_BATTLE_300 = 300,
    ENCOUNTER_SUBSTATE_POST_BATTLE_400 = 400,
    ENCOUNTER_SUBSTATE_POST_BATTLE_401 = 401,
    ENCOUNTER_SUBSTATE_POST_BATTLE_402 = 402,
};
