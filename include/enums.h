...
enum StatusKeys {
    ...
    STATUS_KEY_TURN_DONE            = 0x00000012,
    STATUS_KEY_TURN_DONE_BERSERK    = 0x00000013,
    STATUS_KEY_14                   = 0x00000014, // probably STATUS_KEY_TURN_DONE_FROZEN
    STATUS_KEY_TURN_DONE_SLEEP      = 0x00000015,
    STATUS_KEY_TURN_DONE_WEARY      = 0x00000016,
    STATUS_KEY_17                   = 0x00000017,
    STATUS_KEY_TURN_DONE_DIZZY      = 0x00000018,
