...
enum BtlCameraPreset {
    ...
    BTL_CAM_INTERRUPT               = 1,    // STOP
    BTL_CAM_DEFAULT                 = 2,
    BTL_CAM_VIEW_ENEMIES               = 3,
    BTL_CAM_RETURN_HOME               = 4,
    BTL_CAM_ACTOR_TARGET_MIDPOINT               = 5,
    BTL_CAM_ACTOR_PART               = 6,   // unused?
    BTL_CAM_ACTOR_GOAL_SIMPLE               = 7,
    BTL_CAM_ACTOR_SIMPLE               = 8,
    BTL_CAM_SLOW_DEFAULT               = 9,    // unused?
    BTL_CAM_MIDPOINT_CLOSE               = 10,
    BTL_CAM_MIDPOINT_NORMAL               = 11,
    BTL_CAM_MIDPOINT_FAR               = 12,   // unused?
    BTL_CAM_ACTOR_CLOSE               = 13,
    BTL_CAM_ACTOR               = 14,  // FOCUS_ON_TARGET?
    BTL_CAM_ACTOR_FAR               = 15,
    BTL_CAM_ACTOR_GOAL_NEAR               = 16,   // unused?
    BTL_CAM_ACTOR_GOAL               = 17,   // unused?
    BTL_CAM_ACTOR_GOAL_FAR               = 18,   // unused?
    BTL_CAM_REPOSITION               = 19,
    BTL_CAM_FOLLOW_ACTOR_Y               = 20,   // unused?
    BTL_CAM_FOLLOW_ACTOR_POS               = 21,   // unused?
    BTL_CAM_PLAYER_ENTRY            = 22,
    BTL_CAM_VICTORY                 = 23,   // closeup on party while star points are tallied
    BTL_CAM_PLAYER_DIES               = 24,
    BTL_CAM_PLAYER_FLEE               = 25,   // closeup on player used when running away or being defeated
    BTL_CAM_PLAYER_ATTACK_APPROACH  = 26,
    BTL_CAM_PLAYER_PRE_JUMP_FINISH               = 27,
    BTL_CAM_PLAYER_PRE_ULTRA_JUMP_FINISH               = 28,
    BTL_CAM_PLAYER_MISTAKE               = 29,
    ...
    BTL_CAM_PLAYER_JUMP_MIDAIR               = 34,
    BTL_CAM_PLAYER_JUMP_FINISH               = 35,
    BTL_CAM_PLAYER_JUMP_FINISH_CLOSE               = 36,   // unused?
    BTL_CAM_PLAYER_SUPER_JUMP_MIDAIR               = 37,
    BTL_CAM_PLAYER_ULTRA_JUMP_MIDAIR               = 38,
    BTL_CAM_PLAYER_UNUSED_ULTRA_JUMP               = 39,
    BTL_CAM_PLAYER_MULTIBOUNCE               = 40,
    BTL_CAM_PRESET_UNUSED_29               = 41,   // unused?
    BTL_CAM_PRESET_UNUSED_2A               = 42,   // unused?
    BTL_CAM_PLAYER_AIM_HAMMER       = 43,
    BTL_CAM_PLAYER_HAMMER_STRIKE    = 44,
    BTL_CAM_PRESET_UNUSED_2D               = 45,   // unused?
    BTL_CAM_PLAYER_HAMMER_QUAKE               = 46,
    BTL_CAM_PARTNER_APPROACH        = 47,   // used by Goombario and Watt (power shock only)
    BTL_CAM_CLOSER_PARTNER_APPROACH               = 48,
    BTL_CAM_PRESET_UNUSED_31               = 49,   // unused?
    BTL_CAM_GOOMBARIO_BONK_FOLLOWUP_1               = 50,
    BTL_CAM_PARTNER_MISTAKE               = 51,
    BTL_CAM_PARTNER_MIDAIR               = 52,
    BTL_CAM_GOOMBARIO_BONK_FOLLOWUP_2               = 53,
    BTL_CAM_PARTNER_INJURED         = 54,   // closeup on partner after being injured
    BTL_CAM_PARTNER_GOOMPA               = 55,
    BTL_CAM_PRESET_UNUSED_38               = 56,   // unused?
    BTL_CAM_PRESET_UNUSED_39               = 57,   // unused?
    BTL_CAM_PRESET_UNUSED_3A               = 58,   // unused?
    BTL_CAM_PARTNER_CLOSE_UP               = 59,
    BTL_CAM_PRESET_UNUSED_3C               = 60,   // unused?
    BTL_CAM_PARTNER_HIT_SPIKE               = 61,
    BTL_CAM_PARTNER_HIT_HAZARD               = 62,
    BTL_CAM_ENEMY_APPROACH          = 63,   // (very common)
    BTL_CAM_PRESET_UNUSED_40               = 64,   // unused?
    BTL_CAM_SLOWER_DEFAULT               = 65,   // unused?
    BTL_CAM_ENEMY_DIVE               = 66,
    BTL_CAM_PRESET_UNUSED_43               = 67,   // unused?
    BTL_CAM_PRESET_UNUSED_44               = 68,   // unused?
    BTL_CAM_PLAYER_WISH               = 69,
    BTL_CAM_PRESET_UNUSED_46               = 70,   // unused?
    BTL_CAM_PRESET_UNUSED_47               = 71,   // unused?
    BTL_CAM_PRESET_UNUSED_48               = 72,   // unused?
    BTL_CAM_STAR_SPIRIT               = 73,
};
