...
enum SoundIDs {
    ...
    SOUND_SRAW_TRAIN_CHUG_A                     = 0x000001FB,
    SOUND_SRAW_TRAIN_CHUG_B                     = 0x000001FC,
    ...
    SOUND_SRAW_RAVEN_FALL_A                     = 0x0000020C,
    SOUND_SRAW_RAVEN_FALL_B                     = 0x0000020D,
    SOUND_SRAW_RAVEN_FALL_C                     = 0x0000020E,
    ...
    SOUND_SRAW_SHUFFLE_CARD_A                   = 0x0000202A,
    SOUND_SRAW_SHUFFLE_CARD_B                   = 0x0000202B,
    ...
    SOUND_SEQ_RAVEN_FALL                        = 0xB0000014, // unused
