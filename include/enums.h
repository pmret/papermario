...
enum StoryProgress {
    ...
    STORY_CH0_WAKE_UP                        = -0x7F,
    STORY_CH0_MET_INNKEEPER                  = -0x7E,
    STORY_CH0_MET_GOOMPA                     = -0x7C,
    STORY_CH0_GATE_CRUSHED                   = -0x7B,
    STORY_CH0_FELL_OFF_CLIFF                 = -0x7A,
    STORY_CH0_GOOMPA_JOINED_PARTY            = -0x79,
    STORY_CH0_LOOKING_FOR_HAMMER             = -0x78,
    STORY_CH0_FOUND_HAMMER                   = -0x77,
    STORY_CH0_DEFEATED_JR_TROOPA             = -0x76,
    STORY_CH0_LEFT_THE_PLAYGROUND            = -0x75,
    STORY_CH0_GOOMBARIO_JOINED_PARTY         = -0x73,
    STORY_CH0_SMASHED_GATE_BLOCK             = -0x72,
    STORY_CH0_DEFEATED_GOOMBA_BROS           = -0x71,
    STORY_CH0_DEFEATED_GOOMBA_KING           = -0x70,
    STORY_CH0_FOUND_GATEHOUSE_SWITCH         = -0x6F,
    STORY_CH0_HIT_GATEHOUSE_SWITCH           = -0x6E,
    STORY_CH0_OPENED_BRIDGE_TO_TOAD_TOWN     = -0x6D,
    STORY_CH0_KAMMY_RETURNED_TO_BOWSER       = -0x6C,
    STORY_CH0_ARRIVED_AT_TOAD_TOWN           = -0x6B,
    STORY_CH0_MET_STAR_SPIRITS               = -0x6A,
    STORY_CH0_BEGAN_PEACH_MISSION            = -0x69,
    STORY_CH0_TWINK_GAVE_LUCKY_STAR          = -0x68,
    STORY_CH0_RETURNED_TO_TOAD_TOWN          = -0x67,

    STORY_CH1_SPOKE_WITH_MERLIN              = -0x66,
    STORY_CH1_TOLD_MERLIN_ABOUT_DARK_TOADS   = -0x65,
    STORY_CH1_MERLIN_REVEALED_KOOPA_BROS     = -0x64,
    STORY_CH1_KNOCKED_SWITCH_FROM_TREE       = -0x63,
    STORY_CH1_MADE_FIRST_BRIDGE              = -0x62,
    STORY_CH1_ARRIVED_AT_KOOPA_VILLAGE       = -0x61,
    STORY_CH1_PROMISED_TO_HELP_KOOPER        = -0x60,
    STORY_CH1_FUZZY_THIEF_LEFT_TOWN          = -0x5F,
    STORY_CH1_FUZZY_THIEF_RAN_AWAY           = -0x5E,
    STORY_CH1_FUZZY_THIEF_HID_IN_TREE        = -0x5D,
    STORY_CH1_KOOPER_JOINED_PARTY            = -0x5C,
    STORY_CH1_MADE_SECOND_BRIDGE             = -0x5B,
    STORY_CH1_ARRIVED_AT_KOOPA_FORTRESS      = -0x5A,
    STORY_CH1_SPOTTED_BY_KOOPA_BROS          = -0x59,
    STORY_CH1_KOOPA_BROS_HID_KEY             = -0x58,
    STORY_CH1_DEFEATED_BASEMENT_GUARD        = -0x57,
    STORY_CH1_LOWERED_FIRST_STAIRS           = -0x56,
    STORY_CH1_KOOPA_BROS_SET_TRAP            = -0x55,
    STORY_CH1_MARIO_ACTIVATED_TRAP           = -0x54,
    STORY_CH1_BOMBETTE_JOINED_PARTY          = -0x53,
    STORY_CH1_DEFEATED_DUNGEON_GUARDS        = -0x52,
    STORY_CH1_LOWERED_SECOND_STAIRS          = -0x51,
    STORY_CH1_RAISED_SUBMERGED_STAIRS        = -0x50,
    STORY_CH1_KOOPA_BROS_FIRING_BLASTERS     = -0x4F,
    STORY_CH1_DEFEATED_KOOPA_BROS            = -0x4E,
    STORY_CH1_STAR_SPIRIT_RESCUED            = -0x4D,
    STORY_CH1_BEGAN_PEACH_MISSION            = -0x4C,
    STORY_CH1_STAR_SPRIT_DEPARTED            = -0x4B,
    STORY_CH1_DEFEATED_JR_TROOPA             = -0x4A,
    STORY_CH1_RETURNED_TO_TOAD_TOWN          = -0x49,

    STORY_CH2_ARRIVED_AT_MT_RUGGED           = -0x48,
    STORY_CH2_SPOKE_WITH_PARAKARRY           = -0x47,
    STORY_CH2_PARAKARRY_JOINED_PARTY         = -0x46,
    STORY_CH2_ARRIVED_AT_DRY_DRY_DESERT      = -0x45,
    STORY_CH2_ARRIVED_AT_DRY_DRY_OUTPOST     = -0x44,
    STORY_CH2_SHADY_MOUSE_LEFT_SHOP          = -0x43,
    STORY_CH2_SPOKE_WITH_SHEEK               = -0x42,
    STORY_CH2_SHADY_MOUSE_ENTERED_SHOP       = -0x41,
    STORY_CH2_BOUGHT_SECRET_ITEMS            = -0x40,
    STORY_CH2_GOT_PULSE_STONE                = -0x3F,
    STORY_CH2_UNCOVERED_DRY_DRY_RUINS        = -0x3E,
    STORY_CH2_DRAINED_FIRST_SAND_ROOM        = -0x3D,
    STORY_CH2_DRAINED_SECOND_SAND_ROOM       = -0x3C,
    STORY_CH2_GOT_SUPER_HAMMER               = -0x3B,
    STORY_CH2_DRAINED_THIRD_SAND_ROOM        = -0x3A,
    STORY_CH2_SOLVED_ARTIFACT_PUZZLE         = -0x39,
    STORY_CH2_DEFEATED_TUTANKOOPA            = -0x38,
    STORY_CH2_STAR_SPIRIT_RESCUED            = -0x37,
    STORY_CH2_BEGAN_PEACH_MISSION            = -0x36,
    STORY_CH2_STAR_SPRIT_DEPARTED            = -0x35,

    STORY_CH3_SAW_BOO_ENTER_FOREST           = -0x33,
    STORY_CH3_INVITED_TO_BOOS_MANSION        = -0x32,
    STORY_CH3_ALLOWED_INTO_FOREVER_FOREST    = -0x31,
    STORY_CH3_ARRIVED_AT_BOOS_MANSION        = -0x30,
    STORY_CH3_OPENED_BOOS_MANSION_GATE       = -0x2F,
    STORY_CH3_ENTERED_BOOS_MANSION           = -0x2E,
    STORY_CH3_TRIGGERED_DOOR_JUMP_SCARE      = -0x2D,
    STORY_CH3_GOT_RECORD                     = -0x2C,
    STORY_CH3_PLAYED_THE_RECORD              = -0x2B,
    STORY_CH3_GOT_WEIGHT                     = -0x2A,
    STORY_CH3_WEIGHED_DOWN_CHANDELIER        = -0x29,
    STORY_CH3_GOT_SUPER_BOOTS                = -0x28,
    STORY_CH3_HIT_HUGE_BLUE_SWITCH           = -0x27,
    STORY_CH3_GOT_BOO_PORTRAIT               = -0x26,
    STORY_CH3_RESTORED_BOO_PORTRAIT          = -0x25,
    STORY_CH3_BOW_JOINED_PARTY               = -0x24,
    STORY_CH3_UNLOCKED_GUSTY_GULCH           = -0x23,
    STORY_CH3_ARRIVED_AT_GHOST_TOWN          = -0x22,
    STORY_CH3_SAW_TUBBA_EAT_BOO              = -0x21,
    STORY_CH3_ARRIVED_AT_TUBBAS_MANOR        = -0x20,
    STORY_CH3_TUBBA_BEGAN_NAPPING            = -0x1E,
    STORY_CH3_TUBBA_WOKE_UP                  = -0x1D,
    STORY_CH3_TUBBA_SMASHED_THE_BRIDGES      = -0x1C,
    STORY_CH3_TUBBA_CHASED_MARIO_IN_HALL     = -0x1B,
    STORY_CH3_TUBBA_CHASED_MARIO_IN_FOYER    = -0x1A,
    STORY_CH3_ESCAPED_TUBBAS_MANOR           = -0x19,
    STORY_CH3_UNLOCKED_WINDY_MILL            = -0x18,
    STORY_CH3_WENT_DOWN_THE_WELL             = -0x17,
    STORY_CH3_HEART_FLED_FIRST_TUNNEL        = -0x16,
    STORY_CH3_HEART_FLED_SECOND_TUNNEL       = -0x13,
    STORY_CH3_HEART_ESCAPED_WELL             = -0x12,
    STORY_CH3_HEART_ESCAPED_WINDY_MILL       = -0x11,
    STORY_CH3_DEFEATED_TUBBA_BLUBBA          = -0x10,
    STORY_CH3_STAR_SPIRIT_RESCUED            = -0x0F,
    STORY_CH3_BEGAN_PEACH_MISSION            = -0x0E,
    STORY_CH3_STAR_SPRIT_DEPARTED            = -0x0D,

    STORY_CH4_FRYING_PAN_STOLEN              = -0x0C,
    STORY_CH4_MET_WITH_TWINK                 = -0x0B,
    STORY_CH4_FOUND_HIDDEN_DOOR              = -0x0A,
    STORY_CH4_ENTERED_THE_TOY_BOX            = -0x09,
    STORY_CH4_GOT_STOREROOM_KEY              = -0x08,
    STORY_CH4_RETURNED_STOREROOM_KEY         = -0x07,
    STORY_CH4_GOT_TOY_TRAIN                  = -0x06,
    STORY_CH4_RETURNED_TOY_TRAIN             = -0x05,
    STORY_CH4_GOT_FRYING_PAN                 = -0x04,
    STORY_CH4_GOT_TAYCE_TS_CAKE              = -0x03,
    STORY_CH4_GAVE_CAKE_TO_GOURMET_GUY       = -0x02,
    STORY_CH4_PULLED_SWITCH_SWITCH           = -0x01,
    STORY_CH4_SOLVED_COLOR_PUZZLE            =  0x00,
    STORY_CH4_DEFEATED_LANTERN_GHOST         =  0x01,
    STORY_CH4_WATT_JOINED_PARTY              =  0x02,
    STORY_CH4_OPENED_GENERAL_GUY_ROOM        =  0x03,
    STORY_CH4_DEFEATED_GENERAL_GUY           =  0x04,
    STORY_CH4_STAR_SPIRIT_RESCUED            =  0x05,
    STORY_CH4_BEGAN_PEACH_MISSION            =  0x06,
    STORY_CH4_STAR_SPRIT_DEPARTED            =  0x07,

    STORY_CH5_WHALE_MOUTH_OPEN               =  0x08,
    STORY_CH5_ENTERED_WHALE                  =  0x09,
    STORY_CH5_DEFEATED_FUZZIPEDE             =  0x0A,
    STORY_CH5_REACHED_LAVA_LAVA_ISLAND       =  0x0B,
    STORY_CH5_KOLORADO_ESCAPED_FUZZIES       =  0x0C,
    STORY_CH5_KOLORADO_ESCAPED_SPEAR_GUYS    =  0x0D,
    STORY_CH5_YOSHI_CHILDREN_ARE_MISSING     =  0x0E,
    STORY_CH5_SUSHIE_JOINED_PARTY            =  0x0F,
    STORY_CH5_ALL_YOSHI_CHILDREN_RESCUED     =  0x10,
    STORY_CH5_GOT_JADE_RAVEN                 =  0x11,
    STORY_CH5_MOVED_RAVEN_STATUE             =  0x12,
    STORY_CH5_DEFEATED_PIRANHAS_MINIBOSS     =  0x13,
    STORY_CH5_REACHED_RAFAELS_TREE           =  0x14,
    STORY_CH5_RAFAEL_LEFT_NEST               =  0x15,
    STORY_CH5_RAFAEL_MOVED_ROOT              =  0x16,
    STORY_CH5_RAFAEL_WAITING_FOR_MARIO       =  0x17,
    STORY_CH5_ZIP_LINE_READY                 =  0x18,
    STORY_CH5_ENTERED_MT_LAVA_LAVA           =  0x19,
    STORY_CH5_KOLORADO_FELL_IN_LAVA          =  0x1A,
    STORY_CH5_LAVA_STREAM_BLOCKED            =  0x1B,
    STORY_CH5_GOT_ULTRA_HAMMER               =  0x1C,
    STORY_CH5_SMASHED_ULTRA_BLOCK            =  0x1D,
    STORY_CH5_KOLORADO_FELL_IN_PIT           =  0x1E,
    STORY_CH5_KOLORADO_AT_DEAD_END           =  0x1F,
    STORY_CH5_HIDDEN_PASSAGE_OPEN            =  0x20,
    STORY_CH5_KOLORADO_RAN_AHEAD             =  0x21,
    STORY_CH5_KOLORADO_IN_TREASURE_ROOM      =  0x22,
    STORY_CH5_DEFEATED_LAVA_PIRANHA          =  0x23,
    STORY_CH5_MT_LAVA_LAVA_ERUPTING          =  0x24,
    STORY_CH5_OPENED_ESCAPE_ROUTE            =  0x25,
    STORY_CH5_BEGAN_PEACH_MISSION            =  0x26,
    STORY_CH5_STAR_SPRIT_DEPARTED            =  0x27,
    STORY_CH5_TRADED_VASE_FOR_SEED           =  0x28,
    STORY_CH5_RETURNED_TO_TOAD_TOWN          =  0x29,

    STORY_CH6_FLOWER_GATE_OPEN               =  0x2A,
    STORY_CH6_ARRIVED_AT_FLOWER_FIELDS       =  0x2B,
    STORY_CH6_ASKED_TO_DEFEAT_MONTY_MOLES    =  0x2C,
    STORY_CH6_GOT_MAGICAL_BEAN               =  0x2D,
    STORY_CH6_GOT_FERTILE_SOIL               =  0x2E,
    STORY_CH6_GOT_CRYSTAL_BERRY              =  0x2F,
    STORY_CH6_GOT_WATER_STONE                =  0x30,
    STORY_CH6_FILLED_SPRING_WITH_WATER       =  0x31,
    STORY_CH6_SPOKE_WITH_THE_SUN             =  0x32,
    STORY_CH6_LAKILESTER_JOINED_PARTY        =  0x33,
    STORY_CH6_DEFEATED_PUFF_PUFF_GUARDS      =  0x34,
    STORY_CH6_DESTROYED_PUFF_PUFF_MACHINE    =  0x35,
    STORY_CH6_WISTERWOOD_GAVE_HINT           =  0x36,
    STORY_CH6_GREW_MAGIC_BEANSTALK           =  0x37,
    STORY_CH6_DEFEATED_HUFF_N_PUFF           =  0x38,
    STORY_CH6_STAR_SPIRIT_RESCUED            =  0x39,
    STORY_CH6_BEGAN_PEACH_MISSION            =  0x3A,
    STORY_CH6_STAR_SPRIT_DEPARTED            =  0x3B,
    STORY_CH6_RETURNED_TO_TOAD_TOWN          =  0x3C,

    STORY_CH7_INVITED_TO_STARBORN_VALLEY     =  0x3D,
    STORY_CH7_ARRIVED_AT_SHIVER_CITY         =  0x3E,
    STORY_CH7_MAYOR_MURDER_MYSTERY           =  0x3F,
    STORY_CH7_SHATTERED_FROZEN_POND          =  0x40,
    STORY_CH7_SPOKE_WITH_HERRINGWAY          =  0x41,
    STORY_CH7_HERRINGWAY_AT_MAYORS_HOUSE     =  0x42,
    STORY_CH7_MAYOR_MURDER_SOLVED            =  0x43,
    STORY_CH7_DEFEATED_JR_TROOPA             =  0x44,
    STORY_CH7_DEFEATED_MONSTAR               =  0x45,
    STORY_CH7_ARRIVED_AT_STARBORN_VALLEY     =  0x46,
    STORY_CH7_MERLE_APOLOGIZED               =  0x47,
    STORY_CH7_GOT_SNOWMAN_SCARF              =  0x48,
    STORY_CH7_GOT_SNOWMAN_BUCKET             =  0x49,
    STORY_CH7_UNLOCKED_SHIVER_MOUNTAIN       =  0x4A,
    STORY_CH7_DEFEATED_FIRST_DUPLIGHOST      =  0x4B,
    STORY_CH7_GOT_STAR_STONE                 =  0x4C,
    STORY_CH7_RAISED_FROZEN_STAIRS           =  0x4D,
    STORY_CH7_ARRIVED_AT_CRYSTAL_PALACE      =  0x4E,
    STORY_CH7_DEFEATED_MIRROR_DUPLIGHOSTS    =  0x4F,
    STORY_CH7_DEFEATED_BOMBETTE_DUPLIGHOSTS  =  0x50,
    STORY_CH7_DEFEATED_CLUBBAS               =  0x51,
    STORY_CH7_DEFEATED_KOOPER_DUPLIGHOSTS    =  0x52,
    STORY_CH7_EXTENDED_PALACE_BRIDGE         =  0x53,
    STORY_CH7_FOUND_HIDDEN_ROOM_UNDER_STATUE =  0x54,
    STORY_CH7_SOLVED_ALBINO_DINO_PUZZLE      =  0x55,
    STORY_CH7_DEFEATED_CRYSTAL_KING          =  0x56,
    STORY_CH7_STAR_SPIRIT_RESCUED            =  0x57,
    STORY_CH7_BEGAN_PEACH_MISSION            =  0x58,
    STORY_CH7_STAR_SPRIT_DEPARTED            =  0x59,

    STORY_CH8_OPENED_PATH_TO_STAR_WAY        =  0x5A,
    STORY_CH8_REACHED_STAR_HAVEN             =  0x5B,
    STORY_CH8_STAR_SHIP_ACTIVATED            =  0x5C,
    STORY_CH8_REACHED_BOWSERS_CASTLE         =  0x5E,
    STORY_CH8_REACHED_PEACHS_CASTLE          =  0x5F,
