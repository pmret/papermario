...
enum PlayerAnims {
    ...
    ANIM_Mario_STUNNED_STILL              = 0x0001000E,
    ANIM_Mario_DEAD_STILL                 = 0x0001000F,
    ANIM_Mario_10010                      = 0x00010010,
    ANIM_Mario_SPINNING                   = 0x00010011,
    ANIM_Mario_FLAILING                   = 0x00010012,
    ANIM_Mario_SIT_STILL                  = 0x00010013,
    ANIM_Mario_CROUCH                     = 0x00010014,
    ANIM_Mario_STONE_STILL                = 0x00010015,
    ANIM_Mario_THROW                      = 0x00010016,
    ANIM_Mario_FALL_BACK                  = 0x00010017,
    ANIM_Mario_FALL_DOWN                  = 0x00010018,
    ANIM_Mario_SCARED                     = 0x00010019,
    ANIM_Mario_HURT_FOOT                  = 0x0001001A,
    ANIM_Mario_RUN_PANIC                  = 0x0001001B,
    ANIM_Mario_EAT                        = 0x0001001C,
    ANIM_Mario_STICK_OUT_TONGUE           = 0x0001001D,
    ANIM_PLANT                            = 0x0001001E,
    ANIM_Mario_GOT_ITEM                   = 0x0001001F,
    ANIM_Mario_READY_JUMP                 = 0x00010020,
    ANIM_Mario_THINKING                   = 0x00010021,
    ANIM_Mario_LOST_BALANCE               = 0x00010022,
    ANIM_Mario_SHOCK_STILL                = 0x00010023,
    ANIM_Mario_10024                      = 0x00010024,
    ANIM_Mario_DRINK                      = 0x00010025,
    ANIM_Mario_SQUISH                     = 0x00010026,
    ANIM_Mario_RUN_THINKING               = 0x00010027,
    ANIM_Mario_QUESTION                   = 0x00010028,
    ANIM_Mario_NOD_YES                    = 0x00010029,
    ...
    ANIM_Mario_GET_UP                     = 0x00010030,
    ANIM_Mario_DUST_OFF                   = 0x00010031,
    ANIM_Mario_THUMBS_UP                  = 0x00010032,
