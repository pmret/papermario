...
enum StatusKeys {
    ...
    STATUX_TURN_MOD_DEFAULT        = 0x0000001F,
    STATUX_TURN_MOD_SLEEP          = 0x00000020,
    STATUX_TURN_MOD_STATIC         = 0x00000021,
    STATUX_TURN_MOD_FROZEN         = 0x00000022,
    STATUX_TURN_MOD_FEAR           = 0x00000023,
    STATUX_TURN_MOD_DIZZY          = 0x00000024,
    STATUX_TURN_MOD_POISON         = 0x00000025,
    STATUX_TURN_MOD_PARALYZE       = 0x00000026,
    STATUX_TURN_MOD_SHRINK         = 0x00000027,
    STATUX_TURN_MOD_STONE          = 0x00000028,
    STATUX_TURN_MOD_STOP           = 0x00000029,
};
