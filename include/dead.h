...
#define evt_get_variable dead_get_variable
#define evt_set_variable dead_set_variable
#define evt_get_float_variable dead_get_float_variable
#define cos_rad dead_cos_rad
#define evt_set_float_variable dead_set_float_variable
