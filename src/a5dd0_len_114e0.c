...
/*
int step_entity_commandlist(entity *entity)
{
  int *addr;
  void *iVar1;
  int shouldBreak;
  ...
  readPos = entity->scriptReadPos;
  args = (int **)(readPos + 1);
  switch(*readPos) {
  case 0:
    shouldBreak = 0;
    entity->hasEntityScript = true;
    entity->fpUpdateScriptCallback = (void *)0x0;
    entity->scriptReadPos = (int *)0x0;
    break;
  case 1:
    readPos = *args;
    shouldBreak = 1;
    entity->scriptReadPos = readPos;
    entity->hasEntityScript = true;
    entity->savedReadPos[0] = readPos;
    break;
  case 2:
    addr = *args;
    entity->scriptReadPos = readPos + 2;
    (*(code *)addr)();
    shouldBreak = 1;
    break;
  case 3:
    shouldBreak = 0;
    entity->hasEntityScript = *(bool *)((int)readPos + 7);
    iVar1 = (void *)readPos[2];
    entity->scriptReadPos = readPos + 3;
    entity->fpUpdateScriptCallback = iVar1;
    break;
  case 4:
    shouldBreak = 1;
    entity->scriptReadPos = entity->savedReadPos[(int)*args];
    break;
  case 5:
    shouldBreak = 1;
    entity->savedReadPos[(int)*args] = readPos + 2;
    entity->scriptReadPos = readPos + 2;
    break;
  case 6:
    if (entity->boundScriptBytecode != (bytecode *)0x0) {
      entity->flags = entity->flags | 0x1000000;
    }
    goto LAB_8010fd48;
  case 7:
    addr = *args;
    shouldBreak = 1;
    entity->scriptReadPos = readPos + 2;
    entity->flags = entity->flags | (uint)addr;
    break;
  case 8:
    addr = *args;
    shouldBreak = 1;
