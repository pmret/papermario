...
INCLUDE_ASM(s32, "pause_items", pause_items_draw_contents);
...
#else
INCLUDE_ASM(s32, "pause_items", pause_items_load_items);
#endif
...
INCLUDE_ASM(s32, "pause_items", pause_items_handle_input);
