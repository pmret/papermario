...
/*
void N(func_802401D4_915F44)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing* shape) {
...
/*
void N(func_802404D0_916240)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing* shape) {
...
/*
void N(func_80240694_916404)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing* shape) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
...
/*
void N(func_80240834_9165A4)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing* shape) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
    f32 posX, posY, posZ;
    s32 phi_s1;
...
/*
void N(func_80240984_9166F4)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing* shape) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
...
/*
void N(func_80240A30_9167A0)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing* shape) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
    PlayerStatus** playerStatus = &gPlayerStatusPtr;
...
/*
s32 N(func_80240FE0_916D50)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
