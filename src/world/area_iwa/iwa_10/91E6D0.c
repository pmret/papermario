...
/*
ApiStatus N(func_8024030C_91E87C)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_8024032C_91E89C)(ScriptInstance* script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240358_91E8C8)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_iwa/iwa_10/91E6D0", func_802403C4_91E934);

INCLUDE_ASM(s32, "world/area_iwa/iwa_10/91E6D0", func_80240410_91E980);
/*
ApiStatus N(func_80240410_91E980)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
/*
ApiStatus N(func_80240738_91ECA8)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240770_91ECE0)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
/*
ApiStatus N(func_80240834_91EDA4)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_iwa/iwa_10/91E6D0", func_80240898_91EE08);
/*
ApiStatus N(func_80240898_91EE08)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_802408F0_91EE60)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    Npc* npc = get_npc_safe(-4);
...
/*
s32 N(func_80240E28_91F398)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
