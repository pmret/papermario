...
EvtScript N(EVS_ParadePhase_Bowser) = {
    ...
    EVT_CALL(NpcJump1, NPC_JrTroopa, 2010, 0, 0, 20)
    EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_Run)
    EVT_CALL(NpcMoveTo, NPC_JrTroopa, 1930, 0, 20)
    ...
    EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_Idle)
    EVT_CALL(NpcFlyTo, NPC_Kammy, 2060, 60, 0, 10, -10, EASING_LINEAR)
    ...
    EVT_CALL(NpcFlyTo, NPC_Kammy, 1940, 60, 0, 20, -10, EASING_LINEAR)
    ...
    EVT_THREAD
        EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_Run)
        EVT_CALL(NpcMoveTo, NPC_JrTroopa, 1900, 0, 50)
    EVT_END_THREAD
    EVT_WAIT(20)
    EVT_CALL(SetNpcAnimation, NPC_Kammy, ANIM_WorldKammy_Anim14)
    ...
    EVT_CALL(InterpNpcYaw, NPC_Kammy, 90, 0)
    EVT_WAIT(20)
    EVT_CALL(NpcFlyTo, NPC_Kammy, 1900, 40, 0, 25, -10, EASING_LINEAR)
    EVT_WAIT(150)
    EVT_THREAD
        EVT_WAIT(35)
        ...
        EVT_CALL(InterpNpcYaw, NPC_Kammy, 270, 0)
    EVT_END_THREAD
    EVT_CALL(SetNpcPos, NPC_JrTroopa, 2040, 0, 20)
    EVT_CALL(SetNpcYaw, NPC_JrTroopa, 90)
    EVT_CALL(NpcMoveTo, NPC_JrTroopa, 2400, 20, 90)
    EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_Idle)
    EVT_WAIT(10)
    EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_RaiseStaff)
    EVT_WAIT(10)
    ...
    EVT_THREAD
        EVT_WAIT(10)
        EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_Run)
        EVT_CALL(NpcMoveTo, NPC_JrTroopa, 2480, 20, 20)
        EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_Idle)
        EVT_CALL(InterpNpcYaw, NPC_JrTroopa, 270, 0)
        EVT_WAIT(10)
        EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_RaiseStaff)
    ...
    EVT_THREAD
        ...
        EVT_CALL(NpcMoveTo, NPC_HammerBros2, 2140, 0, 30)
    ...
    EVT_THREAD
        ...
        EVT_CALL(NpcFlyTo, NPC_Kammy, 2180, 60, -20, 30, -10, EASING_LINEAR)
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(SetNpcAnimation, NPC_JrTroopa, ANIM_MageJrTroopa_Run)
        EVT_CALL(NpcMoveTo, NPC_JrTroopa, 2160, 20, 40)
    EVT_END_THREAD
    EVT_WAIT(40)
    EVT_THREAD
    ...
    EVT_THREAD
        ...
        EVT_CALL(NpcJump1, NPC_Kammy, 2380, 0, 0, 20)
        EVT_CALL(NpcJump1, NPC_Kammy, 2430, 0, 0, 10)
    EVT_END_THREAD
    EVT_THREAD
        ...
        EVT_CALL(SetNpcJumpscale, NPC_JrTroopa, EVT_FLOAT(0.5))
        EVT_CALL(NpcJump1, NPC_JrTroopa, 2420, 0, 0, 20)
        EVT_CALL(NpcJump1, NPC_JrTroopa, 2470, 0, 0, 10)
    EVT_END_THREAD
    EVT_WAIT(30)
    EVT_SETF(LVar0, 2430)
    EVT_SETF(LVar1, 2470)
