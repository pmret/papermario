...
EvtScript N(EVS_Bobomb1) = {
    EVT_CALL(SetNpcFlagBits, NPC_Bobomb1, NPC_FLAG_ENABLE_HIT_SCRIPT | NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_8000, TRUE)
    EVT_WAIT(180)
...
EvtScript N(EVS_Bobomb2) = {
    EVT_CALL(SetNpcFlagBits, NPC_Bobomb2, NPC_FLAG_ENABLE_HIT_SCRIPT | NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_8000, TRUE)
    EVT_WAIT(180)
...
EvtScript N(EVS_Bobomb3) = {
    EVT_CALL(SetNpcFlagBits, NPC_Bobomb3, NPC_FLAG_ENABLE_HIT_SCRIPT | NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_8000, TRUE)
    EVT_WAIT(180)
...
EvtScript N(EVS_Bobomb4) = {
    EVT_CALL(SetNpcFlagBits, NPC_Bobomb4, NPC_FLAG_ENABLE_HIT_SCRIPT | NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_8000, TRUE)
    EVT_WAIT(180)
