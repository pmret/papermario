...
EvtScript N(EVS_ParadePhase_CrystalKing) = {
    ...
    EVT_ADD(LVar0, -40)
    EVT_CALL(NpcJump1, NPC_Duplighost1, LVar0, LVar1, LVar2, 20)
    ...
    EVT_ADD(LVar0, -80)
    EVT_CALL(NpcMoveTo, NPC_FakeCrystalKing, LVar0, LVar2, 40)
    EVT_SET(LVar0, 78)
    EVT_EXEC_GET_TID(N(EVS_OffsetNpcScroll), LVarB)
    EVT_THREAD
        EVT_CALL(SetNpcAnimation, NPC_FakeCrystalKing, ANIM_CrystalKing_Anim10)
    ...
    EVT_ADD(LVar0, -40)
    EVT_CALL(NpcJump1, NPC_Duplighost2, LVar0, LVar1, LVar2, 20)
    ...
    EVT_CALL(GetNpcPos, NPC_TrueCrystalKing, LVar0, LVar1, LVar2)
    EVT_ADD(LVar0, -80)
    EVT_CALL(NpcMoveTo, NPC_TrueCrystalKing, LVar0, LVar2, 40)
    EVT_SET(LVar0, 77)
    EVT_EXEC_GET_TID(N(EVS_OffsetNpcScroll), LVarC)
    EVT_THREAD
        EVT_LOOP(6)
    ...
    EVT_WAIT(60)
    EVT_THREAD
        EVT_CALL(LoadPath, 50, EVT_PTR(N(CrystalsFlyInPath)), ARRAY_COUNT(N(CrystalsFlyInPath)), EASING_LINEAR)
        EVT_LOOP(0)
    ...
    EVT_THREAD
        EVT_CALL(SetNpcAnimation, NPC_TrueCrystalKing, ANIM_CrystalKing_Anim19)
        EVT_CALL(LoadPath, 50, EVT_PTR(N(CrystalsFlyOutPath)), ARRAY_COUNT(N(CrystalsFlyInPath)), EASING_LINEAR)
        EVT_LOOP(0)
            EVT_CALL(GetNextPathPos)
            EVT_SET(LVar4, LVar1)
            EVT_ADD(LVar4, -30)
