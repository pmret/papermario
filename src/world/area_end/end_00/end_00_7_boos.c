...
EvtScript N(EVS_ParadePhase_Boos) = {
    ...
    EVT_CALL(NpcMoveTo, NPC_TubbasBody, -460, 0, 100)
    ...
    EVT_CALL(NpcJump0, NPC_TubbasHeart, -290, 0, 0, 10)
    EVT_CALL(NpcJump0, NPC_TubbasHeart, -320, 0, 0, 10)
    EVT_SET(LVar0, 53)
    ...
    EVT_THREAD
        ...
        EVT_SUB(LVar0, 180)
        EVT_CALL(NpcMoveTo, NPC_Bootler, LVar0, LVar2, 60)
    EVT_END_THREAD
    ...
    EVT_THREAD
        ...
        EVT_CALL(GetNpcPos, NPC_TubbasBody, LVar0, LVar1, LVar2)
        EVT_SUB(LVar0, 180)
        EVT_CALL(NpcMoveTo, NPC_TubbasBody, LVar0, LVar2, 60)
    EVT_END_THREAD
    EVT_THREAD
        ...
        EVT_SUB(LVar0, 180)
        EVT_CALL(NpcMoveTo, NPC_Boo1, LVar0, LVar2, 60)
    EVT_END_THREAD
    EVT_THREAD
        ...
        EVT_SUB(LVar0, 180)
        EVT_CALL(NpcMoveTo, NPC_Boo2, LVar0, LVar2, 60)
    EVT_END_THREAD
    EVT_THREAD
        ...
        EVT_SUB(LVar0, 180)
        EVT_CALL(NpcMoveTo, NPC_Boo3, LVar0, LVar2, 60)
    EVT_END_THREAD
    EVT_WAIT(30)
    ...
    EVT_LOOP(6)
        EVT_SUB(LVar0, 45)
        EVT_CALL(NpcJump0, NPC_TubbasHeart, LVar0, LVar1, LVar2, 15)
    EVT_END_LOOP
    EVT_RETURN
    EVT_END
};
