...
EvtScript N(EVS_ParadePhase_Boos) = {
    ...
    EVT_CALL(SetNpcFoldParams, NPC_Boo1, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
    EVT_CALL(SetNpcFoldParams, NPC_Boo2, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
    EVT_CALL(SetNpcFoldParams, NPC_Boo3, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_LOOP(30 * DT)
            EVT_CALL(UpdateLerp)
            EVT_CALL(SetNpcFoldParams, NPC_Boo1, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
            EVT_CALL(SetNpcFoldParams, NPC_Boo2, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
            EVT_CALL(SetNpcFoldParams, NPC_Boo3, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
            EVT_WAIT(1)
        EVT_END_LOOP
