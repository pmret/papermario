...
/*
ApiStatus N(func_802407AC_DDCFDC)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_802407CC_DDCFFC)(ScriptInstance* script, s32 isInitialCall) {
    func_800EB168(get_variable(script, *script->ptrReadPos));
    return ApiStatus_DONE2;
}
*/

INCLUDE_ASM(s32, "world/area_omo/omo_11/DDCFC0", func_802407F8_DDD028);
/*
ApiStatus N(func_802407F8_DDD028)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_omo/omo_11/DDCFC0", func_80240864_DDD094);

INCLUDE_ASM(s32, "world/area_omo/omo_11/DDCFC0", func_802408B0_DDD0E0);
/*
ApiStatus N(func_802408B0_DDD0E0)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
INCLUDE_ASM(s32, "world/area_omo/omo_11/DDCFC0", func_80240BD8_DDD408);
/*
ApiStatus N(func_80240BD8_DDD408)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240CA0_DDD4D0)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_omo/omo_11/DDCFC0", func_80240CD4_DDD504);
/*
ApiStatus N(func_80240CD4_DDD504)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240D38_DDD568)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240D90_DDD5C0)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    Npc* npc = get_npc_safe(-4);
...
INCLUDE_ASM(s32, "world/area_omo/omo_11/DDCFC0", func_802412C8_DDDAF8);
/*
s32 N(func_802412C8_DDDAF8)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
...
INCLUDE_ASM(s32, "world/area_omo/omo_11/DDCFC0", func_80241498_DDDCC8);
