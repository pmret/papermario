...
EvtScript N(EVS_EnterScene) = {
    ...
    EVT_CALL(MakeLerp, 255, 100, 60, EASING_LINEAR)
    EVT_LABEL(0)
        EVT_CALL(UpdateLerp)
    ...
    EVT_CALL(SetNpcSpeed, NPC_BigLanternGhost, EVT_FLOAT(3.0))
...
EvtScript N(EVS_Scene_ReleaseWatt) = {
    ...
    EVT_CALL(GetNpcPos, NPC_LaternTop, LVar0, LVar1, LVar2)
    EVT_CALL(SetCamProperties, CAM_DEFAULT, EVT_FLOAT(2.0), LVar0, LVar1, LVar2, EVT_FLOAT(450.0), EVT_FLOAT(15.0), EVT_FLOAT(-6.0))
    EVT_SET(LVarA, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(NpcJump0, NPC_LaternTop, LVar0, 20, LVar2, 20)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(6)
        EVT_CALL(GetNpcPos, NPC_LaternTop, LVar0, LVar1, LVar2)
    ...
    EVT_CALL(GetAngleToPlayer, NPC_Watt, LVar0)
    EVT_IF_LT(LVar0, 180)
        EVT_CALL(LoadPath, 15, EVT_PTR(N(WattRightFlightPath)), ARRAY_COUNT(N(WattRightFlightPath)), EASING_LINEAR)
        EVT_SET(LVar4, 12)
    EVT_ELSE
        EVT_CALL(LoadPath, 15, EVT_PTR(N(WattLeftFlightPath)), ARRAY_COUNT(N(WattLeftFlightPath)), EASING_LINEAR)
        EVT_SET(LVar4, -12)
    EVT_END_IF
    ...
    EVT_THREAD
        ...
        EVT_CALL(MakeLerp, 200, 255, 45, EASING_LINEAR)
        EVT_LOOP(0)
            EVT_CALL(UpdateLerp)
            EVT_CALL(N(SetLightOriginAndPower), LVar2, LVar3, LVar4, LVar0)
            EVT_WAIT(1)
...
StaticNpc N(NpcData_LanternBottom) = {
    ...
    .pos = { NPC_DISPOSE_LOCATION },
    .yaw = 270,
    .flags = ENEMY_FLAG_8 | ENEMY_FLAG_100 | ENEMY_FLAG_200 | ENEMY_FLAG_400 | ENEMY_FLAG_800 | ENEMY_FLAG_100000 | ENEMY_FLAG_IGNORE_TOUCH | ENEMY_FLAG_8000000,
