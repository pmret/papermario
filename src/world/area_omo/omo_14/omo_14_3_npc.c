                ...
                EVT_SWITCH(LVar9)
                    ...
                    EVT_CASE_EQ(PARTNER_WATT)
                        ...
                        EVT_ELSE
                            ...
                            EVT_IF_LT(LVar0, 150)
                                EVT_CALL(SetNpcJumpscale, NPC_SELF, EVT_FLOAT(1.0))
                                EVT_CALL(NpcJump0, NPC_SELF, LVar3, 0, LVar4, 15)
                                EVT_WAIT(30)
                            EVT_ELSE
...
EvtScript N(EVS_NpcIdle_ShyGuy_Crowd) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(1)
            ...
            EVT_CALL(NpcJump0, NPC_SELF, LVar0, LVar1, LVar2, 12)
            EVT_CALL(GetSelfVar, 0, LVar0)
            EVT_IF_EQ(LVar0, 1)
                EVT_CALL(N(GetActingPartner))
                EVT_IF_NE(LVar9, 6)
        ...
        EVT_CASE_EQ(2)
            ...
            EVT_CALL(GetNpcPos, NPC_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(SetNpcJumpscale, NPC_SELF, EVT_FLOAT(1.0))
            EVT_CALL(NpcJump0, NPC_SELF, 235, LVar1, LVar2, 20)
            EVT_WAIT(30)
...
NpcData N(NpcData_ShyGuy_Loner) = {
    ...
    .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_100 | ENEMY_FLAG_200,
