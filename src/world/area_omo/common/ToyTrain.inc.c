...
EvtScript N(EVS_TrainUnk_D) = {
    EVT_CALL(SetNpcFlagBits, NPC_Conductor, NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_100, TRUE)
...
EvtScript N(EVS_TrainUnk_E) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFlagBits, NPC_Conductor, NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_100, FALSE)
    EVT_END_THREAD
    EVT_WAIT(10)
    EVT_THREAD
    ...
    EVT_CALL(SetNpcAnimation, NPC_PARTNER, PARTNER_ANIM_IDLE)
    EVT_CALL(SetNpcFlagBits, NPC_PARTNER, NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_100, FALSE)
    EVT_RETURN
    EVT_END
};
