...
EvtScript N(EVS_Scene_Epilogue) = {
    ...
    Call(SetNpcAnimation, NPC_ShyGuy_01, ANIM_ShyGuy_Red_Excited)
    Call(SetNpcAnimation, NPC_ShyGuy_02, ANIM_ShyGuy_Red_Excited)
    Call(SetNpcAnimation, NPC_ShyGuy_03, ANIM_ShyGuy_Red_Excited)
    Wait(60)
