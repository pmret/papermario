...
EvtScript N(EVS_Scene_PullBlueSwitch) = {
    ...
    EVT_LABEL(0)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(0)
        EVT_END_IF
    EVT_CALL(PlaySoundAt, SOUND_1F1, SOUND_SPACE_MODE_0, -440, 10, 40)
    ...
    EVT_WAIT(20)
    EVT_CALL(PlaySoundAt, SOUND_1F2, SOUND_SPACE_MODE_0, -130, 0, -215)
    ...
    EVT_LABEL(1)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(1)
        EVT_END_IF
    EVT_CALL(PlaySoundAt, SOUND_51, SOUND_SPACE_MODE_0, -130, 0, -215)
