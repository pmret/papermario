...
EvtScript N(EVS_Scene_PullPinkSwitch) = {
    ...
    EVT_LABEL(0)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(0)
        EVT_END_IF
    EVT_CALL(PlaySoundAt, SOUND_1F1, SOUND_SPACE_MODE_0, -395, 0, -185)
    ...
    EVT_WAIT(20 * DT)
    EVT_CALL(PlaySoundAt, SOUND_1F2, SOUND_SPACE_MODE_0, 265, 0, -235)
    ...
    EVT_LABEL(1)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(1)
        EVT_END_IF
    EVT_CALL(PlaySoundAt, SOUND_51, SOUND_SPACE_MODE_0, 265, 0, -235)
