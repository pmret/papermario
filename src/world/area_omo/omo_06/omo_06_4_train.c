...
EvtScript N(D_80244518_DBBE28) = {
    ...
    EVT_IF_EQ(AB_OMO_6, 1)
        ...
        EVT_CALL(SpeakToPlayer, NPC_Conductor, ANIM_TrainStationToad_Talk, ANIM_TrainStationToad_Idle, 0, MSG_CH4_000F)
        ...
        EVT_ELSE
            EVT_SWITCH(GB_StoryProgress)
                EVT_CASE_LT(STORY_CH4_PULLED_SWITCH_SWITCH)
                    EVT_CALL(SpeakToPlayer, NPC_Conductor, ANIM_TrainStationToad_SadTalk, ANIM_TrainStationToad_SadIdle, 0, MSG_CH4_0012)
