...
EvtScript N(EVS_NpcInteract_GourmetGuy) = {
    ...
    EVT_SWITCH(LVar9)
        ...
        EVT_CASE_EQ(2)
            ...
            EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
            EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_381, 0)
            EVT_WAIT(33)
            ...
            EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
            EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_382, 0)
            EVT_WAIT(33)
            ...
            EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
            EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_383, 0)
            EVT_WAIT(18)
            ...
            EVT_THREAD
                ...
                EVT_END_IF
            EVT_END_THREAD
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_384, 0)
...
StaticNpc N(NpcData_GourmetGuy)[] = {
    {
        ...
        .yaw = 90,
        .flags = ENEMY_FLAG_1 | ENEMY_FLAG_100 | ENEMY_FLAG_800 | ENEMY_FLAG_400000,
