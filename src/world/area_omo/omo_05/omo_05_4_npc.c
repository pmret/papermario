...
EvtScript N(EVS_NpcInteract_GourmetGuy) = {
    ...
    EVT_SWITCH(LVar9)
        ...
        EVT_CASE_EQ(2)
            ...
            EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
            EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_0381, SOUND_SPACE_MODE_0)
            EVT_WAIT(33 * DT)
            ...
            EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
            EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_0382, SOUND_SPACE_MODE_0)
            EVT_WAIT(33 * DT)
            ...
            EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
            EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_0383, SOUND_SPACE_MODE_0)
            EVT_WAIT(18 * DT)
            ...
            EVT_THREAD
                ...
                EVT_END_IF
            EVT_END_THREAD
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_0384, SOUND_SPACE_MODE_0)
            ...
            EVT_THREAD
                EVT_WAIT(15 * DT)
                EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_0385, SOUND_SPACE_MODE_0)
