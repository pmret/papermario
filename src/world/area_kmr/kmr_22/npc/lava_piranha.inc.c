...
EvtScript N(EVS_NpcInit_LavaPiranhaHead) = {
    EVT_CALL(SetNpcFoldParams, NPC_LavaPiranhaHead, FOLD_UPD_FILL_COLOR, 80, 80, 80, 0)
    EVT_CALL(SetNpcFoldParams, NPC_LavaBud_01, FOLD_UPD_FILL_COLOR, 80, 80, 80, 0)
    EVT_CALL(SetNpcFoldParams, NPC_LavaBud_02, FOLD_UPD_FILL_COLOR, 80, 80, 80, 0)
