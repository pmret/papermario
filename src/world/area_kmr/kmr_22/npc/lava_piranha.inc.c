...
EvtScript N(EVS_NpcInit_LavaPiranhaHead) = {
    EVT_CALL(SetNpcFoldParams, NPC_LavaPiranhaHead, IMGFX_UPD_FILL_COLOR, 80, 80, 80, 0)
    EVT_CALL(SetNpcFoldParams, NPC_LavaBud_01, IMGFX_UPD_FILL_COLOR, 80, 80, 80, 0)
    EVT_CALL(SetNpcFoldParams, NPC_LavaBud_02, IMGFX_UPD_FILL_COLOR, 80, 80, 80, 0)
