EvtScript N(EVS_NpcInit_Mamar) = {
    ...
    EVT_CALL(SetNpcFoldParams, NPC_SELF, IMGFX_UPD_SET_TINT, 0, 0, 0, 128)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_NpcInit_Tutankoopa) = {
    ...
    EVT_CALL(SetNpcFoldParams, NPC_SELF, IMGFX_UPD_FILL_COLOR, 80, 80, 80, 0)
    EVT_RETURN
    EVT_END
};
