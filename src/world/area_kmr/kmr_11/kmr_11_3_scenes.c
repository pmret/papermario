...
EvtScript N(EVS_GoombaKingBlastoff) = {
    ...
    EVT_CALL(PlaySoundAt, SOUND_LENS_FLARE, SOUND_SPACE_DEFAULT, -1600, 1000, -1600)
...
EvtScript N(EVS_Scene_MeetGoombaKing_Impl) = {
    ...
    EVT_CALL(PlaySoundAt, SOUND_HEAVY_NPC_FOOSTEP, SOUND_SPACE_DEFAULT, -330, 0, -130)
    EVT_CALL(PlaySoundAt, SOUND_20B4, SOUND_SPACE_DEFAULT, -330, 0, -130)
