...
Script N(Hit_80240F64) = SCRIPT({
    ...
    if (SI_MAP_VAR(0) < 3) {
        ...
        EnablePartnerAI();
        SetNpcAux(NPC_SELF, N(Script_8024097C));
...
Script N(MakeEntities) = SCRIPT({
    if (STORY_PROGRESS < STORY_CH0_LEFT_THE_PLAYGROUND) {
        MakeEntity(0x802EA10C, 45, 0, 70, 15, ARGS_END);
        AssignScript(N(Script_80241470));
    } else {
        ModifyColliderFlags(0, 9, 0x7FFFFE00);
    }
    if (SI_SAVE_FLAG(54) == 0) {
        MakeEntity(0x802EA19C, 230, 0, 310, 15, ARGS_END);
        AssignScript(N(Script_802414A8));
    }
    MakeEntity(0x802EA588, 230, 60, 310, 15, ITEM_REPEL_GEL, ARGS_END);
    AssignBlockFlag(SI_SAVE_FLAG(52));
    MakeEntity(0x802EA0C4, 230, 50, -160, 15, ARGS_END);
    MakeEntity(0x802EA0C4, 165, 0, 380, 20, ARGS_END);
    MakeEntity(0x802EA564, -170, 0, 370, 43, ITEM_COIN, ARGS_END);
    AssignBlockFlag(SI_SAVE_FLAG(50));
    MakeEntity(0x802EAA54, 345, 75, -250, 0, ITEM_WATER, ARGS_END);
    ...
    MakeEntity(0x802EAB04, 300, 0, 150, 0, ITEM_PULSE_STONE, ARGS_END);
    AssignPanelFlag(SI_SAVE_FLAG(88));
    MakeEntity(0x802EA7E0, 130, 60, 0, 0, ARGS_END);
});
