...
EvtScript N(npcAI_80240B50) = {
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_EQ(-122)
            ...
            EVT_WAIT(10)
            EVT_CALL(SpeakToPlayer, 0, NPC_ANIM_goompa_Palette_00_Anim_8, NPC_ANIM_goompa_Palette_00_Anim_1, 0, MSG_CH0_00A6)
            ...
            EVT_WAIT(30)
            EVT_CALL(SpeakToPlayer, 0, NPC_ANIM_goompa_Palette_00_Anim_8, NPC_ANIM_goompa_Palette_00_Anim_1, 0, MSG_CH0_00A7)
            EVT_WAIT(5)
            EVT_CALL(SetPlayerAnimation, ANIM_Mario_80007)
            EVT_WAIT(30)
            EVT_CALL(SpeakToPlayer, 0, NPC_ANIM_goompa_Palette_00_Anim_8, NPC_ANIM_goompa_Palette_00_Anim_1, 0, MSG_CH0_00A8)
