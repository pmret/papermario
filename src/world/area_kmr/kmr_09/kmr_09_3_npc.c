...
EvtScript N(EVS_NpcIdle_Goomba_Ambush) = {
    ...
    EVT_CALL(SetNpcFoldFlags, NPC_SELF, IMGFX_STATE_FLAG_2000)
    EVT_CALL(SetNpcFoldParams, NPC_SELF, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_UNFURL, 1, 1, 0)
    EVT_WAIT(15)
    EVT_CALL(SetNpcFoldFlags, NPC_SELF, IMGFX_STATE_FLAG_2000)
    EVT_CALL(SetNpcFoldParams, NPC_SELF, IMGFX_TYPE_3, 0, 0, 0, 0)
    EVT_THREAD
        EVT_WAIT(2)
