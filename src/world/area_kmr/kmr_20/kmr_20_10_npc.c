...
EvtScript N(EVS_Scene_LuigiWaitingAround) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(PlaySoundAtNpc, NPC_Luigi_1, SOUND_0263, SOUND_SPACE_DEFAULT)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Luigi_1, SOUND_0262, SOUND_SPACE_DEFAULT)
    ...
    EVT_WAIT(15)
    EVT_CALL(PlaySoundAtNpc, NPC_PARTNER, SOUND_0263, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_NpcAI_ShyGuy) = {
    ...
    EVT_WAIT(10)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_ShyGuy_Red_Anim03)
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_203F, SOUND_SPACE_DEFAULT)
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_032C, SOUND_SPACE_DEFAULT)
