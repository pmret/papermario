...
EvtScript N(EVS_Luigi_EnterPipe_Epilogue) = {
    ...
    EVT_WAIT(2)
    EVT_CALL(PlaySoundAtNpc, NPC_Luigi_1, SOUND_ENTER_PIPE, SOUND_SPACE_MODE_0)
    ...
    EVT_THREAD
        ...
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(SetNpcImgfxFlags, NPC_Luigi_1, IMGFX_STATE_FLAG_800)
    EVT_CALL(SetNpcImgfxParams, NPC_Luigi_1, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_VERTICAL_PIPE_CURL, 1, 1, 0)
    EVT_WAIT(25)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_Scene_EpilogueGetLetter) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Luigi_1, SOUND_JUMP_2081, SOUND_SPACE_MODE_0)
    EVT_WAIT(5)
