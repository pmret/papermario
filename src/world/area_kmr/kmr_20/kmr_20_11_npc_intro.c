...
EvtScript N(EVS_Luigi_EnterPipe_Intro) = {
    ...
    EVT_THREAD
        ...
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(SetNpcFoldFlags, NPC_Scene_Luigi, IMGFX_STATE_FLAG_800)
    EVT_CALL(SetNpcFoldParams, NPC_Scene_Luigi, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_VERTICAL_PIPE_CURL, 1, 1, 0)
    EVT_WAIT(25)
    EVT_RETURN
    EVT_END
};
