    ...
    switch (script->functionTemp[0]) {
        case FUNC_STATE_0:
            ...
            if (script->VAR_1 >= script->varTable[15]) {
                ...
                sfx_play_sound_at_position(SOUND_SEQ_1E, SOUND_SPACE_DEFAULT, npc->pos.x, npc->pos.y, npc->pos.z);
...
EvtScript N(EVS_Scene_MarioRevived) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtPlayer, SOUND_SEQ_1F, SOUND_SPACE_DEFAULT)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Goombaria, SOUND_0263, SOUND_SPACE_DEFAULT)
