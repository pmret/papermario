...
ApiStatus func_80241CC8_8D31D8(Evt* script, s32 isInitialCall) {
    ...
    s32* mapVar10 = get_variable(script, EVT_MAP_VAR(10));
    s32 mapVar11 = get_variable(script, EVT_MAP_VAR(11));
    s32 mapVar12 = get_variable(script, EVT_MAP_VAR(12));
    ...
    set_variable(script, EVT_MAP_VAR(10), NULL);
    set_variable(script, EVT_MAP_VAR(11), NULL);
    set_variable(script, EVT_MAP_VAR(12), NULL);
