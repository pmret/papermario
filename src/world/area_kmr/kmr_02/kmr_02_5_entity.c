...
EvtScript N(EVS_SummonGateBlock) = {
    EVT_CALL(PlaySoundAt, SOUND_207A, SOUND_SPACE_DEFAULT, 373, 88, 255)
    EVT_CALL(GetNpcPos, NPC_Kammy, LVar0, LVar1, LVar2)
    EVT_PLAY_EFFECT(EFFECT_GATHER_ENERGY_PINK, 0, 373, 88, 255, 1, 100)
    EVT_WAIT(20 * DT)
    EVT_CALL(PlaySoundAt, SOUND_207B, SOUND_SPACE_DEFAULT, 326, 150, 261)
    ...
    EVT_LABEL(10)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(10)
        EVT_END_IF
    EVT_CALL(PlaySoundAt, SOUND_207C, SOUND_SPACE_DEFAULT, LVar2, LVar0, LVar4)
    EVT_WAIT(20 * DT)
    ...
    EVT_END_THREAD
    EVT_CALL(PlaySoundAt, SOUND_207D, SOUND_SPACE_DEFAULT, LVar2, LVar0, LVar4)
