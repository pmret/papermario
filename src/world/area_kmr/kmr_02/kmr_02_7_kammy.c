...
EvtScript N(EVS_Scene_KammyStrikes) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetPlayerImgfxFlags, IMGFX_STATE_FLAG_REVERSE_ANIM)
        EVT_CALL(UpdatePlayerImgfx, ANIM_MarioW2_PanicHoverStill, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_SHOCK, 1, 1, 0)
        EVT_WAIT(13 * DT)
        EVT_CALL(UpdatePlayerImgfx, ANIM_MarioW2_PanicHoverStill, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
        EVT_CALL(SetPlayerAnimation, ANIM_MarioW2_PanicHover)
        EVT_CALL(SetPlayerImgfxFlags, IMGFX_STATE_FLAG_REVERSE_ANIM)
        EVT_CALL(UpdatePlayerImgfx, ANIM_MarioW2_PanicHover, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_SHOCK, 1, 1, 0)
        EVT_WAIT(13 * DT)
        EVT_CALL(UpdatePlayerImgfx, ANIM_MarioW2_PanicHover, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcImgfxFlags, NPC_Goombaria, IMGFX_STATE_FLAG_REVERSE_ANIM)
        EVT_CALL(SetNpcImgfxParams, NPC_Goombaria, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_SHOCK, 1, 1, 0)
        ...
        EVT_CALL(SetNpcAnimation, NPC_Goombaria, ANIM_Goombaria_LookUp)
        EVT_CALL(SetNpcImgfxParams, NPC_Goombaria, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_END_THREAD
    EVT_CALL(SetNpcImgfxFlags, NPC_Goompapa, IMGFX_STATE_FLAG_REVERSE_ANIM)
    EVT_CALL(SetNpcImgfxParams, NPC_Goompapa, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_SHOCK, 1, 1, 0)
    ...
    EVT_CALL(SetNpcAnimation, NPC_Goompapa, ANIM_Goompapa_LookUp)
    EVT_CALL(SetNpcImgfxParams, NPC_Goompapa, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_WAIT(10 * DT)
    EVT_CALL(SetNpcAnimation, NPC_Kammy, ANIM_WorldKammy_Anim13)
    EVT_CALL(SetCamType, CAM_DEFAULT, 4, FALSE)
    EVT_CALL(SetCamPitch, CAM_DEFAULT, EVT_FLOAT(6.0), EVT_FLOAT(-6.0))
