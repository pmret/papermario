...
EvtScript N(EVS_ReturnToVillage) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_PARTNER, SOUND_0269, SOUND_SPACE_DEFAULT)
    EVT_WAIT(15 * DT)
    EVT_CALL(PlaySoundAtCollider, COLLIDER_mm1, SOUND_01D2, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_Scene_EldstarsPlea) = {
    ...
    EVT_WAIT(90 * DT)
    EVT_CALL(PlaySoundAtNpc, NPC_Eldstar_02, SOUND_SRAW_1E_A, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_NpcIdle_Eldstar_Epilogue) = {
    ...
    EVT_WAIT(10)
    EVT_THREAD
        EVT_CALL(PlaySoundAtNpc, NPC_Goombaria, SOUND_0262, SOUND_SPACE_DEFAULT)
        EVT_CALL(ShowEmote, NPC_Goombaria, EMOTE_EXCLAMATION, 0, 30, EMOTER_NPC, 0, 0, 0, 0)
    EVT_END_THREAD
    EVT_CALL(PlaySoundAtNpc, NPC_Goombario, SOUND_0262, SOUND_SPACE_DEFAULT)
