...
EvtScript N(EVS_Goombaria_RequestDolly) = {
    ...
    EVT_IF_EQ(LVar0, 0)
        ...
        EVT_WAIT(10)
        EVT_CALL(UpdatePlayerImgfx, ANIM_Mario1_Idle, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_SHIVER, 1, 1, 0)
        EVT_WAIT(35)
...
EvtScript N(EVS_Scene_EldstarsPlea) = {
    ...
    EVT_THREAD
        ...
        EVT_LABEL(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(SetNpcImgfxParams, NPC_Eldstar_02, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_WAIT(1)
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(0)
        EVT_END_IF
...
EvtScript N(EVS_NpcAI_Eldstar_02) = {
    ...
    EVT_LABEL(1)
    EVT_LOOP(50)
        EVT_CALL(SetNpcImgfxParams, NPC_SELF, IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, ArrayVar(0), 0, MV_Unk_01)
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_LOOP(50)
        EVT_CALL(SetNpcImgfxParams, NPC_SELF, IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, ArrayVar(0), 0, MV_Unk_01)
