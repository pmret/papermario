...
EvtScript N(EVS_BombWall_MiddleCell) = {
    ...
    EVT_LOOP(10)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(ModifyColliderFlags, 0, COLLIDER_deilit2, COLLIDER_FLAGS_UPPER_MASK)
    EVT_CALL(ModifyColliderFlags, 0, COLLIDER_tt2, COLLIDER_FLAGS_UPPER_MASK)
...
EvtScript N(EVS_BombWall_RightCell) = {
    ...
    EVT_LOOP(10)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(ModifyColliderFlags, 0, COLLIDER_deilit3, COLLIDER_FLAGS_UPPER_MASK)
    EVT_CALL(ModifyColliderFlags, 0, COLLIDER_tt3, COLLIDER_FLAGS_UPPER_MASK)
...
EvtScript N(EVS_Main) = {
    ...
    EVT_ELSE
        ...
        EVT_CALL(ModifyColliderFlags, 0, COLLIDER_deilit1, COLLIDER_FLAGS_UPPER_MASK)
