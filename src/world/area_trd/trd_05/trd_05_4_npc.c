...
EvtScript N(EVS_KoopaBros_SetTrap) = {
    ...
    EVT_THREAD
        EVT_LOOP(8)
            EVT_CALL(SetNpcFoldParams, NPC_KoopaBros_01, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
            EVT_CALL(SetNpcFoldParams, NPC_KoopaBros_02, IMGFX_UPD_SET_ALPHA, 255, 0, 0, 0)
            EVT_WAIT(6 * DT)
            EVT_CALL(SetNpcFoldParams, NPC_KoopaBros_01, IMGFX_UPD_SET_ALPHA, 255, 0, 0, 0)
            EVT_CALL(SetNpcFoldParams, NPC_KoopaBros_02, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
            EVT_WAIT(6 * DT)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_THREAD
