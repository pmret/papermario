...
EvtScript N(EVS_Scene_LowerStairs) = {
    ...
    EVT_THREAD
        EVT_LOOP(5)
            ...
            EVT_ADD(LVar1, 150)
            EVT_CALL(PlayEffect, EFFECT_DUST, 0, LVar0, LVar1, LVar2, 40, 0, 0, 0, 0, 0, 0, 0, 0)
    ...
    EVT_THREAD
        EVT_LOOP(7)
            ...
            EVT_ADD(LVar2, 200)
            EVT_ADD(LVar3, LVar5)
            EVT_CALL(PlayEffect, EFFECT_SHATTERING_STONES, 0, LVar1, LVar2, LVar3, 0, 0, 0, 0, 0, 0, 0, 0, 0)
...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(ModifyColliderFlags, 0, COLLIDER_dai, COLLIDER_FLAGS_UPPER_MASK)
