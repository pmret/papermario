...
EvtScript N(EVS_NpcAI_KoopaBros_01) = {
    ...
    EVT_WAIT(10 * DT)
    EVT_CALL(SetNpcFoldParams, NPC_KoopaBros_01, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_STARTLE, 2, 1, 0)
    EVT_CALL(SetNpcAnimation, NPC_KoopaBros_01, ANIM_KoopaBros_Black_Anim1E)
    EVT_WAIT(12 * DT)
    EVT_CALL(SetNpcFoldParams, NPC_KoopaBros_01, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
