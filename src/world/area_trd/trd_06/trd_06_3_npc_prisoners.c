...
EvtScript N(EVS_NpcInteract_Bombette) = {
    EVT_THREAD
        EVT_CALL(AdjustCam, CAM_DEFAULT, EVT_FLOAT(5.0), 0, EVT_FLOAT(300.0), EVT_FLOAT(18.0), EVT_FLOAT(-7.0))
    EVT_END_THREAD
...
EvtScript N(EVS_NpcIdle_KoopaTroopa) = {
    ...
    EVT_THREAD
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(20)
        EVT_END_IF
        EVT_CALL(PlaySoundAtCollider, COLLIDER_ttw, SOUND_METAL_DOOR_CLOSE, 0)
    EVT_END_THREAD
    EVT_THREAD
...
StaticNpc N(NpcData_Jailers)[] = {
    {
        ...
        .yaw = 0,
        .flags = ENEMY_FLAGS_1 | ENEMY_FLAGS_800 | ENEMY_FLAGS_40000,
