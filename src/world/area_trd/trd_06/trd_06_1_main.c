...
EvtScript N(EVS_BombWall_Cell) = {
    ...
    EVT_THREAD
        ...
        EVT_IF_LT(LVar0, 110)
            EVT_IF_LT(LVar2, 140)
                EVT_WAIT(25)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_01, NPC_FLAG_100, TRUE)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_02, NPC_FLAG_100, TRUE)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_03, NPC_FLAG_100, TRUE)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_04, NPC_FLAG_100, TRUE)
                EVT_CALL(SetPlayerSpeed, EVT_FLOAT(3.0))
                EVT_CALL(PlayerMoveTo, 110, 140, 0)
                EVT_CALL(PlayerFaceNpc, NPC_PARTNER, FALSE)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_01, NPC_FLAG_100, FALSE)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_02, NPC_FLAG_100, FALSE)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_03, NPC_FLAG_100, FALSE)
                EVT_CALL(SetNpcFlagBits, NPC_Bombomb_04, NPC_FLAG_100, FALSE)
            EVT_END_IF
        EVT_END_IF
    EVT_END_THREAD
    EVT_CALL(DisablePartnerAI, 0)
