...
EvtScript N(EVS_BombWall_Cell) = {
    EVT_CALL(SetPlayerFlagBits, PS_FLAGS_CANT_CHANGE_PARTNER | PS_FLAGS_CANT_USE_PARTNER, TRUE)
    ...
    EVT_CALL(SetPlayerFlagBits, PS_FLAGS_CANT_CHANGE_PARTNER | PS_FLAGS_CANT_USE_PARTNER, FALSE)
