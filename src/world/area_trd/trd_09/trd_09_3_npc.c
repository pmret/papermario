...
EvtScript N(EVS_NpcAI_KoopaBros_Red) = {
    ...
    EVT_CALL(NpcJump0, NPC_SELF, 1440, 30, 0, 20)
    EVT_CALL(NpcJump0, NPC_SELF, 1380, 0, 0, 20)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_KoopaBros_Red_Anim03)
...
EvtScript N(EVS_NpcAI_KoopaBros_Black) = {
    ...
    EVT_CALL(NpcJump0, NPC_SELF, 1470, 30, 30, 20)
    EVT_CALL(NpcJump0, NPC_SELF, 1410, 0, 40, 20)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_KoopaBros_Black_Anim03)
...
EvtScript N(EVS_NpcAI_KoopaBros_Yellow) = {
    ...
    EVT_CALL(NpcJump0, NPC_SELF, 1455, 30, 5, 20)
    EVT_CALL(NpcJump0, NPC_SELF, 1395, 0, 5, 20)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_KoopaBros_Yellow_Anim03)
...
EvtScript N(EVS_NpcAI_KoopaBros_Green) = {
    ...
    EVT_CALL(NpcJump0, NPC_SELF, 1440, 30, -20, 20)
    EVT_CALL(NpcJump0, NPC_SELF, 1380, 0, -30, 20)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_KoopaBros_Green_Anim03)
...
EvtScript N(EVS_NpcAI_BulletBill) = {
    ...
    EVT_LABEL(1)
        ...
        EVT_CALL(func_80045838, -1, 808, 0x00200000)
        EVT_SET(LVarA, LVar1)
        EVT_SUB(LVarA, 10)
        EVT_SET(LVarB, LVar2)
        EVT_ADD(LVarB, 5)
        ...
        EVT_END_SWITCH
        EVT_CALL(func_80045838, -1, 0xB0000018, 0)
...
NpcGroupList N(DefaultNPCs) = {
    ...
    NPC_GROUP(N(NpcData_BulletBill_01), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_02), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_03), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_04), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_05), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_06), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_07), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_08), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_09), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_10), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
...
NpcGroupList N(DemoNPCs) = {
    NPC_GROUP(N(NpcData_BulletBill_Demo1), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_Demo2), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_Demo3), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_Demo4), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    NPC_GROUP(N(NpcData_BulletBill_Demo5), BTL_TRD_PART_1_FORMATION_1A, BTL_TRD_PART_1_STAGE_06),
    {}
};
