...
EvtScript N(EVS_Scene_RaiseStairs) = {
    ...
    EVT_WAIT(10)
    EVT_CALL(ModifyColliderFlags, 0, COLLIDER_o162, COLLIDER_FLAGS_UPPER_MASK)
    ...
    EVT_THREAD
        EVT_WAIT(20)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaTroopa_02, SOUND_263, 0)
        EVT_CALL(ShowEmote, NPC_KoopaTroopa_02, EMOTE_QUESTION, 0, 20, TRUE, 0, 0, 0, 0)
        EVT_WAIT(120)
        EVT_CALL(SetNpcAnimation, NPC_KoopaTroopa_02, ANIM_KoopaTroopa_Anim08)
        EVT_WAIT(20)
        EVT_CALL(SetNpcAnimation, NPC_KoopaTroopa_02, ANIM_KoopaTroopa_Anim17)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaTroopa_02, SOUND_262, 0)
        EVT_CALL(ShowEmote, NPC_KoopaTroopa_02, EMOTE_EXCLAMATION, 0, 15, TRUE, 0, 0, 0, 0)
        EVT_LOOP(4)
    ...
    EVT_THREAD
        EVT_WAIT(25)
        EVT_CALL(ShowEmote, NPC_KoopaTroopa_03, EMOTE_QUESTION, 0, 20, TRUE, 0, 0, 0, 0)
        EVT_WAIT(120)
        EVT_CALL(SetNpcAnimation, NPC_KoopaTroopa_03, ANIM_KoopaTroopa_Anim08)
        EVT_WAIT(20)
        EVT_CALL(SetNpcAnimation, NPC_KoopaTroopa_03, ANIM_KoopaTroopa_Anim17)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaTroopa_03, SOUND_262, 0)
        EVT_CALL(ShowEmote, NPC_KoopaTroopa_03, EMOTE_EXCLAMATION, 0, 15, TRUE, 0, 0, 0, 0)
        EVT_LOOP(4)
    ...
    EVT_ADD(LVar2, 325)
    EVT_IF_GE(LVar2, -20)
        EVT_IF_EQ(LocalFlag(3), FALSE)
            EVT_SET(LocalFlag(3), TRUE)
            EVT_CALL(PlaySound, SOUND_23)
    ...
    EVT_ADD(LVar2, 299)
    EVT_IF_GE(LVar2, -20)
        EVT_IF_EQ(LocalFlag(4), FALSE)
            EVT_SET(LocalFlag(4), TRUE)
            EVT_CALL(PlaySound, SOUND_23)
    ...
    EVT_ADD(LVar2, 273)
    EVT_IF_GE(LVar2, -20)
        EVT_IF_EQ(LocalFlag(5), FALSE)
            EVT_SET(LocalFlag(5), TRUE)
            EVT_CALL(PlaySound, SOUND_23)
    ...
    EVT_ADD(LVar2, 245)
    EVT_IF_GE(LVar2, -20)
        EVT_IF_EQ(LocalFlag(6), FALSE)
            EVT_SET(LocalFlag(6), TRUE)
            EVT_CALL(PlaySound, SOUND_23)
    ...
    EVT_ADD(LVar2, 220)
    EVT_IF_GE(LVar2, -20)
        EVT_IF_EQ(LocalFlag(7), FALSE)
            EVT_SET(LocalFlag(7), TRUE)
            EVT_CALL(PlaySound, SOUND_23)
