...
EvtScript N(EVS_Scene_RaiseStairs) = {
    ...
    EVT_THREAD
        EVT_WAIT(20 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaTroopa_02, SOUND_0263, SOUND_SPACE_DEFAULT)
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaTroopa_02, SOUND_0262, SOUND_SPACE_DEFAULT)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaTroopa_03, SOUND_0262, SOUND_SPACE_DEFAULT)
