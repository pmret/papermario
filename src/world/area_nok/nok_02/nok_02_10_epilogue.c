...
EvtScript N(D_802543B0_9EB3D0) = {
    ...
    EVT_WAIT(15)
    EVT_CALL(SetNpcAnimation, NPC_KoloradoWife_01, ANIM_KoloradoWife_Walk)
    EVT_CALL(NpcMoveTo, NPC_KoloradoWife_01, -80, -50, 30)
    EVT_CALL(SetNpcAnimation, NPC_KoloradoWife_01, ANIM_KoloradoWife_Idle)
    EVT_CALL(SetCamSpeed, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_CALL(SetPanTarget, CAM_DEFAULT, -53, LVar1, LVar2)
    EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_CALL(InterpNpcYaw, NPC_Parakarry, 270, 0)
    EVT_WAIT(15)
    EVT_CALL(SetNpcAnimation, NPC_KoloradoWife_01, ANIM_KoloradoWife_Talk)
    EVT_WAIT(45)
