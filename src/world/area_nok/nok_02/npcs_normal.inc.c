...
EvtScript N(EVS_Dueling_Bobombs) = {
    EVT_LABEL(10)
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_Bobomb_02, SOUND_BOMBETTE_BLAST_LV1, SOUND_SPACE_MODE_0)
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_Bobomb_01, SOUND_BOMBETTE_BLAST_LV1, SOUND_SPACE_MODE_0)
        EVT_CALL(N(SpawnExplosionEffect), LVar0, LVar1, LVar2)
        EVT_WAIT(30)
        EVT_GOTO(10)
    EVT_RETURN
