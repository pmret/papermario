...
EvtScript N(EVS_FuzzyBoss_PlayerEntersKoopersHouse) = {
    ...
    EVT_LABEL(10)
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_FuzzyBoss, SOUND_SRAW_17_A, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_NpcIdle_MiscFuzzy1) = {
    ...
    EVT_LABEL(0)
        ...
        EVT_LOOP(18)
            ...
            EVT_ADD(LVar3, 15)
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SRAW_17_B, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_NpcIdle_MiscFuzzy2) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SRAW_17_C, SOUND_SPACE_DEFAULT)
