...
EvtScript N(EVS_FuzzyBoss_PlayerEntersKoopersHouse) = {
    ...
    EVT_LABEL(10)
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_FuzzyBoss, SOUND_SRAW_17_A, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_NpcIdle_MiscFuzzy1) = {
    ...
    EVT_LABEL(0)
        ...
        EVT_LOOP(18)
            ...
            EVT_ADD(LVar3, 15)
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SRAW_17_B, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_NpcIdle_MiscFuzzy2) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SRAW_17_C, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_BreakBlock_DropShell) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_KoopaShell_02, SOUND_ITEM_BOUNCE, SOUND_SPACE_MODE_0)
...
NpcData N(NpcData_Fuzzy_01) = {
    ...
    .settings = &N(NpcSettings_Fuzzy),
    .flags = ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_PLAYER_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_100000 | ENEMY_FLAG_ACTIVE_WHILE_OFFSCREEN | ENEMY_FLAG_400000 | ENEMY_FLAG_IGNORE_TOUCH | ENEMY_FLAG_IGNORE_PARTNER,
    .drops = NO_DROPS,
    .animations = FUZZY_ANIMS,
};
