...
EvtScript N(EVS_FuzzyBoss_PlayerEntersKoopersHouse) = {
    ...
    EVT_LABEL(10)
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_FuzzyBoss, SOUND_LRAW_331, 0)
...
EvtScript N(EVS_NpcIdle_MiscFuzzy1) = {
    ...
    EVT_LABEL(0)
        ...
        EVT_LOOP(18)
            ...
            EVT_ADD(LVar3, 15)
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_LRAW_332, 0)
...
EvtScript N(EVS_NpcIdle_MiscFuzzy2) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_LRAW_333, 0)
...
EvtScript N(EVS_BreakBlock_DropShell) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_KoopaShell_02, SOUND_LRAW_21A, 0)
