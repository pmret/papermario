...
EvtScript N(EVS_Scene_RecoverTreeShell) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_KoopaShell_03, SOUND_021A, 0)
...
EvtScript N(EVS_Scene_KooverGetsMugged) = {
    ...
    EVT_END_THREAD
    EVT_CALL(PlaySoundAtNpc, NPC_FuzzyWithShell, SOUND_SRAW_17_A, 0)
...
EvtScript N(EVS_NpcIdle_Koover_Crisis) = {
    ...
    EVT_IF_LT(GB_StoryProgress, STORY_CH1_ARRIVED_AT_KOOPA_VILLAGE)
        ...
        EVT_SUB(LVar0, 5)
        EVT_ADD(LVar1, 35)
        EVT_CALL(PlaySoundAtNpc, NPC_Koover, SOUND_0262, 0)
