...
EvtScript N(EVS_Scene_RecoverTreeShell) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_KoopaShell_03, SOUND_LRAW_21A, 0)
...
EvtScript N(EVS_Scene_RecoverBlockShell) = {
    ...
    EVT_CALL(PlaySound, SOUND_LRAW_21A)
...
EvtScript N(EVS_Scene_KooverGetsMugged) = {
    ...
    EVT_END_THREAD
    EVT_CALL(PlaySoundAtNpc, NPC_FuzzyWithShell, SOUND_LRAW_331, 0)
