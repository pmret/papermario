...
EvtScript N(EVS_Scene_BuildBridge) = {
    ...
    EVT_WAIT(15)
    EVT_CALL(PlaySoundAt, SOUND_NOK_BRIDGE_THUD_1, 0, -275, 0, -39)
    ...
    EVT_END_LOOP
    EVT_WAIT(15)
    EVT_CALL(PlaySoundAt, SOUND_NOK_BRIDGE_THUD_2, 0, -275, 0, -39)
    ...
    EVT_END_IF
    EVT_WAIT(10)
    EVT_CALL(PlaySoundAt, SOUND_NOK_BRIDGE_THUD_3, 0, -275, 0, -39)
    EVT_CALL(MakeLerp, 0, 90, 10, EASING_QUADRATIC_IN)
    EVT_LABEL(30)
    EVT_CALL(UpdateLerp)
    EVT_CALL(TranslateModel, MODEL_o91, 0, -80, 0)
