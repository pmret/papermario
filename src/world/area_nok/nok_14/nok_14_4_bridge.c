...
EvtScript N(EVS_Scene_BuildBridge) = {
    ...
    EVT_CALL(PlaySoundAt, SOUND_0071, SOUND_SPACE_MODE_0, 0, 0, -60)
    ...
    EVT_END_LOOP
    EVT_WAIT(15)
    EVT_CALL(PlaySoundAt, SOUND_0067, SOUND_SPACE_MODE_0, -84, 0, -60)
    EVT_THREAD
    ...
    EVT_END_THREAD
    EVT_WAIT(3)
    EVT_CALL(PlaySoundAt, SOUND_0068, SOUND_SPACE_MODE_0, -56, 0, -60)
    EVT_THREAD
    ...
    EVT_END_THREAD
    EVT_WAIT(3)
    EVT_CALL(PlaySoundAt, SOUND_0069, SOUND_SPACE_MODE_0, -28, 0, -60)
    EVT_THREAD
        EVT_CALL(MakeLerp, 0, 90, 8, EASING_LINEAR)
        EVT_LABEL(21)
            EVT_CALL(UpdateLerp)
    ...
    EVT_END_THREAD
    EVT_WAIT(3)
    EVT_CALL(PlaySoundAt, SOUND_006A, SOUND_SPACE_MODE_0, 0, 0, -60)
    EVT_THREAD
        EVT_CALL(MakeLerp, 0, 90, 8, EASING_LINEAR)
        EVT_LABEL(25)
            EVT_CALL(UpdateLerp)
    ...
    EVT_END_THREAD
    EVT_WAIT(3)
    EVT_CALL(PlaySoundAt, SOUND_006B, SOUND_SPACE_MODE_0, 28, 0, -60)
    EVT_THREAD
        EVT_CALL(MakeLerp, 0, 90, 8, EASING_LINEAR)
        EVT_LABEL(22)
            EVT_CALL(UpdateLerp)
    ...
    EVT_END_THREAD
    EVT_WAIT(3)
    EVT_CALL(PlaySoundAt, SOUND_006C, SOUND_SPACE_MODE_0, 56, 0, -60)
    EVT_THREAD
        EVT_CALL(MakeLerp, 0, 90, 8, EASING_LINEAR)
        EVT_LABEL(26)
            EVT_CALL(UpdateLerp)
    ...
    EVT_END_THREAD
    EVT_WAIT(3)
    EVT_CALL(PlaySoundAt, SOUND_006D, SOUND_SPACE_MODE_0, 84, 0, -60)
    EVT_THREAD
        EVT_CALL(MakeLerp, 0, 90, 8, EASING_LINEAR)
        EVT_LABEL(23)
            EVT_CALL(UpdateLerp)
