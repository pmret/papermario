...
EvtScript N(EVS_BossJumpTo) = {
    EVT_CALL(PlaySoundAtNpc, NPC_BossFuzzy, SOUND_PAIR_17, 0)
...
EvtScript N(EVS_Scene_ShuffleFuzzyPositions) = {
    ...
    EVT_LOOP(LVarE)
        ...
        EVT_CALL(PlaySound, SOUND_PAIR_17)
        EVT_THREAD
...
EvtScript N(EVS_Unused_RandomlyReveal) = {
    ...
    EVT_LABEL(0)
        ...
        EVT_ADD(LVar3, 20)
        EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_PAIR_17, 0)
...
EvtScript N(EVS_Scene_KooperArrives) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_Fuzzy_01, SOUND_PAIR_17, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_Fuzzy_02, SOUND_PAIR_17, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_Fuzzy_03, SOUND_PAIR_17, 0)
...
EvtScript N(EVS_HitTree_Wrong) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_LT(1000)
            ...
            EVT_ADD(LVar2, 10)
            EVT_ADD(LVar1, 10)
            EVT_CALL(PlaySoundAtNpc, NPC_AmbushFuzzy, SOUND_PAIR_17, 0)
