...
EvtScript N(EVS_Main) = {
    ...
    EVT_SET(AF_NOK_04, FALSE)
    EVT_CALL(ModifyColliderFlags, MODIFY_COLLIDER_FLAGS_SET_BITS, COLLIDER_o147, COLLIDER_FLAGS_UPPER_MASK)
    EVT_CALL(MakeNpcs, FALSE, EVT_PTR(N(DefaultNPCs)))
    EVT_EXEC_WAIT(N(EVS_MakeEntities))
    EVT_SET(LVar0, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_80245BD8)), TRIGGER_WALL_HAMMER, COLLIDER_o59, 1, 0)
    EVT_SET(LVar0, 1)
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_80245BD8)), TRIGGER_WALL_HAMMER, COLLIDER_o58, 1, 0)
    EVT_SET(LVar0, 2)
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_80245BD8)), TRIGGER_WALL_HAMMER, COLLIDER_o57, 1, 0)
    EVT_SET(LVar0, 3)
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_80245BD8)), TRIGGER_WALL_HAMMER, COLLIDER_o56, 1, 0)
