...
void N(draw_score_display)(void) {
   ...
   if (scorekeeper->varTable[3] == 0 || scorekeeper->varTable[3] >= 4) {
    ...
    draw_msg(MESSAGE_ID(0x8,0x47), data->windowA_posX + 42, 28, 255, 0, 0);
    draw_number(NUM_PANELS - data->found, data->windowA_posX + 65, 43, 1, 0, 255, 3);
    ...
    // draw dot
    draw_msg(MESSAGE_ID(0x8,0x24), data->windowB_posX + 30, 29, 255, 0, 0);
}
