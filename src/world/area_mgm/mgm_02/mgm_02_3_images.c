...
INCLUDE_IMG("world/area_mgm/mgm_02/panel_peach.png.bin", mgm_02_panel_peach_img);
INCLUDE_PAL("world/area_mgm/mgm_02/panel_peach.pal.bin", mgm_02_panel_peach_pal);
