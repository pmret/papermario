...
ApiStatus func_80240000_E12760(Evt* script, s32 isInitialCall) {
    ...
    evt_set_float_variable(script, LocalVar(0), spotLightPosX);
    evt_set_float_variable(script, LocalVar(1), spotLightPosZ);
    evt_set_float_variable(script, LocalVar(2), lightBeamRotX);
    evt_set_float_variable(script, LocalVar(3), lightBeamRotZ);
