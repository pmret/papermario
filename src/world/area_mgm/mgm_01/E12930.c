...
void func_802401D0_E12930(void) {
    Enemy* scorekeeper = get_enemy(JUMP_DATA_ENEMY_IDX);
    ...
    if (data->scoreWindowPosX < 321) {
        ...
        if (data->currentScore > data->targetScore) {
            ...
            sfx_play_sound_with_params(0x211, 0U, 0x40U, 0x32);
...
ApiStatus func_8024045C_E12BBC(Evt* script, s32 isInitialCall) {
    JumpGameData* data = (JumpGameData*)get_enemy(JUMP_DATA_ENEMY_IDX)->varTable[JUMP_DATA_VAR_IDX];
...
ApiStatus func_80240F90_E136F0(Evt* script, s32 isInitialCall) {
    JumpGameData* data = (JumpGameData*)get_enemy(0)->varTable[5];
    s32 i; 
...
ApiStatus func_80241574_E13CD4(Evt* script, s32 isInitialCall) {
    JumpGameData* data = get_enemy(JUMP_DATA_ENEMY_IDX)->varTable[JUMP_DATA_VAR_IDX];
    s32 i;
