...
ApiStatus func_802BD338_318088(Evt* script, s32 isInitialCall) {
    ...
    switch (BombetteTweesterPhysicsPtr->state) {
        case 0:
            ...
            bombette->flags |= NPC_FLAG_40000 | NPC_FLAG_100 | NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_ENABLE_HIT_SCRIPT;
...
ApiStatus func_802BD758_3184A8(Evt *evt, s32 isInitialCall) {
    ...
    switch (evt->functionTemp[0]) {
        case 20:
            ...
            D_802BE930 = 0;
            D_802BE934 = 0;
            npc->flags &= ~(NPC_FLAG_JUMPING | NPC_FLAG_GRAVITY | NPC_FLAG_IGNORE_WORLD_COLLISION | NPC_FLAG_ENABLE_HIT_SCRIPT);
