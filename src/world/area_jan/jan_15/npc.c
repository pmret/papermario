...
EvtScript N(EVS_PutridPiranhas_IdleChomping) = {
    ChildThread
        Loop(0)
            ...
            IfNe(LVar0, 0)
                ...
                Wait(15)
            Else
                Call(SetNpcAnimation, NPC_SELF, ANIM_LargePiranha_Putrid_Windup)
                Wait(10)
                Call(SetNpcAnimation, NPC_SELF, ANIM_LargePiranha_Putrid_Bite)
                Wait(5)
            EndIf
        EndLoop
    EndChildThread
    ...
    Loop(0)
        Call(RandInt, 5, LVar0)
        IfNe(LVar0, 0)
            Call(SetNpcAnimation, NPC_PutridPiranha_03, ANIM_LargePiranha_Putrid_Idle)
            Wait(15)
        Else
            Call(SetNpcAnimation, NPC_PutridPiranha_03, ANIM_LargePiranha_Putrid_Windup)
            Wait(10)
            Call(SetNpcAnimation, NPC_PutridPiranha_03, ANIM_LargePiranha_Putrid_Bite)
            Wait(5)
        EndIf
    EndLoop
    Return
...
EvtScript N(EVS_NpcIdle_PutridPiranha) = {
    ...
    Thread
        Wait(10)
        Call(SetNpcAnimation, NPC_PutridPiranha_03, ANIM_LargePiranha_Putrid_Talk)
        Set(LVar0, 0)
        Loop(15)
            Add(LVar0, 24)
