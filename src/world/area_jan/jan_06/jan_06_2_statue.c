...
EvtScript N(EVS_Scene_MoveStatue) = {
    EVT_CALL(PlaySound, SOUND_80000018)
    EVT_EXEC_WAIT(N(EVS_MoveStatue))
    EVT_CALL(GetModelCenter, MODEL_o162)
    EVT_CALL(PlaySoundAt, SOUND_80000010, 0, LVar0, LVar1, LVar2)
    ...
    EVT_CALL(StopSound, SOUND_80000018)
...
EvtScript N(ItemPrompt_Statue) = {
    ...
    EVT_CALL(CloseChoicePopup)
    EVT_CALL(SetTimeFreezeMode, TIME_FREEZE_NORMAL)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_60006 | SPRITE_ID_BACK_FACING)
    EVT_WAIT(20)
