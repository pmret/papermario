...
EvtScript N(D_8024202C_B861AC) = {
    EVT_IF_LT(GB_StoryProgress, STORY_CH5_ZIP_LINE_READY)
        EVT_CALL(SetGroupEnabled, MODEL_g39, 0)
        EVT_CALL(SetGroupEnabled, MODEL_g52, 0)
        EVT_CALL(SetGroupEnabled, MODEL_g58, 0)
    ...
    EVT_END_IF
    EVT_IF_GE(GB_StoryProgress, STORY_CH5_RAFAEL_WAITING_FOR_MARIO)
...
EvtScript N(EVS_Main) = {
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(STORY_CH5_RAFAEL_MOVED_ROOT)
