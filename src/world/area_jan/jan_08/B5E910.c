...
/*
ApiStatus N(func_8024067C_B5E92C)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_8024069C_B5E94C)(ScriptInstance* script, s32 isInitialCall) {
    func_800EB168(get_variable(script, *script->ptrReadPos));
    return ApiStatus_DONE2;
}
*/

INCLUDE_ASM(s32, "world/area_jan/jan_08/B5E910", func_802406C8_B5E978);
/*
ApiStatus N(func_802406C8_B5E978)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_jan/jan_08/B5E910", func_80240734_B5E9E4);

INCLUDE_ASM(s32, "world/area_jan/jan_08/B5E910", func_80240780_B5EA30);
/*
ApiStatus N(func_80240780_B5EA30)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
INCLUDE_ASM(s32, "world/area_jan/jan_08/B5E910", func_80240AA8_B5ED58);
/*
ApiStatus N(func_80240AA8_B5ED58)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240AE0_B5ED90)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
/*
ApiStatus N(func_80240B70_B5EE20)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240BA4_B5EE54)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240C08_B5EEB8)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240C60_B5EF10)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    Npc* npc = get_npc_safe(-4);
