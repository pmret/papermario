...
EvtScript N(EVS_NpcInteract_RaphaelRaven_Before) = {
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, -250)
        EVT_ADD(LVar2, 63)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_01, SOUND_SRAW_14_A, 0)
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, -250)
        EVT_ADD(LVar2, 63)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_02, SOUND_SRAW_14_B, 0)
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, -250)
        EVT_ADD(LVar2, 50)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_03, SOUND_SRAW_14_C, 0)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Raven_05, SOUND_SRAW_14_B, 0)
    ...
    EVT_THREAD
        ...
        EVT_WAIT(15 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SRAW_14_A, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_01, SOUND_SRAW_14_B, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_02, SOUND_SRAW_14_C, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_03, SOUND_SRAW_14_A, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_04, SOUND_SRAW_14_B, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(45 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_05, SOUND_SRAW_14_C, 0)
    EVT_END_THREAD
