...
EvtScript N(EVS_NpcInteract_RaphaelRaven_Before) = {
    ...
    EVT_LOOP(5)
        EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_0386, 0)
        EVT_CALL(SetCamDistance, CAM_DEFAULT, 310)
        EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
        EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
        EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_0387, 0)
        EVT_CALL(SetCamDistance, CAM_DEFAULT, 460)
        EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
        EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_END_LOOP
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, -250)
        EVT_ADD(LVar2, 63)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_01, SOUND_SRAW_RAVEN_FALL_A, 0)
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, -250)
        EVT_ADD(LVar2, 63)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_02, SOUND_SRAW_RAVEN_FALL_B, 0)
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, -250)
        EVT_ADD(LVar2, 50)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_03, SOUND_SRAW_RAVEN_FALL_C, 0)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Raven_05, SOUND_SRAW_RAVEN_FALL_B, 0)
    ...
    EVT_THREAD
        ...
        EVT_WAIT(15 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SRAW_RAVEN_FALL_A, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_01, SOUND_SRAW_RAVEN_FALL_B, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_02, SOUND_SRAW_RAVEN_FALL_C, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_03, SOUND_SRAW_RAVEN_FALL_A, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(35 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_04, SOUND_SRAW_RAVEN_FALL_B, 0)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_THREAD
        EVT_WAIT(45 * DT)
        EVT_CALL(PlaySoundAtNpc, NPC_Raven_05, SOUND_SRAW_RAVEN_FALL_C, 0)
    EVT_END_THREAD
