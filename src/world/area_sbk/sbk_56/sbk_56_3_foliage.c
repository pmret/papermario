...
FoliageModelList N(Tree10_LeafModels) = {
    .count = 1,
    .models = {
        MODEL_o64,
    }
...
FoliageModelList N(Tree10_TrunkModels) = {
    .count = 1,
    .models = {
        MODEL_o63,
    }
...
EvtScript N(EVS_SetupFoliage) = {
    EVT_SET(GF_SBK56_Tree1_Lemon, FALSE)
    EVT_SET(GF_SBK56_UnusedA, FALSE)
    EVT_SET(GF_SBK56_Tree2_Lime, FALSE)
    EVT_SET(GF_SBK56_UnusedB, FALSE)
    EVT_SET(LVar0, EVT_PTR(N(ShakeTree_Tree1)))
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_remon, 1, 0)
    ...
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_rim, 1, 0)
    ...
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_y_miki, 1, 0)
    ...
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_o67, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_POINT_BOMB, EVT_PTR(N(BombPos_Tree4)), 1, 0)
    EVT_SET(LVar0, EVT_PTR(N(ShakeTree_Tree5)))
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_o68, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_POINT_BOMB, EVT_PTR(N(BombPos_Tree5)), 1, 0)
    EVT_SET(LVar0, EVT_PTR(N(ShakeTree_Tree6)))
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_o69, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_POINT_BOMB, EVT_PTR(N(BombPos_Tree6)), 1, 0)
    EVT_SET(LVar0, EVT_PTR(N(ShakeTree_Tree7)))
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_o70, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_POINT_BOMB, EVT_PTR(N(BombPos_Tree7)), 1, 0)
    EVT_SET(LVar0, EVT_PTR(N(ShakeTree_Tree8)))
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_o71, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_POINT_BOMB, EVT_PTR(N(BombPos_Tree8)), 1, 0)
    EVT_SET(LVar0, EVT_PTR(N(ShakeTree_Tree9)))
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_o72, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_POINT_BOMB, EVT_PTR(N(BombPos_Tree9)), 1, 0)
    EVT_SET(LVar0, EVT_PTR(N(ShakeTree_Tree10)))
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_WALL_HAMMER, COLLIDER_o73, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(shakeTree)), TRIGGER_POINT_BOMB, EVT_PTR(N(BombPos_Tree10)), 1, 0)
    EVT_RETURN
    EVT_END
};
