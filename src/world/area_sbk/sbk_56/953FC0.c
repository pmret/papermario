...
/*
ApiStatus N(func_8024009C_95405C)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_sbk/sbk_56/953FC0", func_802400E8_9540A8);
/*
ApiStatus N(func_802400E8_9540A8)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_sbk/sbk_56/953FC0", func_802401A0_954160);
/*
ApiStatus N(func_802401A0_954160)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
INCLUDE_ASM(s32, "world/area_sbk/sbk_56/953FC0", func_802404C8_954488);
/*
ApiStatus N(func_802404C8_954488)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240500_9544C0)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
INCLUDE_ASM(s32, "world/area_sbk/sbk_56/953FC0", func_80240590_954550);
/*
ApiStatus N(func_80240590_954550)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240628_9545E8)(ScriptInstance *script, s32 isInitialCall) {
...
/*
s32 N(func_80240BB8_954B78)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
