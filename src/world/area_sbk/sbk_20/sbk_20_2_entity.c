    ...
    EVT_SWITCH(MV_BlockHitCounter)
        EVT_CASE_EQ(1)
            EVT_IF_EQ(GF_SBK20_ItemBlock_Mushroom, FALSE)
                ...
                EVT_CALL(PlaySoundAt, SOUND_SPAWN_BLOCK, SOUND_SPACE_DEFAULT, -80, 60, -200)
        ...
        EVT_CASE_EQ(10)
            EVT_IF_EQ(GF_SBK20_ItemBlock_SuperShroom, FALSE)
                EVT_CALL(PlaySound, SOUND_CHIME_SOLVED_PUZZLE)
                EVT_CALL(PlaySoundAt, SOUND_SPAWN_BLOCK, SOUND_SPACE_DEFAULT, -180, 60, -200)
        ...
        EVT_CASE_EQ(100)
            EVT_IF_EQ(GF_SBK20_ItemBlock_UltraShroom, FALSE)
                EVT_CALL(PlaySound, SOUND_CHIME_SOLVED_PUZZLE)
                EVT_CALL(PlaySoundAt, SOUND_SPAWN_BLOCK, SOUND_SPACE_DEFAULT, -130, 60, -150)
