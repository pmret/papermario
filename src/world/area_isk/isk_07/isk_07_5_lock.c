...
EvtScript N(EVS_UnlockPrompt_RuinsDoor) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(-1)
            ...
            EVT_RETURN
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAt, SOUND_0269, SOUND_SPACE_DEFAULT, -300, -380, 530)
...
EvtScript N(EVS_ShutEntryDoor) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_deilitte, SOUND_0266, SOUND_SPACE_DEFAULT)
    ...
    EVT_LABEL(10)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(10)
        EVT_END_IF
    EVT_CALL(PlaySoundAtCollider, COLLIDER_deilitte, SOUND_0267, SOUND_SPACE_DEFAULT)
