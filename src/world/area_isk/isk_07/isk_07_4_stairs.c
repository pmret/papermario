...
EvtScript N(EVS_RedStairs_FlipCCW) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o2000, SOUND_LOOP_02, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_RedStairs_FlipCW) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o1994, SOUND_LOOP_02, SOUND_SPACE_DEFAULT)
