...
EvtScript N(EVS_Scene_TutankoopaAppears) = {
    ...
    EVT_END_THREAD
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_02, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
    ...
    EVT_LABEL(2)
    EVT_CALL(UpdateLerp)
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_02, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
    EVT_WAIT(1)
    EVT_IF_EQ(LVar1, 1)
        EVT_GOTO(2)
    EVT_END_IF
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_02, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_WAIT(30 * DT)
    EVT_SET(LVar0, 255)
    EVT_LOOP(60 * DT)
#if VERSION_PAL
    ...
    EVT_END_THREAD
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_01, IMGFX_UPD_SET_ALPHA, 255, 0, 0, 0)
    EVT_CALL(SetNpcImgfxFlags, NPC_Tutankoopa_01, IMGFX_STATE_FLAG_800)
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_01, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_TUTANKOOPA_SWIRL_1, 2, 1, 0)
    EVT_WAIT(39)
    EVT_CALL(SetNpcImgfxFlags, NPC_Tutankoopa_01, IMGFX_STATE_FLAG_800)
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_01, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_TUTANKOOPA_SWIRL_2, 2, 1, 0)
    EVT_WAIT(39)
    EVT_CALL(SetNpcImgfxFlags, NPC_Tutankoopa_01, IMGFX_STATE_FLAG_800)
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_01, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_TUTANKOOPA_GATHER, 2, 1, 0)
    EVT_WAIT(55)
    EVT_CALL(SetNpcImgfxParams, NPC_Tutankoopa_01, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
