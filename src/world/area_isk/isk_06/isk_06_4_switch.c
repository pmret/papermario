...
EvtScript N(EVS_OnTouch_DrainSwitch) = {
    ...
    EVT_IF_LT(LVar1, -80)
        ...
        EVT_END_THREAD
    EVT_END_IF
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o2091, SOUND_FLOOR_SWITCH_DEPRESS, SOUND_SPACE_DEFAULT)
    ...
    EVT_IF_EQ(LVar1, 1)
        EVT_GOTO(10)
    EVT_END_IF
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o2091, SOUND_FLOOR_SWITCH_ACTIVATE, SOUND_SPACE_DEFAULT)
