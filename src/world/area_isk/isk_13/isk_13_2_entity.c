...
EvtScript N(EVS_MakeEntities) = {
    ...
    EVT_PLAY_EFFECT(EFFECT_FLAME, 1, 415, -583, -291, EVT_FLOAT(0.3), LVar0)
    EVT_PLAY_EFFECT(EFFECT_FLAME, 1, 489, -453, -131, EVT_FLOAT(0.3), LVar0)
    EVT_PLAY_EFFECT(EFFECT_FLAME, 1, 489, -583, -131, EVT_FLOAT(0.3), LVar0)
    EVT_RETURN
    EVT_END
};
