...
EvtScript N(EVS_OnTouch_DrainSwitch) = {
    ...
    EVT_IF_LT(LVar1, -470)
        ...
        EVT_END_THREAD
    EVT_END_IF
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o2059, SOUND_208A, 0)
    ...
    EVT_IF_EQ(LVar1, 1)
        EVT_GOTO(10)
    EVT_END_IF
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o2059, SOUND_208B, 0)
...
EvtScript N(EVS_OnTouch_StaircaseSwitch) = {
    ...
    EVT_END_IF
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o2090, SOUND_208A, 0)
    EVT_CALL(MakeLerp, 0, -14, 30, EASING_LINEAR)
    EVT_LABEL(10)
    EVT_CALL(UpdateLerp)
    ...
    EVT_IF_EQ(LVar1, 1)
        EVT_GOTO(10)
    EVT_END_IF
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o2090, SOUND_208B, 0)
    EVT_CALL(InterpPlayerYaw, 260, 0)
    EVT_SET(AF_ISK12_StairSwitchActivated, TRUE)
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, 0, 449, -822, 148)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(20)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, 0, 449, -822, 148)
        EVT_CALL(ShakeCam, CAM_DEFAULT, 0, 3, EVT_FLOAT(0.1))
    EVT_END_THREAD
    EVT_WAIT(50)
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, 0, 460, -806, 108)
        EVT_CALL(MakeLerp, -50, 0, 60, EASING_QUADRATIC_IN)
        EVT_LABEL(22)
        EVT_CALL(UpdateLerp)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(22)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, 0, 460, -806, 108)
        EVT_CALL(ShakeCam, CAM_DEFAULT, 0, 3, EVT_FLOAT(0.1))
    EVT_END_THREAD
    EVT_WAIT(30)
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, 0, 432, -825, 189)
        EVT_CALL(MakeLerp, -50, 0, 60, EASING_QUADRATIC_IN)
        EVT_LABEL(24)
        EVT_CALL(UpdateLerp)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(24)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, 0, 432, -825, 189)
        EVT_CALL(ShakeCam, CAM_DEFAULT, 0, 3, EVT_FLOAT(0.1))
    EVT_END_THREAD
    EVT_WAIT(30)
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, 0, 451, -812, 137)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(26)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, 0, 451, -812, 137)
