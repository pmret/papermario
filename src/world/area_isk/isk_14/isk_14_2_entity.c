...
EvtScript N(EVS_MakeEntities) = {
    ...
    EVT_END_IF
    EVT_PLAY_EFFECT(EFFECT_FLAME, 1, -459, -583, -214, EVT_FLOAT(0.3), LVar0)
    EVT_PLAY_EFFECT(EFFECT_FLAME, 1, -358, -583, -358, EVT_FLOAT(0.3), LVar0)
    EVT_PLAY_EFFECT(EFFECT_FLAME, 1, -459, -713, -214, EVT_FLOAT(0.3), LVar0)
    EVT_RETURN
    EVT_END
};
