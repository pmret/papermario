...
NpcGroupList N(npcGroupList_80244740) = {
    NPC_GROUP(N(npcGroup_80243378), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80243568), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80243758), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80243948), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80243B38), BTL_NONE, BTL_DEFAULT_STAGE),
    {},
};
...
NpcGroupList N(npcGroupList_80244788) = {
    ...
    NPC_GROUP(N(npcGroup_80243948), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80243B38), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80243F80), BTL_NONE, BTL_DEFAULT_STAGE),
    {},
};
