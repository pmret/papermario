...
EvtScript N(makeEntities) = {
    EVT_CALL(MakeEntity, D_802EA564, 450, 285, 120, 0, 140, MAKE_ENTITY_END)
    EVT_CALL(AssignBlockFlag, EVT_SAVE_FLAG(1008))
    EVT_CALL(MakeEntity, D_802EA564, 720, 333, 75, 0, 343, MAKE_ENTITY_END)
    EVT_CALL(AssignBlockFlag, EVT_SAVE_FLAG(1009))
    EVT_CALL(MakeEntity, D_802EA0E8, 600, 290, 200, 0, MAKE_ENTITY_END)
