...
EvtScript N(80243FE8) = {
    ...
    EVT_THREAD
        ...
        EVT_END_IF
    EVT_END_THREAD
    EVT_CALL(SpeakToPlayer, LVar5, NPC_ANIM_world_bow_Palette_00_Anim_B, NPC_ANIM_world_bow_Palette_00_Anim_B, 0, MESSAGE_ID(0x0E, 0x00CD))
    ...
    EVT_WAIT(10)
    EVT_CALL(SpeakToPlayer, LVar5, NPC_ANIM_world_bow_Palette_00_Anim_4, NPC_ANIM_world_bow_Palette_00_Anim_1, 0, MESSAGE_ID(0x0E, 0x00CE))
    EVT_CALL(ShowChoice, MESSAGE_ID(0x1E, 0x000D))
    EVT_IF_EQ(LVar0, 0)
        EVT_CALL(ContinueSpeech, LVar5, NPC_ANIM_world_bow_Palette_00_Anim_B, NPC_ANIM_world_bow_Palette_00_Anim_B, 0, MESSAGE_ID(0x0E, 0x00CF))
    EVT_ELSE
        EVT_CALL(ContinueSpeech, LVar5, NPC_ANIM_world_bow_Palette_00_Anim_B, NPC_ANIM_world_bow_Palette_00_Anim_B, 0, MESSAGE_ID(0x0E, 0x00D0))
    EVT_END_IF
    EVT_CALL(SpeakToPlayer, LVar5, NPC_ANIM_world_bow_Palette_00_Anim_4, NPC_ANIM_world_bow_Palette_00_Anim_1, 0, MESSAGE_ID(0x0E, 0x00D1))
    ...
    EVT_THREAD
        ...
        EVT_END_IF
    EVT_END_THREAD
    EVT_CALL(SpeakToPlayer, LVar5, NPC_ANIM_world_bow_Palette_00_Anim_4, NPC_ANIM_world_bow_Palette_00_Anim_1, 0, MESSAGE_ID(0x0E, 0x00D2))
    EVT_THREAD
        EVT_IF_NE(LVar6, 9)
            EVT_WAIT(12)
            EVT_CALL(InterpNpcYaw, NPC_PARTNER, 270, 0)
