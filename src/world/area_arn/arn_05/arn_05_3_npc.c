...
EvtScript N(EVS_Scene_TubbaRaid) = {
    ...
    EVT_LOOP(20 * DT)
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Boo_01, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_CALL(SetNpcFoldParams, NPC_Boo_02, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_CALL(SetNpcFoldParams, NPC_Boo_05, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_WAIT(1)
    EVT_END_LOOP
    ...
    EVT_LOOP(20 * DT)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(SetNpcFoldParams, NPC_Boo_01, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_CALL(SetNpcFoldParams, NPC_Boo_02, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_CALL(SetNpcFoldParams, NPC_Boo_05, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_WAIT(10 * DT)
