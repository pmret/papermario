...
EvtScript N(EVS_Scene_KammyDefeated) = {
    ...
    EVT_ADD(LVar1, 15)
    EVT_CALL(PlaySoundAt, SOUND_PAIR_1E, 0, LVar0, LVar1, LVar2)
    ...
    EVT_THREAD
        ...
        EVT_CALL(GetPlayerPos, LVar0, LVar1, LVar2)
        EVT_ADD(LVar1, 20)
        EVT_CALL(PlaySoundAt, SOUND_PAIR_1F, 0, LVar0, LVar1, LVar2)
        EVT_PLAY_EFFECT(EFFECT_SPARKLES, 0, LVar0, LVar1, LVar2, 10)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(20)
    ...
    EVT_END_THREAD
    EVT_WAIT(40)
    EVT_CALL(PlaySoundAt, SOUND_PAIR_1F, 0, 110, 20, 3)
    EVT_PLAY_EFFECT(EFFECT_SPARKLES, 0, 110, 20, 3, 10)
    EVT_WAIT(6)
    EVT_CALL(PlaySoundAt, SOUND_PAIR_1F, 0, 100, 20, 3)
    EVT_PLAY_EFFECT(EFFECT_SPARKLES, 0, 100, 20, 3, 15)
    EVT_WAIT(6)
    EVT_CALL(PlaySoundAt, SOUND_PAIR_1F, 0, 90, 20, 3)
