...
EvtScript N(EVS_NpcInit_Eldstar) = {
    EVT_CALL(SetNpcFoldParams, NPC_Eldstar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Mamar) = {
    EVT_CALL(SetNpcFoldParams, NPC_Mamar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Skolar) = {
    EVT_CALL(SetNpcFoldParams, NPC_Skolar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Muskular) = {
    EVT_CALL(SetNpcFoldParams, NPC_Muskular, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Misstar) = {
    EVT_CALL(SetNpcFoldParams, NPC_Misstar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Klevar) = {
    EVT_CALL(SetNpcFoldParams, NPC_Klevar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Kalmar) = {
    EVT_CALL(SetNpcFoldParams, NPC_Kalmar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
