...
EvtScript N(EVS_NpcInit_Eldstar) = {
    EVT_CALL(SetNpcImgfxParams, NPC_Eldstar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Mamar) = {
    EVT_CALL(SetNpcImgfxParams, NPC_Mamar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Skolar) = {
    EVT_CALL(SetNpcImgfxParams, NPC_Skolar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Muskular) = {
    EVT_CALL(SetNpcImgfxParams, NPC_Muskular, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Misstar) = {
    EVT_CALL(SetNpcImgfxParams, NPC_Misstar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Klevar) = {
    EVT_CALL(SetNpcImgfxParams, NPC_Klevar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
...
EvtScript N(EVS_NpcInit_Kalmar) = {
    EVT_CALL(SetNpcImgfxParams, NPC_Kalmar, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
