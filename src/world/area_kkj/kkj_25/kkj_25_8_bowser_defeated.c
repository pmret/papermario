...
EvtScript N(EVS_Scene_BowserDefeated) = {
    ...
    EVT_CALL(PlaySound, SOUND_LRAW_022D)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Peach_02, SOUND_0262, SOUND_SPACE_DEFAULT)
    ...
    EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
    EVT_WAIT(40)
    EVT_CALL(PlaySoundAt, SOUND_203C, SOUND_SPACE_DEFAULT, 220, -43, 350)
    ...
    EVT_CALL(PlaySoundAt, SOUND_203C, SOUND_SPACE_DEFAULT, 370, -10, 180)
    ...
    EVT_WAIT(5)
    EVT_CALL(PlaySoundAt, SOUND_203C, SOUND_SPACE_DEFAULT, 350, 50, -100)
    ...
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_203C, SOUND_SPACE_DEFAULT, 570, 0, 100)
    ...
    EVT_WAIT(20)
    EVT_CALL(StopSound, SOUND_LRAW_03BC)
    EVT_CALL(PlaySoundAt, SOUND_0230, SOUND_SPACE_DEFAULT, 500, 0, 100)
