...
EvtScript N(EVS_Scene_Chapter0_BowserAndKammy) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_02, ANIM_KoopaBros_Red_IdleTower)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(5)
        ...
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_01, ANIM_KoopaBros_Black_IdleTower)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(10)
        ...
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_03, ANIM_KoopaBros_Yellow_IdleTower)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(15)
        ...
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_04, ANIM_KoopaBros_Green_IdleTower)
    EVT_END_THREAD
    EVT_WAIT(50)
    ...
    EVT_CALL(SetNpcAnimation, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Idle)
    EVT_CALL(SpeakToNpc, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Idle, 0, NPC_Bowser, MSG_Peach_CH1_KoopaBros_000B)
    EVT_EXEC_WAIT(N(EVS_FocusCam_WholeRoom))
    ...
    EVT_CALL(SpeakToNpc, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Idle, 0, NPC_Bowser, MSG_Peach_CH1_KoopaBros_000D)
    EVT_CALL(InterpNpcYaw, NPC_KoopaBros_02, 90, 5)
    EVT_WAIT(10 * DT)
    EVT_CALL(SpeakToPlayer, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Idle, 5, MSG_Peach_CH1_KoopaBros_000E)
    EVT_CALL(UseSettingsFrom, CAM_DEFAULT, -50, 0, 0)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, -50, 0, 0)
    ...
    EVT_EXEC_WAIT(N(EVS_FocusCam_KoopaBros))
    EVT_WAIT(10 * DT)
    EVT_CALL(SpeakToNpc, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Idle, 0, NPC_Bowser, MSG_Peach_CH1_KoopaBros_0010)
    EVT_EXEC_WAIT(N(EVS_FocusCam_WholeRoom))
    ...
    EVT_CALL(SpeakToNpc, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Idle, 0, NPC_Bowser, MSG_Peach_CH1_KoopaBros_0012)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, -50, 0, 0)
    EVT_CALL(SetCamDistance, CAM_DEFAULT, EVT_FLOAT(250.0))
    EVT_CALL(SetCamPitch, CAM_DEFAULT, EVT_FLOAT(17.0), EVT_FLOAT(-17.0))
    EVT_CALL(SetCamSpeed, CAM_DEFAULT, EVT_FLOAT(90.0))
    ...
    EVT_WAIT(30 * DT)
    EVT_CALL(SpeakToNpc, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Idle, 0, NPC_Bowser, MSG_Peach_CH1_KoopaBros_0014)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, 30, 0, 0)
