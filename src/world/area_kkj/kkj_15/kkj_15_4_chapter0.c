...
EvtScript N(EVS_PlaySounds_KoopaBrosShowOff) = {
    EVT_LOOP(0)
        EVT_CALL(PlaySoundAt, SOUND_55, 0, 100, 0, -40)
        EVT_WAIT(30)
        EVT_CALL(PlaySoundAt, SOUND_356, 0, 100, 0, -40)
        EVT_WAIT(60)
        EVT_CALL(PlaySoundAt, SOUND_37C, 0, 100, 0, -40)
        EVT_WAIT(30)
    EVT_END_LOOP
    EVT_RETURN
    EVT_END
...
EvtScript N(EVS_Scene_Chapter0_BowserAndKammy) = {
    ...
    EVT_CALL(ShowEmote, NPC_Bowser, EMOTE_EXCLAMATION, -45, 20, TRUE, 0, 0, 0, 0)
    EVT_CALL(PlaySoundAtNpc, NPC_Kammy, SOUND_262, 0)
    EVT_CALL(ShowEmote, NPC_Kammy, EMOTE_EXCLAMATION, -45, 20, TRUE, 0, 0, 0, 0)
    EVT_WAIT(20)
    EVT_THREAD
        EVT_LOOP(2)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFlagBits, NPC_KoopaBros_02, NPC_FLAG_8, FALSE)
        EVT_CALL(NpcMoveTo, NPC_KoopaBros_02, 100, -40, 18)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_02, SOUND_3E9, SOUND_PARAM_MUTE)
        EVT_PLAY_EFFECT(EFFECT_LANDING_DUST, 1, 100, 0, -40, 0)
        EVT_CALL(EnableNpcBlur, NPC_KoopaBros_02, FALSE)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim05)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(5)
        EVT_CALL(SetNpcPos, NPC_KoopaBros_01, 328, 180, -15)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_01, ANIM_KoopaBros_Black_Anim12)
        ...
        EVT_CALL(SetNpcFlagBits, NPC_KoopaBros_01, NPC_FLAG_8, FALSE)
        EVT_CALL(NpcMoveTo, NPC_KoopaBros_01, 128, -15, 18)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_01, SOUND_3E9, SOUND_PARAM_MUTE)
        EVT_PLAY_EFFECT(EFFECT_LANDING_DUST, 1, 128, 0, -15, 0)
        EVT_CALL(EnableNpcBlur, NPC_KoopaBros_01, FALSE)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_01, ANIM_KoopaBros_Black_Anim05)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(10)
        EVT_CALL(SetNpcPos, NPC_KoopaBros_03, 340, 180, -90)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_03, ANIM_KoopaBros_Yellow_Anim12)
        ...
        EVT_CALL(SetNpcFlagBits, NPC_KoopaBros_03, NPC_FLAG_8, FALSE)
        EVT_CALL(NpcMoveTo, NPC_KoopaBros_03, 140, -90, 18)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_03, SOUND_3E9, SOUND_PARAM_MUTE)
        EVT_PLAY_EFFECT(EFFECT_LANDING_DUST, 1, 140, 0, -90, 0)
        EVT_CALL(EnableNpcBlur, NPC_KoopaBros_03, FALSE)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_03, ANIM_KoopaBros_Yellow_Anim05)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(SetNpcPos, NPC_KoopaBros_04, 368, 180, -45)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_04, ANIM_KoopaBros_Green_Anim12)
        ...
        EVT_CALL(SetNpcFlagBits, NPC_KoopaBros_04, NPC_FLAG_8, FALSE)
        EVT_CALL(NpcMoveTo, NPC_KoopaBros_04, 168, -45, 18)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_04, SOUND_3E9, SOUND_PARAM_MUTE)
        EVT_PLAY_EFFECT(EFFECT_LANDING_DUST, 1, 168, 0, -45, 0)
        EVT_CALL(EnableNpcBlur, NPC_KoopaBros_04, FALSE)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_04, ANIM_KoopaBros_Green_Anim05)
    EVT_END_THREAD
    EVT_WAIT(50)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim1A)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(5)
        ...
        EVT_ADD(LVar1, 30)
        EVT_PLAY_EFFECT(EFFECT_LENS_FLARE, 0, LVar0, LVar1, LVar2, 40)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_01, ANIM_KoopaBros_Black_Anim1A)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(10)
        ...
        EVT_ADD(LVar1, 30)
        EVT_PLAY_EFFECT(EFFECT_LENS_FLARE, 0, LVar0, LVar1, LVar2, 40)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_03, ANIM_KoopaBros_Yellow_Anim1A)
    EVT_END_THREAD
    EVT_THREAD
        EVT_WAIT(15)
        ...
        EVT_ADD(LVar1, 30)
        EVT_PLAY_EFFECT(EFFECT_LENS_FLARE, 0, LVar0, LVar1, LVar2, 40)
        EVT_CALL(SetNpcAnimation, NPC_KoopaBros_04, ANIM_KoopaBros_Green_Anim1A)
    EVT_END_THREAD
    EVT_WAIT(45)
    ...
    EVT_CALL(SetNpcAnimation, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim04)
    EVT_CALL(SpeakToNpc, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Anim04, 0, NPC_Bowser, MSG_Peach_CH1_KoopaBros_000B)
    EVT_EXEC_WAIT(N(EVS_FocusCam_WholeRoom))
    ...
    EVT_CALL(SpeakToNpc, NPC_KoopaBros_02, ANIM_KoopaBros_Red_Anim14, ANIM_KoopaBros_Red_Anim04, 0, NPC_Bowser, MSG_Peach_CH1_KoopaBros_0012)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, -50, 0, 0)
    EVT_CALL(SetCamDistance, CAM_DEFAULT, EVT_FLOAT(250.0))
    EVT_CALL(SetCamPitch, CAM_DEFAULT, EVT_FLOAT(17.0), EVT_FLOAT(-17.0))
    EVT_CALL(SetCamSpeed, CAM_DEFAULT, EVT_FLOAT(90.0))
    ...
    EVT_CALL(ShowEmote, NPC_KoopaBros_03, EMOTE_EXCLAMATION, -45, 20, TRUE, 0, 0, 0, 0)
    EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_02, SOUND_262, 0)
    EVT_CALL(ShowEmote, NPC_KoopaBros_02, EMOTE_EXCLAMATION, -45, 20, TRUE, 0, 0, 0, 0)
    EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_04, SOUND_262, 0)
    EVT_CALL(ShowEmote, NPC_KoopaBros_04, EMOTE_EXCLAMATION, -45, 20, TRUE, 0, 0, 0, 0)
    EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_01, SOUND_262, 0)
    EVT_CALL(ShowEmote, NPC_KoopaBros_01, EMOTE_EXCLAMATION, -45, 20, TRUE, 0, 0, 0, 0)
    EVT_WAIT(30)
    ...
    EVT_THREAD
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBros_02, SOUND_173, 0)
