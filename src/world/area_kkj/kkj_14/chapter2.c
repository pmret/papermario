...
EvtScript N(EVS_Scene_Chapter2) = {
    ...
    Wait(10)
    Call(SpeakToNpc, NPC_Kammy, ANIM_WorldKammy_Talk, ANIM_WorldKammy_Idle, 0, NPC_Bowser, MSG_Peach_005F)
    ...
    Call(SetNpcAnimation, NPC_Kammy, ANIM_WorldKammy_Idle)
    Call(SpeakToNpc, NPC_Kammy, ANIM_WorldKammy_Talk, ANIM_WorldKammy_Idle, 0, NPC_Bowser, MSG_Peach_0060)
    ...
    Call(SetNpcAnimation, NPC_Kammy, ANIM_WorldKammy_Idle)
    Wait(10 * DT)
    Call(SpeakToNpc, NPC_Kammy, ANIM_WorldKammy_Talk, ANIM_WorldKammy_Idle, 0, NPC_Bowser, MSG_Peach_0062)
    Call(GetNpcPos, NPC_Bowser, LVar0, LVar1, LVar2)
    ...
    Call(SpeakToNpc, NPC_Kammy, ANIM_WorldKammy_Talk, ANIM_WorldKammy_Idle, 0, NPC_Bowser, MSG_Peach_0064)
