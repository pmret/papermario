...
EvtScript N(EVS_ManageQuizGame) = {
    ...
    Call(SetNpcAnimation, NPC_PARTNER, ANIM_Twink_Idle)
    Wait(30 * DT)
    Call(SetMusicTrack, 0, SONG_PEACH_QUIZ_INTRO, 0, VOL_LEVEL_8)
    ...
    Call(PanToTarget, CAM_DEFAULT, 0, TRUE)
    Call(WaitForCam, CAM_DEFAULT, Float(1.0))
    Call(SetMusicTrack, 0, SONG_PEACH_QUIZ_INTRO, 1, VOL_LEVEL_8)
    ...
    Call(SetNpcAnimation, NPC_HammerBros, ANIM_HammerBros_Anim03)
    Call(SetMusicTrack, 0, SONG_PEACH_QUIZ_INTRO, 2, VOL_LEVEL_8)
