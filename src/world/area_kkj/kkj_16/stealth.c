...
EvtScript N(EVS_ManageSneakingScenes) = {
    ...
    Thread
        ...
        Wait(3)
        Call(SetMusicTrack, 0, SONG_PEACH_SNEAKING, 0, VOL_LEVEL_6)
        Wait(3)
        Call(SetMusicTrack, 0, SONG_PEACH_SNEAKING, 0, VOL_LEVEL_5)
        Wait(3)
        Call(SetMusicTrack, 0, SONG_PEACH_SNEAKING, 0, VOL_LEVEL_4)
    EndThread
