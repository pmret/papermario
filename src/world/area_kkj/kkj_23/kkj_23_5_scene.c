...
EvtScript N(EVS_RemoveDisguise) = {
    ...
    EVT_LOOP(10)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(PlaySoundAtPlayer, SOUND_2049, 0)
...
EvtScript N(EVS_Scene_KammyUnmasksPeach) = {
    ...
    EVT_CALL(SetNpcFlagBits, NPC_Koopatrol_01, NPC_FLAG_100, TRUE)
    ...
    EVT_CALL(ShowEmote, NPC_Kammy, EMOTE_EXCLAMATION, -45, 15, TRUE, 0, 0, 0, 0)
    EVT_WAIT(20)
    EVT_CALL(InterpNpcYaw, NPC_Kammy, 270, 5)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Kammy, SOUND_207A, 0)
    EVT_CALL(GetNpcPos, NPC_Kammy, LVar0, LVar1, LVar2)
    EVT_ADD(LVar0, -20)
    EVT_ADD(LVar1, 40)
    EVT_ADD(LVar2, 27)
