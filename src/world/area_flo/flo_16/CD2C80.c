...
Script N(npcAI_80244058) = SCRIPT({
    SetSelfVar(0, 1);
    SetSelfVar(5, 0);
    SetSelfVar(6, 0);
    SetSelfVar(1, 600);
...
Script N(802451C4) = SCRIPT({
    ...
    bind N(80244500) to TRIGGER_FLOOR_TOUCH 26;
    bind N(802448FC) to TRIGGER_FLOOR_TOUCH 29;
    bind N(80244500) to TRIGGER_FLOOR_TOUCH 32;
    bind N(802448FC) to TRIGGER_FLOOR_TOUCH 35;
    bind N(80244DC8) to TRIGGER_FLOOR_TOUCH 38;
    bind N(802448FC) to TRIGGER_FLOOR_TOUCH 41;
...
void N(func_80241000_CD2E30)(ScriptInstance* script, NpcAISettings* aiSettings, EnemyTerritoryThing* territory) {
    Enemy* enemy = script->owner1.enemy;
    Npc* npc = get_npc_unsafe(enemy->npcID);
    f32 temp_f24;
...
#else
INCLUDE_ASM(void, "world/area_flo/flo_16/CD2C80", flo_16_func_80241000_CD2E30, ScriptInstance* script, NpcAISettings* aiSettings, EnemyTerritoryThing* territory);
#endif
...
void N(func_80242478_CD42A8)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *territory) {
    Enemy* enemy = script->owner1.enemy;
    Npc* npc = get_npc_unsafe(enemy->npcID);
    f32 x, y, z, w;
    s32 var;
