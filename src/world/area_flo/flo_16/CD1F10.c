...
/*
ApiStatus N(func_802400FC_CD1F2C)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_flo/flo_16/CD1F10", func_80240148_CD1F78);
/*
ApiStatus N(func_80240148_CD1F78)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_flo/flo_16/CD1F10", func_802401B4_CD1FE4);

INCLUDE_ASM(s32, "world/area_flo/flo_16/CD1F10", func_80240200_CD2030);
/*
ApiStatus N(func_80240200_CD2030)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
/*
ApiStatus N(func_80240528_CD2358)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240560_CD2390)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
/*
ApiStatus N(func_802405F0_CD2420)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_flo/flo_16/CD1F10", func_80240624_CD2454);
/*
ApiStatus N(func_80240624_CD2454)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_flo/flo_16/CD1F10", func_80240688_CD24B8);
/*
ApiStatus N(func_80240688_CD24B8)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_flo/flo_16/CD1F10", func_802406E0_CD2510);
/*
...
/*
s32 N(func_80240C18_CD2A48)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
