...
EvtScript N(main) = {
    ...
    EVT_SET(LocalVar(2), 583)
    EVT_SET(LocalVar(3), -64)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(80243A40))
    EVT_SET(LocalVar(0), 433)
    EVT_SET(LocalVar(1), 108)
    EVT_SET(LocalVar(2), 580)
    EVT_SET(LocalVar(3), 169)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(80243A40))
    EVT_SET(LocalVar(0), -460)
    EVT_SET(LocalVar(1), 90)
    EVT_SET(LocalVar(2), -125)
    EVT_SET(LocalVar(3), 130)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(80243A40))
    ...
    EVT_SET(LocalVar(3), -50)
    EVT_SET(LocalVar(4), 160)
    EVT_EXEC(N(80243A40))
...
EvtScript N(80244560) = {
    ...
    EVT_LABEL(0)
    EVT_CALL(GetNpcPos, 1, LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_CALL(N(UnkFunc42))
    EVT_CALL(InterpNpcYaw, 1, LocalVar(10), 0)
    EVT_SET(LocalVar(0), LocalVar(3))
    EVT_SET(LocalVar(1), LocalVar(4))
    EVT_SET(LocalVar(2), LocalVar(5))
    EVT_CALL(GetAngleBetweenNPCs, -4, 1, LocalVar(10))
    EVT_CALL(InterpNpcYaw, NPC_PARTNER, LocalVar(10), 0)
    EVT_IF_LT(GB_StoryProgress, 51)
        EVT_CALL(GetAngleBetweenNPCs, 0, 1, LocalVar(11))
        EVT_CALL(InterpNpcYaw, 0, LocalVar(11), 0)
    EVT_END_IF
...
EvtScript N(802446AC) = {
    ...
    EVT_LOOP(0)
        EVT_LOOP(2)
            ...
            EVT_CALL(SetNpcPos, 2, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(GetNpcPos, 1, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_ADD(LocalVar(1), 1)
...
EvtScript N(80244888) = {
    ...
    EVT_CALL(GetNpcPos, 1, LocalVar(1), LocalVar(2), LocalVar(3))
    ...
    EVT_CALL(NpcJump0, 2, LocalVar(1), LocalVar(2), LocalVar(3), 7)
    EVT_ADD(LocalVar(1), -100)
    EVT_ADD(LocalVar(2), 10)
    EVT_THREAD
        EVT_CALL(SetNpcJumpscale, 2, EVT_FLOAT(1.5))
        EVT_CALL(NpcJump0, 2, LocalVar(1), LocalVar(2), LocalVar(3), 15)
    ...
    EVT_LOOP(20)
        EVT_ADD(LocalVar(0), 144)
        EVT_IF_GT(LocalVar(0), 359)
            EVT_SUB(LocalVar(0), 360)
        EVT_END_IF
        EVT_CALL(InterpPlayerYaw, LocalVar(0), 1)
        EVT_WAIT(1)
    EVT_END_LOOP
...
EvtScript N(80245014) = {
    EVT_CALL(GetNpcPos, 1, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(AwaitPlayerLeave, LocalVar(0), LocalVar(2), 120)
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_CALL(GetNpcPos, 1, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(UseSettingsFrom, 0, LocalVar(0), 0, LocalVar(2))
    EVT_CALL(SetPanTarget, 0, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(80245444) = {
    ...
    EVT_CALL(NpcMoveTo, 0, LocalVar(0), 60, 0)
...
EvtScript N(defeat_80246038) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(0)
            ...
            EVT_CALL(GetNpcPos, NPC_SELF, LocalVar(3), LocalVar(1), LocalVar(2))
            EVT_CALL(GetPlayerPos, LocalVar(0), LocalVar(1), LocalVar(2))
