...
EvtScript N(main) = {
    ...
    EVT_SET(LocalVar(0), 140)
    EVT_SET(LocalVar(1), -137)
    EVT_SET(LocalVar(2), 340)
    EVT_SET(LocalVar(3), -60)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(80242680))
    EVT_SET(LocalVar(0), 450)
    EVT_SET(LocalVar(1), -137)
    EVT_SET(LocalVar(2), 590)
    EVT_SET(LocalVar(3), -60)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(80242680))
    EVT_EXEC(N(80245914))
...
EvtScript N(80242F00) = {
    ...
    EVT_CALL(PlayEffect, 0x11, 3, LocalVar(0), LocalVar(1), LocalVar(2), 30, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(15)
    EVT_GOTO(0)
    EVT_RETURN
    EVT_END
    ...
    EVT_IF_EQ(GF_FLO08_GaveYellowBerry, 0)
        ...
        EVT_SWITCH(LocalVar(0))
            ...
            EVT_CASE_DEFAULT
                ...
                EVT_CALL(MakeItemEntity, LocalVar(8), -695, 20, -29, 1, 0)
                ...
                EVT_SWITCH(LocalVar(8))
                    EVT_CASE_EQ(160)
                        ...
                        EVT_LOOP(0)
                            ...
                            EVT_CALL(RotateModel, 103, LocalVar(8), 0, 1, 0)
                            EVT_CALL(RotateModel, 104, LocalVar(8), 0, 1, 0)
                            EVT_CALL(RotateModel, 105, LocalVar(8), 0, 1, 0)
                            EVT_CALL(RotateModel, 99, LocalVar(9), 0, -1, 0)
                            EVT_CALL(RotateModel, 100, LocalVar(9), 0, -1, 0)
                            EVT_CALL(RotateModel, 101, LocalVar(9), 0, -1, 0)
                            EVT_WAIT(1)
                    ...
                    EVT_CASE_DEFAULT
                        ...
                        EVT_IF_LT(LocalVar(0), 180)
                            ...
                            EVT_LOOP(0)
                                ...
                                EVT_ADDF(LocalVar(2), EVT_FLOAT(-700.0))
                                EVT_ADDF(LocalVar(3), EVT_FLOAT(15.0))
                                EVT_ADDF(LocalVar(4), EVT_FLOAT(-25.0))
                        ...
                        EVT_ELSE
                            ...
                            EVT_LOOP(0)
                                ...
                                EVT_MULF(LocalVar(3), LocalVar(0))
                                EVT_MULF(LocalVar(4), LocalVar(0))
                                EVT_ADDF(LocalVar(2), EVT_FLOAT(-690.0))
                                EVT_ADDF(LocalVar(3), EVT_FLOAT(15.0))
                                EVT_ADDF(LocalVar(4), EVT_FLOAT(-25.0))
                                EVT_CALL(N(FlowerGuard_SetItemEntityPosition), LocalVar(7), LocalVar(2), LocalVar(3), LocalVar(4))
                                EVT_WAIT(1)
...
EvtScript N(init_80244BC8) = {
    EVT_THREAD
        EVT_WAIT(2)
        EVT_CALL(GetNpcPointer, 2, LocalVar(0))
        EVT_IF_EQ(LocalVar(0), 0)
            EVT_CALL(RemoveNpc, NPC_SELF)
            EVT_RETURN
        EVT_END_IF
        EVT_CALL(RandInt, 100, LocalVar(0))
        EVT_IF_LT(LocalVar(0), 30)
...
EvtScript N(80245F5C) = {
    ...
    EVT_SET(LocalVar(3), 60)
    EVT_SET(LocalVar(4), 61)
    EVT_SET(LocalVar(5), 62)
    EVT_SET(LocalVar(6), 63)
    EVT_SET(LVarA, 0)
    EVT_EXEC(N(80245C3C))
    EVT_CALL(GetModelCenter, 54)
    EVT_SET(LocalVar(3), 54)
    EVT_SET(LocalVar(4), 55)
    EVT_SET(LocalVar(5), 56)
    EVT_SET(LocalVar(6), 57)
    EVT_SET(LVarA, 0)
    EVT_EXEC(N(80245C3C))
    EVT_CALL(GetModelCenter, 48)
    EVT_SET(LocalVar(3), 48)
    EVT_SET(LocalVar(4), 49)
    EVT_SET(LocalVar(5), 50)
    EVT_SET(LocalVar(6), 51)
    EVT_SET(LVarA, 0)
    EVT_EXEC(N(80245C3C))
    EVT_CALL(GetModelCenter, 67)
    EVT_SET(LocalVar(3), 67)
    EVT_SET(LocalVar(4), 66)
    EVT_SET(LocalVar(5), 68)
    EVT_SET(LocalVar(6), 69)
    EVT_SET(LVarA, 174)
    EVT_EXEC(N(80245C3C))
    EVT_RETURN
    EVT_END
