...
EvtScript N(EVS_DamagedLeftOnce) = {
    ...
    EVT_THREAD
        EVT_WAIT(10)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o130, SOUND_1E6, 0)
    EVT_END_THREAD
    EVT_LOOP(300)
...
EvtScript N(EVS_DamagedRightOnce) = {
    ...
    EVT_THREAD
        EVT_WAIT(12)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o175, SOUND_1E7, 0)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar4, EVT_FLOAT(-0.5))
        EVT_ADDF(LVar0, LVar3)
...
EvtScript N(EVS_DamagedLeftTwice) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o174, SOUND_1E7, 0)
    EVT_END_THREAD
    EVT_LOOP(300)
...
EvtScript N(EVS_DamagedRightTwice) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o127, SOUND_1E7, 0)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar5, EVT_FLOAT(0.5))
        EVT_ADDF(LVar2, LVar5)
...
EvtScript N(EVS_BreakSmokestack) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o131, SOUND_1E6, 0)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar4, EVT_FLOAT(-0.5))
        EVT_ADDF(LVar5, EVT_FLOAT(0.093))
...
EvtScript N(EVS_BreakAntenna) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o126, SOUND_1E6, 0)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar4, EVT_FLOAT(-0.5))
        EVT_ADDF(LVar0, LVar3)
        ...
        EVT_IF_EQ(GB_FLO18_MachineDamage_Right, 2)
            ...
            EVT_THREAD
                ...
                EVT_LOOP(ARRAY_COUNT(N(SmokeBurstPositions)))
                    ...
                    EVT_CALL(PlaySoundAt, SOUND_190, 0, LVar0, LVar1, LVar2)
            ...
            EVT_CALL(PlaySoundAtCollider, COLLIDER_o126, SOUND_91 | SOUND_ID_TRIGGER_CHANGE_SOUND, 0)
