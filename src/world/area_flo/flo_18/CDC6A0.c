...
EvtScript N(802436BC) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetTexPanOffset, 13, 0, LVar1, 0)
        EVT_CALL(SetTexPanOffset, 14, 0, LVar2, 0)
        EVT_CALL(SetTexPanOffset, 15, 0, LVar3, 0)
        EVT_CALL(SetTexPanOffset, 11, 0, LVar4, 0)
        EVT_CALL(SetTexPanOffset, 10, 0, LVar5, 0)
        EVT_CALL(SetTexPanOffset, 9, 0, LVar5, 0)
        EVT_WAIT(1)
        EVT_GOTO(0)
    EVT_END_THREAD
    EVT_RETURN
...
EvtScript N(80244058) = {
    ...
    EVT_CALL(SpeakToPlayer, NPC_PARTNER, NPC_ANIM_world_lakilester_Palette_00_Anim_9, NPC_ANIM_world_lakilester_Palette_00_Anim_1, 5, MESSAGE_ID(0x1100C9))
...
EvtScript N(80244774) = {
    ...
    EVT_CALL(SpeakToPlayer, 4, NPC_ANIM_flying_magikoopa_Palette_02_Anim_9, NPC_ANIM_flying_magikoopa_Palette_02_Anim_1, 0, MESSAGE_ID(0x1100BB))
    EVT_WAIT(20)
    EVT_EXEC(N(80244270))
    EVT_WAIT(80)
    EVT_CALL(AdjustCam, 0, EVT_FLOAT(8.0), 0, 300, EVT_FLOAT(19.0), EVT_FLOAT(-8.5))
    ...
    EVT_CALL(NpcFacePlayer, NPC_PARTNER, 0)
    EVT_CALL(DisablePartnerAI, 0)
    EVT_CALL(SpeakToPlayer, NPC_PARTNER, NPC_ANIM_world_lakilester_Palette_00_Anim_9, NPC_ANIM_world_lakilester_Palette_00_Anim_1, 5, MESSAGE_ID(0x1100C1))
    EVT_CALL(EnablePartnerAI)
    EVT_WAIT(20)
    EVT_CALL(PutPartnerAway)
    EVT_CALL(ResetCam, 0, EVT_FLOAT(4.0))
    ...
    EVT_CALL(NpcFacePlayer, NPC_PARTNER, 0)
    EVT_CALL(DisablePartnerAI, 0)
    EVT_CALL(SpeakToPlayer, NPC_PARTNER, NPC_ANIM_world_lakilester_Palette_00_Anim_9, NPC_ANIM_world_lakilester_Palette_00_Anim_1, 5, MESSAGE_ID(0x1100C2))
    EVT_CALL(EnablePartnerAI)
    EVT_CALL(PutPartnerAway)
    EVT_CALL(ResetCam, 0, EVT_FLOAT(4.0))
    EVT_CALL(DisablePlayerInput, FALSE)
...
EvtScript N(80244ED0) = {
    EVT_SWITCH(MapVar(10))
        EVT_CASE_EQ(0)
            EVT_CALL(SpeakToPlayer, 3, NPC_ANIM_magikoopa_Palette_02_Anim_2, NPC_ANIM_magikoopa_Palette_02_Anim_1, 16, MESSAGE_ID(0x1100B9))
            EVT_CALL(InterpNpcYaw, 3, 90, 0)
        EVT_CASE_EQ(1)
            EVT_CALL(SpeakToPlayer, 0, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 16, MESSAGE_ID(0x1100BF))
            EVT_CALL(InterpNpcYaw, 0, 90, 0)
        EVT_CASE_EQ(2)
            EVT_CALL(SpeakToPlayer, 1, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 16, MESSAGE_ID(0x1100BF))
            EVT_CALL(InterpNpcYaw, 1, 270, 0)
        EVT_CASE_EQ(3)
            EVT_CALL(SpeakToPlayer, 2, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 16, MESSAGE_ID(0x1100BF))
            EVT_CALL(InterpNpcYaw, 2, 270, 0)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
...
EvtScript N(80245004) = {
    EVT_SWITCH(MapVar(10))
        EVT_CASE_EQ(0)
            EVT_CALL(SpeakToPlayer, 3, NPC_ANIM_magikoopa_Palette_02_Anim_2, NPC_ANIM_magikoopa_Palette_02_Anim_1, 16, MESSAGE_ID(0x1100BA))
        EVT_CASE_EQ(1)
            EVT_CALL(SpeakToPlayer, 0, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 16, MESSAGE_ID(0x1100C0))
        EVT_CASE_EQ(2)
            EVT_CALL(SpeakToPlayer, 1, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 16, MESSAGE_ID(0x1100C0))
        EVT_CASE_EQ(3)
            EVT_CALL(SpeakToPlayer, 2, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 16, MESSAGE_ID(0x1100C0))
    EVT_END_SWITCH
...
EvtScript N(interact_802457D4) = {
    EVT_SWITCH(AreaByte(6))
        EVT_CASE_EQ(0)
            EVT_CALL(GetSelfNpcID, LVar0)
            EVT_IF_EQ(LVar0, 3)
                EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_magikoopa_Palette_02_Anim_2, NPC_ANIM_magikoopa_Palette_02_Anim_1, 5, MESSAGE_ID(0x1100B6))
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 5, MESSAGE_ID(0x1100BC))
            EVT_END_IF
            EVT_ADD(AreaByte(6), 1)
        EVT_CASE_EQ(1)
            EVT_CALL(GetSelfNpcID, LVar0)
            EVT_IF_EQ(LVar0, 3)
                EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_magikoopa_Palette_02_Anim_2, NPC_ANIM_magikoopa_Palette_02_Anim_1, 5, MESSAGE_ID(0x1100B7))
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 5, MESSAGE_ID(0x1100BD))
            EVT_END_IF
            EVT_ADD(AreaByte(6), 1)
        EVT_CASE_EQ(2)
            ...
            EVT_CALL(GetSelfNpcID, LVar0)
            EVT_IF_EQ(LVar0, 3)
                EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_magikoopa_Palette_02_Anim_2, NPC_ANIM_magikoopa_Palette_02_Anim_1, 5, MESSAGE_ID(0x1100B8))
                EVT_CALL(NpcFacePlayer, NPC_SELF, 0)
                EVT_WAIT(15)
                EVT_CALL(EndSpeech, -1, NPC_ANIM_magikoopa_Palette_02_Anim_2, NPC_ANIM_magikoopa_Palette_02_Anim_1, 0)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_lakitu_Palette_00_Anim_16, NPC_ANIM_lakitu_Palette_00_Anim_1, 5, MESSAGE_ID(0x1100BE))
                EVT_CALL(NpcFacePlayer, NPC_SELF, 0)
                EVT_WAIT(15)
