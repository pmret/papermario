...
EvtScript N(80241094) = {
    ...
    EVT_LOOP(LVarE)
        ...
        EVT_ADDF(LocalVar(8), LVarA)
        EVT_SETF(LocalVar(9), LocalVar(7))
        EVT_CALL(N(UnkFloatFunc), LVarE, LVarA, EVT_FLOAT(0.0), EVT_FLOAT(0.203125), 20, 0, 90)
        EVT_ADDF(LocalVar(9), LVarA)
        EVT_SETF(LVarA, LocalVar(0))
        EVT_MULF(LVarA, EVT_FLOAT(10.0))
        EVT_CALL(TranslateModel, LVarF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(ScaleModel, LVarF, LocalVar(8), LocalVar(9), 1)
...
EvtScript N(802413F0) = {
    ...
    EVT_LOOP(12)
        ...
        EVT_SETF(LocalVar(0), LVarE)
        EVT_SETF(LocalVar(1), LVarD)
        EVT_SETF(LocalVar(2), LVarE)
