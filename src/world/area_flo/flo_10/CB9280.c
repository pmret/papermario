...
Script N(80244A50) = SCRIPT({
    ...
    bind N(shakeTree_802443F0) to TRIGGER_WALL_HAMMER 9;
    bind N(shakeTree_802443F0) to TRIGGER_POINT_BOMB N(triggerCoord_80244A40);
});
