...
EvtScript N(EVS_HuffNPuff_Defeat_Flashing) = {
    ...
    EVT_CHILD_THREAD
        EVT_LOOP(0)
            ...
            EVT_LOOP(0)
                EVT_CALL(UpdateLerp)
                EVT_CALL(SetNpcFoldParams, NPC_HuffNPuff_01, IMGFX_TYPE_9, LVar0, LVar0, LVar0, 0)
                EVT_CALL(SetNpcFoldParams, NPC_HuffNPuff_02, IMGFX_TYPE_9, LVar0, LVar0, LVar0, 0)
                EVT_CALL(SetNpcFoldParams, NPC_HuffNPuff_03, IMGFX_TYPE_9, LVar0, LVar0, LVar0, 0)
                EVT_WAIT(1)
                EVT_IF_EQ(LVar1, 0)
                    EVT_BREAK_LOOP
                EVT_END_IF
