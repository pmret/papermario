...
/*
s32 N(func_80240000_CE6700)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
...
/*
s32 N(func_8024004C_CE674C)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
...
/*
s32 N(func_802405BC_CE6CBC)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
...
/*
s32 N(func_802405FC_CE6CFC)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
    Bytecode* args = script->ptrReadPos;
...
/*
s32 N(func_80240708_CE6E08)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
