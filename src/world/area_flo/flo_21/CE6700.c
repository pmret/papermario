...
EvtScript N(80241B98) = {
    ...
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_WAIT(10)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x1100CA), 630, 120, 0)
    EVT_CALL(SetCamDistance, 0, EVT_FLOAT(600.0))
    EVT_CALL(SetCamPitch, 0, EVT_FLOAT(30.0), EVT_FLOAT(-9.0))
    EVT_CALL(SetCamSpeed, 0, EVT_FLOAT(90.0))
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_WAIT(10)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x1100CB), 630, 120, 0)
    EVT_CALL(SetCamDistance, 0, EVT_FLOAT(300.0))
    EVT_CALL(SetCamPitch, 0, EVT_FLOAT(17.0), EVT_FLOAT(-9.0))
    EVT_CALL(PanToTarget, 0, 0, 1)
    ...
    EVT_IF_NE(LVar0, 8)
        EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x1100CC), 630, 120, 0)
    EVT_ELSE
        EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x1100CD), 630, 120, 0)
    EVT_END_IF
    EVT_CHILD_THREAD
        EVT_WAIT(15)
        EVT_CALL(GetPlayerPos, LVar0, LVar1, LVar2)
...
EvtScript N(80243010) = {
    ...
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_CALL(SpeakToPlayer, 0, NPC_ANIM_huff_n_puff_Palette_00_Anim_30, NPC_ANIM_huff_n_puff_Palette_00_Anim_5, 256, -30, 30, MESSAGE_ID(0x1100CE))
