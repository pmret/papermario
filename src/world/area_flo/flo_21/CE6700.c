...
EvtScript N(80243010) = {
    EVT_CALL(SetNpcAnimation, 1, ANIM_HuffNPuff_Anim04)
    EVT_CALL(SetNpcAnimation, 0, ANIM_HuffNPuff_Anim05)
    EVT_CALL(SetNpcAnimation, 2, ANIM_HuffNPuff_Anim06)
    ...
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_CALL(SpeakToPlayer, 0, ANIM_HuffNPuff_Anim30, ANIM_HuffNPuff_Anim05, 256, -30, 30, MSG_CH6_00CE)
...
EvtScript N(init_802437A8) = {
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_TuffPuff_Anim0B)
