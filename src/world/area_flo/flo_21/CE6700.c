...
EvtScript N(80243010) = {
    EVT_CALL(SetNpcAnimation, 1, ANIM_HuffNPuff_Anim4)
    EVT_CALL(SetNpcAnimation, 0, ANIM_HuffNPuff_Anim5)
    EVT_CALL(SetNpcAnimation, 2, ANIM_HuffNPuff_Anim6)
    ...
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_CALL(SpeakToPlayer, 0, ANIM_HuffNPuff_Anim30, ANIM_HuffNPuff_Anim5, 256, -30, 30, MSG_CH6_00CE)
...
EvtScript N(init_802435E4) = {
    EVT_IF_LT(GB_StoryProgress, 56)
        ...
        EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_HuffNPuff_Anim2)
    EVT_ELSE
...
EvtScript N(init_80243684) = {
    EVT_IF_LT(GB_StoryProgress, 56)
        ...
        EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_HuffNPuff_Anim1)
        EVT_EXEC(N(80242290))
    EVT_ELSE
        EVT_CALL(SetNpcPos, NPC_SELF, 0, -1000, 0)
    EVT_END_IF
...
EvtScript N(init_802437A8) = {
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_TuffPuff_AnimB)
...
s32 N(extraAnimationList_802437E0)[] = {
    ANIM_HuffNPuff_Anim0,
    ANIM_HuffNPuff_Anim1,
    ANIM_HuffNPuff_Anim2,
    ANIM_HuffNPuff_Anim4,
    ANIM_HuffNPuff_Anim5,
