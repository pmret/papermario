            ...
            EVT_CASE_DEFAULT
                ...
                EVT_SWITCH(LVar8)
                    EVT_CASE_EQ(158)
                        ...
                        EVT_CALL(EndSpeech, -1, ANIM_GateFlower_Blue_HappyTalk, ANIM_GateFlower_Blue_HappyIdle, 0)
                    ...
                    EVT_CASE_DEFAULT
                        ...
                        EVT_CALL(RemoveItemEntity, LVar7)
                        EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_GateFlower_Blue_Idle)
                        EVT_CALL(EndSpeech, -1, ANIM_GateFlower_Blue_Talk, ANIM_GateFlower_Blue_Idle, 0)
                EVT_END_SWITCH
        EVT_END_SWITCH
        EVT_THREAD
