...
EvtScript N(EVS_AnimatePlatforms) = {
    ...
    EVT_LABEL(0)
        ...
        EVT_CALL(N(CosInterpAbsMinMax), LVarF, LVar1, EVT_FLOAT(5.0), EVT_FLOAT(136.76562), 300, 0, 0)
        EVT_SETF(LVar2, EVT_FLOAT(-200.0))
        ...
        EVT_CALL(N(CosInterpAbsMinMax), LVarF, LVar1, EVT_FLOAT(5.0), EVT_FLOAT(106.765625), 300, 0, 0)
        EVT_SETF(LVar2, EVT_FLOAT(10.0))
        EVT_ADDF(LVar1, MV_Distortion_Platform_03)
        EVT_CALL(TranslateGroup, MODEL_g22, LVar0, LVar1, LVar2)
        EVT_SETF(LVar0, EVT_FLOAT(295.73438))
        EVT_CALL(N(CosInterpAbsMinMax), LVarF, LVar1, EVT_FLOAT(65.0), EVT_FLOAT(86.984375), 200, 0, 0)
        EVT_SETF(LVar2, EVT_FLOAT(-80.0))
        EVT_ADDF(LVar1, MV_Distortion_Platform_04)
        EVT_CALL(TranslateGroup, MODEL_g23, LVar0, LVar1, LVar2)
        EVT_CALL(N(CosInterpAbsMinMax), LVarF, LVar2, EVT_FLOAT(0.96875), EVT_FLOAT(1.03125), 15, 0, 0)
        EVT_CALL(N(CosInterpAbsMinMax), LVarF, LVar3, EVT_FLOAT(1.03125), EVT_FLOAT(0.96875), 15, 0, 0)
        ...
        EVT_MULF(MV_Distortion_Platform_01, EVT_FLOAT(0.84375))
        EVT_MULF(MV_Distortion_Platform_02, EVT_FLOAT(0.84375))
        EVT_MULF(MV_Distortion_Platform_03, EVT_FLOAT(0.84375))
        EVT_MULF(MV_Distortion_Platform_04, EVT_FLOAT(0.84375))
...
EvtScript N(EVS_SetupClouds) = {
    ...
    EVT_THREAD
        EVT_SET(LVarF, 0)
        EVT_LABEL(0)
            EVT_CALL(N(CosInterpAbsMinMax), LVarF, LVar0, EVT_FLOAT(0.96875), EVT_FLOAT(1.03125), 15, 0, 0)
            EVT_CALL(N(CosInterpAbsMinMax), LVarF, LVar1, EVT_FLOAT(1.03125), EVT_FLOAT(0.96875), 15, 0, 0)
