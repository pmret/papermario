...
EvtScript N(80241050) = {
    ...
    EVT_LABEL(0)
    EVT_SETF(LocalVar(0), EVT_FIXED(-215.4375))
    EVT_SETF(LocalVar(1), EVT_FIXED(128.59375))
    EVT_SETF(LocalVar(2), EVT_FIXED(-200.0))
    EVT_ADDF(LocalVar(1), MapVar(12))
    EVT_CALL(TranslateGroup, 28, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_SETF(LocalVar(0), EVT_FIXED(-79.86))
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FIXED(5.0), EVT_FIXED(136.765625), 300, 0, 0)
    EVT_SETF(LocalVar(2), EVT_FIXED(-200.0))
    EVT_ADDF(LocalVar(1), MapVar(13))
    EVT_CALL(TranslateGroup, 32, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_SETF(LocalVar(0), EVT_FIXED(-364.265625))
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FIXED(5.0), EVT_FIXED(106.765625), 300, 0, 0)
    EVT_SETF(LocalVar(2), EVT_FIXED(10.0))
    EVT_ADDF(LocalVar(1), MapVar(14))
    EVT_CALL(TranslateGroup, 36, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_SETF(LocalVar(0), EVT_FIXED(295.734375))
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FIXED(65.0), EVT_FIXED(86.984375), 200, 0, 0)
    EVT_SETF(LocalVar(2), EVT_FIXED(-80.0))
    EVT_ADDF(LocalVar(1), MapVar(15))
    EVT_CALL(TranslateGroup, 40, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(2), EVT_FIXED(0.96875), EVT_FIXED(1.03125), 15, 0, 0)
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(3), EVT_FIXED(1.03125), EVT_FIXED(0.96875), 15, 0, 0)
    EVT_SETF(LocalVar(0), MapVar(12))
    EVT_SETF(LocalVar(1), MapVar(12))
    EVT_MULF(LocalVar(0), EVT_FIXED(-0.02))
    EVT_MULF(LocalVar(1), EVT_FIXED(0.04))
    ...
    EVT_IF_GE(LocalVar(15), 1200)
        EVT_SET(LocalVar(15), 0)
    EVT_END_IF
    EVT_SETF(LocalVar(0), LocalVar(10))
    EVT_SETF(LocalVar(1), LocalVar(11))
    EVT_SETF(LocalVar(2), LocalVar(12))
    EVT_SETF(LocalVar(3), LocalVar(13))
    EVT_MULF(LocalVar(0), EVT_FIXED(-0.046875))
    EVT_MULF(LocalVar(1), EVT_FIXED(-0.09375))
    EVT_MULF(LocalVar(2), EVT_FIXED(-0.09375))
    EVT_MULF(LocalVar(3), EVT_FIXED(-0.09375))
    EVT_ADDF(MapVar(12), LocalVar(0))
    EVT_ADDF(MapVar(13), LocalVar(1))
    EVT_ADDF(MapVar(14), LocalVar(2))
    EVT_ADDF(MapVar(15), LocalVar(3))
    EVT_MULF(MapVar(12), EVT_FIXED(0.84375))
    EVT_MULF(MapVar(13), EVT_FIXED(0.84375))
    EVT_MULF(MapVar(14), EVT_FIXED(0.84375))
    EVT_MULF(MapVar(15), EVT_FIXED(0.84375))
    EVT_ADDF(LocalVar(10), MapVar(12))
    EVT_ADDF(LocalVar(11), MapVar(13))
    EVT_ADDF(LocalVar(12), MapVar(14))
    EVT_ADDF(LocalVar(13), MapVar(15))
    EVT_WAIT(1)
    EVT_GOTO(0)
    EVT_RETURN
    EVT_END
...
EvtScript N(80241650) = {
    EVT_THREAD
        EVT_ADDF(MapVar(12), EVT_FIXED(-1.5))
        EVT_WAIT(1)
        EVT_ADDF(MapVar(12), EVT_FIXED(-1.5))
    EVT_END_THREAD
    EVT_RETURN
...
EvtScript N(8024169C) = {
    EVT_THREAD
        EVT_ADDF(MapVar(13), EVT_FIXED(-1.5))
        EVT_WAIT(1)
        EVT_ADDF(MapVar(13), EVT_FIXED(-1.5))
    EVT_END_THREAD
    EVT_RETURN
...
EvtScript N(802416E8) = {
    EVT_THREAD
        EVT_ADDF(MapVar(14), EVT_FIXED(-1.5))
        EVT_WAIT(1)
        EVT_ADDF(MapVar(14), EVT_FIXED(-1.5))
    EVT_END_THREAD
    EVT_RETURN
...
EvtScript N(80241734) = {
    EVT_THREAD
        EVT_ADDF(MapVar(15), EVT_FIXED(-1.5))
        EVT_WAIT(1)
        EVT_ADDF(MapVar(15), EVT_FIXED(-1.5))
    EVT_END_THREAD
    EVT_RETURN
...
EvtScript N(80241780) = {
    ...
    EVT_THREAD
        EVT_SET(LocalVar(15), 0)
        EVT_LABEL(0)
        EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(0), EVT_FIXED(0.96875), EVT_FIXED(1.03125), 15, 0, 0)
        EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FIXED(1.03125), EVT_FIXED(0.96875), 15, 0, 0)
...
EvtScript N(80241BB0) = {
    ...
    EVT_MULF(LocalVar(1), EVT_FIXED(-12.0))
...
EvtScript N(80241CC4) = {
    ...
    EVT_SET(LocalVar(9), EVT_FIXED(45.0))
    EVT_SET(LocalVar(10), EVT_FIXED(28.0))
    EVT_SET(LocalVar(11), EVT_FIXED(5.0))
    EVT_SET(LocalVar(12), EVT_FIXED(60.0))
    EVT_SET(LocalVar(13), EVT_FIXED(28.0))
    EVT_SET(LocalVar(14), EVT_FIXED(10.0))
    EVT_THREAD
        EVT_WAIT(5)
    ...
    EVT_LOOP(344)
        EVT_ADD(LocalVar(15), 1)
        EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), -210, 0, 344, 0, 0)
        EVT_SETF(LocalVar(1), LocalVar(0))
        EVT_MULF(LocalVar(1), EVT_FIXED(-3.0))
        EVT_CALL(TranslateModel, 86, EVT_FIXED(1.3134765625), LocalVar(0), EVT_FIXED(-0.56640625))
        EVT_CALL(RotateModel, 86, LocalVar(1), 0, 1, 0)
        EVT_CALL(UpdateColliderTransform, 12)
        EVT_SETF(LocalVar(2), LocalVar(0))
        EVT_MULF(LocalVar(2), EVT_FIXED(-3.0))
...
EvtScript N(802423F8) = {
    EVT_IF_EQ(AreaFlag(44), 0)
        ...
        EVT_THREAD
            ...
            EVT_LOOP(344)
                EVT_ADD(LocalVar(15), 1)
                EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), 0, -210, 344, 0, 0)
                EVT_SETF(LocalVar(1), LocalVar(0))
                EVT_MULF(LocalVar(1), EVT_FIXED(-3.0))
                EVT_CALL(TranslateModel, 86, EVT_FIXED(1.3134765625), LocalVar(0), EVT_FIXED(-0.56640625))
                EVT_CALL(RotateModel, 86, LocalVar(1), 0, 1, 0)
...
EvtScript N(80242A2C) = {
    ...
    EVT_CALL(SetCamSpeed, 0, EVT_FIXED(90.0))
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_SET(LocalVar(15), 100)
    EVT_SET(MapVar(11), LocalVar(15))
    ...
    EVT_LOOP(400)
        ...
        EVT_END_IF
        EVT_ADD(LocalVar(15), 1)
        EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), -350, 0, 400, 0, 0)
        EVT_SETF(MapVar(11), LocalVar(15))
        EVT_MULF(MapVar(11), EVT_FIXED(1.6))
        EVT_SETF(LocalVar(2), LocalVar(0))
        EVT_MULF(LocalVar(2), EVT_FIXED(1.0))
