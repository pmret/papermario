...
EvtScript N(80241050) = {
    ...
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FLOAT(5.0), EVT_FLOAT(136.765625), 300, 0, 0)
    EVT_SETF(LocalVar(2), EVT_FLOAT(-200.0))
    ...
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FLOAT(5.0), EVT_FLOAT(106.765625), 300, 0, 0)
    ...
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FLOAT(65.0), EVT_FLOAT(86.984375), 200, 0, 0)
    ...
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(2), EVT_FLOAT(0.96875), EVT_FLOAT(1.03125), 15, 0, 0)
    EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(3), EVT_FLOAT(1.03125), EVT_FLOAT(0.96875), 15, 0, 0)
...
EvtScript N(80241780) = {
    ...
    EVT_THREAD
        EVT_SET(LocalVar(15), 0)
        EVT_LABEL(0)
        EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(0), EVT_FLOAT(0.96875), EVT_FLOAT(1.03125), 15, 0, 0)
        EVT_CALL(N(func_80240340_CE3A30), LocalVar(15), LocalVar(1), EVT_FLOAT(1.03125), EVT_FLOAT(0.96875), 15, 0, 0)
...
EvtScript N(80241CC4) = {
    ...
    EVT_SET(LocalVar(10), EVT_FLOAT(28.0))
    EVT_SET(LocalVar(11), EVT_FLOAT(5.0))
    EVT_SET(LocalVar(12), EVT_FLOAT(60.0))
    EVT_SET(LocalVar(13), EVT_FLOAT(28.0))
    EVT_SET(LocalVar(14), EVT_FLOAT(10.0))
    EVT_THREAD
        EVT_WAIT(5)
