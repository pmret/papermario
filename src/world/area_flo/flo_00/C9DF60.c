...
EvtScript N(802416C0) = {
    ...
    EVT_ADD(LocalVar(0), LVarA)
    EVT_ADD(LocalVar(1), LVarB)
    EVT_CALL(PlayEffect, EFFECT_FLOATING_FLOWER, LocalVar(0), LVarE, LocalVar(1), 200, 0, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(LVarF)
    EVT_GOTO(0)
    EVT_RETURN
    EVT_END
...
EvtScript N(802477EC) = {
    EVT_IF_EQ(AreaFlag(44), 0)
        ...
        EVT_THREAD
            ...
            EVT_LOOP(0)
                EVT_ADD(LVarF, 1)
                EVT_CALL(N(UnkFloatFunc), LVarF, LocalVar(0), 0, 700, 800, 0, 0)
                EVT_EXEC(N(80247770))
...
EvtScript N(80247BCC) = {
    ...
    EVT_LOOP(120)
        EVT_ADD(LVarF, 1)
        EVT_CALL(N(UnkFloatFunc), LVarF, LocalVar(0), 70, 0, 120, 0, 0)
        EVT_EXEC(N(80247770))
        EVT_SETF(LocalVar(2), LocalVar(0))
        EVT_MULF(LocalVar(2), EVT_FLOAT(-3.0))
        EVT_SETF(LocalVar(3), LocalVar(0))
...
EvtScript N(80247FAC) = {
    ...
    EVT_LOOP(100)
        EVT_ADD(LVarF, 1)
        EVT_CALL(N(UnkFloatFunc), LVarF, LocalVar(0), 0, EVT_FLOAT(1.0), 100, 0, 0)
        EVT_EXEC(N(80247588))
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_SET(MapVar(10), 0)
    EVT_THREAD
        ...
        EVT_LOOP(1200)
            EVT_ADD(LVarF, 1)
            EVT_CALL(N(UnkFloatFunc), LVarF, LocalVar(0), -700, 0, 1200, 0, 0)
            EVT_SETF(LocalVar(2), LocalVar(0))
...
EvtScript N(8024834C) = {
    ...
    EVT_LOOP(5)
        EVT_ADD(LVarF, 20)
        EVT_CALL(N(UnkFloatFunc), LVarF, LocalVar(0), EVT_FLOAT(0.0), EVT_FLOAT(1.0), 100, 0, 0)
        EVT_EXEC(N(802476F4))
        EVT_WAIT(1)
    EVT_END_LOOP
