...
EvtScript N(80242998) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x1100C4), 0, 50, -200)
    EVT_WAIT(10)
...
EvtScript N(80242AF0) = {
    ...
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_WAIT(75)
    EVT_CALL(ShowMessageAtScreenPos, MESSAGE_ID(0x110000), 160, 40)
    ...
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_WAIT(15)
    EVT_CALL(SpeakToPlayer, 0, -1, -1, 5, MESSAGE_ID(0x110001))
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
    EVT_CALL(InterpPlayerYaw, 350, 0)
    EVT_WAIT(15)
    EVT_CALL(ContinueSpeech, 0, -1, -1, 5, MESSAGE_ID(0x110002))
    EVT_WAIT(10)
    ...
    EVT_CALL(func_802D2C14, 1)
    EVT_WAIT(10)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x110003), 0, 70, -200)
    ...
    EVT_WAIT(20)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x110004), 0, 50, -200)
    EVT_CALL(SetCamPitch, 0, EVT_FLOAT(9.0), EVT_FLOAT(-22.0))
    EVT_CALL(SetCamDistance, 0, 333)
    EVT_CALL(SetCamPosA, 0, -2, 0)
    EVT_CALL(PanToTarget, 0, 0, 1)
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_WAIT(10)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x110005), 0, 70, -200)
...
EvtScript N(80242FCC) = {
    ...
    EVT_IF_EQ(GB_StoryProgress, 53)
        EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x110006), 0, 50, -200)
        EVT_SET(GB_StoryProgress, 54)
        EVT_CALL(DisablePlayerInput, FALSE)
        EVT_RETURN
    EVT_END_IF
    EVT_IF_LT(GB_StoryProgress, 60)
        EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x11000D), 0, 50, -200)
        EVT_CALL(ShowChoice, MESSAGE_ID(0x1E001F))
        EVT_WAIT(10)
        EVT_SWITCH(LVar0)
            EVT_CASE_EQ(0)
                EVT_SWITCH(GB_StoryProgress)
                    EVT_CASE_LT(45)
                        EVT_CALL(SwitchMessage, MESSAGE_ID(0x11000E))
                    EVT_CASE_LT(46)
                        EVT_CALL(SwitchMessage, MESSAGE_ID(0x11000F))
                    EVT_CASE_LT(49)
                        EVT_CALL(SwitchMessage, MESSAGE_ID(0x110010))
                    EVT_CASE_LT(53)
                        EVT_CALL(SwitchMessage, MESSAGE_ID(0x110011))
                    EVT_CASE_LT(55)
                        EVT_CALL(SwitchMessage, MESSAGE_ID(0x110007))
                    EVT_CASE_LT(58)
                        EVT_CALL(SwitchMessage, MESSAGE_ID(0x110012))
                    EVT_CASE_DEFAULT
                        EVT_CALL(SwitchMessage, MESSAGE_ID(0x110013))
                EVT_END_SWITCH
            EVT_CASE_EQ(1)
        ...
        EVT_END_SWITCH
    EVT_ELSE
        EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x110014), 0, 50, -200)
        EVT_CALL(ShowChoice, MESSAGE_ID(0x1E001F))
        EVT_WAIT(10)
        EVT_SWITCH(LVar0)
            EVT_CASE_EQ(0)
                EVT_CALL(SwitchMessage, MESSAGE_ID(0x110015))
            EVT_CASE_EQ(1)
                EVT_CALL(CloseMessage)
                EVT_EXEC(N(8024196C))
                EVT_RETURN
...
EvtScript N(80243368) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x11000B), 0, 50, -200)
    ...
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_WAIT(10)
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x11000C), 0, 50, -200)
    EVT_CALL(ResetCam, 0, EVT_FLOAT(90.0))
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_8024352C) = {
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(45)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_00_Anim_3, NPC_ANIM_bubulb_Palette_00_Anim_2, 0, MESSAGE_ID(0x110016))
        EVT_CASE_LT(46)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_00_Anim_3, NPC_ANIM_bubulb_Palette_00_Anim_2, 0, MESSAGE_ID(0x110017))
        EVT_CASE_LT(49)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_00_Anim_3, NPC_ANIM_bubulb_Palette_00_Anim_2, 0, MESSAGE_ID(0x110018))
        EVT_CASE_LT(53)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_00_Anim_3, NPC_ANIM_bubulb_Palette_00_Anim_2, 0, MESSAGE_ID(0x110019))
        EVT_CASE_LT(57)
            EVT_SWITCH(AreaFlag(18))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_00_Anim_9, NPC_ANIM_bubulb_Palette_00_Anim_8, 0, MESSAGE_ID(0x11001A))
                    EVT_SET(AreaFlag(18), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_00_Anim_9, NPC_ANIM_bubulb_Palette_00_Anim_8, 0, MESSAGE_ID(0x11001B))
                    EVT_SET(AreaFlag(18), 0)
            EVT_END_SWITCH
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_00_Anim_9, NPC_ANIM_bubulb_Palette_00_Anim_8, 0, MESSAGE_ID(0x11001C))
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_802436C0) = {
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(45)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_01_Anim_3, NPC_ANIM_bubulb_Palette_01_Anim_2, 0, MESSAGE_ID(0x11001D))
        EVT_CASE_LT(46)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_01_Anim_3, NPC_ANIM_bubulb_Palette_01_Anim_2, 0, MESSAGE_ID(0x11001E))
        EVT_CASE_LT(49)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_01_Anim_3, NPC_ANIM_bubulb_Palette_01_Anim_2, 0, MESSAGE_ID(0x11001F))
        EVT_CASE_LT(53)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_01_Anim_3, NPC_ANIM_bubulb_Palette_01_Anim_2, 0, MESSAGE_ID(0x110020))
        EVT_CASE_LT(57)
            EVT_SWITCH(AreaFlag(19))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_01_Anim_3, NPC_ANIM_bubulb_Palette_01_Anim_2, 0, MESSAGE_ID(0x110021))
                    EVT_SET(AreaFlag(19), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_01_Anim_3, NPC_ANIM_bubulb_Palette_01_Anim_2, 0, MESSAGE_ID(0x110022))
                    EVT_SET(AreaFlag(19), 0)
            EVT_END_SWITCH
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_01_Anim_3, NPC_ANIM_bubulb_Palette_01_Anim_2, 0, MESSAGE_ID(0x110023))
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_80243854) = {
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(45)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_02_Anim_3, NPC_ANIM_bubulb_Palette_02_Anim_2, 0, MESSAGE_ID(0x110024))
        EVT_CASE_LT(46)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_02_Anim_3, NPC_ANIM_bubulb_Palette_02_Anim_2, 0, MESSAGE_ID(0x110025))
        EVT_CASE_LT(49)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_02_Anim_3, NPC_ANIM_bubulb_Palette_02_Anim_2, 0, MESSAGE_ID(0x110026))
        EVT_CASE_LT(53)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_02_Anim_3, NPC_ANIM_bubulb_Palette_02_Anim_2, 0, MESSAGE_ID(0x110027))
        EVT_CASE_LT(57)
            EVT_SWITCH(AreaFlag(20))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_02_Anim_9, NPC_ANIM_bubulb_Palette_02_Anim_8, 0, MESSAGE_ID(0x110028))
                    EVT_SET(AreaFlag(20), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_02_Anim_9, NPC_ANIM_bubulb_Palette_02_Anim_8, 0, MESSAGE_ID(0x110029))
                    EVT_SET(AreaFlag(20), 0)
            EVT_END_SWITCH
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_02_Anim_9, NPC_ANIM_bubulb_Palette_02_Anim_8, 0, MESSAGE_ID(0x11002A))
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_802439E8) = {
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(45)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_03_Anim_3, NPC_ANIM_bubulb_Palette_03_Anim_2, 0, MESSAGE_ID(0x11002B))
        EVT_CASE_LT(46)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_03_Anim_3, NPC_ANIM_bubulb_Palette_03_Anim_2, 0, MESSAGE_ID(0x11002C))
        EVT_CASE_LT(49)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_03_Anim_3, NPC_ANIM_bubulb_Palette_03_Anim_2, 0, MESSAGE_ID(0x11002D))
        EVT_CASE_LT(53)
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_03_Anim_3, NPC_ANIM_bubulb_Palette_03_Anim_2, 0, MESSAGE_ID(0x11002E))
        EVT_CASE_LT(57)
            EVT_SWITCH(AreaFlag(21))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_03_Anim_9, NPC_ANIM_bubulb_Palette_03_Anim_8, 0, MESSAGE_ID(0x11002F))
                    EVT_SET(AreaFlag(21), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_03_Anim_9, NPC_ANIM_bubulb_Palette_03_Anim_8, 0, MESSAGE_ID(0x110030))
                    EVT_SET(AreaFlag(21), 0)
            EVT_END_SWITCH
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_bubulb_Palette_03_Anim_9, NPC_ANIM_bubulb_Palette_03_Anim_8, 0, MESSAGE_ID(0x110031))
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(45)
            EVT_SWITCH(AreaByte(0))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x110035))
                    EVT_CALL(EndSpeech, -1, NPC_ANIM_tolielup_Palette_00_Anim_3, NPC_ANIM_tolielup_Palette_00_Anim_3, 0)
                    EVT_SET(AreaByte(0), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x110038))
                    EVT_CALL(EndSpeech, -1, NPC_ANIM_tolielup_Palette_00_Anim_3, NPC_ANIM_tolielup_Palette_00_Anim_3, 0)
                    EVT_SET(AreaByte(0), 2)
                EVT_CASE_EQ(2)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x110039))
                    EVT_CALL(EndSpeech, -1, NPC_ANIM_tolielup_Palette_00_Anim_3, NPC_ANIM_tolielup_Palette_00_Anim_3, 0)
        ...
        EVT_CASE_LT(47)
            EVT_SWITCH(AreaByte(0))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x110036))
                    EVT_CALL(EndSpeech, -1, NPC_ANIM_tolielup_Palette_00_Anim_3, NPC_ANIM_tolielup_Palette_00_Anim_3, 0)
                    EVT_SET(AreaByte(0), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x110038))
        ...
        EVT_CASE_LT(53)
            EVT_SWITCH(AreaByte(0))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x110037))
                    EVT_CALL(EndSpeech, -1, NPC_ANIM_tolielup_Palette_00_Anim_3, NPC_ANIM_tolielup_Palette_00_Anim_3, 0)
                    EVT_SET(AreaByte(0), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x110038))
        ...
        EVT_CASE_LT(57)
            ...
            EVT_END_SWITCH
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, NPC_ANIM_tolielup_Palette_00_Anim_2, NPC_ANIM_tolielup_Palette_00_Anim_1, 0, MESSAGE_ID(0x11003A))
            EVT_CALL(EndSpeech, -1, NPC_ANIM_tolielup_Palette_00_Anim_3, NPC_ANIM_tolielup_Palette_00_Anim_3, 0)
    EVT_END_SWITCH
...
EvtScript N(8024427C) = {
    ...
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_WAIT(40)
    EVT_CALL(SpeakToPlayer, 6, NPC_ANIM_world_klevar_Palette_00_Anim_3, NPC_ANIM_world_klevar_Palette_00_Anim_1, 512, MESSAGE_ID(0x1100D8))
    ...
    EVT_CALL(ShowMessageAtScreenPos, MESSAGE_ID(0x1D0196), 160, 40)
    EVT_WAIT(10)
    ...
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_WAIT(10)
    EVT_CALL(SpeakToPlayer, 6, NPC_ANIM_world_klevar_Palette_00_Anim_3, NPC_ANIM_world_klevar_Palette_00_Anim_1, 512, MESSAGE_ID(0x1100D9))
    EVT_WAIT(10)
    EVT_CALL(GetPlayerPos, LVar0, LVar1, LVar2)
    EVT_ADD(LVar0, -25)
    EVT_CALL(SetPanTarget, 0, LVar0, LVar1, LVar2)
    ...
    EVT_CALL(WaitForCam, 0, EVT_FLOAT(1.0))
    EVT_WAIT(10)
    EVT_CALL(SpeakToPlayer, 6, NPC_ANIM_world_klevar_Palette_00_Anim_3, NPC_ANIM_world_klevar_Palette_00_Anim_1, 512, MESSAGE_ID(0x1100DA))
...
EvtScript N(interact_80244C98) = {
    EVT_IF_LE(GB_StoryProgress, 53)
        EVT_CALL(SpeakToPlayer, 7, NPC_ANIM_lakilulu_Palette_00_Anim_4, NPC_ANIM_lakilulu_Palette_00_Anim_1, 0, MESSAGE_ID(0x110032))
    EVT_ELSE
        ...
        EVT_IF_EQ(LVar0, 8)
            ...
            EVT_WAIT(10)
            EVT_CALL(DisablePartnerAI, 0)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, NPC_ANIM_world_lakilester_Palette_00_Anim_B, NPC_ANIM_world_lakilester_Palette_00_Anim_3, 5, MESSAGE_ID(0x110033))
            ...
            EVT_CALL(EnablePartnerAI)
        EVT_ELSE
            EVT_CALL(SpeakToPlayer, 7, NPC_ANIM_lakilulu_Palette_00_Anim_4, NPC_ANIM_lakilulu_Palette_00_Anim_1, 0, MESSAGE_ID(0x110034))
        EVT_END_IF
    EVT_END_IF
    EVT_RETURN
    EVT_END
...
EvtScript N(8024834C) = {
    ...
    EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x11000A), 0, 50, -200)
    EVT_CALL(ResetCam, 0, EVT_FLOAT(90.0))
    EVT_CALL(DisablePlayerInput, FALSE)
    EVT_RETURN
    EVT_END
        ...
        EVT_SWITCH(LVar2)
            ...
            EVT_CASE_DEFAULT
                EVT_SWITCH(AreaFlag(17))
                    EVT_CASE_EQ(0)
                        EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x110008), 0, 10, -200)
                        EVT_SET(AreaFlag(17), 1)
                    EVT_CASE_DEFAULT
                        EVT_CALL(ShowMessageAtWorldPos, MESSAGE_ID(0x110009), 0, 10, -200)
                EVT_END_SWITCH
        EVT_END_SWITCH
        EVT_CALL(DisablePlayerInput, FALSE)
