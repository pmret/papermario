...
EvtScript N(8024196C) = {
    ...
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(RotateGroup, 28, LocalVar(0), 0, 1, 0)
        EVT_WAIT(1)
...
EvtScript N(main) = {
    ...
    EVT_SET(LocalVar(0), 150)
    EVT_SET(LocalVar(1), -270)
    EVT_SET(LocalVar(2), 410)
    EVT_SET(LocalVar(3), 170)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802416C0))
    EVT_SET(LocalVar(0), 115)
    EVT_SET(LocalVar(1), -450)
    EVT_SET(LocalVar(2), 250)
    EVT_SET(LocalVar(3), -270)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802416C0))
    EVT_SET(LocalVar(0), -330)
    EVT_SET(LocalVar(1), 220)
    EVT_SET(LocalVar(2), 45)
    EVT_SET(LocalVar(3), 410)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802416C0))
    EVT_SET(LocalVar(0), -420)
    EVT_SET(LocalVar(1), -260)
    EVT_SET(LocalVar(2), -140)
    EVT_SET(LocalVar(3), 160)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802416C0))
    ...
    EVT_THREAD
        ...
        EVT_LABEL(0)
        EVT_CALL(RandInt, 300, LocalVar(1))
        EVT_ADD(LocalVar(1), 100)
        EVT_CALL(RandInt, 1, LocalVar(2))
...
EvtScript N(80242AF0) = {
    ...
    EVT_CALL(PlayerJump1, LocalVar(0), LocalVar(1), LocalVar(2), 12)
    EVT_WAIT(10)
...
EvtScript N(80242FCC) = {
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_WAIT(2)
    EVT_CALL(GetPlayerActionState, LocalVar(3))
    EVT_SET(LocalVar(4), 0)
    EVT_IF_EQ(LocalVar(3), 0)
        EVT_ADD(LocalVar(4), 1)
    EVT_END_IF
    EVT_IF_EQ(LocalVar(3), 1)
        EVT_ADD(LocalVar(4), 1)
    EVT_END_IF
...
EvtScript N(8024427C) = {
    ...
    EVT_CALL(SetNpcPos, 6, LocalVar(3), LocalVar(4), LocalVar(2))
    ...
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(SetNpcRotation, 6, 0, LocalVar(0), 0)
        EVT_WAIT(1)
        EVT_IF_EQ(LocalVar(1), 0)
            EVT_BREAK_LOOP
        EVT_END_IF
    ...
    EVT_LOOP(5)
        EVT_CALL(PlayEffect, EFFECT_SPARKLES, 3, LocalVar(0), LocalVar(1), LocalVar(2), 20, 0, 0, 0, 0, 0, 0, 0, 0)
        EVT_WAIT(6)
        EVT_CALL(PlayEffect, EFFECT_SPARKLES, 1, LocalVar(0), LocalVar(3), LocalVar(2), 20, 0, 0, 0, 0, 0, 0, 0, 0)
        EVT_WAIT(6)
    EVT_END_LOOP
    EVT_WAIT(20)
    ...
    EVT_CALL(PlayEffect, EFFECT_ENERGY_ORB_WAVE, 4, LocalVar(0), LocalVar(1), LocalVar(2), 1, 30, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(30)
    EVT_CALL(SetPlayerAnimation, ANIM_10002)
    ...
    EVT_WAIT(10)
    EVT_CALL(GetNpcPos, 6, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(SetPanTarget, 0, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_THREAD
        EVT_LOOP(25)
            EVT_CALL(GetNpcPos, 6, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(PlayEffect, EFFECT_SPARKLES, 4, LocalVar(0), LocalVar(1), LocalVar(2), 20, 0, 0, 0, 0, 0, 0, 0, 0)
            EVT_WAIT(4)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(GetNpcPos, 6, LocalVar(2), LocalVar(3), LocalVar(4))
        EVT_SET(LocalVar(5), LocalVar(3))
        EVT_ADD(LocalVar(5), 180)
        EVT_CALL(MakeLerp, LocalVar(3), LocalVar(5), 100, 2)
        EVT_LOOP(0)
            EVT_CALL(UpdateLerp)
            EVT_CALL(SetNpcPos, 6, LocalVar(2), LocalVar(0), LocalVar(4))
            EVT_WAIT(1)
            EVT_IF_EQ(LocalVar(1), 0)
                EVT_BREAK_LOOP
            EVT_END_IF
...
EvtScript N(80245EB8) = {
    ...
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_CALL(DisablePlayerPhysics, TRUE)
    EVT_SET(LocalVar(0), 230)
    EVT_SET(LocalVar(1), 0)
    EVT_SET(LocalVar(2), 350)
    EVT_CALL(UseSettingsFrom, 0, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(SetPanTarget, 0, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(SetCamSpeed, 0, EVT_FLOAT(90.0))
...
EvtScript N(80246850) = {
    ...
    EVT_SUBF(LocalVar(1), EVT_FLOAT(-700.0))
    EVT_DIVF(LocalVar(1), EVT_FLOAT(100.0))
    EVT_SETF(LocalVar(2), LocalVar(1))
    EVT_MULF(LocalVar(2), EVT_FLOAT(100.0))
    EVT_IF_GT(LocalVar(2), 100)
        EVT_SETF(LocalVar(1), EVT_FLOAT(1.0))
    EVT_END_IF
    EVT_CALL(ScaleGroup, 74, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 89, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 91, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 93, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 95, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 97, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 99, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 101, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 103, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 105, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 107, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 109, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 111, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 113, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 115, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 117, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(ScaleModel, 119, LocalVar(1), 1, LocalVar(1))
    EVT_CALL(TranslateGroup, 74, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 89, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 91, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 93, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 95, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 97, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 99, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 101, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 103, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 105, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 107, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 109, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 111, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 113, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 115, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 117, 0, LocalVar(0), 0)
    EVT_CALL(TranslateModel, 119, 0, LocalVar(0), 0)
    EVT_SETF(LocalVar(1), LocalVar(0))
    EVT_MULF(LocalVar(1), EVT_FLOAT(-12.0))
    EVT_CALL(RotateGroup, 74, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 89, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 91, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 93, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 95, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 97, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 99, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 101, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 103, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 105, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 107, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 109, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 111, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 113, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 115, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 117, LocalVar(1), 0, 1, 0)
    EVT_CALL(RotateModel, 119, LocalVar(1), 0, 1, 0)
    ...
    EVT_SETF(LocalVar(1), LocalVar(0))
    EVT_SUBF(LocalVar(1), EVT_FLOAT(-700.0))
    EVT_DIVF(LocalVar(1), EVT_FLOAT(300.0))
    EVT_SETF(LocalVar(2), LocalVar(1))
    EVT_MULF(LocalVar(2), EVT_FLOAT(100.0))
    EVT_IF_GT(LocalVar(2), 100)
        EVT_SETF(LocalVar(1), EVT_FLOAT(1.0))
    EVT_END_IF
    EVT_CALL(ScaleModel, 89, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 91, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 93, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 95, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 97, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 99, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 101, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 103, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 105, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 107, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 109, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 111, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 113, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 115, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 117, LocalVar(1), LocalVar(1), LocalVar(1))
    EVT_CALL(ScaleModel, 119, LocalVar(1), LocalVar(1), LocalVar(1))
...
EvtScript N(80247488) = {
    ...
    EVT_IF_GT(LocalVar(2), 100)
        EVT_SETF(LocalVar(1), EVT_FLOAT(1.0))
    EVT_END_IF
    EVT_CALL(ScaleGroup, 79, LocalVar(1), 1, LocalVar(1))
...
EvtScript N(80247588) = {
    ...
    EVT_SETF(LocalVar(1), LocalVar(0))
    EVT_MULF(LocalVar(1), EVT_FLOAT(90.0))
    EVT_CALL(RotateModel, 83, LocalVar(1), 0, 0, -1)
    EVT_CALL(RotateModel, 85, LocalVar(1), 0, 0, 1)
    EVT_CALL(TranslateModel, 83, EVT_FLOAT(-9.5), EVT_FLOAT(-12.0), EVT_FLOAT(-15.0))
    EVT_CALL(TranslateModel, 85, EVT_FLOAT(9.5), EVT_FLOAT(-12.0), EVT_FLOAT(-15.0))
    EVT_CALL(TranslateModel, 87, EVT_FLOAT(0.0), EVT_FLOAT(0.0), EVT_FLOAT(-17.0))
    EVT_CALL(ScaleModel, 83, LocalVar(0), LocalVar(0), LocalVar(0))
    EVT_CALL(ScaleModel, 85, LocalVar(0), LocalVar(0), LocalVar(0))
    EVT_CALL(ScaleModel, 87, LocalVar(0), LocalVar(0), LocalVar(0))
    EVT_RETURN
    EVT_END
};

EvtScript N(802476F4) = {
    EVT_CALL(ScaleModel, 81, LocalVar(0), LocalVar(0), LocalVar(0))
    EVT_SETF(LocalVar(1), LocalVar(0))
    EVT_MULF(LocalVar(1), EVT_FLOAT(90.0))
    EVT_ADDF(LocalVar(1), EVT_FLOAT(-90.0))
    EVT_CALL(RotateModel, 81, LocalVar(1), 1, 0, 0)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(80247770) = {
    ...
    EVT_CALL(TranslateModel, 81, EVT_FLOAT(-0.26), LocalVar(0), EVT_FLOAT(1.4775390625))
    EVT_CALL(RotateModel, 81, LocalVar(1), 0, 1, 0)
...
EvtScript N(802477EC) = {
    EVT_IF_EQ(AreaFlag(44), 0)
        ...
        EVT_CALL(ModifyColliderFlags, 0, 48, 0x7FFFFE00)
        EVT_SET(LocalVar(9), EVT_FLOAT(-59.0))
        EVT_SET(LocalVar(10), EVT_FLOAT(22.0))
        EVT_SET(LocalVar(11), EVT_FLOAT(125.0))
        EVT_SET(LocalVar(12), EVT_FLOAT(-55.0))
        EVT_SET(LocalVar(13), EVT_FLOAT(24.0))
        EVT_SET(LocalVar(14), EVT_FLOAT(145.0))
        EVT_CALL(PlayerMoveTo, LocalVar(9), LocalVar(11), 8)
        EVT_CALL(SetNpcJumpscale, NPC_PARTNER, EVT_FLOAT(0.0))
        EVT_CALL(NpcJump0, NPC_PARTNER, LocalVar(12), LocalVar(13), LocalVar(14), 5)
        EVT_CALL(PlaySound, 0x19C)
        EVT_CALL(SetMusicTrack, 0, SONG_MAGIC_BEANSTALK, 1, 8)
        EVT_CALL(SetNpcAnimation, NPC_PARTNER, 0x000106)
        EVT_CALL(SetPlayerAnimation, ANIM_WALKING)
        EVT_CALL(N(func_80240F10_C9EE30), LocalVar(3), LocalVar(4))
        ...
        EVT_THREAD
            ...
            EVT_LOOP(0)
                ...
                EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), 0, 700, 800, 0, 0)
                EVT_EXEC(N(80247770))
...
EvtScript N(80247BCC) = {
    ...
    EVT_SET(LocalVar(11), EVT_FLOAT(125.0))
    EVT_SET(LocalVar(12), EVT_FLOAT(-55.0))
    EVT_SET(LocalVar(13), EVT_FLOAT(23.0))
    EVT_SET(LocalVar(14), EVT_FLOAT(145.0))
    EVT_THREAD
        EVT_WAIT(5)
        EVT_CALL(SetNpcAnimation, NPC_PARTNER, 0x000106)
    ...
    EVT_LOOP(120)
        EVT_ADD(LocalVar(15), 1)
        EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), 70, 0, 120, 0, 0)
        EVT_EXEC(N(80247770))
        EVT_SETF(LocalVar(2), LocalVar(0))
        EVT_MULF(LocalVar(2), EVT_FLOAT(-3.0))
        EVT_SETF(LocalVar(3), LocalVar(0))
...
EvtScript N(80247FAC) = {
    ...
    EVT_LOOP(100)
        EVT_ADD(LocalVar(15), 1)
        EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), 0, EVT_FLOAT(1.0), 100, 0, 0)
        EVT_EXEC(N(80247588))
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_SET(MapVar(10), 0)
    EVT_THREAD
        ...
        EVT_LOOP(1200)
            EVT_ADD(LocalVar(15), 1)
            EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), -700, 0, 1200, 0, 0)
            EVT_SETF(LocalVar(2), LocalVar(0))
...
EvtScript N(8024834C) = {
    ...
    EVT_SET(LocalVar(15), 0)
    EVT_LOOP(5)
        EVT_ADD(LocalVar(15), 20)
        EVT_CALL(N(UnkFloatFunc), LocalVar(15), LocalVar(0), EVT_FLOAT(0.0), EVT_FLOAT(1.0), 100, 0, 0)
        EVT_EXEC(N(802476F4))
        EVT_WAIT(1)
    EVT_END_LOOP
...
EvtScript N(80248D3C) = {
    EVT_LABEL(0)
    EVT_CALL(IsPlayerWithin, -85, 85, 20, LocalVar(0))
