...
EvtScript N(main) = {
    ...
    EVT_SET(LocalVar(0), -511)
    EVT_SET(LocalVar(1), -4)
    EVT_SET(LocalVar(2), -319)
    EVT_SET(LocalVar(3), 10)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802418F0))
    EVT_SET(LocalVar(0), -302)
    EVT_SET(LocalVar(1), 77)
    EVT_SET(LocalVar(2), -32)
    EVT_SET(LocalVar(3), 116)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802418F0))
    EVT_SET(LocalVar(0), 51)
    EVT_SET(LocalVar(1), 18)
    EVT_SET(LocalVar(2), 141)
    EVT_SET(LocalVar(3), 127)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802418F0))
    EVT_SET(LocalVar(0), 234)
    EVT_SET(LocalVar(1), 38)
    EVT_SET(LocalVar(2), 502)
    EVT_SET(LocalVar(3), 98)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802418F0))
    EVT_SET(LocalVar(0), -525)
    EVT_SET(LocalVar(1), -163)
    EVT_SET(LocalVar(2), -400)
    EVT_SET(LocalVar(3), -80)
    EVT_SET(LocalVar(4), 60)
    EVT_EXEC(N(802418F0))
    EVT_SET(LocalVar(0), -346)
    EVT_SET(LocalVar(1), -148)
    EVT_SET(LocalVar(2), 517)
    EVT_SET(LocalVar(3), -91)
    EVT_SET(LocalVar(4), 60)
    EVT_EXEC(N(802418F0))
...
EvtScript N(802425DC) = {
    ...
    EVT_SET(LocalVar(3), 83)
    EVT_SET(LocalVar(4), 84)
    EVT_SET(LocalVar(5), 85)
    EVT_SET(LocalVar(6), 86)
    EVT_SET(LocalVar(10), 0)
    EVT_EXEC(N(802422BC))
    EVT_CALL(GetModelCenter, 89)
    EVT_SET(LocalVar(3), 89)
    EVT_SET(LocalVar(4), 90)
    EVT_SET(LocalVar(5), 91)
    EVT_SET(LocalVar(6), 92)
    EVT_SET(LocalVar(10), 0)
    EVT_EXEC(N(802422BC))
    EVT_CALL(GetModelCenter, 97)
    EVT_SET(LocalVar(3), 97)
    EVT_SET(LocalVar(4), 98)
    EVT_SET(LocalVar(5), 99)
    EVT_SET(LocalVar(6), 100)
    EVT_SET(LocalVar(10), 0)
    EVT_EXEC(N(802422BC))
    EVT_CALL(GetModelCenter, 103)
    EVT_SET(LocalVar(3), 103)
    EVT_SET(LocalVar(4), 104)
    EVT_SET(LocalVar(5), 105)
    EVT_SET(LocalVar(6), 106)
    EVT_SET(LocalVar(10), 0)
    EVT_EXEC(N(802422BC))
    EVT_RETURN
    EVT_END
...
EvtScript N(802431E4) = {
    ...
    EVT_IF_LT(LocalVar(1), 0)
        EVT_CALL(GetModelCenter, LocalVar(9))
        EVT_ADD(LocalVar(2), 35)
