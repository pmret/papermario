...
Script N(802428C4) = SCRIPT({
    ...
    bind N(shakeTree_802415AC) to TRIGGER_WALL_HAMMER 4;
    bind N(shakeTree_802415AC) to TRIGGER_POINT_BOMB N(triggerCoord_802428B4);
});
