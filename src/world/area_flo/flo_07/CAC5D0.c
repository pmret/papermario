...
EvtScript N(main) = {
    ...
    EVT_SET(LocalVar(1), -95)
    EVT_SET(LocalVar(2), 383)
    EVT_SET(LocalVar(3), -65)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(8024096C))
    EVT_SET(LocalVar(0), 293)
    EVT_SET(LocalVar(1), 71)
    EVT_SET(LocalVar(2), 378)
    EVT_SET(LocalVar(3), 113)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(8024096C))
    EVT_SET(LocalVar(0), 21)
    EVT_SET(LocalVar(1), -346)
    EVT_SET(LocalVar(2), 147)
    EVT_SET(LocalVar(3), -242)
    EVT_SET(LocalVar(4), 20)
    EVT_EXEC(N(8024096C))
    EVT_SET(LocalVar(0), -350)
    EVT_SET(LocalVar(1), -190)
    EVT_SET(LocalVar(2), -81)
    EVT_SET(LocalVar(3), -106)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(8024096C))
    EVT_SET(LocalVar(0), -380)
    EVT_SET(LocalVar(1), 85)
    EVT_SET(LocalVar(2), -95)
...
EvtScript N(802424F4) = {
    EVT_IF_NE(AreaByte(3), 0)
        ...
        EVT_IF_LT(AreaByte(3), 5)
            ...
            EVT_CALL(PlayerMoveTo, 410, LocalVar(3), 10)
