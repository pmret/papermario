...
EvtScript N(80241C14) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_00C5)
    EVT_WAIT(10)
...
EvtScript N(80241DBC) = {
    EVT_IF_EQ(AreaFlag(6), 1)
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0068)
    EVT_THREAD
        EVT_CALL(SetCamDistance, 0, 300)
    ...
    EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim06, ANIM_Posie_Anim06, 0, MSG_CH6_0069)
    ...
    EVT_WAIT(20)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_006A)
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(45)
            EVT_IF_EQ(AreaFlag(5), 0)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0070)
                EVT_SET(AreaFlag(5), 1)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0071)
            EVT_END_IF
        EVT_CASE_LT(46)
            EVT_CALL(AdjustCam, 0, EVT_FLOAT(4.0), 0, EVT_FLOAT(350.0), EVT_FLOAT(18.0), EVT_FLOAT(-7.5))
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0065)
            EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Posie_Anim05)
            EVT_WAIT(20)
            EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Posie_Anim00)
            EVT_SET(LVar0, 89)
            EVT_SET(LVar1, 1)
            EVT_EXEC_WAIT(N(80241BB4))
            EVT_CALL(AddKeyItem, ITEM_FERTILE_SOIL)
            EVT_SET(GB_StoryProgress, 46)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0066)
        ...
        EVT_CASE_LT(47)
            EVT_IF_EQ(GF_FLO12_RosieRequestedSomethingBeautiful, 1)
                EVT_IF_EQ(AreaFlag(6), 0)
                    ...
                    EVT_CALL(ResetCam, 0, EVT_FLOAT(4.0))
                EVT_ELSE
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0072)
                EVT_END_IF
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0072)
            EVT_END_IF
        EVT_CASE_LT(53)
            ...
            EVT_ELSE
                EVT_IF_LT(GB_StoryProgress, 48)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0073)
                EVT_ELSE
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0074)
                EVT_END_IF
                EVT_CALL(ContinueSpeech, -1, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0075)
            EVT_END_IF
        EVT_CASE_LT(60)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0076)
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_0077)
    EVT_END_SWITCH
...
EvtScript N(802424F4) = {
    EVT_IF_NE(AreaByte(3), 0)
        ...
        EVT_IF_LT(AreaByte(3), 5)
            EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_006E)
            EVT_CALL(GetPlayerPos, LVar1, LVar2, LVar3)
            EVT_CALL(PlayerMoveTo, 410, LVar3, 10)
            EVT_ADD(AreaByte(3), 1)
        EVT_ELSE
            EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim02, ANIM_Posie_Anim01, 0, MSG_CH6_006F)
...
EvtScript N(tree1_Callback) = {
    ...
    EVT_IF_LT(GB_StoryProgress, 47)
        ...
        EVT_WAIT(10)
        EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim04, ANIM_Posie_Anim01, 0, MSG_CH6_0067)
    ...
    EVT_ELSE
        ...
        EVT_ELSE
            ...
            EVT_SWITCH(AreaByte(2))
                EVT_CASE_LT(2)
                    EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim03, ANIM_Posie_Anim01, 0, MSG_CH6_006B)
                EVT_CASE_LT(5)
                    EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim03, ANIM_Posie_Anim01, 0, MSG_CH6_006C)
                EVT_CASE_GE(5)
                    EVT_CALL(SpeakToPlayer, 0, ANIM_Posie_Anim03, ANIM_Posie_Anim01, 0, MSG_CH6_006D)
