...
EvtScript N(main) = {
    ...
    EVT_SET(LocalVar(0), -736)
    EVT_SET(LocalVar(1), -137)
    EVT_SET(LocalVar(2), -522)
    EVT_SET(LocalVar(3), -118)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802432F0))
    EVT_SET(LocalVar(0), -728)
    EVT_SET(LocalVar(1), 76)
    EVT_SET(LocalVar(2), -496)
    EVT_SET(LocalVar(3), 137)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802432F0))
    EVT_SET(LocalVar(0), -160)
    EVT_SET(LocalVar(1), -117)
    EVT_SET(LocalVar(2), -92)
    EVT_SET(LocalVar(3), -54)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802432F0))
    EVT_SET(LocalVar(0), 76)
    EVT_SET(LocalVar(1), -124)
    EVT_SET(LocalVar(2), 150)
    EVT_SET(LocalVar(3), -55)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802432F0))
    EVT_SET(LocalVar(0), 192)
    EVT_SET(LocalVar(1), 60)
    EVT_SET(LocalVar(2), 309)
    EVT_SET(LocalVar(3), 133)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802432F0))
    EVT_SET(LocalVar(0), 488)
    EVT_SET(LocalVar(1), 46)
    EVT_SET(LocalVar(2), 733)
    EVT_SET(LocalVar(3), 137)
    EVT_SET(LocalVar(4), 0)
    EVT_EXEC(N(802432F0))
...
EvtScript N(80243FD0) = {
    EVT_LOOP(0)
        EVT_CALL(N(func_80240040_CD7320), LocalVar(0))
...
EvtScript N(80244284) = {
    EVT_SET(LocalVar(4), 35)
    EVT_SET(LocalVar(5), 14)
    EVT_SET(LocalVar(6), 15)
    EVT_SET(LocalVar(7), MapVar(10))
    EVT_SET(LocalVar(8), MapVar(11))
    EVT_SET(LocalVar(9), 38)
    EVT_EXEC(N(80243FD0))
    EVT_SET(LocalVar(4), 36)
    EVT_SET(LocalVar(5), 19)
    EVT_SET(LocalVar(6), 20)
    EVT_SET(LocalVar(7), MapVar(12))
    EVT_SET(LocalVar(8), MapVar(13))
    EVT_SET(LocalVar(9), 39)
    EVT_EXEC(N(80243FD0))
    EVT_SET(LocalVar(4), 37)
    EVT_SET(LocalVar(5), 24)
    EVT_SET(LocalVar(6), 25)
    EVT_SET(LocalVar(7), MapVar(14))
    EVT_SET(LocalVar(8), MapVar(15))
