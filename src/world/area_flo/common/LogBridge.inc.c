    ...
    EVT_LOOP(0)
            ...
            EVT_IF_NE(LVar0, ACTION_STATE_HIT_LAVA)
                EVT_IF_EQ(LVar8, 0)
                    EVT_THREAD
                        ...
                        EVT_CALL(PlaySoundAt, SOUND_01DB, SOUND_PARAM_QUIET | SOUND_SPACE_MODE_0, LVar0, LVar1, LVar2)
                    EVT_END_THREAD
                EVT_END_IF
                EVT_IF_LT(LVar7, 90)
                    EVT_IF_EQ(LVar7, 0)
        ...
        EVT_IF_NE(LVar7, 0)
            ...
            EVT_IF_LE(LVar7, 0)
                ...
                EVT_THREAD
                    EVT_CALL(GetModelCenter, LVar5)
                    EVT_CALL(PlaySoundAt, SOUND_01DC, SOUND_SPACE_MODE_0, LVar0, LVar1, LVar2)
                EVT_END_THREAD
