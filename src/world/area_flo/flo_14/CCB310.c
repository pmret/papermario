...
EvtScript N(80243B1C) = {
    ...
    EVT_LOOP(LocalVar(8))
        EVT_SETF(LVarE, LocalVar(2))
        EVT_SUBF(LVarE, LocalVar(0))
        EVT_MULF(LVarE, EVT_FLOAT(0.046875))
        EVT_ADDF(LocalVar(0), LVarE)
        EVT_SETF(LVarE, LocalVar(3))
        EVT_SUBF(LVarE, LocalVar(1))
        EVT_MULF(LVarE, EVT_FLOAT(0.046875))
        EVT_ADDF(LocalVar(1), LVarE)
        EVT_ADDF(LocalVar(4), LocalVar(0))
        EVT_ADDF(LocalVar(5), LocalVar(1))
        EVT_SETF(LVarE, LocalVar(7))
        EVT_SUBF(LVarE, LocalVar(9))
        EVT_MULF(LVarE, EVT_FLOAT(0.203125))
        EVT_ADDF(LocalVar(9), LVarE)
        EVT_CALL(TranslateModel, LVarF, LocalVar(4), LocalVar(5), LocalVar(6))
        EVT_CALL(ScaleModel, LVarF, LocalVar(9), LocalVar(9), LocalVar(9))
        EVT_WAIT(1)
    EVT_END_LOOP
