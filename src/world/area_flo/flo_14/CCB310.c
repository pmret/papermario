...
EvtScript N(80243870) = {
    ...
    EVT_SETF(LocalVar(2), EVT_FIXED(1.0))
    EVT_SETF(LocalVar(4), EVT_FIXED(0.0))
    EVT_SETF(LocalVar(5), EVT_FIXED(0.0))
    EVT_SETF(LocalVar(6), EVT_FIXED(0.0))
    EVT_SET(LocalVar(7), -30)
    EVT_SET(LocalVar(8), 20)
    EVT_DIVF(LocalVar(7), EVT_FIXED(90.0))
    EVT_DIVF(LocalVar(8), EVT_FIXED(90.0))
    ...
    EVT_LOOP(LocalVar(9))
        ...
        EVT_ADDF(LocalVar(2), EVT_FIXED(0.05))
    ...
    EVT_DIVF(LocalVar(7), EVT_FIXED(60.0))
    EVT_DIVF(LocalVar(8), EVT_FIXED(60.0))
    EVT_LOOP(60)
        EVT_CALL(TranslateModel, 123, 591, 55, 121)
        EVT_CALL(ScaleModel, 123, LocalVar(3), LocalVar(3), LocalVar(3))
        EVT_CALL(TranslateModel, 123, LocalVar(4), LocalVar(5), LocalVar(6))
...
EvtScript N(80243B1C) = {
    ...
    EVT_ADDF(LocalVar(0), EVT_FIXED(4.0))
    EVT_MULF(LocalVar(0), EVT_FIXED(-1.0))
    EVT_SETF(LocalVar(1), EVT_FIXED(2.0))
    EVT_SETF(LocalVar(2), LocalVar(0))
    EVT_DIVF(LocalVar(2), EVT_FIXED(10.0))
    EVT_SETF(LocalVar(3), EVT_FIXED(0.4))
    EVT_SETF(LocalVar(4), EVT_FIXED(591.0))
    EVT_SETF(LocalVar(5), EVT_FIXED(60.0))
    EVT_SETF(LocalVar(6), EVT_FIXED(121.0))
    EVT_CALL(RandInt, 3, LocalVar(7))
    EVT_ADDF(LocalVar(7), EVT_FIXED(3.0))
    EVT_MULF(LocalVar(7), EVT_FIXED(0.04))
    EVT_SETF(LocalVar(9), LocalVar(7))
    EVT_DIVF(LocalVar(9), EVT_FIXED(5.0))
    EVT_CALL(RandInt, 50, LocalVar(8))
    EVT_ADD(LocalVar(8), 50)
    EVT_LOOP(LocalVar(8))
        EVT_SETF(LocalVar(14), LocalVar(2))
        EVT_SUBF(LocalVar(14), LocalVar(0))
        EVT_MULF(LocalVar(14), EVT_FIXED(0.046875))
        ...
        EVT_MULF(LocalVar(14), EVT_FIXED(0.203125))
