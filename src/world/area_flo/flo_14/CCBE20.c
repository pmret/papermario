...
EvtScript N(interact_80244790) = {
    EVT_IF_EQ(AreaFlag(37), 1)
        ...
        EVT_CALL(SpeakToPlayer, NPC_SELF, -1, -1, 0, MESSAGE_ID(0x110063))
        EVT_SET(AreaFlag(35), 0)
        EVT_RETURN
    EVT_END_IF
    EVT_SET(AreaFlag(35), 1)
    EVT_IF_EQ(GF_FLO14_GaveBerryToBubblePlant, 0)
        EVT_CALL(SpeakToPlayer, NPC_SELF, -1, -1, 0, MESSAGE_ID(0x11005F))
    EVT_ELSE
        EVT_CALL(SpeakToPlayer, NPC_SELF, -1, -1, 0, MESSAGE_ID(0x110060))
    EVT_END_IF
    ...
    EVT_IF_NE(LVar0, -1)
        ...
        EVT_IF_EQ(LVar0, -1)
            EVT_CALL(SpeakToPlayer, NPC_SELF, -1, -1, 0, MESSAGE_ID(0x110064))
        EVT_ELSE
            EVT_CALL(SpeakToPlayer, NPC_SELF, -1, -1, 0, MESSAGE_ID(0x110061))
            ...
            EVT_EXEC(N(80243870))
            EVT_CALL(SpeakToPlayer, NPC_SELF, -1, -1, 0, MESSAGE_ID(0x110062))
            EVT_THREAD
                EVT_WAIT(40)
            ...
            EVT_CALL(SpeakToPlayer, NPC_SELF, -1, -1, 5, MESSAGE_ID(0x110063))
