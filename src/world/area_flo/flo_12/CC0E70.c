...
EvtScript N(802419F4) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_00C7)
    EVT_WAIT(10)
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(47)
            EVT_SWITCH(GF_FLO12_Met_Rosie)
                EVT_CASE_EQ(0)
                    ...
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim03, ANIM_Rosie_Anim01, 5, MSG_CH6_008C)
                    EVT_CALL(ShowChoice, MSG_Choice_0011)
                    EVT_WAIT(10)
                    EVT_SWITCH(LVar0)
                        EVT_CASE_EQ(0)
                            EVT_CALL(ContinueSpeech, -1, ANIM_Rosie_Anim03, ANIM_Rosie_Anim01, 5, MSG_CH6_008D)
                        EVT_CASE_EQ(1)
                            EVT_CALL(ContinueSpeech, -1, ANIM_Rosie_Anim03, ANIM_Rosie_Anim01, 5, MSG_CH6_008E)
                    EVT_END_SWITCH
                    EVT_CALL(SetNpcFlagBits, 1, ((NPC_FLAG_100)), FALSE)
                    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Rosie_Anim05)
                    EVT_WAIT(10)
                    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Rosie_Anim02)
                    EVT_CALL(MakeItemEntity, ITEM_WATER_STONE, -33, 14, 19, 1, 1380)
                    EVT_WAIT(10)
                    EVT_SWITCH(GF_FLO10_LilyRequestedWaterStone)
                        EVT_CASE_EQ(0)
                            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim04, 5, MSG_CH6_008F)
                        EVT_CASE_EQ(1)
                            EVT_CALL(SetPlayerAnimation, 393218)
                            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim04, 5, MSG_CH6_008F)
                            EVT_CALL(SetPlayerAnimation, 393221)
                            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0091)
                            EVT_CALL(SetPlayerAnimation, ANIM_Mario_AnimPray)
                            EVT_WAIT(40)
                            EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
                            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0092)
                    ...
                    EVT_SWITCH(GF_FLO12_RosieRequestedSomethingBeautiful)
                        EVT_CASE_EQ(0)
                            EVT_IF_EQ(GF_FLO10_LilyRequestedWaterStone, 1)
                                EVT_EXEC(N(80241BE4))
                                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim04, 5, MSG_CH6_0090)
                                EVT_CALL(SetPlayerAnimation, 393221)
                                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0091)
                                EVT_CALL(SetPlayerAnimation, ANIM_Mario_AnimPray)
                                EVT_WAIT(40)
                            ...
                            EVT_END_IF
                        EVT_CASE_EQ(1)
                            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0093)
                    EVT_END_SWITCH
            EVT_END_SWITCH
        EVT_CASE_LT(48)
            ...
            EVT_IF_NE(LVar0, -1)
                ...
                EVT_CALL(SetCamProperties, 0, EVT_FLOAT(4.0), LVar0, LVar1, LVar2, 325, EVT_FLOAT(19.0), EVT_FLOAT(-9.5))
            EVT_END_IF
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0094)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_LE(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0093)
                EVT_CASE_DEFAULT
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0095)
                    ...
                    EVT_WAIT(10)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0096)
        ...
        EVT_CASE_LT(53)
            EVT_SWITCH(AreaFlag(22))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0097)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0096)
            EVT_END_SWITCH
        EVT_CASE_LT(60)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0098)
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Rosie_Anim04, ANIM_Rosie_Anim02, 5, MSG_CH6_0099)
    EVT_END_SWITCH
