...
Script N(80241F6C) = SCRIPT({
    ...
    bind N(shakeTree_80241900) to TRIGGER_WALL_HAMMER 14;
    bind N(shakeTree_80241900) to TRIGGER_POINT_BOMB N(triggerCoord_80241F28);
    SI_VAR(0) = N(shakeTreeEvent_Tree2);
    bind N(shakeTree_80241900) to TRIGGER_WALL_HAMMER 16;
    bind N(shakeTree_80241900) to TRIGGER_POINT_BOMB N(triggerCoord_80241F5C);
});
