...
void N(appendGfx_test_reflection_floor)(void* data) {
    ...
    spr_set_player_imgfx_update_all(trueAnimation, IMGFX_UPD_SET_ALPHA, 255, 255, 255, 20, 0);
    spr_draw_player_sprite(PLAYER_SPRITE_AUX1, 0, 0, 0, sp20);
    spr_set_player_imgfx_update_all(trueAnimation, IMGFX_UPD_CLEAR, 0, 0, 0, 0, 0);
}
