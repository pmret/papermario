...
EvtScript N(EVS_InspectFlowers_South) = {
    ...
    EVT_CALL(PlaySoundAt, SOUND_FLOWERS_LAUGH, SOUND_SPACE_MODE_0, -10, 0, -300)
...
EvtScript N(EVS_InspectFlowers_West) = {
    ...
    EVT_WAIT(15)
    EVT_CALL(PlaySoundAt, SOUND_FLOWERS_WITHER, SOUND_SPACE_MODE_0, -300, 0, -10)
...
EvtScript N(EVS_InspectFlowers_North) = {
    ...
    EVT_WAIT(15)
    EVT_CALL(PlaySoundAt, SOUND_FLOWERS_WITHER, SOUND_SPACE_MODE_0, 10, 0, 300)
