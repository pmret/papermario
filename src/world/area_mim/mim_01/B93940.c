...
/*
ApiStatus N(func_802408BC_B93CFC)(ScriptInstance *script, s32 isInitialCall) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
    Enemy* enemy2;
    Npc* npc2;
...
ApiStatus N(func_80240B1C_B93F5C)(ScriptInstance *script, s32 isInitialCall) {
    ...
    if ((script->functionTemp[0].s < 30) && (enemy->varTable[0] == 0) && N(func_80240708_B93B48)(script)) {
...
INCLUDE_ASM(s32, "world/area_mim/mim_01/B93940", func_80241978_B94DB8);
...
INCLUDE_ASM(s32, "world/area_mim/mim_01/B93940", func_80241B68_B94FA8);
