...
EvtScript N(EVS_Scene_UnlockGate) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_GateBoo_01, SOUND_BOO_VANISH_A, SOUND_SPACE_MODE_0)
    ...
    EVT_WAIT(10 * DT)
    EVT_CALL(PlaySoundAtNpc, NPC_GateBoo_01, SOUND_BOO_APPEAR_A, SOUND_SPACE_MODE_0)
