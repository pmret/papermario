...
EvtScript N(EVS_Scene_PuzzleSolved) = {
    ...
    EVT_THREAD
        EVT_WAIT(50)
        EVT_CALL(PlaySoundAtModel, MODEL_k1, SOUND_0030, 0)
        EVT_WAIT(25)
        EVT_CALL(PlaySoundAtModel, MODEL_k2, SOUND_01EE, 0)
        EVT_WAIT(5)
        EVT_CALL(PlaySoundAtModel, MODEL_k3, SOUND_01EE, 0)
        EVT_WAIT(5)
        EVT_CALL(PlaySoundAtModel, MODEL_k3, SOUND_01EE, 0)
        EVT_WAIT(5)
        EVT_CALL(PlaySoundAtModel, MODEL_k3, SOUND_01EE, 0)
...
EvtScript N(EVS_PushStatue_Impl) = {
    ...
    EVT_CALL(PlaySoundAtCollider, LVar9, SOUND_002D, 0)
