...
EvtScript N(EVS_Scene_PuzzleSolved) = {
    ...
    EVT_THREAD
        EVT_WAIT(45)
        EVT_CALL(SetGroupVisibility, MODEL_g255, 1)
        EVT_CALL(SetGroupVisibility, MODEL_g262, 1)
        EVT_CALL(SetGroupVisibility, MODEL_g264, 1)
        EVT_CALL(SetGroupVisibility, MODEL_g265, 1)
...
EvtScript N(EVS_SetupPuzzle) = {
    ...
    EVT_IF_GE(GB_StoryProgress, STORY_CH7_SOLVED_ALBINO_DINO_PUZZLE)
        ...
        EVT_CALL(SetGroupVisibility, MODEL_no, 0)
        EVT_CALL(SetGroupVisibility, MODEL_kage_yuka, 1)
    EVT_ELSE
        ...
        EVT_CALL(SetGroupVisibility, MODEL_g255, 0)
        EVT_CALL(SetGroupVisibility, MODEL_g262, 0)
        EVT_CALL(SetGroupVisibility, MODEL_g264, 0)
        EVT_CALL(SetGroupVisibility, MODEL_g265, 0)
        EVT_CALL(SetGroupVisibility, MODEL_no, 1)
        EVT_CALL(SetGroupVisibility, MODEL_kage_yuka, 0)
