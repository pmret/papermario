...
EvtScript N(EVS_ExitDoors_pra_21_1) = {
    ...
    EVT_WAIT(17)
    EVT_CALL(GotoMap, EVT_PTR("pra_21"), pra_21_ENTRY_1)
    EVT_WAIT(100)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_ExitDoors_pra_27_0) = {
    ...
    EVT_EXEC(ExitSplitDoubleDoor)
    EVT_WAIT(17)
    EVT_CALL(GotoMap, EVT_PTR("pra_27"), pra_27_ENTRY_0)
    EVT_WAIT(100)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_BindExitTriggers) = {
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_ExitDoors_pra_21_1)), TRIGGER_WALL_PRESS_A, COLLIDER_deilittsw, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_ExitDoors_pra_27_0)), TRIGGER_WALL_PRESS_A, COLLIDER_deilittse, 1, 0)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_EnterMap) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(pra_36_ENTRY_0)
            EVT_SET(LVar2, MODEL_o772)
            EVT_SET(LVar3, MODEL_o768)
            EVT_SET(LVar4, MODEL_o844)
            EVT_SET(LVar5, MODEL_o846)
            EVT_EXEC_WAIT(EnterSplitDoubleDoor)
        EVT_CASE_EQ(pra_36_ENTRY_1)
            EVT_SET(LVar2, MODEL_o1019)
            EVT_SET(LVar3, MODEL_o1021)
            EVT_SET(LVar4, MODEL_o1020)
            EVT_SET(LVar5, MODEL_o1022)
