...
EvtScript N(EVS_Scene_RescuedKalmar) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtNpc, NPC_Kalmar, SOUND_2045, 0)
    EVT_END_THREAD
    EVT_WAIT(10)
...
StaticNpc N(NpcData_Kalmar) = {
    ...
    .yaw = 90,
    .flags = ENEMY_FLAG_1 | ENEMY_FLAG_8 | ENEMY_FLAG_100 | ENEMY_FLAG_400 | ENEMY_FLAG_800 | ENEMY_FLAG_200000 | ENEMY_FLAG_400000,
