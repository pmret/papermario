...
EvtScript N(EVS_ExitDoors_pra_03_1) = {
    EVT_SET_GROUP(EVT_GROUP_1B)
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_SET(LVar0, pra_38_ENTRY_0)
    ...
    EVT_WAIT(17)
    EVT_CALL(GotoMap, EVT_PTR("pra_03"), pra_03_ENTRY_1)
    EVT_WAIT(100)
    EVT_RETURN
    EVT_END
};

EvtScript N(EVS_ExitDoors_pra_05_0) = {
    EVT_SET_GROUP(EVT_GROUP_1B)
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_SET(LVar0, pra_38_ENTRY_1)
    ...
    EVT_EXEC(ExitSplitDoubleDoor)
    EVT_WAIT(17)
    EVT_CALL(GotoMap, EVT_PTR("pra_05"), pra_05_ENTRY_0)
    EVT_WAIT(100)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_BindExitTriggers) = {
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_ExitDoors_pra_03_1)), TRIGGER_WALL_PRESS_A, COLLIDER_deilittsw, 1, 0)
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_ExitDoors_pra_05_0)), TRIGGER_WALL_PRESS_A, COLLIDER_deilittse, 1, 0)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_EnterMap) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(pra_38_ENTRY_0)
            EVT_SET(LVar2, MODEL_o772)
            EVT_SET(LVar3, MODEL_o768)
            EVT_SET(LVar4, MODEL_o844)
            EVT_SET(LVar5, MODEL_o846)
            EVT_EXEC_WAIT(EnterSplitDoubleDoor)
        EVT_CASE_EQ(pra_38_ENTRY_1)
            EVT_SET(LVar2, MODEL_o1019)
            EVT_SET(LVar3, MODEL_o1021)
            EVT_SET(LVar4, MODEL_o1020)
            EVT_SET(LVar5, MODEL_o1022)
