...
EvtScript N(EVS_ExitDoors_pra_38_1) = {
    ...
    EVT_WAIT(17)
    EVT_CALL(GotoMap, EVT_PTR("pra_38"), pra_38_ENTRY_1)
    EVT_WAIT(100)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_BindExitTriggers) = {
    EVT_BIND_TRIGGER(EVT_PTR(N(EVS_ExitDoors_pra_38_1)), TRIGGER_WALL_PRESS_A, COLLIDER_deilittsw, 1, 0)
    EVT_RETURN
    EVT_END
};
