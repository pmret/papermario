...
EvtScript N(EVS_NpcDefeat_Clubba_01) = {
    EVT_THREAD
        ...
        EVT_LOOP(10)
            EVT_WAIT(2)
            EVT_CALL(SetGroupEnabled, MODEL_g297, 1)
            EVT_WAIT(2)
            EVT_CALL(SetGroupEnabled, MODEL_g297, 0)
        EVT_END_LOOP
...
EvtScript N(EVS_NpcDefeat_Clubba_02) = {
    EVT_THREAD
        ...
        EVT_LOOP(10)
            EVT_WAIT(2)
            EVT_CALL(SetGroupEnabled, MODEL_g296, 1)
            EVT_WAIT(2)
...
EvtScript N(EVS_NpcDefeat_Clubba_03) = {
    EVT_THREAD
        ...
        EVT_LOOP(10)
            EVT_WAIT(2)
            EVT_CALL(SetGroupEnabled, MODEL_g298, 1)
            EVT_WAIT(2)
            EVT_CALL(SetGroupEnabled, MODEL_g298, 0)
        EVT_END_LOOP
