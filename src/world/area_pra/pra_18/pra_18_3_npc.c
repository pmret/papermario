...
EvtScript N(EVS_NpcDefeat_Clubba_01) = {
    EVT_THREAD
        ...
        EVT_LOOP(10)
            EVT_WAIT(2)
            EVT_CALL(SetGroupVisibility, MODEL_g297, 1)
            EVT_WAIT(2)
            EVT_CALL(SetGroupVisibility, MODEL_g297, 0)
        EVT_END_LOOP
...
EvtScript N(EVS_NpcDefeat_Clubba_02) = {
    EVT_THREAD
        ...
        EVT_LOOP(10)
            EVT_WAIT(2)
            EVT_CALL(SetGroupVisibility, MODEL_g296, 1)
            EVT_WAIT(2)
...
EvtScript N(EVS_NpcDefeat_Clubba_03) = {
    EVT_THREAD
        ...
        EVT_LOOP(10)
            EVT_WAIT(2)
            EVT_CALL(SetGroupVisibility, MODEL_g298, 1)
            EVT_WAIT(2)
            EVT_CALL(SetGroupVisibility, MODEL_g298, 0)
        EVT_END_LOOP
...
NpcData N(NpcData_Clubba_01)[] = {
    {
        ...
        .flags = ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_100000 | ENEMY_FLAG_400000,
        .drops = NO_DROPS,
    ...
    },
    {
        ...
        .settings = &N(NpcSettings_Clubba),
        .flags = ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_HAS_NO_SPRITE | ENEMY_FLAG_400000,
        .drops = NO_DROPS,
        .animations = FROST_CLUBBA_ANIMS,
    },
};
