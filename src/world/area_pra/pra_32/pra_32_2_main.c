...
EvtScript N(EVS_SpawnStarCard) = {
    ...
    EVT_IF_EQ(LVar0, 0)
        ...
        EVT_THREAD
            ...
            EVT_CALL(PlaySoundAt, SOUND_B2, 0, 595, 185, 116)
        EVT_END_THREAD
        EVT_THREAD
            EVT_WAIT(45)
        ...
        EVT_THREAD
            EVT_WAIT(180)
            EVT_WAIT(115)
            EVT_CALL(PlaySoundAt, SOUND_137, 0, 595, 185, 116)
        EVT_END_THREAD
    ...
    EVT_CALL(GotoMapSpecial, EVT_PTR("kmr_23"), kmr_23_ENTRY_6, TRANSITION_14)
    EVT_WAIT(100)
    EVT_RETURN
    EVT_END
};
