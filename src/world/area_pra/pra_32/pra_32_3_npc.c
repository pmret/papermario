...
EvtScript N(EVS_Scene_CrystalKingAppears) = {
    ...
    EVT_CALL(SetNpcImgfxParams, NPC_CrystalKing_01, IMGFX_UPD_SET_ALPHA, 0, 0, 0, 0)
    ...
    EVT_LABEL(5)
    EVT_CALL(UpdateLerp)
    EVT_CALL(SetNpcImgfxParams, NPC_CrystalKing_01, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
    EVT_WAIT(1)
    EVT_IF_EQ(LVar1, 1)
        EVT_GOTO(5)
    EVT_END_IF
