...
EvtScript N(EVS_AnimateCam_CrystalKing) = {
    ...
    EVT_THREAD
        ...
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(MakeLerp, 200, 100, 200, EASING_LINEAR)
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
...
EvtScript N(EVS_Scene_CrystalKingAppears) = {
    ...
    EVT_END_THREAD
    EVT_CALL(MakeLerp, 0, 255, 120, EASING_LINEAR)
    EVT_LABEL(5)
    EVT_CALL(UpdateLerp)
...
EvtScript N(EVS_Scene_BossDefeated) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(MakeLerp, 0, 19 * 360, 210, EASING_COS_IN_OUT)
        EVT_LOOP(0)
            EVT_CALL(UpdateLerp)
    ...
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(MakeLerp, 100, 200, 210, EASING_COS_IN_OUT)
        EVT_LOOP(0)
            EVT_CALL(UpdateLerp)
        ...
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(MakeLerp, 255, 122, 30, EASING_COS_IN_OUT)
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(func_802CFD30, NPC_CrystalKing_01, FOLD_TYPE_7, LVar0, 0, 0, 0)
        EVT_IF_EQ(LVar1, 0)
    ...
    EVT_END_THREAD
    EVT_WAIT(30)
    EVT_CALL(MakeLerp, 120, 0, 30, EASING_COS_IN_OUT)
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(func_802CFD30, NPC_CrystalKing_01, FOLD_TYPE_7, LVar0, 0, 0, 0)
        EVT_IF_EQ(LVar1, 0)
...
NpcData N(NpcData_CrystalKing_01)[] = {
    {
        ...
        .flags = ENEMY_FLAG_ENABLE_HIT_SCRIPT | ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_40000 | ENEMY_FLAG_200000 | ENEMY_FLAG_400000,
        .drops = NO_DROPS,
    ...
    },
    {
        ...
        .settings = &N(NpcSettings_CrystalKing),
        .flags = ENEMY_FLAG_4 | ENEMY_FLAG_ENABLE_HIT_SCRIPT | ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_4000 | ENEMY_FLAG_40000 | ENEMY_FLAG_200000 | ENEMY_FLAG_400000,
        .drops = NO_DROPS,
        .animations = CRYSTAL_KING_ANIMS,
    },
};
