    ...
    switch (script->functionTemp[0]) {
        case 0:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                D_80286528 = msg_get_printer_for_msg(MESSAGE_ID(0x1E0001), &script->functionTemp[2]);
            }
            break;
        case 100:
    ...
    switch (script->functionTemp[0]) {
        case DIALOG_STATE_4:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTemp[2] = 0;
                D_80286538 = msg_get_printer_for_msg(MESSAGE_ID(0x1E0003), &script->functionTemp[2]);
            }
            break;
