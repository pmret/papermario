...
EvtScript N(EVS_PlayIntroSong) = {
    Wait(80)
    Call(SetMusicTrack, 0, SONG_INTRO_STORY, BGM_VARIATION_2, VOL_LEVEL_FULL)
    Return
    End
};
    ...
    Switch(LVar0)
        ...
        CaseDefault
            IfEq(GF_HOS04_Visited, FALSE)
                Call(SetMusicTrack, 0, SONG_STAR_SANCTUARY, BGM_VARIATION_1, VOL_LEVEL_FULL)
            Else
                Call(SetMusicTrack, 0, SONG_STAR_HAVEN, 0, VOL_LEVEL_FULL)
            EndIf
