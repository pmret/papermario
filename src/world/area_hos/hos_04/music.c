...
EvtScript N(EVS_PlayIntroSong) = {
    Wait(80)
    Call(SetMusicTrack, 0, SONG_INTRO_STORY, 2, VOL_LEVEL_8)
    Return
    End
};
    ...
    Switch(LVar0)
        ...
        CaseDefault
            IfEq(GF_HOS04_Visited, FALSE)
                Call(SetMusicTrack, 0, SONG_STAR_SANCTUARY, 1, VOL_LEVEL_8)
            Else
                Call(SetMusicTrack, 0, SONG_STAR_HAVEN, 0, VOL_LEVEL_8)
            EndIf
