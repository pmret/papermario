...
/*
s32 N(func_80240F7C_A3A45C)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
...
/*
s32 N(func_80240FD0_A3A4B0)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
    Bytecode* args = script->ptrReadPos;
...
/*
s32 N(func_802410A4_A3A584)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
