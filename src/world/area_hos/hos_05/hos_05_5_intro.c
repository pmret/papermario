...
EvtScript N(EVS_CaptureSpirits) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Klevar, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Skolar, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Muskular, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Kalmar, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Misstar, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Mamar, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
...
EvtScript N(EVS_Scene_IntroStory) = {
    ...
    EVT_WAIT(50 * DT)
    EVT_CALL(SetNpcFoldParams, NPC_Bowser_Body, IMGFX_UPD_SET_TINT, 0, 0, 0, 0)
    EVT_CALL(SetNpcFoldParams, NPC_Bowser_Prop, IMGFX_UPD_SET_TINT, 0, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_LOOP(50 * DT)
            ...
            EVT_IF_GT(LVar0, 255)
                EVT_SET(LVar0, 255)
            EVT_END_IF
            EVT_CALL(SetNpcFoldParams, NPC_Bowser_Body, IMGFX_UPD_SET_TINT, 0, 0, 0, LVar0)
            EVT_CALL(SetNpcFoldParams, NPC_Bowser_Prop, IMGFX_UPD_SET_TINT, 0, 0, 0, LVar0)
            EVT_WAIT(1)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_END_LOOP
    EVT_WAIT(30 * DT)
    EVT_CALL(SetNpcFoldParams, NPC_Bowser_Body, IMGFX_UPD_SET_TINT, 0, 0, 0, 255)
    EVT_CALL(SetNpcFoldParams, NPC_Bowser_Prop, IMGFX_UPD_SET_TINT, 0, 0, 0, 255)
    EVT_THREAD
        EVT_SET(LVar0, 0)
        EVT_LOOP(4)
            EVT_ADD(LVar0, 70)
            EVT_IF_GT(LVar0, 255)
                EVT_SET(LVar0, 255)
            EVT_END_IF
            EVT_CALL(SetNpcFoldParams, NPC_Bowser_Body, IMGFX_UPD_SET_TINT, LVar0, LVar0, LVar0, 255)
            EVT_CALL(SetNpcFoldParams, NPC_Bowser_Prop, IMGFX_UPD_SET_TINT, LVar0, LVar0, LVar0, 255)
            EVT_WAIT(1)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_WAIT(3)
    ...
    EVT_THREAD
        EVT_WAIT(28)
        EVT_CALL(SetNpcFoldParams, NPC_Eldstar, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_SPIRIT_CAPTURE, 1, 1, 0)
    EVT_END_THREAD
    EVT_SET(LVar0, 255)
    EVT_LOOP(20)
        EVT_CALL(SetNpcFoldParams, NPC_Mamar,    IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_CALL(SetNpcFoldParams, NPC_Skolar,   IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_CALL(SetNpcFoldParams, NPC_Muskular, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_CALL(SetNpcFoldParams, NPC_Misstar,  IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_CALL(SetNpcFoldParams, NPC_Klevar,   IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_CALL(SetNpcFoldParams, NPC_Kalmar,   IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_WAIT(15 * DT)
    EVT_CALL(SetNpcFoldParams, NPC_Eldstar, IMGFX_UPD_SET_ALPHA, 255, 0, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(N(SetCardCaptureState1))
        EVT_CALL(SetNpcAnimation, NPC_Eldstar, ANIM_WorldEldstar_Panic)
        EVT_CALL(SetNpcFoldParams, NPC_Eldstar, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
