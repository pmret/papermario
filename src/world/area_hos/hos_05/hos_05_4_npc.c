...
EvtScript N(EVS_Scene_RecieveStarBeam) = {
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar7, 20)
        EVT_CALL(PlaySoundAt, SOUND_SEQ_1F, SOUND_SPACE_DEFAULT, LVar6, LVar7, LVar8)
    ...
    EVT_END_THREAD
    EVT_WAIT(40)
    EVT_CALL(PlaySoundAt, SOUND_SEQ_1F, SOUND_SPACE_DEFAULT, 10, 154, 88)
    ...
    EVT_LOOP(3)
        EVT_CALL(PlaySoundAt, SOUND_SEQ_1F, SOUND_SPACE_DEFAULT, 0, 154, 88)
