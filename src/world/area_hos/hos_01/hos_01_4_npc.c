...
EvtScript N(EVS_NpcAux_Eldstar) = {
    ...
    EVT_LOOP(0)
        ...
        EVT_LOOP(20)
            ...
            EVT_END_IF
            EVT_CALL(SetNpcFoldParams, NPC_Eldstar,  IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, AB_HOS_StatcAmt_Eldstar,  1, LVar2)
            EVT_CALL(SetNpcFoldParams, NPC_Mamar,    IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, AB_HOS_StatcAmt_Mamar,    1, LVar3)
            EVT_CALL(SetNpcFoldParams, NPC_Skolar,   IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, AB_HOS_StatcAmt_Skolar,   1, LVar3)
            EVT_CALL(SetNpcFoldParams, NPC_Muskular, IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, AB_HOS_StatcAmt_Muskular, 1, LVar3)
            EVT_CALL(SetNpcFoldParams, NPC_Misstar,  IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, AB_HOS_StatcAmt_Misstar,  1, LVar3)
            EVT_CALL(SetNpcFoldParams, NPC_Klevar,   IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, AB_HOS_StatcAmt_Klevar,   1, LVar3)
            EVT_CALL(SetNpcFoldParams, NPC_Kalmar,   IMGFX_UPD_HOLOGRAM, IMGFX_HOLOGRAM_NOISE, AB_HOS_StatcAmt_Kalmar,   1, LVar3)
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_LOOP(20)
            EVT_ADDF(LVar0, EVT_FLOAT(-4.0))
