...
WorldPartner wPartners[12] = {
    {}, // None
    {
        ...
        .idle = ANIM_WorldGoombario_Anim1,
    ...
    },
    {
        ...
        .idle = ANIM_WorldParakarry_Anim1,
        .canPlayerPause = partner_is_idle,
    ...
    },
    {
        ...
        .idle = ANIM_WorldLakilester_Anim1,
        .canPlayerPause = world_partner_can_player_pause_default,
