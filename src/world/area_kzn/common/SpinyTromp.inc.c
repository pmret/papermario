...
EvtScript N(D_80240D10_C7EE90) = {
    ...
    EVT_CALL(UpdatePlayerImgfx, ANIM_Mario1_Fallen, IMGFX_UPD_WAVY, EVT_FLOAT(3.0), EVT_FLOAT(3.0), 0, 0)
    EVT_LABEL(1)
        EVT_WAIT(1)
        ...
        EVT_END_IF
    EVT_WAIT(30)
    EVT_CALL(UpdatePlayerImgfx, ANIM_Mario1_Fallen, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
