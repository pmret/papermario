...
/*
ApiStatus N(func_8024001C_C76CFC)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_8024003C_C76D1C)(ScriptInstance* script, s32 isInitialCall) {
    func_800EB168(get_variable(script, *script->ptrReadPos));
    return ApiStatus_DONE2;
}
*/

INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240068_C76D48);
/*
ApiStatus N(func_80240068_C76D48)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_802400D4_C76DB4);

INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240120_C76E00);
/*
ApiStatus N(func_80240120_C76E00)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240448_C77128);
/*
ApiStatus N(func_80240448_C77128)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240480_C77160);
/*
ApiStatus N(func_80240480_C77160)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240510_C771F0);
/*
ApiStatus N(func_80240510_C771F0)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240544_C77224);
/*
ApiStatus N(func_80240544_C77224)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_802405A8_C77288);
/*
ApiStatus N(func_802405A8_C77288)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240600_C772E0)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    Npc* npc = get_npc_safe(-4);
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240B38_C77818);
/*
s32 N(func_80240B38_C77818)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_09/C76CE0", func_80240D08_C779E8);
