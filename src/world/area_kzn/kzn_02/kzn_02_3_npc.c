...
EvtScript N(EVS_NpcIdle_Kolorado) = {
    ...
    EVT_THREAD
        ...
        EVT_END_IF
    EVT_END_THREAD
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_E8, SOUND_SPACE_MODE_0)
...
StaticNpc N(NpcData_Kolorado) = {
    ...
    .yaw = 90,
    .flags = ENEMY_FLAG_1 | ENEMY_FLAG_8 | ENEMY_FLAG_100 | ENEMY_FLAG_400 | ENEMY_FLAG_10000 | ENEMY_FLAG_100000,
