...
extern API_FUNC(func_80240000_C71480);
extern API_FUNC(func_80240348_C717C8);
...
s32 func_80240000_C71480(Evt* script, s32 isInitialCall) {
    ...
    N(D_80244170_C755F0) += 1.0f;
    if (N(D_80244170_C755F0) > 360.0f) {
        N(D_80244170_C755F0) -= 360.0f;
    }
    ...
    slowOsc = sin_deg(N(D_80244170_C755F0) * 3.0f);
    fastOsc = sin_deg(N(D_80244170_C755F0) * 8.0f);
...
EvtScript N(EVS_Main) = {
    ...
    EVT_THREAD
        EVT_SET_GROUP(EVT_GROUP_00)
        EVT_CALL(func_80240000_C71480, 2, 0)
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(func_80240348_C717C8, EVT_PTR(N(D_80244448_C758C8)))
    EVT_END_THREAD
