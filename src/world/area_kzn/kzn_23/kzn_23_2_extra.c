        ...
        EVT_THREAD
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    ...
                    EVT_SET(LVarE, LVarF)
                    EVT_CALL(LoadPath, 15, EVT_PTR(N(PyroclastPathA)), 4, EASING_QUADRATIC_OUT)
                EVT_CASE_EQ(1)
                    EVT_CALL(PlayEffect, EFFECT_65, 2, -20, 2650, -20, 1, 0, 0, 0, 0, 0, 0, 0, 0)
                    EVT_SET(LVarE, LVarF)
                    EVT_CALL(LoadPath, 10, EVT_PTR(N(PyroclastPathB)), 3, EASING_QUADRATIC_OUT)
                EVT_CASE_EQ(2)
                    EVT_CALL(PlayEffect, EFFECT_65, 2, 10, 2650, -20, 1, 0, 0, 0, 0, 0, 0, 0, 0)
                    EVT_SET(LVarE, LVarF)
                    EVT_CALL(LoadPath, 15, EVT_PTR(N(PyroclastPathC)), 5, EASING_QUADRATIC_OUT)
                EVT_CASE_EQ(3)
                    EVT_CALL(PlayEffect, EFFECT_65, 2, -50, 2650, -20, 1, 0, 0, 0, 0, 0, 0, 0, 0)
                    EVT_SET(LVarE, LVarF)
                    EVT_CALL(LoadPath, 20, EVT_PTR(N(PyroclastPathD)), 6, EASING_QUADRATIC_OUT)
            EVT_END_SWITCH
