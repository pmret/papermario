...
/*
ApiStatus N(func_8024032C_C6845C)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240378_C684A8)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240758_C68888)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_04/C68440", func_80240790_C688C0);
/*
ApiStatus N(func_80240790_C688C0)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_04/C68440", func_80240854_C68984);
/*
ApiStatus N(func_80240854_C68984)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_kzn/kzn_04/C68440", func_802408B8_C689E8);
/*
ApiStatus N(func_802408B8_C689E8)(ScriptInstance *script, s32 isInitialCall) {
...
/*
s32 N(func_80240E48_C68F78)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
