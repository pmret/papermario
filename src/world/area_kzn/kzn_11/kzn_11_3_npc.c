...
s32 N(FireBar_Sounds)[] = {
    SOUND_PAIR_FIRE_BAR_0, SOUND_PAIR_FIRE_BAR_1, SOUND_PAIR_FIRE_BAR_2, SOUND_PAIR_FIRE_BAR_3,
    SOUND_PAIR_FIRE_BAR_4, SOUND_PAIR_FIRE_BAR_5, SOUND_PAIR_FIRE_BAR_6, SOUND_PAIR_FIRE_BAR_7,
    SOUND_PAIR_FIRE_BAR_8, SOUND_PAIR_FIRE_BAR_9, SOUND_PAIR_FIRE_BAR_9,
};
...
EvtScript N(EVS_FireBar_Defeated) = {
    ...
    EVT_CALL(PlaySoundAt, SOUND_PAIR_0A, SOUND_SPACE_MODE_0, LVar1, LVar2, LVar3)
    EVT_LOOP(10)
        EVT_CALL(GetNpcPos, LVar0, LVar1, LVar2, LVar3)
