...
/*
ApiStatus N(func_8024006C_892A8C)(ScriptInstance* script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_80240150_892B70);
/*
ApiStatus N(func_80240150_892B70)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_80240478_892E98);
/*
ApiStatus N(func_80240478_892E98)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_802404B0_892ED0);
/*
ApiStatus N(func_802404B0_892ED0)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_80240540_892F60);
/*
ApiStatus N(func_80240540_892F60)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_80240574_892F94);
/*
ApiStatus N(func_80240574_892F94)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_802405D8_892FF8);
/*
ApiStatus N(func_802405D8_892FF8)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_80240630_893050);
/*
ApiStatus N(func_80240630_893050)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    Npc* npc = get_npc_safe(-4);
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_80240B68_893588);
/*
s32 N(func_80240B68_893588)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
...
INCLUDE_ASM(s32, "world/area_tik/tik_17/892A50", func_80240D38_893758);