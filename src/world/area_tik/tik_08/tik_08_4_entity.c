...
EvtScript N(EVS_SpawnSwitch) = {
    EVT_CALL(PlaySoundAt, SOUND_301, 0, 90, 200, 100)
    ...
    EVT_LOOP(0)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(PlaySoundAt, SOUND_48, 0, 90, LVar0, 100)
...
EvtScript N(EVS_MakeEntities) = {
    EVT_IF_EQ(GF_TIK08_WarpPipe, FALSE)
        EVT_CALL(MakeEntity, EVT_PTR(Entity_BlueSwitch), 0, -1000, 0, 0, MAKE_ENTITY_END)
