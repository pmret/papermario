...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(PlaySound, SOUND_LOOP_TIK02_WATER)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_TIK02_FLOW2, SOUND_SPACE_WITH_DEPTH, -230, -180, 120)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_TIK02_FLOW3, SOUND_SPACE_WITH_DEPTH, 20, -180, 120)
