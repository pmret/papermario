...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(PlaySound, SOUND_LOOP_44)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_45, SOUND_SPACE_WITH_DEPTH, 0, -20, 30)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_46, SOUND_SPACE_WITH_DEPTH, 270, -20, 30)
