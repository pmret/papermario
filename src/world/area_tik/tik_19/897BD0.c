...
/*
ApiStatus N(func_8024060C_897BEC)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240658_897C38)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_802406C4_897CA4);

INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_80240710_897CF0);
/*
ApiStatus N(func_80240710_897CF0)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
/*
ApiStatus N(func_80240A38_898018)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_80240A70_898050);
/*
ApiStatus N(func_80240A70_898050)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_80240B00_8980E0);
/*
ApiStatus N(func_80240B00_8980E0)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_80240B34_898114);
/*
ApiStatus N(func_80240B34_898114)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_80240B98_898178);
/*
ApiStatus N(func_80240B98_898178)(ScriptInstance *script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240BF0_8981D0)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    Npc* npc = get_npc_safe(-4);
...
INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_80241128_898708);
/*
s32 N(func_80241128_898708)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
...
INCLUDE_ASM(s32, "world/area_tik/tik_19/897BD0", func_802412F8_8988D8);