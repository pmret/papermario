...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(PlaySound, SOUND_LOOP_2F)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_30, SOUND_SPACE_WITH_DEPTH, -85, -180, 120)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_31, SOUND_SPACE_WITH_DEPTH, -25, -140, -130)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_32, SOUND_SPACE_WITH_DEPTH, -35, -180, 130)
