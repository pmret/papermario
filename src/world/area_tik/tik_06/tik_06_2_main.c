...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_30, SOUND_SPACE_MODE_1, -85, -180, 120)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_31, SOUND_SPACE_MODE_1, -25, -140, -130)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_32, SOUND_SPACE_MODE_1, -35, -180, 130)
