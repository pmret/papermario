...
/*
ApiStatus N(func_80240C80_887040)(Evt *script, s32 isInitialCall) {
    ...
    if (isInitialCall) {
        ...
        for (i = 0, save = 50.0f; i < 3; i++) {
            var = 0;
            add_vec2D_polar(&var, &scriptPtr->unk_44[i], save, N(D_80242088_888448)[i]);
    ...
    switch (scriptPtr->unk_00) {
        case 0:
            ...
            for (i = 0; i < 3; i++) {
                ...
                var = save2;
                add_vec2D_polar(&var, &scriptPtr->unk_20[i], save, N(D_80242088_888448)[i]);
