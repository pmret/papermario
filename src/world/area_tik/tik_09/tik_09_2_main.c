...
EvtScript N(EVS_CloseGates) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o59, SOUND_26B, 0)
    ...
    EVT_LOOP(0)
        ...
        EVT_END_IF
    EVT_END_LOOP
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o59, SOUND_26C, 0)
...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(PlaySoundAtF, SOUND_80000036, 1, -190, -20, -120)
    EVT_CALL(PlaySoundAtF, SOUND_80000037, 1, 50, -20, -120)
