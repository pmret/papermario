...
EvtScript N(EVS_CloseGates) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o59, SOUND_026B, SOUND_SPACE_MODE_0)
    ...
    EVT_LOOP(0)
        ...
        EVT_END_IF
    EVT_END_LOOP
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o59, SOUND_026C, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(PlaySound, SOUND_LOOP_35)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_36, SOUND_SPACE_MODE_1, -190, -20, -120)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_37, SOUND_SPACE_MODE_1, 50, -20, -120)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_38, SOUND_SPACE_MODE_1, 290, -20, -120)
