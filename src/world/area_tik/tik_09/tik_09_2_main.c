...
EvtScript N(EVS_CloseGates) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o59, SOUND_026B, SOUND_SPACE_DEFAULT)
    ...
    EVT_LOOP(0)
        ...
        EVT_END_IF
    EVT_END_LOOP
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o59, SOUND_026C, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_Main) = {
    ...
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_36, SOUND_SPACE_WITH_DEPTH, -190, -20, -120)
    EVT_CALL(PlaySoundAtF, SOUND_LOOP_37, SOUND_SPACE_WITH_DEPTH, 50, -20, -120)
