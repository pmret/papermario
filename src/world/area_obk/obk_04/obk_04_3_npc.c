...
void N(func_802400D0_BC7F30)(Npc* npc) {
    if (npc->yaw > 340.0f || npc->yaw < 20.0f) {
        ...
        npc_set_imgfx_params(npc, IMGFX_UPD_SET_ALPHA, gPlayerStatusPtr->alpha1, 255, 0, 0, npc->foldFlags);
        npc->foldArg1 = 255;
    }
}
...
API_CALLABLE(N(UpdateKeepAwayBoo)) {
    ...
    switch (script->functionTemp[1]) {
        ...
        case RING_STATE_1:
            ...
            npc->duration--;
            if (npc->duration == 0) {
                sfx_play_sound_at_position(SOUND_B000000F, SOUND_SPACE_MODE_0, npc->pos.x, npc->pos.y, npc->pos.z);
...
NpcData N(NpcData_Boo_01) = {
    ...
    .flags = ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_PLAYER_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_100000 | ENEMY_FLAG_ACTIVE_WHILE_OFFSCREEN | ENEMY_FLAG_IGNORE_TOUCH | ENEMY_FLAG_IGNORE_PARTNER,
    .drops = NO_DROPS,
...
NpcData N(NpcData_KeepAwayExtras)[] = {
    ...
    },
    {
        ...
        .settings = &N(NpcSettings_Boo),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_PLAYER_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_HAS_NO_SPRITE,
        .drops = NO_DROPS,
        .animations = NORMAL_BOO_ANIMS,
    },
};
