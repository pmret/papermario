...
EvtScript N(EVS_BooSpookAndVanish) = {
    ...
    EVT_LABEL(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(SetNpcImgfxParams, LVarA, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_WAIT(1)
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(0)
        EVT_END_IF
...
EvtScript N(EVS_Scene_BoosUnleashed) = {
    ...
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(SetNpcImgfxParams, NPC_LeaderBoo, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
    ...
    EVT_LABEL(50)
        ...
        EVT_ELSE
            ...
            EVT_LOOP(0)
                EVT_CALL(UpdateLerp)
                EVT_CALL(SetNpcImgfxParams, MV_ItemCarrierNpc, IMGFX_UPD_SET_ALPHA, LVar0, 0, 0, 0)
                EVT_WAIT(1)
                EVT_IF_EQ(LVar1, 0)
                    EVT_BREAK_LOOP
                EVT_END_IF
