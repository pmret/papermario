...
EvtScript N(EVS_AnimateShutterLeft) = {
    EVT_CALL(PlaySoundWithVolume, SOUND_PAIR_11, 0)
    EVT_CALL(PlaySoundAtModel, LVar2, SOUND_PAIR_11, SOUND_SPACE_MODE_0)
    ...
    EVT_LABEL(40)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(40)
        EVT_END_IF
    EVT_CALL(PlaySoundWithVolume, SOUND_PAIR_12, 0)
    EVT_CALL(PlaySoundAtModel, LVar2, SOUND_PAIR_12, SOUND_SPACE_MODE_0)
    EVT_RETURN
    EVT_END
};
