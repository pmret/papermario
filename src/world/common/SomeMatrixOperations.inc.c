...
void M(SomeMatrixOperation)(Matrix4f* mtx, f32 arg1, f32 arg2, f32 arg3) {
    guMtxIdentF(mtx);
...
ApiStatus M(SomeMatrixOperation2)(ScriptInstance* script, s32 isInitialCall) {
    ...
    if (!(model->flags & 0x400)) {
        ...
        M(SomeMatrixOperation)(&mtx, temp_f28, temp_f26, temp_f24);
