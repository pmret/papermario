...
EvtScript N(EVS_Pipe_EnterVertical) = {
    ...
    EVT_CALL(UpdatePlayerFold, ANIM_Mario1_Still, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_VERTICAL_PIPE_CURL, 1, 1, 0)
    ...
    EVT_END_IF
    EVT_WAIT(2)
    EVT_CALL(UpdatePlayerFold, ANIM_Mario1_Still, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
    EVT_WAIT(1)
...
EvtScript N(EVS_Pipe_EnterHorizontal) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(HidePlayerShadow, FALSE)
    EVT_END_THREAD
    EVT_CALL(SetPlayerFoldFlags, IMGFX_STATE_FLAG_REVERSE_ANIM | IMGFX_STATE_FLAG_800)
    EVT_CALL(UpdatePlayerFold, ANIM_Mario1_Idle, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_HORIZONTAL_PIPE_CURL, 1, 1, 0)
    EVT_LOOP(40)
    ...
    EVT_END_IF
    EVT_WAIT(5)
    EVT_CALL(UpdatePlayerFold, ANIM_Mario1_Idle, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
...
EvtScript N(EVS_Pipe_ExitVertical_Impl) = {
    ...
    EVT_THREAD
        ...
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(SetPlayerFoldFlags, IMGFX_STATE_FLAG_800)
    EVT_CALL(UpdatePlayerFold, ANIM_Mario1_Idle, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_VERTICAL_PIPE_CURL, 1, 1, 0)
    EVT_WAIT(25)
    EVT_EXEC_WAIT(LVarC)
    EVT_RETURN
    EVT_END
...
EvtScript N(EVS_Pipe_ExitHorizontal) = {
    ...
    EVT_CALL(SetPlayerAnimation, ANIM_Mario1_Still)
    EVT_CALL(SetPlayerFoldFlags, IMGFX_STATE_FLAG_800)
    EVT_CALL(UpdatePlayerFold, ANIM_Mario1_Still, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_HORIZONTAL_PIPE_CURL, 1, 1, 0)
    EVT_THREAD
        EVT_WAIT(8)
        EVT_CALL(HidePlayerShadow, TRUE)
    EVT_END_THREAD
