...
ApiStatus N(Pipe_GetEntryPos)(Evt* script, s32 isInitialCall) {
    ...
    s32 index = evt_get_variable(script, LocalVar(0));

    evt_set_variable(script, LocalVar(1), ((Vec4f*)*mapSettings->entryList)[index].x);
    evt_set_variable(script, LocalVar(2), ((Vec4f*)*mapSettings->entryList)[index].y);
    evt_set_variable(script, LocalVar(3), ((Vec4f*)*mapSettings->entryList)[index].z);
    evt_set_variable(script, LocalVar(4), ((Vec4f*)*mapSettings->entryList)[index].yaw);
    #ifdef _DEAD_H_
