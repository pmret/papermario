...
EvtScript N(EVS_Quizmo_Exit) = {
    ...
    EVT_IF_LE(LVar0, 1)
        ...
        EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_ChuckQuizmo_AnimC)
        EVT_WAIT(40)
...
EvtScript N(EVS_Quizmo_MoveQuizmoToMicrophone) = {
    ...
    EVT_CALL(SetNpcAnimation, CHUCK_QUIZMO_NPC_ID, ANIM_ChuckQuizmo_Anim1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_Quizmo_QuizMain) = {
    ...
    EVT_IF_EQ(GB_CompletedQuizzes, 63)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_ChuckQuizmo_Anim4, ANIM_ChuckQuizmo_Anim1, 0, MSG_MGM_000A)
    EVT_ELSE
        EVT_IF_EQ(GF_Met_ChuckQuizmo, 1)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_ChuckQuizmo_Anim4, ANIM_ChuckQuizmo_Anim1, 0, MSG_MGM_0009)
        EVT_ELSE
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_ChuckQuizmo_Anim4, ANIM_ChuckQuizmo_Anim1, 0, MSG_MGM_0008)
            EVT_SET(GF_Met_ChuckQuizmo, 1)
        EVT_END_IF
    EVT_END_IF
    EVT_CALL(ShowChoice, MSG_Choice_000D)
    EVT_IF_EQ(LVar0, 1)
        EVT_CALL(ContinueSpeech, -1, ANIM_ChuckQuizmo_Anim4, ANIM_ChuckQuizmo_Anim1, 0, MSG_MGM_000C)
    ...
    EVT_CALL(ContinueSpeech, -1, ANIM_ChuckQuizmo_Anim4, ANIM_ChuckQuizmo_Anim1, 0, MSG_MGM_000B)
    ...
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_ChuckQuizmo_Anim5, ANIM_ChuckQuizmo_Anim6, 0, LVar0)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_Question)
    ...
    EVT_END_THREAD
    EVT_IF_EQ(LVar0, 1)
        EVT_CALL(SetNpcAnimation, CHUCK_QUIZMO_NPC_ID, ANIM_ChuckQuizmo_Anim7)
        ...
        EVT_IF_GT(GB_CompletedQuizzes, 63)
            ...
            EVT_CALL(SetNpcAnimation, CHUCK_QUIZMO_NPC_ID, ANIM_ChuckQuizmo_Anim6)
            EVT_LOOP(0)
                EVT_IS_THREAD_RUNNING(LVar1, LVar0)
                EVT_IF_EQ(LVar0, 0)
                    EVT_BREAK_LOOP
                ...
                EVT_WAIT(1)
            EVT_END_LOOP
            EVT_CALL(SetNpcAnimation, CHUCK_QUIZMO_NPC_ID, ANIM_ChuckQuizmo_Anim5)
            ...
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_ChuckQuizmo_Anim4, ANIM_ChuckQuizmo_Anim1, 0, MSG_MGM_0011)
        EVT_ELSE
            ...
            EVT_END_IF
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_ChuckQuizmo_Anim4, ANIM_ChuckQuizmo_Anim1, 0, MSG_MGM_000F)
        EVT_END_IF
        EVT_SET(LVar0, 1)
    EVT_ELSE
        EVT_CALL(SetNpcAnimation, CHUCK_QUIZMO_NPC_ID, ANIM_ChuckQuizmo_Anim9)
        ...
        EVT_CALL(SetNpcAnimation, CHUCK_QUIZMO_NPC_ID, ANIM_ChuckQuizmo_AnimA)
        EVT_LOOP(0)
            EVT_IS_THREAD_RUNNING(LVar1, LVar0)
            EVT_IF_EQ(LVar0, 0)
                EVT_BREAK_LOOP
