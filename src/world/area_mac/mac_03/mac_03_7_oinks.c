...
EvtScript N(EVS_TurnCrank) = {
    ...
    EVT_LOOP(5)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(PlaySoundAt, SOUND_EAT_OR_DRINK, SOUND_SPACE_MODE_0, 170, 73, -450)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Capsule, SOUND_EAT_OR_DRINK, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_OpenCapsule) = {
    ...
    EVT_IF_GE(GB_MAC03_LilOinkCount, 10)
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_LilOink_01, SOUND_PLAYER_RUN_AWAY, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_LilOinkFlee) = {
    ...
    EVT_CALL(PlaySoundAtNpc, LVar1, SOUND_PLAYER_RUN_AWAY, SOUND_SPACE_MODE_0)
