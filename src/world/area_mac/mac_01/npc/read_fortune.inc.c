...
EvtScript N(EVS_Merlon_ReadFortuneFX) = {
    ...
    EVT_CALL(PlaySoundAt, SOUND_LRAW_207, SOUND_SPACE_MODE_0, LVar0, LVar1, LVar2)
    ...
    EVT_WAIT(40)
    EVT_CALL(PlaySoundAt, SOUND_LRAW_207 | SOUND_ID_TRIGGER_CHANGE_SOUND, 0, LVar0, LVar1, LVar2)
