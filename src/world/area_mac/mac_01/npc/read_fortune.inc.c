...
EvtScript N(EVS_Merlon_ReadFortuneFX) = {
    ...
    EVT_CALL(PlaySoundAt, SOUND_LRAW_CRYSTAL_BALL_GLOW, SOUND_SPACE_MODE_0, LVar0, LVar1, LVar2)
    ...
    EVT_WAIT(50)
    EVT_CALL(GetModelCenter, MODEL_tama)
    EVT_CALL(PlaySoundAt, SOUND_CRYSTAL_BALL_WAVE, SOUND_SPACE_MODE_0, LVar0, LVar1, LVar2)
