...
EvtScript N(EVS_ExitFlowerGate) = {
    ...
    EVT_THREAD
        EVT_CALL(PlaySoundAtCollider, COLLIDER_deilitf, SOUND_01CF, SOUND_SPACE_MODE_0)
        ...
        EVT_LOOP(0)
            ...
            EVT_END_IF
        EVT_END_LOOP
        EVT_CALL(PlaySoundAtCollider, COLLIDER_deilitf, SOUND_01D0, SOUND_SPACE_MODE_0)
    EVT_END_THREAD
    EVT_WAIT(15)
