...
EvtScript N(EVS_Rhuff_RevealBadges) = {
    ...
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_00A9, SOUND_SPACE_MODE_0, -220, 37, 271)
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_o295, SOUND_00AA, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_Rhuff_HideBadges) = {
    ...
    EVT_THREAD
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o295, SOUND_00AC, SOUND_SPACE_MODE_0)
    ...
    EVT_THREAD
        ...
        EVT_IF_EQ(LVar1, 1)
            ...
            EVT_GOTO(0)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_00AB, SOUND_SPACE_MODE_0, -220, 37, 271)
    EVT_END_THREAD
    EVT_WAIT(15)
    EVT_THREAD
