...
EvtScript N(EVS_LuigiExitPipe_Epilogue) = {
    ...
    EVT_CALL(SetNpcImgfxFlags, NPC_Luigi_Epilogue, IMGFX_STATE_FLAG_REVERSE_ANIM)
    EVT_CALL(SetNpcImgfxParams, NPC_Luigi_Epilogue, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_VERTICAL_PIPE_CURL, 1, 1, 0)
    ...
    EVT_LOOP(45)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(SetNpcImgfxParams, NPC_Luigi_Epilogue, IMGFX_UPD_CLEAR, 0, 0, 0, 0)
