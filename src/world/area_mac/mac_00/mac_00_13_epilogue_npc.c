...
NpcData N(NpcData_DojoMembers_Epilogue)[] = {
    {
        ...
        .settings = &N(NpcSettings_Luigi_Epilogue),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_4 | ENEMY_FLAG_ENABLE_HIT_SCRIPT | ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_800 | ENEMY_FLAG_2000 | ENEMY_FLAG_10000,
        .drops = NO_DROPS,
        .animations = {
