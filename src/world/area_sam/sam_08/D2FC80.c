...
/*
ApiStatus N(func_8024003C_D2FCBC)(Evt* script, s32 isInitialCall) {
...
/*
ApiStatus N(func_80240600_D30280)(Evt *script, s32 isInitialCall) {
    ...
    if (isInitialCall) {
        ...
        for (i = 0, save = 50.0f; i < 3; i++) {
            var = 0;
            add_vec2D_polar(&var, &scriptPtr->unk_44[i], save, N(D_80241B38_D317B8)[i]);
    ...
    switch (scriptPtr->unk_00) {
        case 0:
            ...
            for (i = 0; i < 3; i++) {
                ...
                var = save2;
                add_vec2D_polar(&var, &scriptPtr->unk_20[i], save, N(D_80241B38_D317B8)[i]);
