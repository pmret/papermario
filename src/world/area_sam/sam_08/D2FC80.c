...
/*
ApiStatus N(func_8024001C_D2FC9C)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_sam/sam_08/D2FC80", func_80240068_D2FCE8);
/*
ApiStatus N(func_80240068_D2FCE8)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_sam/sam_08/D2FC80", func_802400D4_D2FD54);

INCLUDE_ASM(s32, "world/area_sam/sam_08/D2FC80", func_80240120_D2FDA0);
/*
ApiStatus N(func_80240120_D2FDA0)(ScriptInstance *script, s32 isInitialCall) {
    PlayerData* playerData = &gPlayerData;
    s32 i;
...
INCLUDE_ASM(s32, "world/area_sam/sam_08/D2FC80", func_80240448_D300C8);
/*
ApiStatus N(func_80240448_D300C8)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_sam/sam_08/D2FC80", func_80240480_D30100);
/*
ApiStatus N(func_80240480_D30100)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
...
INCLUDE_ASM(s32, "world/area_sam/sam_08/D2FC80", func_80240544_D301C4);
/*
ApiStatus N(func_80240544_D301C4)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_sam/sam_08/D2FC80", func_802405A8_D30228);
/*
ApiStatus N(func_802405A8_D30228)(ScriptInstance *script, s32 isInitialCall) {
...
/*
s32 N(func_80240B38_D307B8)(ScriptInstance *script, s32 isInitialCall) {
    Bytecode *args = script->ptrReadPos;
    s32 ret = 0;
