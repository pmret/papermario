...
API_CALLABLE(N(AdjustFightingSoundsPos)) {
    ...
    sfx_adjust_env_sound_pos(SOUND_8000006C, 0, x, y, z);
...
EvtScript N(EVS_Scene_ImposterAppears) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtCollider, COLLIDER_m1_kabe, SOUND_39B, 0)
        EVT_CALL(MakeLerp, -120, 0, 60, EASING_COS_IN_OUT)
        EVT_LABEL(0)
        EVT_CALL(UpdateLerp)
    ...
    EVT_CALL(SetNpcFlagBits, NPC_Kooper_01A, NPC_FLAG_100, TRUE)
    EVT_CALL(SetNpcFlagBits, NPC_Kooper_02A, NPC_FLAG_100, TRUE)
    ...
    EVT_THREAD
        ...
        EVT_SUB(LVar5, 30)
        EVT_CALL(MakeLerp, LVar2, LVar5, 20, EASING_QUADRATIC_OUT)
        EVT_LABEL(1)
        EVT_CALL(UpdateLerp)
    ...
    EVT_CALL(ShowEmote, NPC_Kooper_02A, EMOTE_QUESTION, 45, 20, TRUE, 0, 0, 0, 0)
    EVT_WAIT(15)
    EVT_CALL(PlaySoundAtNpc, NPC_Kooper_01A, SOUND_263, 0)
    EVT_CALL(ShowEmote, NPC_Kooper_01A, EMOTE_QUESTION, 0, 20, TRUE, 0, 0, 0, 0)
    EVT_WAIT(15)
    ...
    EVT_CALL(SetNpcFlagBits, NPC_Kooper_01A, NPC_FLAG_100, FALSE)
    EVT_CALL(SetNpcFlagBits, NPC_Kooper_02A, NPC_FLAG_100, FALSE)
...
EvtScript N(EVS_Scene_HitTrueKooper) = {
    ...
    EVT_CALL(SetNpcJumpscale, NPC_Kooper_01A, EVT_FLOAT(1.0))
    EVT_CALL(SetNpcAnimation, NPC_Kooper_01A, ANIM_WorldKooper_Jump)
    EVT_CALL(NpcJump0, NPC_Kooper_01A, LVar0, LVar1, LVar2, 20)
    EVT_CALL(NpcJump0, NPC_Kooper_01A, LVar3, LVar4, LVar5, 10)
    EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_CALL(GetNpcPos, NPC_Kooper_01A, LVar0, LVar1, LVar2)
    EVT_CALL(UseSettingsFrom, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, LVar0, LVar1, LVar2)
    ...
    EVT_THREAD
        EVT_CALL(SetNpcJumpscale, NPC_Kooper_01A, EVT_FLOAT(1.0))
        EVT_CALL(NpcJump1, NPC_Kooper_01A, LVar0, LVar1, LVar2, 20)
    EVT_END_THREAD
    EVT_CALL(SetNpcJumpscale, NPC_Kooper_02A, EVT_FLOAT(1.0))
    EVT_CALL(NpcJump1, NPC_Kooper_02A, LVar0, LVar1, LVar2, 20)
    EVT_CALL(PlayerFaceNpc, NPC_Kooper_01A, FALSE)
    EVT_LOOP(3)
        EVT_CALL(GetNpcYaw, NPC_Kooper_01A, LVar0)
        EVT_ADD(LVar0, 180)
    ...
    EVT_ELSE
        ...
        EVT_THREAD
            ...
            EVT_CALL(SetNpcJumpscale, NPC_Kooper_01A, EVT_FLOAT(2.0))
            EVT_CALL(NpcJump1, NPC_Kooper_01A, -1172, -120, -37, 15)
        EVT_END_THREAD
        EVT_THREAD
            EVT_CALL(InterpNpcYaw, NPC_Kooper_02A, 270, 0)
            EVT_CALL(SetNpcJumpscale, NPC_Kooper_02A, EVT_FLOAT(2.0))
            EVT_CALL(NpcJump1, NPC_Kooper_02A, -1062, -120, -37, 15)
        EVT_END_THREAD
    EVT_END_IF
    EVT_WAIT(30)
    EVT_CALL(SetNpcAnimation, NPC_Kooper_01A, ANIM_WorldKooper_Idle)
...
EvtScript N(EVS_Scene_HitFakeKooper) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(PlaySoundAtNpc, NPC_Kooper_02A, SOUND_20B8, 0)
    EVT_LOOP(10)
        EVT_CALL(GetNpcPos, NPC_Kooper_02A, LVar0, LVar1, LVar2)
        EVT_ADD(LVar2, 3)
        EVT_CALL(N(PlayBigSmokePuff), LVar0, LVar1, LVar2)
        EVT_WAIT(5)
    EVT_END_LOOP
    EVT_CALL(PlaySoundAtNpc, NPC_Kooper_02A, SOUND_SMOKE_BURST, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcSpeed, NPC_Kooper_01A, EVT_FLOAT(3.0))
        EVT_CALL(SetNpcAnimation, NPC_Kooper_01A, ANIM_WorldKooper_Run)
        EVT_CALL(SetNpcFlagBits, NPC_Kooper_01A, NPC_FLAG_100, TRUE)
