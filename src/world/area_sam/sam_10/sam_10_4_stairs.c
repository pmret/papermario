...
EvtScript N(EVS_ItemPrompt_StarStoneSocket) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(SetGroupVisibility, MODEL_move1, 0)
    EVT_CALL(SetGroupVisibility, MODEL_move2, 1)
    EVT_CALL(SetGroupVisibility, MODEL_move3, 0)
    ...
    EVT_CALL(SetGroupVisibility, MODEL_move1, 0)
    EVT_CALL(SetGroupVisibility, MODEL_move2, 0)
    EVT_CALL(SetGroupVisibility, MODEL_move3, 1)
