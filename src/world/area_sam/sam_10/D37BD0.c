...
INCLUDE_ASM(s32, "world/area_sam/sam_10/D37BD0", func_8024078C_D37F8C);
/*
ApiStatus N(func_8024078C_D37F8C)(ScriptInstance *script, s32 isInitialCall) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
    Enemy* enemy2;
    Npc* npc2;
...
ApiStatus N(func_802409EC_D381EC)(ScriptInstance *script, s32 isInitialCall) {
    ...
    if ((script->functionTemp[0].s < 30) && (enemy->varTable[0] == 0) && N(func_802405D8_D37DD8)(script)) {
