...
EvtScript N(EVS_NpcInit_Kolorado) = {
    ...
    EVT_CALL(SetNpcFlagBits, NPC_Archeologist_01, NPC_FLAG_100, TRUE)
    EVT_CALL(SetNpcFlagBits, NPC_Archeologist_02, NPC_FLAG_100, TRUE)
...
StaticNpc N(NpcData_Epilogue)[] = {
    {
        ...
        .pos = { NPC_DISPOSE_LOCATION },
        .yaw = 0,
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_ENABLE_HIT_SCRIPT | ENEMY_FLAG_100 | ENEMY_FLAG_400 | ENEMY_FLAG_800 | ENEMY_FLAG_2000 | ENEMY_FLAG_200000 | ENEMY_FLAG_400000,
