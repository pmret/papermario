...
EvtScript N(EVS_LetterPrompt_Mayor) = {
    EVT_CALL(N(LetterDelivery_Init),
        NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle,
...
EvtScript N(EVS_Mayor_CarryBucket) = {
    EVT_LABEL(0)
        ...
        EVT_ADD(LVar0, -5)
        EVT_ADD(LVar1, 15)
        EVT_CALL(GetNpcYaw, NPC_MayorPenguin_01, LVar3)
        EVT_IF_GE(LVar3, 90)
            EVT_IF_LE(LVar3, 270)
                EVT_ADD(LVar2, 10)
            EVT_ELSE
...
EvtScript N(EVS_Mayor_HandOverBucket) = {
    ...
    EVT_END_THREAD
    EVT_CALL(NpcMoveTo, NPC_MayorPenguin_01, LVar0, LVar2, 10)
    EVT_RETURN
    EVT_END
};
        ...
        EVT_CASE_LT(STORY_CH7_GOT_SNOWMAN_BUCKET)
            ...
            EVT_LABEL(20)
                ...
                EVT_IF_EQ(LVar1, 1)
                    EVT_GOTO(20)
                EVT_END_IF
            EVT_CALL(PlaySoundAtCollider, COLLIDER_yana, SOUND_1D0, 0)
...
EvtScript N(EVS_NpcInteract_Penguin_06) = {
    EVT_EXEC_WAIT(N(EVS_NpcInteract_Penguin_05))
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_80247DE4) = {
    EVT_CALL(ShowMessageAtScreenPos, MSG_CH7_0004, 160, 40)
    EVT_RETURN
    EVT_END
};

EvtScript N(EVS_NpcInit_MayorPenguin_01) = {
...
EvtScript N(EVS_NpcInit_MayorPenguin_02) = {
...
StaticNpc N(NpcData_MayorPenguin_01)[] = {
    {
        .id = NPC_MayorPenguin_01,
        ...
        .init = &N(EVS_NpcInit_MayorPenguin_01),
        .drops = NPC_NO_DROPS,
        .animations = {
    ...
    {
        .id = NPC_MayorPenguin_02,
        .settings = &N(NpcSettings_Penguin),
        .pos = { -272.0f, 0.0f, -180.0f },
        .yaw = 270,
        .flags = ENEMY_FLAG_1 | ENEMY_FLAG_8 | ENEMY_FLAG_200 | ENEMY_FLAG_400 | ENEMY_FLAG_800 | ENEMY_FLAG_4000 | ENEMY_FLAG_400000,
        .init = &N(EVS_NpcInit_MayorPenguin_02),
        .drops = NPC_NO_DROPS,
        .animations = {
            .idle   = ANIM_MayorPenguin_Idle,
            .walk   = ANIM_MayorPenguin_Walk,
...
NpcGroupList N(DefaultNPCs) = {
    NPC_GROUP(N(NpcData_MayorPenguin_01), BTL_KMR_PART_1_FORMATION_00, BTL_KMR_PART_1_STAGE_00),
