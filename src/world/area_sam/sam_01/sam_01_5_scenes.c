...
EvtScript N(EVS_MayorCarryGift) = {
    EVT_CALL(GetNpcPos, NPC_MayorPenguin_01, LVar0, LVar1, LVar2)
...
EvtScript N(EVS_Scene_MysteryBegins) = {
    ...
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin_01, NPC_FLAG_100, TRUE)
    ...
    EVT_END_THREAD
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguinWife, NPC_FLAG_40, TRUE)
    EVT_CALL(SetNpcPos, NPC_MayorPenguinWife, -255, 0, 28)
    EVT_CALL(SetNpcSpeed, NPC_MayorPenguinWife, EVT_FLOAT(2.0))
    ...
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguinWife, ANIM_MayorPenguinWife_Idle)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguinWife, SOUND_262, 0)
    EVT_CALL(ShowEmote, NPC_MayorPenguinWife, EMOTE_EXCLAMATION, 0, 30, TRUE, 0, 0, 0, 0)
    EVT_WAIT(30)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguinWife, ANIM_MayorPenguinWife_Walk)
    EVT_CALL(SetNpcSpeed, NPC_MayorPenguinWife, EVT_FLOAT(0.5))
    ...
    EVT_LABEL(2)
        ...
        EVT_END_IF
    EVT_WAIT(20)
    EVT_CALL(SetNpcSpeed, NPC_MayorPenguinWife, EVT_FLOAT(6.0))
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcSpeed, NPC_PenguinPatrol, EVT_FLOAT(2.0))
    ...
    EVT_THREAD
        EVT_WAIT(30)
        EVT_CALL(PlayerMoveTo, -315, -150, 20)
        EVT_CALL(InterpPlayerYaw, 0, 0)
    EVT_END_THREAD
    EVT_CALL(SetNpcAnimation, NPC_PenguinPatrol, ANIM_PenguinPatrol_Walk)
    ...
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin_01, NPC_FLAG_100, FALSE)
...
EvtScript N(EVS_Scene_MysterySolved) = {
    ...
    EVT_THREAD
        EVT_CALL(SetNpcAnimation, NPC_PARTNER, PARTNER_ANIM_WALK)
        EVT_CALL(NpcMoveTo, NPC_PARTNER, -306, -116, 10)
        EVT_CALL(SetNpcAnimation, NPC_PARTNER, PARTNER_ANIM_IDLE)
    ...
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Twitch)
    EVT_WAIT(30)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin_01, SOUND_3E4, 0)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Dead)
    EVT_WAIT(2)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Twitch)
    EVT_WAIT(20)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin_01, SOUND_3E4, 0)
    ...
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_Twitch, ANIM_MayorPenguin_Twitch, 0, MSG_CH7_0026)
    EVT_CALL(GetAngleBetweenNPCs, NPC_PenguinPatrol, NPC_MayorPenguin_01, LVar0)
    EVT_CALL(InterpNpcYaw, NPC_PenguinPatrol, LVar0, 0)
    EVT_CALL(GetAngleBetweenNPCs, NPC_MayorPenguinWife, NPC_MayorPenguin_01, LVar0)
    EVT_CALL(InterpNpcYaw, NPC_MayorPenguinWife, LVar0, 0)
    EVT_CALL(GetAngleBetweenNPCs, NPC_Herringway, NPC_MayorPenguin_01, LVar0)
    EVT_CALL(InterpNpcYaw, NPC_Herringway, LVar0, 0)
    EVT_CALL(PlayerFaceNpc, NPC_MayorPenguin_01, FALSE)
    EVT_CALL(NpcFaceNpc, NPC_PARTNER, NPC_MayorPenguin_01, 0)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin_01, SOUND_3E4, 0)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Dead)
    EVT_WAIT(2)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Twitch)
    ...
    EVT_ADD(LVar0, 11)
    EVT_ADD(LVar2, 10)
    EVT_CALL(SetNpcPos, NPC_MayorPenguin_01, LVar0, LVar1, LVar2)
    EVT_CALL(EnableNpcShadow, NPC_MayorPenguin_01, FALSE)
    EVT_CALL(SetNpcPos, NPC_MayorPenguin_02, -270, 0, -205)
    EVT_THREAD
        EVT_WAIT(30)
        EVT_CALL(SetNpcPos, NPC_MayorPenguin_02, NPC_DISPOSE_LOCATION)
        EVT_CALL(EnableNpcShadow, NPC_MayorPenguin_01, TRUE)
    EVT_END_THREAD
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_WakeUp)
    EVT_WAIT(30)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Idle)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin_01, SOUND_32C, 0)
    EVT_CALL(SetNpcJumpscale, NPC_MayorPenguin_01, EVT_FLOAT(1.0))
    EVT_CALL(GetNpcPos, NPC_MayorPenguin_01, LVar0, LVar1, LVar2)
    EVT_CALL(NpcJump0, NPC_MayorPenguin_01, LVar0, 0, LVar2, 10)
    EVT_CALL(SetMusicTrack, 0, SONG_PENGUIN_WAKES_UP, 0, 8)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 0, MSG_CH7_0027)
    EVT_CALL(InterpNpcYaw, NPC_MayorPenguin_01, 0, 0)
    EVT_WAIT(20)
    ...
    EVT_CALL(GetNpcPos, NPC_MayorPenguinWife, LVar0, LVar1, LVar2)
    EVT_CALL(NpcJump0, NPC_MayorPenguinWife, LVar0, LVar1, LVar2, 20)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguinWife, ANIM_MayorPenguinWife_Idle)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguinWife, ANIM_MayorPenguinWife_Talk, ANIM_MayorPenguinWife_Idle, 0, MSG_CH7_0028)
    EVT_WAIT(30)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 0, MSG_CH7_0029)
    EVT_CALL(GetPlayerPos, LVar0, LVar1, LVar2)
    EVT_CALL(UseSettingsFrom, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetCamSpeed, CAM_DEFAULT, EVT_FLOAT(90.0))
    EVT_WAIT(1)
    EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 0)
    EVT_CALL(SpeakToNpc, NPC_PenguinPatrol, ANIM_PenguinPatrol_Talk, ANIM_PenguinPatrol_Idle, 0, NPC_MayorPenguin_01, MSG_CH7_002A)
    EVT_WAIT(10)
    EVT_CALL(SpeakToNpc, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 0, NPC_PenguinPatrol, MSG_CH7_002B)
    EVT_CALL(GetNpcPos, NPC_MayorPenguin_01, LVar0, LVar1, LVar2)
    EVT_CALL(UseSettingsFrom, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetCamDistance, CAM_DEFAULT, EVT_FLOAT(280.0))
    EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_CarryTalk, ANIM_MayorPenguin_Idle, 0, MSG_CH7_002C)
    EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_THREAD
        EVT_LOOP(200)
            EVT_CALL(GetAngleBetweenNPCs, NPC_PenguinPatrol, NPC_MayorPenguin_01, LVar0)
    ...
    EVT_CALL(SetNpcSpeed, NPC_MayorPenguin_01, EVT_FLOAT(3.0))
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Walk)
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin_01, NPC_FLAG_100, TRUE)
    EVT_CALL(NpcMoveTo, NPC_MayorPenguin_01, -320, -258, 0)
    EVT_CALL(InterpNpcYaw, NPC_MayorPenguin_01, 180, 0)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Idle)
    EVT_WAIT(30)
    EVT_THREAD
    ...
    EVT_THREAD
        ...
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_PickUp)
    EVT_WAIT(30)
    ...
    EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Carry)
    EVT_CALL(GetNpcPos, NPC_Herringway, LVar0, LVar1, LVar2)
    EVT_ADD(LVar2, -35)
    EVT_CALL(NpcMoveTo, NPC_MayorPenguin_01, LVar0, LVar2, 0)
    ...
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin_01, NPC_FLAG_100, FALSE)
    EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_CALL(SpeakToNpc, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 0, NPC_Herringway, MSG_CH7_002D)
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Give)
    EVT_WAIT(60)
    EVT_CALL(GetNpcPos, NPC_Herringway, LVar0, LVar1, LVar2)
    EVT_ADD(LVar2, -5)
    ...
    EVT_CALL(SpeakToNpc, NPC_Herringway, ANIM_Herringway_TalkCarry, ANIM_Herringway_IdleCarry, 0, NPC_MayorPenguin_01, MSG_CH7_002E)
    EVT_CALL(GetPlayerPos, LVar0, LVar1, LVar2)
    EVT_CALL(UseSettingsFrom, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetCamSpeed, CAM_DEFAULT, EVT_FLOAT(90.0))
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin_01, NPC_FLAG_100, TRUE)
        EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Walk)
        EVT_CALL(NpcMoveTo, NPC_MayorPenguin_01, -249, -109, 0)
        EVT_CALL(SetNpcAnimation, NPC_MayorPenguin_01, ANIM_MayorPenguin_Idle)
        EVT_LOOP(100)
            EVT_CALL(GetAngleBetweenNPCs, NPC_MayorPenguin_01, NPC_PenguinPatrol, LVar0)
            EVT_CALL(InterpNpcYaw, NPC_MayorPenguin_01, LVar0, 0)
            EVT_WAIT(1)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_CALL(SetNpcAnimation, NPC_PenguinPatrol, ANIM_PenguinPatrol_Idle)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 0, MSG_CH7_0030)
    ...
    EVT_CALL(SetNpcSpeed, NPC_Herringway, EVT_FLOAT(3.0))
    ...
    EVT_WAIT(30)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 5, MSG_CH7_0032)
    EVT_CALL(GetNpcPos, NPC_MayorPenguin_01, LVar0, LVar1, LVar2)
    EVT_CALL(SetPanTarget, CAM_DEFAULT, LVar0, LVar1, LVar2)
    EVT_CALL(SetCamDistance, CAM_DEFAULT, EVT_FLOAT(250.0))
    ...
    EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_WAIT(30)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 0, MSG_CH7_0033)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_80007)
    EVT_WAIT(20)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
    EVT_WAIT(1)
    EVT_CALL(SpeakToPlayer, NPC_MayorPenguin_01, ANIM_MayorPenguin_Talk, ANIM_MayorPenguin_Idle, 0, MSG_CH7_0034)
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin_01, NPC_FLAG_100, FALSE)
    ...
    EVT_SET(MV_Unk_02, 0)
    EVT_SET(MV_Unk_03, 0)
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin_01, NPC_FLAG_40, FALSE)
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguinWife, NPC_FLAG_40, FALSE)
