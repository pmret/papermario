...
EvtScript N(EVS_Scene_MysteryBegins) = {
    ...
    EVT_CALL(SetNpcAnimation, NPC_MayorPenguinWife, ANIM_MayorPenguinWife_Idle)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguinWife, SOUND_0262, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_Scene_MysterySolved) = {
    ...
    EVT_WAIT(30 * DT)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin, SOUND_ACTOR_TWITCH, SOUND_SPACE_MODE_0)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin, SOUND_032C, SOUND_SPACE_MODE_0)
