...
EvtScript N(EVS_Scene_MysterySolved) = {
    ...
    EVT_WAIT(30)
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin, SOUND_3E4, 0)
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_MayorPenguin, SOUND_32C, 0)
    EVT_CALL(SetNpcJumpscale, NPC_MayorPenguin, EVT_FLOAT(1.0))
    EVT_CALL(GetNpcPos, NPC_MayorPenguin, LVar0, LVar1, LVar2)
    EVT_CALL(NpcJump0, NPC_MayorPenguin, LVar0, 0, LVar2, 10)
    ...
    EVT_SET(MV_DialogueState_Penguin3, 0)
    EVT_SET(MV_DialogueState_Penguin4, 0)
    EVT_CALL(SetNpcFlagBits, NPC_MayorPenguin, NPC_FLAG_40, FALSE)
