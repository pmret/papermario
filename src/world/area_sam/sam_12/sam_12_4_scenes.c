...
EvtScript N(EVS_SpawnMerlarSparkles) = {
    EVT_CALL(PlaySoundAtNpc, NPC_Merlar, SOUND_MERLAR_APPEARS, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_MarioSleeping) = {
    ...
    EVT_LOOP(0)
        EVT_CALL(PlaySoundAtPlayer, SOUND_SRAW_0C_A, SOUND_SPACE_MODE_0)
        EVT_WAIT(60)
    EVT_END_LOOP
    EVT_RETURN
    EVT_END
...
EvtScript N(EVS_Scene_MeetMerlar) = {
    ...
    EVT_CALL(PlaySoundAtNpc, NPC_Merlar, SOUND_RECEIVE_STAR_POWER, SOUND_SPACE_MODE_0)
    ...
    EVT_CALL(PlaySoundAtPlayer, SOUND_SRAW_0E_A, SOUND_SPACE_MODE_0)
