...
EvtScript N(EVS_MerlarFlickering) = {
    EVT_LABEL(0)
        ...
        EVT_LOOP(LVar1)
            ...
            EVT_LOOP(5)
                EVT_BUF_READ1(LVar0)
                EVT_CALL(SetNpcFoldParams, NPC_Merlar, FOLD_UPD_HOLOGRAM, EVT_FLOAT(0.0), LVar0, EVT_FLOAT(200.0), EVT_FLOAT(100.0))
                EVT_WAIT(1)
            EVT_END_LOOP
            EVT_CALL(SetNpcFoldParams, NPC_Merlar, FOLD_UPD_HOLOGRAM, EVT_FLOAT(0.0), EVT_FLOAT(0.0), EVT_FLOAT(0.0), EVT_FLOAT(100.0))
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_GOTO(0)
    EVT_RETURN
...
EvtScript N(EVS_Scene_MeetMerlar) = {
    ...
    EVT_LOOP(LOOPCOUNT_2)
        ...
        EVT_CALL(SetNpcFoldParams, NPC_Merlar, FOLD_UPD_SET_ALPHA, LVar0, 0, 0, 0)
        EVT_WAIT(1)
    EVT_END_LOOP
