...
INCLUDE_ASM(s32, "world/area_sam/sam_05/D187E0", update_starpoints_display_D18B9C);
/*
ApiStatus N(update_starpoints_display_D18B9C)(ScriptInstance *script, s32 isInitialCall) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
    Enemy* enemy2;
    Npc* npc2;
...
ApiStatus N(func_8024061C_D18DFC)(ScriptInstance *script, s32 isInitialCall) {
    ...
    if ((script->functionTemp[0].s < 30) && (enemy->varTable[0] == 0) && N(func_80240208_D189E8)(script)) {
...
INCLUDE_ASM(s32, "world/area_sam/sam_05/D187E0", func_80241608_D19DE8);

INCLUDE_ASM(s32, "world/area_sam/sam_05/D187E0", func_80241668_D19E48);
