...
EvtScript N(EVS_Scene_SnowmenSpeak) = {
    ...
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_01, NPC_FLAG_100, TRUE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_02, NPC_FLAG_100, TRUE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_03, NPC_FLAG_100, TRUE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_04, NPC_FLAG_100, TRUE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_05, NPC_FLAG_100, TRUE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_06, NPC_FLAG_100, TRUE)
    EVT_WAIT(1)
    EVT_THREAD
        EVT_WAIT(22)
    ...
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_01, NPC_FLAG_100, FALSE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_02, NPC_FLAG_100, FALSE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_03, NPC_FLAG_100, FALSE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_04, NPC_FLAG_100, FALSE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_05, NPC_FLAG_100, FALSE)
    EVT_CALL(SetNpcFlagBits, NPC_Snowman_06, NPC_FLAG_100, FALSE)
