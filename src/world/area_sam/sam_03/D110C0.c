...
INCLUDE_ASM(s32, "world/area_sam/sam_03/D110C0", func_8024040C_D114CC);
/*
ApiStatus N(func_8024040C_D114CC)(ScriptInstance *script, s32 isInitialCall) {
    Enemy* enemy = script->owner1.enemy;
    Npc *npc = get_npc_unsafe(enemy->npcID);
    Enemy* enemy2;
    Npc* npc2;
...
ApiStatus N(func_8024066C_D1172C)(ScriptInstance *script, s32 isInitialCall) {
    ...
    if ((script->functionTemp[0].s < 30) && (enemy->varTable[0] == 0) && N(func_80240258_D11318)(script)) {
