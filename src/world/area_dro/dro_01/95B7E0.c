...
EvtScript N(802479FC) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_DEFAULT
            ...
            EVT_CALL(SetNpcAnimation, NPC_PARTNER, ANIM_WorldParakarry_Anim02)
            ...
            EVT_CALL(SetNpcAnimation, NPC_PARTNER, ANIM_WorldParakarry_Anim01)
        ...
        EVT_IF_NE(LVar1, -1)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(-1)
                    EVT_CALL(DisablePartnerAI, 0)
                    EVT_WAIT(1)
                    EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldParakarry_Anim06, ANIM_WorldParakarry_Anim01, 5, LVar8)
                    EVT_CALL(EnablePartnerAI)
                    EVT_SET(LVarC, 1)
                EVT_CASE_DEFAULT
                    EVT_CALL(DisablePartnerAI, 0)
                    EVT_WAIT(1)
                    EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldParakarry_Anim06, ANIM_WorldParakarry_Anim01, 5, LVar9)
                    EVT_IF_NE(LVarA, 0)
...
EvtScript N(80248090) = {
    EVT_CALL(N(LetterDelivery_Init), 6, ANIM_Mouser_Purple_Anim05, ANIM_Mouser_Purple_Anim01, 76, 69,
...
EvtScript N(interact_802480E0) = {
    EVT_IF_GE(GB_StoryProgress, -53)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim05, ANIM_Mouser_Blue_Anim01, 0, MSG_CH2_0062)
        EVT_RETURN
    EVT_END_IF
    EVT_SWITCH(AreaByte(0))
        EVT_CASE_EQ(0)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim05, ANIM_Mouser_Blue_Anim01, 0, MSG_CH2_005F)
            EVT_ADD(AreaByte(0), 1)
        EVT_CASE_EQ(1)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim05, ANIM_Mouser_Blue_Anim01, 0, MSG_CH2_0060)
            EVT_ADD(AreaByte(0), 1)
        EVT_CASE_EQ(2)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim05, ANIM_Mouser_Blue_Anim01, 0, MSG_CH2_0061)
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-53)
            ...
            EVT_SWITCH(AreaByte(1))
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Yellow_Anim04, ANIM_Dryite_Yellow_Anim01, 0, MSG_CH2_0063)
                    EVT_ADD(AreaByte(1), 1)
                EVT_CASE_EQ(1)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Yellow_Anim04, ANIM_Dryite_Yellow_Anim01, 0, MSG_CH2_0064)
                    EVT_ADD(AreaByte(1), 1)
                EVT_CASE_EQ(2)
                    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Yellow_Anim04, ANIM_Dryite_Yellow_Anim01, 0, MSG_CH2_0065)
                    EVT_SET(AreaByte(1), 0)
            EVT_END_SWITCH
        EVT_CASE_LT(39)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Yellow_Anim04, ANIM_Dryite_Yellow_Anim01, 0, MSG_CH2_0066)
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Yellow_Anim04, ANIM_Dryite_Yellow_Anim01, 0, MSG_CH2_0067)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_802483CC) = {
    EVT_SWITCH(AreaByte(2))
        EVT_CASE_EQ(0)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim04, ANIM_Dryite_Blue_Anim01, 0, MSG_CH2_0068)
            EVT_ADD(AreaByte(2), 1)
        EVT_CASE_EQ(1)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim04, ANIM_Dryite_Blue_Anim01, 0, MSG_CH2_0069)
            EVT_ADD(AreaByte(2), 1)
        EVT_CASE_EQ(2)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim04, ANIM_Dryite_Blue_Anim01, 0, MSG_CH2_006A)
            EVT_ADD(AreaByte(2), 1)
        EVT_CASE_EQ(3)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim04, ANIM_Dryite_Blue_Anim01, 0, MSG_CH2_006B)
...
EvtScript N(80248504) = {
    ...
    EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0078)
    EVT_CALL(GetPlayerPos, LVar0, LVar1, LVar2)
    ...
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
    EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0079)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_80007)
    EVT_WAIT(30)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
    EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_007A)
    EVT_CALL(GetPlayerPos, LVar0, LVar1, LVar2)
    EVT_CALL(UseSettingsFrom, 0, LVar0, LVar1, LVar2)
...
EvtScript N(interact_80248864) = {
    EVT_IF_EQ(GF_MAC01_Merlon_HeardAboutDream, 1)
        EVT_IF_EQ(GF_DRO01_HeardHintAboutSpinningRoof, 1)
            ...
            EVT_IF_EQ(LVar0, 1)
                EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_007B)
                EVT_RETURN
            EVT_END_IF
        EVT_END_IF
    EVT_END_IF
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-53)
            EVT_IF_EQ(AreaFlag(1), 0)
                EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_006C)
                EVT_CALL(SpeakToPlayer, 4, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_006D)
                EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_006E)
                EVT_SET(AreaFlag(1), 1)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_006F)
                EVT_CALL(SpeakToPlayer, 4, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0070)
                EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0071)
                EVT_SET(AreaFlag(1), 0)
            EVT_END_IF
        EVT_CASE_LT(39)
            EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0072)
            EVT_CALL(SpeakToPlayer, 4, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0073)
            EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0074)
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0075)
            EVT_CALL(SpeakToPlayer, 4, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0076)
            EVT_CALL(SpeakToPlayer, 3, ANIM_Dryite_Green_Anim04, ANIM_Dryite_Green_Anim01, 0, MSG_CH2_0077)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(init_80248AE4) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_OR_EQ(3)
        EVT_CASE_OR_EQ(4)
            EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Dryite_Green_Anim04)
            EVT_RETURN
        EVT_END_CASE_GROUP
    EVT_END_SWITCH
...
EvtScript N(interact_80248BA0) = {
    ...
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Dryite_Green_Anim03)
    EVT_CALL(SetNpcSpeed, NPC_SELF, EVT_FLOAT(3.5))
    EVT_CALL(NpcMoveTo, NPC_SELF, LVar0, LVar1, 0)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Dryite_Green_Anim01)
...
EvtScript N(interact_80249750) = {
    EVT_IF_EQ(AreaByte(4), 4)
        EVT_IF_EQ(AreaByte(5), 1)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Purple_Anim05, ANIM_Mouser_Purple_Anim01, 0, MSG_CH2_0088)
...
EvtScript N(interact_80249854) = {
    EVT_CALL(SpeakToPlayer, 7, ANIM_Toadette_Pink_Anim04, ANIM_Toadette_Pink_Anim01, 0, MSG_CH2_008E)
    EVT_CALL(SpeakToPlayer, 8, ANIM_Toadette_Pink_Anim04, ANIM_Toadette_Pink_Anim01, 0, MSG_CH2_008F)
    EVT_CALL(SpeakToPlayer, 9, ANIM_Toadette_Pink_Anim04, ANIM_Toadette_Pink_Anim01, 0, MSG_CH2_0090)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_802498E8) = {
    ...
    EVT_IF_NE(LVar1, -1)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Brown_Anim04, ANIM_Dryite_Brown_Anim01, 0, MSG_CH2_009A)
        EVT_RETURN
    EVT_END_IF
    EVT_IF_NE(LVar2, -1)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Brown_Anim04, ANIM_Dryite_Brown_Anim01, 0, MSG_CH2_009B)
        EVT_RETURN
    EVT_END_IF
    EVT_IF_NE(LVar3, -1)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Brown_Anim04, ANIM_Dryite_Brown_Anim01, 0, MSG_CH2_009C)
        EVT_RETURN
    EVT_END_IF
    EVT_IF_NE(LVar4, -1)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Brown_Anim04, ANIM_Dryite_Brown_Anim01, 0, MSG_CH2_009D)
        EVT_RETURN
    EVT_END_IF
    EVT_IF_NE(LVar5, -1)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Brown_Anim04, ANIM_Dryite_Brown_Anim01, 0, MSG_CH2_009E)
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Brown_Anim04, ANIM_Dryite_Brown_Anim01, 0, MSG_CH2_0099)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_80249AE0) = {
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Brown_Anim04, ANIM_Dryite_Brown_Anim01, 0, MSG_CH2_009F)
    EVT_RETURN
    EVT_END
};
...
StaticNpc N(npcGroup_80249B34)[] = {
	...
	.territory = { .temp = { -235, 0, 160, 30, 0, -32767, 0, 0, 0, 0, 0, 0, 0, 1 }},
        .animations = {
            ANIM_Dryite_Yellow_Anim01,
            ANIM_Dryite_Yellow_Anim02,
            ANIM_Dryite_Yellow_Anim03,
            ANIM_Dryite_Yellow_Anim03,
            ANIM_Dryite_Yellow_Anim01,
            ANIM_Dryite_Yellow_Anim01,
            ANIM_Dryite_Yellow_Anim00,
            ANIM_Dryite_Yellow_Anim00,
            ANIM_Dryite_Yellow_Anim01,
            ANIM_Dryite_Yellow_Anim01,
            ANIM_Dryite_Yellow_Anim01,
	...
	.animations = {
            ANIM_ChuckQuizmo_Anim01,
            ANIM_ChuckQuizmo_Anim02,
            ANIM_ChuckQuizmo_Anim03,
            ANIM_ChuckQuizmo_Anim03,
            ANIM_ChuckQuizmo_Anim01,
            ANIM_ChuckQuizmo_Anim01,
            ANIM_ChuckQuizmo_Anim00,
            ANIM_ChuckQuizmo_Anim00,
            ANIM_ChuckQuizmo_Anim03,
            ANIM_ChuckQuizmo_Anim03,
            ANIM_ChuckQuizmo_Anim03,
	...
	.territory = { .temp = { -120, 0, 134, 40, 0, -32767, 0, 0, 0, 0, 0, 0, 0, 1 }},
        .animations = {
            ANIM_Dryite_Brown_Anim01,
            ANIM_Dryite_Brown_Anim02,
            ANIM_Dryite_Brown_Anim03,
            ANIM_Dryite_Brown_Anim03,
            ANIM_Dryite_Brown_Anim01,
            ANIM_Dryite_Brown_Anim01,
            ANIM_Dryite_Brown_Anim00,
            ANIM_Dryite_Brown_Anim00,
            ANIM_Dryite_Brown_Anim01,
            ANIM_Dryite_Brown_Anim01,
            ANIM_Dryite_Brown_Anim01,
...
StaticNpc N(npcGroup_8024AE94)[] = {
	...
	.animations = {
            ANIM_Toadette_Pink_Anim01,
            ANIM_Toadette_Pink_Anim02,
            ANIM_Toadette_Pink_Anim03,
            ANIM_Toadette_Pink_Anim03,
            ANIM_Toadette_Pink_Anim01,
            ANIM_Toadette_Pink_Anim01,
            ANIM_Toadette_Pink_Anim06,
            ANIM_Toadette_Pink_Anim06,
            ANIM_Toadette_Pink_Anim03,
            ANIM_Toadette_Pink_Anim03,
            ANIM_Toadette_Pink_Anim03,
...
EvtScript N(8024B6B4) = {
    ...
    EVT_IF_LT(GB_StoryProgress, -64)
        EVT_CALL(SpeakToPlayer, 6, ANIM_Mouser_Purple_Anim05, ANIM_Mouser_Purple_Anim01, 0, MSG_CH2_0087)
        EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
        EVT_WAIT(10)
        EVT_CALL(SetPlayerAnimation, ANIM_Mario_80007)
        EVT_WAIT(30)
    EVT_END_IF
    EVT_CALL(SpeakToPlayer, 6, ANIM_Mouser_Purple_Anim05, ANIM_Mouser_Purple_Anim01, 0, MSG_CH2_0088)
...
EvtScript N(8024B7B0) = {
    EVT_IF_EQ(GF_DRO01_Gift_RedJar, 0)
        ...
        EVT_CALL(func_802D2C14, 1)
        EVT_EXEC_WAIT(N(8024B614))
        EVT_CALL(SpeakToPlayer, 6, ANIM_Mouser_Purple_Anim05, ANIM_Mouser_Purple_Anim01, 0, MSG_CH2_008D)
        EVT_SET(LVar0, 119)
        EVT_SET(LVar1, 1)
