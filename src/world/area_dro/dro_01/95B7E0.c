...
Script N(8024DD78) = SCRIPT({
    ...
    bind N(shakeTree_8024D720) to TRIGGER_WALL_HAMMER 11;
    bind N(shakeTree_8024D720) to TRIGGER_POINT_BOMB N(triggerCoord_8024DD68);
});
