...
EvtScript N(80247AA0) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldMerlee_AnimA)
        EVT_WAIT(200)
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldMerlee_Anim9)
        EVT_WAIT(40)
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldMerlee_AnimA)
        EVT_WAIT(75)
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldMerlee_AnimB)
    EVT_END_THREAD
    EVT_WAIT(60)
...
EvtScript N(802482F8) = {
    ...
    EVT_END_IF
    EVT_IF_EQ(LVar0, 3)
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_WorldMerlee_Anim7, ANIM_WorldMerlee_Anim4, 0, MSG_CH2_00DC)
        EVT_SET(LVar0, 39)
        EVT_SET(LVar1, 1)
        ...
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_WorldMerlee_Anim7, ANIM_WorldMerlee_Anim4, 0, MSG_CH2_00D6)
    EVT_CALL(ShowChoice, MSG_Choice_0011)
    EVT_IF_NE(LVar0, 0)
        EVT_CALL(ContinueSpeech, -1, ANIM_WorldMerlee_Anim7, ANIM_WorldMerlee_Anim4, 0, MSG_CH2_00D7)
        EVT_CALL(func_802D2C14, 0)
        EVT_EXEC_WAIT(N(802482A8))
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(ContinueSpeech, -1, ANIM_WorldMerlee_Anim7, ANIM_WorldMerlee_Anim4, 0, MSG_CH2_00D8)
    ...
    EVT_IF_NE(LVar1, 0)
        EVT_CALL(ContinueSpeech, -1, ANIM_WorldMerlee_Anim7, ANIM_WorldMerlee_Anim4, 0, MSG_CH2_00D9)
        EVT_CALL(func_802D2C14, 0)
        EVT_EXEC_WAIT(N(802482A8))
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(ContinueSpeech, -1, ANIM_WorldMerlee_Anim7, ANIM_WorldMerlee_Anim4, 0, MSG_CH2_00DA)
    ...
    EVT_END_LOOP
    EVT_WAIT(60)
    EVT_CALL(SetNpcAnimation, 4, ANIM_WorldMerlee_Anim4)
    EVT_CALL(PlayerMoveTo, -100, -370, 8)
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_WorldMerlee_Anim7, ANIM_WorldMerlee_Anim4, 0, MSG_CH2_00DB)
    EVT_EXEC(N(80243AF0))
...
EvtScript N(interact_8024ADE4) = {
    ...
    EVT_IF_EQ(LVar1, 0)
        EVT_SET(LVar8, LVar0)
    EVT_END_IF
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Toad_Red_Anim4, ANIM_Toad_Red_Anim1, 0, LVar8)
    EVT_CALL(ShowChoice, MSG_Choice_0006)
    EVT_WAIT(3)
    EVT_IF_EQ(LVar0, 1)
        EVT_CALL(ContinueSpeech, -1, ANIM_Toad_Red_Anim4, ANIM_Toad_Red_Anim1, 0, LVar9)
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(ContinueSpeech, -1, ANIM_Toad_Red_Anim4, ANIM_Toad_Red_Anim1, 0, LVarA)
    ...
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Toad_Red_Anim4, ANIM_Toad_Red_Anim1, 0, LVarB)
...
EvtScript N(8024B20C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_DEFAULT
            ...
            EVT_CALL(SetNpcAnimation, NPC_PARTNER, ANIM_WorldParakarry_Anim2)
            ...
            EVT_CALL(SetNpcAnimation, NPC_PARTNER, ANIM_WorldParakarry_Anim1)
        ...
        EVT_IF_NE(LVar1, -1)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(-1)
                    EVT_CALL(DisablePartnerAI, 0)
                    EVT_WAIT(1)
                    EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldParakarry_Anim6, ANIM_WorldParakarry_Anim1, 5, LVar8)
                    EVT_CALL(EnablePartnerAI)
                    EVT_SET(LVarC, 1)
                EVT_CASE_DEFAULT
                    EVT_CALL(DisablePartnerAI, 0)
                    EVT_WAIT(1)
                    EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldParakarry_Anim6, ANIM_WorldParakarry_Anim1, 5, LVar9)
                    EVT_IF_NE(LVarA, 0)
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-53)
            EVT_IF_EQ(GF_SBK30_Kolorado_SharedRumorAboutMoustafa, 1)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Archeologist_Anim4, ANIM_Archeologist_Anim1, 0, MSG_CH2_00B2)
            EVT_ELSE
                EVT_SWITCH(AreaByte(3))
                    EVT_CASE_EQ(0)
                        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Archeologist_Anim4, ANIM_Archeologist_Anim1, 0, MSG_CH2_00AF)
                        EVT_SET(AreaByte(3), 1)
                    EVT_CASE_EQ(1)
                        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Archeologist_Anim4, ANIM_Archeologist_Anim1, 0, MSG_CH2_00B0)
                        EVT_SET(AreaByte(3), 2)
                    EVT_CASE_EQ(2)
                        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Archeologist_Anim4, ANIM_Archeologist_Anim1, 0, MSG_CH2_00B1)
                        EVT_SET(AreaByte(3), 1)
                EVT_END_SWITCH
            EVT_END_IF
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Archeologist_Anim4, ANIM_Archeologist_Anim1, 0, MSG_CH2_00B3)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-53)
            EVT_IF_EQ(GF_DRO02_Sheek_AskedAboutDesert, 0)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim4, ANIM_Dryite_Blue_Anim1, 0, MSG_CH2_0091)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim4, ANIM_Dryite_Blue_Anim1, 0, MSG_CH2_0092)
            EVT_END_IF
        EVT_CASE_LT(39)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim4, ANIM_Dryite_Blue_Anim1, 0, MSG_CH2_0093)
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Blue_Anim4, ANIM_Dryite_Blue_Anim1, 0, MSG_CH2_0094)
    EVT_END_SWITCH
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-53)
            EVT_IF_EQ(AreaFlag(3), 0)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Green_Anim4, ANIM_Dryite_Green_Anim1, 0, MSG_CH2_00A1)
                EVT_SET(AreaFlag(3), 1)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Green_Anim4, ANIM_Dryite_Green_Anim1, 0, MSG_CH2_00A2)
                EVT_SET(AreaFlag(3), 0)
            EVT_END_IF
        EVT_CASE_LT(39)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Green_Anim4, ANIM_Dryite_Green_Anim1, 0, MSG_CH2_00A3)
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Green_Anim4, ANIM_Dryite_Green_Anim1, 0, MSG_CH2_00A4)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(interact_8024BCF8) = {
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Dryite_Green_Anim4, ANIM_Dryite_Green_Anim1, 0, MSG_CH2_00A0)
    EVT_RETURN
    EVT_END
};
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-53)
            EVT_IF_EQ(AreaFlag(4), 0)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00A5)
                EVT_SET(AreaFlag(4), 1)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00A6)
                EVT_SET(AreaFlag(4), 0)
            EVT_END_IF
        EVT_CASE_LT(39)
            EVT_IF_EQ(AreaFlag(4), 0)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00A7)
                EVT_SET(AreaFlag(4), 1)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00A8)
                EVT_SET(AreaFlag(4), 0)
            EVT_END_IF
        EVT_CASE_DEFAULT
            EVT_IF_EQ(AreaFlag(4), 0)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00A9)
                EVT_SET(AreaFlag(4), 1)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00AA)
                EVT_SET(AreaFlag(4), 0)
            EVT_END_IF
    EVT_END_SWITCH
    EVT_RETURN
    ...
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-53)
            EVT_IF_EQ(AreaFlag(5), 0)
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00AB)
                EVT_SET(AreaFlag(5), 1)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00AC)
                EVT_SET(AreaFlag(5), 0)
            EVT_END_IF
        EVT_CASE_LT(39)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00AD)
        EVT_CASE_DEFAULT
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_Mouser_Blue_Anim5, ANIM_Mouser_Blue_Anim1, 0, MSG_CH2_00AE)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(8024C248) = {
    ...
    EVT_CALL(SetNpcAnimation, 2, ANIM_DisguisedMoustafa_Anim5)
    EVT_WAIT(30)
    EVT_CALL(SetNpcAnimation, 2, ANIM_DisguisedMoustafa_Anim6)
    EVT_CALL(SetNpcAnimation, 5, ANIM_Moustafa_Anim7)
    ...
    EVT_CALL(SetNpcAnimation, 5, ANIM_Moustafa_Anim1)
    EVT_CALL(SetNpcFlagBits, 2, ((NPC_FLAG_100)), FALSE)
...
EvtScript N(interact_8024C4EC) = {
    EVT_IF_EQ(GF_DRO02_Moustafa_UnusedDialogOverride, 1)
        EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00CF)
        EVT_RETURN
    EVT_END_IF
    EVT_SWITCH(GB_StoryProgress)
        EVT_CASE_LT(-64)
            EVT_SET(LVarB, 0)
            EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00B4)
            EVT_LABEL(0)
            EVT_CALL(ShowChoice, MSG_Choice_0019)
            EVT_IF_EQ(LVar0, 1)
                EVT_CALL(ContinueSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00B6)
                EVT_EXEC(N(8024C1F8))
                EVT_RETURN
            EVT_ELSE
                EVT_CALL(EndSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0)
            EVT_END_IF
            EVT_LABEL(1)
            EVT_SET(LVar0, 0)
            EVT_SET(LVar1, 2)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00B8)
                    EVT_EXEC(N(8024C1F8))
                    EVT_RETURN
                EVT_CASE_EQ(-1)
                    EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00B7)
                    EVT_EXEC(N(8024C1F8))
                    EVT_RETURN
            EVT_END_SWITCH
            EVT_SET(LVarA, LVar0)
            EVT_IF_EQ(GB_DRO02_SheekLemonGiftCount, 0)
                EVT_IF_EQ(LVarA, 156)
                    ...
                    EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00BB)
                    EVT_CALL(ShowChoice, MSG_Choice_001C)
                EVT_ELSE
                    EVT_ADD(GB_DRO02_SheekGiftCount, 1)
                    EVT_IF_LE(GB_DRO02_SheekGiftCount, 2)
                        EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00B5)
                        EVT_GOTO(0)
                    EVT_END_IF
                    EVT_IF_EQ(GB_DRO02_SheekGiftCount, 3)
                        EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00B9)
                        EVT_CALL(ShowChoice, MSG_Choice_001B)
                    EVT_ELSE
                        EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00BA)
                        EVT_CALL(ShowChoice, MSG_Choice_001B)
                        EVT_SET(GB_DRO02_SheekGiftCount, 10)
                    EVT_END_IF
                EVT_END_IF
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    EVT_CALL(ContinueSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00BC)
                EVT_CASE_EQ(1)
                    EVT_EXEC_WAIT(N(8024C0B8))
                    EVT_CALL(ContinueSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00BD)
                    EVT_SET(GF_DRO02_Sheek_AskedAboutDesert, 1)
                EVT_CASE_EQ(2)
                    EVT_EXEC_WAIT(N(8024C0B8))
                    EVT_CALL(ContinueSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00BE)
                    EVT_SET(GF_DRO02_Sheek_AskedAboutRuins, 1)
                EVT_CASE_EQ(3)
                    EVT_EXEC_WAIT(N(8024C0B8))
                    EVT_CALL(ContinueSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00BF)
                EVT_CASE_EQ(4)
                    EVT_EXEC_WAIT(N(8024C0B8))
                    EVT_CALL(ContinueSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00C1)
                    EVT_SET(GF_DRO02_Sheek_AskedAboutMoustafa, 1)
                    EVT_SET(LVarB, 1)
            EVT_END_SWITCH
            EVT_SET(GF_DRO02_Sheek_SpokeTo, 1)
            EVT_CALL(ContinueSpeech, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00C0)
            ...
            EVT_IF_EQ(LVarB, 1)
                EVT_IF_EQ(MapFlag(0), 0)
                    ...
                    EVT_THREAD
                        ...
                        EVT_CALL(DisablePlayerInput, TRUE)
                        EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00C2)
                        EVT_CALL(DisablePlayerInput, FALSE)
                        EVT_SET(MapFlag(0), 0)
                    EVT_END_THREAD
                EVT_END_IF
        ...
        EVT_CASE_LT(-63)
            ...
            EVT_IF_EQ(GF_DRO02_Sheek_AskedAboutMoustafa, 1)
                EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00C3)
                EVT_EXEC_WAIT(N(8024C248))
                EVT_CALL(func_802D2C14, 0)
                EVT_CALL(SetNpcJumpscale, 5, EVT_FLOAT(1.0))
                EVT_CALL(NpcJump0, 5, -425, 140, -206, 20)
                EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00C4)
            EVT_ELSE
                EVT_CALL(SpeakToPlayer, 2, ANIM_DisguisedMoustafa_Anim4, ANIM_DisguisedMoustafa_Anim1, 0, MSG_CH2_00C5)
                EVT_EXEC_WAIT(N(8024C248))
                EVT_CALL(func_802D2C14, 0)
                EVT_CALL(SetNpcJumpscale, 5, EVT_FLOAT(1.0))
                EVT_CALL(NpcJump0, 5, -425, 140, -206, 20)
                EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00C6)
            EVT_END_IF
            EVT_CALL(SetNpcJumpscale, 5, EVT_FLOAT(1.0))
            EVT_CALL(NpcJump0, 5, -337, 140, -200, 20)
            EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00C7)
            EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00C8)
            EVT_CALL(SetNpcJumpscale, 5, EVT_FLOAT(1.0))
            EVT_CALL(NpcJump0, 5, -335, 163, -260, 20)
            EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00C9)
            EVT_SET(LVar0, 18)
            EVT_SET(LVar1, 1)
            EVT_EXEC_WAIT(N(EVS_Quizmo_GiveItem_0))
            EVT_CALL(AddKeyItem, ITEM_PULSE_STONE)
            EVT_SET(GB_StoryProgress, -63)
            EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00CA)
            EVT_KILL_THREAD(LVarA)
            EVT_EXEC(N(80243AF0))
        EVT_CASE_GE(-63)
            EVT_SWITCH(GB_StoryProgress)
                EVT_CASE_LT(-62)
                    EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00CB)
                EVT_CASE_GE(-62)
                    EVT_IF_GE(GB_StoryProgress, -56)
                        EVT_IF_EQ(GF_DRO02_Moustafa_HeardAboutDryDryRuins, 0)
                            EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00CD)
                            EVT_CALL(SetPlayerAnimation, ANIM_Mario_10002)
                            EVT_WAIT(15)
                            EVT_CALL(SetPlayerAnimation, ANIM_Mario_80007)
                            EVT_WAIT(30)
                            EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00CE)
                            EVT_SET(GF_DRO02_Moustafa_HeardAboutDryDryRuins, 1)
                        EVT_ELSE
                            EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00D0)
                        EVT_END_IF
                    EVT_ELSE
                        EVT_CALL(SpeakToPlayer, 5, ANIM_Moustafa_Anim5, ANIM_Moustafa_Anim1, 0, MSG_CH2_00CC)
                    EVT_END_IF
            EVT_END_SWITCH
    EVT_END_SWITCH
    EVT_RETURN
...
EvtScript N(init_8024D04C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(3)
            ...
            EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_DisguisedMoustafa_Anim5)
        EVT_END_CASE_GROUP
        EVT_CASE_DEFAULT
...
EvtScript N(idle_8024D154) = {
    ...
    EVT_LABEL(10)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Mouser_Purple_Anim7)
    EVT_CALL(SetNpcAnimation, 2, ANIM_DisguisedMoustafa_Anim1)
    EVT_LOOP(50)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Mouser_Purple_Anim1)
    EVT_CALL(SetNpcAnimation, 2, ANIM_DisguisedMoustafa_Anim7)
    EVT_LOOP(50)
        EVT_CALL(IsPlayerWithin, 200, 50, 100, LVar0)
        EVT_IF_EQ(LVar0, 1)
            EVT_GOTO(20)
    ...
    EVT_LABEL(20)
    EVT_CALL(SetNpcAnimation, 2, ANIM_DisguisedMoustafa_Anim1)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Mouser_Purple_Anim4)
    EVT_CALL(SetNpcFlagBits, NPC_SELF, ((NPC_FLAG_100)), TRUE)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Mouser_Purple_Anim4)
...
StaticNpc N(npcGroup_8024D7B4)[] = {
    {
        ...
        .animations = {
            ANIM_Archeologist_Anim1,
            ANIM_Archeologist_Anim2,
            ANIM_Archeologist_Anim3,
            ANIM_Archeologist_Anim3,
            ANIM_Archeologist_Anim1,
            ANIM_Archeologist_Anim1,
            ANIM_Archeologist_Anim1,
    ...
    },
    {
        ...
        .animations = {
            ANIM_Dryite_Blue_Anim1,
            ANIM_Dryite_Blue_Anim2,
            ANIM_Dryite_Blue_Anim3,
            ANIM_Dryite_Blue_Anim3,
            ANIM_Dryite_Blue_Anim1,
            ANIM_Dryite_Blue_Anim1,
            ANIM_Dryite_Blue_Anim0,
            ANIM_Dryite_Blue_Anim0,
            ANIM_Dryite_Blue_Anim1,
            ANIM_Dryite_Blue_Anim1,
            ANIM_Dryite_Blue_Anim1,
    ...
    },
    {
	    ...
	    .animations = {
            ANIM_WorldMerlee_Anim4,
            ANIM_WorldMerlee_Anim5,
            ANIM_WorldMerlee_Anim6,
            ANIM_WorldMerlee_Anim6,
            ANIM_WorldMerlee_Anim4,
            ANIM_WorldMerlee_Anim4,
            ANIM_WorldMerlee_Anim4,
    ...
    },
    {
	    ...
	    .animations = {
            ANIM_Dryite_Green_Anim1,
            ANIM_Dryite_Green_Anim2,
            ANIM_Dryite_Green_Anim3,
            ANIM_Dryite_Green_Anim3,
            ANIM_Dryite_Green_Anim1,
            ANIM_Dryite_Green_Anim1,
            ANIM_Dryite_Green_Anim0,
            ANIM_Dryite_Green_Anim0,
            ANIM_Dryite_Green_Anim1,
            ANIM_Dryite_Green_Anim1,
            ANIM_Dryite_Green_Anim1,
    ...
    },
    {
	    ...
	    .animations = {
            ANIM_Mouser_Blue_Anim1,
            ANIM_Mouser_Blue_Anim4,
            ANIM_Mouser_Blue_Anim4,
            ANIM_Mouser_Blue_Anim4,
            ANIM_Mouser_Blue_Anim1,
            ANIM_Mouser_Blue_Anim1,
    ...
    },
    {
	    ...
	    .animations = {
            ANIM_Mouser_Purple_Anim1,
            ANIM_Mouser_Purple_Anim4,
            ANIM_Mouser_Purple_Anim4,
            ANIM_Mouser_Purple_Anim1,
            ANIM_Mouser_Purple_Anim1,
            ANIM_Mouser_Purple_Anim1,
    ...
    },
    {
	    ...
	    .animations = {
            ANIM_ChuckQuizmo_Anim1,
            ANIM_ChuckQuizmo_Anim2,
            ANIM_ChuckQuizmo_Anim3,
            ANIM_ChuckQuizmo_Anim3,
            ANIM_ChuckQuizmo_Anim1,
            ANIM_ChuckQuizmo_Anim1,
            ANIM_ChuckQuizmo_Anim0,
            ANIM_ChuckQuizmo_Anim0,
            ANIM_ChuckQuizmo_Anim3,
            ANIM_ChuckQuizmo_Anim3,
            ANIM_ChuckQuizmo_Anim3,
