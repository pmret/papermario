...
EvtScript N(EVS_KoopaBros_FlingAway) = {
    EVT_THREAD
        EVT_CALL(PlaySoundAtNpc, LVar0, SOUND_HIT_NORMAL, 0)
...
EvtScript N(EVS_NpcIdle_Door) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosRed, SOUND_3E9, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosBlk, SOUND_3E9, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosYlw, SOUND_3E9, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosGrn, SOUND_3E9, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosRed, SOUND_20F3, 0)
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, 30)
        EVT_PLAY_EFFECT(EFFECT_LENS_FLARE, 0, LVar0, LVar1, LVar2, 40)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosBlk, SOUND_20F3, 0)
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, 30)
        EVT_PLAY_EFFECT(EFFECT_LENS_FLARE, 0, LVar0, LVar1, LVar2, 40)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosYlw, SOUND_20F3, 0)
    ...
    EVT_THREAD
        ...
        EVT_ADD(LVar1, 30)
        EVT_PLAY_EFFECT(EFFECT_LENS_FLARE, 0, LVar0, LVar1, LVar2, 40)
        EVT_CALL(PlaySoundAtNpc, NPC_KoopaBrosGrn, SOUND_20F3, 0)
    ...
    EVT_THREAD
        ...
        EVT_LOOP(0)
            ...
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_CALL(SetPlayerFlagBits, PS_FLAGS_NO_STATIC_COLLISION | PS_FLAGS_ROTATION_LOCKED | PS_FLAGS_FACE_FORWARDS, TRUE)
        EVT_CALL(MakeLerp, 0, 11 * 180, 50, EASING_QUADRATIC_OUT)
        EVT_LOOP(0)
            EVT_CALL(UpdateLerp)
            ...
            EVT_END_IF
        EVT_END_LOOP
        EVT_CALL(SetPlayerFlagBits, PS_FLAGS_NO_STATIC_COLLISION | PS_FLAGS_ROTATION_LOCKED | PS_FLAGS_FACE_FORWARDS, FALSE)
...
StaticNpc N(NpcData_Enemies)[] = {
    {
        ...
        .yaw = 270,
        .flags = ENEMY_FLAGS_8 | ENEMY_FLAGS_100 | ENEMY_FLAGS_200 | ENEMY_FLAGS_400 | ENEMY_FLAGS_800 | ENEMY_FLAGS_100000 | ENEMY_FLAGS_200000 | ENEMY_FLAGS_400000 | ENEMY_FLAGS_IGNORE_TOUCH | ENEMY_FLAGS_IGNORE_JUMP,
    ...
    },
    {
        ...
        .pos = { NPC_DISPOSE_LOCATION },
        .yaw = 270,
        .flags = ENEMY_FLAGS_8 | ENEMY_FLAGS_100 | ENEMY_FLAGS_400 | ENEMY_FLAGS_800 | ENEMY_FLAGS_100000 | ENEMY_FLAGS_200000 | ENEMY_FLAGS_400000 | ENEMY_FLAGS_IGNORE_TOUCH | ENEMY_FLAGS_IGNORE_JUMP,
        .init = &N(EVS_NpcInit_KoopaBros),
        .drops = KOOPA_BROS_DROPS,
