...
INCLUDE_ASM(s32, "world/area_kpa/kpa_115/A9ED40", func_80240000_A9ED40);
/*
ApiStatus N(func_80240000_A9ED40)(ScriptInstance *script, s32 isInitialCall) {
...
INCLUDE_ASM(s32, "world/area_kpa/kpa_115/A9ED40", func_802400BC_A9EDFC);
/*
ApiStatus N(func_802400BC_A9EDFC)(ScriptInstance *script, s32 isInitialCall) {
    PlayerStatus* playerStatus = &gPlayerStatus;
