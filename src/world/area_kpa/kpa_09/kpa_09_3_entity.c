...
EvtScript N(EVS_ActivateSwitch) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o19, SOUND_0227, SOUND_SPACE_MODE_0)
        ...
        EVT_END_LOOP
        EVT_WAIT(80)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o19, SOUND_0228, SOUND_SPACE_MODE_0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o106, SOUND_0227, SOUND_SPACE_MODE_0)
        ...
        EVT_WAIT(80)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o106, SOUND_0228, SOUND_SPACE_MODE_0)
        EVT_CALL(MakeLerp, 0, -50, 15, EASING_COS_IN_OUT)
        EVT_LOOP(0)
            EVT_CALL(UpdateLerp)
            EVT_CALL(N(ElevatePlayer), 18, 100)
