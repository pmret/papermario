...
EvtScript N(EVS_ActivateSwitch) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o19, SOUND_227, 0)
        ...
        EVT_END_LOOP
        EVT_WAIT(80)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o19, SOUND_228, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o106, SOUND_227, 0)
        ...
        EVT_WAIT(80)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o106, SOUND_228, 0)
        EVT_CALL(MakeLerp, 0, -50, 15, EASING_COS_IN_OUT)
        EVT_LOOP(0)
            EVT_CALL(UpdateLerp)
            EVT_CALL(N(ElevatePlayer), 18, 100)
