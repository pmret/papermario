...
EvtScript N(EVS_OpenAirshipDockDoor) = {
    EVT_CALL(PlaySoundAtCollider, COLLIDER_deilitts, SOUND_01DF, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_CloseAirshipDockDoor) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_deilitts, SOUND_01E0, SOUND_SPACE_MODE_0)
    EVT_RETURN
    EVT_END
};
