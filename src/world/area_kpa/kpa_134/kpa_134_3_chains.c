...
EvtScript N(EVS_SetupLowerChain) = {
    ...
    EVT_LABEL(10)
        ...
        EVT_CALL(PlaySoundAtPlayer, SOUND_LRAW_229, SOUND_SPACE_MODE_0)
...
EvtScript N(EVS_LowerWaterLevel0) = {
    ...
    EVT_IF_EQ(LVar1, 1)
        EVT_GOTO(30)
    EVT_END_IF
    EVT_CALL(PlaySound, SOUND_LRAW_22B | SOUND_ID_TRIGGER_CHANGE_SOUND)
    EVT_CALL(func_802D62E4, SOUND_LRAW_22B)
...
EvtScript N(EVS_RaiseWaterLevel1) = {
    ...
    EVT_THREAD
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(40)
        EVT_END_IF
        EVT_CALL(PlaySound, SOUND_LRAW_22A | SOUND_ID_TRIGGER_CHANGE_SOUND)
        EVT_CALL(func_802D62E4, SOUND_LRAW_22A)
        EVT_CALL(EnableModel, MODEL_o389, FALSE)
        EVT_CALL(EnableModel, MODEL_o388, FALSE)
    EVT_END_THREAD
    EVT_WAIT(230)
