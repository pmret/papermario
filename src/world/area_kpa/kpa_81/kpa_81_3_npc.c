...
StaticNpc N(NpcData_Door) = {
    ...
    .yaw = 0,
    .flags = ENEMY_FLAGS_8 | ENEMY_FLAGS_100 | ENEMY_FLAGS_400 | ENEMY_FLAGS_800 | ENEMY_FLAGS_4000 | ENEMY_FLAGS_100000 | ENEMY_FLAGS_400000 | ENEMY_FLAGS_IGNORE_TOUCH | ENEMY_FLAGS_IGNORE_JUMP,
...
NpcGroupList N(DefaultNPCs) = {
    NPC_GROUP(N(NpcData_Door), BTL_KMR_PART_1_FORMATION_00, BTL_KMR_PART_1_STAGE_00),
    {}
};
