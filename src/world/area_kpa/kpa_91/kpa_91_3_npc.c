...
EvtScript N(EVS_ToadHouse_GetInBed) = {
    ...
    EVT_CALL(SetPlayerFoldFlags, IMGFX_STATE_FLAG_2000 | IMGFX_STATE_FLAG_800)
    EVT_CALL(UpdatePlayerFold, ANIM_Mario1_Idle, IMGFX_UPD_SET_ANIM, IMGFX_ANIM_GET_IN_BED, 1, 1, 0)
    EVT_WAIT(61)
