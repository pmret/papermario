...
EvtScript N(EVS_ActivateSwitch) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o90, SOUND_LRAW_227, SOUND_SPACE_MODE_0)
        ...
        EVT_WAIT(80)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o90, SOUND_LRAW_228, SOUND_SPACE_MODE_0)
