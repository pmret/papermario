...
EvtScript N(802430E0) = {
    ...
    EVT_LOOP(20)
        ...
        EVT_IF_NE(LVarA, 0)
            ...
            EVT_RETURN
        EVT_END_IF
        EVT_CALL(N(UnkFunc11), LocalVar(9))
    ...
    EVT_THREAD
        ...
        EVT_SUB(LocalVar(2), LocalVar(6))
        EVT_ADD(LocalVar(1), LocalVar(2))
        EVT_CALL(MakeLerp, LocalVar(0), LocalVar(1), 100, 0)
        EVT_LOOP(0)
            EVT_CALL(SetPlayerActionState, 20)
            EVT_CALL(UpdateLerp)
    ...
    EVT_END_THREAD
    EVT_CALL(MakeLerp, LocalVar(6), LocalVar(7), 100, 0)
    EVT_CALL(PlaySoundAtCollider, 27, 0x80000010, 0)
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(TranslateModel, 51, LocalVar(0), 0, 0)
...
EvtScript N(80243470) = {
    ...
    EVT_SET(LocalVar(7), 48)
    EVT_SET(LocalVar(8), 0)
    EVT_SET(LocalVar(9), 27)
    EVT_EXEC_WAIT(N(802430E0))
    EVT_LABEL(90)
    EVT_IF_NE(LocalVar(8), -1)
