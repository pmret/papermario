...
NpcGroupList N(npcGroupList_802436EC) = {
    NPC_GROUP(N(npcGroup_80241FE4), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_802421D4), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_802423C4), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_802425B4), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_802427A4), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80242994), BTL_NONE, BTL_DEFAULT_STAGE),
    {},
};

NpcGroupList N(npcGroupList_80243740) = {
    NPC_GROUP(N(npcGroup_802434FC), BTL_NONE, BTL_DEFAULT_STAGE),
    {},
};
