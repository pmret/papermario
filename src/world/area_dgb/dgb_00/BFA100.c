...
EvtScript N(80240B08) = {
    ...
    EVT_CALL(SetNpcAnimation, 0, ANIM_Boo_Tan_Anim6)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(80240B74) = {
    ...
    EVT_CALL(SetNpcAnimation, 1, ANIM_Boo_Tan_Anim6)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(80240C4C) = {
    ...
    EVT_CALL(SetNpcAnimation, 3, ANIM_Boo_Tan_Anim6)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(80240CB8) = {
    ...
    EVT_CALL(SetNpcAnimation, 4, ANIM_Boo_Tan_Anim6)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(80240D24) = {
    ...
    EVT_CALL(SetNpcAnimation, 5, ANIM_Boo_Tan_Anim6)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(8024103C) = {
    ...
    EVT_CALL(SpeakToPlayer, 0, ANIM_Boo_Tan_Anim4, ANIM_Boo_Tan_Anim1, 5, MSG_CH3_00DB)
    EVT_CALL(SpeakToPlayer, 4, ANIM_Boo_Tan_Anim4, ANIM_Boo_Tan_Anim1, 5, MSG_CH3_00DC)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Boo_Tan_Anim4, ANIM_Boo_Tan_Anim1, 5, MSG_CH3_00DD)
    EVT_CALL(PlaySoundAt, SOUND_B4, 0, 240, 10, -125)
    EVT_CALL(ShakeCam, 0, 0, 20, EVT_FLOAT(2.0))
    EVT_WAIT(10)
    EVT_CALL(PlaySoundAt, SOUND_B4, 0, 240, 10, -125)
...
EvtScript N(802413F4) = {
    ...
    EVT_CALL(SpeakToPlayer, 0, ANIM_Boo_Tan_Anim4, ANIM_Boo_Tan_Anim1, 0, MSG_CH3_00DF)
    EVT_KILL_THREAD(LVarA)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_80007)
    EVT_WAIT(20)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Boo_Tan_Anim4, ANIM_Boo_Tan_Anim1, 0, MSG_CH3_00E0)
    EVT_WAIT(20)
    EVT_CALL(SetPlayerAnimation, ANIM_Mario_NodYes)
    EVT_WAIT(20)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Boo_Tan_Anim4, ANIM_Boo_Tan_Anim1, 0, MSG_CH3_00E1)
    EVT_CALL(DisablePartnerAI, 0)
    EVT_CALL(GetCurrentPartnerID, LVar0)
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(1)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldGoombario_Anim8, ANIM_WorldGoombario_Anim1, 0, MSG_CH3_00E2)
        EVT_CASE_EQ(2)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldKooper_AnimD, ANIM_WorldKooper_Anim3, 0, MSG_CH3_00E3)
        EVT_CASE_EQ(3)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldBombette_AnimE, ANIM_WorldBombette_Anim3, 0, MSG_CH3_00E4)
        EVT_CASE_EQ(4)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldParakarry_Anim6, ANIM_WorldParakarry_Anim1, 0, MSG_CH3_00E5)
        EVT_CASE_EQ(9)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldBow_Anim4, ANIM_WorldBow_Anim1, 0, MSG_CH3_00E6)
    EVT_END_SWITCH
    EVT_CALL(EnablePartnerAI)
    EVT_CALL(SetCamType, 0, 4, 0)
    EVT_CALL(SetCamSpeed, 0, EVT_FLOAT(6.0))
    ...
    EVT_WAIT(10)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Boo_Tan_Anim6, ANIM_Boo_Tan_Anim6, 5, MSG_CH3_00E8)
    EVT_CALL(SetNpcAnimation, 0, ANIM_Boo_Tan_Anim6)
    EVT_EXEC(N(80240F50))
...
EvtScript N(interact_80241CD8) = {
    EVT_SET(MapVar(0), 1)
    EVT_CALL(SpeakToPlayer, 0, ANIM_Boo_Tan_Anim6, ANIM_Boo_Tan_Anim6, 5, MSG_CH3_00E9)
    EVT_CALL(SetNpcAnimation, 0, ANIM_Boo_Tan_Anim6)
    EVT_CALL(DisablePartnerAI, 0)
    EVT_CALL(GetCurrentPartnerID, LVar0)
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(1)
            ...
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldGoombario_Anim8, ANIM_WorldGoombario_Anim1, 0, MSG_CH3_00EA)
            EVT_CALL(ResetCam, 0, EVT_FLOAT(6.0))
        EVT_CASE_EQ(2)
            EVT_CALL(AdjustCam, 0, EVT_FLOAT(6.0), 0, EVT_FLOAT(-275.0), EVT_FLOAT(15.0), EVT_FLOAT(-6.0))
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldKooper_AnimD, ANIM_WorldKooper_Anim3, 0, MSG_CH3_00EB)
            EVT_CALL(ResetCam, 0, EVT_FLOAT(6.0))
        EVT_CASE_EQ(3)
            EVT_CALL(AdjustCam, 0, EVT_FLOAT(6.0), 0, EVT_FLOAT(-275.0), EVT_FLOAT(15.0), EVT_FLOAT(-6.0))
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldBombette_AnimE, ANIM_WorldBombette_Anim3, 0, MSG_CH3_00EC)
            EVT_CALL(ResetCam, 0, EVT_FLOAT(6.0))
        EVT_CASE_EQ(4)
            EVT_CALL(AdjustCam, 0, EVT_FLOAT(6.0), 0, EVT_FLOAT(-275.0), EVT_FLOAT(15.0), EVT_FLOAT(-6.0))
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldParakarry_Anim6, ANIM_WorldParakarry_Anim1, 0, MSG_CH3_00ED)
            EVT_CALL(ResetCam, 0, EVT_FLOAT(6.0))
        EVT_CASE_EQ(9)
            EVT_CALL(AdjustCam, 0, EVT_FLOAT(6.0), 0, EVT_FLOAT(-275.0), EVT_FLOAT(15.0), EVT_FLOAT(-6.0))
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldBow_Anim4, ANIM_WorldBow_Anim1, 0, MSG_CH3_00EE)
            EVT_CALL(ResetCam, 0, EVT_FLOAT(6.0))
    EVT_END_SWITCH
    EVT_CALL(EnablePartnerAI)
    EVT_SET(MapVar(0), 0)
...
EvtScript N(80242B84) = {
    ...
    EVT_CALL(SetNpcAnimation, 6, ANIM_Sentinel_Anim8)
    ...
    EVT_CALL(SetNpcAnimation, 6, ANIM_Sentinel_Anim9)
    EVT_WAIT(20)
    EVT_CALL(PlaySoundAtNpc, 6, SOUND_2F7, 0)
    EVT_CALL(SetNpcAnimation, 6, ANIM_Sentinel_Anim2)
    EVT_CALL(SetNpcPos, 6, 175, 70, -33)
    EVT_THREAD
        EVT_WAIT(40)
        EVT_CALL(SetNpcAnimation, 6, ANIM_Sentinel_Anim3)
