...
EvtScript N(80243EF0) = {
    ...
    EVT_THREAD
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_AnimD)
...
EvtScript N(idle_8024536C) = {
    ...
    EVT_LOOP(0)
        ...
        EVT_END_IF
    EVT_END_LOOP
    EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_AnimA)
    EVT_CALL(SetNpcPos, NPC_SELF, 520, 420, 0)
    EVT_CALL(SetNpcYaw, NPC_SELF, 270)
    EVT_CALL(NpcMoveTo, NPC_SELF, 390, 0, 30)
    EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_Anim7)
    EVT_THREAD
        EVT_WAIT(20)
    ...
    EVT_END_THREAD
    EVT_CALL(SpeakToPlayer, 4, ANIM_WorldTubba_Anim10, ANIM_WorldTubba_Anim6, 0, MSG_CH3_0101)
    EVT_THREAD
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_Anim19)
        EVT_WAIT(4)
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_Anim1A)
        EVT_WAIT(17)
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_Anim1B)
        EVT_WAIT(11)
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_Anim1C)
        EVT_WAIT(30)
        EVT_CALL(SetNpcAnimation, 4, ANIM_WorldTubba_Anim1D)
    EVT_END_THREAD
    EVT_WAIT(4)
...
EvtScript N(init_80245D80) = {
    ...
    EVT_IF_GE(LVar0, -29)
        ...
        EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Sentinel_Anim1)
