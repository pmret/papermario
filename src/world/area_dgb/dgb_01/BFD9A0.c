...
NpcGroupList N(npcGroupList_80246E50) = {
    NPC_GROUP(N(npcGroup_80246090), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80246280), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80246470), BTL_NONE, BTL_DEFAULT_STAGE),
    NPC_GROUP(N(npcGroup_80246660), BTL_NONE, BTL_DEFAULT_STAGE),
    {},
};
