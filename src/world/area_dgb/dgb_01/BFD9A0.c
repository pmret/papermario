...
EvtScript N(80243EF0) = {
    ...
    EVT_LOOP(0)
        EVT_CALL(GetNpcVar, 4, 0, LocalVar(0))
    ...
    EVT_THREAD
        ...
        EVT_SUB(LocalVar(1), 210)
        EVT_WAIT(1)
        EVT_CALL(SetNpcJumpscale, NPC_PARTNER, EVT_FIXED(0.5))
        EVT_CALL(NpcJump1, NPC_PARTNER, 151, LocalVar(1), 0, 60)
        EVT_WAIT(30)
        EVT_CALL(EnablePartnerAI)
    EVT_END_THREAD
...
EvtScript N(idle_8024536C) = {
    ...
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(RotateModel, 49, LocalVar(0), 0, 1, 0)
        EVT_CALL(RotateModel, 51, LocalVar(0), 0, -1, 0)
        EVT_WAIT(1)
    ...
    EVT_CALL(NpcJump0, 4, LocalVar(0), LocalVar(1), LocalVar(2), 30)
...
EvtScript N(idle_8024598C) = {
    ...
    EVT_LOOP(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(RotateModel, 39, LocalVar(0), 0, -1, 0)
        EVT_CALL(RotateModel, 41, LocalVar(0), 0, 1, 0)
        EVT_WAIT(1)
        EVT_IF_EQ(LocalVar(1), 0)
            EVT_BREAK_LOOP
        EVT_END_IF
...
EvtScript N(init_80245D80) = {
    EVT_SET(LocalVar(0), GB_StoryProgress)
    EVT_IF_GE(LocalVar(0), -29)
