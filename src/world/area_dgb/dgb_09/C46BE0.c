...
s32 N(extraAnimationList_802440BC)[] = {
    ANIM_WorldClubba_Anim0,
    ANIM_WorldClubba_Anim2,
    ANIM_WorldClubba_Anim3,
    ANIM_WorldClubba_Anim4,
    ANIM_WorldClubba_AnimC,
    ANIM_WorldClubba_Anim7,
    ANIM_WorldClubba_Anim8,
...
EvtScript N(npcAI_802443DC) = {
    ...
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_Sentinel_Anim8)
    EVT_WAIT(10)
