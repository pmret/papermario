...
s32 N(unk_missing_80242100)[] = {
    0x00000000, 0x000E0012, 0x00000000, 0x00000000, (s32) N(80242058), 0x00000000, 0x00000000, (s32) N(80241EA0),
...
EvtScript N(idle_80242238) = {
    ...
    EVT_CALL(SetNpcAnimation, 0, ANIM_WorldTubba_Anim09)
...
EvtScript N(npcAI_8024274C) = {
    ...
    EVT_CALL(SetNpcAnimation, 0, ANIM_WorldTubba_Anim0C)
    EVT_EXEC(N(802424E8))
