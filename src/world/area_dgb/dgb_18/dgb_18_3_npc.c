...
EvtScript N(EVS_Scene_TubbaFallsAsleep) = {
    ...
    EVT_WAIT(30)
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SNORE_INHALE, SOUND_SPACE_DEFAULT)
    EVT_WAIT(30)
    EVT_THREAD
        ...
        EVT_LOOP(0)
            ...
            EVT_IF_EQ(LVar0, 1)
                EVT_BREAK_LOOP
            EVT_END_IF
            EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SNORE_EXHALE, SOUND_SPACE_DEFAULT)
...
EvtScript N(EVS_NpcAI_Tubba_WakeUp) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_SRAW_0E_A, SOUND_SPACE_DEFAULT)
