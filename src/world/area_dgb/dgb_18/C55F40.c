...
EvtScript N(idle_80242A24) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(1)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldGoombario_Anim8, ANIM_WorldGoombario_Anim1, 0, MSG_CH3_00FC)
        EVT_CASE_EQ(2)
            EVT_CALL(SpeakToPlayer, NPC_PARTNER, ANIM_WorldKooper_AnimD, ANIM_WorldKooper_Anim3, 0, MSG_CH3_00FD)
        EVT_CASE_EQ(3)
