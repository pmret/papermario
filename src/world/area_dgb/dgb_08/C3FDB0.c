...
EvtScript N(idle_80244A54) = {
    ...
    EVT_LOOP(0)
        ...
        EVT_END_IF
    EVT_END_LOOP
    EVT_CALL(SetNpcAnimation, 9, ANIM_WorldTubba_AnimA)
...
EvtScript N(idle_80246210) = {
    EVT_LABEL(0)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_WorldClubba_Anim7)
    EVT_WAIT(30)
    EVT_LOOP(15)
        EVT_CALL(N(func_80243C50_C43A00))
        EVT_WAIT(60)
    EVT_END_LOOP
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_WorldClubba_AnimC)
    EVT_WAIT(20)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_WorldClubba_Anim7)
    EVT_WAIT(30)
    EVT_LOOP(5)
...
EvtScript N(interact_80246310) = {
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_WorldClubba_Anim8)
    EVT_CALL(PlaySoundAtNpc, NPC_SELF, SOUND_2F1, 0)
    EVT_WAIT(10)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_WorldClubba_Anim2)
    EVT_WAIT(20)
    ...
    EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_WorldClubba_Anim5, ANIM_WorldClubba_Anim2, 0, MSG_CH3_00F2)
    EVT_WAIT(10)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_WorldClubba_Anim6)
    EVT_WAIT(10)
    EVT_CALL(SetNpcAnimation, NPC_SELF, ANIM_WorldClubba_Anim7)
    EVT_RETURN
    EVT_END
