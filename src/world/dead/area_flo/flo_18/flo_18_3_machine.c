...
EvtScript N(EVS_DamagedLeftOnce) = {
    ...
    EVT_THREAD
        EVT_WAIT(10)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o130, SOUND_01E6, SOUND_SPACE_DEFAULT)
    EVT_END_THREAD
    EVT_LOOP(300)
...
EvtScript N(EVS_DamagedRightOnce) = {
    ...
    EVT_THREAD
        EVT_WAIT(12)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o175, SOUND_01E7, SOUND_SPACE_DEFAULT)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar4, EVT_FLOAT(-0.5))
        EVT_ADDF(LVar0, LVar3)
...
EvtScript N(EVS_DamagedLeftTwice) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o174, SOUND_01E7, SOUND_SPACE_DEFAULT)
    EVT_END_THREAD
    EVT_LOOP(300)
...
EvtScript N(EVS_DamagedRightTwice) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o127, SOUND_01E7, SOUND_SPACE_DEFAULT)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar5, EVT_FLOAT(0.5))
        EVT_ADDF(LVar2, LVar5)
...
EvtScript N(EVS_BreakSmokestack) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o131, SOUND_01E6, SOUND_SPACE_DEFAULT)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar4, EVT_FLOAT(-0.5))
        EVT_ADDF(LVar5, EVT_FLOAT(0.093))
...
EvtScript N(EVS_BreakAntenna) = {
    ...
    EVT_THREAD
        EVT_WAIT(15)
        EVT_CALL(PlaySoundAtCollider, COLLIDER_o126, SOUND_01E6, SOUND_SPACE_DEFAULT)
    EVT_END_THREAD
    EVT_LOOP(300)
        EVT_ADDF(LVar4, EVT_FLOAT(-0.5))
        EVT_ADDF(LVar0, LVar3)
        ...
        EVT_IF_EQ(GB_FLO18_MachineDamage_Right, 2)
            ...
            EVT_THREAD
                ...
                EVT_LOOP(ARRAY_COUNT(N(SmokeBurstPositions)))
                    ...
                    EVT_CALL(PlaySoundAt, SOUND_0190, SOUND_SPACE_DEFAULT, LVar0, LVar1, LVar2)
                ...
                EVT_END_LOOP
            EVT_END_THREAD
            EVT_CALL(PlaySoundAt, SOUND_01A0, SOUND_SPACE_DEFAULT, 70, 40, 10)
            EVT_PLAY_EFFECT(EFFECT_RING_BLAST, 0, 70, 40, 10, EVT_FLOAT(3.0), 30)
            EVT_CALL(ShakeCam, CAM_DEFAULT, 0, 20, EVT_FLOAT(1.0))
            EVT_CALL(PlaySoundAt, SOUND_01A0, SOUND_SPACE_DEFAULT, 0, 30, 30)
