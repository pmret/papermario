...
EvtScript N(EVS_Wisterwood_Exit) = {
    ...
    EVT_CALL(PlaySoundAtCollider, COLLIDER_deilittn, SOUND_01CF, SOUND_SPACE_DEFAULT)
    ...
    EVT_LOOP(0)
        ...
        EVT_END_IF
    EVT_END_LOOP
    EVT_CALL(PlaySoundAtCollider, COLLIDER_deilittn, SOUND_01D0, SOUND_SPACE_DEFAULT)
