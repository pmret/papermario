...
EvtScript N(EVS_NpcInit_HuffNPuff_Face) = {
    IfLt(GB_StoryProgress, STORY_CH6_DEFEATED_HUFF_N_PUFF)
        Call(SetEnemyFlagBits, NPC_SELF, ENEMY_FLAG_DO_NOT_AUTO_FACE_PLAYER, 1)
...
NpcGroupList N(DefaultNPCs) = {
    NPC_GROUP(N(NpcData_HuffNPuff), 0x1B00, BTL_FLO2_STAGE_07),
    NPC_GROUP(N(NpcData_RuffPuffs), 0x1A1F, BTL_FLO_STAGE_07),
    {}
};
