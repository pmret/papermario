...
EvtScript N(EVS_TrySpawningStarCard) = {
    ...
    EVT_IF_EQ(LVar0, 0)
        ...
        EVT_THREAD
            ...
            EVT_CALL(PlaySoundAt, SOUND_STAR_ORB_BURST, SOUND_SPACE_MODE_0, 185, 110, -30)
        EVT_END_THREAD
        EVT_THREAD
            EVT_WAIT(45)
        ...
        EVT_THREAD
            EVT_WAIT(180)
            EVT_WAIT(115)
            EVT_CALL(PlaySoundAt, SOUND_STAR_CARD_APPEARS, SOUND_SPACE_MODE_0, 185, 110, -30)
        EVT_END_THREAD
    ...
    EVT_CALL(PlaySoundAtPlayer, SOUND_RESCUE_STAR_SPIRIT, SOUND_SPACE_MODE_0)
    EVT_CALL(DisablePlayerInput, TRUE)
