...
INCLUDE_IMG("level_up/big_V.png.bin", D_802A1418_79F358);
#include "level_up/big_V.gfx.inc.c"
INCLUDE_IMG("level_up/big_P.png.bin", D_802A2490_7A03D0);
#include "level_up/big_P.gfx.inc.c"
INCLUDE_IMG("level_up/big_exclamation_mark.png.bin", D_802A3508_7A1448);
#include "level_up/big_exclamation_mark.gfx.inc.c"
INCLUDE_IMG("level_up/big_U.png.bin", D_802A4580_7A24C0);
#include "level_up/big_U.gfx.inc.c"
INCLUDE_IMG("level_up/big_L.png.bin", D_802A55F8_7A3538);
#include "level_up/big_L.gfx.inc.c"
INCLUDE_IMG("level_up/big_E.png.bin", D_802A6670_7A45B0);
...
INCLUDE_IMG("level_up/heart.png.bin", level_up_heart_png);
INCLUDE_PAL("level_up/heart.pal.bin", level_up_heart_pal);
INCLUDE_IMG("level_up/flower.png.bin", level_up_flower_png);
INCLUDE_PAL("level_up/flower.pal.bin", level_up_flower_pal);
INCLUDE_IMG("level_up/leaves.png.bin", level_up_leaves_png);
INCLUDE_PAL("level_up/leaves.pal.bin", level_up_leaves_pal);
INCLUDE_IMG("level_up/badge.png.bin", level_up_badge_png);
INCLUDE_PAL("level_up/badge.pal.bin", level_up_badge_pal);
INCLUDE_IMG("level_up/FP.png.bin", level_up_FP_png);
INCLUDE_PAL("level_up/FP.pal.bin", level_up_FP_pal);
INCLUDE_IMG("level_up/BP.png.bin", level_up_BP_png);
INCLUDE_PAL("level_up/BP.pal.bin", level_up_BP_pal);
INCLUDE_IMG("level_up/HP.png.bin", level_up_HP_png);
INCLUDE_PAL("level_up/HP.pal.bin", level_up_HP_pal);

INCLUDE_IMG("level_up/digit_0.png.bin", level_up_digit_0_png);
INCLUDE_PAL("level_up/digit_0.pal.bin", level_up_digit_0_pal);
INCLUDE_IMG("level_up/digit_1.png.bin", level_up_digit_1_png);
INCLUDE_PAL("level_up/digit_1.pal.bin", level_up_digit_1_pal);
INCLUDE_IMG("level_up/digit_2.png.bin", level_up_digit_2_png);
INCLUDE_PAL("level_up/digit_2.pal.bin", level_up_digit_2_pal);
INCLUDE_IMG("level_up/digit_3.png.bin", level_up_digit_3_png);
INCLUDE_PAL("level_up/digit_3.pal.bin", level_up_digit_3_pal);
INCLUDE_IMG("level_up/digit_4.png.bin", level_up_digit_4_png);
INCLUDE_PAL("level_up/digit_4.pal.bin", level_up_digit_4_pal);
INCLUDE_IMG("level_up/digit_5.png.bin", level_up_digit_5_png);
INCLUDE_PAL("level_up/digit_5.pal.bin", level_up_digit_5_pal);
INCLUDE_IMG("level_up/digit_6.png.bin", level_up_digit_6_png);
INCLUDE_PAL("level_up/digit_6.pal.bin", level_up_digit_6_pal);
INCLUDE_IMG("level_up/digit_7.png.bin", level_up_digit_7_png);
INCLUDE_PAL("level_up/digit_7.pal.bin", level_up_digit_7_pal);
INCLUDE_IMG("level_up/digit_8.png.bin", level_up_digit_8_png);
INCLUDE_PAL("level_up/digit_8.pal.bin", level_up_digit_8_pal);
INCLUDE_IMG("level_up/digit_9.png.bin", level_up_digit_9_png);
INCLUDE_PAL("level_up/digit_9.pal.bin", level_up_digit_9_pal);

INCLUDE_IMG("level_up/small_digit_0.png.bin", level_up_small_digit_0_png);
INCLUDE_PAL("level_up/small_digit_0.pal.bin", level_up_small_digit_0_pal);
INCLUDE_IMG("level_up/small_digit_1.png.bin", level_up_small_digit_1_png);
INCLUDE_PAL("level_up/small_digit_1.pal.bin", level_up_small_digit_1_pal);
INCLUDE_IMG("level_up/small_digit_2.png.bin", level_up_small_digit_2_png);
INCLUDE_PAL("level_up/small_digit_2.pal.bin", level_up_small_digit_2_pal);
INCLUDE_IMG("level_up/small_digit_3.png.bin", level_up_small_digit_3_png);
INCLUDE_PAL("level_up/small_digit_3.pal.bin", level_up_small_digit_3_pal);
INCLUDE_IMG("level_up/small_digit_4.png.bin", level_up_small_digit_4_png);
INCLUDE_PAL("level_up/small_digit_4.pal.bin", level_up_small_digit_4_pal);
INCLUDE_IMG("level_up/small_digit_5.png.bin", level_up_small_digit_5_png);
INCLUDE_PAL("level_up/small_digit_5.pal.bin", level_up_small_digit_5_pal);
INCLUDE_IMG("level_up/small_digit_6.png.bin", level_up_small_digit_6_png);
INCLUDE_PAL("level_up/small_digit_6.pal.bin", level_up_small_digit_6_pal);
INCLUDE_IMG("level_up/small_digit_7.png.bin", level_up_small_digit_7_png);
INCLUDE_PAL("level_up/small_digit_7.pal.bin", level_up_small_digit_7_pal);
INCLUDE_IMG("level_up/small_digit_8.png.bin", level_up_small_digit_8_png);
INCLUDE_PAL("level_up/small_digit_8.pal.bin", level_up_small_digit_8_pal);
INCLUDE_IMG("level_up/small_digit_9.png.bin", level_up_small_digit_9_png);
INCLUDE_PAL("level_up/small_digit_9.pal.bin", level_up_small_digit_9_pal);
INCLUDE_IMG("level_up/small_arrow.png.bin", level_up_small_arrow_png);
INCLUDE_PAL("level_up/small_arrow.pal.bin", level_up_small_arrow_pal);

#define level_up_digit_0_red_png level_up_digit_0_png
INCLUDE_PAL("level_up/digit_0.red.pal.bin", level_up_digit_0_red_pal);
#define level_up_digit_1_red_png level_up_digit_1_png
INCLUDE_PAL("level_up/digit_1.red.pal.bin", level_up_digit_1_red_pal);
#define level_up_digit_2_red_png level_up_digit_2_png
INCLUDE_PAL("level_up/digit_2.red.pal.bin", level_up_digit_2_red_pal);
#define level_up_digit_3_red_png level_up_digit_3_png
INCLUDE_PAL("level_up/digit_3.red.pal.bin", level_up_digit_3_red_pal);
#define level_up_digit_4_red_png level_up_digit_4_png
INCLUDE_PAL("level_up/digit_4.red.pal.bin", level_up_digit_4_red_pal);
#define level_up_digit_5_red_png level_up_digit_5_png
INCLUDE_PAL("level_up/digit_5.red.pal.bin", level_up_digit_5_red_pal);
#define level_up_digit_6_red_png level_up_digit_6_png
INCLUDE_PAL("level_up/digit_6.red.pal.bin", level_up_digit_6_red_pal);
#define level_up_digit_7_red_png level_up_digit_7_png
INCLUDE_PAL("level_up/digit_7.red.pal.bin", level_up_digit_7_red_pal);
#define level_up_digit_8_red_png level_up_digit_8_png
INCLUDE_PAL("level_up/digit_8.red.pal.bin", level_up_digit_8_red_pal);
#define level_up_digit_9_red_png level_up_digit_9_png
INCLUDE_PAL("level_up/digit_9.red.pal.bin", level_up_digit_9_red_pal);

#define level_up_small_digit_0_red_png level_up_small_digit_0_png
INCLUDE_PAL("level_up/small_digit_0.red.pal.bin", level_up_small_digit_0_red_pal);
#define level_up_small_digit_1_red_png level_up_small_digit_1_png
INCLUDE_PAL("level_up/small_digit_1.red.pal.bin", level_up_small_digit_1_red_pal);
#define level_up_small_digit_2_red_png level_up_small_digit_2_png
INCLUDE_PAL("level_up/small_digit_2.red.pal.bin", level_up_small_digit_2_red_pal);
#define level_up_small_digit_3_red_png level_up_small_digit_3_png
INCLUDE_PAL("level_up/small_digit_3.red.pal.bin", level_up_small_digit_3_red_pal);
#define level_up_small_digit_4_red_png level_up_small_digit_4_png
INCLUDE_PAL("level_up/small_digit_4.red.pal.bin", level_up_small_digit_4_red_pal);
#define level_up_small_digit_5_red_png level_up_small_digit_5_png
INCLUDE_PAL("level_up/small_digit_5.red.pal.bin", level_up_small_digit_5_red_pal);
#define level_up_small_digit_6_red_png level_up_small_digit_6_png
INCLUDE_PAL("level_up/small_digit_6.red.pal.bin", level_up_small_digit_6_red_pal);
#define level_up_small_digit_7_red_png level_up_small_digit_7_png
INCLUDE_PAL("level_up/small_digit_7.red.pal.bin", level_up_small_digit_7_red_pal);
#define level_up_small_digit_8_red_png level_up_small_digit_8_png
INCLUDE_PAL("level_up/small_digit_8.red.pal.bin", level_up_small_digit_8_red_pal);
#define level_up_small_digit_9_red_png level_up_small_digit_9_png
INCLUDE_PAL("level_up/small_digit_9.red.pal.bin", level_up_small_digit_9_red_pal);
#define level_up_small_arrow_red_png level_up_small_arrow_png
INCLUDE_PAL("level_up/small_arrow.red.pal.bin", level_up_small_arrow_red_pal);

#define level_up_digit_0_blue_png level_up_digit_0_png
INCLUDE_PAL("level_up/digit_0.blue.pal.bin", level_up_digit_0_blue_pal);
#define level_up_digit_1_blue_png level_up_digit_1_png
INCLUDE_PAL("level_up/digit_1.blue.pal.bin", level_up_digit_1_blue_pal);
#define level_up_digit_2_blue_png level_up_digit_2_png
INCLUDE_PAL("level_up/digit_2.blue.pal.bin", level_up_digit_2_blue_pal);
#define level_up_digit_3_blue_png level_up_digit_3_png
INCLUDE_PAL("level_up/digit_3.blue.pal.bin", level_up_digit_3_blue_pal);
#define level_up_digit_4_blue_png level_up_digit_4_png
INCLUDE_PAL("level_up/digit_4.blue.pal.bin", level_up_digit_4_blue_pal);
#define level_up_digit_5_blue_png level_up_digit_5_png
INCLUDE_PAL("level_up/digit_5.blue.pal.bin", level_up_digit_5_blue_pal);
#define level_up_digit_6_blue_png level_up_digit_6_png
INCLUDE_PAL("level_up/digit_6.blue.pal.bin", level_up_digit_6_blue_pal);
#define level_up_digit_7_blue_png level_up_digit_7_png
INCLUDE_PAL("level_up/digit_7.blue.pal.bin", level_up_digit_7_blue_pal);
#define level_up_digit_8_blue_png level_up_digit_8_png
INCLUDE_PAL("level_up/digit_8.blue.pal.bin", level_up_digit_8_blue_pal);
#define level_up_digit_9_blue_png level_up_digit_9_png
INCLUDE_PAL("level_up/digit_9.blue.pal.bin", level_up_digit_9_blue_pal);

#define level_up_small_digit_0_blue_png level_up_small_digit_0_png
INCLUDE_PAL("level_up/small_digit_0.blue.pal.bin", level_up_small_digit_0_blue_pal);
#define level_up_small_digit_1_blue_png level_up_small_digit_1_png
INCLUDE_PAL("level_up/small_digit_1.blue.pal.bin", level_up_small_digit_1_blue_pal);
#define level_up_small_digit_2_blue_png level_up_small_digit_2_png
INCLUDE_PAL("level_up/small_digit_2.blue.pal.bin", level_up_small_digit_2_blue_pal);
#define level_up_small_digit_3_blue_png level_up_small_digit_3_png
INCLUDE_PAL("level_up/small_digit_3.blue.pal.bin", level_up_small_digit_3_blue_pal);
#define level_up_small_digit_4_blue_png level_up_small_digit_4_png
INCLUDE_PAL("level_up/small_digit_4.blue.pal.bin", level_up_small_digit_4_blue_pal);
#define level_up_small_digit_5_blue_png level_up_small_digit_5_png
INCLUDE_PAL("level_up/small_digit_5.blue.pal.bin", level_up_small_digit_5_blue_pal);
#define level_up_small_digit_6_blue_png level_up_small_digit_6_png
INCLUDE_PAL("level_up/small_digit_6.blue.pal.bin", level_up_small_digit_6_blue_pal);
#define level_up_small_digit_7_blue_png level_up_small_digit_7_png
INCLUDE_PAL("level_up/small_digit_7.blue.pal.bin", level_up_small_digit_7_blue_pal);
#define level_up_small_digit_8_blue_png level_up_small_digit_8_png
INCLUDE_PAL("level_up/small_digit_8.blue.pal.bin", level_up_small_digit_8_blue_pal);
#define level_up_small_digit_9_blue_png level_up_small_digit_9_png
INCLUDE_PAL("level_up/small_digit_9.blue.pal.bin", level_up_small_digit_9_blue_pal);
#define level_up_small_arrow_blue_png level_up_small_arrow_png
INCLUDE_PAL("level_up/small_arrow.blue.pal.bin", level_up_small_arrow_blue_pal);

INCLUDE_IMG("level_up/select_one_to_upgrade.png.bin", level_up_select_one_to_upgrade_png);
INCLUDE_PAL("level_up/select_one_to_upgrade.pal.bin", level_up_select_one_to_upgrade_pal);
