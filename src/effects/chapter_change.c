...
#if VERSION_IQUE
    { D_0900BE40_3F7CA0,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 },
    { D_0900BE88_3F7CE8,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 },
    { D_0900BED0_3F7D30,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 },
    { D_0900BF18_3F7D78,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 },
    { D_0900BF60_3F7DC0,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 },
    { D_0900BFA8_3F7E08,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 },
    { D_0900BFF0_3F7E50,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 },
    { D_0900C038_3F7E98,  48, -13, 64, 64 },
    {              NULL,   0,   0,  0,  0 }
#else
