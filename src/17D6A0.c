...
u32 bMarioIdleAnims[] = {
    ...
    STATUS_KEY_TURN_DONE,           ANIM_Mario1_Still,
    STATUS_KEY_TURN_DONE_BERSERK,   ANIM_MarioB2_BerserkStill,
    STATUS_KEY_14,                  ANIM_MarioB2_Inert,
    STATUS_KEY_TURN_DONE_SLEEP,     ANIM_MarioB1_SleepStill,
    STATUS_KEY_TURN_DONE_DIZZY,     ANIM_MarioB1_SickStill,
    STATUS_KEY_TURN_DONE_WEARY,     ANIM_Mario1_TiredStill,
...
s32 bMarioHideAnims[] = {
    ...
    STATUS_KEY_FROZEN,              ANIM_Mario1_Frozen,
    STATUS_KEY_TRANSPARENT,         ANIM_Mario1_Idle,
    STATUS_KEY_TURN_DONE,           ANIM_Mario1_Crouch,
    STATUS_KEY_TURN_DONE_BERSERK,   ANIM_MarioB2_BerserkStill,
    STATUS_KEY_14,                  ANIM_MarioB2_Inert,
    STATUS_KEY_TURN_DONE_SLEEP,     ANIM_MarioB1_SleepStill,
    STATUS_KEY_TURN_DONE_DIZZY,     ANIM_MarioB1_SickStill,
...
s32 bPeachIdleAnims[] = {
    ...
    STATUS_KEY_TURN_DONE,       ANIM_Peach2_Inert,
    STATUS_TABLE_END
};
