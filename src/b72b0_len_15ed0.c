...
INCLUDE_ASM(s32, "b72b0_len_15ed0", clear_entity_models);

INCLUDE_ASM(s32, "b72b0_len_15ed0", init_entity_models);

INCLUDE_ASM(s32, "b72b0_len_15ed0", load_entity_model);

INCLUDE_ASM(s32, "b72b0_len_15ed0", ALT_load_entity_model);

INCLUDE_ASM(s32, "b72b0_len_15ed0", update_entity_rendercmd);

INCLUDE_ASM(s32, "b72b0_len_15ed0", step_entity_rendercmd);
...
INCLUDE_ASM(s32, "b72b0_len_15ed0", func_80122D7C);

s32 func_80122DDC(s32 arg0) {
    return gCurrentEntityModelList[arg0 & ~0x800];
}

INCLUDE_ASM(s32, "b72b0_len_15ed0", free_entity_model_by_index);

INCLUDE_ASM(s32, "b72b0_len_15ed0", free_entity_model_by_ref);

INCLUDE_ASM(s32, "b72b0_len_15ed0", set_entity_model_flags);

INCLUDE_ASM(s32, "b72b0_len_15ed0", clear_entity_model_flags);

INCLUDE_ASM(s32, "b72b0_len_15ed0", func_80122F64);

INCLUDE_ASM(s32, "b72b0_len_15ed0", func_80122F8C);

INCLUDE_ASM(s32, "b72b0_len_15ed0", func_80122FB8);
...
INCLUDE_ASM(s32, "b72b0_len_15ed0", clear_dynamic_entity_list);
...
INCLUDE_ASM(s32, "b72b0_len_15ed0", bind_dynamic_entity_3);

INCLUDE_ASM(s32, "b72b0_len_15ed0", bind_dynamic_entity_7, s32* updateFunc, void (*drawFunc)(void));

INCLUDE_ASM(s32, "b72b0_len_15ed0", bind_dynamic_entity_B);

INCLUDE_ASM(s32, "b72b0_len_15ed0", update_dynamic_entities);

INCLUDE_ASM(s32, "b72b0_len_15ed0", render_dynamic_entities);

INCLUDE_ASM(s32, "b72b0_len_15ed0", func_801234E0);

INCLUDE_ASM(s32, "b72b0_len_15ed0", func_80123550);

INCLUDE_ASM(s32, "b72b0_len_15ed0", func_801235C0);
