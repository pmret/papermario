...
void func_8004E3A4(BGMPlayer* arg0) {
    arg0->fadeInfo.fadeTime--;

    if (arg0->fadeInfo.fadeTime != 0) {
        arg0->fadeInfo.currentVolume.s32 += arg0->fadeInfo.fadeStep;
    } else {
        arg0->fadeInfo.currentVolume.s32 = arg0->fadeInfo.endVolume << 16;

        if (arg0->fadeInfo.fpFadeCallback != NULL) {
            arg0->fadeInfo.fpFadeCallback();
        }

        if (arg0->fadeSongName != 0) {
            func_8004DC80(arg0->fadeSongName);
        } else if (arg0->fadeInfo.currentVolume.s32 == 0) {
            func_8004DAA8(arg0);
        }
    }
    func_8004E444(arg0);
...
INCLUDE_ASM(s16, "code_28910_len_5090", func_8004E4B8, BGMPlayer* arg0);
...
void func_8004FBBC(BGMPlayer* arg0, UnkAl60* arg1) {
    ...
    arg0->unk_B0 = temp_v0;
    arg0->unkFrequency = temp_v0 * 10;
    arg0->unk_BC = 0;
    arg0->unk_B8 = 0;
    arg0->unk_B4 = 0;
}

s32 func_8004FC08(BGMPlayer* arg0, u32 arg1) {
...
void func_8004FCB4(BGMPlayer* arg0, UnkAl60* arg1) {
...
void func_8004FCE4(BGMPlayer* arg0, UnkAl60* arg1) {
    arg0->unk_20C = (s8)arg0->unk_D4.u8[0] * 100;
}

void func_8004FD04(BGMPlayer* arg0, UnkAl60* arg1) {
    arg0->data->unk_40[arg0->unk_235].unk_00 = arg0->unk_D4.u8[0];
    arg0->data->unk_40[arg0->unk_235].unk_01 = 1;
}

void func_8004FD38(BGMPlayer* arg0, UnkAl60* arg1) {
...
void func_8004FD94(BGMPlayer* arg0, UnkAl60* arg1) {
...
void func_8004FE10(BGMPlayer* arg0, UnkAl60* arg1) {
    s32 temp_a1;
    s32 temp_a2;
...
#else
INCLUDE_ASM(void, "code_28910_len_5090", func_8004FE6C, BGMPlayer* arg0, UnkAl60* arg1);
#endif

void func_8004FEB0(BGMPlayer* arg0, UnkAl60* arg1) {
...
#else
INCLUDE_ASM(void, "code_28910_len_5090", func_8004FED0, BGMPlayer* arg0, UnkAl60* arg1);
#endif

void func_8004FF3C(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_4A = arg0->unk_D4.u8[0] & 0x7F;
    arg1->unk_57 = 0;
    arg1->unk_42 = 1;
}

void func_8004FF58(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_4B = arg0->unk_D4.u8[0] & 0x7F;
    arg1->unk_43 = 1;
}

void func_8004FF70(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_49 = arg0->unk_D4.u8[0] & 0x7F;
    arg1->unk_41 = 1;
}

void func_8004FF88(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_46 = (s8)arg0->unk_D4.u8[0] * 100;
}

void func_8004FFA8(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_48 = arg0->unk_D4.u8[0];
}

void func_8004FFB4(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_38 = arg0->unk_D4.u16;
    arg1->unk_40 = 1;
}

void func_8004FFC8(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_3A = arg0->unk_D4.u8[0];
    arg1->unk_55 = arg0->unk_D4.u8[1];
    arg1->unk_56 = arg0->unk_D6.u8[0];
}

void func_8004FFE4(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_55 = arg0->unk_D4.u8[0];
}

void func_8004FFF0(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_56 = arg0->unk_D4.u8[0];
}

void func_8004FFFC(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_56 = 0;
}

void func_80050004(BGMPlayer* arg0, UnkAl60* arg1) {
    arg1->unk_4A = arg0->unk_D4.u8[0] & 0x7F;
    arg1->unk_57 = arg0->unk_D4.u8[1] & 0x7F;
}

INCLUDE_ASM(void, "code_28910_len_5090", func_80050020, BGMPlayer* arg0, UnkAl60* arg1);

void func_80050128(BGMPlayer* arg0, UnkAl60* arg1) {
...
#else
INCLUDE_ASM(void, "code_28910_len_5090", func_8005015C, BGMPlayer* arg0, UnkAl60* arg1);
#endif

void func_80050184(BGMPlayer* arg0, UnkAl60* arg1) {
...
INCLUDE_ASM(void, "code_28910_len_5090", func_800501A8, BGMPlayer* arg0, UnkAl60* arg1);

INCLUDE_ASM(void, "code_28910_len_5090", func_800502F0, BGMPlayer* arg0, UnkAl60* arg1);

void func_80050560(BGMPlayer* arg0, UnkAl60* arg1) {
}
