...
INCLUDE_ASM_T(void, "code_362a0_len_2f70", update_collider_transform, s16 colliderID);

INCLUDE_ASM("code_362a0_len_2f70", get_collider_type_by_id);

INCLUDE_ASM("code_362a0_len_2f70", func_8005BDD8);

INCLUDE_ASM_T(void, "code_362a0_len_2f70", get_collider_center, s32 colliderID, f32* x, f32* y, f32* z);
