...
INCLUDE_IMG("starpoint/starpoint.png.bin", D_802A1018_7A89B8);
...
INCLUDE_IMG("starpoint/starpoints.png.bin", D_802A21D8_7A9B78);
...
INCLUDE_IMG("starpoint/digit_0.png.bin", D_802A3340_7AACE0);
...
INCLUDE_IMG("starpoint/digit_1.png.bin", D_802A4460_7ABE00);
...
INCLUDE_IMG("starpoint/digit_2.png.bin", D_802A5580_7ACF20);
...
INCLUDE_IMG("starpoint/digit_3.png.bin", D_802A66A0_7AE040);
...
INCLUDE_IMG("starpoint/digit_4.png.bin", D_802A77C0_7AF160);
...
INCLUDE_IMG("starpoint/digit_5.png.bin", D_802A88E0_7B0280);
...
INCLUDE_IMG("starpoint/digit_6.png.bin", D_802A9A00_7B13A0);
...
INCLUDE_IMG("starpoint/digit_7.png.bin", D_802AAB20_7B24C0);
...
INCLUDE_IMG("starpoint/digit_8.png.bin", D_802ABC40_7B35E0);
...
INCLUDE_IMG("starpoint/digit_9.png.bin", D_802ACD60_7B4700);
