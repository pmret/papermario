...
s32 gPauseMessages[] = {
    [PAUSE_MSG_00]		MSG_NONE,
    [PAUSE_MSG_01]		MSG_MenuTip_BadgeTutorial_01,
    [PAUSE_MSG_02]		MSG_MenuTip_002B,
    [PAUSE_MSG_03]		MSG_MenuTip_002C,
    [PAUSE_MSG_04]		MSG_MenuTip_002D,
    [PAUSE_MSG_05]		MSG_MenuTip_002E,
    [PAUSE_MSG_06]		MSG_MenuTip_002F,
    [PAUSE_MSG_07]		MSG_MenuTip_0030,
    [PAUSE_MSG_08]		MSG_MenuTip_0031,
    [PAUSE_MSG_09]		MSG_MenuTip_BadgeTutorial_02,
    [PAUSE_MSG_0A]		MSG_MenuTip_BadgeTutorial_03,
    [PAUSE_MSG_0B]		MSG_MenuTip_BadgeTutorial_04,
    [PAUSE_MSG_0C]		MSG_MenuTip_BadgeTutorial_05,
    [PAUSE_MSG_0D]		MSG_MenuTip_BadgeTutorial_06,
    [PAUSE_MSG_0E]		MSG_MenuTip_BadgeTutorial_07,
    [PAUSE_MSG_0F]		MSG_MenuTip_BadgeTutorial_08,
    [PAUSE_MSG_10]		MSG_MenuTip_BadgeTutorial_09,
    [PAUSE_MSG_11]		MSG_MenuTip_BadgeTutorial_10,
    [PAUSE_MSG_12]		MSG_MenuTip_BadgeTutorial_11,
    [PAUSE_MSG_13]		MSG_MenuTip_BadgeTutorial_12,
    [PAUSE_MSG_14]		MSG_MenuTip_BadgeTutorial_13,
    [PAUSE_MSG_15]		MSG_MenuTip_BadgeTutorial_14,
    [PAUSE_MSG_16]		MSG_MenuTip_BadgeTutorial_15,
    [PAUSE_MSG_17]		(s32)gPauseMsg_17,
    [PAUSE_MSG_18]		(s32)gPauseMsg_18,
    [PAUSE_MSG_19]		(s32)gPauseMsg_19,
    [PAUSE_MSG_1A]		(s32)gPauseMsg_1A,
    [PAUSE_MSG_1B]		MSG_MenuTip_StatsTab,
    [PAUSE_MSG_1C]		MSG_MenuTip_BadgesTab,
    [PAUSE_MSG_1D]		MSG_MenuTip_ItemsTab,
    [PAUSE_MSG_1E]		MSG_MenuTip_PartyTab,
    [PAUSE_MSG_1F]		MSG_MenuTip_SpiritsTab,
    [PAUSE_MSG_20]		MSG_MenuTip_MapTab,
    [PAUSE_MSG_21]		MSG_MenuTip_ControllingMario,
    [PAUSE_MSG_22]		MSG_MenuTip_HeartPoints,
    [PAUSE_MSG_23]		MSG_MenuTip_FlowerPoints,
    [PAUSE_MSG_24]		MSG_MenuTip_BadgePoints,
    [PAUSE_MSG_25]		MSG_MenuTip_Boots1,
    [PAUSE_MSG_26]		MSG_MenuTip_Boots2,
    [PAUSE_MSG_27]		MSG_MenuTip_Boots3,
    [PAUSE_MSG_28]		MSG_MenuTip_Hammer0,
    [PAUSE_MSG_29]		MSG_MenuTip_Hammer1,
    [PAUSE_MSG_2A]		MSG_MenuTip_Hammer2,
    [PAUSE_MSG_2B]		MSG_MenuTip_Hammer3,
    [PAUSE_MSG_2C]		MSG_MenuTip_StarPower,
    [PAUSE_MSG_2D]		MSG_MenuTip_StarPoints,
    [PAUSE_MSG_2E]		MSG_MenuTip_Coins,
    [PAUSE_MSG_2F]		MSG_MenuTip_Secrets,
    [PAUSE_MSG_30]		MSG_MenuTip_StarPieces,
    [PAUSE_MSG_31]		MSG_MenuTip_Time,
    [PAUSE_MSG_32]		(s32)gPauseMsg_32,
    [PAUSE_MSG_33]		(s32)gPauseMsg_33,
    [PAUSE_MSG_34]		(s32)gPauseMsg_34,
    [PAUSE_MSG_35]		(s32)gPauseMsg_35,
    [PAUSE_MSG_36]		(s32)gPauseMsg_36,
    [PAUSE_MSG_37]		(s32)gPauseMsg_37,
    [PAUSE_MSG_38]		(s32)gPauseMsg_38,
    [PAUSE_MSG_39]		(s32)gPauseMsg_39,
    [PAUSE_MSG_3A]		(s32)gPauseMsg_3A,
    ...
    [PAUSE_MSG_43]		(s32)gPauseMsg_43,
    [PAUSE_MSG_44]		(s32)gPauseMsg_44,
    [PAUSE_MSG_45]		MSG_MenuTip_None,
    [PAUSE_MSG_46]		(s32)gPauseMsg_46,
    [PAUSE_MSG_47]		(s32)gPauseMsg_47,
    [PAUSE_MSG_48]		(s32)gPauseMsg_48,
    [PAUSE_MSG_49]		(s32)gPauseMsg_49,
    [PAUSE_MSG_4A]		(s32)gPauseMsg_4A,
    [PAUSE_MSG_4B]		(s32)gPauseMsg_4B,
    [PAUSE_MSG_4C]		MSG_MenuTip_BadgeTab_All,
    [PAUSE_MSG_4D]		MSG_MenuTip_BadgeTab_Equipped,
    [PAUSE_MSG_4E]		MSG_MenuTip_None,
    [PAUSE_MSG_4F]		(s32)gPauseMsg_4F,
    [PAUSE_MSG_50]		(s32)gPauseMsg_50,
    [PAUSE_MSG_51]		MSG_MenuTip_ItemTab_Consumables,
    [PAUSE_MSG_52]		MSG_MenuTip_ItemTab_KeyItems,
    [PAUSE_MSG_53]		(s32)gPauseMsg_53,
    [PAUSE_MSG_54]		(s32)gPauseMsg_54,
    [PAUSE_MSG_55]		(s32)gPauseMsg_55,
    [PAUSE_MSG_56]		(s32)gPauseMsg_56,
};
