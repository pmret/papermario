...
INCLUDE_ASM(void, "audio/2d9a0_len_890", func_80052660, SndGlobals* arg0);
...
INCLUDE_ASM(void, "audio/2d9a0_len_890", func_80052BF8, UnkAl48* arg0, s32* arg1);

INCLUDE_ASM(s32, "audio/2d9a0_len_890", func_80052CFC, UnkAl48* arg0);
