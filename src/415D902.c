...
extern s16 D_802AB340[];

extern s16 D_802AB344[];

extern IconHudScriptPair battle_menu_JumpHudScripts[];

extern IconHudScriptPair battle_menu_HammerHudScripts[];
...
extern HudScript* battle_menu_StarPowerMovesHudScripts[];

extern HudScript* battle_menu_PartnerHudScripts[];

extern HudScript* battle_menu_DisabledPartnerHudScripts[];

extern IconHudScriptPair battle_menu_StrategiesHudScript;

extern IconHudScriptPair battle_menu_DoNothingHudScripts;

extern IconHudScriptPair battle_menu_FleeHudScripts;

extern s32 BattleMenu_LeftJustMessages[];

extern s32 BattleMenu_CenteredMessages[];

extern s32 D_802AB4F0[];

extern AnimID BattleMenu_PartnerThinkAnims[];

extern AnimID BattleMenu_PartnerIdleAnims[];

extern HudScript* battle_menu_PartnerMoveHudScripts[10][10];
extern s32 D_8008EEF0[]; // TODO MOVE

extern IconHudScriptPair battle_menu_PeachStarPowerHudScripts;

extern s32 D_802AB728[];

extern IconHudScriptPair battle_menu_TwinkStarPowerHudScripts;

extern s32 D_802AB734[];
...
extern s32 D_802ACC70[24];
extern PopupMenu D_802ACCD0;
extern s8 BattleMenuState;
extern s8 D_802AD001;
extern s8 BattleMenu_CurPos;
extern s8 BattleMenu_PrevPos;
extern s8 D_802AD004;
extern s16 D_802AD006;
extern s16 BattleMenuAlpha;
extern s16 D_802AD00A;
extern s16 D_802AD00C; // unused?
extern s32 D_802AD010[6];
extern s32 D_802AD028[6];
...
extern s32 BattleMenu_BasePosX;
extern s32 BattleMenu_BasePosY;
extern s8 BattleMenuDisableMsg;
extern s8 BattleMenu_MinIdx;
extern s8 BattleMenu_MaxIdx;
extern s8 BattleMenu_HomePos;
extern f32 BattleMenu_WheelAngle;
extern f32 D_802AD070;
extern s32 D_802AD074; // unused?
extern HudScript* BattleMenu_HudScripts[6];
extern s32 BattleMenu_TitleMessages[6];
extern s32 D_802AD0A8;
extern s32 BattleMenu_NumOptions;
extern s32 D_802AD0B0;
extern s32 D_802AD0B4; // unused?
extern s32 battle_menu_submenuIDs[6];
extern s32 BattleMenu_OptionEnabled[6];
extern s32 battle_menu_isMessageDisabled[6];
...
extern s16 BattleMenu_Moves_TextColor;
extern s16 BattleMenu_Moves_TextAlpha;
extern HudElemID BattleMenu_Moves_CursorID;
extern HudElemID BattleMenu_Moves_UpArrowID;
extern HudElemID BattleMenu_Moves_DownArrowID;
extern s32 D_802AD124; // unused?
extern HudElemID BattleMenu_Moves_OptionIDs[24];
extern HudElemID BattleMenu_Moves_TitleID;
extern s32 D_802AD18C; // unused?
extern HudElemID BattleMenu_Moves_OptionCostUnitIDs[24];
extern s16 BattleMenu_Moves_PosX;
extern s16 BattleMenu_Moves_PosY;
extern s32 D_802AD1F4; // unused?
extern s32 BattleMenu_Moves_OptionIndexMap[24];
extern s32 D_802AD258;
extern s32 D_802AD25C; // unused?
...
extern s8 BattleSubmenuStratsState;
...
extern HudElemID GreenArrowUpID;
extern HudElemID GreenArrowDownID;
extern s32 D_802AD624;
extern s32 D_802AD628[5];
extern s16 D_802AD63C;
extern s16 D_802AD63E;
extern HudScript* D_802AD640[6];
extern s32 D_802AD658[5]; // msg IDs
extern s32 D_802AD66C;
extern s32 D_802AD670;

//TODO remove it in func_802A45D8 and use D_802AD670 instead
extern s8 D_802AD673;

extern s32 D_802AD674; // unused?
extern s32 D_802AD678[6];
extern s32 D_802AD690[6];
extern s32 D_802AD6A8[6];
extern s32 D_802AD6C0[5];
