...
static Map kpa_maps[] = {
    ...
    { MAP_UNSPLIT(kpa_100, 0x80240060), .songVariation = 1, .flags = 2, .init = (MapInitialiser*)0x80240000 },
    { MAP_UNSPLIT(kpa_101, 0x80240060), .songVariation = 1, .flags = 2, .init = (MapInitialiser*)0x80240000 },
