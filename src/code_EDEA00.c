...
#define NAMESPACE code_EDEA00

INCLUDE_ASM(s32, "code_EDEA00", func_80240040_EDEA00);

INCLUDE_ASM(s32, "code_EDEA00", func_802401C4_EDEB84);
/*
void N(func_802401C4_EDEB84)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
...
/*
void N(func_80240A5C_EDF41C)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
    Enemy* enemy = script->owner1.enemy;
    Npc* npc = get_npc_unsafe(enemy->npcID);
...
/*
void N(func_80240E18_EDF7D8)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
    Enemy* enemy = script->owner1.enemy;
    Npc* npc = get_npc_unsafe(enemy->npcID);
...
/*
void N(func_8024101C_EDF9DC)(ScriptInstance *script, NpcAISettings *aiSettings, EnemyTerritoryThing *shape) {
    Enemy* enemy = script->owner1.enemy;
    Npc* npc = get_npc_unsafe(enemy->npcID);
    f32 posX, posY, posZ, posW;
    f32 temp_f0_2;
...
INCLUDE_ASM(s32, "code_EDEA00", func_802416E8_EE00A8);

INCLUDE_ASM(s32, "code_EDEA00", func_80241730_EE00F0);

INCLUDE_ASM(s32, "code_EDEA00", func_80241B94_EE0554);

INCLUDE_ASM(s32, "code_EDEA00", func_80241DE4_EE07A4);

INCLUDE_ASM(s32, "code_EDEA00", func_802422F0_EE0CB0);

INCLUDE_ASM(s32, "code_EDEA00", func_8024236C_EE0D2C);

INCLUDE_ASM(s32, "code_EDEA00", func_802424A0_EE0E60);

INCLUDE_ASM(s32, "code_EDEA00", func_80242604_EE0FC4);

INCLUDE_ASM(s32, "code_EDEA00", func_80242684_EE1044);

INCLUDE_ASM(s32, "code_EDEA00", func_80242AF0_EE14B0);

INCLUDE_ASM(s32, "code_EDEA00", pause_interp_text_scroll_EE1DD8);

INCLUDE_ASM(s32, "code_EDEA00", func_80243470_EE1E30);

INCLUDE_ASM(s32, "code_EDEA00", func_80243584_EE1F44);