...
enum HudElementFlags {
    HUD_ELEMENT_FLAGS_1 = 0x00000001,
    HUD_ELEMENT_FLAGS_2 = 0x00000002,
    HUD_ELEMENT_FLAGS_4 = 0x00000004,
    HUD_ELEMENT_FLAGS_8 = 0x00000008,
    HUD_ELEMENT_FLAGS_10 = 0x00000010,
    HUD_ELEMENT_FLAGS_20 = 0x00000020,
    HUD_ELEMENT_FLAGS_40 = 0x00000040,
    HUD_ELEMENT_FLAGS_80 = 0x00000080,
    HUD_ELEMENT_FLAGS_100 = 0x00000100,
    HUD_ELEMENT_FLAGS_200 = 0x00000200,
    HUD_ELEMENT_FLAGS_400 = 0x00000400,
    HUD_ELEMENT_FLAGS_800 = 0x00000800,
    HUD_ELEMENT_FLAGS_1000 = 0x00001000,
    HUD_ELEMENT_FLAGS_2000 = 0x00002000,
    HUD_ELEMENT_FLAGS_4000 = 0x00004000,
    HUD_ELEMENT_FLAGS_8000 = 0x00008000,
    HUD_ELEMENT_FLAGS_10000 = 0x00010000,
    HUD_ELEMENT_FLAGS_20000 = 0x00020000,
    HUD_ELEMENT_FLAGS_40000 = 0x00040000,
    HUD_ELEMENT_FLAGS_80000 = 0x00080000,
    HUD_ELEMENT_FLAGS_100000 = 0x00100000,
    HUD_ELEMENT_FLAGS_200000 = 0x00200000,
    HUD_ELEMENT_FLAGS_400000 = 0x00400000,
    HUD_ELEMENT_FLAGS_800000 = 0x00800000,
    ...
    HUD_ELEMENT_FLAGS_20000000 = 0x20000000,
