...
void npc_do_world_collision(Npc* npc) {
    ...
    if (npc->flags & NPC_FLAG_IGNORE_WORLD_COLLISION) {
        ...
        if (hit) {
            ...
            npc->currentWall = NpcHitQueryColliderID;
            npc->pos.x = testX;
            npc->pos.z = testZ;
        } else {
            npc->flags &= ~(NPC_FLAG_COLLDING_WITH_WORLD | NPC_FLAG_COLLDING_FORWARD_WITH_WORLD);
...
void appendGfx_npc(void* data) {
    ...
    if (!(npc->flags & NPC_FLAG_NO_ANIMS_LOADED)) {
        if (!(npc->flags & NPC_FLAG_HAS_NO_SPRITE) && (npc->currentAnim != 0) && (npc->spriteInstanceID >= 0)) {
    ...
    if (npc->flags & NPC_FLAG_REFLECT_WALL) {
        ...
        if (!(npc->flags & NPC_FLAG_NO_ANIMS_LOADED)) {
            if (!(npc->flags & NPC_FLAG_HAS_NO_SPRITE) && (npc->currentAnim != 0)) {
...
void appendGfx_npc_blur(void* data) {
    ...
    while (TRUE) {
        ...
        if (var_s3 >= 3) {
            ...
            y = blur->y[index];
            z = blur->z[index];
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_SET_ALPHA, 255, 255, 255, 120 - (var_s5 * 20), 0);
            yaw = npc->renderYaw;
...
void npc_update_decoration_charged(Npc* npc, s32 idx) {
    ...
    if (!npc->decorationInitialised[idx]) {
        func_802DE894(npc->spriteInstanceID, IMGFX_UPD_ALLOC_COLOR_BUF, 20, 0, 0, 255, 0);
    ...
    if (npc->decorationInitialised[idx] == TRUE) {
        ...
        for (temp3 = 255, i = 0; i < 20; i++) {
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_COLOR_BUF_SET_C, i, (sp50[i] << 24) | (sp38[i] << 16) | (sp20[i] << 8) | temp3, 0, 255, 0);
        }
    }
}
...
void func_8003D3BC(Npc* npc) {
    ...
    func_802DE894(npc->spriteInstanceID, IMGFX_UPD_CLEAR, 0, 0, 0, 0, 0);

    switch (foldType) {
        case IMGFX_UPD_CLEAR:
            npc->renderMode = RENDER_MODE_ALPHATEST;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_CLEAR, 0, 0, 0, 0, foldFlags);
            break;
        case IMGFX_TYPE_2:
        case IMGFX_TYPE_3:
            npc->renderMode = RENDER_MODE_ALPHATEST;
        ...
        case IMGFX_UPD_WAVY:
            npc->renderMode = RENDER_MODE_ALPHATEST;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_WAVY, foldArg1, foldArg2, foldArg3, 0, foldFlags);
            break;
        case IMGFX_UPD_SET_COLOR:
            npc->renderMode = RENDER_MODE_ALPHATEST;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_SET_COLOR, foldArg1, foldArg2, foldArg3, 255, foldFlags);
            break;
        case IMGFX_UPD_SET_ALPHA:
            npc->renderMode = RENDER_MODE_SURFACE_XLU_LAYER2;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_SET_ALPHA, 255, 255, 255, foldArg1, foldFlags);
            break;
        case IMGFX_UPD_SET_TINT:
            npc->renderMode = RENDER_MODE_SURFACE_XLU_LAYER2;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_SET_TINT, foldArg1, foldArg2, foldArg3, foldArg4, foldFlags);
            break;
        case IMGFX_TYPE_9:
            npc->renderMode = RENDER_MODE_ALPHATEST;
        ...
        case IMGFX_UPD_SET_ANIM:
            npc->renderMode = RENDER_MODE_ALPHATEST;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_SET_ANIM, foldArg1, foldArg2, foldArg3, 0, foldFlags);
            break;
        case IMGFX_UPD_HOLOGRAM:
            npc->renderMode = RENDER_MODE_SURFACE_XLU_LAYER2;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_HOLOGRAM, foldArg1, foldArg2, foldArg3, foldArg4, foldFlags);
            break;
        case IMGFX_UPD_FILL_COLOR:
            npc->renderMode = RENDER_MODE_ALPHATEST;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_FILL_COLOR, foldArg1, foldArg2, foldArg3, 255, foldFlags);
            break;
        case IMGFX_UPD_OVERLAY:
            npc->renderMode = RENDER_MODE_ALPHATEST;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_OVERLAY, foldArg1, 255, 0, 255, foldFlags);
            break;
        case IMGFX_UPD_OVERLAY_XLU:
            npc->renderMode = RENDER_MODE_SURFACE_XLU_LAYER2;
            func_802DE894(npc->spriteInstanceID, IMGFX_UPD_OVERLAY, foldArg1, foldArg2, 0, foldArg2, foldFlags);
            break;
    }
}
...
void kill_enemy(Enemy* enemy) {
    ...
    do {
        if (!(enemy->flags & ENEMY_FLAG_4)
            && (!(enemy->flags & ENEMY_FLAG_ENABLE_HIT_SCRIPT) || (enemy == encounterStatus->currentEnemy))
