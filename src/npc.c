            ...
            if (npc != NULL) {
                if (npc->flags != 0) {
                    ...
                    if (!(npc->flags & NPC_FLAG_NO_ANIMS_LOADED)) {
                        ...
                        spr_update_player_sprite(PLAYER_SPRITE_INSTANCE_1, npc->currentAnim, npc->animationSpeed);
                    }
...
void appendGfx_npc(void* data) {
    ...
    if (npc->flags & NPC_FLAG_REFLECT_WALL) {
        ...
        if (!(npc->flags & NPC_FLAG_NO_ANIMS_LOADED)) {
            ...
            spr_draw_player_sprite(PLAYER_SPRITE_INSTANCE_1 | DRAW_SPRITE_OVERRIDE_YAW, renderYaw, 0, 0, mtx1);
        }
    }
    ...
    while (TRUE) {
        ...
        if (var_s3 >= 3) {
            ...
            if (!(npc->flags & NPC_FLAG_NO_ANIMS_LOADED)) {
                ...
                spr_draw_player_sprite(PLAYER_SPRITE_INSTANCE_1 | DRAW_SPRITE_OVERRIDE_YAW, (s32) yaw, 0, 0, sp20);
            }
        }
    }
    func_8003D3BC(npc);
...
void npc_draw_palswap_mode_0(Npc* npc, s32 arg1, Matrix4f mtx) {
    ...
    if (!(npc->flags & NPC_FLAG_NO_ANIMS_LOADED)) {
        ...
        spr_draw_player_sprite(PLAYER_SPRITE_INSTANCE_1 | DRAW_SPRITE_OVERRIDE_YAW, arg1, 0, 0, mtx);
    }
}
