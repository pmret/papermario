    ...
    if (battleStatus->darknessMode != BTL_DARKNESS_STATE_LOCKED) {
        ...
        if (battleStatus->darknessMode > BTL_DARKNESS_STATE_NONE) {
            ...
            if (partner == NULL) {
                ...
                set_screen_overlay_params_back(STENCIL_TYPE_0, paramAmount);
            } else {
                paramAmount += 10.0f;
            ...
            if (D_802809F6 == -1) {
                if (gGameStatusPtr->demoState == DEMO_STATE_CHANGE_MAP) {
                    ...
                    if (paramType == (u8) STENCIL_TYPE_NONE) {
                        D_802809F6 = 0;
                        set_screen_overlay_params_front(STENCIL_TYPE_0, 0.0f);
                    }
                }
                ...
                set_screen_overlay_params_front(STENCIL_TYPE_0, D_802809F6);
