...
//         gGameStatusPtr->stickX = stickX;
//         gGameStatusPtr->stickY = stickY;
...
//             if (!(gGameStatusPtr->prevButtons & BUTTON_STICK_RIGHT)) {
//                 D_8009A6A0 = stickX;
...
//             if (!(gGameStatusPtr->prevButtons & BUTTON_STICK_LEFT)) {
//                 D_8009A6A0 = stickX;
//             } else if (D_8009A6A4 == 0) {
//                 if (D_8009A6A0 > stickX) {
//                     D_8009A6A0 = stickX;
...
//             if (!(gGameStatusPtr->prevButtons & BUTTON_STICK_UP)) {
//                 D_8009A6A2 = stickY;
...
//             if (!(gGameStatusPtr->prevButtons & BUTTON_STICK_DOWN)) {
//                 D_8009A6A2 = stickY;
//             } else if (D_8009A6A6 == 0) {
//                 if (D_8009A6A2 > stickY) {
//                     D_8009A6A2 = stickY;
...
//         gGameStatusPtr->pressedButtons = buttons ^ gGameStatusPtr->prevButtons;
//         gGameStatusPtr->currentButtons = buttons;
//         gGameStatusPtr->pressedButtons &= buttons;
//         if (gGameStatusPtr->currentButtons != 0) {
//             if (gGameStatusPtr->prevButtons == buttons) {
...
//                         gGameStatusPtr->heldButtons = 0;
//                     } else {
//                         gGameStatusPtr->heldButtons = buttons;
...
//                         gGameStatusPtr->heldButtons = 0;
//                     } else {
//                         gGameStatusPtr->heldButtons = gGameStatusPtr->currentButtons;
//                         gGameStatusPtr->unk_60 = gGameStatusPtr->unk_50[0];
//                     }
//                 }
//             } else {
...
//                 gGameStatusPtr->heldButtons = gGameStatusPtr->currentButtons ^ gGameStatusPtr->prevButtons;
//                 gGameStatusPtr->heldButtons &= gGameStatusPtr->currentButtons;
...
//             gGameStatusPtr->heldButtons = 0;
//         }
//         gGameStatusPtr->prevButtons = gGameStatusPtr->currentButtons;
//     }
// }
