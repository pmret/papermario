...
API_CALLABLE(N(UnkSfxFunc)) {
    ...
    if (isInitialCall) {
        ...
        sfx_play_sound_at_position(SOUND_0359, SOUND_SPACE_MODE_0, actor->curPos.x, actor->curPos.y, actor->curPos.z);
    }
    ...
    sfx_play_sound_at_position(SOUND_0359 | SOUND_ID_TRIGGER_CHANGE_SOUND, SOUND_SPACE_MODE_0, actor->curPos.x, actor->curPos.y, actor->curPos.z);
