...
EvtScript N(80233AF0) = {
    ...
    EVT_CALL(RotateModel, LocalVar(10), -20, 0, 0, 1)
    EVT_WAIT(1)
    EVT_LOOP(0)
    ...
    EVT_END_LOOP
    EVT_CALL(TranslateModel, LocalVar(10), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(RotateModel, LocalVar(10), -7, 0, 0, 1)
    EVT_WAIT(5)
    EVT_CALL(TranslateModel, LocalVar(10), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(RotateModel, LocalVar(10), -27, 0, 0, 1)
    EVT_WAIT(2)
    EVT_CALL(TranslateModel, LocalVar(10), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(RotateModel, LocalVar(10), -5, 0, 0, 1)
    EVT_WAIT(3)
    EVT_CALL(TranslateModel, LocalVar(10), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(RotateModel, LocalVar(10), -20, 0, 0, 1)
    EVT_WAIT(5)
    EVT_LOOP(0)
        ...
        EVT_CALL(RotateModel, LocalVar(10), -20, 0, 0, 1)
        EVT_WAIT(1)
        EVT_IF_EQ(LocalVar(11), 2)
            EVT_BREAK_LOOP
        EVT_END_IF
    EVT_END_LOOP
    EVT_CALL(RandInt, 80, LocalVar(11))
    EVT_ADD(LocalVar(11), 30)
    EVT_LOOP(LocalVar(11))
        EVT_CALL(TranslateModel, LocalVar(10), LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(RotateModel, LocalVar(10), -20, 0, 0, 1)
        EVT_WAIT(1)
    EVT_END_LOOP
...
EvtScript N(80234564) = {
    ...
    EVT_CALL(TranslateModel, LocalVar(10), LocalVar(0), LocalVar(1), 0)
    EVT_WAIT(1)
    EVT_ADD(LocalVar(5), 1)
    EVT_SET(LocalVar(12), LocalVar(11))
    EVT_SUB(LocalVar(12), 20)
    EVT_IF_GT(LocalVar(5), LocalVar(12))
        EVT_GOTO(1)
    EVT_END_IF
    EVT_SET(LocalVar(0), LocalVar(5))
    EVT_CALL(TranslateModel, LocalVar(10), LocalVar(0), LocalVar(1), 0)
...
EvtScript N(802347D0) = {
    ...
    EVT_LOOP(0)
        ...
        EVT_CALL(TranslateModel, LocalVar(10), 0, -2, 0)
        EVT_WAIT(2)
        EVT_CALL(TranslateModel, LocalVar(10), 0, -3, 0)
        EVT_WAIT(2)
        EVT_CALL(TranslateModel, LocalVar(10), 0, -3, 0)
        EVT_WAIT(2)
        EVT_CALL(TranslateModel, LocalVar(10), 0, -3, 0)
