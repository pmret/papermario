...
s32 N(idleAnimations_80227F00)[] = {
    ...
    STATUS_POISON,    ANIM_SpikedParaJrTroopa_Anim00,
    STATUS_STOP,      ANIM_SpikedParaJrTroopa_Anim00,
    STATUS_STATIC,    ANIM_SpikedParaJrTroopa_Anim00,
...
s32 N(idleAnimations_80227F44)[] = {
    STATUS_NORMAL,    ANIM_JrTroopa_Anim05,
    STATUS_END,
};
...
EvtScript N(handleEvent_802287D0) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(9)
            ...
            EVT_SET_CONST(LVar1, ANIM_SpikedParaJrTroopa_Anim09)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_SpikedParaJrTroopa_Anim0B)
            EVT_EXEC_WAIT(N(8022A018))
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_EXEC_WAIT(N(80228FE8))
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedParaJrTroopa_Anim03)
        EVT_CASE_EQ(38)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_SpikedParaJrTroopa_Anim09)
            EVT_EXEC_WAIT(DoShockHit)
            ...
            EVT_EXEC_WAIT(DoJumpBack)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_SpikedParaJrTroopa_Anim00)
            EVT_EXEC_WAIT(N(8022A018))
            EVT_RETURN
        EVT_CASE_OR_EQ(23)
        EVT_CASE_OR_EQ(25)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_SpikedParaJrTroopa_Anim03)
        ...
        EVT_CASE_EQ(31)
            ...
            EVT_END_IF
        EVT_CASE_EQ(42)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedParaJrTroopa_Anim09)
            EVT_WAIT(20)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedParaJrTroopa_Anim07)
...
EvtScript N(takeTurn_8022936C) = {
    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedParaJrTroopa_Anim08)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(10)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_JrTroopa_Anim05)
                EVT_WAIT(25)
