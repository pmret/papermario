...
EvtScript N(handleEvent_802287D0) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(9)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_para_jr_troopa_default_hurt)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_para_jr_troopa_default_burn_dead)
            EVT_EXEC_WAIT(N(8022A018))
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_EXEC_WAIT(N(80228FE8))
        ...
        EVT_CASE_EQ(38)
            ...
            EVT_EXEC_WAIT(DoJumpBack)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_para_jr_troopa_default_still)
            EVT_EXEC_WAIT(N(8022A018))
            EVT_RETURN
        EVT_CASE_OR_EQ(23)
        EVT_CASE_OR_EQ(25)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_para_jr_troopa_default_idle)
...
EvtScript N(8022906C) = {
    ...
    EVT_IF_EQ(LocalVar(0), 1)
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(0))
        EVT_IF_NOT_FLAG(LocalVar(0), 0x351000)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(10)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                ...
                EVT_CALL(func_802189DC_447E1C, LocalVar(0), LocalVar(1), LocalVar(10))
                EVT_WAIT(10)
                EVT_CALL(GetEnemyMaxHP, -127, LocalVar(0))
                EVT_LABEL(0)
                EVT_SUB(LocalVar(0), 1)
                EVT_CALL(SetEnemyHP, -127, LocalVar(0))
                EVT_WAIT(1)
                EVT_IF_GT(LocalVar(0), 20)
                    EVT_GOTO(0)
                EVT_END_IF
                ...
                EVT_CALL(SetActorFlagBits, ACTOR_SELF, 4096, 0)
                EVT_CALL(N(FreeIcon), LocalVar(10))
...
EvtScript N(8022A39C) = {
    ...
    EVT_MULF(LocalVar(4), EVT_FLOAT(0.3))
    EVT_CALL(FlyToGoal, ACTOR_SELF, 0, LocalVar(4), 0)
    EVT_RETURN
    EVT_END
};
