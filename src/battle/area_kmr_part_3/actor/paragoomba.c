...
s32 N(idleAnimations_8021C3D8)[] = {
    STATUS_NORMAL,    ANIM_Paragoomba_Anim01,
    STATUS_STONE,     ANIM_Paragoomba_Anim00,
    STATUS_SLEEP,     ANIM_Paragoomba_Anim0B,
    STATUS_POISON,    ANIM_Paragoomba_Anim01,
    STATUS_STOP,      ANIM_Paragoomba_Anim00,
    STATUS_STATIC,    ANIM_Paragoomba_Anim01,
    STATUS_PARALYZE,  ANIM_Paragoomba_Anim00,
    STATUS_DIZZY,     ANIM_Paragoomba_Anim0C,
    STATUS_FEAR,      ANIM_Paragoomba_Anim0C,
    STATUS_END,
};

s32 N(idleAnimations_8021C424)[] = {
    STATUS_NORMAL,    ANIM_Paragoomba_Anim04,
    STATUS_STONE,     ANIM_Paragoomba_Anim00,
    STATUS_SLEEP,     ANIM_Paragoomba_Anim0B,
    STATUS_POISON,    ANIM_Paragoomba_Anim01,
    STATUS_STOP,      ANIM_Paragoomba_Anim00,
    STATUS_STATIC,    ANIM_Paragoomba_Anim04,
    STATUS_PARALYZE,  ANIM_Paragoomba_Anim00,
    STATUS_DIZZY,     ANIM_Paragoomba_Anim0C,
    STATUS_FEAR,      ANIM_Paragoomba_Anim0C,
    STATUS_END,
...
s32 N(idleAnimations_8021C470)[] = {
    STATUS_NORMAL,    ANIM_Paragoomba_Anim09,
    STATUS_END,
};

s32 N(idleAnimations_8021C47C)[] = {
    STATUS_NORMAL,    ANIM_Paragoomba_Anim0A,
    STATUS_END,
};
...
EvtScript N(8021C790) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_Paragoomba_Anim01)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent_8021C808) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim06)
        ...
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim0D)
            EVT_SET_CONST(LVar2, ANIM_Paragoomba_Anim0E)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim0E)
        ...
        EVT_CASE_EQ(47)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim0F)
            EVT_EXEC_WAIT(DoShockHit)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim06)
            EVT_EXEC_WAIT(DoJumpBack)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_Paragoomba_Anim0C)
        ...
        EVT_CASE_EQ(38)
            ...
            EVT_EXEC_WAIT(DoShockHit)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim07)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(19)
        EVT_CASE_OR_EQ(23)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim01)
        ...
        EVT_CASE_EQ(53)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_Paragoomba_Anim04)
            EVT_EXEC_WAIT(N(8021C790))
        ...
        EVT_CASE_EQ(57)
            ...
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, ANIM_Paragoomba_Anim04)
            EVT_SET_CONST(LVar2, ANIM_Paragoomba_Anim06)
...
EvtScript N(takeTurn_8021CDFC) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_Paragoomba_Anim05)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            ...
            EVT_THREAD
                ...
                EVT_END_LOOP
            EVT_END_THREAD
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_Paragoomba_Anim02)
...
EvtScript N(8021D614) = {
    ...
    EVT_CALL(GetLastEvent, ACTOR_SELF, LVar0)
    EVT_IF_EQ(LVar0, 15)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim0A)
    EVT_ELSE
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim05)
    EVT_END_IF
    ...
    EVT_CALL(SetPartFlagBits, -127, 3, 1, 1)
    EVT_CALL(SetPartFlagBits, -127, 4, 1, 1)
    EVT_CALL(GetIndexFromHome, -127, LVar0)
    EVT_MOD(LVar0, 4)
    EVT_CALL(SetGoalToIndex, -127, LVar0)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_CALL(SetHomePos, -127, LVar0, LVar1, LVar2)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim01)
    EVT_CALL(SetActorFlagBits, ACTOR_SELF, 512, 0)
...
s32 N(idleAnimations_8021DB9C)[] = {
    STATUS_NORMAL,    ANIM_Goomba_Anim01,
    STATUS_STONE,     ANIM_Goomba_Anim00,
    STATUS_SLEEP,     ANIM_Goomba_Anim08,
    STATUS_POISON,    ANIM_Goomba_Anim01,
    STATUS_STOP,      ANIM_Goomba_Anim00,
    STATUS_STATIC,    ANIM_Goomba_Anim01,
    STATUS_PARALYZE,  ANIM_Goomba_Anim00,
    STATUS_DIZZY,     ANIM_Goomba_Anim07,
    STATUS_FEAR,      ANIM_Goomba_Anim07,
    STATUS_END,
};

s32 N(idleAnimations_8021DBE8)[] = {
    STATUS_NORMAL,    ANIM_Goomba_Anim03,
    STATUS_STONE,     ANIM_Goomba_Anim00,
    STATUS_SLEEP,     ANIM_Goomba_Anim08,
    STATUS_POISON,    ANIM_Goomba_Anim01,
    STATUS_STOP,      ANIM_Goomba_Anim00,
    STATUS_STATIC,    ANIM_Goomba_Anim03,
    STATUS_PARALYZE,  ANIM_Goomba_Anim00,
    STATUS_DIZZY,     ANIM_Goomba_Anim07,
    STATUS_FEAR,      ANIM_Goomba_Anim07,
    STATUS_END,
...
EvtScript N(handleEvent_8021DF5C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim05)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim09)
            EVT_SET_CONST(LVar2, ANIM_Goomba_Anim0A)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(36)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim09)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim0A)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(33)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim06)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(47)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim0E)
            EVT_EXEC_WAIT(DoShockHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim05)
            EVT_EXEC_WAIT(DoJumpBack)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim07)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(8.0))
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim01)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(32)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(53)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(2.0))
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim03)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Goomba_Anim03)
            EVT_SET_CONST(LVar2, ANIM_Goomba_Anim05)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(58)
            EVT_SET_CONST(LVar0, 0x00000001)
...
EvtScript N(takeTurn_8021E788) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim04)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LVar0, ((0)), 0, 1, 16)
    EVT_SWITCH(LVar0)
        EVT_CASE_OR_EQ(6)
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim08)
        ...
        EVT_CASE_DEFAULT
            ...
            EVT_END_THREAD
            EVT_CALL(JumpToGoal, ACTOR_SELF, 16, FALSE, TRUE, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Goomba_Anim0B)
            EVT_CALL(SetActorScale, ACTOR_SELF, EVT_FLOAT(1.1), EVT_FLOAT(0.8), EVT_FLOAT(1.0))
            EVT_WAIT(1)
            EVT_CALL(SetActorScale, ACTOR_SELF, EVT_FLOAT(1.3), EVT_FLOAT(0.5), EVT_FLOAT(1.0))
            EVT_WAIT(1)
