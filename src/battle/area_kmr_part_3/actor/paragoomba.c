...
EvtScript N(handleEvent_8021C808) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_paragoomba_default_pain)
        ...
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, NPC_ANIM_paragoomba_default_burn_pain)
            EVT_SET_CONST(LVar2, NPC_ANIM_paragoomba_default_burn_dead)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, NPC_ANIM_paragoomba_default_burn_dead)
        ...
        EVT_CASE_EQ(47)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, NPC_ANIM_paragoomba_default_electrocute)
        ...
        EVT_CASE_EQ(38)
            ...
            EVT_EXEC_WAIT(DoShockHit)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, NPC_ANIM_paragoomba_default_dead)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(19)
        EVT_CASE_OR_EQ(23)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, NPC_ANIM_paragoomba_default_idle)
        ...
        EVT_CASE_EQ(57)
            ...
            EVT_SET_CONST(LVar0, 0x00000002)
            EVT_SET_CONST(LVar1, NPC_ANIM_paragoomba_default_run)
            EVT_SET_CONST(LVar2, NPC_ANIM_paragoomba_default_pain)
...
EvtScript N(handleEvent_8021DF5C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_pain)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_burn_pain)
            EVT_SET_CONST(LVar2, NPC_ANIM_goomba_normal_burn_dead)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(36)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_burn_pain)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_burn_dead)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(33)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_dead)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(47)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_electrocute)
            EVT_EXEC_WAIT(DoShockHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_pain)
            EVT_EXEC_WAIT(DoJumpBack)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_idle)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(32)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_normal_run)
            EVT_SET_CONST(LVar2, NPC_ANIM_goomba_normal_pain)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(58)
            EVT_SET_CONST(LVar0, 0x00000001)
