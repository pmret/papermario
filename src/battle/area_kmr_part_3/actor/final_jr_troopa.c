    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_EQ(27)
            ...
            EVT_SWITCH(LocalVar(3))
                EVT_CASE_FLAG(266240)
                    EVT_ADD(LocalVar(0), -13)
                    EVT_ADD(LocalVar(1), 37)
                ...
                EVT_CASE_DEFAULT
                    ...
                    EVT_ADD(LocalVar(1), 37)
            EVT_END_SWITCH
            EVT_CALL(PlayEffect, 0x1A, 0, LocalVar(0), LocalVar(1), LocalVar(2), 20, 0, 0, 0, 0, 0, 0, 0, 0)
            EVT_WAIT(20)
        EVT_CASE_EQ(58)
        ...
        EVT_CASE_EQ(31)
            ...
            EVT_IF_NOT_FLAG(LocalVar(0), 0x35D000)
                ...
                EVT_EXEC_WAIT(N(802315F0))
                EVT_CALL(SetAnimation, ACTOR_SELF, LocalVar(0), LocalVar(1))
                EVT_CALL(ActorSpeak, 1900955, -127, LocalVar(0), -1, -1)
...
EvtScript N(takeTurn_8022D920) = {
    ...
    EVT_IF_NE(LocalVar(0), 3)
        EVT_CALL(GetActorHP, -127, LocalVar(1))
        EVT_CALL(GetEnemyMaxHP, -127, LocalVar(2))
        EVT_MUL(LocalVar(1), 100)
        EVT_DIV(LocalVar(1), LocalVar(2))
        EVT_IF_EQ(LocalVar(0), 1)
            EVT_IF_LT(LocalVar(1), 65)
                EVT_EXEC_WAIT(N(8022DD48))
            EVT_END_IF
        EVT_ELSE
            EVT_IF_LT(LocalVar(1), 35)
                EVT_EXEC_WAIT(N(8022DF54))
            EVT_END_IF
        EVT_END_IF
    EVT_END_IF
    EVT_CALL(GetActorHP, -127, LocalVar(0))
    EVT_IF_LT(LocalVar(0), 15)
        EVT_CALL(GetActorVar, -127, 2, LocalVar(0))
        EVT_IF_NOT_FLAG(LocalVar(0), 0x2)
            EVT_BITWISE_OR_CONST(LocalVar(0), 0x2)
        ...
        EVT_CASE_EQ(3)
            ...
            EVT_SWITCH(LocalVar(0))
                ...
                EVT_CASE_DEFAULT
                    ...
                    EVT_IF_NE(LocalVar(0), LocalVar(1))
                        EVT_CALL(GetActorVar, -127, 4, LocalVar(2))
                        EVT_IF_GT(LocalVar(2), 0)
                            EVT_SUB(LocalVar(2), 1)
                            EVT_CALL(SetActorVar, -127, 4, LocalVar(2))
...
EvtScript N(8022ED10) = {
    ...
    EVT_CALL(FlyToGoal, ACTOR_SELF, 0, -10, 0)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 8, 32)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    ...
    EVT_SWITCH(LVarF)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_LOOP(20)
                ...
                EVT_CALL(N(CalculateRotationZ), LocalVar(1), LocalVar(2), LocalVar(4), LocalVar(5), LocalVar(0))
                EVT_CALL(SetPartRotation, -127, 2, 0, 0, LocalVar(0))
            ...
            EVT_LOOP(14)
                ...
                EVT_ADD(LocalVar(7), 180)
                EVT_CALL(SetPartRotation, -127, 2, 0, 0, LocalVar(7))
                EVT_SET(LocalVar(1), LocalVar(4))
                EVT_SET(LocalVar(2), LocalVar(5))
                EVT_SET(LocalVar(3), LocalVar(6))
                EVT_WAIT(1)
...
EvtScript N(80230034) = {
    ...
    EVT_ELSE
        ...
        EVT_SETF(LocalVar(5), MapFlag(-1999590))
    EVT_END_IF
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_SWITCH(LVarA)
        EVT_CASE_EQ(6)
            ...
            EVT_ELSE
                ...
                EVT_SETF(LocalVar(8), MapFlag(-1999590))
            EVT_END_IF
            EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        ...
        EVT_CASE_EQ(5)
            EVT_THREAD
                ...
                EVT_CALL(PlayEffect, 0x3E, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(3.0), 30, 0, 0, 0, 0, 0, 0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, 3, NPC_ANIM_mage_jr_troopa_default_attack2_burn)
                EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_WAIT(40)
                EVT_SUB(LocalVar(0), 7)
                EVT_ADD(LocalVar(1), 14)
                EVT_ADD(LocalVar(2), 4)
                EVT_CALL(PlayEffect, 0x7, 2, LocalVar(0), LocalVar(1), LocalVar(2), 0, 0, 0, 0, 0, 0, 0, 0, 0)
                EVT_WAIT(20)
...
EvtScript N(80230794) = {
    ...
    EVT_SWITCH(LVarA)
        EVT_CASE_EQ(6)
            ...
            EVT_CALL(PlayEffect, 0x5E, 0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), LocalVar(4), LocalVar(5), EVT_FLOAT(1.0), 18, 0, 0, 0, 0)
            EVT_WAIT(20)
        ...
        EVT_CASE_EQ(5)
            ...
            EVT_CALL(PlayEffect, 0x5E, 0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 0, LocalVar(5), EVT_FLOAT(1.0), 18, 0, 0, 0, 0)
            EVT_THREAD
                EVT_WAIT(10)
                EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_ADD(LocalVar(1), 12)
    ...
    EVT_CALL(PlayEffect, 0x5E, 0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), LocalVar(4), LocalVar(5), EVT_FLOAT(1.0), 18, 0, 0, 0, 0)
    EVT_WAIT(14)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), (DAMAGE_TYPE_MAGIC | DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_NO_CONTACT), 0, 65536, 9, 32)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MakeLerp, 200, 0, 60, 0)
    EVT_LABEL(2)
    EVT_CALL(UpdateLerp)
...
EvtScript N(8023106C) = {
    ...
    EVT_CALL(PlayEffect, 0x11, 1, LocalVar(1), LocalVar(2), LocalVar(3), 10, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(PlayEffect, 0x40, 2, LocalVar(1), LocalVar(2), LocalVar(3), 0, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(30)
    EVT_CALL(SetAnimation, ACTOR_SELF, 3, NPC_ANIM_mage_jr_troopa_default_idle)
    EVT_WAIT(10)
    EVT_CALL(GetEnemyMaxHP, -127, LocalVar(0))
    EVT_MUL(LocalVar(0), 17)
    EVT_DIV(LocalVar(0), 100)
    EVT_THREAD
        EVT_WAIT(5)
    ...
    EVT_THREAD
        ...
        EVT_CALL(HealActor, -127, LocalVar(0), 0)
...
EvtScript N(802315F0) = {
    ...
    EVT_SWITCH(LocalVar(1))
        EVT_CASE_EQ(0)
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(1), 2293769)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(1), 2359305)
                EVT_CASE_DEFAULT
                    EVT_SET(LocalVar(1), 2162705)
            EVT_END_SWITCH
        EVT_CASE_EQ(1)
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(1), 2293770)
                    EVT_SET(LocalVar(2), 2293771)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(1), 2359306)
                    EVT_SET(LocalVar(2), 2359307)
                EVT_CASE_DEFAULT
                    EVT_SET(LocalVar(1), 2162728)
                    EVT_SET(LocalVar(2), 2162729)
            EVT_END_SWITCH
        EVT_CASE_EQ(2)
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(1), 2293776)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(1), 2359311)
                EVT_CASE_DEFAULT
                    EVT_SET(LocalVar(1), 2162730)
            EVT_END_SWITCH
        EVT_CASE_EQ(3)
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(1), 2293775)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(1), 2359310)
                EVT_CASE_DEFAULT
                    EVT_SET(LocalVar(1), 2162710)
            EVT_END_SWITCH
        EVT_CASE_EQ(4)
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(1), 2293767)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(1), 2359301)
                EVT_CASE_DEFAULT
                    EVT_SET(LocalVar(1), 2162697)
            EVT_END_SWITCH
        EVT_CASE_DEFAULT
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(1), 2293763)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(1), 2359298)
                EVT_CASE_DEFAULT
                    EVT_SET(LocalVar(1), 2162691)
            EVT_END_SWITCH
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
