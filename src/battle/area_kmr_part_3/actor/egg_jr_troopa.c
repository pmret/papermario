...
EvtScript N(handleEvent_80224B58) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_jr_troopa_default_burn_dead)
            EVT_EXEC_WAIT(N(80224658))
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_EXEC_WAIT(N(802250E4))
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_jr_troopa_default_run)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_jr_troopa_default_idle_shell)
...
EvtScript N(802250E4) = {
    ...
    EVT_IF_EQ(LocalVar(0), 0)
        ...
        EVT_IF_NOT_FLAG(LocalVar(2), 0x80000)
