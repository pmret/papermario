...
s32 N(idleAnimations_80225DC0)[] = {
    STATUS_NORMAL,    ANIM_ParaJrTroopa_Anim02,
    STATUS_SLEEP,     ANIM_ParaJrTroopa_Anim0A,
    STATUS_STONE,     ANIM_ParaJrTroopa_Anim00,
    STATUS_POISON,    ANIM_ParaJrTroopa_Anim00,
    STATUS_STOP,      ANIM_ParaJrTroopa_Anim00,
    STATUS_STATIC,    ANIM_ParaJrTroopa_Anim00,
    STATUS_PARALYZE,  ANIM_ParaJrTroopa_Anim00,
    STATUS_DIZZY,     ANIM_ParaJrTroopa_Anim0B,
    STATUS_END,
};
...
EvtScript N(handleEvent_802266B0) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, ANIM_ParaJrTroopa_Anim07)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_ParaJrTroopa_Anim09)
            EVT_EXEC_WAIT(N(802279B0))
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ParaJrTroopa_Anim02)
        EVT_CASE_EQ(38)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_ParaJrTroopa_Anim07)
            EVT_EXEC_WAIT(DoShockHit)
            ...
            EVT_EXEC_WAIT(DoJumpBack)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_ParaJrTroopa_Anim02)
            EVT_EXEC_WAIT(N(802279B0))
            EVT_RETURN
        EVT_CASE_EQ(23)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(25)
            ...
            EVT_EXEC_WAIT(N(80227E1C))
        EVT_CASE_EQ(42)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ParaJrTroopa_Anim07)
            EVT_WAIT(20)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ParaJrTroopa_Anim05)
        ...
        EVT_CASE_EQ(58)
            ...
            EVT_IF_NOT_FLAG(LVar0, 0x35D000)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ParaJrTroopa_Anim0D)
                EVT_WAIT(1000)
            EVT_END_IF
        EVT_CASE_EQ(31)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LVar0)
            EVT_IF_NOT_FLAG(LVar0, 0x35D000)
                EVT_SET_CONST(LVar0, 0x00000001)
                EVT_SET_CONST(LVar1, ANIM_ParaJrTroopa_Anim0D)
                EVT_EXEC_WAIT(DoImmune)
...
EvtScript N(takeTurn_80226F58) = {
    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ParaJrTroopa_Anim06)
