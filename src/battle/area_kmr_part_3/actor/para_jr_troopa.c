...
EvtScript N(handleEvent_802266B0) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_jr_troopa_default_hurt)
        ...
        EVT_CASE_EQ(14)
            ...
            EVT_SET(LocalVar(1), 2424840)
            EVT_SET(LocalVar(2), 2424841)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_jr_troopa_default_burn_dead)
            EVT_EXEC_WAIT(N(802279B0))
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
        ...
        EVT_CASE_EQ(38)
            ...
            EVT_EXEC_WAIT(DoJumpBack)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_jr_troopa_default_idle)
            EVT_EXEC_WAIT(N(802279B0))
            EVT_RETURN
        EVT_CASE_EQ(23)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
        ...
        EVT_CASE_EQ(31)
            ...
            EVT_IF_NOT_FLAG(LocalVar(0), 0x35D000)
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_jr_troopa_default_hanging)
                EVT_EXEC_WAIT(DoImmune)
    ...
    EVT_SWITCH(LocalVar(15))
        EVT_CASE_EQ(10)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                ...
                EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_ADD(LocalVar(0), 20)
                EVT_CALL(SetGoalPos, ACTOR_SELF, LocalVar(0), 60, LocalVar(2))
                EVT_CALL(FlyToGoal, ACTOR_SELF, 45, 0, 0)
                EVT_CALL(ForceHomePos, ACTOR_SELF, LocalVar(0), 60, LocalVar(2))
                EVT_CALL(HPBarToHome, ACTOR_SELF)
                EVT_WAIT(8)
