...
EvtScript N(handleEvent_802266B0) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_para_jr_troopa_default_hurt)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_para_jr_troopa_default_burn_dead)
            EVT_EXEC_WAIT(N(802279B0))
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(38)
            ...
            EVT_EXEC_WAIT(DoJumpBack)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_para_jr_troopa_default_idle)
            EVT_EXEC_WAIT(N(802279B0))
            EVT_RETURN
        EVT_CASE_EQ(23)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(31)
            ...
            EVT_IF_NOT_FLAG(LVar0, 0x35D000)
                EVT_SET_CONST(LVar0, 0x00000001)
                EVT_SET_CONST(LVar1, NPC_ANIM_para_jr_troopa_default_hanging)
                EVT_EXEC_WAIT(DoImmune)
