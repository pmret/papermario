...
EvtScript N(handleEvent_8021A854) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_goomba_default_pain)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_goomba_default_burn_dead)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_spiked_goomba_default_burn_pain)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_goomba_default_burn_pain)
        ...
        EVT_CASE_EQ(33)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_goomba_default_dead)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(47)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_goomba_default_electrocute)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_goomba_default_idle)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_spiked_goomba_default_run)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_spiked_goomba_default_pain)
...
EvtScript N(takeTurn_8021B19C) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_DEFAULT
            ...
            EVT_WAIT(1)
    EVT_END_SWITCH
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), ((0)), 0, 0, 2, 32)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
            ...
            EVT_CALL(GetLastDamage, 0, LocalVar(0))
