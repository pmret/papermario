...
s32 N(idleAnimations_8022A550)[] = {
    ...
    STATUS_POISON,    ANIM_MageJrTroopa_Anim0,
    STATUS_STOP,      ANIM_MageJrTroopa_Anim0,
    STATUS_STATIC,    ANIM_MageJrTroopa_Anim0,
...
s32 N(idleAnimations_8022A594)[] = {
    STATUS_NORMAL,   ANIM_MageJrTroopa_Anim2,
    STATUS_SLEEP,    ANIM_MageJrTroopa_Anim0,
    STATUS_STONE,    ANIM_MageJrTroopa_Anim0,
    STATUS_POISON,   ANIM_MageJrTroopa_Anim0,
    STATUS_STOP,     ANIM_MageJrTroopa_Anim0,
    STATUS_STATIC,   ANIM_MageJrTroopa_Anim0,
...
EvtScript N(handleEvent_8022ADD8) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(9)
            ...
            EVT_SET_CONST(LVar1, ANIM_MageJrTroopa_Anim9)
        ...
        EVT_CASE_EQ(32)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_MageJrTroopa_Anim0)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_MageJrTroopa_AnimB)
            EVT_EXEC_WAIT(N(8022BF1C))
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_MageJrTroopa_Anim5)
        ...
        EVT_CASE_OR_EQ(25)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_MageJrTroopa_Anim2)
        ...
        EVT_CASE_EQ(58)
            ...
            EVT_IF_NOT_FLAG(LVar0, 0x35D000)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_MageJrTroopa_AnimF)
                EVT_WAIT(1000)
            EVT_END_IF
        EVT_CASE_EQ(31)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LVar0)
            EVT_IF_NOT_FLAG(LVar0, 0x35D000)
                ...
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_MageJrTroopa_Anim2)
                EVT_EXEC_WAIT(N(8022AC40))
            EVT_END_IF
        EVT_CASE_EQ(42)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_MageJrTroopa_Anim9)
            EVT_WAIT(20)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_MageJrTroopa_Anim5)
...
EvtScript N(takeTurn_8022B4F0) = {
    ...
    EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_MageJrTroopa_Anim6)
    EVT_WAIT(8)
    ...
    EVT_WAIT(30)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_MageJrTroopa_Anim7)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
