...
EvtScript N(beforeBattle_80224BD0) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(0)
            ...
            EVT_IF_GT(LocalVar(0), 32768)
                EVT_ADD(LocalVar(0), -32768)
            EVT_END_IF
            EVT_IF_LT(LocalVar(1), -32768)
                EVT_ADD(LocalVar(1), 32768)
            EVT_END_IF
            EVT_ADD(LocalVar(2), -50)
            EVT_ADD(LocalVar(3), 100)
            EVT_IF_LT(LocalVar(2), -32768)
                EVT_ADD(LocalVar(2), 32768)
            EVT_END_IF
            EVT_IF_GT(LocalVar(3), 32768)
                EVT_ADD(LocalVar(3), -32768)
            EVT_END_IF
            EVT_CALL(SetTexPanOffset, 0, 0, LocalVar(0), LocalVar(1))
            EVT_CALL(SetTexPanOffset, 0, 1, LocalVar(2), LocalVar(3))
            EVT_WAIT(1)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_THREAD
        ...
        EVT_LABEL(0)
        EVT_CALL(UpdateLerp)
        EVT_CALL(TranslateModel, MODEL_o357, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o344, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o361, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o354, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o341, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o362, 0, LocalVar(0), 0)
        EVT_WAIT(1)
    ...
    EVT_THREAD
        ...
        EVT_LABEL(4)
        EVT_CALL(UpdateLerp)
        EVT_CALL(TranslateModel, MODEL_o363, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o343, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o355, 0, LocalVar(0), 0)
        EVT_CALL(TranslateModel, MODEL_o338, 0, LocalVar(0), 0)
        EVT_WAIT(1)
        EVT_IF_EQ(LocalVar(1), 1)
            EVT_GOTO(4)
        EVT_END_IF
