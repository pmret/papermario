...
EvtScript N(80221144) = {
    ...
    EVT_SWITCH(LW(1))
        EVT_CASE_EQ(0)
            EVT_SET(ScriptFlag(11), 1)
        EVT_CASE_EQ(1)
            EVT_SET(ScriptFlag(12), 1)
        EVT_CASE_EQ(2)
            EVT_SET(ScriptFlag(13), 1)
        EVT_CASE_EQ(3)
            EVT_SET(ScriptFlag(14), 1)
    EVT_END_SWITCH
    EVT_CALL(ChooseNextTarget, 0, LW(0))
    EVT_IF_NE(LW(0), -1)
        EVT_GOTO(0)
    ...
    EVT_SWITCH(LW(1))
        EVT_CASE_EQ(0)
            EVT_IF_EQ(ScriptFlag(12), 0)
                EVT_SET(LW(0), 1)
            EVT_END_IF
        EVT_CASE_EQ(1)
            EVT_IF_EQ(ScriptFlag(11), 0)
                EVT_SET(LW(0), 0)
            EVT_END_IF
            EVT_IF_EQ(ScriptFlag(13), 0)
                EVT_SET(LW(0), 2)
            EVT_END_IF
        EVT_CASE_EQ(2)
            EVT_IF_EQ(ScriptFlag(12), 0)
