...
EvtScript N(80219C74) = {
    ...
    EVT_CALL(SetActionTutorialState, ACTION_TUTORIAL_GUIDED)
    ...
    EVT_CALL(UseIdleAnimation, ACTOR_PARTNER, TRUE)
    EVT_CALL(SetActionTutorialState, ACTION_TUTORIAL_MOVES_LEARNED)
    ...
    EVT_LOOP(0)
        EVT_CALL(GetActionTutorialState, LVar0)
        EVT_IF_NE(LVar0, ACTION_TUTORIAL_GUIDED)
            EVT_BREAK_LOOP
        EVT_END_IF
        EVT_WAIT(1)
    EVT_END_LOOP
    ...
    EVT_CALL(UseIdleAnimation, ACTOR_PARTNER, TRUE)
    EVT_CALL(SetActionSuccess, 1)
    EVT_CALL(SetActionTutorialState, ACTION_TUTORIAL_LEARN_BLOCK)
