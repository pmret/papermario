...
s32 N(idleAnimations_8021AE5C)[] = {
    STATUS_NORMAL,    ANIM_Bubble_Pal1_Anim1,
    STATUS_STONE,     ANIM_Bubble_Pal1_Anim0,
    STATUS_SLEEP,     ANIM_Bubble_Pal1_Anim1,
    STATUS_POISON,    ANIM_Bubble_Pal1_Anim1,
    STATUS_STOP,      ANIM_Bubble_Pal1_Anim0,
    STATUS_STATIC,    ANIM_Bubble_Pal1_Anim1,
    STATUS_PARALYZE,  ANIM_Bubble_Pal1_Anim0,
    STATUS_DIZZY,     ANIM_Bubble_Pal1_AnimA,
    STATUS_FEAR,      ANIM_Bubble_Pal1_AnimA,
    STATUS_END,
};
...
EvtScript N(8021B2FC) = {
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bubble_Pal1_Anim3)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bubble_Pal1_Anim1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent_8021B8BC) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, ANIM_Bubble_Pal1_Anim7)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_EXEC(N(split))
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Bubble_Pal1_Anim8)
            EVT_SET_CONST(LVar2, ANIM_Bubble_Pal1_Anim9)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Bubble_Pal1_Anim9)
        ...
        EVT_CASE_OR_EQ(28)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Bubble_Pal1_Anim1)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Bubble_Pal1_Anim3)
            EVT_SET_CONST(LVar2, ANIM_Bubble_Pal1_Anim7)
...
EvtScript N(8021BE64) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(5)
            EVT_SET(LVarA, LVar0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bubble_Pal1_Anim4)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_SUB(LVar0, 20)
            EVT_SET(LVar1, 0)
...
EvtScript N(8021C654) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bubble_Pal1_Anim1)
    EVT_WAIT(10)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bubble_Pal1_Anim5)
    EVT_WAIT(30)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LVar0, 0, 0, 1, 16)
    EVT_SWITCH(LVar0)
        EVT_CASE_OR_EQ(6)
        EVT_CASE_OR_EQ(5)
            EVT_SET(LVarA, LVar0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bubble_Pal1_Anim6)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_SUB(LVar0, 5)
            EVT_ADD(LVar1, 4)
            EVT_ADD(LVar2, 2)
