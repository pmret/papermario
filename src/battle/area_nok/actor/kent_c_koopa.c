...
EvtScript N(handleEvent_80227E08) = {
    ...
    EVT_CALL(GetLastEvent, ACTOR_SELF, LocalVar(13))
    EVT_SWITCH(LocalVar(13))
        EVT_CASE_EQ(56)
        EVT_CASE_EQ(9)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_CALL(GetActorVar, -127, 1, LocalVar(1))
        ...
        EVT_CASE_EQ(14)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                ...
                EVT_SET(LocalVar(1), 4653077)
                EVT_SET(LocalVar(2), 4653078)
                EVT_EXEC_WAIT(DoBurnHit)
            EVT_ELSE
                EVT_SET(LocalVar(0), 1)
                EVT_SET(LocalVar(1), 4653079)
                EVT_SET(LocalVar(2), 4653080)
                EVT_EXEC_WAIT(DoBurnHit)
            EVT_END_IF
        EVT_CASE_EQ(36)
            EVT_CALL(GetActorVar, -127, 0, LocalVar(0))
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), LocalVar(2))
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_CALL(SetActorVar, -127, 4, 2)
        ...
        EVT_CASE_EQ(23)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_kent_c_koopa_Palette_00_Anim_9)
                EVT_EXEC_WAIT(DoImmune)
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_kent_c_koopa_Palette_00_Anim_1A)
                EVT_EXEC_WAIT(DoImmune)
            EVT_END_IF
        EVT_CASE_EQ(25)
            EVT_CALL(SetActorVar, -127, 4, 2)
        ...
        EVT_CASE_EQ(31)
            EVT_CALL(GetActorVar, -127, 0, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET(LocalVar(1), 4653057)
            EVT_ELSE
                EVT_SET(LocalVar(1), 4653082)
            EVT_END_IF
            EVT_SET(LocalVar(0), 1)
            EVT_EXEC_WAIT(DoImmune)
        EVT_CASE_EQ(53)
        ...
        EVT_CASE_EQ(49)
            EVT_CALL(GetActorVar, -127, 0, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_kent_c_koopa_Palette_00_Anim_1)
                EVT_SET_CONST(LocalVar(0), 0x00000001)
        ...
        EVT_CASE_EQ(13)
            ...
            EVT_IF_EQ(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_kent_c_koopa_Palette_00_Anim_12)
                EVT_EXEC_WAIT(DoNormalHit)
                EVT_RETURN
            EVT_END_IF
            ...
            EVT_IF_GT(LocalVar(0), 0)
                ...
                EVT_CALL(SetActorVar, -127, 4, LocalVar(0))
            EVT_END_IF
            EVT_CALL(func_80269E80, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 22)
                EVT_CALL(SetActorVar, -127, 4, 0)
            EVT_END_IF
            EVT_CALL(GetActorVar, -127, 4, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_CALL(GetBattleFlags, LocalVar(13))
                EVT_IF_FLAG(LocalVar(13), 0x20)
                    EVT_CALL(SetActorVar, -127, 4, 2)
                EVT_END_IF
            ...
            EVT_ELSE
                ...
                EVT_IF_FLAG(LocalVar(13), 0x20)
                    ...
                    EVT_IF_GT(LocalVar(0), 0)
                        EVT_SET_CONST(LocalVar(0), 0x00000001)
                        EVT_SET_CONST(LocalVar(1), NPC_ANIM_kent_c_koopa_Palette_00_Anim_1C)
                        EVT_EXEC_WAIT(DoNormalHit)
                    EVT_ELSE
                        EVT_SET_CONST(LocalVar(0), 0x00000001)
                        EVT_SET_CONST(LocalVar(1), NPC_ANIM_kent_c_koopa_Palette_00_Anim_9)
...
EvtScript N(takeTurn_80228A7C) = {
    ...
    EVT_IF_EQ(LocalVar(0), 1)
        ...
        EVT_SUB(LocalVar(0), 1)
        EVT_CALL(SetActorVar, -127, 2, LocalVar(0))
        EVT_IF_GT(LocalVar(0), 0)
            EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_ADD(LocalVar(0), 36)
            EVT_ADD(LocalVar(1), 18)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(3.0))
            EVT_LOOP(5)
                EVT_CALL(PlayEffect, 0x28, 1, LocalVar(0), LocalVar(1), LocalVar(2), 1, 225, 10, 0, 0, 0, 0, 0, 0)
                EVT_WAIT(5)
            EVT_END_LOOP
            EVT_WAIT(30)
    ...
    EVT_IF_LT(LocalVar(0), 50)
        EVT_CALL(GetStatusFlags, ACTOR_PARTNER, LocalVar(0))
        EVT_IF_NOT_FLAG(LocalVar(0), 0x1000000)
...
EvtScript N(shellToss_KentC) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlayEffect, 0x1D, 1, LocalVar(0), LocalVar(1), LocalVar(2), 32, 4, 0, 10, 0, 0, 0, 0, 0)
        EVT_WAIT(3)
        EVT_CALL(PlayEffect, 0x1D, 1, LocalVar(0), LocalVar(1), LocalVar(2), 32, 4, 0, 10, 0, 0, 0, 0, 0)
        EVT_WAIT(2)
        EVT_CALL(PlayEffect, 0x1D, 1, LocalVar(0), LocalVar(1), LocalVar(2), 32, 4, 0, 10, 0, 0, 0, 0, 0)
    ...
    EVT_WAIT(10)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(10), 0, 0, 3, 16)
    EVT_SWITCH(LocalVar(10))
        EVT_CASE_OR_EQ(6)
        EVT_CASE_OR_EQ(5)
            EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PARTNER)
            EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(11), 0, 0, 3, 16)
            EVT_SWITCH(LocalVar(11))
                EVT_CASE_EQ(6)
                    ...
                    EVT_CALL(SetGoalPos, ACTOR_SELF, -240, 0, LocalVar(2))
                    EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
                    EVT_CALL(SetActorPos, ACTOR_SELF, 240, 0, LocalVar(2))
                ...
                EVT_CASE_DEFAULT
                    ...
                    EVT_IF_NOT_FLAG(LocalVar(0), 0x435D000)
        ...
        EVT_CASE_DEFAULT
            ...
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(14))
            EVT_IF_NOT_FLAG(LocalVar(14), 0x80000)
                EVT_CALL(func_80269EAC, 24)
            EVT_END_IF
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), 0, 65535, 0, 3, 32)
            EVT_SET(LocalVar(10), 0)
            EVT_IF_NOT_FLAG(LocalVar(14), 0x80000)
                EVT_CALL(GetBattleFlags, LocalVar(0))
                EVT_IF_NOT_FLAG(LocalVar(0), 0x80000000)
                    EVT_CALL(GetStatusFlags, ACTOR_PLAYER, LocalVar(0))
                    EVT_IF_NOT_FLAG(LocalVar(0), 0x100000)
                        EVT_SET(LocalVar(10), 1)
                    EVT_END_IF
                EVT_END_IF
            EVT_END_IF
    ...
    EVT_IF_NE(LocalVar(10), 0)
        ...
        EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 65535, 0, 3, 32)
        EVT_CALL(GetBattleFlags, LocalVar(0))
        EVT_IF_NOT_FLAG(LocalVar(0), 0x80000000)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_CALL(MoveBattleCamOver, 20)
    EVT_SET_CONST(LocalVar(0), 0x00000001)
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_kent_c_koopa_Palette_00_Anim_4)
    EVT_EXEC_WAIT(DoReturnHome)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_kent_c_koopa_Palette_00_Anim_1)
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
    EVT_CALL(UseIdleAnimation, ACTOR_SELF, TRUE)
...
EvtScript N(tackle_KentC) = {
    ...
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), 0, 0, 1, 16)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(6)
        EVT_CASE_OR_EQ(5)
            ...
            EVT_LOOP(12)
                ...
                EVT_CALL(SetActorYaw, ACTOR_SELF, LocalVar(3))
                EVT_WAIT(1)
            EVT_END_LOOP
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            ...
            EVT_SET(LocalVar(3), 180)
            EVT_LOOP(15)
                EVT_SUB(LocalVar(3), 12)
                EVT_CALL(SetActorYaw, ACTOR_SELF, LocalVar(3))
                EVT_WAIT(1)
            EVT_END_LOOP
    ...
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(15))
    EVT_IF_NOT_FLAG(LocalVar(15), 0x80000)
        EVT_CALL(func_80269EAC, 24)
    EVT_END_IF
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), 0, 65535, 0, 10, 32)
...
EvtScript N(8022B2E8) = {
    ...
    EVT_IF_FLAG(LocalVar(3), 0x80000)
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(GetActorVar, -127, 3, LocalVar(3))
    EVT_CALL(GetLastDamage, -127, LocalVar(4))
    EVT_IF_GT(LocalVar(4), LocalVar(3))
        EVT_SET(LocalVar(4), LocalVar(3))
    EVT_END_IF
    EVT_IF_GT(LocalVar(4), 6)
        EVT_SET(LocalVar(4), 6)
    EVT_END_IF
    EVT_IF_GT(LocalVar(4), 0)
        EVT_THREAD
            EVT_SUB(LocalVar(3), LocalVar(4))
            EVT_CALL(SetActorVar, -127, 3, LocalVar(3))
...
EvtScript N(8022B444) = {
    EVT_CALL(PlaySoundAtPart, -127, LocalVar(5), 530)
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(6), LocalVar(7), LocalVar(8))
    EVT_CALL(SetPartPos, ACTOR_SELF, LocalVar(5), LocalVar(6), 35, LocalVar(8))
    EVT_CALL(func_80218C74_48DE14, LocalVar(6), LocalVar(8), LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3))
    EVT_CALL(SetPartFlagBits, -127, LocalVar(5), 1, 0)
    EVT_CALL(SetPartJumpGravity, -127, LocalVar(5), EVT_FLOAT(1.0))
    EVT_CALL(JumpPartTo, -127, LocalVar(5), LocalVar(0), 0, LocalVar(1), 18, 1)
    EVT_CALL(JumpPartTo, -127, LocalVar(5), LocalVar(2), 0, LocalVar(3), 9, 1)
    EVT_WAIT(10)
    EVT_LOOP(10)
        EVT_CALL(SetPartFlagBits, -127, LocalVar(5), 1, 0)
        EVT_WAIT(1)
        EVT_CALL(SetPartFlagBits, -127, LocalVar(5), 1, 1)
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(PlaySoundAtPart, -127, LocalVar(5), 529)
    EVT_CALL(AddCoin, 1)
    EVT_RETURN
    EVT_END
};
