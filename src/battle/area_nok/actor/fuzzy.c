...
EvtScript N(handleEvent_802221FC) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_IF_FLAG(LocalVar(0), 0x20)
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_00_Anim_13)
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_00_Anim_8)
            EVT_END_IF
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_00_Anim_10)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_fuzzy_Palette_00_Anim_12)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_00_Anim_12)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_00_Anim_3)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_fuzzy_Palette_00_Anim_9)
...
EvtScript N(takeTurn_80222860) = {
    ...
    EVT_WAIT(5)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_IGNORE_DEFENSE, 0, 1, 16)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(6)
        EVT_CASE_OR_EQ(5)
    ...
    EVT_IF_EQ(LocalFlag(0), 1)
        EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_IGNORE_DEFENSE, 0, 0, 0, 32)
        EVT_RETURN
    EVT_END_IF
    EVT_WAIT(10)
    ...
    EVT_WAIT(10)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_IGNORE_DEFENSE, 0, 0, 1, 32)
    EVT_CALL(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_fuzzy_Palette_00_Anim_1)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
            EVT_CALL(GetLastDamage, 0, LocalVar(3))
            EVT_IF_NE(LocalVar(3), 0)
                ...
                EVT_CALL(PlayEffect, 0x40, 0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 0, 0, 0, 0, 0, 0, 0, 0)
