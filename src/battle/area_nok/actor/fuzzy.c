...
s32 N(idleAnimations_80222154)[] = {
    STATUS_NORMAL,    ANIM_Fuzzy_Anim1,
    STATUS_STONE,     ANIM_Fuzzy_Anim0,
    STATUS_SLEEP,     ANIM_Fuzzy_AnimE,
    STATUS_POISON,    ANIM_Fuzzy_Anim1,
    STATUS_STOP,      ANIM_Fuzzy_Anim0,
    STATUS_STATIC,    ANIM_Fuzzy_Anim1,
    STATUS_PARALYZE,  ANIM_Fuzzy_Anim0,
    STATUS_DIZZY,     ANIM_Fuzzy_AnimF,
    STATUS_FEAR,      ANIM_Fuzzy_AnimF,
    STATUS_END,
};
...
EvtScript N(handleEvent_802221FC) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 0x00000001)
                EVT_SET_CONST(LVar1, ANIM_Fuzzy_Anim8)
            EVT_END_IF
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Fuzzy_Anim3)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Fuzzy_Anim1)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Fuzzy_Anim3)
            EVT_SET_CONST(LVar2, ANIM_Fuzzy_Anim9)
...
EvtScript N(takeTurn_80222860) = {
    ...
    EVT_IF_EQ(LVar0, 1)
        ...
        EVT_GOTO(100)
    EVT_END_IF
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Anim3)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_ADD(LVar0, 50)
    EVT_SET(LVar1, 0)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Anim1)
    EVT_LABEL(100)
    EVT_CALL(SetActorDispOffset, ACTOR_SELF, 0, 10, 0)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Anim4)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Anim5)
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(JumpToGoal, ACTOR_SELF, 11, FALSE, TRUE, FALSE)
            EVT_CALL(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Anim9)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_SUB(LVar0, 20)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(3.0))
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Anim7)
    EVT_WAIT(21)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Anim0)
