...
EvtScript N(summonPetitPiranha) = {
    ...
    EVT_IF_EQ(LVar9, 1)
        ...
        EVT_CALL(FlyToGoal, LVar5, 24, -42, 6)
    EVT_ELSE
        EVT_CALL(GetActorPos, LVar5, LVar0, LVar1, LVar2)
        EVT_SET(LVar0, 18)
        EVT_SET(LVar1, 28)
        ...
        EVT_CALL(FlyToGoal, LVar5, 16, -15, 5)
    EVT_END_IF
...
EvtScript N(onDeath) = {
    ...
    EVT_IF_NE(LVar0, 0)
        ...
        EVT_CALL(SetPartEventBits, ACTOR_SELF, 1, ACTOR_EVENT_FLAG_FIREY, 0)
        EVT_CALL(SetPartEventBits, ACTOR_SELF, 2, ACTOR_EVENT_FLAG_FIREY, 0)
        EVT_WAIT(29)
    ...
    EVT_IF_EQ(LVar0, 0)
        ...
        EVT_CALL(SetActorVar, ACTOR_SELF, 5, 2)
        EVT_EXEC_WAIT(N(8022630C))
        EVT_CALL(SetPartFlagBits, ACTOR_SELF, 2, ACTOR_PART_FLAG_2000 | ACTOR_PART_FLAG_NO_TARGET, 1)
        EVT_CALL(SetActorFlagBits, ACTOR_SELF, ACTOR_FLAG_40000, 1)
    EVT_ELSE
        EVT_EXEC_WAIT(N(onHit))
        EVT_RETURN
    EVT_END_IF
...
EvtScript N(onHitCombo) = {
    ...
    EVT_ELSE
        ...
        EVT_ELSE
            ...
            EVT_SUB(LVar2, 25)
            EVT_ADD(LVar3, 2)
            EVT_CALL(PlayEffect, EFFECT_EMBERS, 0, LVar1, LVar2, LVar3, 40, 50, EVT_FLOAT(1.2), 24, 42, EVT_FLOAT(0.8), EVT_FLOAT(0.6), 0, 0)
            EVT_WAIT(29)
        EVT_END_IF
    EVT_END_IF
    EVT_RETURN
        ...
        EVT_IF_FLAG(LVarE, DAMAGE_TYPE_ICE | DAMAGE_TYPE_WATER)
            ...
            EVT_ELSE
                ...
                EVT_IF_NE(LVar0, 0)
                    ...
                    EVT_CALL(SetActorVar, ACTOR_SELF, 6, 0)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(PlayEffect, EFFECT_COLD_BREATH, 0, LVar0, LVar1, LVar2, EVT_FLOAT(2.0), 45, 0, 0, 0, 0, 0, 0, 0)
                EVT_END_IF
                EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_PTR(N(idleAnimations_wet)))
                EVT_CALL(SetDefenseTable, ACTOR_SELF, 1, EVT_PTR(N(defenseTable_wet)))
                EVT_CALL(SetDefenseTable, ACTOR_SELF, 2, EVT_PTR(N(defenseTable_wet)))
...
EvtScript N(attackPetitSpit) = {
    ...
    EVT_SWITCH(LVar9)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetActorJumpGravity, LVar5, EVT_FLOAT(1.8))
            EVT_CALL(FlyToGoal, LVar5, 0, 0, 0)
    ...
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LVar9, DAMAGE_TYPE_FIRE, EVENT_SUPPRESS_ALL, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LVar9)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_10)
            ...
            EVT_SET(LVar1, 10)
            EVT_ADD(LVar2, 2)
            EVT_CALL(PlayEffect, EFFECT_FLAME, 2, LVar0, LVar1, LVar2, EVT_FLOAT(0.3), LVarA, 0, 0, 0, 0, 0, 0, 0)
            EVT_CALL(MakeLerp, 120, 10, 20, 1)
            EVT_LOOP(0)
                EVT_CALL(UpdateLerp)
