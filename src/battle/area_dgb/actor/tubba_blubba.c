    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(PHASE_PLAYER_BEGIN)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_CALL(ActorSpeak, MSG_CH3_0102, ACTOR_SELF, 1, NPC_ANIM_battle_tubba_Palette_00_Anim_9, NPC_ANIM_battle_tubba_Palette_00_Anim_2)
                EVT_THREAD
...
EvtScript N(takeTurn_80219750) = {
    ...
    EVT_IF_EQ(LVar0, 1)
        ...
        EVT_CALL(MoveBattleCamOver, 20)
        EVT_WAIT(20)
        EVT_CALL(ActorSpeak, MSG_CH3_0103, ACTOR_SELF, 1, NPC_ANIM_battle_tubba_Palette_00_Anim_9, NPC_ANIM_battle_tubba_Palette_00_Anim_2)
        EVT_THREAD
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_battle_tubba_Palette_00_Anim_15)
            EVT_WAIT(4)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_battle_tubba_Palette_00_Anim_16)
