...
EvtScript N(init_80218D70) = {
    ...
    EVT_END_IF
    EVT_EXEC_GET_TID(N(80218E60), LocalVar(0))
...
EvtScript N(80218E60) = {
    ...
    EVT_IF_EQ(LocalVar(0), NPC_ANIM_battle_tubba_Palette_00_Anim_6)
        EVT_GOTO(1)
    EVT_END_IF
    EVT_IF_EQ(LocalVar(0), NPC_ANIM_battle_tubba_Palette_00_Anim_7)
        EVT_GOTO(1)
    EVT_END_IF
    EVT_GOTO(0)
    EVT_LABEL(1)
...
EvtScript N(handleEvent_80219338) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_tubba_Palette_00_Anim_2)
        ...
        EVT_CASE_OR_EQ(EVENT_BURN_DEATH)
            ...
            EVT_IF_EQ(LocalVar(0), EVENT_BURN_DEATH)
                EVT_WAIT(10)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_tubba_Palette_00_Anim_14)
...
EvtScript N(takeTurn_80219750) = {
    ...
    EVT_IF_EQ(LocalVar(0), HIT_RESULT_MISS)
    ...
    EVT_SWITCH(LocalVar(15))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_10)
            ...
            EVT_IF_NOT_FLAG(LocalVar(0), BS_FLAGS1_ATK_BLOCKED)
                ...
                EVT_IF_NOT_FLAG(LocalVar(0), STATUS_FLAG_STONE)
