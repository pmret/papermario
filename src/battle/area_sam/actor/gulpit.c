...
s32 N(idleAnimations1)[] = {
    STATUS_NORMAL, ANIM_Gulpit_Anim1,
    STATUS_STONE, ANIM_Gulpit_Anim0,
    STATUS_SLEEP, ANIM_Gulpit_AnimF,
    STATUS_POISON, ANIM_Gulpit_Anim1,
    STATUS_STOP, ANIM_Gulpit_Anim0,
    STATUS_STATIC, ANIM_Gulpit_Anim1,
    STATUS_PARALYZE, ANIM_Gulpit_Anim0,
    STATUS_DIZZY, ANIM_Gulpit_AnimE,
    STATUS_FEAR, ANIM_Gulpit_AnimE,
    STATUS_END,
};
...
EvtScript N(returnHome) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_Gulpit_Anim3)
    EVT_EXEC_WAIT(DoReturnHome)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Gulpit_AnimB)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Gulpit_AnimC)
            EVT_SET_CONST(LVar2, ANIM_Gulpit_AnimD)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Gulpit_AnimD)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Gulpit_Anim1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Gulpit_Anim3)
            EVT_SET_CONST(LVar2, ANIM_Gulpit_AnimB)
...
EvtScript N(attack_lick) = {
    ...
    EVT_END_IF
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim3)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    ...
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim4)
    EVT_WAIT(9)
...
EvtScript N(attack_rock) = {
    ...
    EVT_ADD(LVar0, 20)
    EVT_SUB(LVar2, 1)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim2)
    ...
    EVT_SWITCH(LVarB)
        EVT_CASE_EQ(0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim5)
            EVT_WAIT(3)
            EVT_CALL(RemoveActor, LVarA)
            EVT_WAIT(20)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim6)
            EVT_WAIT(15)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim7)
            EVT_SET(LVarA, 2)
        EVT_CASE_EQ(1)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim8)
            EVT_WAIT(3)
            EVT_CALL(RemoveActor, LVarA)
            EVT_WAIT(20)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_Anim9)
            EVT_WAIT(15)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Gulpit_AnimA)
            EVT_SET(LVarA, 3)
    EVT_END_SWITCH
