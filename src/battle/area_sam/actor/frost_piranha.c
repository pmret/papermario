...
EvtScript N(idle) = {
    ...
    EVT_IF_FLAG(LocalVar(10), STATUS_FLAG_DIZZY)
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_putrid_piranha_Palette_01_Anim_E)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_putrid_piranha_Palette_01_Anim_10)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_putrid_piranha_Palette_01_Anim_11)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_putrid_piranha_Palette_01_Anim_11)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_putrid_piranha_Palette_01_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_putrid_piranha_Palette_01_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_putrid_piranha_Palette_01_Anim_E)
...
EvtScript N(attack_bite) = {
    ...
    EVT_IF_EQ(LocalVar(0), PHASE_FIRST_STRIKE)
        ...
        EVT_ADD(LocalVar(0), 27)
        EVT_SET(LocalVar(1), 0)
        EVT_SET(LocalVar(3), LocalVar(0))
        EVT_SET(LocalVar(4), LocalVar(1))
        EVT_SET(LocalVar(5), LocalVar(2))
        EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(6), LocalVar(7), LocalVar(8))
        EVT_ADD(LocalVar(3), LocalVar(6))
        EVT_ADD(LocalVar(4), LocalVar(7))
        EVT_ADD(LocalVar(5), LocalVar(8))
        EVT_DIV(LocalVar(3), 2)
        EVT_DIV(LocalVar(4), 2)
        EVT_DIV(LocalVar(5), 2)
        EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_19)
        EVT_CALL(SetBattleCamTarget, LocalVar(3), LocalVar(4), LocalVar(5))
...
EvtScript N(attack_icy_breath) = {
    ...
    EVT_END_IF
    EVT_CALL(N(UnkEffect6FFunc), LocalVar(2), LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 30, 120, 0, 120)
    EVT_WAIT(1)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_putrid_piranha_Palette_01_Anim_C)
    EVT_WAIT(5)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(10), DAMAGE_TYPE_ICE, STATUS_FLAG_FROZEN, 1, BS_FLAGS1_10)
    EVT_SWITCH(LocalVar(10))
        EVT_CASE_OR_EQ(HIT_RESULT_MISS)
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_WAIT(10)
    ...
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_ICE | DAMAGE_TYPE_STATUS_ALWAYS_HITS, 65535, 0x00000002 | STATUS_FLAG_4 | STATUS_FLAG_8 | 0x00000010 | STATUS_FLAG_20 | STATUS_FLAG_40 | 0x00000080 | STATUS_FLAG_200 | STATUS_FLAG_FROZEN, 0, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SET(LocalVar(15), LocalVar(0))
    EVT_SWITCH(LocalVar(15))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
