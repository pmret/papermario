...
EvtScript N(singleStrike3) = {
    ...
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20BB)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 10, 48)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
...
EvtScript N(doubleStrike3) = {
    ...
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20BB)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 6, 16)
    EVT_WAIT(15)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_THREAD
    ...
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20BB)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 7, 32)
    EVT_WAIT(15)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
...
EvtScript N(tripleStrike3) = {
    ...
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20BB)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 6, 0)
    EVT_THREAD
        EVT_WAIT(5)
...
EvtScript N(80230240) = {
    ...
    EVT_LOOP(5)
        EVT_ADD(LocalVar(0), 20)
        EVT_CALL(ModifyActorDecoration, -127, 1, 0, 80, LocalVar(0), 0, 0)
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_LOOP(5)
...
EvtScript N(8023059C) = {
    ...
    EVT_CALL(JumpPartTo, -127, 2, LocalVar(0), LocalVar(1), LocalVar(2), 10, 1)
    EVT_CALL(SetPartFlagBits, -127, 2, 1, 1)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 10, 16)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
        EVT_END_CASE_GROUP
