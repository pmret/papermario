...
EvtScript N(8021A12C) = {
    ...
    EVT_CALL(GetIndexFromPos, -127, LocalVar(10))
    EVT_MOD(LocalVar(10), 4)
    EVT_CALL(SetGoalToIndex, -127, LocalVar(10))
    EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(10), LocalVar(11), LocalVar(12))
    EVT_CALL(SetHomePos, -127, LocalVar(10), LocalVar(11), LocalVar(12))
...
EvtScript N(handleEvent_8021A560) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(9)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_6)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_chan_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_4)
        ...
        EVT_CASE_EQ(23)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_C)
        ...
        EVT_CASE_EQ(25)
            ...
            EVT_IF_NOT_FLAG(LocalVar(0), 0x200000)
                EVT_EXEC_WAIT(N(8021A12C))
            EVT_END_IF
        EVT_CASE_EQ(32)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
...
EvtScript N(8021AA1C) = {
    EVT_CALL(GetActorVar, -127, 8, LocalVar(3))
...
EvtScript N(handleEvent_8021AAB8) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(10)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_6)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_chan_Palette_00_Anim_7)
        ...
        EVT_CASE_EQ(14)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_14)
                EVT_SET_CONST(LocalVar(2), NPC_ANIM_chan_Palette_00_Anim_15)
                EVT_EXEC_WAIT(DoBurnHit)
            EVT_END_IF
        EVT_CASE_EQ(36)
            EVT_CALL(GetActorVar, -127, 8, LocalVar(0))
            ...
            EVT_ELSE
                ...
                EVT_EXEC_WAIT(DoBurnHit)
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_15)
                EVT_EXEC_WAIT(DoDeath)
            EVT_END_IF
            EVT_RETURN
        EVT_CASE_EQ(11)
        ...
        EVT_CASE_EQ(23)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_2)
                EVT_EXEC_WAIT(DoImmune)
            EVT_END_IF
        EVT_CASE_EQ(25)
            EVT_CALL(GetActorVar, -127, 8, LocalVar(0))
        ...
        EVT_CASE_EQ(49)
            ...
            EVT_IF_EQ(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(22)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 0x00000001)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_7)
            EVT_END_IF
...
EvtScript N(takeTurn_8021B81C) = {
    ...
    EVT_IF_EQ(LocalVar(0), 1)
        ...
        EVT_CALL(func_8024ECF8, -1, 1, 0)
    EVT_END_IF
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), 0, 0, 3, 16)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(6)
        EVT_CASE_OR_EQ(5)
...
EvtScript N(takeTurn_Chan) = {
    ...
    EVT_IF_EQ(LocalVar(0), 2)
        ...
        EVT_ELSE
            ...
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chan_Palette_00_Anim_2)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_chan_Palette_00_Anim_1)
    ...
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), 0, 0, 2, 16)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(6)
        EVT_CASE_OR_EQ(5)
            EVT_SET(LocalVar(10), LocalVar(0))
...
EvtScript N(nextTurn_8021CD7C) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(12)
            ...
            EVT_END_IF
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(0))
            EVT_IF_FLAG(LocalVar(0), 0x37100A)
                EVT_BREAK_SWITCH
            EVT_END_IF
            EVT_SET_CONST(LocalVar(10), NPC_ANIM_chan_Palette_00_Anim_4)
            EVT_SET_CONST(LocalVar(11), NPC_ANIM_chan_Palette_00_Anim_3)
            EVT_CALL(GetActorVar, -127, 8, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 2)
                EVT_SET_CONST(LocalVar(10), NPC_ANIM_chan_Palette_00_Anim_7)
                EVT_SET_CONST(LocalVar(11), NPC_ANIM_chan_Palette_00_Anim_2)
            EVT_END_IF
            ...
            EVT_IF_LE(LocalVar(0), LocalVar(1))
                ...
                EVT_IF_EQ(LocalVar(0), 0)
                    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
                    EVT_CALL(MoveBattleCamOver, 10)
                    EVT_CALL(ActorSpeak, 131105, -127, 1, LocalVar(10), LocalVar(11))
            ...
            EVT_IF_LE(LocalVar(0), 5)
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
                EVT_CALL(MoveBattleCamOver, 10)
                EVT_CALL(ActorSpeak, 131106, -127, 1, LocalVar(10), LocalVar(11))
                EVT_BREAK_SWITCH
            EVT_END_IF
    EVT_END_SWITCH
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
...
EvtScript N(handleEvent_8021D0CC) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(13)
            ...
            EVT_IF_NOT_FLAG(LocalVar(0), 0x20)
                EVT_BREAK_SWITCH
            EVT_END_IF
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(0))
            ...
            EVT_IF_EQ(LocalVar(0), 2)
                ...
                EVT_END_SWITCH
                EVT_CALL(SetActorVar, -127, 1, LocalVar(0))
            EVT_END_IF
            EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
            EVT_CALL(UseIdleAnimation, ACTOR_SELF, TRUE)
    EVT_END_SWITCH
