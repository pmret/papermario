...
s32 N(idleAnimations_8022B640)[] = {
    STATUS_NORMAL,    ANIM_TheMaster_Anim05,
    STATUS_STONE,     ANIM_TheMaster_Anim00,
    STATUS_SLEEP,     ANIM_TheMaster_Anim1C,
    STATUS_POISON,    ANIM_TheMaster_Anim00,
    STATUS_STOP,      ANIM_TheMaster_Anim00,
    STATUS_STATIC,    ANIM_TheMaster_Anim00,
    STATUS_PARALYZE,  ANIM_TheMaster_Anim00,
    STATUS_DIZZY,     ANIM_TheMaster_Anim1E,
    STATUS_DIZZY,     ANIM_TheMaster_Anim1E,
    STATUS_END,
};

s32 N(idleAnimations_8022B68C)[] = {
    STATUS_NORMAL,    ANIM_TheMaster_Anim06,
    STATUS_STONE,     ANIM_TheMaster_Anim01,
    STATUS_SLEEP,     ANIM_TheMaster_Anim1D,
    STATUS_POISON,    ANIM_TheMaster_Anim01,
    STATUS_STOP,      ANIM_TheMaster_Anim01,
    STATUS_STATIC,    ANIM_TheMaster_Anim01,
    STATUS_PARALYZE,  ANIM_TheMaster_Anim01,
    STATUS_DIZZY,     ANIM_TheMaster_Anim1F,
    STATUS_DIZZY,     ANIM_TheMaster_Anim1F,
    STATUS_END,
};
...
EvtScript N(8022B8C0) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, ANIM_TheMaster_Anim16)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_TheMaster_Anim1A)
            EVT_SET_CONST(LVar2, ANIM_TheMaster_Anim1B)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_TheMaster_Anim18)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim08)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(8.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(1.0))
            EVT_WAIT(5)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim06)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_TheMaster_Anim03)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_TheMaster_Anim08)
            EVT_SET_CONST(LVar2, ANIM_TheMaster_Anim16)
...
EvtScript N(singleStrike2) = {
    ...
    EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim03)
    EVT_WAIT(10)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20BD)
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim0E)
    EVT_WAIT(30)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim0F)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(2)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim21)
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
            EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20BA)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim23)
...
EvtScript N(doubleStrike2) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim15)
    EVT_WAIT(40)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(AddGoalPos, ACTOR_SELF, -50, 0, 0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim13)
            EVT_CALL(RunToGoal, ACTOR_SELF, 10, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim03)
            EVT_CALL(EnableActorBlur, -127, 0)
            EVT_WAIT(10)
    ...
    EVT_THREAD
        ...
        EVT_CALL(EnableActorBlur, -127, 1)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim14)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(10)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim0D)
                EVT_WAIT(15)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim0C)
                EVT_WAIT(5)
                ...
                EVT_SET(LVar0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim00)
                EVT_LOOP(15)
                    EVT_ADD(LVar0, 24)
                ...
                EVT_LOOP(5)
                    ...
                    EVT_WAIT(1)
                EVT_END_LOOP
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim01)
                EVT_LOOP(5)
                    EVT_ADD(LVar0, 18)
                    EVT_CALL(SetActorRotation, ACTOR_SELF, 0, LVar0, 0)
                    EVT_WAIT(1)
