...
s32 N(idleAnimations_8022B640)[] = {
    STATUS_NORMAL,    ANIM_TheMaster_Anim5,
    STATUS_STONE,     ANIM_TheMaster_Anim0,
    STATUS_SLEEP,     ANIM_TheMaster_Anim1C,
    STATUS_POISON,    ANIM_TheMaster_Anim0,
    STATUS_STOP,      ANIM_TheMaster_Anim0,
    STATUS_STATIC,    ANIM_TheMaster_Anim0,
    STATUS_PARALYZE,  ANIM_TheMaster_Anim0,
...
s32 N(idleAnimations_8022B68C)[] = {
    STATUS_NORMAL,    ANIM_TheMaster_Anim6,
    STATUS_STONE,     ANIM_TheMaster_Anim1,
    STATUS_SLEEP,     ANIM_TheMaster_Anim1D,
    STATUS_POISON,    ANIM_TheMaster_Anim1,
    STATUS_STOP,      ANIM_TheMaster_Anim1,
    STATUS_STATIC,    ANIM_TheMaster_Anim1,
    STATUS_PARALYZE,  ANIM_TheMaster_Anim1,
...
EvtScript N(8022B8C0) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim8)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(8.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(1.0))
            EVT_WAIT(5)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim6)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_TheMaster_Anim3)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_TheMaster_Anim8)
...
EvtScript N(singleStrike2) = {
    ...
    EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim3)
    EVT_WAIT(10)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20BD)
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_AnimE)
    EVT_WAIT(30)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_AnimF)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(10)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_AnimD)
                EVT_WAIT(15)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_AnimC)
                EVT_WAIT(5)
                ...
                EVT_SET(LVar0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim0)
                EVT_LOOP(15)
                    EVT_ADD(LVar0, 24)
                ...
                EVT_LOOP(5)
                    ...
                    EVT_WAIT(1)
                EVT_END_LOOP
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_TheMaster_Anim1)
                EVT_LOOP(5)
                    EVT_ADD(LVar0, 18)
                    EVT_CALL(SetActorRotation, ACTOR_SELF, 0, LVar0, 0)
                    EVT_WAIT(1)
