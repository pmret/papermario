...
EvtScript N(8021D5C4) = {
    ...
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_lee_Palette_00_Anim_4)
...
EvtScript N(handleEvent_8021D600) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(10)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_lee_Palette_00_Anim_B)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_lee_Palette_00_Anim_D)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_lee_Palette_00_Anim_2)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_lee_Palette_00_Anim_4)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_lee_Palette_00_Anim_B)
...
EvtScript N(8021E118) = {
    ...
    EVT_CALL(CopyStatusEffects, -127, LocalVar(10))
    ...
    EVT_CALL(CopyBuffs, -127, LocalVar(10))
    ...
    EVT_CALL(SetPartFlagBits, LocalVar(10), 1, 8388608, 1)
    EVT_CALL(SetPartFlagBits, LocalVar(10), 1, 131073, 0)
    ...
    EVT_CALL(SetPartFlagBits, -127, LocalVar(0), 1, 1)
    EVT_CALL(SetIdleAnimations, LocalVar(10), 1, EVT_ADDR(N(idleAnimations_8021D3AC)))
    EVT_CALL(SetAnimation, LocalVar(10), 1, 0xA4000B)
    EVT_WAIT(30)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    ...
    EVT_CALL(SetIdleAnimations, LocalVar(10), 1, EVT_ADDR(N(idleAnimations_8021D360)))
    EVT_CALL(SetAnimation, LocalVar(10), 1, 0xA40002)
...
EvtScript N(8021E5DC) = {
    ...
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_THREAD
        EVT_CALL(SetActorRotationOffset, -127, 0, LocalVar(12), 0)
...
EvtScript N(8021F6E0) = {
    ...
    EVT_WAIT(1)
    EVT_WAIT(2)
    EVT_CALL(GetActorVar, -127, 1, LocalVar(9))
    EVT_SWITCH(LocalVar(9))
        EVT_CASE_EQ(0)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 1, 16)
        EVT_CASE_EQ(1)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 2, 16)
        EVT_CASE_EQ(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 3, 16)
    EVT_END_SWITCH
    EVT_CALL(GetActorHP, 0, LocalVar(0))
    ...
    EVT_SWITCH(LocalVar(9))
        ...
        EVT_CASE_EQ(2)
            EVT_THREAD
                ...
                EVT_LOOP(6)
                    EVT_ADD(LocalVar(0), 30)
                    EVT_CALL(SetActorRotation, ACTOR_SELF, 0, -250000000, LocalVar(0))
                    EVT_WAIT(1)
                EVT_END_LOOP
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_battle_goombario_default_headbonk)
            EVT_END_THREAD
            EVT_THREAD
                ...
                EVT_LOOP(LocalVar(10))
                    ...
                    EVT_CALL(SetActorRotation, ACTOR_SELF, -250000000, LocalVar(0), -250000000)
                    EVT_WAIT(1)
                EVT_END_LOOP
            EVT_END_THREAD
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    ...
    EVT_SWITCH(LocalVar(9))
        ...
        EVT_CASE_EQ(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 3, 32)
    EVT_END_SWITCH
    EVT_LABEL(100)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
...
EvtScript N(80220100) = {
    ...
    EVT_CALL(func_80218E2C_4652BC, LocalVar(5))
    EVT_WAIT(12)
...
EvtScript N(handleEvent_80220908) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(N(8021E0E0))
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_13)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
        ...
        EVT_CASE_OR_EQ(31)
            ...
            EVT_SWITCH(LocalVar(0))
                ...
                EVT_CASE_EQ(1)
                    ...
                    EVT_SET_CONST(LocalVar(0), 0x00000001)
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_19)
            EVT_END_SWITCH
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(32)
...
EvtScript N(takeTurn_80221200) = {
    ...
    EVT_IF_EQ(LocalVar(0), 1)
        ...
        EVT_SUB(LocalVar(0), 1)
        EVT_IF_GT(LocalVar(0), 0)
            EVT_CALL(SetActorVar, -127, 5, LocalVar(0))
            EVT_CALL(AddActorDecoration, ACTOR_SELF, 1, 0, 2)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(3.0))
            EVT_WAIT(30)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(1.0))
    ...
    EVT_LOOP(LocalVar(0))
        ...
        EVT_SWITCH(LocalVar(9))
            ...
            EVT_CASE_EQ(20)
                ...
                EVT_CALL(PlayEffect, 0x1D, 1, LocalVar(4), LocalVar(5), LocalVar(6), 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_LT(40)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_WAIT(5)
            EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(4), LocalVar(5), LocalVar(6))
            EVT_CALL(PlayEffect, 0x1D, 1, LocalVar(4), LocalVar(5), LocalVar(6), 16, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_LOOP(5)
    ...
    EVT_SWITCH(LocalVar(9))
        EVT_CASE_EQ(0)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 65535, 0, 2, 32)
        EVT_CASE_EQ(1)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 65535, 0, 3, 32)
        EVT_CASE_EQ(2)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 65535, 0, 5, 32)
    EVT_END_SWITCH
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
...
EvtScript N(handleEvent_80222468) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(10)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_12)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_13)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_bombette_Palette_00_Anim_14)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(36)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_13)
            ...
            EVT_EXEC_WAIT(N(8021E0E0))
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_14)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_4)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(32)
            EVT_EXEC_WAIT(N(8021E0E0))
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_8)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_bombette_Palette_00_Anim_12)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(58)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
...
EvtScript N(handleEvent_80223584) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(57)
            ...
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_parakarry_Palette_00_Anim_D)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(58)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_THREAD
                ...
                EVT_LOOP(20)
                    ...
                    EVT_CALL(SetPartAlpha, -127, 1, LocalVar(0))
                    EVT_WAIT(1)
                EVT_END_LOOP
            EVT_END_THREAD
            EVT_WAIT(10)
...
EvtScript N(takeTurn_80224CA0) = {
    ...
    EVT_CALL(GetActorVar, -127, 1, LocalVar(8))
    ...
    EVT_LOOP(LocalVar(7))
        ...
        EVT_WAIT(8)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_battle_bow_Palette_00_Anim_1)
        EVT_CALL(GetActorHP, 0, LocalVar(1))
...
EvtScript N(takeTurn_80226004) = {
    ...
    EVT_IF_FLAG(LocalVar(0), 0x80000)
        ...
        EVT_CALL(PlayEffect, 0x33, 8, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(0.5205), LocalVar(10), 0, 0, 0, 0, 0, 0, 0)
    EVT_ELSE
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(1), 12)
        EVT_CALL(PlayEffect, 0x33, 8, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.3), LocalVar(10), 0, 0, 0, 0, 0, 0, 0)
    EVT_END_IF
    ...
    EVT_SWITCH(LocalVar(9))
        EVT_CASE_EQ(0)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), (DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_IGNORE_DEFENSE), 65535, 0, 3, 32)
        EVT_CASE_EQ(1)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), (DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_IGNORE_DEFENSE), 65535, 0, 4, 32)
        EVT_CASE_EQ(2)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), (DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_IGNORE_DEFENSE), 65535, 0, 5, 32)
    EVT_END_SWITCH
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
...
EvtScript N(takeTurn_802270BC) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetPartScale, -127, 1, EVT_FLOAT(1.0), EVT_FLOAT(1.0), EVT_FLOAT(1.0))
    EVT_END_THREAD
    EVT_CALL(GetActorVar, -127, 1, LocalVar(10))
    EVT_SWITCH(LocalVar(10))
        ...
        EVT_CASE_EQ(1)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 4, 32)
        EVT_CASE_EQ(2)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 5, 32)
    EVT_END_SWITCH
...
EvtScript N(takeTurn_80228B78) = {
    ...
    EVT_END_IF
    EVT_CALL(PlayEffect, 0x6B, 0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 30, 0, 0, 0, 0, 0, 0, 0)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(JumpPartTo, -127, 3, LocalVar(0), 0, LocalVar(2), 20, 1)
            EVT_THREAD
                EVT_ADD(LocalVar(0), -50)
                EVT_CALL(JumpPartTo, -127, 3, LocalVar(0), 0, LocalVar(2), 15, 1)
    ...
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(JumpPartTo, -127, 3, LocalVar(0), LocalVar(1), LocalVar(2), 20, 1)
    EVT_THREAD
        EVT_ADD(LocalVar(0), -50)
        EVT_CALL(JumpPartTo, -127, 3, LocalVar(0), 0, LocalVar(2), 15, 1)
        EVT_CALL(SetPartFlagBits, -127, 3, 1, 1)
    ...
    EVT_SWITCH(LocalVar(9))
        EVT_CASE_EQ(0)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 3, 32)
        EVT_CASE_EQ(1)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 4, 32)
        EVT_CASE_EQ(2)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 5, 32)
    EVT_END_SWITCH
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
...
EvtScript N(copyPartner) = {
    ...
    EVT_ELSE
        ...
        EVT_SETF(LocalVar(3), EVT_FLOAT(1.0))
    EVT_END_IF
    EVT_CALL(PlayEffect, 0x13, 1, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 40, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(N(UnkBackgroundFunc3))
    ...
    EVT_END_IF
    EVT_WAIT(10)
    EVT_CALL(func_802197B8_465C48, LocalVar(5), LocalVar(6))
    EVT_CALL(func_80218100_464590)
    EVT_CALL(func_80219824_465CB4, LocalVar(5))
