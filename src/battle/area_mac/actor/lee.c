...
s32 N(idleAnimations_8021D360)[] = {
    STATUS_NORMAL,    ANIM_Lee_Anim02,
    STATUS_STONE,     ANIM_Lee_Anim00,
    STATUS_SLEEP,     ANIM_Lee_Anim0E,
    STATUS_POISON,    ANIM_Lee_Anim02,
    STATUS_STOP,      ANIM_Lee_Anim00,
    STATUS_STATIC,    ANIM_Lee_Anim02,
    STATUS_PARALYZE,  ANIM_Lee_Anim00,
    STATUS_DIZZY,     ANIM_Lee_Anim0F,
    STATUS_DIZZY,     ANIM_Lee_Anim0F,
    STATUS_END,
};

s32 N(idleAnimations_8021D3AC)[] = {
    STATUS_NORMAL,    ANIM_Lee_Anim0B,
    STATUS_END,
};
...
EvtScript N(8021D5C4) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_Lee_Anim04)
...
EvtScript N(handleEvent_8021D600) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Lee_Anim0B)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Lee_Anim0D)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Lee_Anim02)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_Lee_Anim04)
            EVT_SET_CONST(LVar2, ANIM_Lee_Anim0B)
...
EvtScript N(flyingTackle) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Lee_Anim08)
    EVT_WAIT(20)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Lee_Anim09)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Lee_Anim02)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(2)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
            EVT_CALL(ResetActorSounds, -127, 2)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Lee_Anim0A)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
...
s32 N(idleAnimations_80220540)[] = {
    STATUS_NORMAL,    ANIM_BattleKooper_Anim04,
    STATUS_STONE,     ANIM_BattleKooper_Anim00,
    STATUS_SLEEP,     ANIM_BattleKooper_Anim00,
    STATUS_POISON,    ANIM_BattleKooper_Anim04,
    STATUS_STOP,      ANIM_BattleKooper_Anim00,
    STATUS_STATIC,    ANIM_BattleKooper_Anim04,
    STATUS_PARALYZE,  ANIM_BattleKooper_Anim00,
    STATUS_DIZZY,     ANIM_BattleKooper_Anim1C,
    STATUS_FEAR,      ANIM_BattleKooper_Anim1C,
    STATUS_END,
};

s32 N(idleAnimations_8022058C)[] = {
    STATUS_NORMAL,    ANIM_BattleKooper_Anim19,
    STATUS_STONE,     ANIM_BattleKooper_Anim03,
    STATUS_SLEEP,     ANIM_BattleKooper_Anim03,
    STATUS_POISON,    ANIM_BattleKooper_Anim19,
    STATUS_STOP,      ANIM_BattleKooper_Anim03,
    STATUS_STATIC,    ANIM_BattleKooper_Anim19,
    STATUS_PARALYZE,  ANIM_BattleKooper_Anim03,
    STATUS_DIZZY,     ANIM_BattleKooper_Anim19,
    STATUS_FEAR,      ANIM_BattleKooper_Anim19,
    STATUS_END,
};
...
EvtScript N(handleEvent_80220908) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(N(8021E0E0))
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim13)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(13)
            ...
            EVT_CALL(SetTargetOffset, -127, 1, 5, 15)
            EVT_CALL(func_8027D4C8, -127, 1, 0, -6)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim11)
            EVT_CALL(SetActorRotationOffset, -127, 0, 12, 0)
            EVT_THREAD
                EVT_WAIT(4)
            ...
            EVT_CALL(SetActorRotation, ACTOR_SELF, 0, 0, 0)
            EVT_CALL(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim19)
        EVT_CASE_OR_EQ(23)
        EVT_CASE_OR_EQ(25)
        EVT_CASE_OR_EQ(31)
            EVT_CALL(GetActorVar, -127, 4, LVar0)
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_EQ(1)
                    ...
                    EVT_SET_CONST(LVar0, 0x00000001)
                    EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim19)
            EVT_END_SWITCH
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(32)
...
EvtScript N(takeTurn_80221200) = {
    ...
    EVT_IF_EQ(LVar0, 1)
        ...
        EVT_ELSE
            ...
            EVT_CALL(SetActorRotation, ACTOR_SELF, 0, 0, 0)
            EVT_CALL(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim04)
            EVT_CALL(SetActorVar, -127, 4, 0)
        ...
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim0E)
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, SOUND_0)
    EVT_WAIT(15)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim0A)
    ...
    EVT_LOOP(LVar0)
        ...
        EVT_SWITCH(LVar9)
            ...
            EVT_CASE_LT(40)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim0B)
                EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(12.0))
            EVT_CASE_EQ(40)
                EVT_CALL(GetActorPos, ACTOR_SELF, LVar4, LVar5, LVar6)
                EVT_CALL(PlayEffect, 0x1D, 1, LVar4, LVar5, LVar6, 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_LT(50)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim0C)
                EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(14.0))
            EVT_CASE_EQ(50)
                EVT_CALL(GetActorPos, ACTOR_SELF, LVar4, LVar5, LVar6)
                EVT_CALL(PlayEffect, 0x1D, 1, LVar4, LVar5, LVar6, 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_LT(60)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim0D)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_END_THREAD
            EVT_WAIT(4)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim09)
            ...
            EVT_END_IF
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim0F)
            EVT_WAIT(10)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
            EVT_CALL(YieldTurn)
            EVT_CALL(ResetAllActorSounds, ACTOR_SELF)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleKooper_Anim06)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
...
s32 N(idleAnimations_80222290)[] = {
    STATUS_NORMAL,    ANIM_BattleBombette_Anim04,
    STATUS_STONE,     ANIM_BattleBombette_Anim00,
    STATUS_SLEEP,     ANIM_BattleBombette_Anim00,
    STATUS_POISON,    ANIM_BattleBombette_Anim04,
    STATUS_STOP,      ANIM_BattleBombette_Anim00,
    STATUS_STATIC,    ANIM_BattleBombette_Anim04,
    STATUS_PARALYZE,  ANIM_BattleBombette_Anim00,
    STATUS_DIZZY,     ANIM_BattleBombette_Anim1E,
    STATUS_FEAR,      ANIM_BattleBombette_Anim1E,
    STATUS_END,
};
...
EvtScript N(handleEvent_80222468) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_BattleBombette_Anim12)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_BattleBombette_Anim13)
            EVT_SET_CONST(LVar2, ANIM_BattleBombette_Anim14)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(36)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_BattleBombette_Anim13)
            ...
            EVT_EXEC_WAIT(N(8021E0E0))
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_BattleBombette_Anim14)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(11)
            EVT_SET_CONST(LVar0, 0x00000001)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET(LVar2, 15)
            EVT_EXEC_WAIT(N(8021E5DC))
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleBombette_Anim08)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(5.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
        EVT_CASE_EQ(38)
        ...
        EVT_CASE_EQ(57)
            ...
            EVT_SET_CONST(LVar2, ANIM_BattleBombette_Anim12)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(58)
            EVT_SET_CONST(LVar0, 0x00000001)
...
EvtScript N(takeTurn_802229C4) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleBombette_Anim04)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleBombette_Anim0F)
    EVT_WAIT(15)
    EVT_CALL(SetActorSounds, -127, 0, 0, 0)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleBombette_Anim10)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(2)
            ...
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
            EVT_CALL(MoveBattleCamOver, 8)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleBombette_Anim11)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_ADD(LVar0, 40)
            EVT_SET(LVar1, 0)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.4))
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(JumpToGoal, ACTOR_SELF, 20, FALSE, TRUE, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleBombette_Anim0E)
            EVT_WAIT(1)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleBombette_Anim11)
            EVT_ADD(LVar0, 40)
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
...
EvtScript N(handleEvent_80223584) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(57)
            ...
            EVT_SET_CONST(LVar2, ANIM_BattleParakarry_Anim0D)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(58)
            EVT_SET_CONST(LVar0, 0x00000001)
...
EvtScript N(copyPartner) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Lee_Anim07)
    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_CALL(GetStatusFlags, ACTOR_SELF, LVarA)
    EVT_IF_FLAG(LVarA, 0x80000)
        EVT_ADD(LVar1, 8)
