...
EvtScript N(attack) = {
    ...
    EVT_THREAD
        EVT_LOOP(15)
            ...
            EVT_CALL(SetPartDispOffset, ACTOR_SELF, PRT_2, 1, 0, 0)
            EVT_WAIT(1)
            EVT_CALL(SetActorDispOffset, ACTOR_SELF, -1, 0, 0)
            EVT_CALL(SetPartDispOffset, ACTOR_SELF, PRT_2, -1, 0, 0)
            EVT_WAIT(1)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, PRT_2, EVT_FLOAT(1.5))
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            ...
            EVT_THREAD
                EVT_ADD(LVar0, -50)
                EVT_CALL(JumpPartTo, ACTOR_SELF, PRT_2, LVar0, 0, LVar2, 15, TRUE)
