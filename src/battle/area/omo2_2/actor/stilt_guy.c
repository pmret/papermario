...
EvtScript N(init) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetActorPaletteSwapParams, ACTOR_SELF, 5, SPR_PAL_StiltGuyUnfold_Alt, SPR_PAL_StiltGuyUnfold, 0, 36, 0, 255, 0, 0)
        EVT_CALL(SetActorPaletteEffect, ACTOR_SELF, 5, PAL_ADJUST_BLEND_PALSETS)
        EVT_WAIT(18)
