...
EvtScript N(beforeBattle) = {
    ...
    EVT_CALL(SetGroupVisibility, 13, 0)
    EVT_CALL(SetGroupVisibility, 17, 0)
    EVT_CALL(SetGroupVisibility, 16, 0)
    EVT_CALL(SetGroupVisibility, 18, 0)
    EVT_CALL(SetGroupVisibility, 20, 0)
    EVT_CALL(SetGroupVisibility, 22, 0)
    EVT_CALL(SetGroupVisibility, 24, 0)
    EVT_SET(LVar0, 32)
    EVT_EXEC(N(8022FA10))
    EVT_SET(LVar0, 34)
    EVT_EXEC(N(8022FA10))
