...
s32 N(BasicAnims)[] = {
    ...
    STATUS_SLEEP,     ANIM_ChainChomp_Sleep,
    STATUS_POISON,    ANIM_ChainChomp_Idle,
    STATUS_STOP,      ANIM_ChainChomp_Still,
    STATUS_STATIC,    ANIM_ChainChomp_Still,
    STATUS_PARALYZE,  ANIM_ChainChomp_Still,
    STATUS_DIZZY,     ANIM_ChainChomp_Dizzy,
    STATUS_END,
};

s32 N(QuickBiteAnims)[] = {
    STATUS_NORMAL,    ANIM_ChainChomp_QuickBite,
    STATUS_POISON,    ANIM_ChainChomp_QuickBite,
    STATUS_STOP,      ANIM_ChainChomp_Still,
    STATUS_STONE,     ANIM_ChainChomp_Still,
    STATUS_SLEEP,     ANIM_ChainChomp_Sleep,
    STATUS_STATIC,    ANIM_ChainChomp_Still,
...
s32 N(BiteAnims)[] = {
    STATUS_NORMAL,    ANIM_ChainChomp_Bite,
    STATUS_POISON,    ANIM_ChainChomp_Bite,
    STATUS_STOP,      ANIM_ChainChomp_Still,
    STATUS_STONE,     ANIM_ChainChomp_Still,
    STATUS_SLEEP,     ANIM_ChainChomp_Sleep,
    STATUS_STATIC,    ANIM_ChainChomp_Still,
...
s32 N(SlowBiteAnims)[] = {
    STATUS_NORMAL,    ANIM_ChainChomp_SlowBite,
    STATUS_POISON,    ANIM_ChainChomp_SlowBite,
    STATUS_STOP,      ANIM_ChainChomp_Still,
    STATUS_STONE,     ANIM_ChainChomp_Still,
    STATUS_SLEEP,     ANIM_ChainChomp_Sleep,
    STATUS_STATIC,    ANIM_ChainChomp_Still,
...
s32 N(ChainAnims)[] = {
    STATUS_NORMAL,    ANIM_ChainChomp_Chain,
    STATUS_END,
};
...
EvtScript N(EVS_Chomp_SpinSmashHit) = {
    ...
    EVT_END_IF
    EVT_LABEL(0)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ChainChomp_Hurt)
...
EvtScript N(EVS_TakeTurn) = {
    ...
    EVT_THREAD
        ...
        EVT_END_IF
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ChainChomp_SlowBite)
    EVT_WAIT(15)
    ...
    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_CALL(SetPartPos, ACTOR_SELF, 2, LVar0, LVar1, LVar2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LVarF, 0, 0, 0, DMG_CHOMP_BITE, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LVarF)
        EVT_CASE_DEFAULT
            EVT_CALL(UseBattleCamPreset, BTL_CAM_DEFAULT)
            EVT_CALL(MoveBattleCamOver, 20)
