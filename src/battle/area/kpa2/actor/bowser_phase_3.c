...
EvtScript N(init) = {
    ...
    EVT_CALL(SetPartEventBits, ACTOR_SELF, 1, ACTOR_EVENT_FLAG_GIANT_BOWSER_ENCHANTED, TRUE)
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_PEACH_BEAM)
            ...
            EVT_CALL(SetPartEventBits, ACTOR_SELF, 1, ACTOR_EVENT_FLAG_GIANT_BOWSER_ENCHANTED, FALSE)
            EVT_CALL(SetActorVar, ACTOR_SELF, N(VAR_TURNS_SINCE_LAST_STAR_BEAM), 0)
...
EvtScript N(doTakeTurn) = {
    ...
    EVT_IF_GT(LVar0, 1)
        ...
        EVT_IF_NOT_FLAG(LVar0, ACTOR_EVENT_FLAG_GIANT_BOWSER_ENCHANTED)
...
EvtScript N(attackHeavyJump) = {
    ...
    EVT_IF_FLAG(LVar1, ACTOR_EVENT_FLAG_GIANT_BOWSER_ENCHANTED)
        EVT_SET(LVar0, 16)
    EVT_ELSE
        EVT_SET(LVar0, 8)
    EVT_END_IF
...
EvtScript N(attackClawSwipe) = {
    ...
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetPartEventFlags, ACTOR_SELF, 1, LVar0)
    EVT_IF_FLAG(LVar0, ACTOR_EVENT_FLAG_GIANT_BOWSER_ENCHANTED)
        EVT_SET(LVar0, 16)
...
EvtScript N(attackFlameBreath) = {
    ...
    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_IF_FLAG(LVar3, ACTOR_EVENT_FLAG_GIANT_BOWSER_ENCHANTED)
    ...
    EVT_IF_FLAG(LVar6, ACTOR_EVENT_FLAG_GIANT_BOWSER_ENCHANTED)
