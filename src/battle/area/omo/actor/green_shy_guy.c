...
s32 N(IdleAnimations_8021FF1C)[] = {
    STATUS_KEY_NORMAL,    ANIM_ShyGuy_Green_Anim01,
    STATUS_KEY_STONE,     ANIM_ShyGuy_Green_Anim00,
    STATUS_KEY_SLEEP,     ANIM_ShyGuy_Green_Anim12,
    STATUS_KEY_POISON,    ANIM_ShyGuy_Green_Anim01,
    STATUS_KEY_STOP,      ANIM_ShyGuy_Green_Anim00,
    STATUS_KEY_STATIC,    ANIM_ShyGuy_Green_Anim01,
    STATUS_KEY_PARALYZE,  ANIM_ShyGuy_Green_Anim00,
    STATUS_KEY_DIZZY,     ANIM_ShyGuy_Green_Anim13,
    STATUS_KEY_FEAR,      ANIM_ShyGuy_Green_Anim13,
    STATUS_END,
};
...
EvtScript N(80220604) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim04)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim05)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
...
EvtScript N(80220D2C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                EVT_WAIT(12)
                EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim0A)
            EVT_END_THREAD
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_NO_DAMAGE)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim09)
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim07)
            EVT_WAIT(15)
            EVT_GOTO(2)
            EVT_LABEL(1)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim10)
            EVT_WAIT(10)
            EVT_CALL(PlaySoundAtActor, ACTOR_SELF, SOUND_20C3)
            EVT_CALL(AddActorDecoration, ACTOR_SELF, PRT_MAIN, 0, ACTOR_DECORATION_SWEAT)
            EVT_CALL(RandInt, 100, LVar0)
            EVT_IF_LT(LVar0, 50)
                EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim11)
            EVT_ELSE
                EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_ShyGuy_Green_Anim13)
            EVT_END_IF
            EVT_WAIT(25)
            EVT_CALL(RemoveActorDecoration, ACTOR_SELF, PRT_MAIN, 0)
            EVT_CALL(SetActorYaw, ACTOR_SELF, 180)
