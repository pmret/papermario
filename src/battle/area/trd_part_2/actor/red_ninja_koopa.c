...
s32 N(IdleAnimations_80228610)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Red_Anim04,
    STATUS_STONE,     ANIM_KoopaBros_Red_Anim00,
    STATUS_SLEEP,     ANIM_KoopaBros_Red_Anim15,
    STATUS_POISON,    ANIM_KoopaBros_Red_Anim00,
    STATUS_STOP,      ANIM_KoopaBros_Red_Anim00,
    STATUS_STATIC,    ANIM_KoopaBros_Red_Anim00,
    STATUS_PARALYZE,  ANIM_KoopaBros_Red_Anim00,
    STATUS_PARALYZE,  ANIM_KoopaBros_Red_Anim00,
    STATUS_DIZZY,     ANIM_KoopaBros_Red_Anim18,
    STATUS_DIZZY,     ANIM_KoopaBros_Red_Anim18,
    STATUS_END,
};

s32 N(IdleAnimations_80228664)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Red_Anim05,
    STATUS_STONE,     ANIM_KoopaBros_Red_Anim01,
    STATUS_POISON,    ANIM_KoopaBros_Red_Anim01,
    STATUS_STOP,      ANIM_KoopaBros_Red_Anim01,
    STATUS_STATIC,    ANIM_KoopaBros_Red_Anim01,
    STATUS_PARALYZE,  ANIM_KoopaBros_Red_Anim01,
    STATUS_PARALYZE,  ANIM_KoopaBros_Red_Anim01,
    STATUS_END,
};

s32 N(IdleAnimations_802286A0)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Red_Anim0D,
    STATUS_STONE,     ANIM_KoopaBros_Red_Anim01,
    STATUS_POISON,    ANIM_KoopaBros_Red_Anim01,
    STATUS_STOP,      ANIM_KoopaBros_Red_Anim01,
    STATUS_STATIC,    ANIM_KoopaBros_Red_Anim01,
...
s32 N(IdleAnimations_802286DC)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Red_Anim0C,
    STATUS_STONE,     ANIM_KoopaBros_Red_Anim17,
    STATUS_SLEEP,     ANIM_KoopaBros_Red_Anim17,
    STATUS_POISON,    ANIM_KoopaBros_Red_Anim17,
    STATUS_STOP,      ANIM_KoopaBros_Red_Anim17,
    STATUS_STATIC,    ANIM_KoopaBros_Red_Anim17,
    STATUS_PARALYZE,  ANIM_KoopaBros_Red_Anim17,
    STATUS_PARALYZE,  ANIM_KoopaBros_Red_Anim17,
    STATUS_DIZZY,     ANIM_KoopaBros_Red_Anim22,
    STATUS_DIZZY,     ANIM_KoopaBros_Red_Anim22,
    STATUS_END,
};

s32 N(IdleAnimations_80228730)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Red_Anim0A,
    STATUS_END,
};
...
EvtScript N(80228748) = {
    ...
    EVT_SWITCH(LVarA)
        EVT_CASE_EQ(0)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim04)
                EVT_CASE_OR_EQ(4)
                EVT_CASE_OR_EQ(5)
                EVT_CASE_OR_EQ(6)
                    EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_PTR(N(IdleAnimations_80228664)))
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim05)
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
        EVT_CASE_EQ(1)
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LVar0)
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim0D)
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
        EVT_CASE_EQ(2)
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LVar0)
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_ELSE
                        ...
                        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim0A)
                    EVT_END_IF
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
        EVT_CASE_EQ(3)
        ...
        EVT_CASE_EQ(4)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim09)
                EVT_CASE_OR_EQ(4)
                EVT_CASE_OR_EQ(5)
                EVT_CASE_OR_EQ(6)
                    EVT_SET_CONST(LVar0, 1)
                    ...
                    EVT_EXEC_WAIT(DoImmune)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim20)
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
            EVT_WAIT(15)
        EVT_CASE_EQ(5)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_IF_EQ(LocalFlag(0), 1)
                        ...
                        EVT_END_THREAD
                    EVT_END_IF
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim0C)
        ...
        EVT_CASE_EQ(6)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_CALL(N(UnkEnemyPosFunc), LVar0, LVar1, LVar2)
                    EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim0E)
                    EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_PTR(N(IdleAnimations_80228730)))
                    EVT_CALL(JumpToGoal, ACTOR_SELF, 20, FALSE, TRUE, FALSE)
                    EVT_IF_EQ(LocalFlag(0), 1)
                        EVT_CALL(N(StartRumbleWithParams), 256, 5)
        ...
        EVT_CASE_EQ(7)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim08)
                    EVT_WAIT(10)
                    ...
                    EVT_END_SWITCH
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim07)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim1B)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_SUB(LVar0, 22)
                    EVT_ADD(LVar1, 19)
                ...
                EVT_CASE_OR_EQ(5)
                EVT_CASE_OR_EQ(6)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim1F)
                    EVT_WAIT(10)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim07)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(N(UnkWhirlwindEffectFunc), LVar0, LVar1, LVar2, 60)
        ...
        EVT_CASE_EQ(8)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    ...
                    EVT_SET(LVar2, 15)
                    EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim03)
...
EvtScript N(handleEvent_8022ADE8) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_FLIP_TRIGGER)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LVar0)
            EVT_IF_EQ(LVar0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Red_Anim0B)
