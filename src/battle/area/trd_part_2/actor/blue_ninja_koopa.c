...
s32 N(DefaultAnims)[] = {
    ...
    STATUS_KEY_POISON,    ANIM_KoopaBros_Black_Anim00,
    STATUS_KEY_STOP,      ANIM_KoopaBros_Black_Anim00,
    STATUS_KEY_STATIC,    ANIM_KoopaBros_Black_Anim00,
    STATUS_KEY_PARALYZE,  ANIM_KoopaBros_Black_Anim00,
    STATUS_KEY_PARALYZE,  ANIM_KoopaBros_Black_Anim00,
    STATUS_KEY_DIZZY,     ANIM_KoopaBros_Black_Anim18,
    STATUS_KEY_DIZZY,     ANIM_KoopaBros_Black_Anim18,
    STATUS_END,
};
...
s32 N(TowerAnims)[] = {
    ...
    STATUS_KEY_STOP,      ANIM_KoopaBros_Black_Anim01,
    STATUS_KEY_STATIC,    ANIM_KoopaBros_Black_Anim01,
    STATUS_KEY_PARALYZE,  ANIM_KoopaBros_Black_Anim01,
    STATUS_KEY_PARALYZE,  ANIM_KoopaBros_Black_Anim01,
    STATUS_END,
};
...
s32 N(ToppledAnims)[] = {
    ...
    STATUS_KEY_POISON,    ANIM_KoopaBros_Black_Anim17,
    STATUS_KEY_STOP,      ANIM_KoopaBros_Black_Anim17,
    STATUS_KEY_STATIC,    ANIM_KoopaBros_Black_Anim17,
    STATUS_KEY_PARALYZE,  ANIM_KoopaBros_Black_Anim17,
    STATUS_KEY_PARALYZE,  ANIM_KoopaBros_Black_Anim17,
    STATUS_KEY_DIZZY,     ANIM_KoopaBros_Black_Anim22,
    STATUS_KEY_DIZZY,     ANIM_KoopaBros_Black_Anim22,
    STATUS_END,
};

s32 N(IdleAnimations_8022B6D0)[] = {
    STATUS_KEY_NORMAL,    ANIM_KoopaBros_Black_Anim0A,
    STATUS_END,
};
...
EvtScript N(8022B6E8) = {
    ...
    EVT_SWITCH(LVarA)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_ELSE
                        ...
                        EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim0A)
                    EVT_END_IF
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
        EVT_CASE_EQ(3)
        ...
        EVT_CASE_EQ(4)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim09)
                EVT_CASE_OR_EQ(4)
                EVT_CASE_OR_EQ(5)
                EVT_CASE_OR_EQ(6)
                    EVT_SET_CONST(LVar0, 1)
                    ...
                    EVT_EXEC_WAIT(EVS_Enemy_NoDamageHit)
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim20)
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
            EVT_WAIT(15)
        EVT_CASE_EQ(5)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_CALL(SetIdleAnimations, ACTOR_SELF, PRT_MAIN, EVT_PTR(N(IdleAnimations_8022B6DC)))
        ...
        EVT_CASE_EQ(6)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_CALL(N(UnkEnemyPosFunc), LVar0, LVar1, LVar2)
                    EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim0E)
                    EVT_CALL(SetIdleAnimations, ACTOR_SELF, PRT_MAIN, EVT_PTR(N(IdleAnimations_8022B6D0)))
                    EVT_CALL(JumpToGoal, ACTOR_SELF, 20, FALSE, TRUE, FALSE)
                    EVT_IF_EQ(LocalFlag(0), 1)
                        EVT_CALL(N(StartRumbleWithParams), 256, 5)
        ...
        EVT_CASE_EQ(7)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim08)
                    EVT_WAIT(10)
                    ...
                    EVT_END_SWITCH
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim07)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim1B)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_SUB(LVar0, 22)
                    EVT_ADD(LVar1, 19)
                ...
                EVT_CASE_OR_EQ(5)
                EVT_CASE_OR_EQ(6)
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim1F)
                    EVT_WAIT(10)
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim07)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(N(UnkWhirlwindEffectFunc), LVar0, LVar1, LVar2, 60)
        ...
        EVT_CASE_EQ(8)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    ...
                    EVT_SET(LVar2, 15)
                    EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim03)
...
EvtScript N(EVS_HandleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_FLIP_TRIGGER)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LVar0)
            EVT_IF_EQ(LVar0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KoopaBros_Black_Anim0B)
