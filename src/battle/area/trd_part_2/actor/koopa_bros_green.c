...
enum N(ThisBrosParams) {
    ...
    THIS_ANIM_TOWER_IDLE 		= ANIM_KoopaBros_Green_IdleTower,
    THIS_ANIM_TOWER_STILL 		= ANIM_KoopaBros_Green_StillTower,
    THIS_ANIM_TOPPLE_IDLE		= ANIM_KoopaBros_Green_IdleTopple,
    THIS_ANIM_TOPPLE_STILL		= ANIM_KoopaBros_Green_StillTopple,
    THIS_ANIM_TOPPLE_DIZZY		= ANIM_KoopaBros_Green_DizzyTopple,
    ...
    THIS_ANIM_ALT_ENTER_SHELL	= ANIM_KoopaBros_Green_AltEnterShell,
    THIS_ANIM_ALT_EXIT_SHELL 	= ANIM_KoopaBros_Green_AltExitShell,
