...
Formation N(Formation_04) = {
    ACTOR_BY_POS(N(swoopula), N(pos_swoopula_3)[0], 10, 0xFFFFFFFF),
    ACTOR_BY_POS(N(swoopula), N(pos_swoopula_3)[1], 9, 0xFFFFFFFF),
    ACTOR_BY_POS(N(swoopula), N(pos_swoopula_3)[2], 8, 0xFFFFFFFF),
