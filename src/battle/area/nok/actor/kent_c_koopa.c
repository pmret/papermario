...
EvtScript N(EVS_Attack_HeavyStomp) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Anim01)
    EVT_WAIT(8)
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, SOUND_03E7)
...
EvtScript N(EVS_DropDummyCoin) = {
    EVT_CALL(PlaySoundAtPart, ACTOR_SELF, LVar5, SOUND_0212)
    ...
    EVT_END_LOOP
    // give coin to player
    EVT_CALL(PlaySoundAtPart, ACTOR_SELF, LVar5, SOUND_0211)
    EVT_CALL(AddCoin, 1)
    EVT_RETURN
    EVT_END
};
