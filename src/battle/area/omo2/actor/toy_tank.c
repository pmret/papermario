    ...
    Switch(LVar1)
        CaseEq(DMG_SRC_ELECTRO_DASH)
            IfNotFlag(LVar0, AVAR_GeneralFlag_ComplainElectric)
                ...
                Wait(20)
                Call(ActorSpeak, MSG_CH4_0072, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Hurt, ANIM_GeneralGuy_Hurt)
        ...
        CaseOrEq(DMG_SRC_D_DOWN_JUMP)
            IfNotFlag(LVar0, AVAR_GeneralFlag_ComplainUnfair)
                ...
                Call(MoveBattleCamOver, 20)
                Wait(20)
                Call(ActorSpeak, MSG_CH4_0073, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Hurt, ANIM_GeneralGuy_Hurt)
                Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
                Call(MoveBattleCamOver, 30)
            EndIf
        EndCaseGroup
        CaseDefault
            IfNotFlag(LVar0, AVAR_GeneralFlag_ComplainGeneric)
                ...
                Call(MoveBattleCamOver, 20)
                Wait(20)
                Call(ActorSpeak, MSG_CH4_0074, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Hurt, ANIM_GeneralGuy_Hurt)
                Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
                Call(MoveBattleCamOver, 30)
            EndIf
    EndSwitch
...
EvtScript N(EVS_BeginWave_StiltGuys) = {
    ...
    IfNotFlag(LVar0, AVAR_GeneralFlag_SquadFled)
        Call(ActorSpeak, MSG_CH4_0069, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Still, ANIM_GeneralGuy_Still)
    ...
    Call(SetAnimation, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Shock)
    Wait(16)
...
EvtScript N(EVS_BeginWave_ShyStacks) = {
    ...
    Call(GetActorVar, ACTOR_GENERAL, AVAR_General_WavesDefeated, LVar0)
    IfEq(LVar0, 2)
        Call(ActorSpeak, MSG_CH4_006E, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Talk, ANIM_GeneralGuy_Idle)
    Else
    EndIf
    Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
    Call(MoveBattleCamOver, 30)
    ...
    Call(MoveBattleCamOver, 40)
    Wait(40)
    Call(ActorSpeak, MSG_CH4_006F, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Talk, ANIM_GeneralGuy_Idle)
    Thread
...
EvtScript N(EVS_SummonStiltGuys) = {
    ...
    Call(GetActorVar, ACTOR_GENERAL, AVAR_General_WavesDefeated, LVar0)
    IfEq(LVar0, 1)
        Call(ActorSpeak, MSG_CH4_006B, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Talk, ANIM_GeneralGuy_Idle)
    Else
    EndIf
    Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
    Call(MoveBattleCamOver, 30)
    ...
    Call(MoveBattleCamOver, 40)
    Wait(40)
    Call(ActorSpeak, MSG_CH4_006C, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Talk, ANIM_GeneralGuy_Idle)
    Thread
        Call(GetActorPos, ACTOR_WAVE_A, LVar0, LVar1, LVar2)
        Call(SetActorJumpGravity, ACTOR_WAVE_A, Float(1.5))
        Call(SetGoalPos, ACTOR_WAVE_A, LVar0, LVar1, LVar2)
...
EvtScript N(EVS_BeginWave_ShySquadRedux) = {
    ...
    Loop(15)
        ...
        Switch(LVar1)
            CaseEq(0)
                Set(LVar1, ANIM_TankGuy_Hiding)
            CaseEq(1)
                Set(LVar1, ANIM_TankGuy_LookDown)
            CaseEq(2)
                Set(LVar1, ANIM_TankGuy_LookUp)
            CaseDefault
                Set(LVar1, ANIM_TankGuy_Salute)
        EndSwitch
    ...
    Set(LVar0, 2)
    Loop(15)
        Call(SetAnimation, ACTOR_WAVE_A, LVar0, ANIM_TankGuy_Idle)
        Add(LVar0, 1)
    EndLoop
    Call(FreezeBattleState, false)
    Return
...
EvtScript N(EVS_BeginWave_Tank) = {
    ...
    Wait(60)
    Call(ActorSpeak, MSG_CH4_0071, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Still, ANIM_GeneralGuy_Still)
    Call(SetAnimation, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Hurt)
    Call(EndActorSpeech, ACTOR_GENERAL, PRT_MAIN, -1, -1)
...
EvtScript N(EVS_Death) = {
    ...
    Call(SetAnimation, ACTOR_GENERAL, PRT_MAIN, ANIM_GeneralGuy_Fallen)
