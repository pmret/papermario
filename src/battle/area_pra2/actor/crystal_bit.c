...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_CALL(GetAnimation, ACTOR_SELF, 1, LocalVar(1))
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_CALL(GetOwnerID, LocalVar(0))
            EVT_CALL(GetActorVar, ACTOR_ENEMY0, 4, LocalVar(3))
            EVT_IF_EQ(LocalVar(0), LocalVar(3))
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_crystal_king_Palette_00_Anim_22)
                EVT_SET_CONST(LocalVar(2), -1)
            EVT_END_IF
            EVT_CALL(GetActorVar, ACTOR_ENEMY0, 5, LocalVar(3))
            EVT_IF_EQ(LocalVar(0), LocalVar(3))
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_crystal_king_Palette_00_Anim_23)
                EVT_SET_CONST(LocalVar(2), -1)
            EVT_END_IF
            EVT_CALL(GetActorVar, ACTOR_ENEMY0, 6, LocalVar(3))
            EVT_IF_EQ(LocalVar(0), LocalVar(3))
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_crystal_king_Palette_00_Anim_24)
                EVT_SET_CONST(LocalVar(2), -1)
            EVT_END_IF
        ...
        EVT_CASE_EQ(EVENT_DEATH)
            ...
            EVT_CALL(SetGoalPos, ACTOR_SELF, LocalVar(1), 0, LocalVar(3))
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
            EVT_CALL(GetOwnerID, LocalVar(0))
            EVT_CALL(GetActorVar, ACTOR_ENEMY0, 4, LocalVar(1))
            EVT_IF_EQ(LocalVar(0), LocalVar(1))
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_crystal_king_Palette_00_Anim_5)
            EVT_END_IF
            EVT_CALL(GetActorVar, ACTOR_ENEMY0, 5, LocalVar(1))
            EVT_IF_EQ(LocalVar(0), LocalVar(1))
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_crystal_king_Palette_00_Anim_6)
            EVT_END_IF
            EVT_CALL(GetActorVar, ACTOR_ENEMY0, 6, LocalVar(1))
            EVT_IF_EQ(LocalVar(0), LocalVar(1))
            ...
            EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(1), LocalVar(2), LocalVar(3))
            EVT_CALL(AddVectorPolar, LocalVar(1), LocalVar(3), EVT_FLOAT(30.0), LocalVar(0))
            EVT_CALL(SetGoalPos, ACTOR_SELF, LocalVar(1), 0, LocalVar(3))
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
