...
EvtScript N(idle) = {
    ...
    EVT_IF_FLAG(LocalVar(0), N(FLAG_HAS_CLONES))
        ...
        EVT_IF_EQ(LocalVar(3), TRUE)
            EVT_CALL(N(UnkFloatFunc), LVarF, LocalVar(4), EVT_FLOAT(128.0), EVT_FLOAT(254.0), 20, 0, 0)
...
EvtScript N(FlyWithClones) = {
    ...
    EVT_IF_NOT_FLAG(LocalVar(0), N(FLAG_NOT_IDLE))
        ...
        EVT_SET(LocalVar(4), 41)
        EVT_ADD(LocalVar(4), LVarE)
        EVT_CALL(SetActorPos, LocalVar(2), LocalVar(3), LocalVar(4), LocalVar(5))
        EVT_CALL(N(UnkFloatFunc), LVarF, LocalVar(0), EVT_FLOAT(0.0), EVT_FLOAT(5.0), 30, 0, 0)
        EVT_SET(LVarA, LVarB)
        EVT_SET(LVarB, LVarC)
        EVT_SET(LVarC, LVarD)
        EVT_SET(LVarD, LVarE)
        EVT_SET(LVarE, LocalVar(0))
        EVT_ADD(LVarF, 1)
        EVT_IF_GT(LVarF, 60)
            EVT_SET(LVarF, 0)
        EVT_END_IF
...
EvtScript N(OnHit) = {
    ...
    EVT_CALL(ActorExists, LocalVar(9), LVarA)
...
EvtScript N(OnDeath) = {
    ...
    EVT_END_IF
    EVT_CALL(GetActorVar, ACTOR_SELF, N(VAR_FLY_THREAD_ID), LVarA)
    EVT_IS_THREAD_RUNNING(LVarA, LocalVar(0))
                    ...
                    EVT_CASE_OR_EQ(N(PHASE_ATTACKED_WITH_CLONES))
                        ...
                        EVT_LOOP(30)
                            ...
                            EVT_IF_EQ(LVarB, TRUE)
                                EVT_CALL(SetPartScale, LVarA, 1, LocalVar(0), LocalVar(0), LocalVar(0))
                            EVT_END_IF
...
EvtScript N(MakeIllusions) = {
    ...
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(GetActorVar, ACTOR_SELF, N(VAR_CLONE1_ID), LVarA)
    EVT_CALL(SetActorPos, LVarA, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(GetActorVar, ACTOR_SELF, N(VAR_CLONE2_ID), LVarA)
    EVT_CALL(SetActorPos, LVarA, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_WAIT(1)
    ...
    EVT_END_SWITCH
    EVT_CALL(SetActorFlagBits, LVarA, ACTOR_FLAG_NO_SHADOW, 0)
    EVT_CALL(SetActorFlagBits, LVarB, ACTOR_FLAG_NO_SHADOW, 0)
    EVT_CALL(SetActorFlagBits, LVarC, ACTOR_FLAG_NO_SHADOW, 0)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    ...
    EVT_THREAD
        ...
        EVT_LOOP(60)
            EVT_ADDF(LocalVar(0), LocalVar(3))
            EVT_ADDF(LocalVar(2), LocalVar(5))
            EVT_CALL(SetActorPos, LVarB, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_WAIT(1)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(GetActorPos, LVarC, LocalVar(0), LocalVar(1), LocalVar(2))
        ...
        EVT_LOOP(60)
            EVT_ADDF(LocalVar(0), LocalVar(3))
            EVT_ADDF(LocalVar(2), LocalVar(5))
            EVT_CALL(SetActorPos, LVarC, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_WAIT(1)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_WAIT(90)
    ...
    EVT_CALL(GetActorPos, LVarA, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(ForceHomePos, LVarA, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(CrystalBitAppear) = {
    ...
    EVT_SUBF(LocalVar(2), LVarB)
    EVT_DIVF(LocalVar(2), EVT_FLOAT(120.0))
    EVT_SETF(ArrayVar(4), LocalVar(2))
    EVT_SETF(LocalVar(6), LVarB)
    EVT_CALL(GetActorPos, ACTOR_SELF, LVarA, LVarB, LVarC)
    EVT_CALL(GetDist2D, LVarD, LVarA, LVarC, LocalVar(1), LocalVar(3))
    EVT_DIVF(LVarD, EVT_FLOAT(120.0))
    EVT_SETF(ArrayVar(5), LVarD)
    EVT_CALL(GetActorPos, ACTOR_SELF, LVarA, LVarB, LVarC)
    EVT_CALL(func_802183A4_660AF4, ArrayVar(6), LVarA, LVarC, LocalVar(1), LocalVar(3))
...
EvtScript N(AttackIcyBreathWithClones) = {
    ...
    EVT_CALL(MoveBattleCamOver, 15)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_crystal_king_Palette_00_Anim_13)
    EVT_CALL(SetAnimation, LVarA, 1, NPC_ANIM_crystal_king_Palette_00_Anim_13)
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_crystal_king_Palette_00_Anim_13)
    EVT_WAIT(10)
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, SOUND_206D)
    ...
    EVT_CALL(MoveBattleCamOver, 20)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_crystal_king_Palette_00_Anim_1C)
    EVT_CALL(SetAnimation, LVarA, 1, NPC_ANIM_crystal_king_Palette_00_Anim_1C)
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_crystal_king_Palette_00_Anim_1C)
    EVT_WAIT(3)
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, SOUND_35D)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), 0, 0, 1, BS_FLAGS1_10)
    EVT_SWITCH(LocalVar(0))
    ...
    EVT_CALL(StopSound, SOUND_35D)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_crystal_king_Palette_00_Anim_15)
    EVT_CALL(SetAnimation, LVarA, 1, NPC_ANIM_crystal_king_Palette_00_Anim_15)
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_crystal_king_Palette_00_Anim_15)
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_ICE | DAMAGE_TYPE_NO_CONTACT, 0, 0, 8, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
...
EvtScript N(MoveBitToTarget) = {
    ...
    EVT_END_IF
    EVT_CALL(func_8021848C_660BDC, LVarB, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_CALL(LoadPath, 30, LVarB, 3, 1)
    EVT_LABEL(0)
    EVT_CALL(GetNextPathPos)
    EVT_CALL(SetActorPos, LVarA, LocalVar(1), LocalVar(2), LocalVar(3))
    EVT_WAIT(1)
    EVT_IF_EQ(LocalVar(0), 1)
        EVT_GOTO(0)
    EVT_END_IF
    EVT_CALL(SetPartFlagBits, LVarA, 1, ACTOR_PART_FLAG_INVISIBLE, 1)
    EVT_CALL(SetActorFlagBits, LVarA, ACTOR_FLAG_NO_SHADOW, 1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(RemoveCrystalBit) = {
    ...
    EVT_SET(LVarA, LocalVar(0))
    EVT_CALL(SetPartFlagBits, LVarA, 1, ACTOR_PART_FLAG_INVISIBLE, 0)
    EVT_CALL(SetActorFlagBits, LVarA, ACTOR_FLAG_NO_SHADOW, 0)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(AddGoalPos, ACTOR_SELF, -150, 0, 0)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(GetActorPos, LVarA, LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_THREAD
    ...
    EVT_CALL(SetGoalPos, LVarA, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(FlyToGoal, LVarA, 0, 0, 0)
...
EvtScript N(AttackWithCrystalBit) = {
    ...
    EVT_CALL(GetActorPos, LVarA, LocalVar(1), LocalVar(2), LocalVar(3))
    EVT_SUB(LocalVar(1), 100)
    EVT_CALL(RandInt, 50, LocalVar(4))
    EVT_ADD(LocalVar(2), LocalVar(4))
    EVT_CALL(SetGoalPos, LVarA, LocalVar(1), LocalVar(2), LocalVar(3))
...
EvtScript N(Heal) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(N(PHASE_ATTACKED_WITH_CLONES))
            EVT_CALL(GetActorVar, ACTOR_SELF, N(VAR_CLONE1_ID), LVarA)
            EVT_CALL(GetActorVar, ACTOR_SELF, N(VAR_CLONE2_ID), LVarB)
            EVT_CALL(ActorExists, LVarA, LocalVar(0))
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_crystal_king_Palette_00_Anim_1D)
    EVT_IF_EQ(LocalFlag(0), 1)
        EVT_CALL(SetAnimation, LVarA, 1, NPC_ANIM_crystal_king_Palette_00_Anim_1D)
        EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_crystal_king_Palette_00_Anim_1D)
    EVT_END_IF
    EVT_WAIT(20)
    EVT_THREAD
        EVT_WAIT(5)
    ...
    EVT_ELSE
        ...
        EVT_THREAD
            ...
            EVT_CALL(func_8026BF48, 0)
        EVT_END_THREAD
        EVT_CALL(SetAnimation, LVarA, 1, NPC_ANIM_crystal_king_Palette_00_Anim_9)
        EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_crystal_king_Palette_00_Anim_9)
    EVT_END_IF
