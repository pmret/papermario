...
EvtScript N(handleEvent_8021D8C4) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(10)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_bros_Palette_01_Anim_9)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_bros_Palette_01_Anim_E)
            EVT_SET_CONST(LVar2, NPC_ANIM_goomba_bros_Palette_01_Anim_F)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_bros_Palette_01_Anim_F)
        ...
        EVT_CASE_OR_EQ(31)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_bros_Palette_01_Anim_2)
        ...
        EVT_CASE_EQ(57)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, NPC_ANIM_goomba_bros_Palette_01_Anim_6)
            EVT_SET_CONST(LVar2, NPC_ANIM_goomba_bros_Palette_01_Anim_9)
