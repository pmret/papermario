...
EvtScript N(shakeTree) = {
    ...
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(6), LocalVar(15), LocalVar(8))
...
EvtScript N(shake_goomnut_tree) = {
    EVT_SET(LocalVar(0), EVT_ADDR(N(tree)))
...
EvtScript N(80223DBC) = {
    ...
    EVT_CALL(SetPartJumpGravity, -127, 2, EVT_FLOAT(0.8))
    EVT_CALL(SetPartMoveSpeed, -127, 2, EVT_FLOAT(4.0))
    EVT_CALL(GetStatusFlags, ACTOR_ENEMY0, LocalVar(0))
    ...
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), ((DAMAGE_TYPE_IGNORE_DEFENSE)), 0, 0, 3, 32)
    EVT_CALL(ActorExists, 513, LocalVar(0))
    EVT_IF_EQ(LocalVar(0), 0)
        EVT_CALL(GetPartOffset, -127, 2, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(0), 65)
        EVT_SET(LocalVar(1), 20)
        EVT_CALL(SetPartJumpGravity, -127, 2, EVT_FLOAT(0.7))
        EVT_CALL(JumpPartTo, -127, 2, LocalVar(0), LocalVar(1), LocalVar(2), 20, 1)
        EVT_ADD(LocalVar(0), 12)
        EVT_CALL(JumpPartTo, -127, 2, LocalVar(0), LocalVar(1), LocalVar(2), 8, 1)
        EVT_LOOP(20)
            EVT_CALL(SetPartFlagBits, -127, 2, 1, 0)
            EVT_WAIT(1)
            EVT_CALL(SetPartFlagBits, -127, 2, 1, 1)
    ...
    EVT_CALL(GetStatusFlags, ACTOR_ENEMY1, LocalVar(3))
    ...
    EVT_CALL(GetStatusFlags, ACTOR_ENEMY2, LocalVar(3))
    EVT_IF_NOT_FLAG(LocalVar(3), 0x80000)
        EVT_ADD(LocalVar(1), 50)
    EVT_ELSE
        EVT_ADD(LocalVar(1), 20)
