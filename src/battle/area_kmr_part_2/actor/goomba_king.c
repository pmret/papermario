...
s32 N(idleAnimations_80220800)[] = {
    STATUS_NORMAL,    ANIM_GoombaKing_Anim01,
    STATUS_STONE,     ANIM_GoombaKing_Anim00,
    STATUS_SLEEP,     ANIM_GoombaKing_Anim08,
    STATUS_POISON,    ANIM_GoombaKing_Anim00,
    STATUS_STOP,      ANIM_GoombaKing_Anim00,
    STATUS_STATIC,    ANIM_GoombaKing_Anim00,
    STATUS_PARALYZE,  ANIM_GoombaKing_Anim00,
    STATUS_DIZZY,     ANIM_GoombaKing_Anim07,
    STATUS_END,
};

s32 N(idleAnimations_80220844)[] = {
    STATUS_NORMAL,    ANIM_GoombaKing_Anim04,
    STATUS_STONE,     ANIM_GoombaKing_Anim00,
    STATUS_SLEEP,     ANIM_GoombaKing_Anim08,
    STATUS_POISON,    ANIM_GoombaKing_Anim00,
    STATUS_STOP,      ANIM_GoombaKing_Anim00,
...
s32 N(idleAnimations_80220888)[] = {
    STATUS_NORMAL,   ANIM_GoombaKing_Anim07,
    STATUS_STONE,    ANIM_GoombaKing_Anim00,
    STATUS_SLEEP,    ANIM_GoombaKing_Anim08,
    STATUS_POISON,   ANIM_GoombaKing_Anim00,
    STATUS_STOP,     ANIM_GoombaKing_Anim00,
...
s32 N(idleAnimations_802208CC)[] = {
    STATUS_NORMAL,   ANIM_GoombaKing_Anim09,
    STATUS_STONE,    ANIM_GoombaKing_Anim00,
    STATUS_SLEEP,    ANIM_GoombaKing_Anim08,
    STATUS_POISON,   ANIM_GoombaKing_Anim00,
    STATUS_STOP,     ANIM_GoombaKing_Anim00,
...
EvtScript N(handleEvent_80220F34) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(9)
            ...
            EVT_SET_CONST(LVar1, ANIM_GoombaKing_Anim06)
        ...
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_GoombaKing_Anim0D)
            EVT_SET_CONST(LVar2, ANIM_GoombaKing_Anim0E)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_GoombaKing_Anim04)
        ...
        EVT_CASE_OR_EQ(25)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_GoombaKing_Anim01)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_KILL_THREAD(LVar0)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_GoombaKing_Anim0E)
            EVT_EXEC_WAIT(N(doDeath_80222F50))
            EVT_RETURN
        EVT_CASE_EQ(33)
            EVT_SET_CONST(LVar0, 0x00000001)
            ...
            EVT_RETURN
        EVT_CASE_EQ(42)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GoombaKing_Anim06)
            EVT_WAIT(20)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GoombaKing_Anim04)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GoombaKing_Anim01)
        EVT_CASE_EQ(53)
            EVT_SET_CONST(LVar0, 0x00000001)
            EVT_SET_CONST(LVar1, ANIM_GoombaKing_Anim01)
            EVT_EXEC_WAIT(DoReturnHome)
...
EvtScript N(80221680) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20ED)
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GoombaKing_Anim05)
    EVT_SET(LVar0, 0)
    EVT_LOOP(20)
        EVT_ADD(LVar0, 18)
    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_END_IF
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GoombaKing_Anim07)
            EVT_SET(LVar0, 0)
            EVT_LOOP(20)
                EVT_ADD(LVar0, 18)
                EVT_CALL(SetActorYaw, ACTOR_SELF, LVar0)
...
EvtScript N(80221CD4) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GoombaKing_Anim09)
    ...
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 30)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GoombaKing_Anim00)
    EVT_THREAD
