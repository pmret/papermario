...
EvtScript N(init_80220A38) = {
    ...
    EVT_EXEC_GET_TID(N(80222D9C), LocalVar(0))
...
EvtScript N(handleEvent_80220F34) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(9)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_goomba_king_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_goomba_king_Palette_00_Anim_D)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_goomba_king_Palette_00_Anim_E)
        ...
        EVT_CASE_EQ(47)
            ...
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_goomba_king_Palette_00_Anim_4)
        ...
        EVT_CASE_OR_EQ(25)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_goomba_king_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(36)
            ...
            EVT_KILL_THREAD(LocalVar(0))
            EVT_SET_CONST(LocalVar(0), 0x00000001)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_goomba_king_Palette_00_Anim_E)
            EVT_EXEC_WAIT(N(doDeath_80222F50))
            EVT_RETURN
        EVT_CASE_EQ(33)
            EVT_SET_CONST(LocalVar(0), 0x00000001)
...
EvtScript N(takeTurn_80221530) = {
    ...
    EVT_IF_NOT_FLAG(LocalVar(0), 0x80000)
        EVT_CALL(GetActorVar, 515, 6, LocalVar(0))
        EVT_IF_NE(LocalVar(0), 0)
            EVT_CALL(RandInt, 100, LocalVar(1))
            EVT_IF_LT(LocalVar(1), 60)
                EVT_SUB(LocalVar(0), 1)
                EVT_CALL(SetActorVar, 515, 6, LocalVar(0))
...
EvtScript N(80221680) = {
    ...
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(10), 0, 0, 0, 1, 32)
...
EvtScript N(80221CD4) = {
    ...
    EVT_SWITCH(LocalVar(10))
        ...
        EVT_CASE_OR_EQ(5)
            ...
            EVT_THREAD
                ...
                EVT_CALL(GetPartOffset, 515, 3, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_CALL(FallPartTo, 515, 3, LocalVar(0), 10, LocalVar(2), 14)
                EVT_SUB(LocalVar(0), 12)
                EVT_CALL(JumpPartTo, 515, 3, LocalVar(0), 10, LocalVar(2), 10, 1)
                EVT_SUB(LocalVar(0), 7)
                EVT_CALL(JumpPartTo, 515, 3, LocalVar(0), 10, LocalVar(2), 7, 1)
                EVT_LOOP(20)
            ...
            EVT_THREAD
                ...
                EVT_CALL(GetPartOffset, 515, 4, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_CALL(FallPartTo, 515, 4, LocalVar(0), 10, LocalVar(2), 15)
                EVT_SUB(LocalVar(0), 12)
                EVT_CALL(JumpPartTo, 515, 4, LocalVar(0), 10, LocalVar(2), 10, 1)
                EVT_SUB(LocalVar(0), 7)
                EVT_CALL(JumpPartTo, 515, 4, LocalVar(0), 10, LocalVar(2), 7, 1)
                EVT_LOOP(20)
            ...
            EVT_THREAD
                ...
                EVT_CALL(GetPartOffset, 515, 5, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_CALL(FallPartTo, 515, 5, LocalVar(0), 10, LocalVar(2), 17)
                EVT_ADD(LocalVar(0), 12)
                EVT_CALL(JumpPartTo, 515, 5, LocalVar(0), 10, LocalVar(2), 10, 1)
                EVT_ADD(LocalVar(0), 7)
                EVT_CALL(JumpPartTo, 515, 5, LocalVar(0), 10, LocalVar(2), 7, 1)
                EVT_LOOP(20)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetPartJumpGravity, 515, 3, EVT_FLOAT(1.5))
        EVT_CALL(GetPartOffset, 515, 3, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(FallPartTo, 515, 3, LocalVar(0), 35, LocalVar(2), 14)
        EVT_SUB(LocalVar(0), 12)
        EVT_CALL(JumpPartTo, 515, 3, LocalVar(0), 10, LocalVar(2), 10, 1)
        EVT_SUB(LocalVar(0), 7)
        EVT_CALL(JumpPartTo, 515, 3, LocalVar(0), 10, LocalVar(2), 7, 1)
...
EvtScript N(80222D9C) = {
    EVT_LABEL(0)
    EVT_WAIT(1)
    EVT_CALL(GetAnimation, -127, 1, LocalVar(0))
    EVT_IF_NE(LocalVar(0), 6488068)
        EVT_GOTO(0)
    EVT_END_IF
    EVT_CALL(GetAnimation, -127, 1, LocalVar(0))
    EVT_IF_NE(LocalVar(0), 6488068)
    ...
    EVT_CALL(func_8026DF88, -127, 1, LocalVar(0))
...
EvtScript N(doDeath_80222F50) = {
    ...
    EVT_WAIT(30)
    EVT_CALL(ActorExists, 513, LocalVar(0))
    EVT_IF_EQ(LocalVar(0), 1)
        EVT_CALL(GetActorHP, 513, LocalVar(0))
    EVT_END_IF
    EVT_IF_NE(LocalVar(0), 0)
        EVT_CALL(UseIdleAnimation, ACTOR_ENEMY1, FALSE)
        EVT_CALL(EnableIdleScript, ACTOR_ENEMY1, 0)
        ...
        EVT_CALL(UseIdleAnimation, ACTOR_ENEMY1, TRUE)
    EVT_END_IF
    EVT_CALL(ActorExists, 514, LocalVar(0))
    EVT_IF_EQ(LocalVar(0), 1)
        EVT_CALL(GetActorHP, 514, LocalVar(0))
    EVT_END_IF
    EVT_IF_NE(LocalVar(0), 0)
        EVT_CALL(UseIdleAnimation, ACTOR_ENEMY2, FALSE)
        EVT_CALL(EnableIdleScript, ACTOR_ENEMY2, 0)
