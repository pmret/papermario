...
EvtScript N(handleEvent_8021ACE8) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_E)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_CASE_EQ(EVENT_HIT)
            EVT_CALL(GetLastElement, LVarE)
            EVT_IF_FLAG(LVarE, DAMAGE_TYPE_ELECTRIC)
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_10)
                EVT_SET_CONST(LVar2, NPC_ANIM_bob_omb_Palette_00_Anim_11)
                EVT_EXEC_WAIT(DoBurnHit)
                EVT_EXEC_WAIT(N(8021AB54))
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_11)
                EVT_SET(LVar2, -12345)
        ...
        EVT_CASE_EQ(EVENT_UNKNOWN_TRIGGER)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_2)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_6)
            EVT_SET_CONST(LVar2, NPC_ANIM_bob_omb_Palette_00_Anim_E)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_1C)
...
EvtScript N(handleEvent_8021B4A8) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_F)
                EVT_EXEC_WAIT(DoNormalHit)
            EVT_END_IF
        EVT_CASE_EQ(EVENT_HIT)
            EVT_CALL(GetLastElement, LVarE)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_3)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_CALL(GetLastElement, LVarE)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_bob_omb_Palette_00_Anim_1D)
            EVT_EXEC_WAIT(DoAirLift)
        EVT_CASE_EQ(EVENT_BLOW_AWAY)
