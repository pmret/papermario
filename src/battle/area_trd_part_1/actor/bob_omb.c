...
EvtScript N(8021AB54) = {
    ...
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(2), 2)
    EVT_CALL(PlayEffect, EFFECT_SMOKE_RING, 0, LocalVar(0), LocalVar(1), LocalVar(2), 0, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_ADD(LocalVar(1), 20)
    EVT_ADD(LocalVar(2), 2)
    EVT_CALL(PlayEffect, EFFECT_EXPLOSION, 0, LocalVar(0), LocalVar(1), LocalVar(2), 0, 0, 0, 0, 0, 0, 0, 0, 0)
...
EvtScript N(handleEvent_8021ACE8) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_E)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_CASE_EQ(EVENT_HIT)
            EVT_CALL(GetLastElement, LocalVar(14))
            EVT_IF_FLAG(LocalVar(14), DAMAGE_TYPE_ELECTRIC)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_10)
                EVT_SET_CONST(LocalVar(2), NPC_ANIM_bob_omb_Palette_00_Anim_11)
                EVT_EXEC_WAIT(DoBurnHit)
                EVT_EXEC_WAIT(N(8021AB54))
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_11)
                EVT_SET(LocalVar(2), -12345)
        ...
        EVT_CASE_EQ(EVENT_UNKNOWN_TRIGGER)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_2)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_6)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_bob_omb_Palette_00_Anim_E)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_1C)
...
EvtScript N(handleEvent_8021B4A8) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            EVT_CALL(GetLastElement, LocalVar(14))
            EVT_IF_FLAG(LocalVar(14), DAMAGE_TYPE_WATER)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_F)
                EVT_EXEC_WAIT(DoNormalHit)
            EVT_END_IF
        EVT_CASE_EQ(EVENT_HIT)
            EVT_CALL(GetLastElement, LocalVar(14))
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_3)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_CALL(GetLastElement, LocalVar(14))
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_1D)
            EVT_EXEC_WAIT(DoAirLift)
        EVT_CASE_EQ(EVENT_BLOW_AWAY)
            EVT_CALL(func_80269E80, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 20)
                EVT_EXEC_WAIT(N(8021A9C8))
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_1C)
            EVT_ELSE
...
EvtScript N(tackleAttack) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(HIT_RESULT_HIT_STATIC)
            ...
            EVT_WAIT(20)
            EVT_EXEC_WAIT(N(8021AB54))
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_BLAST, 0, 0, 2, BS_FLAGS1_SP_EVT_ACTIVE)
            EVT_RETURN
    EVT_END_SWITCH
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.1))
...
EvtScript N(blastAttack) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_bob_omb_Palette_00_Anim_11)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_BLAST | DAMAGE_TYPE_NO_CONTACT, 0, 0, 2, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_WAIT(15)
    EVT_SET_CONST(LocalVar(0), 1)
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_bob_omb_Palette_00_Anim_11)
