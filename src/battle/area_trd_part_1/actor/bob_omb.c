...
s32 N(idleAnimations_8021A510)[] = {
    STATUS_NORMAL,    ANIM_Bobomb_Anim2,
    STATUS_STONE,     ANIM_Bobomb_Anim0,
    STATUS_SLEEP,     ANIM_Bobomb_Anim18,
    STATUS_POISON,    ANIM_Bobomb_Anim4,
    STATUS_STOP,      ANIM_Bobomb_Anim0,
    STATUS_STATIC,    ANIM_Bobomb_Anim2,
    STATUS_PARALYZE,  ANIM_Bobomb_Anim0,
...
s32 N(idleAnimations_8021A55C)[] = {
    STATUS_NORMAL,    ANIM_Bobomb_Anim5,
    STATUS_STONE,     ANIM_Bobomb_Anim1,
    STATUS_SLEEP,     ANIM_Bobomb_Anim18,
    STATUS_POISON,    ANIM_Bobomb_Anim5,
    STATUS_STOP,      ANIM_Bobomb_Anim1,
    STATUS_STATIC,    ANIM_Bobomb_Anim3,
    STATUS_PARALYZE,  ANIM_Bobomb_Anim1,
...
EvtScript N(ignite) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bobomb_Anim5)
...
EvtScript N(handleEvent_8021ACE8) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LVar1, ANIM_Bobomb_AnimE)
        ...
        EVT_CASE_EQ(EVENT_UNKNOWN_TRIGGER)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Bobomb_Anim2)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Bobomb_Anim6)
            EVT_SET_CONST(LVar2, ANIM_Bobomb_AnimE)
...
EvtScript N(handleEvent_8021B4A8) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, ANIM_Bobomb_AnimF)
                EVT_EXEC_WAIT(DoNormalHit)
            EVT_END_IF
        EVT_CASE_EQ(EVENT_HIT)
            EVT_CALL(GetLastElement, LVarE)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Bobomb_Anim3)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_CALL(GetLastElement, LVarE)
...
EvtScript N(tackleAttack) = {
    ...
    EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bobomb_Anim6)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(AddGoalPos, ACTOR_SELF, 50, 0, 0)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
    EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bobomb_Anim2)
...
EvtScript N(blastAttack) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_SET(LVarA, LVar0)
            EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Bobomb_Anim7)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
