...
EvtScript N(init_80219088) = {
    ...
    EVT_ELSE
        ...
        EVT_IF_FLAG(LocalVar(4), STATUS_FLAG_SHRINK)
            EVT_SET(LocalVar(5), -13)
            EVT_SET(LocalVar(6), 4)
        EVT_ELSE
            EVT_SET(LocalVar(5), -33)
            EVT_SET(LocalVar(6), 11)
        EVT_END_IF
        EVT_ADD(LocalVar(1), LocalVar(5))
        EVT_ADD(LocalVar(2), LocalVar(6))
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(1), LocalVar(2), LocalVar(3))
        EVT_CALL(CopyStatusEffects, LocalVar(0), ACTOR_SELF)
        EVT_CALL(CopyBuffs, LocalVar(0), ACTOR_SELF)
        EVT_CALL(SetActorSounds, ACTOR_SELF, 2, 0, 0)
        EVT_CALL(GetActorPos, LocalVar(0), LocalVar(1), LocalVar(11), LocalVar(12))
        EVT_SUB(LocalVar(1), 90)
        ...
        EVT_CALL(ForceHomePos, ACTOR_SELF, LocalVar(1), LocalVar(2), LocalVar(3))
        EVT_CALL(HPBarToHome, ACTOR_SELF)
    EVT_END_IF
    EVT_RETURN
    EVT_END
...
EvtScript N(80219390) = {
    ...
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_bullet_bill_Palette_00_Anim_7)
...
EvtScript N(handleEvent_802193E8) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bullet_bill_Palette_00_Anim_5)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bullet_bill_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bullet_bill_Palette_00_Anim_3)
...
EvtScript N(80219BE0) = {
    ...
    EVT_ADD(LocalVar(1), 16)
    EVT_ADD(LocalVar(2), 2)
    EVT_CALL(PlayEffect, EFFECT_BLAST, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(3.0), 30, 0, 0, 0, 0, 0, 0, 0)
