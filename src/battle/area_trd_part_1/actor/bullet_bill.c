...
s32 N(idleAnimations_80219064)[] = {
    STATUS_NORMAL,    ANIM_BulletBill_Anim1,
    STATUS_STONE,     ANIM_BulletBill_Anim0,
    STATUS_STOP,      ANIM_BulletBill_Anim0,
    STATUS_PARALYZE,  ANIM_BulletBill_Anim0,
    STATUS_END,
};
...
EvtScript N(init_80219088) = {
    ...
    EVT_ELSE
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BulletBill_Anim3)
        EVT_CALL(SetGoalPos, ACTOR_SELF, LVar1, LVar2, LVar3)
        EVT_CALL(JumpToGoal, ACTOR_SELF, 5, FALSE, TRUE, FALSE)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BulletBill_Anim1)
...
EvtScript N(80219390) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_BulletBill_Anim7)
    EVT_SET(LVar2, -12345)
...
EvtScript N(handleEvent_802193E8) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BulletBill_Anim5)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BulletBill_Anim1)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BulletBill_Anim3)
...
EvtScript N(takeTurn_802197C0) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BulletBill_Anim4)
