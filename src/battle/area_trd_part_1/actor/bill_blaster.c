...
EvtScript N(handleEvent_80219EE0) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bill_blaster_Palette_00_Anim_3)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bill_blaster_Palette_00_Anim_1)
...
EvtScript N(8021A2BC) = {
    ...
    EVT_SUB(LocalVar(0), 33)
    EVT_ADD(LocalVar(1), 19)
    EVT_ADD(LocalVar(2), 3)
    EVT_CALL(PlayEffect, EFFECT_00, LocalVar(0), LocalVar(1), LocalVar(2), 2, 5, 0, 2, 0, 0, 0, 0, 0, 0)
    EVT_CALL(PlayEffect, EFFECT_00, LocalVar(0), LocalVar(1), LocalVar(2), 2, 5, 2, 2, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(2)
