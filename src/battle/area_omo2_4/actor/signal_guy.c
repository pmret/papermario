...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_DEATH)
            ...
            EVT_LOOP(4)
                EVT_CALL(PlayEffect, EFFECT_SWEAT, 0, LocalVar(0), LocalVar(1), LocalVar(2), 10, 45, 4, 0, 0, 0, 0, 0, 0)
                EVT_WAIT(6)
            EVT_END_LOOP
            ...
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(RemoveActorDecoration, ACTOR_SELF, LocalVar(0), 0)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_marshal_guy_Palette_00_Anim_1)
            EVT_EXEC_WAIT(DoRecover)
        EVT_CASE_EQ(EVENT_30)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_marshal_guy_Palette_00_Anim_A)
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_WAIT(1000)
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_marshal_guy_Palette_00_Anim_1)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_marshal_guy_Palette_00_Anim_A)
