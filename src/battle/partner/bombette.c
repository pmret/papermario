...
EvtScript N(handleEvent_802387F0) = {
    ...
    EVT_SWITCH(LW(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LW(2), NPC_ANIM_battle_bombette_Palette_00_Anim_11)
        ...
        EVT_CASE_EQ(EVENT_SPIKE_CONTACT)
            EVT_SET_CONST(LW(1), NPC_ANIM_battle_bombette_Palette_00_Anim_12)
            EVT_SET(LW(2), 15)
            EVT_SET_CONST(LW(3), NPC_ANIM_battle_bombette_Palette_00_Anim_1E)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_SET(LW(10), 0)
            EVT_CALL(func_80238000_6FAD10, LW(0), LW(1), LW(2))
            EVT_THREAD
...
EvtScript N(80239B64) = {
    EVT_SET_CONST(LW(0), 1)
    EVT_SET_CONST(LW(1), NPC_ANIM_battle_bombette_Palette_00_Anim_18)
    EVT_SET_CONST(LW(2), NPC_ANIM_battle_bombette_Palette_00_Anim_19)
    EVT_SET_CONST(LW(3), NPC_ANIM_battle_bombette_Palette_00_Anim_4)
...
EvtScript N(8023A5F8) = {
    ...
    EVT_SWITCH(LW(0))
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LW(0), 0, 1, 0, LW(15), 112)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LW(0), 0, 1, 0, LW(14), 48)
    EVT_END_SWITCH
    EVT_SWITCH(LW(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
...
EvtScript N(8023B228) = {
    ...
    EVT_CALL(func_80238358_6FB068, LW(0))
    EVT_SET(LW(10), LW(0))
    EVT_CALL(GetActorPos, ACTOR_PARTNER, LW(0), LW(1), LW(2))
    EVT_CALL(func_80238000_6FAD10, LW(0), LW(1), LW(2))
    EVT_THREAD
    ...
    EVT_SWITCH(LW(2))
        EVT_CASE_EQ(146)
            ...
            EVT_CALL(PartnerTestEnemy, LW(0), 0, 20, 0, 1, 16)
            EVT_IF_EQ(LW(0), 6)
                EVT_BREAK_SWITCH
            EVT_END_IF
            EVT_CALL(GetActionSuccessCopy, LW(0))
        ...
        EVT_CASE_EQ(147)
            ...
            EVT_END_IF
            EVT_CALL(GetActionSuccessCopy, LW(0))
            EVT_CALL(func_8023849C_6FB1AC, LW(0))
            EVT_SWITCH(LW(0))
                EVT_CASE_GT(0)
        ...
        EVT_CASE_EQ(148)
            ...
            EVT_END_IF
            EVT_CALL(GetActionSuccessCopy, LW(0))
            EVT_CALL(func_80238590_6FB2A0, LW(0))
            EVT_SWITCH(LW(0))
                EVT_CASE_GT(0)
                    EVT_CALL(PartnerDamageEnemy, LW(0), 805306880, 0, 0, LW(15), 112)
                    EVT_SET(ScriptFlag(0), 1)
