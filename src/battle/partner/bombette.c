...
EvtScript N(handleEvent_802387F0) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_bombette_Palette_00_Anim_11)
        ...
        EVT_CASE_EQ(EVENT_SPIKE_CONTACT)
            ...
            EVT_SET_CONST(LocalVar(3), NPC_ANIM_battle_bombette_Palette_00_Anim_1E)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_CALL(func_80238000_6FAD10, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_THREAD
        ...
        EVT_CASE_EQ(EVENT_RECOVER_PARTNER)
            ...
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_bombette_Palette_00_Anim_8)
        ...
        EVT_CASE_OR_EQ(EVENT_BLOCK)
            EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_208C)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_16)
            EVT_EXEC_WAIT(D_80297814)
            EVT_WAIT(10)
        EVT_END_CASE_GROUP
        EVT_CASE_DEFAULT
...
EvtScript N(80239B64) = {
    EVT_SET_CONST(LocalVar(0), 1)
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bombette_Palette_00_Anim_18)
    EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_bombette_Palette_00_Anim_19)
    EVT_SET_CONST(LocalVar(3), NPC_ANIM_battle_bombette_Palette_00_Anim_4)
...
EvtScript N(8023A5F8) = {
    ...
    EVT_LOOP(60)
        EVT_CALL(CheckButtonDown, 0x00008000, LocalVar(0))
    ...
    EVT_IF_EQ(LocalFlag(2), 1)
        ...
        EVT_EXEC_GET_TID(N(8023A4BC), LocalVar(10))
        EVT_LOOP(35)
            EVT_CALL(CheckButtonDown, 0x00008000, LocalVar(0))
        ...
        EVT_END_IF
        EVT_SET(LocalFlag(0), 0)
        EVT_EXEC_GET_TID(N(8023A4F8), LocalVar(10))
        EVT_LOOP(30)
            EVT_CALL(CheckButtonDown, 0x00008000, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), FALSE)
                EVT_SET(LocalFlag(0), 1)
        ...
        EVT_IF_EQ(LocalFlag(0), 0)
            EVT_EXEC_GET_TID(N(8023A584), LocalVar(10))
            EVT_LOOP(30)
                EVT_CALL(CheckButtonDown, 0x00008000, LocalVar(0))
                EVT_IF_EQ(LocalVar(0), FALSE)
                    EVT_SET(LocalFlag(0), 1)
    ...
    EVT_WAIT(2)
    EVT_CALL(CloseActionCommandInfo)
    EVT_CALL(PartnerTestEnemy, LocalVar(0), 0, 149, 0, 1, 16)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 0, 1, 0, LocalVar(15), 112)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 0, 1, 0, LocalVar(14), 48)
    EVT_END_SWITCH
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
...
EvtScript N(8023B228) = {
    ...
    EVT_SWITCH(LocalVar(2))
        EVT_CASE_EQ(146)
            EVT_CALL(PartnerTestEnemy, LocalVar(0), 0, 16, 0, 1, 16)
    EVT_END_SWITCH
    EVT_CALL(StopSound, 647)
    EVT_SWITCH(LocalVar(2))
        EVT_CASE_EQ(146)
    ...
    EVT_CALL(func_80238358_6FB068, LocalVar(0))
    ...
    EVT_THREAD
        ...
        EVT_SWITCH(LocalVar(2))
            ...
            EVT_CASE_EQ(147)
                ...
                EVT_WAIT(8)
                EVT_IF_GT(LocalVar(10), 0)
                    EVT_CALL(PlayEffect, EFFECT_RED_IMPACT, 0, LocalVar(0), 0, LocalVar(2), 1, 0, 0, 0, 0, 0, 0, 0, 0)
                EVT_ELSE
                    EVT_CALL(PlayEffect, EFFECT_RED_IMPACT, 1, LocalVar(0), 0, LocalVar(2), 1, 0, 0, 0, 0, 0, 0, 0, 0)
                EVT_END_IF
            EVT_CASE_EQ(148)
                EVT_SET(LocalVar(10), 0)
                EVT_WAIT(10)
    ...
    EVT_SWITCH(LocalVar(2))
        EVT_CASE_EQ(146)
            ...
            EVT_CALL(PartnerTestEnemy, LocalVar(0), 0, 20, 0, 1, 16)
            EVT_IF_EQ(LocalVar(0), 6)
                EVT_BREAK_SWITCH
            EVT_END_IF
            EVT_CALL(GetActionSuccessCopy, LocalVar(0))
            ...
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_GT(0)
                    EVT_CALL(PartnerDamageEnemy, LocalVar(0), 268435968, 0, 0, LocalVar(15), 112)
                    EVT_SET(LocalFlag(0), 1)
                EVT_CASE_DEFAULT
                    EVT_CALL(PartnerDamageEnemy, LocalVar(0), 268435968, 0, 0, LocalVar(15), 48)
            EVT_END_SWITCH
        EVT_CASE_EQ(147)
            EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_CANNON1)
            EVT_LABEL(5)
            ...
            EVT_END_IF
            EVT_CALL(GetActionSuccessCopy, LocalVar(0))
            EVT_CALL(func_8023849C_6FB1AC, LocalVar(0))
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_GT(0)
                    EVT_CALL(PartnerDamageEnemy, LocalVar(0), 805306880, 0, 0, LocalVar(15), 112)
                    EVT_SET(LocalFlag(0), 1)
                EVT_CASE_DEFAULT
                    EVT_CALL(PartnerDamageEnemy, LocalVar(0), 805306880, 0, 0, LocalVar(15), 48)
            EVT_END_SWITCH
            EVT_LABEL(6)
        ...
        EVT_CASE_EQ(148)
            ...
            EVT_END_IF
            EVT_CALL(GetActionSuccessCopy, LocalVar(0))
            EVT_CALL(func_80238590_6FB2A0, LocalVar(0))
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_GT(0)
                    EVT_CALL(PartnerDamageEnemy, LocalVar(0), 805306880, 0, 0, LocalVar(15), 112)
                    EVT_SET(LocalFlag(0), 1)
