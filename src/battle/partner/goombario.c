...
EvtScript N(handleEvent_80239360) = {
    ...
    EVT_CALL(GetLastEvent, 256, LocalVar(0))
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(9)
        EVT_CASE_OR_EQ(10)
            EVT_SET_CONST(LocalVar(1), 0x9000A)
            EVT_SET_CONST(LocalVar(2), 0x9000A)
        ...
        EVT_CASE_EQ(42)
            ...
            EVT_EXEC_WAIT(D_80296014)
        EVT_CASE_EQ(44)
            EVT_SET_CONST(LocalVar(1), 0x9000B)
            EVT_SET(LocalVar(2), 12)
            EVT_SET_CONST(LocalVar(3), 0x9000C)
            EVT_EXEC_WAIT(D_80294C68)
            EVT_SET_CONST(LocalVar(1), 0x9000A)
            EVT_EXEC_WAIT(D_80296014)
        EVT_CASE_EQ(14)
            EVT_SET_CONST(LocalVar(1), 0x9000B)
            EVT_SET_CONST(LocalVar(2), 0x9000C)
        ...
        EVT_CASE_EQ(52)
            EVT_SET_CONST(LocalVar(0), 0x1)
            EVT_SET_CONST(LocalVar(1), 0x90001)
            EVT_SET_CONST(LocalVar(2), 0x90003)
        ...
        EVT_CASE_OR_EQ(26)
            EVT_CALL(PlaySoundAtActor, 256, 8332)
            EVT_SET_CONST(LocalVar(0), 0x1)
            EVT_SET_CONST(LocalVar(1), 0x9000E)
            EVT_EXEC_WAIT(D_80297814)
            EVT_WAIT(10)
        EVT_END_CASE_GROUP
        EVT_CASE_DEFAULT
...
EvtScript N(80239784) = {
    EVT_SET_CONST(LocalVar(0), 0x1)
    EVT_SET_CONST(LocalVar(1), 0x90010)
    EVT_SET_CONST(LocalVar(2), 0x90011)
    EVT_SET_CONST(LocalVar(3), 0x90001)
...
EvtScript N(8023994C) = {
    EVT_SET_CONST(LocalVar(0), 0x1)
    EVT_SET_CONST(LocalVar(1), 0x90003)
...
EvtScript N(80239CA8) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(3)
            ...
            EVT_CALL(SetActorRotation, -127, 0, 0, LocalVar(0))
            EVT_WAIT(1)
        EVT_END_LOOP
...
EvtScript N(8023A06C) = {
    ...
    EVT_THREAD
        EVT_WAIT(4)
        EVT_CALL(SetActorRotationOffset, -127, 0, 12, 0)
        EVT_SUB(LocalVar(0), 4)
        EVT_SET(LocalVar(1), LocalVar(0))
        EVT_DIV(LocalVar(1), 3)
        EVT_IF_LT(LocalVar(1), 1)
            EVT_SET(LocalVar(1), 1)
        EVT_END_IF
        EVT_SET(LocalVar(2), LocalVar(1))
...
EvtScript N(8023A66C) = {
    EVT_CALL(SetGoalToTarget, 256)
    EVT_CALL(GetGoalPos, 256, LocalVar(11), LocalVar(7), LocalVar(13))
    EVT_CALL(GetActorPos, 256, LocalVar(7), LocalVar(13), LocalVar(14))
    EVT_IF_GT(LocalVar(11), LocalVar(7))
        EVT_SUB(LocalVar(11), LocalVar(7))
    EVT_ELSE
        EVT_SUB(LocalVar(7), LocalVar(11))
...
EvtScript N(8023A754) = {
    ...
    EVT_CALL(func_8023817C_6F125C, LocalVar(10), 0)
    EVT_CALL(PartnerTestEnemy, LocalVar(0), 128, 20, 0, 1, 16)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            ...
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 128, 0, 0, LocalVar(0), 80)
        EVT_CASE_DEFAULT
            EVT_CALL(battle_partner_goombario_StopGlowingAndGet)
            EVT_ADD(LocalVar(0), 1)
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 128, 0, 0, LocalVar(0), 48)
    EVT_END_SWITCH
    ...
    EVT_CALL(battle_partner_goombario_StopGlowingAndGet)
    EVT_ADD(LocalVar(0), 1)
    EVT_CALL(PartnerDamageEnemy, LocalVar(0), 128, 0, 0, LocalVar(0), 32)
    EVT_CALL(PlaySoundAtActor, 256, 0)
...
EvtScript N(8023B45C) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(6)
            EVT_ADD(LocalVar(0), -30)
            EVT_CALL(SetActorRotation, -127, 0, -250000000, LocalVar(0))
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_CALL(SetAnimation, -127, 1, 589830)
    EVT_END_THREAD
    EVT_THREAD
        ...
        EVT_LOOP(LocalVar(10))
            ...
            EVT_CALL(SetActorRotation, -127, -250000000, LocalVar(0), -250000000)
            EVT_WAIT(1)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(SetGoalToTarget, 256)
...
EvtScript N(8023BB9C) = {
    ...
    EVT_WAIT(1)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_52)
    EVT_CALL(func_802A9120_421B10, LocalVar(10), 1)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_52)
    EVT_CALL(SetAnimation, -127, 1, 589830)
    EVT_CALL(SetActorDispOffset, 256, 0, 9, 0)
    EVT_CALL(SetGoalToTarget, 256)
    ...
    EVT_CALL(PlaySoundAtActor, 256, 8205)
    EVT_CALL(func_8023817C_6F125C, LocalVar(10), 0)
    EVT_CALL(PartnerTestEnemy, LocalVar(0), 1048704, 20, 0, 1, 16)
    EVT_IF_EQ(LocalVar(0), 6)
        EVT_CALL(SetJumpAnimations, 256, 0, 589830, 589830, 589830)
        EVT_CALL(battle_partner_goombario_func_80238A20_6F1B00)
        EVT_THREAD
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            EVT_CALL(battle_partner_goombario_IsGlowing)
            EVT_ADD(LocalVar(0), 3)
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 1048704, 0, 0, LocalVar(0), 80)
        EVT_CASE_DEFAULT
            EVT_CALL(battle_partner_goombario_StopGlowingAndGet)
            EVT_ADD(LocalVar(0), 3)
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 1048704, 0, 0, LocalVar(0), 48)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, 256, 0)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
    ...
    EVT_SWITCH(LocalVar(15))
        EVT_CASE_EQ(0)
            EVT_CALL(func_802A9120_421B10, LocalVar(10), 1)
        EVT_CASE_EQ(1)
            EVT_CALL(func_802A9120_421B10, LocalVar(10), 2)
        EVT_CASE_EQ(2)
            EVT_CALL(func_802A9120_421B10, LocalVar(10), 3)
        EVT_CASE_EQ(3)
            EVT_CALL(func_802A9120_421B10, LocalVar(10), 4)
        EVT_CASE_DEFAULT
            EVT_CALL(func_802A9120_421B10, LocalVar(10), 5)
    EVT_END_SWITCH
    EVT_THREAD
        EVT_WAIT(4)
        EVT_SET(LocalVar(0), 0)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            EVT_IF_EQ(LocalFlag(0), 0)
                EVT_CALL(battle_partner_goombario_IsGlowing)
                EVT_ADD(LocalVar(0), 3)
                EVT_CALL(PartnerPowerBounceEnemy, LocalVar(0), 1048704, 0, 0, LocalVar(0), LocalVar(13), 64)
            EVT_ELSE
                EVT_CALL(battle_partner_goombario_StopGlowingAndGet)
                EVT_ADD(LocalVar(0), 3)
                EVT_CALL(PartnerPowerBounceEnemy, LocalVar(0), 1048704, 0, 0, LocalVar(0), LocalVar(13), 32)
            EVT_END_IF
        EVT_CASE_DEFAULT
            EVT_CALL(battle_partner_goombario_StopGlowingAndGet)
            EVT_ADD(LocalVar(0), 3)
...
EvtScript N(8023C5B8) = {
    ...
    EVT_CALL(GetOwnerTarget, LocalVar(10), LocalVar(11))
    ...
    EVT_CALL(ActorSpeak, LocalVar(0), -127, 1, 589839, 589825)
...
EvtScript N(8023C90C) = {
    ...
    EVT_IF_EQ(LocalVar(0), 0)
        ...
        EVT_SWITCH(LocalVar(2))
            ...
            EVT_CASE_EQ(135)
                ...
                EVT_CALL(ShowMessageBox, LocalVar(0), 60)
            EVT_CASE_EQ(136)
                EVT_CALL(ShowMessageBox, 36, 60)
        EVT_END_SWITCH
    EVT_ELSE
    ...
    EVT_LABEL(0)
    EVT_WAIT(1)
    EVT_CALL(IsMessageBoxDisplayed, LocalVar(0))
