...
EvtScript N(electroDash) = {
    ...
    EVT_IF_EQ(LocalFlag(2), 1)
        ...
        EVT_IF_EQ(LocalFlag(0), 1)
            ...
            EVT_GOTO(10)
        EVT_END_IF
        EVT_CALL(PartnerTestEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_4, 0, 1, BS_FLAGS1_10)
        EVT_SET(LocalFlag(0), 0)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_SHOCK | DAMAGE_TYPE_IGNORE_DEFENSE, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_SHOCK | DAMAGE_TYPE_IGNORE_DEFENSE, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_80, 0, LVarE, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_SWITCH
...
EvtScript N(megaShock) = {
    ...
    EVT_LOOP(0)
        ...
        EVT_CALL(PartnerTestEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_10, 0, 1, BS_FLAGS1_10)
        EVT_IF_EQ(LVar0, HIT_RESULT_MISS)
            EVT_GOTO(11)
        EVT_END_IF
        EVT_IF_EQ(LVarF, 100)
