...
EvtScript N(electroDash) = {
    ...
    EVT_CALL(FlyToGoal, ACTOR_PARTNER, 5, 0, 0)
    EVT_THREAD
        EVT_WAIT(2)
    ...
    EVT_IF_EQ(LVar0, HIT_RESULT_MISS)
        ...
        EVT_CALL(FlyToGoal, ACTOR_PARTNER, 10, -20, 4)
        EVT_WAIT(20)
        EVT_CALL(SetGoalToHome, ACTOR_PARTNER)
        EVT_CALL(SetAnimation, ACTOR_PARTNER, -1,  ANIM_BattleWatt_Run)
        EVT_CALL(FlyToGoal, ACTOR_PARTNER, 30, 0, 10)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LVar0, 134217760, 141, 0, LVarF, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LVar0, 134217760, 141, 0, LVarE, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_SWITCH
...
EvtScript N(powerShock) = {
    ...
    EVT_ADD(LVar1, 15)
    EVT_ADD(LVar2, 5)
    EVT_CALL(PlayEffect, EFFECT_SNAKING_STATIC, 0, LVar0, LVar1, LVar2, EVT_FLOAT(1.0), 75, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(N(UnkBackgroundFunc3))
    EVT_SET(LVar9, 0)
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1,  ANIM_BattleWatt_StrainBigger)
    EVT_CALL(func_8026EA7C, ACTOR_SELF, 1, 10)
    ...
    EVT_THREAD
        ...
        EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
        EVT_ADD(LVar1, 8)
        EVT_CALL(PlayEffect, EFFECT_ENERGY_IN_OUT, 6, LVar0, LVar1, LVar2, EVT_FLOAT(1.8), 30, 0, 0, 0, 0, 0, 0, 0)
    EVT_END_THREAD
    EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
    EVT_ADD(LVar1, 20)
    EVT_ADD(LVar2, 5)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PartnerAfflictEnemy, LVar0, 1342177312, 0, -1073675520, 254, 0, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerAfflictEnemy, LVar0, 1342177312, 0, -1073675520, 255, 0, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_SWITCH
    EVT_CALL(PartnerYieldTurn)
    EVT_IF_NE(LocalFlag(15), 1)
        EVT_CALL(AddGoalPos, ACTOR_PARTNER, -25, 10, 0)
        EVT_CALL(FlyToGoal, ACTOR_PARTNER, 15, -10, 10)
    EVT_ELSE
        EVT_CALL(AddGoalPos, ACTOR_PARTNER, -25, -10, 0)
        EVT_CALL(FlyToGoal, ACTOR_PARTNER, 15, -10, 10)
    EVT_END_IF
...
EvtScript N(8023AE8C) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetAnimation, ACTOR_PARTNER, -1,  ANIM_BattleWatt_Run)
        EVT_CALL(SetGoalToHome, ACTOR_PARTNER)
        EVT_CALL(FlyToGoal, ACTOR_PARTNER, 10, -10, 5)
        EVT_CALL(SetAnimation, ACTOR_PARTNER, -1,  ANIM_BattleWatt_Idle)
        EVT_WAIT(10)
    ...
    EVT_IF_EQ(LVar0, 0)
    EVT_ELSE
        EVT_CALL(ShowVariableMessageBox, 42, 60, LVarA)
    EVT_END_IF
...
EvtScript N(megaShock) = {
    ...
    EVT_ADD(LVar1, 15)
    EVT_ADD(LVar2, 5)
    EVT_CALL(PlayEffect, EFFECT_SNAKING_STATIC, 0, LVar0, LVar1, LVar2, EVT_FLOAT(1.0), 90, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
    EVT_ADD(LVar1, 12)
    EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 8, LVar0, LVar1, LVar2, EVT_FLOAT(1.3), 90, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(AddBattleCamZoom, -100)
    ...
    EVT_THREAD
        ...
        EVT_CALL(PlayEffect, EFFECT_FLASHING_BOX_SHOCKWAVE, 2, LVar0, LVar1, LVar2, 0, 0, 0, 0, 0, 0, 0, 0, 0)
        EVT_WAIT(10)
    ...
    EVT_LOOP(0)
        ...
        EVT_END_IF
        EVT_IF_EQ(LVarF, 100)
            EVT_CALL(PartnerAfflictEnemy, LVar0, 1879048224, 0, -1073675520, 254, 0, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
        EVT_ELSE
            EVT_CALL(PartnerAfflictEnemy, LVar0, 1879048224, 0, -1073675520, LVarF, 0, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
        EVT_END_IF
        EVT_LABEL(11)
