...
EvtScript N(returnHome2) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleParakarry_Run)
    EVT_CALL(FlyToGoal, ACTOR_PARTNER, 0, -5, 0)
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleParakarry_Walk)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(skyDive) = {
    ...
    EVT_CALL(FlyToGoal, ACTOR_PARTNER, 20, -20, 6)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_4, 0, LVarF, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_4, 0, LVarE, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_SWITCH
...
EvtScript N(shellShot) = {
    ...
    EVT_CALL(PartnerTestEnemy, LVarA, 0, EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_10, 0, 1, BS_FLAGS1_10)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(1)
            ...
            EVT_CALL(FlyToGoal, ACTOR_PARTNER, 7, 0, 0)
            EVT_CALL(EnableActorBlur, ACTOR_PARTNER, 0)
        EVT_CASE_EQ(-1)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_52)
            EVT_CALL(MoveBattleCamOver, 5)
            ...
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleParakarry_ShellFlyFastest)
            EVT_CALL(FlyToGoal, ACTOR_PARTNER, 7, 0, 100)
            EVT_CALL(EnableActorBlur, ACTOR_PARTNER, 0)
        EVT_CASE_EQ(0)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_52)
            EVT_CALL(MoveBattleCamOver, 5)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
...
EvtScript N(airLift) = {
    ...
    EVT_IF_EQ(LVar0, HIT_RESULT_MISS)
        ...
        EVT_CALL(FlyToGoal, ACTOR_PARTNER, 10, -10, 12)
        ...
        EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleParakarry_Run)
        EVT_CALL(FlyToGoal, ACTOR_PARTNER, 0, 0, 0)
        EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleParakarry_Walk)
        EVT_RETURN
    EVT_END_IF
    EVT_WAIT(3)
    EVT_CALL(PartnerTestEnemy, LVar0, DAMAGE_TYPE_AIR_LIFT, EVENT_SUPPRESS_FLAG_4, 0, 0, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(N(AirLiftChance))
    EVT_IF_NE(LVar0, -1)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_DEFAULT
            ...
            EVT_ADD(LVar1, 20)
            EVT_CALL(SetGoalPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
            EVT_CALL(FlyToGoal, ACTOR_PARTNER, 5, -10, 12)
            EVT_CALL(SetAnimationRate, ACTOR_PARTNER, 0, EVT_FLOAT(8.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleParakarry_Idle)
            EVT_WAIT(10)
    EVT_END_SWITCH
...
EvtScript N(airRaid) = {
    ...
    EVT_ADD(LVar2, 40)
    EVT_CALL(SetGoalPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
    EVT_CALL(FlyToGoal, ACTOR_PARTNER, 10, -10, 10)
    EVT_WAIT(2)
    ...
    EVT_CHILD_THREAD
        EVT_LOOP(5)
            EVT_WAIT(18)
            EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
            EVT_CALL(PlayEffect, EFFECT_LENS_FLARE, 0, LVar0, LVar1, LVar2, 10, 0, 0, 0, 0, 0, 0, 0, 0)
        EVT_END_LOOP
    EVT_END_CHILD_THREAD
    EVT_CHILD_THREAD
        EVT_LOOP(5)
            EVT_WAIT(18)
            EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
            EVT_CALL(PlayEffect, EFFECT_SPARKLES, 1, LVar0, LVar1, LVar2, 40, 0, 0, 0, 0, 0, 0, 0, 0)
        EVT_END_LOOP
    EVT_END_CHILD_THREAD
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleParakarry_ShellFlyFastest)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(99)
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_NO_CONTACT | DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_40)
            EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_110)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_NO_CONTACT | DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_10 | BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_WAIT(5)
    EVT_LABEL(11)
