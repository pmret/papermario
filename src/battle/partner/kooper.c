...
EvtScript N(handleEvent_802385E0) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_11)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_kooper_Palette_00_Anim_11)
        ...
        EVT_CASE_EQ(EVENT_BURN_CONTACT)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_12)
            EVT_SET(LocalVar(2), 16)
            EVT_SET_CONST(LocalVar(3), NPC_ANIM_battle_kooper_Palette_00_Anim_13)
            EVT_EXEC_WAIT(D_80294C68)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_11)
            EVT_EXEC_WAIT(D_80296014)
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_12)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_kooper_Palette_00_Anim_13)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_PARTNER)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_4)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_kooper_Palette_00_Anim_6)
        ...
        EVT_CASE_OR_EQ(EVENT_BLOCK)
            EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_208C)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_10)
            EVT_EXEC_WAIT(D_80297814)
            EVT_WAIT(10)
...
EvtScript N(80238A20) = {
    EVT_SET_CONST(LocalVar(0), 1)
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_16)
    EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_kooper_Palette_00_Anim_5)
    EVT_SET_CONST(LocalVar(3), NPC_ANIM_battle_kooper_Palette_00_Anim_4)
...
EvtScript N(runAway) = {
    EVT_SET_CONST(LocalVar(0), 1)
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_kooper_Palette_00_Anim_6)
...
EvtScript N(802392A4) = {
    ...
    EVT_CALL(GetGoalPos, ACTOR_PARTNER, LocalVar(11), LocalVar(12), LocalVar(13))
    EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(12), LocalVar(13), LocalVar(0))
    ...
    EVT_END_IF
    EVT_DIVF(LocalVar(11), LocalVar(10))
...
EvtScript N(80239384) = {
    ...
    EVT_LOOP(50)
        ...
        EVT_SWITCH(LocalVar(9))
            EVT_CASE_LT(20)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_A)
            EVT_CASE_EQ(20)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(4), LocalVar(5), LocalVar(6))
                EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 1, LocalVar(4), LocalVar(5), LocalVar(6), 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_LT(30)
    ...
    EVT_LABEL(0)
    EVT_WAIT(1)
    EVT_SETF(LocalVar(10), EVT_FLOAT(8.0))
    EVT_SWITCH(LocalVar(9))
        EVT_CASE_LT(20)
            EVT_SETF(LocalVar(10), EVT_FLOAT(10.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_A)
        EVT_CASE_LT(30)
            EVT_SETF(LocalVar(10), EVT_FLOAT(12.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_B)
        EVT_CASE_LT(40)
            EVT_SETF(LocalVar(10), EVT_FLOAT(14.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_C)
        EVT_CASE_LT(50)
            EVT_SETF(LocalVar(10), EVT_FLOAT(16.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_D)
    EVT_END_SWITCH
    EVT_ADD(LocalVar(9), 1)
    ...
    EVT_CALL(SetGoalToTarget, ACTOR_PARTNER)
    EVT_CALL(SetActorSpeed, ACTOR_PARTNER, LocalVar(10))
    EVT_CALL(SetActorSounds, ACTOR_PARTNER, 0, 0, 0)
    EVT_CALL(RunToGoal, ACTOR_PARTNER, 0)
    EVT_CALL(PartnerTestEnemy, LocalVar(0), 0, 20, 0, 2, 16)
    EVT_IF_EQ(LocalVar(0), 6)
        ...
        EVT_WAIT(5)
        EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(4), LocalVar(5), LocalVar(6))
        EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 1, LocalVar(4), LocalVar(5), LocalVar(6), 16, 4, 0, 10, 0, 0, 0, 0, 0)
        EVT_LOOP(5)
            EVT_ADD(LocalVar(0), 12)
            EVT_CALL(SetActorRotation, ACTOR_PARTNER, 0, 0, LocalVar(0))
            EVT_WAIT(1)
        EVT_END_LOOP
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 0, 159, 0, LocalVar(15), 112)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 0, 159, 0, LocalVar(14), 48)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(0)
...
EvtScript N(80239E7C) = {
    EVT_CALL(LoadActionCommand, ACTION_COMMAND_SMASH)
    EVT_CALL(action_command_hammer_CreateHudElements)
    EVT_CALL(GetActorLevel, 256, LocalVar(0))
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(0)
            EVT_SET(LocalVar(14), 1)
            EVT_SET(LocalVar(15), 2)
    ...
    EVT_LABEL(0)
    EVT_WAIT(1)
    EVT_SET(LocalVar(10), EVT_FLOAT(8.0))
    EVT_SWITCH(LocalVar(9))
        EVT_CASE_LT(20)
            EVT_SET(LocalVar(10), EVT_FLOAT(10.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_A)
        EVT_CASE_LT(30)
            EVT_SET(LocalVar(10), EVT_FLOAT(12.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_B)
        EVT_CASE_LT(40)
            EVT_SET(LocalVar(10), EVT_FLOAT(14.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_C)
        EVT_CASE_LT(50)
            EVT_SET(LocalVar(10), EVT_FLOAT(16.0))
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_D)
    EVT_END_SWITCH
    EVT_ADD(LocalVar(9), 1)
    EVT_CALL(GetActionSuccess, LocalVar(0))
    ...
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_D)
    EVT_CALL(MoveBattleCamOver, 15)
    EVT_SET(LocalVar(11), 260)
    EVT_DIVF(LocalVar(11), LocalVar(10))
    EVT_THREAD
        EVT_CALL(AddActorDecoration, ACTOR_SELF, 0, 1, 5)
        EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(0), 260)
        EVT_CALL(SetGoalPos, ACTOR_PARTNER, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(SetActorSpeed, ACTOR_PARTNER, LocalVar(10))
        EVT_CALL(SetActorSounds, ACTOR_PARTNER, 0, 0, 0)
        EVT_CALL(RunToGoal, ACTOR_PARTNER, 0)
    ...
    EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(3), LocalVar(4), LocalVar(5))
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 536870912, 159, 0, LocalVar(15), 112)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 536870912, 159, 0, LocalVar(14), 48)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_LABEL(12)
    EVT_CALL(ChooseNextTarget, 0, LocalVar(2))
...
EvtScript N(8023AA38) = {
    ...
    EVT_SET(LocalVar(10), LocalVar(13))
    EVT_ADD(LocalVar(10), -3)
    EVT_CALL(battle_partner_kooper_AverageTargetDizzyChance)
    EVT_CALL(action_command_dizzy_shell_MashActionCommandInit, 0, LocalVar(10), 3, LocalVar(0))
    EVT_CALL(SetActionResult, 0)
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_A)
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, 0x200C)
    EVT_SET(LocalVar(9), 0)
    ...
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_D)
    EVT_CALL(MoveBattleCamOver, 15)
    EVT_SET(LocalVar(11), 300)
    EVT_DIVF(LocalVar(11), LocalVar(10))
    EVT_THREAD
        EVT_CALL(AddActorDecoration, ACTOR_SELF, 0, 0, 5)
        EVT_CALL(EnableActorBlur, ACTOR_PARTNER, 1)
        EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(0), 350)
        EVT_CALL(SetGoalPos, ACTOR_PARTNER, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(SetActorSpeed, ACTOR_PARTNER, LocalVar(10))
        EVT_CALL(SetActorSounds, ACTOR_PARTNER, 0, 0, 0)
        EVT_CALL(RunToGoal, ACTOR_PARTNER, 0)
    ...
    EVT_END_IF
    EVT_SET(LocalFlag(0), 1)
    EVT_CALL(GetActionResult, LocalVar(15))
    EVT_CALL(GetActionCommandResult, LocalVar(0))
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            EVT_IF_EQ(LocalVar(9), 1)
                EVT_IF_EQ(LocalVar(15), 100)
                    EVT_CALL(PartnerAfflictEnemy, LocalVar(0), 1610612736, 159, -1073478912, 254, 0, 112)
                EVT_ELSE
                    EVT_CALL(PartnerAfflictEnemy, LocalVar(0), 1610612736, 159, -1073478912, LocalVar(15), 0, 112)
                EVT_END_IF
            EVT_ELSE
                EVT_CALL(PartnerAfflictEnemy, LocalVar(0), 1610612736, 159, -1073478912, LocalVar(15), 0, 112)
            EVT_END_IF
        EVT_CASE_DEFAULT
            EVT_IF_EQ(LocalVar(9), 1)
                EVT_CALL(PartnerAfflictEnemy, LocalVar(0), 1610612736, 159, -1073478912, 255, 0, 48)
            EVT_ELSE
                EVT_CALL(PartnerAfflictEnemy, LocalVar(0), 1610612736, 159, -1073478912, 255, 0, 48)
            EVT_END_IF
    EVT_END_SWITCH
...
EvtScript N(8023B660) = {
    ...
    EVT_ADD(LocalVar(12), -3)
    EVT_CALL(action_command_fire_shell_MashActionCommandInit, 0, LocalVar(12), 3)
    ...
    EVT_SET(LocalVar(8), 30)
    EVT_SET(LocalVar(9), 30)
    EVT_LOOP(LocalVar(13))
        EVT_WAIT(1)
        EVT_CALL(GetActionResult, LocalVar(0))
        EVT_SWITCH(LocalVar(0))
            EVT_CASE_GE(80)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_D)
                EVT_SET(LocalVar(9), 80)
                EVT_SET(LocalVar(7), 8)
                EVT_IF_NE(LocalVar(6), LocalVar(7))
                    EVT_CALL(func_8026EA7C, ACTOR_PARTNER, -1, 15)
                    EVT_CALL(func_8026EBF8, ACTOR_PARTNER, -1, LocalVar(6), LocalVar(7), 1, 10, 1000, 10, 0, 0)
                    EVT_SET(LocalVar(6), LocalVar(7))
                EVT_END_IF
            EVT_CASE_GE(60)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_C)
                EVT_SET(LocalVar(9), 60)
                EVT_SET(LocalVar(7), 7)
                EVT_IF_NE(LocalVar(6), LocalVar(7))
                    EVT_CALL(func_8026EA7C, ACTOR_PARTNER, -1, 15)
                    EVT_CALL(func_8026EBF8, ACTOR_PARTNER, -1, LocalVar(6), LocalVar(7), 1, 10, 1000, 10, 0, 0)
                    EVT_SET(LocalVar(6), LocalVar(7))
            ...
            EVT_CASE_GE(40)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_B)
                EVT_SET(LocalVar(9), 40)
                EVT_SET(LocalVar(7), 6)
                EVT_IF_NE(LocalVar(6), LocalVar(7))
                    EVT_CALL(func_8026EA7C, ACTOR_PARTNER, -1, 15)
                    EVT_CALL(func_8026EBF8, ACTOR_PARTNER, -1, LocalVar(6), LocalVar(7), 1, 10, 1000, 10, 0, 0)
                    EVT_SET(LocalVar(6), LocalVar(7))
            ...
            EVT_CASE_GE(20)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, NPC_ANIM_battle_kooper_Palette_00_Anim_A)
                EVT_SET(LocalVar(9), 35)
                EVT_SET(LocalVar(7), 5)
                EVT_IF_NE(LocalVar(6), LocalVar(7))
                    EVT_CALL(func_8026EA7C, ACTOR_PARTNER, -1, 15)
                    EVT_CALL(func_8026EBF8, ACTOR_PARTNER, -1, LocalVar(6), LocalVar(7), 1, 10, 1000, 10, 0, 0)
                    EVT_SET(LocalVar(6), LocalVar(7))
            ...
            EVT_CASE_DEFAULT
                ...
                EVT_END_IF
        EVT_END_SWITCH
        EVT_IF_LT(LocalVar(8), LocalVar(9))
            EVT_ADD(LocalVar(8), 1)
        EVT_END_IF
        EVT_IF_GT(LocalVar(8), LocalVar(9))
            EVT_SUB(LocalVar(8), 1)
        EVT_END_IF
        EVT_CALL(ModifyActorDecoration, 256, -1, 0, LocalVar(8), LocalVar(8), 255, 0)
        EVT_SWITCH(LocalVar(13))
            EVT_CASE_EQ(10)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(3), LocalVar(4), LocalVar(5))
                EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 1, LocalVar(3), LocalVar(4), LocalVar(5), 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_EQ(20)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(3), LocalVar(4), LocalVar(5))
                EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 1, LocalVar(3), LocalVar(4), LocalVar(5), 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_EQ(40)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(99)
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 536870914, 159, 0, LocalVar(15), 112)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LocalVar(0), 536870914, 159, 0, LocalVar(15), 48)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_LABEL(12)
...
EvtScript N(8023C754) = {
    ...
    EVT_SWITCH(LocalVar(2))
        ...
        EVT_CASE_EQ(139)
            EVT_SET(LocalVar(15), 3)
    EVT_END_SWITCH
    EVT_CALL(PartnerDamageEnemy, LocalVar(0), 0, 159, 0, LocalVar(15), 48)
    EVT_CALL(GetMenuSelection, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_SWITCH(LocalVar(2))
        EVT_CASE_EQ(137)
            EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
