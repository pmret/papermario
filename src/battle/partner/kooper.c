...
EvtScript N(80239384) = {
    ...
    EVT_LOOP(50)
        ...
        EVT_SWITCH(LW(9))
            ...
            EVT_CASE_EQ(20)
                ...
                EVT_CALL(PlayEffect, EFFECT_ID_1D, 1, LW(4), LW(5), LW(6), 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_LT(30)
    ...
    EVT_IF_EQ(LW(0), 6)
        ...
        EVT_WAIT_FRAMES(5)
        EVT_CALL(GetActorPos, ACTOR_PARTNER, LW(4), LW(5), LW(6))
        EVT_CALL(PlayEffect, EFFECT_ID_1D, 1, LW(4), LW(5), LW(6), 16, 4, 0, 10, 0, 0, 0, 0, 0)
        EVT_LOOP(5)
            EVT_ADD(LW(0), 12)
            EVT_CALL(SetActorRotation, ACTOR_PARTNER, 0, 0, LW(0))
            EVT_WAIT_FRAMES(1)
...
EvtScript N(8023B660) = {
    ...
    EVT_LOOP(LW(13))
        ...
        EVT_SWITCH(LW(13))
            EVT_CASE_EQ(10)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LW(3), LW(4), LW(5))
                EVT_CALL(PlayEffect, EFFECT_ID_1D, 1, LW(3), LW(4), LW(5), 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_EQ(20)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LW(3), LW(4), LW(5))
                EVT_CALL(PlayEffect, EFFECT_ID_1D, 1, LW(3), LW(4), LW(5), 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_EQ(40)
