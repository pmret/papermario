...
s32 N(idleAnimations_80238430)[] = {
    STATUS_NORMAL,    ANIM_BattleKooper_Anim05,
    STATUS_STONE,     ANIM_BattleKooper_Anim00,
    STATUS_SLEEP,     ANIM_BattleKooper_Anim1B,
    STATUS_POISON,    ANIM_BattleKooper_Anim00,
    STATUS_STOP,      ANIM_BattleKooper_Anim00,
    STATUS_DAZE,      ANIM_BattleKooper_Anim1C,
    STATUS_TURN_DONE, ANIM_BattleKooper_Anim00,
    STATUS_END,
};
...
EvtScript N(handleEvent_802385E0) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim11)
            EVT_SET_CONST(LVar2, ANIM_BattleKooper_Anim11)
        ...
        EVT_CASE_EQ(EVENT_BURN_CONTACT)
            EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim12)
            EVT_SET(LVar2, 16)
            EVT_SET_CONST(LVar3, ANIM_BattleKooper_Anim13)
            EVT_EXEC_WAIT(D_80294C68)
            EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim11)
            EVT_EXEC_WAIT(D_80296014)
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim12)
            EVT_SET_CONST(LVar2, ANIM_BattleKooper_Anim13)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_PARTNER)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim04)
            EVT_SET_CONST(LVar2, ANIM_BattleKooper_Anim06)
            EVT_SET(LVar3, 0)
        ...
        EVT_CASE_OR_EQ(EVENT_BLOCK)
            EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_208C)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim10)
            EVT_EXEC_WAIT(D_80297814)
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim0F)
        EVT_END_CASE_GROUP
        EVT_CASE_DEFAULT
    EVT_END_SWITCH
...
EvtScript N(80238A20) = {
    EVT_SET_CONST(LVar0, 1)
    EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim16)
    EVT_SET_CONST(LVar2, ANIM_BattleKooper_Anim05)
    EVT_SET_CONST(LVar3, ANIM_BattleKooper_Anim04)
...
EvtScript N(runAway) = {
    EVT_SET_CONST(LVar0, 1)
    EVT_SET_CONST(LVar1, ANIM_BattleKooper_Anim06)
...
EvtScript N(runAwayFail) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim06)
    EVT_CALL(SetActorYaw, ACTOR_PARTNER, 0)
    EVT_CALL(RunToGoal, ACTOR_PARTNER, 0)
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim04)
    EVT_CALL(UseIdleAnimation, ACTOR_PARTNER, TRUE)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(80239384) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim04)
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim0E)
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_WAIT(15)
    EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim0A)
    EVT_LOOP(30)
        EVT_WAIT(1)
    ...
    EVT_LOOP(50)
        ...
        EVT_SWITCH(LVar9)
            ...
            EVT_CASE_LT(30)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim0B)
            EVT_CASE_EQ(30)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar4, LVar5, LVar6)
                EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 1, LVar4, LVar5, LVar6, 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_LT(40)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim0C)
            EVT_CASE_EQ(40)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar4, LVar5, LVar6)
                EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 1, LVar4, LVar5, LVar6, 32, 4, 0, 10, 0, 0, 0, 0, 0)
            EVT_CASE_LT(50)
                EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim0D)
            EVT_CASE_EQ(50)
                EVT_CALL(GetActorPos, ACTOR_PARTNER, LVar4, LVar5, LVar6)
                EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 1, LVar4, LVar5, LVar6, 32, 4, 0, 10, 0, 0, 0, 0, 0)
        EVT_END_SWITCH
    ...
    EVT_IF_EQ(LVar0, 6)
        ...
        EVT_END_THREAD
        EVT_WAIT(4)
        EVT_CALL(SetAnimation, ACTOR_PARTNER, -1, ANIM_BattleKooper_Anim09)
