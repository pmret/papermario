...
EvtScript N(shellToss) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_40 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarE, BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_SWITCH(LVar0)
...
EvtScript N(powerShell) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_40 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarE, BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_LABEL(12)
...
EvtScript N(dizzyShell) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_IF_EQ(LVar9, 1)
                EVT_IF_EQ(LVarF, 100)
                    ...
                    EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, DMG_STATUS_ALWAYS(STATUS_FLAG_DIZZY, 3), 254, 0, BS_FLAGS1_40 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
                EVT_ELSE
                    EVT_CALL(PartnerAfflictEnemy, LVar0, DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS | DAMAGE_TYPE_STATUS_ALWAYS_HITS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, DMG_STATUS_ALWAYS(STATUS_FLAG_DIZZY, 3), LVarF, 0, BS_FLAGS1_40 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
                EVT_END_IF
            EVT_ELSE
                EVT_CALL(PartnerAfflictEnemy, LVar0, DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS | DAMAGE_TYPE_STATUS_ALWAYS_HITS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, DMG_STATUS_ALWAYS(STATUS_FLAG_DIZZY, 3), LVarF, 0, BS_FLAGS1_40 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
            EVT_END_IF
        EVT_CASE_DEFAULT
            EVT_IF_EQ(LVar9, 1)
                EVT_CALL(PartnerAfflictEnemy, LVar0, DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS | DAMAGE_TYPE_STATUS_ALWAYS_HITS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, DMG_STATUS_ALWAYS(STATUS_FLAG_DIZZY, 3), 255, 0, BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
            EVT_ELSE
                EVT_CALL(PartnerAfflictEnemy, LVar0, DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS | DAMAGE_TYPE_STATUS_ALWAYS_HITS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, DMG_STATUS_ALWAYS(STATUS_FLAG_DIZZY, 3), 255, 0, BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
            EVT_END_IF
    EVT_END_SWITCH
...
EvtScript N(fireShell) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(99)
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_FIRE | DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_40 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
        EVT_CASE_DEFAULT
            EVT_CALL(PartnerDamageEnemy, LVar0, DAMAGE_TYPE_FIRE | DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
    EVT_END_SWITCH
    EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
    EVT_LABEL(12)
...
EvtScript N(shellTossOnFirstStrike) = {
    ...
    EVT_SWITCH(LVar2)
        ...
        EVT_CASE_EQ(MOVE_SHELL_TOSS3)
            EVT_SET(LVarF, 3)
    EVT_END_SWITCH
    EVT_CALL(PartnerDamageEnemy, LVar0, 0, EVENT_SUPPRESS_FLAG_1 | EVENT_SUPPRESS_FLAG_2 | EVENT_SUPPRESS_FLAG_4 | EVENT_SUPPRESS_FLAG_SHOCK | EVENT_SUPPRESS_FLAG_10 | EVENT_SUPPRESS_FLAG_80, 0, LVarF, BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
    EVT_CALL(GetMenuSelection, LVar0, LVar1, LVar2)
    EVT_SWITCH(LVar2)
        EVT_CASE_EQ(MOVE_SHELL_TOSS1)
            EVT_CALL(PlaySoundAtActor, ACTOR_PARTNER, SOUND_0)
