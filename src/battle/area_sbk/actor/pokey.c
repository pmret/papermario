        ...
        EVT_CASE_EQ(EVENT_SPIKE_TAUNT)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    EVT_SET(LVar0, 0)
                    EVT_SET(LVar1, 77)
                    EVT_SET_CONST(LVar2, NPC_ANIM_pokey_Palette_00_Anim_21)
                EVT_CASE_EQ(1)
                    EVT_SET(LVar0, 0)
                    EVT_SET(LVar1, 59)
                    EVT_SET_CONST(LVar2, NPC_ANIM_pokey_Palette_00_Anim_22)
                EVT_CASE_EQ(2)
                    EVT_SET(LVar0, 0)
                    EVT_SET(LVar1, 41)
                    EVT_SET_CONST(LVar2, NPC_ANIM_pokey_Palette_00_Anim_23)
                EVT_CASE_EQ(3)
                    EVT_SET(LVar0, 0)
                    EVT_SET(LVar1, 23)
                    EVT_SET_CONST(LVar2, NPC_ANIM_pokey_Palette_00_Anim_24)
            EVT_END_SWITCH
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LVar3)
...
EvtScript N(8021AE2C) = {
    ...
    EVT_CHILD_THREAD
        ...
        EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_pokey_Palette_00_Anim_C)
        ...
        EVT_WAIT(20)
        EVT_CALL(GetActorPos, LVarB, LVar0, LVar1, LVar2)
        EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_pokey_Palette_00_Anim_4)
