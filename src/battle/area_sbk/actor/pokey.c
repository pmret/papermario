...
s32 N(idleAnimations_80218438)[] = {
    STATUS_NORMAL,    ANIM_Pokey_Anim4,
    STATUS_STONE,     ANIM_Pokey_Anim0,
    STATUS_SLEEP,     ANIM_Pokey_Anim25,
    STATUS_STOP,      ANIM_Pokey_Anim0,
    STATUS_PARALYZE,  ANIM_Pokey_Anim0,
...
s32 N(idleAnimations_80218474)[] = {
    STATUS_NORMAL,    ANIM_Pokey_Anim5,
    STATUS_STONE,     ANIM_Pokey_Anim1,
    STATUS_SLEEP,     ANIM_Pokey_Anim26,
    STATUS_STOP,      ANIM_Pokey_Anim1,
    STATUS_PARALYZE,  ANIM_Pokey_Anim1,
...
s32 N(idleAnimations_802184B0)[] = {
    STATUS_NORMAL,    ANIM_Pokey_Anim6,
    STATUS_STONE,     ANIM_Pokey_Anim2,
    STATUS_SLEEP,     ANIM_Pokey_Anim27,
    STATUS_STOP,      ANIM_Pokey_Anim2,
    STATUS_PARALYZE,  ANIM_Pokey_Anim2,
...
s32 N(idleAnimations_802184EC)[] = {
    STATUS_NORMAL,    ANIM_Pokey_Anim7,
    STATUS_STONE,     ANIM_Pokey_Anim3,
    STATUS_SLEEP,     ANIM_Pokey_Anim28,
    STATUS_STOP,      ANIM_Pokey_Anim3,
    STATUS_PARALYZE,  ANIM_Pokey_Anim3,
...
EvtScript N(802193B8) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(0)
            ...
            EVT_END_IF
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_Anim8)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_Anim4)
        EVT_CASE_EQ(1)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LVar0)
            EVT_IF_NOT_FLAG(LVar0, STATUS_FLAG_SHRINK)
            ...
            EVT_END_IF
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_Anim9)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_Anim5)
        EVT_CASE_EQ(2)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LVar0)
            EVT_IF_NOT_FLAG(LVar0, STATUS_FLAG_SHRINK)
            ...
            EVT_END_IF
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_AnimA)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_Anim6)
    EVT_END_SWITCH
...
EvtScript N(8021AE2C) = {
    ...
    EVT_CHILD_THREAD
        ...
        EVT_CALL(SetAnimation, LVarB, 1, ANIM_Pokey_AnimC)
        ...
        EVT_WAIT(20)
        EVT_CALL(GetActorPos, LVarB, LVar0, LVar1, LVar2)
        EVT_CALL(SetAnimation, LVarB, 1, ANIM_Pokey_Anim4)
...
EvtScript N(8021B590) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_AnimB)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
    EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(2.0))
    EVT_EXEC_WAIT(D_8029C12C)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Pokey_Anim7)
    EVT_WAIT(4)
