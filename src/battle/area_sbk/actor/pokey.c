...
EvtScript N(handleEvent_802186C0) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_CALL(GetActorVar, ACTOR_SELF, 6, LocalVar(1))
            EVT_CALL(GetActorVar, ACTOR_SELF, 7, LocalVar(2))
            EVT_SET_CONST(LocalVar(0), 1)
        ...
        EVT_CASE_OR_EQ(EVENT_BURN_DEATH)
            ...
            EVT_END_IF
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_CALL(GetActorVar, ACTOR_SELF, 7, LocalVar(1))
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_EQ(EVENT_SPIKE_TAUNT)
            ...
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(0)
                    ...
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_00_Anim_21)
                EVT_CASE_EQ(1)
                    EVT_SET(LocalVar(0), 0)
                    EVT_SET(LocalVar(1), 59)
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_00_Anim_22)
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(0), 0)
                    EVT_SET(LocalVar(1), 41)
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_00_Anim_23)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(0), 0)
                    EVT_SET(LocalVar(1), 23)
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_00_Anim_24)
            EVT_END_SWITCH
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(3))
            EVT_IF_NOT_FLAG(LocalVar(3), STATUS_FLAG_SLEEP)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, LocalVar(2))
            EVT_END_IF
            EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(3), LocalVar(4), LocalVar(5))
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(6))
            EVT_IF_FLAG(LocalVar(6), STATUS_FLAG_SHRINK)
                EVT_MULF(LocalVar(0), EVT_FLOAT(0.4))
                EVT_MULF(LocalVar(1), EVT_FLOAT(0.4))
            EVT_END_IF
            EVT_ADDF(LocalVar(3), LocalVar(0))
            EVT_ADDF(LocalVar(4), LocalVar(1))
            EVT_CALL(PlayEffect, EFFECT_LENS_FLARE, 0, LocalVar(3), LocalVar(4), LocalVar(5), 20, 0, 0, 0, 0, 0, 0, 0, 0)
            EVT_WAIT(30)
...
EvtScript N(802193B8) = {
    ...
    EVT_IF_EQ(LocalVar(1), 1)
        EVT_GOTO(3)
    EVT_END_IF
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
    ...
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, STATUS_FLAG_100 | STATUS_FLAG_200 | STATUS_FLAG_POISON | STATUS_FLAG_80000000, LocalVar(1), BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
...
EvtScript N(80219EB4) = {
    ...
    EVT_SWITCH(LocalVar(2))
        EVT_CASE_EQ(ACTOR_TYPE_POKEY)
            ...
            EVT_IF_NOT_FLAG(LocalVar(3), STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_SHRINK | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
                EVT_CALL(GetActorVar, ACTOR_SELF, 0, LocalVar(3))
                EVT_IF_EQ(LocalVar(3), 0)
                    EVT_CALL(GetActorVar, LocalVar(0), 10, LocalVar(3))
...
EvtScript N(takeTurn_8021A018) = {
    ...
    EVT_IF_EQ(LocalVar(0), 0)
        ...
        EVT_SWITCH(LocalVar(9))
            EVT_CASE_EQ(1)
                ...
                EVT_IF_LT(LocalVar(0), 400)
                    EVT_EXEC_WAIT(N(8021AE2C))
                    EVT_RETURN
                EVT_END_IF
            EVT_CASE_EQ(2)
                EVT_CALL(RandInt, 1000, LocalVar(0))
                EVT_IF_LT(LocalVar(0), 200)
                    EVT_EXEC_WAIT(N(8021AE2C))
                    EVT_RETURN
                EVT_END_IF
            EVT_CASE_EQ(3)
    ...
    EVT_CHILD_THREAD
        ...
        EVT_SWITCH(LocalVar(10))
            EVT_CASE_EQ(0)
                ...
                EVT_END_IF
                EVT_CALL(JumpPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 15, 1)
            EVT_CASE_EQ(1)
                EVT_IF_NOT_FLAG(LocalVar(5), STATUS_FLAG_SHRINK)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 6, NPC_ANIM_pokey_Palette_00_Anim_16)
            EVT_CALL(JumpPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 1)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 6, NPC_ANIM_pokey_Palette_00_Anim_16)
    EVT_CALL(JumpPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 1)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, STATUS_FLAG_100 | STATUS_FLAG_200 | STATUS_FLAG_POISON | STATUS_FLAG_80000000, 2, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(GetActorVar, ACTOR_SELF, 2, LocalVar(1))
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, LocalVar(1))
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 6, EVT_FLOAT(0.1))
            EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 25, 0)
            EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, 6, EVT_FLOAT(4.0))
            EVT_SUB(LocalVar(0), 24)
            EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 21, 0)
            EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, 6, EVT_FLOAT(3.0))
            EVT_SUB(LocalVar(0), 20)
            EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 20, 0)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 6, ACTOR_PART_FLAG_INVISIBLE, 1)
        EVT_END_CASE_GROUP
    EVT_END_SWITCH
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
...
EvtScript N(8021AB44) = {
    ...
    EVT_IF_NE(LocalVar(0), -1)
        EVT_GOTO(0)
    EVT_END_IF
    EVT_CALL(GetIndexFromHome, ACTOR_SELF, LocalVar(1))
...
EvtScript N(8021AE2C) = {
    ...
    EVT_SUB(LocalVar(1), 80)
    EVT_CALL(SetActorPos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CHILD_THREAD
        EVT_CALL(PlayEffect, EFFECT_SHOCKWAVE, 2, LocalVar(0), 0, LocalVar(2), 0, 0, 0, 0, 0, 0, 0, 0, 0)
        EVT_CALL(UseIdleAnimation, LocalVar(11), FALSE)
        EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_pokey_Palette_00_Anim_C)
        EVT_CALL(GetActorPos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(SetActorJumpGravity, LocalVar(11), EVT_FLOAT(1.2))
        EVT_CALL(SetGoalPos, LocalVar(11), LocalVar(0), 0, LocalVar(2))
        EVT_CALL(JumpToGoal, LocalVar(11), 20, FALSE, TRUE, FALSE)
        EVT_WAIT(20)
        EVT_CALL(GetActorPos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_pokey_Palette_00_Anim_4)
        EVT_CALL(SetHomePos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(HPBarToHome, LocalVar(11))
        EVT_CALL(UseIdleAnimation, LocalVar(11), TRUE)
    EVT_END_CHILD_THREAD
    EVT_CALL(GetActorVar, ACTOR_SELF, 10, LocalVar(1))
    EVT_SWITCH(LocalVar(1))
        EVT_CASE_EQ(0)
            EVT_CALL(SetActorVar, LocalVar(11), 10, 1)
        EVT_CASE_EQ(1)
            EVT_CALL(SetActorVar, LocalVar(11), 10, 2)
    EVT_END_SWITCH
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
...
EvtScript N(8021B590) = {
    ...
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, STATUS_FLAG_100 | STATUS_FLAG_200 | STATUS_FLAG_POISON | STATUS_FLAG_80000000, 2, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_pokey_Palette_00_Anim_7)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
...
EvtScript N(8021CCAC) = {
    ...
    EVT_IF_NE(LocalVar(10), 3)
        ...
        EVT_ADD(LocalVar(0), 30)
        EVT_SET(LocalVar(1), 0)
        EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 10, 18, 0)
        EVT_ADD(LocalVar(0), 20)
        EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 8, 10, 0)
        EVT_LOOP(20)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 6, ACTOR_PART_FLAG_INVISIBLE, 1)
            EVT_WAIT(1)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 6, ACTOR_PART_FLAG_INVISIBLE, 0)
...
EvtScript N(8021D184) = {
    ...
    EVT_WAIT(5)
    EVT_CALL(SetActorVar, ACTOR_SELF, 0, LocalVar(2))
    EVT_SWITCH(LocalVar(2))
        EVT_CASE_EQ(0)
            EVT_SET(LocalVar(2), 96)
            EVT_SET(LocalVar(6), 4)
        EVT_CASE_EQ(1)
            EVT_SET(LocalVar(2), 72)
            EVT_SET(LocalVar(6), 3)
        EVT_CASE_EQ(2)
            EVT_SET(LocalVar(2), 48)
    ...
    EVT_CHILD_THREAD
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(10), LocalVar(11), LocalVar(12))
        EVT_LOOP(LocalVar(6))
            EVT_CALL(PlayEffect, EFFECT_SHOCKWAVE, 2, LocalVar(10), 0, LocalVar(12), 0, 0, 0, 0, 0, 0, 0, 0, 0)
            EVT_WAIT(10)
        EVT_END_LOOP
    EVT_END_CHILD_THREAD
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(2.0))
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_SUB(LocalVar(4), LocalVar(2))
    EVT_CALL(SetGoalPos, ACTOR_SELF, LocalVar(3), LocalVar(4), LocalVar(5))
