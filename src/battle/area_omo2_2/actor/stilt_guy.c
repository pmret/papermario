...
s32 N(idleAnimations2)[] = {
    STATUS_NORMAL, ANIM_StiltGuy_Anim1,
    STATUS_STONE, ANIM_StiltGuy_Anim0,
    STATUS_SLEEP, ANIM_StiltGuy_Anim4,
    STATUS_POISON, ANIM_StiltGuy_Anim1,
    STATUS_STOP, ANIM_StiltGuy_Anim0,
    STATUS_STATIC, ANIM_StiltGuy_Anim0,
    STATUS_PARALYZE, ANIM_StiltGuy_Anim0,
    STATUS_PARALYZE, ANIM_StiltGuy_Anim0,
    STATUS_DIZZY, ANIM_StiltGuy_Anim0,
    STATUS_FEAR, ANIM_StiltGuy_Anim0,
    STATUS_END,
};

s32 N(idleAnimations3)[] = {
    STATUS_NORMAL, ANIM_StiltGuyUnfold_Anim0,
    STATUS_END,
};
...
EvtScript N(init) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, 8, ANIM_StiltGuyUnfold_Anim3)
        ...
        EVT_CALL(SetAnimation, ACTOR_ENEMY0, 1, ANIM_GeneralGuy_AnimA)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, 7, ANIM_StiltGuyUnfold_Anim2)
        EVT_CALL(GetActorPos, ACTOR_ENEMY0, LVar0, LVar1, LVar2)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, 6, ANIM_StiltGuyUnfold_Anim1)
        EVT_CALL(GetActorPos, ACTOR_ENEMY0, LVar0, LVar1, LVar2)
        EVT_CALL(GetActorVar, ACTOR_SELF, 0, LVar0)
        EVT_IF_EQ(LVar0, 0)
            EVT_SET(LVar0, 10)
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, 5, ANIM_StiltGuyUnfold_Anim0)
        EVT_CALL(GetActorPos, ACTOR_ENEMY0, LVar0, LVar1, LVar2)
        EVT_CALL(GetActorVar, ACTOR_SELF, 0, LVar0)
        EVT_IF_EQ(LVar0, 0)
            EVT_SET(LVar0, 10)
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, 5, ANIM_StiltGuyUnfold_Anim5)
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, 5, ANIM_StiltGuyUnfold_Anim4)
        EVT_WAIT(5)
        EVT_LOOP(20)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 5, ACTOR_PART_FLAG_INVISIBLE, 0)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 2, ACTOR_PART_FLAG_INVISIBLE, 1)
...
EvtScript N(return_home) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_StiltGuy_Anim3)
    EVT_EXEC_WAIT(DoReturnHome)
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_StiltGuy_Anim1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_StiltGuy_Anim6)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_StiltGuy_Anim6)
            EVT_WAIT(1000)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_IF_NE(LVar0, 9)
                EVT_SET(LVar0, 2)
                EVT_SET(LVar1, ANIM_StiltGuy_Anim9)
                EVT_SET(LVar2, ANIM_StiltGuy_AnimA)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_StiltGuy_AnimA)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_StiltGuy_Anim7)
            EVT_EXEC_WAIT(N(onDeath))
            EVT_RETURN
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_StiltGuy_Anim1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_StiltGuy_Anim3)
            EVT_SET_CONST(LVar2, ANIM_StiltGuy_Anim3)
...
EvtScript N(attack) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_StiltGuy_Anim3)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_StiltGuy_Anim4)
    EVT_WAIT(8)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                ...
                EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_StiltGuy_Anim4)
            EVT_END_THREAD
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_StiltGuy_Anim5)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_SUB(LVar0, 15)
            EVT_SET(LVar1, 0)
...
EvtScript N(fallOff) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_AnimC)
    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    ...
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_StiltGuy_Anim8)
        EVT_SET(LVar0, 0)
        EVT_LOOP(15)
            EVT_ADD(LVar0, 6)
