...
EvtScript N(return_home) = {
    ...
    EVT_SET_CONST(LVar1, NPC_ANIM_stilt_guy_Palette_00_Anim_3)
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_stilt_guy_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_IF_NE(LVar0, 9)
                EVT_SET(LVar0, 2)
                EVT_SET(LVar1, NPC_ANIM_stilt_guy_Palette_00_Anim_9)
                EVT_SET(LVar2, NPC_ANIM_stilt_guy_Palette_00_Anim_A)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_stilt_guy_Palette_00_Anim_A)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_stilt_guy_Palette_00_Anim_7)
            EVT_EXEC_WAIT(N(onDeath))
            EVT_RETURN
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_stilt_guy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_stilt_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LVar2, NPC_ANIM_stilt_guy_Palette_00_Anim_3)
