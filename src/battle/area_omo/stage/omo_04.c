...
EvtScript N(init_8022E060) = {
    ...
    EVT_MUL(LW(0), 45)
    EVT_SET(ArrayVar(5), LW(0))
    EVT_CALL(RandInt, 8, LW(0))
    EVT_MUL(LW(0), 45)
    EVT_SET(ArrayVar(6), LW(0))
    EVT_CALL(RandInt, 8, LW(0))
    EVT_MUL(LW(0), 45)
    EVT_SET(ArrayVar(7), LW(0))
...
EvtScript N(idle_8022E1F8) = {
    ...
    EVT_IF_NE(LW(0), 0)
        EVT_GOTO(1)
    EVT_END_IF
    EVT_SET(LW(0), ArrayVar(2))
    EVT_ADD(LW(0), ArrayVar(3))
    EVT_ADD(LW(0), ArrayVar(4))
    EVT_IF_EQ(LW(0), 9)
        EVT_SET(LW(0), ArrayVar(5))
        EVT_DIV(LW(0), 45)
