...
EvtScript N(beforeBattle_8022DD30) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(0)
            EVT_ADD(LocalVar(14), 32768)
            EVT_CALL(SetTexPanOffset, 10, 0, LocalVar(14), 0)
            EVT_WAIT(10)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_RETURN
...
EvtScript N(init_8022E060) = {
    ...
    EVT_CALL(RandInt, 8, LocalVar(0))
    EVT_MUL(LocalVar(0), 45)
    EVT_SET(ArrayVar(5), LocalVar(0))
    EVT_CALL(RandInt, 8, LocalVar(0))
    EVT_MUL(LocalVar(0), 45)
    EVT_SET(ArrayVar(6), LocalVar(0))
    EVT_CALL(RandInt, 8, LocalVar(0))
    EVT_MUL(LocalVar(0), 45)
    EVT_SET(ArrayVar(7), LocalVar(0))
...
EvtScript N(idle_8022E1F8) = {
    ...
    EVT_IF_EQ(ArrayVar(1), 0)
        EVT_ADD(LocalVar(15), -277)
        EVT_CALL(SetTexPanOffset, 11, 0, 0, LocalVar(15))
    EVT_END_IF
    EVT_IF_EQ(ArrayVar(1), 1)
        EVT_ADD(LocalVar(15), -1110)
        EVT_CALL(SetTexPanOffset, 11, 0, 0, LocalVar(15))
    EVT_END_IF
    EVT_IF_EQ(ArrayVar(1), 2)
        EVT_ADD(LocalVar(15), -3330)
        EVT_CALL(SetTexPanOffset, 11, 0, 0, LocalVar(15))
    EVT_END_IF
    EVT_IF_EQ(ArrayVar(1), 2)
        EVT_GOTO(1)
    ...
    EVT_IF_NE(LocalVar(0), 0)
        EVT_GOTO(1)
    EVT_END_IF
    EVT_SET(LocalVar(0), ArrayVar(2))
    EVT_ADD(LocalVar(0), ArrayVar(3))
    EVT_ADD(LocalVar(0), ArrayVar(4))
    EVT_IF_EQ(LocalVar(0), 9)
        EVT_SET(LocalVar(0), ArrayVar(5))
        EVT_DIV(LocalVar(0), 45)
        EVT_USE_BUF(EVT_ADDR(N(intTable_8022DED4)))
        EVT_BUF_PEEK(LocalVar(10), LocalVar(0))
        EVT_SET(LocalVar(0), ArrayVar(6))
        EVT_DIV(LocalVar(0), 45)
        EVT_USE_BUF(EVT_ADDR(N(intTable_8022DEF4)))
        EVT_BUF_PEEK(LocalVar(11), LocalVar(0))
        EVT_SET(LocalVar(0), ArrayVar(7))
        EVT_DIV(LocalVar(0), 45)
        EVT_USE_BUF(EVT_ADDR(N(intTable_8022DF14)))
        EVT_BUF_PEEK(LocalVar(12), LocalVar(0))
        EVT_LOOP(0)
            EVT_IF_NE(LocalVar(10), LocalVar(11))
                EVT_BREAK_LOOP
            EVT_END_IF
            EVT_IF_NE(LocalVar(10), LocalVar(12))
                EVT_BREAK_LOOP
            EVT_END_IF
            EVT_IF_NE(LocalVar(11), LocalVar(12))
                EVT_BREAK_LOOP
            EVT_END_IF
            EVT_THREAD
