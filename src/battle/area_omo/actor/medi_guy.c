...
extern EvtScript N(init_80223568);
extern EvtScript N(takeTurn_8022494C);
extern EvtScript N(idle_8022360C);
extern EvtScript N(handleEvent_802237E0);

s32 N(idleAnimations_80223410)[] = {
...
s32 N(defenseTable_8022345C)[] = {
    ELEMENT_NORMAL, 0,
    ELEMENT_SHOCK, 0,
    ELEMENT_END,
};

s32 N(statusTable_80223470)[] = {
    STATUS_NORMAL, 0,
    STATUS_DEFAULT, 0,
    STATUS_SLEEP, 70,
    STATUS_POISON, 50,
...
ActorPartBlueprint N(partsTable_8022351C)[] = {
    {
        ...
        .targetOffset = { -2, 38 },
        .opacity = 255,
        .idleAnimations = N(idleAnimations_80223410),
        .defenseTable = N(defenseTable_8022345C),
...
ActorBlueprint NAMESPACE = {
    ...
    .level = 14,
    .maxHP = 7,
    .partCount = ARRAY_COUNT(N(partsTable_8022351C)),
    .partsData = N(partsTable_8022351C),
    .script = N(init_80223568),
    .statusTable = N(statusTable_80223470),
    .escapeChance = 60,
    .airLiftChance = 90,
    .spookChance = 95,
    .baseStatusChance = 70,
...
EvtScript N(init_80223568) = {
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_8022494C)))
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_8022360C)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_802237E0)))
...
EvtScript N(handleEvent_802237E0) = {
...
EvtScript N(takeTurn_8022494C) = {
    EVT_EXEC_WAIT(N(8022486C))
    EVT_IF_EQ(LW(0), -1)
