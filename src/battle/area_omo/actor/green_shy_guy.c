...
s32 N(idleAnimations_8021FF1C)[] = {
    STATUS_NORMAL,    ANIM_ShyGuy_Green_Anim1,
    STATUS_STONE,     ANIM_ShyGuy_Green_Anim0,
    STATUS_SLEEP,     ANIM_ShyGuy_Green_Anim12,
    STATUS_POISON,    ANIM_ShyGuy_Green_Anim1,
    STATUS_STOP,      ANIM_ShyGuy_Green_Anim0,
    STATUS_STATIC,    ANIM_ShyGuy_Green_Anim1,
    STATUS_PARALYZE,  ANIM_ShyGuy_Green_Anim0,
...
EvtScript N(802200C4) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_ShyGuy_Green_Anim3)
    EVT_EXEC_WAIT(DoReturnHome)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent_80220128) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Green_AnimC)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Green_AnimD)
            EVT_SET_CONST(LVar2, ANIM_ShyGuy_Green_AnimE)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Green_AnimE)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Green_Anim1)
...
EvtScript N(80220604) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim3)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim4)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim5)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
            ...
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Green_Anim4)
            EVT_EXEC_WAIT(DoReturnHome)
...
EvtScript N(80220D2C) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim9)
    EVT_WAIT(20)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim3)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                EVT_WAIT(12)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_AnimA)
            EVT_END_THREAD
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim9)
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim7)
            EVT_WAIT(15)
            EVT_GOTO(2)
            EVT_LABEL(1)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            ...
            EVT_IF_LT(LVar0, 50)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim11)
            EVT_ELSE
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Green_Anim13)
            EVT_END_IF
            EVT_WAIT(25)
            EVT_CALL(RemoveActorDecoration, ACTOR_SELF, 1, 0)
            EVT_CALL(SetActorYaw, ACTOR_SELF, 180)
