...
s32 N(idleAnimations_8022CB00)[] = {
    STATUS_NORMAL,    ANIM_PyroGuy_Anim1,
    STATUS_STONE,     ANIM_PyroGuy_Anim0,
    STATUS_SLEEP,     ANIM_PyroGuy_Anim7,
    STATUS_POISON,    ANIM_PyroGuy_Anim1,
    STATUS_STOP,      ANIM_PyroGuy_Anim0,
    STATUS_STATIC,    ANIM_PyroGuy_Anim1,
    STATUS_PARALYZE,  ANIM_PyroGuy_Anim0,
    STATUS_DIZZY,     ANIM_PyroGuy_Anim8,
    STATUS_FEAR,      ANIM_PyroGuy_Anim8,
    STATUS_END,
};
...
EvtScript N(8022CDDC) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_PyroGuy_Anim4)
    EVT_SET_CONST(LVar2, ANIM_PyroGuy_Anim1)
...
EvtScript N(handleEvent_8022CE60) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_PyroGuy_Anim6)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_PyroGuy_Anim1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_PyroGuy_Anim3)
            EVT_SET_CONST(LVar2, ANIM_PyroGuy_Anim9)
...
EvtScript N(takeTurn_8022D344) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_PyroGuy_Anim3)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
    ...
    EVT_CALL(SetActorSounds, ACTOR_SELF, 0, 8378, 948)
    EVT_CALL(SetActorSounds, ACTOR_SELF, 4, 10, 0)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_PyroGuy_Anim4)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_PyroGuy_Anim5)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_PyroGuy_Anim1)
            EVT_WAIT(8)
            EVT_CALL(YieldTurn)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
            EVT_EXEC_WAIT(N(8022CDDC))
