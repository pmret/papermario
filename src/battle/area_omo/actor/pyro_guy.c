...
EvtScript N(8022CDDC) = {
    ...
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_pyro_guy_Palette_00_Anim_4)
    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pyro_guy_Palette_00_Anim_1)
...
EvtScript N(handleEvent_8022CE60) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_pyro_guy_Palette_00_Anim_6)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_pyro_guy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_pyro_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_pyro_guy_Palette_00_Anim_9)
