...
ActorPartBlueprint N(partsTable_8021ADD0)[] = {
    {
        ...
        .projectileTargetOffset = { 0xFF, 0xF6 },
    },
};
...
s32 N(idleAnimations_8021AE1C)[] = {
    ...
    STATUS_POISON,    ANIM_ShyGuy_Blue_Anim01,
    STATUS_STOP,      ANIM_ShyGuy_Blue_Anim00,
    STATUS_STATIC,    ANIM_ShyGuy_Blue_Anim01,
    STATUS_PARALYZE,  ANIM_ShyGuy_Blue_Anim00,
