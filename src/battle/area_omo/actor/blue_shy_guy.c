...
EvtScript N(8021AFC4) = {
    ...
    EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_01_Anim_3)
...
EvtScript N(handleEvent_8021B028) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_01_Anim_C)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_01_Anim_D)
            EVT_SET_CONST(LVar2, NPC_ANIM_shy_guy_Palette_01_Anim_E)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_01_Anim_E)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_01_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_01_Anim_3)
            EVT_SET_CONST(LVar2, NPC_ANIM_shy_guy_Palette_01_Anim_14)
...
EvtScript N(8021B504) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_01_Anim_4)
            EVT_EXEC_WAIT(DoReturnHome)
