...
s32 N(idleAnimations_802294C0)[] = {
    STATUS_NORMAL,    ANIM_SkyGuy_Anim1,
    STATUS_STONE,     ANIM_SkyGuy_Anim0,
    STATUS_SLEEP,     ANIM_SkyGuy_Anim4,
    STATUS_POISON,    ANIM_SkyGuy_Anim1,
    STATUS_STOP,      ANIM_SkyGuy_Anim0,
    STATUS_STATIC,    ANIM_SkyGuy_Anim1,
    STATUS_PARALYZE,  ANIM_SkyGuy_Anim0,
    STATUS_DIZZY,     ANIM_SkyGuy_Anim5,
    STATUS_FEAR,      ANIM_SkyGuy_Anim5,
    STATUS_END,
};

s32 N(idleAnimations_8022950C)[] = {
    STATUS_NORMAL,    ANIM_SkyGuy_Anim10,
    STATUS_STONE,     ANIM_SkyGuy_AnimD,
    STATUS_SLEEP,     ANIM_SkyGuy_Anim19,
    STATUS_POISON,    ANIM_SkyGuy_Anim10,
    STATUS_STOP,      ANIM_SkyGuy_AnimD,
    STATUS_STATIC,    ANIM_SkyGuy_Anim10,
    STATUS_PARALYZE,  ANIM_SkyGuy_AnimD,
...
s32 N(idleAnimations_80229558)[] = {
    STATUS_NORMAL,    ANIM_SkyGuy_AnimF,
    STATUS_STONE,     ANIM_SkyGuy_AnimC,
    STATUS_SLEEP,     ANIM_SkyGuy_Anim18,
    STATUS_POISON,    ANIM_SkyGuy_AnimF,
    STATUS_STOP,      ANIM_SkyGuy_AnimC,
    STATUS_STATIC,    ANIM_SkyGuy_AnimF,
    STATUS_PARALYZE,  ANIM_SkyGuy_AnimC,
    STATUS_DIZZY,     ANIM_SkyGuy_AnimF,
    STATUS_FEAR,      ANIM_SkyGuy_AnimF,
    STATUS_END,
};

s32 N(idleAnimations_802295A4)[] = {
    STATUS_NORMAL,    ANIM_SkyGuy_Anim11,
    STATUS_STONE,     ANIM_SkyGuy_AnimE,
    STATUS_SLEEP,     ANIM_SkyGuy_Anim1A,
    STATUS_POISON,    ANIM_SkyGuy_Anim11,
    STATUS_STOP,      ANIM_SkyGuy_AnimE,
    STATUS_STATIC,    ANIM_SkyGuy_Anim11,
    STATUS_PARALYZE,  ANIM_SkyGuy_AnimE,
...
s32 N(idleAnimations_802295F0)[] = {
    STATUS_NORMAL,    ANIM_SkyGuy_AnimB,
    STATUS_END,
};
...
EvtScript N(80229C40) = {
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_SkyGuy_Anim2)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_ELSE
                ...
                EVT_SET_CONST(LVar1, ANIM_SkyGuy_Anim6)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_SkyGuy_Anim9)
            EVT_SET_CONST(LVar2, ANIM_SkyGuy_AnimA)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_SkyGuy_AnimA)
        ...
        EVT_CASE_EQ(EVENT_UNKNOWN_TRIGGER)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 2)
                EVT_SET_CONST(LVar1, ANIM_SkyGuy_Anim1)
        ...
        EVT_CASE_EQ(EVENT_END_FIRST_STRIKE)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_SkyGuy_Anim3)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_CALL(FlyToGoal, ACTOR_SELF, 0, 1, 0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_SkyGuy_Anim1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_SkyGuy_Anim3)
            EVT_SET_CONST(LVar2, ANIM_SkyGuy_Anim6)
        ...
        EVT_CASE_EQ(EVENT_BLOW_AWAY)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_SkyGuy_Anim7)
...
EvtScript N(takeTurn_8022A9D0) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_SkyGuy_Anim8)
    EVT_WAIT(12)
    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_ADD(LVar1, 20)
    EVT_ADD(LVar2, 2)
    EVT_CALL(SetPartPos, ACTOR_SELF, 6, LVar0, LVar1, LVar2)
    EVT_CALL(SetAnimation, ACTOR_SELF, 6, ANIM_SkyGuy_AnimB)
    EVT_WAIT(12)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_SkyGuy_Anim7)
