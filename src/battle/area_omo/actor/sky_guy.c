...
EvtScript N(80229A34) = {
    EVT_CALL(GetActorVar, ACTOR_SELF, 8, LocalVar(2))
    EVT_IF_NE(LocalVar(2), 0)
        EVT_EXEC_WAIT(DoDeath)
    EVT_ELSE
        EVT_CALL(SetActorVar, ACTOR_SELF, 8, 1)
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(7), LocalVar(8), LocalVar(9))
        EVT_ADD(LocalVar(8), 20)
        EVT_CALL(PlayEffect, EFFECT_BALLOON, 2, LocalVar(7), LocalVar(8), LocalVar(9), EVT_FLOAT(1.0), 150, 0, 0, 0, 0, 0, 0, 0)
        EVT_SUB(LocalVar(7), 14)
        EVT_SUB(LocalVar(8), 4)
        EVT_CALL(PlayEffect, EFFECT_BALLOON, 0, LocalVar(7), LocalVar(8), LocalVar(9), EVT_FLOAT(1.0), 150, 0, 0, 0, 0, 0, 0, 0)
        EVT_ADD(LocalVar(7), 28)
        EVT_CALL(PlayEffect, EFFECT_BALLOON, 1, LocalVar(7), LocalVar(8), LocalVar(9), EVT_FLOAT(1.0), 150, 0, 0, 0, 0, 0, 0, 0)
...
EvtScript N(80229CB0) = {
    ...
    EVT_SETF(LocalVar(2), EVT_FLOAT(2.0))
    EVT_SUBF(LocalVar(2), LocalVar(0))
    EVT_CALL(SetPartScale, ACTOR_SELF, 3, LocalVar(2), LocalVar(0), EVT_FLOAT(1.0))
    EVT_CALL(SetPartScale, ACTOR_SELF, 4, LocalVar(2), LocalVar(0), EVT_FLOAT(1.0))
    EVT_CALL(SetPartScale, ACTOR_SELF, 5, LocalVar(2), LocalVar(0), EVT_FLOAT(1.0))
    EVT_WAIT(1)
...
EvtScript N(80229F08) = {
    ...
    EVT_SET(LocalVar(0), 65536)
    EVT_IF_FLAG(LocalVar(0), DAMAGE_TYPE_FIRE | DAMAGE_TYPE_BLAST | DAMAGE_TYPE_4000 | DAMAGE_TYPE_SPINY_SURGE)
        ...
        EVT_CALL(PlayEffect, EFFECT_EMOTE, 2, 0, LocalVar(0), LocalVar(1), LocalVar(2), 24, 0, 25, 0, 0, 0, 0, 0)
        EVT_WAIT(25)
...
EvtScript N(handleEvent_8022A398) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_IF_GE(LocalVar(1), 3)
                EVT_EXEC_WAIT(N(80229CB0))
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 2)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_sky_guy_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_sky_guy_Palette_00_Anim_9)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_sky_guy_Palette_00_Anim_A)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_sky_guy_Palette_00_Anim_A)
        ...
        EVT_CASE_EQ(EVENT_UNKNOWN_TRIGGER)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 2)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_sky_guy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_sky_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_sky_guy_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_BLOW_AWAY)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_sky_guy_Palette_00_Anim_7)
...
EvtScript N(takeTurn_8022A9D0) = {
    ...
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 3, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 6, EVT_FLOAT(0.1))
            EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 30, 0)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 6, EVT_FLOAT(0.1))
            EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 15, 0)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 6, ACTOR_PART_FLAG_INVISIBLE, 1)
            EVT_EXEC_WAIT(N(80229C40))
            EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
            EVT_CALL(UseIdleAnimation, ACTOR_SELF, TRUE)
    ...
    EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 15, 0)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), DAMAGE_TYPE_NO_CONTACT, 0, 0, 3, BS_FLAGS1_SP_EVT_ACTIVE)
