...
EvtScript N(80224CAC) = {
    ...
    EVT_SET_CONST(LVar1, NPC_ANIM_groove_guy_Palette_00_Anim_4)
...
EvtScript N(handleEvent_80224D10) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_groove_guy_Palette_00_Anim_8)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_groove_guy_Palette_00_Anim_E)
            EVT_SET_CONST(LVar2, NPC_ANIM_groove_guy_Palette_00_Anim_F)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_groove_guy_Palette_00_Anim_F)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_groove_guy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_groove_guy_Palette_00_Anim_4)
            EVT_SET_CONST(LVar2, NPC_ANIM_groove_guy_Palette_00_Anim_11)
...
EvtScript N(80226C00) = {
    ...
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_shy_guy_Palette_00_Anim_4)
    ...
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_shy_guy_Palette_00_Anim_1)
...
EvtScript N(80226DEC) = {
    ...
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_groove_guy_Palette_00_Anim_A)
    EVT_CALL(GetActorPos, LVarB, LVar0, LVar1, LVar2)
    EVT_ADD(LVar1, 20)
    ...
    EVT_CALL(ForceHomePos, LVarB, LVar0, LVar1, LVar2)
    EVT_WAIT(25)
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_groove_guy_Palette_00_Anim_1)
    EVT_CALL(HPBarToHome, LVarB)
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
    EVT_CALL(UseIdleAnimation, ACTOR_SELF, TRUE)
    EVT_CALL(GetActorVar, ACTOR_SELF, 0, LVar0)
...
EvtScript N(802271A0) = {
    ...
    EVT_CALL(SetActorSpeed, LVarB, EVT_FLOAT(4.0))
    EVT_CALL(RunToGoal, LVarB, 0, FALSE)
    EVT_CALL(SetAnimation, LVarB, 1, NPC_ANIM_medi_guy_Palette_00_Anim_1)
    EVT_CALL(GetActorPos, LVarB, LVar0, LVar1, LVar2)
    EVT_CALL(ForceHomePos, LVarB, LVar0, LVar1, LVar2)
    EVT_CALL(HPBarToHome, LVarB)
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
