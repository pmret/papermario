...
EvtScript N(80224CAC) = {
    ...
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_groove_guy_Palette_00_Anim_4)
...
EvtScript N(handleEvent_80224D10) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_groove_guy_Palette_00_Anim_8)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_groove_guy_Palette_00_Anim_E)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_groove_guy_Palette_00_Anim_F)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_groove_guy_Palette_00_Anim_F)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_groove_guy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_groove_guy_Palette_00_Anim_4)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_groove_guy_Palette_00_Anim_11)
...
EvtScript N(sleepySpin) = {
    ...
    EVT_LOOP(30)
        ...
        EVT_MOD(LocalVar(0), 360)
        EVT_CALL(SetActorYaw, ACTOR_SELF, LocalVar(0))
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(SetActorYaw, ACTOR_SELF, 0)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), 0, 0, 1, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_MISS)
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_groove_guy_Palette_00_Anim_B)
            EVT_WAIT(20)
            EVT_IF_EQ(LocalVar(0), HIT_RESULT_LUCKY)
    ...
    EVT_END_SWITCH
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_STATUS_ALWAYS_HITS, 0, 0x00000002 | 0x00000010 | STATUS_FLAG_20 | STATUS_FLAG_200 | STATUS_FLAG_DIZZY | STATUS_FLAG_80000000, 0, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            EVT_CALL(WasStatusInflicted, ACTOR_SELF, LocalVar(0))
...
EvtScript N(8022671C) = {
    ...
    EVT_END_IF
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(func_8021878C_512D5C, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 48)
    EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x2E6)
    EVT_SET(LocalVar(0), 0)
    EVT_LOOP(48)
        EVT_ADD(LocalVar(0), 30)
        EVT_IF_GE(LocalVar(0), 360)
...
EvtScript N(80226C00) = {
    ...
    EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_shy_guy_Palette_00_Anim_4)
    ...
    EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_shy_guy_Palette_00_Anim_1)
...
EvtScript N(80226DEC) = {
    ...
    EVT_SET(LocalVar(11), LocalVar(0))
    EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_groove_guy_Palette_00_Anim_C)
    EVT_CALL(SetGoalToIndex, LocalVar(11), LocalVar(10))
    EVT_CALL(GetGoalPos, LocalVar(11), LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_ADD(LocalVar(3), 200)
    EVT_CALL(SetActorPos, LocalVar(11), LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_THREAD
        EVT_SET(LocalVar(6), 0)
        EVT_LOOP(50)
            EVT_ADD(LocalVar(6), 30)
            EVT_MOD(LocalVar(6), 360)
            EVT_CALL(SetActorYaw, LocalVar(11), LocalVar(6))
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_CALL(SetActorYaw, LocalVar(11), 0)
    EVT_END_THREAD
    EVT_CALL(SetActorSounds, LocalVar(11), 0, 0, 0)
    EVT_THREAD
        EVT_LOOP(2)
            EVT_CALL(PlaySoundAtActor, LocalVar(11), 0x2E2)
            EVT_WAIT(25)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(SetActorSpeed, LocalVar(11), EVT_FLOAT(4.0))
    ...
    EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_groove_guy_Palette_00_Anim_A)
    EVT_CALL(GetActorPos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_CALL(ForceHomePos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_WAIT(25)
    EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_groove_guy_Palette_00_Anim_1)
    EVT_CALL(HPBarToHome, LocalVar(11))
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
    EVT_CALL(UseIdleAnimation, ACTOR_SELF, TRUE)
    EVT_CALL(GetActorVar, ACTOR_SELF, 0, LocalVar(0))
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(0)
            EVT_CALL(SetActorVar, LocalVar(11), 0, 1)
        EVT_CASE_EQ(1)
            EVT_CALL(SetActorVar, LocalVar(11), 0, 2)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(802271A0) = {
    ...
    EVT_SET(LocalVar(11), LocalVar(0))
    EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_medi_guy_Palette_00_Anim_5)
    EVT_ADD(LocalVar(10), 4)
    EVT_CALL(SetGoalToIndex, LocalVar(11), LocalVar(10))
    EVT_CALL(GetGoalPos, LocalVar(11), LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_SET(LocalVar(0), 200)
    ...
    EVT_CALL(SetActorPos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(SetActorSounds, LocalVar(11), 0, 896, 0)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_D)
    EVT_CALL(BattleCamTargetActor, ACTOR_SELF)
    EVT_CALL(SetActorSpeed, LocalVar(11), EVT_FLOAT(4.0))
    EVT_CALL(RunToGoal, LocalVar(11), 0, FALSE)
    EVT_CALL(SetAnimation, LocalVar(11), 1, NPC_ANIM_medi_guy_Palette_00_Anim_1)
    EVT_CALL(GetActorPos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(ForceHomePos, LocalVar(11), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(HPBarToHome, LocalVar(11))
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
