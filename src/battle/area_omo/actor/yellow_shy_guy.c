...
s32 N(idleAnimations_8021C91C)[] = {
    ...
    STATUS_POISON,    ANIM_ShyGuy_Yellow_Anim01,
    STATUS_STOP,      ANIM_ShyGuy_Yellow_Anim00,
    STATUS_STATIC,    ANIM_ShyGuy_Yellow_Anim01,
    STATUS_PARALYZE,  ANIM_ShyGuy_Yellow_Anim00,
...
EvtScript N(8021CAC4) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Yellow_Anim01)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(8021D004) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Yellow_Anim04)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Yellow_Anim05)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
...
EvtScript N(8021D72C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                EVT_WAIT(12)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Yellow_Anim0A)
            EVT_END_THREAD
