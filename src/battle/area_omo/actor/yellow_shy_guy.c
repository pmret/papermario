...
s32 N(idleAnimations_8021C91C)[] = {
    STATUS_NORMAL,    NPC_ANIM_shy_guy_Palette_04_Anim_1,
    STATUS_STONE,     NPC_ANIM_shy_guy_Palette_04_Anim_0,
    STATUS_SLEEP,     NPC_ANIM_shy_guy_Palette_04_Anim_12,
    STATUS_POISON,    NPC_ANIM_shy_guy_Palette_04_Anim_1,
    STATUS_STOP,      NPC_ANIM_shy_guy_Palette_04_Anim_0,
    STATUS_STATIC,    NPC_ANIM_shy_guy_Palette_04_Anim_1,
    STATUS_PARALYZE,  NPC_ANIM_shy_guy_Palette_04_Anim_0,
    STATUS_DIZZY,     NPC_ANIM_shy_guy_Palette_04_Anim_13,
    STATUS_FEAR,      NPC_ANIM_shy_guy_Palette_04_Anim_13,
    STATUS_END,
};

EvtScript N(init_8021C968) = {
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_8021E2B4)))
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_8021C9B4)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_8021CB28)))
    EVT_RETURN
    EVT_END
};
...
EvtScript N(8021CAC4) = {
    EVT_CALL(ResetAllActorSounds, ACTOR_SELF)
    EVT_SET_CONST(LocalVar(0), 1)
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_shy_guy_Palette_04_Anim_3)
    EVT_EXEC_WAIT(DoReturnHome)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent_8021CB28) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_shy_guy_Palette_04_Anim_C)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_shy_guy_Palette_04_Anim_D)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_shy_guy_Palette_04_Anim_E)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_shy_guy_Palette_04_Anim_E)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_shy_guy_Palette_04_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_shy_guy_Palette_04_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_shy_guy_Palette_04_Anim_14)
...
EvtScript N(8021D004) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_3)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_4)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_5)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
            ...
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_shy_guy_Palette_04_Anim_4)
            EVT_EXEC_WAIT(DoReturnHome)
...
EvtScript N(8021D72C) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_9)
    EVT_WAIT(20)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_3)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                EVT_WAIT(12)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_A)
            EVT_END_THREAD
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_9)
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_7)
            EVT_WAIT(15)
            EVT_GOTO(2)
            EVT_LABEL(1)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_10)
            EVT_WAIT(10)
            EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20C3)
            EVT_CALL(AddActorDecoration, ACTOR_SELF, 1, 0, 2)
            EVT_CALL(RandInt, 100, LocalVar(0))
            EVT_IF_LT(LocalVar(0), 50)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_11)
            EVT_ELSE
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_shy_guy_Palette_04_Anim_13)
            EVT_END_IF
            EVT_WAIT(25)
            EVT_CALL(RemoveActorDecoration, ACTOR_SELF, 1, 0)
            EVT_CALL(SetActorYaw, ACTOR_SELF, 180)
...
EvtScript N(takeTurn_8021E2B4) = {
    EVT_CALL(RandInt, 1, LocalVar(0))
    EVT_IF_EQ(LocalVar(0), 0)
        EVT_EXEC_WAIT(N(8021D004))
    EVT_ELSE
        EVT_EXEC_WAIT(N(8021D72C))
    EVT_END_IF
    EVT_RETURN
    EVT_END
};
