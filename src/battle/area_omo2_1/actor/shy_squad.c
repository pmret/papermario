    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(PHASE_PLAYER_BEGIN)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_CALL(ActorSpeak, MESSAGE_ID_0F0065, ACTOR_SELF, 9, NPC_ANIM_shy_squad_guy_Palette_00_Anim_11, NPC_ANIM_shy_squad_guy_Palette_00_Anim_11)
                EVT_SET(LVar0, 2)
                EVT_LOOP(15)
...
EvtScript N(flee) = {
    ...
    EVT_CALL(MoveBattleCamOver, 30)
    EVT_WAIT(30)
    EVT_CALL(ActorSpeak, MESSAGE_ID_0F0066, ACTOR_SELF, 1, -1, -1)
    ...
    EVT_CALL(GetActorVar, ACTOR_SELF, N(ACTOR_VARS_GUYS_KILLED), LVar0)
    EVT_IF_LT(LVar0, 14)
        EVT_CALL(ActorSpeak, MESSAGE_ID_0F0067, ACTOR_ENEMY0, 1, -1, -1)
    EVT_ELSE
        EVT_CALL(ActorSpeak, MESSAGE_ID_0F0068, ACTOR_ENEMY0, 1, -1, -1)
    EVT_END_IF
    EVT_THREAD
        EVT_CALL(PlaySoundAtActor, ACTOR_SELF, SOUND_1E2)
