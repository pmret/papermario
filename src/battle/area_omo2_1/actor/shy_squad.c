    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(PHASE_PLAYER_BEGIN)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_SET(LVar0, 2)
                EVT_LOOP(15)
                    EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, NPC_ANIM_shy_squad_guy_Palette_00_Anim_3)
                    EVT_ADD(LVar0, 1)
                EVT_END_LOOP
                ...
                EVT_SET(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_3)
                ...
                EVT_CALL(ActorSpeak, MESSAGE_ID(0x0F0065), ACTOR_SELF, 9, NPC_ANIM_shy_squad_guy_Palette_00_Anim_11, NPC_ANIM_shy_squad_guy_Palette_00_Anim_11)
                EVT_SET(LVar0, 2)
                EVT_LOOP(15)
                    EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, NPC_ANIM_shy_squad_guy_Palette_00_Anim_A)
                    EVT_ADD(LVar0, 1)
                EVT_END_LOOP
                ...
                EVT_SET(LVar0, 2)
                EVT_LOOP(15)
                    EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, NPC_ANIM_shy_squad_guy_Palette_00_Anim_1)
                    EVT_ADD(LVar0, 1)
                EVT_END_LOOP
            EVT_END_IF
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVarF)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_D)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_CALL(SetActorVar, ACTOR_SELF, N(ACTOR_VAR_WAS_ATTACKED), 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_E)
            EVT_EXEC_WAIT(N(onHit))
            EVT_SET(LVar0, 2)
            EVT_LOOP(15)
                EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, NPC_ANIM_shy_squad_guy_Palette_00_Anim_E)
                EVT_ADD(LVar0, 1)
            EVT_END_LOOP
            EVT_WAIT(20)
            EVT_SET(LVar0, 2)
            EVT_LOOP(15)
                EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, NPC_ANIM_shy_squad_guy_Palette_00_Anim_F)
                EVT_ADD(LVar0, 1)
            EVT_END_LOOP
            EVT_WAIT(15)
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(15)
            EVT_WAIT(10)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_F)
            EVT_EXEC_WAIT(N(onDeath))
            EVT_RETURN
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            ...
            EVT_IF_FLAG(LVar2, BS_FLAGS1_80000)
                ...
                EVT_IF_EQ(LVar2, MOVE_SPOOK)
                    EVT_SET(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_1)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_1)
            EVT_EXEC_WAIT(N(displace_last_guy))
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_8)
            EVT_EXEC_WAIT(N(set_alive_guys_animation))
            EVT_WAIT(1000)
...
EvtScript N(attack) = {
    ...
    EVT_LOOP(15)
        ...
        EVT_IF_LT(LVar7, 50)
            EVT_SET(LVar7, NPC_ANIM_shy_squad_guy_Palette_00_Anim_D)
        EVT_ELSE
            EVT_SET(LVar7, NPC_ANIM_shy_squad_guy_Palette_00_Anim_11)
        EVT_END_IF
    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
            EVT_CALL(SetActorYaw, ACTOR_SELF, 180)
            EVT_SET(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_4)
            EVT_EXEC_WAIT(N(move_squad_to_home))
            EVT_SET(LVar1, NPC_ANIM_shy_squad_guy_Palette_00_Anim_1)
            EVT_EXEC_WAIT(N(set_alive_guys_animation))
            EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
...
EvtScript N(flee) = {
    ...
    EVT_SET(LVar0, 2)
    EVT_LOOP(15)
        EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, NPC_ANIM_shy_squad_guy_Palette_00_Anim_8)
        EVT_ADD(LVar0, 1)
    EVT_END_LOOP
    ...
    EVT_CALL(MoveBattleCamOver, 30)
    EVT_WAIT(30)
    EVT_CALL(ActorSpeak, MESSAGE_ID(0x0F0066), ACTOR_SELF, 1, -1, -1)
    ...
    EVT_CALL(GetActorVar, ACTOR_SELF, N(ACTOR_VARS_GUYS_KILLED), LVar0)
    EVT_IF_LT(LVar0, 14)
        EVT_CALL(ActorSpeak, MESSAGE_ID(0x0F0067), ACTOR_ENEMY0, 1, -1, -1)
    EVT_ELSE
        EVT_CALL(ActorSpeak, MESSAGE_ID(0x0F0068), ACTOR_ENEMY0, 1, -1, -1)
    EVT_END_IF
    EVT_THREAD
        EVT_CALL(PlaySoundAtActor, ACTOR_SELF, SOUND_1E2)
