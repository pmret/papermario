...
extern ActorDesc b_area_isk_part_2_chain_chomp;
extern EvtSource N(init_8021BC1C);
extern EvtSource N(takeTurn_8021CCD4);
extern EvtSource N(idle_8021BE28);
extern EvtSource N(handleEvent_8021BFD0);
extern EvtSource N(nextTurn_8021F9C4);
extern EvtSource N(8021C748);
extern EvtSource N(8021C974);
extern EvtSource N(8021D04C);
extern EvtSource N(8021D81C);
extern EvtSource N(8021DDE8);
extern EvtSource N(8021E008);
extern EvtSource N(8021E9C8);
extern EvtSource N(8021F42C);
extern EvtSource N(8021F5E8);
extern EvtSource N(8021F80C);
extern EvtSource N(8021FA54);
...
ActorPartDesc N(partsTable_8021BAD4)[] = {
    {
...
EvtSource N(handleEvent_8021BFD0) = {
    ...
    EVT_SWITCH(LW(0))
        ...
        EVT_CASE_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LW(1), NPC_ANIM_tutankoopa_Palette_00_Anim_6)
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_CALL(GetActorVar, ACTOR_SELF, 13, LW(2))
            EVT_IF_NE(LW(2), 0)
                EVT_CALL(SetActorVar, ACTOR_SELF, 13, 0)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_tutankoopa_Palette_00_Anim_E)
            ...
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_tutankoopa_Palette_00_Anim_2)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            ...
            EVT_IF_EQ(LW(1), 1)
                ...
                EVT_IF_NE(LW(1), 0)
                    EVT_SET_CONST(LW(1), NPC_ANIM_tutankoopa_Palette_00_Anim_A)
                EVT_ELSE
                    EVT_SET_CONST(LW(1), NPC_ANIM_tutankoopa_Palette_00_Anim_1)
                EVT_END_IF
            EVT_ELSE
                EVT_SET_CONST(LW(1), NPC_ANIM_tutankoopa_Palette_00_Anim_1)
            EVT_END_IF
        ...
        EVT_CASE_EQ(EVENT_SPIKE_TAUNT)
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LW(1))
            EVT_IF_EQ(LW(1), 0)
                EVT_IF_FLAG(LW(14), DAMAGE_TYPE_JUMP)
...
EvtSource N(8021C974) = {
    ...
    EVT_THREAD
        EVT_CALL(SetPartScale, ACTOR_SELF, 1, EVT_FLOAT(1.1005859375), EVT_FLOAT(0.5), EVT_FLOAT(1.0))
        EVT_WAIT_FRAMES(1)
        EVT_CALL(SetPartScale, ACTOR_SELF, 1, EVT_FLOAT(1.0), EVT_FLOAT(0.7001953125), EVT_FLOAT(1.0))
        EVT_WAIT_FRAMES(1)
...
EvtSource N(takeTurn_8021CCD4) = {
    ...
    EVT_IF_EQ(LW(0), 0)
        ...
        EVT_IF_EQ(LW(0), FALSE)
            EVT_CALL(GetActorVar, ACTOR_SELF, 12, LW(0))
            EVT_IF_EQ(LW(0), 0)
            ...
            EVT_ELSE
                EVT_SUB(LW(0), 1)
                EVT_CALL(SetActorVar, ACTOR_SELF, 12, LW(0))
            EVT_END_IF
        EVT_END_IF
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LW(0))
...
EvtSource N(8021D04C) = {
    ...
    EVT_ADD(LW(0), 20)
    EVT_ADD(LW(1), 40)
    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LW(9), EVT_FLOAT(0.80078125))
    ...
    EVT_SWITCH(LW(10))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, LW(9), EVT_FLOAT(14.0))
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LW(9), EVT_FLOAT(0.2001953125))
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LW(9), EVT_FLOAT(0.1005859375))
            EVT_CALL(FlyPartTo, ACTOR_SELF, LW(9), LW(0), LW(1), LW(2), 0, 15, 0)
    ...
    EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, LW(9), EVT_FLOAT(6.0))
    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LW(9), EVT_FLOAT(0.1005859375))
    EVT_CALL(FlyPartTo, ACTOR_SELF, LW(9), LW(0), LW(1), LW(2), 0, 25, 0)
    EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, LW(9), EVT_FLOAT(4.0))
    EVT_SUB(LW(0), 20)
...
EvtSource N(8021D81C) = {
    ...
    EVT_CALL(PlayEffect, EFFECT_ID_4D, 0, 0, 60, 0, EVT_FLOAT(0.2001953125), 0, EVT_FLOAT(1.400390625), 255, EVT_FLOAT(0.1005859375), 150, 0, 0, 0)
    EVT_WAIT_FRAMES(15)
...
EvtSource N(8021DDE8) = {
    EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_ENEMY0)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LW(0), LW(1), LW(2))
    EVT_SET(LW(3), 170)
    EVT_CALL(SetPartPos, ACTOR_SELF, 8, LW(0), LW(3), LW(2))
    ...
    EVT_CALL(FallPartTo, ACTOR_SELF, 8, LW(0), LW(1), LW(2), 20)
    EVT_THREAD
        EVT_LOOP(20)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 8, ACTOR_PART_FLAG_INVISIBLE, 0)
            EVT_WAIT_FRAMES(1)
...
EvtSource N(8021E008) = {
    ...
    EVT_SWITCH(LW(10))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_THREAD
                EVT_LOOP(6)
                    EVT_CALL(RandInt, 120, LW(0))
                    EVT_SUB(LW(0), 150)
                    EVT_CALL(RandInt, 90, LW(1))
                    EVT_SUB(LW(0), 40)
                    EVT_CALL(PlaySound, 0x20EB)
            ...
            EVT_CALL(EnemyTestTarget, ACTOR_SELF, LW(11), 0, 0, 1, BS_FLAGS1_10)
            EVT_SWITCH(LW(11))
                ...
                EVT_CASE_DEFAULT
                    ...
                    EVT_THREAD
                        ...
                        EVT_SET(LW(1), 0)
                        EVT_SET(LW(3), 170)
                        EVT_CALL(SetPartPos, ACTOR_SELF, 6, LW(0), LW(3), LW(2))
                        ...
                        EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 6, EVT_FLOAT(0.30078125))
                    ...
                    EVT_ADD(LW(5), 5)
                    EVT_SET(LW(7), 170)
                    EVT_CALL(SetPartPos, ACTOR_SELF, 7, LW(4), LW(7), LW(6))
                    ...
                    EVT_CALL(FallPartTo, ACTOR_SELF, 7, LW(4), LW(5), LW(6), 20)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 6, NPC_ANIM_tutankoopa_Palette_00_Anim_17)
                    EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PARTNER)
                    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
...
EvtSource N(8021E9C8) = {
    ...
    EVT_LABEL(10)
    EVT_CALL(GetActorVar, ACTOR_SELF, 5, LW(13))
    ...
    EVT_CALL(SetActorDispOffset, LW(11), 0, 0, 0)
    EVT_CALL(UseIdleAnimation, LW(11), FALSE)
    EVT_CALL(EnableIdleScript, LW(11), 0)
    EVT_CALL(SetAnimation, LW(11), 1, NPC_ANIM_chain_chomp_Palette_00_Anim_5)
    EVT_CALL(SetActorSpeed, LW(11), EVT_FLOAT(6.0))
    EVT_CALL(SetActorJumpGravity, LW(11), EVT_FLOAT(0.80078125))
    EVT_SET(LW(0), 90)
    EVT_SET(LW(1), 0)
    EVT_SET(LW(2), -30)
    EVT_SET(LW(3), 8)
    ...
    EVT_CALL(GetActorVar, ACTOR_SELF, 3, LW(5))
    EVT_IF_EQ(LW(5), 0)
    ...
    EVT_CALL(SetActorSpeed, LW(11), EVT_FLOAT(3.0))
    EVT_CALL(SetActorJumpGravity, LW(11), EVT_FLOAT(0.80078125))
    EVT_SET(LW(0), 20)
    EVT_SET(LW(1), 0)
    EVT_SET(LW(2), 20)
    ...
    EVT_CALL(SetPartPos, LW(11), 2, LW(0), LW(1), LW(2))
    EVT_CALL(HPBarToHome, LW(11))
    EVT_CALL(SetActorSpeed, LW(11), EVT_FLOAT(6.0))
    EVT_CALL(SetActorJumpGravity, LW(11), EVT_FLOAT(0.80078125))
    EVT_CALL(EnableIdleScript, LW(11), 1)
...
EvtSource N(8021F42C) = {
    EVT_LABEL(20)
    EVT_CALL(GetActorPos, LW(11), LW(5), LW(6), LW(7))
    EVT_IF_EQ(LW(5), LW(0))
        EVT_GOTO(30)
    EVT_END_IF
    EVT_SET(LW(6), LW(5))
    ...
    EVT_IF_LT(LW(6), LW(4))
        EVT_CALL(SetGoalPos, LW(11), LW(0), LW(1), LW(2))
        EVT_CALL(JumpToGoal, LW(11), LW(3), FALSE, TRUE, FALSE)
    ...
    EVT_ELSE
        EVT_SUB(LW(5), LW(4))
        EVT_CALL(SetGoalPos, LW(11), LW(5), LW(1), LW(2))
        EVT_CALL(JumpToGoal, LW(11), LW(3), FALSE, TRUE, FALSE)
        EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x2062)
        EVT_THREAD
            EVT_CALL(ShakeCam, 1, 0, 1, EVT_FLOAT(0.5))
...
EvtSource N(8021FA54) = {
    EVT_CALL(ActorExists, ACTOR_ENEMY1, LW(2))
    EVT_IF_NE(LW(2), FALSE)
        EVT_CALL(GetActorHP, ACTOR_ENEMY1, LW(2))
        EVT_IF_NE(LW(2), 0)
            EVT_THREAD
