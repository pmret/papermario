...
EvtScript N(init_80218EC4) = {
    ...
    EVT_LOOP(8)
        EVT_CALL(SetPartSize, ACTOR_SELF, LocalVar(0), 16, 16)
...
EvtScript N(80218FCC) = {
    ...
    EVT_ELSE
        ...
        EVT_CALL(GetIdleGoal, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(SetPartPos, ACTOR_SELF, 2, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(8021972C) = {
    ...
    EVT_IF_EQ(LocalVar(0), TRUE)
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(N(ChompChainUpdate), LocalVar(2))
        EVT_GOTO(0)
    EVT_END_IF
    EVT_LABEL(1)
    EVT_RETURN
...
EvtScript N(handleEvent_802197C4) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chain_chomp_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x2062)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chain_chomp_Palette_00_Anim_5)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            ...
            EVT_IF_NOT_FLAG(LocalVar(0), STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
                EVT_CALL(SetGoalToHome, ACTOR_SELF)
                EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(1), LocalVar(2), LocalVar(3))
                EVT_IF_FLAG(LocalVar(0), STATUS_FLAG_SHRINK)
                    EVT_SUB(LocalVar(1), 10)
                    EVT_ADD(LocalVar(2), 4)
                EVT_ELSE
                    EVT_SUB(LocalVar(1), 5)
                    EVT_ADD(LocalVar(2), 11)
                EVT_END_IF
                EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(1), LocalVar(2), LocalVar(3))
            EVT_END_IF
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chain_chomp_Palette_00_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_chain_chomp_Palette_00_Anim_1)
    ...
    EVT_END_SWITCH
    EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(0))
    EVT_IF_FLAG(LocalVar(0), STATUS_FLAG_SLEEP | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE)
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(8021A200) = {
    EVT_CALL(ActorExists, ACTOR_ENEMY0, LocalVar(0))
    EVT_IF_EQ(LocalVar(0), FALSE)
        EVT_GOTO(1)
    EVT_END_IF
    EVT_CALL(GetActorVar, ACTOR_ENEMY0, 8, LocalVar(0))
    ...
    EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(SetGoalPos, ACTOR_SELF, LocalVar(0), 20, LocalVar(2))
    ...
    EVT_END_THREAD
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_IGNORE_DEFENSE, 0, 0, 1, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(0.1))
    ...
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(SetGoalPos, ACTOR_SELF, 135, LocalVar(1), LocalVar(2))
    EVT_CALL(JumpToGoal, ACTOR_SELF, 0, FALSE, TRUE, FALSE)
    EVT_THREAD
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(0))
        EVT_IF_NOT_FLAG(LocalVar(0), STATUS_FLAG_SHRINK)
    ...
    EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.0))
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
    EVT_CALL(SetGoalPos, ACTOR_SELF, 105, LocalVar(1), LocalVar(2))
    EVT_CALL(JumpToGoal, ACTOR_SELF, 10, FALSE, TRUE, FALSE)
    EVT_THREAD
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(0))
        EVT_IF_NOT_FLAG(LocalVar(0), STATUS_FLAG_SHRINK)
