...
EvtScript N(handleEvent_80218C3C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_DEFAULT
                    ...
                    EVT_IF_EQ(LVar0, 1)
                        EVT_SET_CONST(LVar1, NPC_ANIM_cleft_default_Anim_9)
                    EVT_ELSE
                        EVT_SET_CONST(LVar1, NPC_ANIM_cleft_default_skid)
                    EVT_END_IF
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_cleft_default_run)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_CALL(GetActorVar, ACTOR_SELF, 0, LVar0)
            EVT_IF_EQ(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_cleft_default_inverted_idle)
            EVT_ELSE
                EVT_SET_CONST(LVar1, NPC_ANIM_cleft_default_idle)
            EVT_END_IF
            EVT_SET_CONST(LVar0, 1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_cleft_default_run)
                EVT_SET_CONST(LVar2, NPC_ANIM_cleft_default_skid)
                EVT_EXEC_WAIT(DoScareAway)
                EVT_RETURN
            EVT_END_IF
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_cleft_default_inverted_dizzy)
