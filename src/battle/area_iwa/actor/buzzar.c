...
EvtScript N(handleEvent_8021B940) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_buzzar_Palette_00_Anim_B)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_buzzar_Palette_00_Anim_1)
...
EvtScript N(8021DF2C) = {
    ...
    EVT_IF_GT(LVar0, 0)
        ...
        EVT_CALL(SetJumpAnimations, ACTOR_PLAYER, 0, ANIM_MIDAIR_STILL, ANIM_MIDAIR_STILL, ANIM_Mario_10009)
        EVT_CALL(SetActorSpeed, ACTOR_PLAYER, EVT_FLOAT(5.0))
    ...
    EVT_WAIT(39)
    EVT_WAIT(10)
    EVT_CALL(SetJumpAnimations, ACTOR_PLAYER, 0, ANIM_Mario_RUN_PANIC, ANIM_Mario_RUN_PANIC, ANIM_Mario_RUN_PANIC)
    EVT_CALL(SetActorSpeed, ACTOR_PLAYER, EVT_FLOAT(5.0))
