...
EvtScript N(handleEvent_8021B940) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_buzzar_Palette_00_Anim_B)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_buzzar_Palette_00_Anim_1)
...
EvtScript N(takeTurn_8021BCD8) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_DEFAULT
            EVT_CALL(GetActorVar, ACTOR_SELF, 0, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 5)
                EVT_SET(LocalVar(0), 0)
            EVT_ELSE
                EVT_ADD(LocalVar(0), 1)
            EVT_END_IF
            EVT_CALL(SetActorVar, ACTOR_SELF, 0, LocalVar(0))
...
EvtScript N(8021BEBC) = {
    ...
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(SetGoalPos, ACTOR_SELF, LocalVar(0), 70, LocalVar(2))
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(NPC_ANIM_buzzar_Palette_00_Anim_17)
            EVT_LOOP(0)
                EVT_CALL(func_8026DF88, ACTOR_SELF, 1, LocalVar(0))
    ...
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(10), DAMAGE_TYPE_NO_CONTACT, 0, 1, BS_FLAGS1_SP_EVT_ACTIVE)
            ...
            EVT_SWITCH(LocalVar(10))
                EVT_CASE_EQ(HIT_RESULT_MISS)
                    ...
                    EVT_THREAD
                        EVT_LOOP(20)
                            ...
                            EVT_CALL(PlayEffect, EFFECT_WINDY_LEAVES, 2, LocalVar(0), 10, LocalVar(2), 0, 0, 0, 0, 0, 0, 0, 0, 0)
                            EVT_WAIT(3)
                        EVT_END_LOOP
                    EVT_END_THREAD
                    EVT_WAIT(60)
                ...
                EVT_CASE_DEFAULT
                    ...
                    EVT_THREAD
                        EVT_CALL(ShakeCam, 1, 0, 90, EVT_FLOAT(0.5))
                    EVT_END_THREAD
                    EVT_CALL(ActorExists, ACTOR_PARTNER, LocalVar(0))
                    EVT_IF_EQ(LocalVar(0), TRUE)
                        EVT_THREAD
                            ...
                            EVT_LOOP(93)
                                EVT_CALL(SetActorYaw, ACTOR_PARTNER, LocalVar(0))
                    ...
                    EVT_END_IF
                    EVT_WAIT(90)
                    EVT_CALL(GetActionResult, LocalVar(1))
                    EVT_CALL(ActorExists, ACTOR_PARTNER, LocalVar(0))
                    EVT_IF_EQ(LocalVar(0), TRUE)
                        EVT_WAIT(3)
                        ...
                        EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PARTNER)
                        EVT_CALL(SetGoalToTarget, ACTOR_SELF)
                        EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_UNBLOCKABLE | DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, 65535, 0, LocalVar(1), BS_FLAGS1_SP_EVT_ACTIVE)
                    EVT_END_IF
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_buzzar_Palette_00_Anim_1)
                    EVT_WAIT(25)
                    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    ...
    EVT_IF_NOT_FLAG(LocalVar(1), STATUS_FLAG_STONE)
        EVT_THREAD
...
EvtScript N(8021CCE8) = {
    ...
    EVT_CALL(PlayEffect, EFFECT_SHINY_FLARE, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(0.6), 0, 0, 0, 0, 0, 0, 0, 0)
    ...
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 2, BS_FLAGS1_10)
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                ...
                EVT_CALL(FlyPartTo, ACTOR_SELF, 4, LocalVar(0), 5, LocalVar(2), 9, 0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, 4, NPC_ANIM_buzzar_Palette_00_Anim_15)
            EVT_END_THREAD
            EVT_THREAD
                EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_CALL(RandInt, 10, LocalVar(3))
                EVT_SUB(LocalVar(3), 40)
                EVT_ADD(LocalVar(0), LocalVar(3))
                EVT_CALL(FlyPartTo, ACTOR_SELF, 5, LocalVar(0), 5, LocalVar(2), 9, 0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, 5, NPC_ANIM_buzzar_Palette_00_Anim_15)
            EVT_END_THREAD
            EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_SUB(LocalVar(0), 30)
            EVT_CALL(FlyPartTo, ACTOR_SELF, 3, LocalVar(0), 5, LocalVar(2), 9, 0, 0)
    ...
    EVT_THREAD
        ...
        EVT_CALL(FlyPartTo, ACTOR_SELF, 4, LocalVar(0), LocalVar(1), LocalVar(2), 6, 0, 0)
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(RandInt, 10, LocalVar(3))
        ...
        EVT_ADD(LocalVar(1), LocalVar(3))
        EVT_CALL(FlyPartTo, ACTOR_SELF, 5, LocalVar(0), LocalVar(1), LocalVar(2), 6, 0, 0)
    EVT_END_THREAD
    EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(FlyPartTo, ACTOR_SELF, 3, LocalVar(0), LocalVar(1), LocalVar(2), 6, 0, 0)
    EVT_WAIT(2)
    ...
    EVT_SWITCH(LocalVar(15))
        EVT_CASE_DEFAULT
            EVT_THREAD
                ...
                EVT_CALL(JumpPartTo, ACTOR_SELF, 4, LocalVar(0), LocalVar(1), LocalVar(2), 10, 1)
            ...
            EVT_THREAD
                ...
                EVT_CALL(JumpPartTo, ACTOR_SELF, 5, LocalVar(0), LocalVar(1), LocalVar(2), 10, 1)
            ...
            EVT_THREAD
                ...
                EVT_CALL(GetPartOffset, ACTOR_SELF, 3, LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_SUB(LocalVar(0), 5)
                EVT_SET(LocalVar(1), 4)
                EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 3, EVT_FLOAT(1.5))
                EVT_CALL(JumpPartTo, ACTOR_SELF, 3, LocalVar(0), LocalVar(1), LocalVar(2), 10, 1)
...
EvtScript N(8021DF2C) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_buzzar_Palette_00_Anim_2)
    EVT_CALL(FlyToGoal, ACTOR_SELF, 0, -10, 10)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(10), 0, 0, 4, BS_FLAGS1_10)
    EVT_SWITCH(LocalVar(10))
        EVT_CASE_OR_EQ(HIT_RESULT_MISS)
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_WAIT(10)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_buzzar_Palette_00_Anim_18)
    EVT_CALL(FlyToGoal, ACTOR_SELF, 8, -5, 0)
    EVT_IF_EQ(LocalVar(10), HIT_RESULT_HIT_STATIC)
        EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_IF
    ...
    EVT_EXEC_GET_TID(N(8021DCB8), LocalVar(10))
    EVT_WAIT(62)
