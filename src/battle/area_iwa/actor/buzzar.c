            ...
            EVT_SWITCH(LVarA)
                ...
                EVT_CASE_DEFAULT
                    ...
                    EVT_IF_EQ(LVar0, TRUE)
                        ...
                        EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PARTNER)
                        EVT_CALL(SetGoalToTarget, ACTOR_SELF)
                        EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_UNBLOCKABLE | DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_ALL, 0, LVar1, BS_FLAGS1_SP_EVT_ACTIVE)
                    EVT_END_IF
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Buzzar_Anim01)
                    EVT_WAIT(25)
                    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
