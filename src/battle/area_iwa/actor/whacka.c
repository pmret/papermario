...
EvtScript N(handleEvent_8021FE90) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_whacka_Palette_00_Anim_1)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_CASE_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_whacka_Palette_00_Anim_4)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_whacka_Palette_00_Anim_1)
            EVT_SET_CONST(LVar2, NPC_ANIM_whacka_Palette_00_Anim_1)
            EVT_EXEC_WAIT(N(80220684))
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_CALL(RandInt, 100, LVar0)
            EVT_IF_LE(LVar0, 100)
