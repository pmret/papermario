...
EvtScript N(handleEvent_8021FE90) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_whacka_Palette_00_Anim_1)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_CASE_EQ(EVENT_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_whacka_Palette_00_Anim_4)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_whacka_Palette_00_Anim_1)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_whacka_Palette_00_Anim_1)
            EVT_EXEC_WAIT(N(80220684))
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_CALL(RandInt, 100, LocalVar(0))
            EVT_IF_LE(LocalVar(0), 100)
...
EvtScript N(80220684) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(MakeItemEntity, ITEM_WHACKAS_BUMP, LocalVar(0), LocalVar(1), LocalVar(2), 12, 0)
    EVT_END_THREAD
    EVT_RETURN
    EVT_END
};
