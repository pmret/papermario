...
EvtScript N(takeTurn) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(0)
            EVT_CALL(ActorSpeak, MESSAGE_ID(0x1200E5), ACTOR_SELF, 1, NPC_ANIM_monstar_Palette_00_Anim_9, NPC_ANIM_monstar_Palette_00_Anim_9)
        EVT_CASE_EQ(1)
            EVT_CALL(ActorSpeak, MESSAGE_ID(0x1200E6), ACTOR_SELF, 1, NPC_ANIM_monstar_Palette_00_Anim_9, NPC_ANIM_monstar_Palette_00_Anim_9)
        EVT_CASE_EQ(2)
            EVT_CALL(ActorSpeak, MESSAGE_ID(0x1200E7), ACTOR_SELF, 1, NPC_ANIM_monstar_Palette_00_Anim_9, NPC_ANIM_monstar_Palette_00_Anim_9)
        EVT_CASE_DEFAULT
            EVT_CALL(ActorSpeak, MESSAGE_ID(0x1200E6), ACTOR_SELF, 1, NPC_ANIM_monstar_Palette_00_Anim_9, NPC_ANIM_monstar_Palette_00_Anim_9)
    EVT_END_SWITCH
