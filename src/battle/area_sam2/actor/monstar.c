...
s32 N(idleAnimations)[] = {
    STATUS_NORMAL, ANIM_Monstar_Anim1,
    STATUS_STONE, ANIM_Monstar_Anim0,
    STATUS_SLEEP, ANIM_Monstar_Anim1,
    STATUS_POISON, ANIM_Monstar_Anim1,
    STATUS_STOP, ANIM_Monstar_Anim0,
    STATUS_STATIC, ANIM_Monstar_Anim1,
    STATUS_PARALYZE, ANIM_Monstar_Anim0,
    STATUS_PARALYZE, ANIM_Monstar_Anim0,
    STATUS_DIZZY, ANIM_Monstar_Anim1,
    STATUS_DIZZY, ANIM_Monstar_Anim1,
    STATUS_END,
};

s32 N(idleAnimations2)[] = {
    STATUS_NORMAL, ANIM_Monstar_Anim4,
    STATUS_END,
};
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LVar1, ANIM_Monstar_Anim8)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET(LVar0, 1)
            EVT_SET(LVar1, ANIM_Monstar_Anim8)
            EVT_SET(LVar2, -1)
        ...
        EVT_CASE_EQ(EVENT_UNKNOWN_TRIGGER)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    EVT_SET_CONST(LVar0, 1)
                    EVT_SET_CONST(LVar1, ANIM_Monstar_Anim1)
                EVT_CASE_EQ(1)
                    EVT_SET_CONST(LVar0, 1)
                    EVT_SET_CONST(LVar1, ANIM_Monstar_Anim4)
            EVT_END_SWITCH
...
EvtScript N(unused) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Monstar_Anim4)
...
EvtScript N(attack) = {
    ...
    EVT_THREAD
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Monstar_Anim4)
        EVT_WAIT(20)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Monstar_Anim5)
        EVT_WAIT(20)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Monstar_Anim6)
    EVT_END_THREAD
    EVT_THREAD
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Monstar_Anim7)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_SET(LVarA, LVar0)
            EVT_WAIT(170)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Monstar_Anim1)
...
EvtScript N(takeTurn) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(0)
            EVT_CALL(ActorSpeak, MSG_CH7_00E5, ACTOR_SELF, 1, ANIM_Monstar_Anim9, ANIM_Monstar_Anim9)
        EVT_CASE_EQ(1)
            EVT_CALL(ActorSpeak, MSG_CH7_00E6, ACTOR_SELF, 1, ANIM_Monstar_Anim9, ANIM_Monstar_Anim9)
        EVT_CASE_EQ(2)
            EVT_CALL(ActorSpeak, MSG_CH7_00E7, ACTOR_SELF, 1, ANIM_Monstar_Anim9, ANIM_Monstar_Anim9)
        EVT_CASE_DEFAULT
            EVT_CALL(ActorSpeak, MSG_CH7_00E6, ACTOR_SELF, 1, ANIM_Monstar_Anim9, ANIM_Monstar_Anim9)
    EVT_END_SWITCH
