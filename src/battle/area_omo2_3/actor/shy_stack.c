...
EvtScript N(init) = {
    ...
    EVT_IF_EQ(LocalVar(0), 0)
        ...
        EVT_CALL(SetPartPos, ACTOR_SELF, 14, LocalVar(0), 200, 0)
        EVT_CALL(SetPartPos, ACTOR_SELF, 13, LocalVar(0), 200, 0)
        EVT_CALL(SetPartPos, ACTOR_SELF, 12, LocalVar(0), 200, 0)
        EVT_CALL(SetPartPos, ACTOR_SELF, 11, LocalVar(0), 200, 0)
        EVT_THREAD
            EVT_WAIT(5)
        ...
        EVT_THREAD
            ...
            EVT_CALL(FallPartTo, ACTOR_SELF, 14, LocalVar(0), 0, 0, 36)
        ...
        EVT_THREAD
            ...
            EVT_CALL(FallPartTo, ACTOR_SELF, 13, LocalVar(0), 18, 0, 32)
        ...
        EVT_THREAD
            ...
            EVT_CALL(FallPartTo, ACTOR_SELF, 12, LocalVar(0), 36, 0, 28)
        ...
        EVT_THREAD
            ...
            EVT_CALL(FallPartTo, ACTOR_SELF, 11, LocalVar(0), 54, 0, 24)
            ...
            EVT_WAIT(7)
            EVT_CALL(GetPartOffset, ACTOR_SELF, 14, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_ELSE
        ...
        EVT_THREAD
            ...
            EVT_CALL(JumpPartTo, ACTOR_SELF, 11, LocalVar(0), LocalVar(1), LocalVar(2), 20, 1)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LocalVar(0), STATUS_FLAG_SHRINK)
                ...
                EVT_EXEC_WAIT(DoNormalHit)
            EVT_ELSE
                EVT_CALL(GetActorVar, ACTOR_SELF, 8, LocalVar(10))
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 5, LocalVar(2))
            EVT_CALL(GetActorVar, ACTOR_SELF, 8, LocalVar(10))
        ...
        EVT_CASE_EQ(EVENT_30)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_CALL(GetActorVar, ACTOR_SELF, 3, LocalVar(2))
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_WAIT(1000)
...
EvtScript N(doSpinSmashHitLastGuy) = {
    EVT_EXEC_GET_TID(N(rotate), LocalVar(14))
...
EvtScript N(lower_actor_pos) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
        EVT_WAIT(3)
        EVT_SUB(LocalVar(3), 2)
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
        EVT_WAIT(2)
        EVT_SUB(LocalVar(3), 3)
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
        EVT_WAIT(1)
        EVT_SUB(LocalVar(3), 5)
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
        EVT_WAIT(1)
        EVT_SUB(LocalVar(3), 7)
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
        EVT_WAIT(1)
        EVT_ADD(LocalVar(3), 2)
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
        EVT_WAIT(1)
        EVT_ADD(LocalVar(3), 3)
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
        EVT_WAIT(1)
        EVT_ADD(LocalVar(3), 3)
        EVT_CALL(SetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(3), LocalVar(2))
...
EvtScript N(doSpinSmashHit) = {
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("X"), LocalVar(0))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("Y"), LocalVar(1))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("Z"), LocalVar(2))
    ...
    EVT_ADD(LocalVar(15), 1)
    EVT_CALL(ChooseNextTarget, 0, LocalVar(0))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("T"), LocalVar(0))
    EVT_IF_EQ(LocalVar(0), -1)
        EVT_GOTO(10)
    EVT_END_IF
    EVT_CALL(GetOwnerTarget, LocalVar(0), LocalVar(9))
    ...
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("MYSELF ID"), LocalVar(0))
    EVT_CALL(GetOwnerTarget, LocalVar(0), LocalVar(1))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("TARGET ID"), LocalVar(0))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("TARGET PARTS ID"), LocalVar(1))
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("TX"), LocalVar(0))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("TY"), LocalVar(1))
    EVT_CALL(func_80231000_54CC70, EVT_ADDR("TZ"), LocalVar(2))
    EVT_CALL(JumpPartTo, ACTOR_SELF, 10, LocalVar(0), LocalVar(1), LocalVar(2), 0, 1)
    EVT_THREAD
        EVT_CALL(ShakeCam, 1, 0, 2, EVT_FLOAT(1.0))
    EVT_END_THREAD
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    ...
    EVT_SET(LocalVar(4), 70)
    EVT_SUB(LocalVar(4), LocalVar(3))
    EVT_CALL(GetPartOffset, ACTOR_SELF, 10, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_SET(LocalVar(5), LocalVar(4))
    EVT_SUB(LocalVar(5), LocalVar(0))
    EVT_IF_LT(LocalVar(5), 6)
        EVT_SET(LocalVar(5), 1)
    EVT_ELSE
        EVT_SET(LocalVar(5), 0)
    EVT_END_IF
    EVT_CALL(JumpPartTo, ACTOR_SELF, 10, LocalVar(4), LocalVar(1), LocalVar(2), LocalVar(5), 1)
    EVT_SUB(LocalVar(4), 18)
    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 10, EVT_FLOAT(1.5))
    EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, 10, EVT_FLOAT(3.0))
    EVT_CALL(JumpPartTo, ACTOR_SELF, 10, LocalVar(4), LocalVar(1), LocalVar(2), 12, 1)
    ...
    EVT_SET(LocalVar(0), 0)
    EVT_LOOP(12)
        EVT_CALL(SetPartRotation, ACTOR_SELF, 10, LocalVar(0), 0, 0)
...
EvtScript N(80235168) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(30)
            ...
            EVT_CALL(SetPartYaw, ACTOR_SELF, 10, LocalVar(0))
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_CALL(SetPartYaw, ACTOR_SELF, 10, LocalVar(0))
    EVT_END_THREAD
    ...
    EVT_CALL(JumpPartTo, ACTOR_SELF, 10, LocalVar(0), LocalVar(1), LocalVar(2), 10, 1)
    EVT_WAIT(20)
    EVT_CALL(GetPartOffset, ACTOR_SELF, 10, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(1), 10)
    EVT_CALL(PlaySoundAtPart, ACTOR_SELF, 10, SOUND_DEATH)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, LocalVar(0))
            EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(launch_rock) = {
    ...
    EVT_IF_FLAG(LocalVar(15), STATUS_FLAG_SHRINK)
        ...
        EVT_SWITCH(LocalVar(0))
            EVT_CASE_EQ(HIT_RESULT_HIT)
                EVT_ADD(LocalVar(3), -4)
                EVT_ADD(LocalVar(4), 28)
                EVT_SET(LocalVar(2), 9)
            EVT_CASE_EQ(HIT_RESULT_1)
                EVT_ADD(LocalVar(3), -4)
                EVT_ADD(LocalVar(4), 21)
                EVT_SET(LocalVar(2), 8)
            EVT_CASE_EQ(HIT_RESULT_QUAKE_IMMUNE)
                EVT_ADD(LocalVar(3), -4)
                EVT_ADD(LocalVar(4), 14)
                EVT_SET(LocalVar(2), 7)
            EVT_CASE_DEFAULT
                EVT_ADD(LocalVar(3), -4)
                EVT_ADD(LocalVar(4), 7)
                EVT_SET(LocalVar(2), 6)
        EVT_END_SWITCH
    EVT_ELSE
        ...
        EVT_SWITCH(LocalVar(0))
            EVT_CASE_EQ(HIT_RESULT_HIT)
                ...
                EVT_ADD(LocalVar(4), 72)
                EVT_SET(LocalVar(2), 9)
            EVT_CASE_EQ(1)
                EVT_ADD(LocalVar(3), -10)
                EVT_ADD(LocalVar(4), 54)
                EVT_SET(LocalVar(2), 8)
            EVT_CASE_EQ(HIT_RESULT_QUAKE_IMMUNE)
                EVT_ADD(LocalVar(3), -10)
                EVT_ADD(LocalVar(4), 36)
                EVT_SET(LocalVar(2), 7)
            EVT_CASE_DEFAULT
                EVT_ADD(LocalVar(3), -10)
                EVT_ADD(LocalVar(4), 18)
                EVT_SET(LocalVar(2), 6)
        EVT_END_SWITCH
    EVT_END_IF
    EVT_CALL(SetPartSounds, ACTOR_SELF, LocalVar(2), 2, 0, 0)
    EVT_CALL(SetPartPos, ACTOR_SELF, LocalVar(2), LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_CALL(SetAnimation, ACTOR_SELF, LocalVar(2), NPC_ANIM_shy_stack_rock_Palette_00_Anim_0)
    EVT_CALL(SetPartFlagBits, ACTOR_SELF, LocalVar(2), ACTOR_PART_FLAG_INVISIBLE, 0)
    EVT_WAIT(1)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LocalVar(6), LocalVar(7), LocalVar(8))
    EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, LocalVar(2), EVT_FLOAT(12.0))
    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(2), EVT_FLOAT(1.0))
    EVT_SWITCH(LocalVar(1))
        EVT_CASE_EQ(0)
            EVT_CALL(JumpPartTo, ACTOR_SELF, LocalVar(2), LocalVar(6), LocalVar(7), LocalVar(8), 9, 1)
            EVT_SUB(LocalVar(6), 100)
            EVT_CALL(RandInt, 40, LocalVar(9))
            EVT_SUB(LocalVar(6), LocalVar(9))
            EVT_ADD(LocalVar(7), LocalVar(9))
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(2), EVT_FLOAT(0.8))
            EVT_CALL(JumpPartTo, ACTOR_SELF, LocalVar(2), LocalVar(6), LocalVar(7), LocalVar(8), 25, 1)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, LocalVar(2), ACTOR_PART_FLAG_INVISIBLE, 1)
        EVT_CASE_EQ(1)
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(HIT_RESULT_HIT)
                    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(2), EVT_FLOAT(2.2))
                EVT_CASE_EQ(HIT_RESULT_1)
                    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(2), EVT_FLOAT(1.8))
                EVT_CASE_EQ(HIT_RESULT_QUAKE_IMMUNE)
                    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(2), EVT_FLOAT(1.4))
                EVT_CASE_DEFAULT
                    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(2), EVT_FLOAT(1.0))
            EVT_END_SWITCH
            EVT_SET(LocalVar(7), 0)
            EVT_CALL(RandInt, 35, LocalVar(9))
            EVT_ADD(LocalVar(9), 30)
            EVT_SUB(LocalVar(6), LocalVar(9))
            EVT_CALL(JumpPartTo, ACTOR_SELF, LocalVar(2), LocalVar(6), LocalVar(7), LocalVar(8), 9, 1)
            EVT_CALL(RandInt, 25, LocalVar(9))
            EVT_ADD(LocalVar(9), 45)
            EVT_SUB(LocalVar(6), LocalVar(9))
            EVT_CALL(JumpPartTo, ACTOR_SELF, LocalVar(2), LocalVar(6), LocalVar(7), LocalVar(8), 8, 1)
            EVT_SUB(LocalVar(6), 25)
            EVT_CALL(JumpPartTo, ACTOR_SELF, LocalVar(2), LocalVar(6), LocalVar(7), LocalVar(8), 4, 1)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, LocalVar(2), ACTOR_PART_FLAG_INVISIBLE, 1)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
...
EvtScript N(onDeath) = {
    ...
    EVT_CALL(GetActorVar, ACTOR_ENEMY1, 3, LocalVar(0))
    EVT_ADD(LocalVar(0), 1)
    EVT_CALL(SetActorVar, ACTOR_ENEMY1, 3, LocalVar(0))
