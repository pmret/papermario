...
ApiStatus N(init)(Evt* script, s32 isInitialCall) {
    ...
    hud_element_set_render_pos(id, actionCommandStatus->hudX + 54, actionCommandStatus->hudY + 28);
    hud_element_set_render_depth(id, 0);
    hud_element_set_flags(id, HUD_ELEMENT_FLAGS_80 | HUD_ELEMENT_FLAGS_DISABLED);

    id = hud_element_create(&HES_WhirlwindBubble);
    actionCommandStatus->hudElements[3] = id;
    hud_element_set_render_pos(id, actionCommandStatus->hudX + 60, actionCommandStatus->hudY + 28);
    hud_element_set_render_depth(id, 0);
    hud_element_set_flags(id, HUD_ELEMENT_FLAGS_80 | HUD_ELEMENT_FLAGS_DISABLED);
...
void N(update)(void) {
    ...
    switch (actionCommandStatus->state) {
        ...
        case 1:
            ...
            hud_element_set_render_pos(actionCommandStatus->hudElements[2], actionCommandStatus->hudX + 54, actionCommandStatus->hudY + 23);
            hud_element_set_render_pos(actionCommandStatus->hudElements[3], actionCommandStatus->hudX + 60, actionCommandStatus->hudY + 23);
            break;
        case 10:
            btl_set_popup_duration(99);
