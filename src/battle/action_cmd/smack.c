...
void func_802A9298_42E638(void) {
    ...
    case 11:
        ...
        if (actionCommandStatus->unk_68 == 0) {
            ...
            actionCommandStatus->unk_44 -= D_802A99D2_42ED72[actionCommandStatus->unk_44 / mashMeterCutoff / 20].unk_2;
            ...
            if (actionCommandStatus->unk_68 == 0) {
                ...
                if ((battleStatus->currentButtonsDown & BUTTON_STICK_LEFT) == 0 && actionCommandStatus->unk_5C) {
                    ...
                    if (actionCommandStatus->unk_64 == 0) {
                        ...
                        s32 temp_v0_3 = battleStatus->unk_434[actionCommandStatus->unk_50] * 850;
                        temp_v0_3 /= 100;
                        actionCommandStatus->unk_44 += temp_v0_3;
                    }

                    actionCommandStatus->unk_5C = 0;
                    // testFunc(actionCommandStatus, battleStatus);
                }
