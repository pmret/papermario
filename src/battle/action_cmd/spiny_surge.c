...
s32 D_802A9860_42F680[] = { 0, 25, 50, 75, 75, 0, 0, 0 };
    ...
    switch (actionCommandStatus->state) {
        ...
        case AC_STATE_ACTIVE:
            ...
            if (D_802A98C0 & BUTTON_STICK_LEFT) {
                actionCommandStatus->any.unk_5C = 1;
            }
