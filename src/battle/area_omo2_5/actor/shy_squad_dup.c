...
s32 N(idleAnimations_watt)[] = {
    STATUS_NORMAL, ANIM_TankGuy_Anim7,
    STATUS_STOP, ANIM_TankGuy_Anim0,
    STATUS_END,
};
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar1, ANIM_TankGuy_Anim4)
        ...
        EVT_CASE_OR_EQ(EVENT_BURN_DEATH)
            EVT_SET_CONST(LVar1, ANIM_TankGuy_Anim5)
            EVT_EXEC_WAIT(N(onHit))
            EVT_SET(LVar0, 2)
            EVT_LOOP(15)
                EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, ANIM_TankGuy_Anim5)
                EVT_ADD(LVar0, 1)
            EVT_END_LOOP
            EVT_WAIT(20)
            EVT_SET(LVar0, 2)
        ...
        EVT_CASE_OR_EQ(EVENT_SPIKE_TAUNT)
            ...
            EVT_SET_CONST(LVar1, ANIM_TankGuy_Anim1)
            EVT_EXEC_WAIT(N(onSpinSmash))
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET(LVar1, ANIM_TankGuy_Anim4)
        ...
        EVT_CASE_DEFAULT
    EVT_END_SWITCH
    EVT_SET(LVar1, ANIM_TankGuy_Anim1)
    EVT_EXEC_WAIT(N(set_squad_animation))
...
EvtScript N(run_away) = {
    ...
    EVT_LOOP(15)
        ...
        EVT_IF_GE(LVar0, LVar2)
            ...
            EVT_THREAD
                EVT_WAIT(LVar1)
                EVT_CALL(SetAnimation, ACTOR_SELF, LVar0, ANIM_TankGuy_Anim3)
                EVT_CALL(SetPartYaw, ACTOR_SELF, LVar0, 180)
...
EvtScript N(attack) = {
    ...
    EVT_LOOP(15)
        ...
        EVT_IF_LT(LVar7, 50)
            EVT_SET(LVar7, ANIM_TankGuy_Anim4)
        EVT_ELSE
            EVT_SET(LVar7, ANIM_TankGuy_Anim7)
        EVT_END_IF
