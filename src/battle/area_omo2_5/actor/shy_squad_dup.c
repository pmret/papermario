...
EvtScript N(idle) = {
    ...
    EVT_IF_EQ(LW(0), 6)
        EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, N(80231334))
        EVT_SET(LW(0), 2)
        EVT_LOOP(15)
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, LW(0), N(80231334))
            EVT_ADD(LW(0), 1)
        EVT_END_LOOP
    EVT_ELSE
        ...
        EVT_SET(LW(0), 2)
        EVT_LOOP(15)
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, LW(0), N(idleAnimations))
            EVT_ADD(LW(0), 1)
        EVT_END_LOOP
    EVT_END_IF
    EVT_WAIT_FRAMES(1)
