...
EvtScript N(script6) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(25)
            ...
            EVT_CALL(N(func_802A123C_715A8C), LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_WAIT(1)
        EVT_END_LOOP
    ...
    EVT_IF_GT(LocalVar(11), 0)
        EVT_CALL(N(func_802A12EC_715B3C), LocalVar(11))
    EVT_END_IF
    EVT_WAIT(30)
    EVT_CALL(GetActorPos, ACTOR_PARTNER, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(main) = {
    ...
    EVT_CALL(N(func_802A15A0_715DF0), LocalVar(10))
    EVT_CALL(InitTargetIterator)
    ...
    EVT_IF_GT(LocalVar(11), 0)
        ...
        EVT_CALL(N(func_802A1378_715BC8), LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(11))
    EVT_END_IF
    EVT_IF_GT(LocalVar(12), 0)
        EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(0), 20)
        EVT_ADD(LocalVar(1), 25)
        EVT_CALL(N(func_802A1438_715C88), LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(12))
    EVT_END_IF
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(1), 25)
    EVT_CALL(ShowStartRecoveryShimmer, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(11))
