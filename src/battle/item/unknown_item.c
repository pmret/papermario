...
EvtScript N(main) = {
    EVT_SET_CONST(LocalVar(10), 0x0000008E)
    ...
    EVT_CALL(N(func_802A123C_72447C), LocalVar(0), LocalVar(1), LocalVar(2), 20)
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(2), 5)
    EVT_CALL(ShowRecoveryShimmer, LocalVar(0), LocalVar(1), LocalVar(2), 20)
