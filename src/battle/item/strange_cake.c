...
EvtScript N(script6) = {
    ...
    EVT_IF_EQ(LocalVar(1), 211)
        EVT_SET_CONST(LocalVar(10), 0xD3)
        ...
        EVT_CALL(battle_item_strange_cake_func_802A18D8_731BD8, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3))
        EVT_CALL(GetActorPos, 0, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(1), 25)
        EVT_CALL(ShowStartRecoveryShimmer, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3))
        EVT_CALL(battle_item_strange_cake_AddFP, LocalVar(3))
        EVT_WAIT(10)
    ...
    EVT_ELSE
        EVT_SET_CONST(LocalVar(10), 0xD2)
        EVT_SET(LocalVar(1), 0)
        EVT_EXEC_WAIT(battle_item_strange_cake_UseItemWithEffect)
        EVT_EXEC_WAIT(battle_item_strange_cake_EatItem)
        EVT_CALL(SetAnimation, 0, 0, 65567)
...
EvtScript N(script7) = {
    ...
    EVT_CALL(PlayEffect, 87, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 30, 0, 0, 0, 0, 0, 0, 0)
...
EvtScript N(script8) = {
    ...
    EVT_CALL(GetActorPos, 0, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(1), 20)
    EVT_CALL(PlayEffect, 51, 6, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 30, 0, 0, 0, 0, 0, 0, 0)
...
EvtScript N(script9) = {
    ...
    EVT_CALL(GetGoalPos, 0, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_EXEC(DoSleepHit)
