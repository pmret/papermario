...
EvtScript N(script7) = {
    ...
    EVT_CALL(PlayEffect, 87, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FIXED(1.0), 30, 0, 0, 0, 0, 0, 0, 0)
...
EvtScript N(script8) = {
    ...
    EVT_CALL(GetActorPos, 0, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(1), 20)
    EVT_CALL(PlayEffect, 51, 6, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FIXED(1.0), 30, 0, 0, 0, 0, 0, 0, 0)
