...
EvtScript N(main) = {
    EVT_SET_CONST(LocalVar(10), 0x00000090)
    ...
    EVT_IF_EQ(LocalVar(0), 6)
        EVT_GOTO(1)
    EVT_END_IF
    EVT_CALL(GetItemPower, ITEM_P_O_W_BLOCK, LocalVar(3), LocalVar(4))
    EVT_CALL(ApplyShrinkFromOwner, LocalVar(3))
    EVT_CALL(func_80269EAC, 22)
    EVT_CALL(ItemDamageEnemy, LocalVar(0), 939525120, 0, LocalVar(3), 32)
    EVT_LABEL(1)
