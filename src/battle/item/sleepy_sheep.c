...
EvtScript N(main) = {
    ...
    EVT_CALL(SetVirtualEntityScale, LocalVar(10), EVT_FIXED(0.71), EVT_FIXED(0.71), EVT_FIXED(0.71))
    EVT_CALL(SetVirtualEntityMoveSpeed, LocalVar(10), EVT_FIXED(7.0))
    EVT_CALL(SetVirtualEntityJumpGravity, LocalVar(10), EVT_FIXED(1.4))
