...
s32 N(idleAnimations)[] = {
    STATUS_NORMAL, ANIM_Swooper_Grey_Anim0C,
    STATUS_STONE, ANIM_Swooper_Grey_Anim0B,
    STATUS_SLEEP, ANIM_Swooper_Grey_Anim0F,
    STATUS_POISON, ANIM_Swooper_Grey_Anim0C,
    STATUS_STOP, ANIM_Swooper_Grey_Anim0B,
    STATUS_STATIC, ANIM_Swooper_Grey_Anim0C,
    STATUS_PARALYZE, ANIM_Swooper_Grey_Anim0B,
...
s32 N(idleAnimations_flying)[] = {
    STATUS_NORMAL, ANIM_Swooper_Grey_Anim02,
    STATUS_STONE, ANIM_Swooper_Grey_Anim01,
    STATUS_SLEEP, ANIM_Swooper_Grey_Anim13,
    STATUS_POISON, ANIM_Swooper_Grey_Anim02,
    STATUS_STOP, ANIM_Swooper_Grey_Anim01,
    STATUS_STATIC, ANIM_Swooper_Grey_Anim02,
    STATUS_PARALYZE, ANIM_Swooper_Grey_Anim01,
...
EvtScript N(returnHome) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Swooper_Grey_Anim02)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Swooper_Grey_Anim0C)
...
EvtScript N(hadleEvent_flying) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Swooper_Grey_Anim02)
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, ANIM_Swooper_Grey_Anim0E)
                EVT_EXEC_WAIT(DoNormalHit)
            EVT_END_IF
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Swooper_Grey_Anim0C)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_CALL(GetBattlePhase, LVar0)
...
EvtScript N(takeTurn_flying) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Swooper_Grey_Anim06)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
