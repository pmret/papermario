...
EvtScript N(idle_8021AB10) = {
    ...
    EVT_IF_FLAG(LocalVar(10), STATUS_FLAG_SLEEP | STATUS_FLAG_DIZZY)
...
EvtScript N(handleEvent_8021ACA8) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bzzap_Palette_00_Anim_6)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bzzap_Palette_00_Anim_7)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_bzzap_Palette_00_Anim_8)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bzzap_Palette_00_Anim_8)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bzzap_Palette_00_Anim_B)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bzzap_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bzzap_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_bzzap_Palette_00_Anim_6)
...
EvtScript N(8021B28C) = {
    ...
    EVT_WAIT(6)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, STATUS_FLAG_8 | STATUS_FLAG_20 | STATUS_FLAG_100 | STATUS_FLAG_200 | STATUS_FLAG_POISON | STATUS_FLAG_80000000, 6, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
...
EvtScript N(8021B77C) = {
    ...
    EVT_CALL(SetPartYaw, ACTOR_SELF, LocalVar(9), 0)
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(10), LocalVar(11), LocalVar(12))
    EVT_ADD(LocalVar(10), 200)
    EVT_ADD(LocalVar(11), 100)
    EVT_CALL(SetPartPos, ACTOR_SELF, LocalVar(9), LocalVar(10), LocalVar(11), LocalVar(12))
    EVT_CALL(SetPartFlagBits, ACTOR_SELF, LocalVar(9), ACTOR_PART_FLAG_INVISIBLE, 0)
    EVT_CALL(SetAnimation, ACTOR_SELF, LocalVar(9), 0x4B0003)
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(10), LocalVar(11), LocalVar(12))
    EVT_ADD(LocalVar(11), 50)
    EVT_SUB(LocalVar(12), 30)
    EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, LocalVar(9), EVT_FLOAT(6.0))
    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(9), EVT_FLOAT(1.0))
    EVT_CALL(FlyPartTo, ACTOR_SELF, LocalVar(9), LocalVar(10), LocalVar(11), LocalVar(12), 0, -10, 0)
    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(3), LocalVar(4), LocalVar(5))
    EVT_CALL(GetPartOffset, ACTOR_SELF, LocalVar(9), LocalVar(6), LocalVar(7), LocalVar(8))
    EVT_CALL(MakeLerp, 90, 450, 50, 0)
    EVT_LABEL(0)
    EVT_CALL(UpdateLerp)
    EVT_CALL(N(UnkFloatFunc4), LocalVar(3), LocalVar(5), 30, LocalVar(0), LocalVar(6), LocalVar(8))
    EVT_CALL(SetPartPos, ACTOR_SELF, LocalVar(9), LocalVar(6), LocalVar(7), LocalVar(8))
    EVT_IF_GT(LocalVar(3), LocalVar(6))
        EVT_CALL(SetPartYaw, ACTOR_SELF, LocalVar(9), 180)
    EVT_ELSE
        EVT_CALL(SetPartYaw, ACTOR_SELF, LocalVar(9), 0)
    EVT_END_IF
    EVT_WAIT(1)
    ...
    EVT_END_IF
    EVT_CALL(SetAnimation, ACTOR_SELF, LocalVar(9), 0x4B0003)
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(10), LocalVar(11), LocalVar(12))
    EVT_ADD(LocalVar(11), 30)
    EVT_ADD(LocalVar(12), 30)
    EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, LocalVar(9), EVT_FLOAT(6.0))
    EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(9), EVT_FLOAT(1.0))
    EVT_CALL(FlyPartTo, ACTOR_SELF, LocalVar(9), LocalVar(10), LocalVar(11), LocalVar(12), 0, -10, 0)
...
EvtScript N(8021BC74) = {
    ...
    EVT_EXEC_GET_TID(N(8021B77C), LocalVar(10))
    EVT_WAIT(11)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                ...
                EVT_CALL(FlyPartTo, ACTOR_SELF, 2, LocalVar(0), LocalVar(1), LocalVar(2), 0, -10, 0)
            ...
            EVT_THREAD
                ...
                EVT_CALL(FlyPartTo, ACTOR_SELF, 3, LocalVar(0), LocalVar(1), LocalVar(2), 0, -10, 0)
            ...
            EVT_THREAD
                ...
                EVT_CALL(FlyPartTo, ACTOR_SELF, 4, LocalVar(0), LocalVar(1), LocalVar(2), 0, -10, 0)
            ...
            EVT_THREAD
                ...
                EVT_CALL(FlyPartTo, ACTOR_SELF, 5, LocalVar(0), LocalVar(1), LocalVar(2), 0, -10, 0)
            ...
            EVT_THREAD
                ...
                EVT_CALL(FlyPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, -10, 0)
    ...
    EVT_THREAD
        ...
        EVT_WAIT(2)
        EVT_CALL(SetGoalToTarget, ACTOR_SELF)
        EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 1, BS_FLAGS1_10)
        EVT_CALL(SetAnimation, ACTOR_SELF, 2, NPC_ANIM_bzzap_Palette_00_Anim_3)
        EVT_CALL(SetPartYaw, ACTOR_SELF, 2, 180)
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(1), 100)
    ...
    EVT_THREAD
        ...
        EVT_WAIT(2)
        EVT_CALL(SetGoalToTarget, ACTOR_SELF)
        EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 1, BS_FLAGS1_40)
        EVT_CALL(SetAnimation, ACTOR_SELF, 3, NPC_ANIM_bzzap_Palette_00_Anim_3)
        EVT_CALL(SetPartYaw, ACTOR_SELF, 3, 180)
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(1), 100)
    ...
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 1, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
