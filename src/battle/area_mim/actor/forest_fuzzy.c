...
s32 N(idleAnimations_802184C4)[] = {
    STATUS_NORMAL,    ANIM_Fuzzy_Forest_Anim1,
    STATUS_STONE,     ANIM_Fuzzy_Forest_Anim0,
    STATUS_SLEEP,     ANIM_Fuzzy_Forest_AnimE,
    STATUS_POISON,    ANIM_Fuzzy_Forest_Anim1,
    STATUS_STOP,      ANIM_Fuzzy_Forest_Anim0,
    STATUS_STATIC,    ANIM_Fuzzy_Forest_Anim1,
    STATUS_PARALYZE,  ANIM_Fuzzy_Forest_Anim0,
    STATUS_DIZZY,     ANIM_Fuzzy_Forest_AnimF,
    STATUS_FEAR,      ANIM_Fuzzy_Forest_AnimF,
    STATUS_END,
};
...
EvtScript N(handleEvent_80218584) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, ANIM_Fuzzy_Forest_Anim8)
            EVT_END_IF
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Fuzzy_Forest_Anim3)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Fuzzy_Forest_Anim1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_Fuzzy_Forest_Anim3)
            EVT_SET_CONST(LVar2, ANIM_Fuzzy_Forest_Anim9)
...
EvtScript N(80218C48) = {
    ...
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_AnimD)
    EVT_WAIT(130)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim2)
    ...
    EVT_END_THREAD
    EVT_WAIT(1)
    EVT_CALL(SetAnimation, LVar0, 1, ANIM_Fuzzy_Forest_Anim2)
    ...
    EVT_CALL(SetAnimation, LVar0, 1, ANIM_Fuzzy_Forest_Anim1)
...
EvtScript N(80219054) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim3)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_ADD(LVar0, 50)
    EVT_SET(LVar1, 0)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim1)
    EVT_LABEL(100)
    EVT_CALL(SetActorDispOffset, ACTOR_SELF, 0, 10, 0)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim4)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim5)
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(JumpToGoal, ACTOR_SELF, 11, FALSE, TRUE, FALSE)
            EVT_CALL(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim9)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_SUB(LVar0, 20)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(3.0))
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim7)
    EVT_WAIT(21)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Fuzzy_Forest_Anim0)
