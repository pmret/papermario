...
s32 N(idleAnimations_8022E550)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Yellow_Anim4,
    STATUS_STONE,     ANIM_KoopaBros_Yellow_Anim0,
    STATUS_SLEEP,     ANIM_KoopaBros_Yellow_Anim15,
    STATUS_POISON,    ANIM_KoopaBros_Yellow_Anim0,
    STATUS_STOP,      ANIM_KoopaBros_Yellow_Anim0,
    STATUS_STATIC,    ANIM_KoopaBros_Yellow_Anim0,
    STATUS_PARALYZE,  ANIM_KoopaBros_Yellow_Anim0,
    STATUS_PARALYZE,  ANIM_KoopaBros_Yellow_Anim0,
    STATUS_DIZZY,     ANIM_KoopaBros_Yellow_Anim18,
    STATUS_DIZZY,     ANIM_KoopaBros_Yellow_Anim18,
    STATUS_END,
};

s32 N(idleAnimations_8022E5A4)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Yellow_Anim5,
    STATUS_STONE,     ANIM_KoopaBros_Yellow_Anim1,
    STATUS_POISON,    ANIM_KoopaBros_Yellow_Anim1,
    STATUS_STOP,      ANIM_KoopaBros_Yellow_Anim1,
    STATUS_STATIC,    ANIM_KoopaBros_Yellow_Anim1,
    STATUS_PARALYZE,  ANIM_KoopaBros_Yellow_Anim1,
    STATUS_PARALYZE,  ANIM_KoopaBros_Yellow_Anim1,
    STATUS_END,
};

s32 N(idleAnimations_8022E5E0)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Yellow_AnimD,
    STATUS_STONE,     ANIM_KoopaBros_Yellow_Anim1,
    STATUS_POISON,    ANIM_KoopaBros_Yellow_Anim1,
    STATUS_STOP,      ANIM_KoopaBros_Yellow_Anim1,
    STATUS_STATIC,    ANIM_KoopaBros_Yellow_Anim1,
...
s32 N(idleAnimations_8022E61C)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Yellow_AnimC,
    STATUS_STONE,     ANIM_KoopaBros_Yellow_Anim17,
    STATUS_SLEEP,     ANIM_KoopaBros_Yellow_Anim17,
    STATUS_POISON,    ANIM_KoopaBros_Yellow_Anim17,
    STATUS_STOP,      ANIM_KoopaBros_Yellow_Anim17,
    STATUS_STATIC,    ANIM_KoopaBros_Yellow_Anim17,
...
s32 N(idleAnimations_8022E670)[] = {
    STATUS_NORMAL,    ANIM_KoopaBros_Yellow_AnimA,
    STATUS_END,
};
    ...
    EVT_SWITCH(LVarA)
        EVT_CASE_EQ(0)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_Anim4)
                EVT_CASE_OR_EQ(4)
                EVT_CASE_OR_EQ(5)
                EVT_CASE_OR_EQ(6)
                    EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_PTR(N(idleAnimations_8022E5A4)))
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_Anim5)
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
        EVT_CASE_EQ(1)
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LVar0)
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_AnimD)
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
        EVT_CASE_EQ(2)
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LVar0)
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_SET_CONST(LVar1, ANIM_KoopaBros_Yellow_AnimB)
                    ...
                    EVT_ELSE
                        ...
                        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_AnimA)
                    EVT_END_IF
                EVT_END_CASE_GROUP
            EVT_END_SWITCH
        EVT_CASE_EQ(3)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_SET_CONST(LVar0, 1)
                    EVT_SET_CONST(LVar1, ANIM_KoopaBros_Yellow_AnimE)
        ...
        EVT_CASE_EQ(4)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    EVT_SET_CONST(LVar0, 1)
                    EVT_SET_CONST(LVar1, ANIM_KoopaBros_Yellow_Anim8)
                    EVT_EXEC_WAIT(DoImmune)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_Anim9)
                EVT_CASE_OR_EQ(4)
                EVT_CASE_OR_EQ(5)
                EVT_CASE_OR_EQ(6)
                    EVT_SET_CONST(LVar0, 1)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_IF_EQ(LocalFlag(0), 1)
                        ...
                        EVT_END_THREAD
                    EVT_END_IF
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_AnimC)
        ...
        EVT_CASE_EQ(6)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_CALL(N(UnkEnemyPosFunc), LVar0, LVar1, LVar2)
                    EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_AnimE)
                    EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_PTR(N(idleAnimations_8022E670)))
                    EVT_CALL(JumpToGoal, ACTOR_SELF, 20, FALSE, TRUE, FALSE)
                    EVT_IF_EQ(LocalFlag(0), 1)
                        EVT_CALL(N(StartRumbleWithParams), 256, 5)
        ...
        EVT_CASE_EQ(7)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(3)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_Anim8)
                    EVT_WAIT(10)
                    ...
                    EVT_END_SWITCH
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_Anim7)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        ...
        EVT_CASE_EQ(8)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    ...
                    EVT_SET(LVar2, 15)
                    EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
                    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_Anim3)
...
EvtScript N(handleEvent_80230D28) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_KoopaBros_Yellow_AnimE)
            EVT_SET_CONST(LVar2, ANIM_KoopaBros_Yellow_AnimF)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_KoopaBros_Yellow_AnimF)
        ...
        EVT_CASE_EQ(EVENT_FLIP_TRIGGER)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LVar0)
            EVT_IF_EQ(LVar0, 0)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_KoopaBros_Yellow_AnimB)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, ANIM_KoopaBros_Yellow_AnimC)
                EVT_EXEC_WAIT(DoImmune)
            EVT_END_IF
        EVT_END_CASE_GROUP
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_IF_EQ(LVar0, 0)
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, ANIM_KoopaBros_Yellow_Anim4)
