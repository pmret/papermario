    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_EQ(2)
            ...
            EVT_SWITCH(LocalVar(0))
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_B)
        ...
        EVT_CASE_EQ(3)
            ...
            EVT_SWITCH(LocalVar(0))
                ...
                EVT_CASE_OR_EQ(6)
                    ...
                    EVT_SET_CONST(LocalVar(0), 1)
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_E)
        ...
        EVT_CASE_EQ(4)
            ...
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(3)
                    EVT_SET_CONST(LocalVar(0), 1)
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_8)
                ...
                EVT_CASE_OR_EQ(6)
                    EVT_SET_CONST(LocalVar(0), 1)
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_1F)
                    EVT_EXEC_WAIT(DoImmune)
...
EvtScript N(handleEvent_8022DD88) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_E)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_koopa_bros_Palette_00_Anim_F)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_F)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_C)
                EVT_EXEC_WAIT(DoImmune)
            EVT_END_IF
        EVT_END_CASE_GROUP
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_bros_Palette_00_Anim_4)
