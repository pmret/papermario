...
EvtScript N(EVS_UseMove0) = {
    ...
    EVT_SWITCH(LVar1)
        ...
        EVT_CASE_EQ(1)
            EVT_EXEC_WAIT(N(EVS_802A3D1C))
        EVT_CASE_EQ(2)
            EVT_EXEC_WAIT(N(EVS_802A4070))
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(EVS_802A39C8) = {
    ...
    EVT_THREAD
        ...
        EVT_WAIT(8)
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_Mario_50004)
    ...
    EVT_IF_EQ(LVar0, 0)
        ...
        EVT_ADD(LVar0, 15)
        EVT_ADD(LVar1, 35)
        EVT_CALL(func_802A10C8_759678, LVar0, LVar1, LVar2)
        ...
        EVT_CALL(GetActorPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
        EVT_CALL(SetJumpAnimations, ACTOR_PLAYER, 0, ANIM_Mario_50005, ANIM_Mario_50005, ANIM_Mario_50005)
...
EvtScript N(EVS_802A3D1C) = {
    ...
    EVT_THREAD
        ...
        EVT_WAIT(8)
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_Mario_50006)
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
    EVT_CALL(N(UnkMoveFunc2), LVar0, LVar1, LVar2, EVT_FLOAT(1.2))
    EVT_WAIT(3)
    EVT_CALL(N(UnkMoveFunc2), LVar0, LVar1, LVar2, EVT_FLOAT(0.8))
    ...
    EVT_IF_EQ(LVar0, 0)
        ...
        EVT_CALL(SetActorSpeed, ACTOR_PLAYER, EVT_FLOAT(1.0))
        EVT_CALL(GetActorPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
        EVT_CALL(SetJumpAnimations, ACTOR_PLAYER, 0, ANIM_Mario_50007, ANIM_Mario_50007, ANIM_Mario_50007)
        EVT_CALL(SetGoalPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
        EVT_CALL(func_80273444, 20, 0, 0)
        EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_Mario_10009)
        EVT_WAIT(4)
...
EvtScript N(EVS_802A4070) = {
    ...
    EVT_THREAD
        ...
        EVT_WAIT(8)
    EVT_END_THREAD
    EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_Mario_50008)
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
    EVT_CALL(N(UnkMoveFunc2), LVar0, LVar1, LVar2, EVT_FLOAT(1.2))
    EVT_WAIT(3)
    EVT_CALL(N(UnkMoveFunc2), LVar0, LVar1, LVar2, EVT_FLOAT(0.8))
    ...
    EVT_IF_EQ(LVar0, 0)
        ...
        EVT_CALL(SetActorSpeed, ACTOR_PLAYER, EVT_FLOAT(1.0))
        EVT_CALL(GetActorPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
        EVT_CALL(SetJumpAnimations, ACTOR_PLAYER, 0, ANIM_Mario_50009, ANIM_Mario_50009, ANIM_Mario_50009)
        EVT_CALL(SetGoalPos, ACTOR_PLAYER, LVar0, LVar1, LVar2)
        EVT_CALL(func_80273444, 20, 0, 0)
        EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_Mario_10009)
        EVT_WAIT(4)
