...
EvtScript N(EVS_UseMove1_Impl) = {
    ...
    EVT_CALL(PlaySoundAtActor, ACTOR_PLAYER, SOUND_LRAW_211E)
...
EvtScript N(EVS_UseMove2_Impl) = {
    ...
    EVT_CALL(PlaySoundAtActor, ACTOR_PLAYER, SOUND_LRAW_211F)
    EVT_CALL(PlayerTestEnemy, LVar0, DAMAGE_TYPE_SMASH, 25, 0, 0, 16)
    EVT_IF_EQ(LVar0, HIT_RESULT_MISS)
        EVT_WAIT(10)
        EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_Mario1_Idle)
...
EvtScript N(EVS_UseMove3_Impl) = {
    ...
    EVT_CALL(PlaySoundAtActor, ACTOR_PLAYER, SOUND_LRAW_2120)
    EVT_CALL(PlayerTestEnemy, LVar0, DAMAGE_TYPE_SMASH, 25, 0, 0, 16)
    EVT_IF_EQ(LVar0, HIT_RESULT_MISS)
        EVT_WAIT(10)
        EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_Mario1_Idle)
