...
EvtScript D_802A1C20_7384B0 = {
    ...
    EVT_IF_NE(LVar0, ACTION_COMMAND_MODE_NOT_LEARNED)
        ...
        EVT_IF_LT(LVar0, ACTION_COMMAND_MODE_TUTORIAL)
            EVT_CALL(battle_move_spin_smash_ShouldMovesAutoSucceed)
            EVT_IF_EQ(LVar0, 0)
                EVT_LOOP(45)
                    EVT_WAIT(1)
                    EVT_CALL(CheckButtonDown, 0x00040000, LVar0)
...
EvtScript D_802A3258_739AE8 = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            ...
            EVT_CALL(PlayerDamageEnemy, LVar0, 603979840, 25, 0, LVarF, BS_FLAGS1_40 | BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
        EVT_CASE_DEFAULT
            EVT_CALL(func_802A1074_737904)
            EVT_CALL(PlayerDamageEnemy, LVar0, 603979840, 25, 0, LVarE, BS_FLAGS1_SP_EVT_ACTIVE | BS_FLAGS1_10)
    EVT_END_SWITCH
    EVT_SWITCH(LVar0)
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
