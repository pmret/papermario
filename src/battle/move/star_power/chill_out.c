...
API_CALLABLE(N(func_802A1518_7905E8)) {
    D_802A2CC0 = FALSE;
    return ApiStatus_DONE2;
}

API_CALLABLE(N(func_802A1528_7905F8)) {
    script->varTable[0] = D_802A2CC0;
    return ApiStatus_DONE2;
}

API_CALLABLE(N(func_802A153C_79060C)) {
...
API_CALLABLE(N(func_802A163C_79070C)) {
...
EvtScript N(EVS_UsePower) = {
    EVT_CALL(N(func_802A1518_7905E8))
    ...
    EVT_LABEL(10)
        ...
        EVT_IF_EQ(LVar0, HIT_RESULT_MISS)
            EVT_GOTO(11)
        EVT_END_IF
        EVT_CALL(N(func_802A163C_79070C))
        ...
        EVT_END_IF
    EVT_LOOP(30)
        EVT_CALL(N(func_802A153C_79060C))
        EVT_WAIT(2)
    EVT_END_LOOP
    ...
    EVT_LABEL(0)
        ...
        EVT_CALL(N(func_802A163C_79070C))
        EVT_IF_EQ(LVar0, TRUE)
            EVT_CALL(N(func_802A16F4_7907C4))
        EVT_ELSE
        ...
        EVT_END_IF
    EVT_WAIT(5)
    EVT_CALL(N(func_802A1528_7905F8))
    EVT_IF_EQ(LVar0, TRUE)
