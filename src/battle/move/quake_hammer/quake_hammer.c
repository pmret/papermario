...
EvtScript D_802A3168_0073D038 = {
    ...
    EVT_LABEL(10)
    EVT_CALL(SetGoalToTarget, ACTOR_PLAYER)
    EVT_CALL(PlayerTestEnemy, LVar0, 2097152, 29, 0, 0, 16)
    EVT_IF_EQ(LVar0, 6)
        EVT_GOTO(11)
    EVT_END_IF
    EVT_CALL(DidActionSucceed, LVar0)
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(0)
            EVT_CALL(PlayerDamageEnemy, LVar0, 941623296, 25, 0, LVarF, 112)
        EVT_CASE_DEFAULT
            EVT_CALL(PlayerDamageEnemy, LVar0, 941623296, 25, 0, LVarE, 48)
    EVT_END_SWITCH
    EVT_LABEL(11)
