...
EvtScript N(EVS_UseMove_ImplA) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(FALSE)
            ...
            EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 75), 1, 80)
        EVT_CASE_DEFAULT
            EVT_CALL(SetActorSounds, ACTOR_PLAYER, ACTOR_SOUND_HURT, SOUND_15B, SOUND_0)
            EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 75), 1, 48)
    EVT_END_SWITCH
    EVT_SWITCH(LVar0)
    ...
    EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 100), 1, 224)
...
EvtScript N(EVS_UseMove_ImplB) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(FALSE)
            ...
            EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 75), 2, 80)
        EVT_CASE_DEFAULT
            EVT_CALL(PlaySoundAtActor, ACTOR_PLAYER, SOUND_15B)
            EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 75), 2, 48)
    EVT_END_SWITCH
    EVT_SWITCH(LVar0)
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_NO_DAMAGE)
    ...
    EVT_WAIT(1)
    EVT_CALL(PlaySoundAtActor, ACTOR_PLAYER, SOUND_15B)
    EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 100), 2, 224)
    EVT_CALL(func_80269550, LVarF)
    EVT_EXEC_WAIT(N(EVS_JumpSupport_E))
    EVT_RETURN
    EVT_END
...
EvtScript N(EVS_UseMove_ImplC) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_GT(FALSE)
            ...
            EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 75), 3, 80)
        EVT_CASE_DEFAULT
            EVT_CALL(PlaySoundAtActor, ACTOR_PLAYER, SOUND_15C)
            EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 75), 3, 48)
    EVT_END_SWITCH
    EVT_SWITCH(LVar0)
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_NO_DAMAGE)
    ...
    EVT_WAIT(1)
    EVT_CALL(PlaySoundAtActor, ACTOR_PLAYER, SOUND_15C)
    EVT_CALL(PlayerDamageEnemy, LVar0, DAMAGE_TYPE_JUMP, 0, DMG_STATUS_CHANCE(STATUS_FLAG_SHRINK, 3, 100), 3, 224)
    EVT_CALL(func_80269550, LVarF)
    EVT_EXEC_WAIT(N(EVS_JumpSupport_E))
    EVT_RETURN
    EVT_END
