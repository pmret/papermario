...
extern EvtSource D_802A4018_00740878;
extern EvtSource D_802A2720_0073EF80;
extern EvtSource D_802A2ABC_0073F31C;
extern EvtSource D_802A2DE8_0073F648;
extern EvtSource D_802A3188_0073F9E8;
extern EvtSource D_802A3378_0073FBD8;
extern EvtSource D_802A34EC_0073FD4C;
extern EvtSource D_802A36D8_0073FF38;
extern EvtSource D_802A39C4_00740224;
extern EvtSource D_802A3CF0_00740550;
...
EvtSource D_802A21D4_0073EA34 = {
    EVT_CALL(LoadActionCommand, ACTION_COMMAND_JUMP)
    EVT_CALL(action_command_jump_CreateHudElements)
    EVT_EXEC_WAIT(D_802A11FC_0073DA5C)
    EVT_EXEC_WAIT(D_802A1370_0073DBD0)
...
EvtSource D_802A2280 = {
    ...
    EVT_EXEC_WAIT(D_802A11FC_0073DA5C)
    EVT_CALL(InitTargetIterator)
    EVT_EXEC_WAIT(D_802A1458_0073DCB8)
    EVT_SET(LW(11), LW(10))
    EVT_ADD(LW(11), 14)
    EVT_ADD(LW(11), -3)
...
EvtSource D_802A23D4_0073EC34 = {
    EVT_CALL(LoadActionCommand, ACTION_COMMAND_JUMP)
    EVT_CALL(action_command_jump_CreateHudElements)
    EVT_EXEC_WAIT(D_802A11FC_0073DA5C)
    EVT_EXEC_WAIT(D_802A1540_0073DDA0)
...
EvtSource D_802A2650_0073EEB0 = {
    EVT_CALL(func_802694A4, 1)
    EVT_CALL(GetBattleFlags2, LW(0))
    EVT_IF_FLAG(LW(0), BS_FLAGS2_200)
        EVT_EXEC_WAIT(D_802A4018_00740878)
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(GetMenuSelection, LW(0), LW(1), LW(2))
    EVT_SWITCH(LW(1))
        EVT_CASE_EQ(0)
            EVT_EXEC_WAIT(D_802A2720_0073EF80)
        EVT_CASE_EQ(1)
            EVT_EXEC_WAIT(D_802A2ABC_0073F31C)
        EVT_CASE_EQ(2)
            EVT_EXEC_WAIT(D_802A2DE8_0073F648)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};

EvtSource D_802A2720_0073EF80 = {
    EVT_EXEC_WAIT(D_802A21D4_0073EA34)
    ...
    EVT_IF_EQ(LW(0), 6)
        EVT_EXEC_WAIT(D_802A203C_0073E89C)
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(GetActionCommandMode, LW(0))
    EVT_IF_GT(LW(0), 0)
    ...
    EVT_SWITCH(LW(0))
        EVT_CASE_OR_EQ(0)
        EVT_CASE_OR_EQ(2)
            EVT_EXEC_WAIT(D_802A1A00_0073E260)
            EVT_RETURN
        EVT_END_CASE_GROUP
        EVT_CASE_OR_EQ(1)
        EVT_CASE_OR_EQ(3)
...
EvtSource D_802A30F4_0073F954 = {
    EVT_CALL(func_802694A4, 1)
    EVT_CALL(GetMenuSelection, LW(0), LW(1), LW(2))
    EVT_SWITCH(LW(1))
        EVT_CASE_EQ(0)
            EVT_EXEC_WAIT(D_802A3188_0073F9E8)
        EVT_CASE_EQ(1)
            EVT_EXEC_WAIT(D_802A3378_0073FBD8)
        EVT_CASE_EQ(2)
            EVT_EXEC_WAIT(D_802A34EC_0073FD4C)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};

EvtSource D_802A3188_0073F9E8 = {
    EVT_CALL(SetGoalToTarget, ACTOR_PLAYER)
    EVT_CALL(GetGoalPos, ACTOR_PLAYER, LW(3), LW(4), LW(5))
    EVT_SUB(LW(3), 40)
    EVT_SET(LW(4), 40)
...
EvtSource D_802A3644_0073FEA4 = {
    EVT_CALL(func_802694A4, 1)
    EVT_CALL(GetMenuSelection, LW(0), LW(1), LW(2))
    EVT_SWITCH(LW(1))
        EVT_CASE_EQ(0)
            EVT_EXEC_WAIT(D_802A36D8_0073FF38)
        EVT_CASE_EQ(1)
            EVT_EXEC_WAIT(D_802A39C4_00740224)
        EVT_CASE_EQ(2)
            EVT_EXEC_WAIT(D_802A3CF0_00740550)
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};

EvtSource D_802A36D8_0073FF38 = {
    EVT_EXEC_WAIT(D_802A21D4_0073EA34)
    EVT_CALL(PlayerTestEnemy, LW(0), 128, 0, 0, 1, 0)
    EVT_IF_EQ(LW(0), 6)
        EVT_EXEC_WAIT(D_802A203C_0073E89C)
