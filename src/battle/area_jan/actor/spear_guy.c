...
s32 N(idleAnimations_802185C0)[] = {
    STATUS_NORMAL,    ANIM_JungleGuy_Anim4,
    STATUS_STONE,     ANIM_JungleGuy_Anim2,
    STATUS_SLEEP,     ANIM_JungleGuy_AnimD,
    STATUS_POISON,    ANIM_JungleGuy_AnimF,
    STATUS_STOP,      ANIM_JungleGuy_Anim2,
    STATUS_STATIC,    ANIM_JungleGuy_Anim4,
    STATUS_PARALYZE,  ANIM_JungleGuy_Anim2,
    STATUS_DIZZY,     ANIM_JungleGuy_AnimF,
    STATUS_FEAR,      ANIM_JungleGuy_AnimF,
    STATUS_END,
};

s32 N(idleAnimations_8021860C)[] = {
    STATUS_NORMAL,    ANIM_JungleGuy_Anim3,
    STATUS_STONE,     ANIM_JungleGuy_AnimD,
    STATUS_SLEEP,     ANIM_JungleGuy_AnimD,
    STATUS_POISON,    ANIM_JungleGuy_AnimF,
    STATUS_STOP,      ANIM_JungleGuy_Anim1,
    STATUS_STATIC,    ANIM_JungleGuy_Anim3,
    STATUS_PARALYZE,  ANIM_JungleGuy_Anim1,
    STATUS_DIZZY,     ANIM_JungleGuy_AnimF,
    STATUS_FEAR,      ANIM_JungleGuy_AnimF,
    STATUS_END,
};
...
EvtScript N(init_80218980) = {
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(0)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_JungleGuy_Anim4)
        EVT_CASE_EQ(1)
            EVT_EXEC_WAIT(N(setSpearStance))
            EVT_CALL(SetPartEventFlags, -127, 2, 16)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_JungleGuy_Anim3)
    EVT_END_SWITCH
...
EvtScript N(80218D7C) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_JungleGuy_Anim6)
...
EvtScript N(handleEvent_80218E3C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_JungleGuy_Anim7)
            EVT_SET_CONST(LVar2, ANIM_JungleGuy_Anim8)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_IF_FLAG(LVarB, STATUS_FLAG_SLEEP | STATUS_FLAG_FEAR | STATUS_FLAG_DIZZY)
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, ANIM_JungleGuy_AnimA)
                    EVT_SET_CONST(LVar2, ANIM_JungleGuy_AnimC)
                EVT_ELSE
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, ANIM_JungleGuy_AnimB)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_IF_FLAG(LVarB, STATUS_FLAG_SLEEP | STATUS_FLAG_FEAR | STATUS_FLAG_DIZZY)
                    ...
                    EVT_EXEC_WAIT(DoBurnHit)
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, ANIM_JungleGuy_AnimC)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_JungleGuy_Anim9)
            EVT_SET_CONST(LVar2, ANIM_JungleGuy_Anim8)
            EVT_EXEC_WAIT(N(80218B5C))
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_JungleGuy_Anim3)
            EVT_SET_CONST(LVar2, ANIM_JungleGuy_Anim4)
            EVT_EXEC_WAIT(N(80218B5C))
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, ANIM_JungleGuy_Anim4)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, ANIM_JungleGuy_Anim6)
            EVT_SET_CONST(LVar2, ANIM_JungleGuy_Anim7)
...
EvtScript N(spearStab) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_JungleGuy_Anim6)
...
EvtScript N(summonBackup) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_JungleGuy_Anim5)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_JungleGuy_AnimE)
    EVT_WAIT(20)
    ...
    EVT_IF_EQ(LVar0, LVar2)
        EVT_CALL(SetAnimation, LVar1, 2, ANIM_JungleGuy_Anim4)
        ...
        EVT_IF_LT(LVarA, LVar3)
            ...
            EVT_IF_EQ(LVar4, 0)
                ...
                EVT_CALL(SetAnimation, LVar1, 2, ANIM_JungleGuy_Anim3)
            EVT_END_IF
        EVT_END_IF
    EVT_END_IF
    ...
    EVT_ADD(LVar1, 15)
    EVT_CALL(PlayEffect, EFFECT_SPARKLES, 0, LVar0, LVar1, LVar2, 30, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(SetAnimation, LVarB, 2, ANIM_JungleGuy_AnimE)
    EVT_WAIT(20)
    EVT_IF_EQ(LocalFlag(0), 0)
        EVT_CALL(SetAnimation, LVarB, 2, ANIM_JungleGuy_Anim4)
    EVT_ELSE
        EVT_CALL(SetAnimation, LVarB, 2, ANIM_JungleGuy_Anim3)
    EVT_END_IF
    EVT_CALL(GetActorPos, LVarB, LVar0, LVar1, LVar2)
...
s32 N(idleAnimations_8021BF40)[] = {
    ...
    STATUS_STONE,     ANIM_ShyGuy_Red_Anim0,
    STATUS_SLEEP,     ANIM_ShyGuy_Red_Anim12,
    STATUS_POISON,    ANIM_ShyGuy_Red_Anim1,
    STATUS_STOP,      ANIM_ShyGuy_Red_Anim0,
    STATUS_STATIC,    ANIM_ShyGuy_Red_Anim1,
    STATUS_PARALYZE,  ANIM_ShyGuy_Red_Anim0,
...
EvtScript N(8021C0E8) = {
    ...
    EVT_SET_CONST(LVar1, ANIM_ShyGuy_Red_Anim3)
    EVT_EXEC_WAIT(DoReturnHome)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim1)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent_8021C14C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Red_AnimC)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Red_AnimD)
            EVT_SET_CONST(LVar2, ANIM_ShyGuy_Red_AnimE)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Red_AnimD)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Red_AnimE)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SPIN_SMASH_HIT)
            EVT_SET_CONST(LVar0, 1)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Red_Anim1)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_SET_CONST(LVar0, 1)
...
EvtScript N(8021C628) = {
    ...
    EVT_CALL(func_8024ECF8, -1, 1, 0)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim3)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_ADD(LVar0, 50)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim4)
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim5)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(0.5))
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_SUB(LVar0, 30)
            ...
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_ShyGuy_Red_Anim4)
            EVT_EXEC_WAIT(DoReturnHome)
...
EvtScript N(8021CD50) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim9)
    EVT_WAIT(20)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim3)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                EVT_WAIT(12)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_AnimA)
            EVT_END_THREAD
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim9)
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_ShyGuy_Red_Anim7)
            EVT_WAIT(15)
            EVT_GOTO(2)
            EVT_LABEL(1)
            EVT_CALL(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
