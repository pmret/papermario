...
EvtScript N(80218D7C) = {
    ...
    EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_6)
...
EvtScript N(handleEvent_80218E3C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_7)
            EVT_SET_CONST(LVar2, NPC_ANIM_jungle_guy_Palette_00_Anim_8)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_IF_FLAG(LVarB, STATUS_FLAG_SLEEP | STATUS_FLAG_FEAR | STATUS_FLAG_DIZZY)
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_A)
                    EVT_SET_CONST(LVar2, NPC_ANIM_jungle_guy_Palette_00_Anim_C)
                EVT_ELSE
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_B)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_IF_FLAG(LVarB, STATUS_FLAG_SLEEP | STATUS_FLAG_FEAR | STATUS_FLAG_DIZZY)
                    ...
                    EVT_EXEC_WAIT(DoBurnHit)
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_C)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_9)
            EVT_SET_CONST(LVar2, NPC_ANIM_jungle_guy_Palette_00_Anim_8)
            EVT_EXEC_WAIT(N(80218B5C))
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LVar2, NPC_ANIM_jungle_guy_Palette_00_Anim_4)
            EVT_EXEC_WAIT(N(80218B5C))
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_SWITCH(LVar0)
                EVT_CASE_EQ(0)
                    EVT_SET_CONST(LVar0, 2)
                    EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_4)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 2)
            EVT_SET_CONST(LVar1, NPC_ANIM_jungle_guy_Palette_00_Anim_6)
            EVT_SET_CONST(LVar2, NPC_ANIM_jungle_guy_Palette_00_Anim_7)
...
EvtScript N(summonBackup) = {
    ...
    EVT_IF_EQ(LVar0, LVar2)
        EVT_CALL(SetAnimation, LVar1, 2, NPC_ANIM_jungle_guy_Palette_00_Anim_4)
        ...
        EVT_IF_LT(LVarA, LVar3)
            ...
            EVT_IF_EQ(LVar4, 0)
                ...
                EVT_CALL(SetAnimation, LVar1, 2, NPC_ANIM_jungle_guy_Palette_00_Anim_3)
            EVT_END_IF
        EVT_END_IF
    EVT_END_IF
...
EvtScript N(8021C0E8) = {
    ...
    EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_3)
    EVT_EXEC_WAIT(DoReturnHome)
...
EvtScript N(handleEvent_8021C14C) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_C)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_D)
            EVT_SET_CONST(LVar2, NPC_ANIM_shy_guy_Palette_00_Anim_E)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_D)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_E)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SPIN_SMASH_HIT)
            EVT_SET_CONST(LVar0, 1)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_1)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_SET_CONST(LVar0, 1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LVar2, NPC_ANIM_shy_guy_Palette_00_Anim_14)
            EVT_EXEC_WAIT(DoScareAway)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LVar0, 1)
...
EvtScript N(8021C628) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_shy_guy_Palette_00_Anim_4)
            EVT_EXEC_WAIT(DoReturnHome)
