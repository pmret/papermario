...
EvtScript N(80218D7C) = {
    ...
    EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_6)
...
EvtScript N(handleEvent_80218E3C) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_7)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_jungle_guy_Palette_00_Anim_8)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                ...
                EVT_ELSE
                    EVT_SET_CONST(LocalVar(0), 2)
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_B)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                ...
                EVT_IF_FLAG(LVarB, STATUS_FLAG_SLEEP | STATUS_FLAG_FEAR | STATUS_FLAG_DIZZY)
                    ...
                    EVT_EXEC_WAIT(DoBurnHit)
                    EVT_SET_CONST(LocalVar(0), 2)
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_C)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_9)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_jungle_guy_Palette_00_Anim_8)
            EVT_EXEC_WAIT(N(80218B5C))
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_jungle_guy_Palette_00_Anim_4)
            EVT_EXEC_WAIT(N(80218B5C))
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(0)
                    EVT_SET_CONST(LocalVar(0), 2)
                    EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_4)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_jungle_guy_Palette_00_Anim_6)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_jungle_guy_Palette_00_Anim_7)
        ...
        EVT_CASE_EQ(EVENT_SPIKE_TAUNT)
            ...
            EVT_SWITCH(LVarA)
                EVT_CASE_EQ(0)
                    ...
                    EVT_END_IF
                    EVT_IF_FLAG(LocalVar(3), STATUS_FLAG_DIZZY)
                        EVT_ADD(LocalVar(0), -4)
                        EVT_ADD(LocalVar(1), 36)
                        EVT_SET(LocalFlag(0), 1)
                    EVT_END_IF
                    EVT_IF_FLAG(LocalVar(3), STATUS_FLAG_SLEEP)
                        EVT_ADD(LocalVar(0), -8)
                        EVT_ADD(LocalVar(1), 36)
                        EVT_SET(LocalFlag(0), 1)
                    EVT_END_IF
                    EVT_IF_EQ(LocalFlag(0), 0)
                        EVT_ADD(LocalVar(0), -28)
...
EvtScript N(summonBackup) = {
    ...
    EVT_WAIT(20)
    EVT_CALL(GetOriginalActorType, ACTOR_SELF, LocalVar(0))
    EVT_CALL(EnemyCreateTargetList, 32772)
    EVT_CALL(InitTargetIterator)
    EVT_LABEL(0)
    EVT_CALL(GetOwnerTarget, LocalVar(1), LocalVar(2))
    EVT_CALL(GetOriginalActorType, LocalVar(1), LocalVar(2))
...
EvtScript N(becomeShyGuy) = {
    ...
    EVT_THREAD
        EVT_LOOP(10)
            EVT_CALL(GetPartOffset, ACTOR_SELF, 4, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(PlayEffect, EFFECT_SPARKLES, 3, LocalVar(0), LocalVar(1), LocalVar(2), 5, 0, 0, 0, 0, 0, 0, 0, 0)
            EVT_WAIT(3)
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(PlaySoundAtPart, ACTOR_SELF, 4, 0x2FC)
    EVT_CALL(SetPartSounds, ACTOR_SELF, 4, 2, 0, 0)
    EVT_CALL(JumpPartTo, ACTOR_SELF, 4, LocalVar(0), 0, LocalVar(2), 30, 1)
    EVT_WAIT(5)
...
EvtScript N(spearThrow) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_END_THREAD
            EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(SetPartPos, ACTOR_SELF, 3, LocalVar(0), 20, LocalVar(2))
            ...
            EVT_THREAD
                ...
                EVT_LABEL(0)
                EVT_CALL(UpdateLerp)
                EVT_CALL(SetPartRotation, ACTOR_SELF, 3, 0, 0, LocalVar(0))
                EVT_WAIT(1)
