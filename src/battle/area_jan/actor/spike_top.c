...
extern s32 N(idleAnimations_80223C8C)[];
extern EvtScript N(init_80223D1C);
extern EvtScript N(idle_80223EEC);
extern EvtScript N(takeTurn_80225624);
extern EvtScript N(handleEvent_80224330);
extern EvtScript N(takeTurn_802260DC);
extern EvtScript N(handleEvent_80224888);
...
s32 N(defenseTable_80223B3C)[] = {
    ELEMENT_NORMAL, 0,
    ELEMENT_END,
};

s32 N(statusTable_80223B48)[] = {
    STATUS_NORMAL, 0,
    STATUS_DEFAULT, 0,
    STATUS_SLEEP, 60,
    STATUS_POISON, 50,
...
ActorPartBlueprint N(partsTable_80223BF4)[] = {
    {
        ...
        .targetOffset = { 0, 24 },
        .opacity = 255,
        .idleAnimations = N(idleAnimations_80223C8C),
...
ActorBlueprint NAMESPACE = {
    ...
    .level = 17,
    .maxHP = 4,
    .partCount = ARRAY_COUNT(N(partsTable_80223BF4)),
    .partsData = N(partsTable_80223BF4),
    .script = N(init_80223D1C),
    .statusTable = N(statusTable_80223B48),
    .escapeChance = 60,
    .airLiftChance = 70,
    .spookChance = 65,
    .baseStatusChance = 60,
...
EvtScript N(init_80223D1C) = {
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_80223EEC)))
    EVT_CALL(GetActorVar, ACTOR_SELF, 0, LW(0))
    EVT_IF_EQ(LW(0), 1)
        EVT_CALL(SetActorVar, ACTOR_SELF, 8, 0)
        EVT_CALL(N(UnkBattleFunc1), -10, 0, 10, 0)
        EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_80225624)))
        EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_80224330)))
    ...
    EVT_ELSE
        ...
        EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_802260DC)))
        EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_80224888)))
        EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_ADDR(N(idleAnimations_80223C40)))
...
EvtScript N(idle_80223EEC) = {
    EVT_RETURN
    EVT_END
};

EvtScript N(80223EFC) = {
    ...
    EVT_CALL(SetDefenseTable, ACTOR_SELF, 1, EVT_ADDR(N(defenseTable_80223B3C)))
    EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_ADDR(N(idleAnimations_80223CD8)))
    EVT_CALL(SetActorFlagBits, ACTOR_SELF, ACTOR_FLAG_HP_OFFSET_BELOW, 0)
...
EvtScript N(handleEvent_80224330) = {
...
s32 N(intTable_8022483C)[] = {
    7, 13, 17, 21, 23, 24, 23, 21, 17, 13,
    7, 0,  4,  7,  6,  4,  0,  2,  0,
};

EvtScript N(handleEvent_80224888) = {
    EVT_CALL(UseIdleAnimation, ACTOR_SELF, FALSE)
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 0)
    EVT_CALL(GetLastEvent, ACTOR_SELF, LW(0))
    EVT_SWITCH(LW(0))
        ...
        EVT_CASE_EQ(EVENT_FLIP_TRIGGER)
            ...
            EVT_THREAD
                ...
                EVT_WAIT_FRAMES(1)
            EVT_END_THREAD
            EVT_USE_BUF(EVT_ADDR(N(intTable_8022483C)))
            EVT_LOOP(19)
                EVT_BUF_READ1(LW(0))
...
EvtScript N(takeTurn_802260DC) = {
    ...
    EVT_IF_EQ(LW(0), 2)
        ...
        EVT_ELSE
            ...
            EVT_CALL(SetTargetOffset, ACTOR_SELF, 1, 0, 24)
            EVT_CALL(func_8027D4C8, ACTOR_SELF, 1, -1, -9)
            EVT_CALL(SetDefenseTable, ACTOR_SELF, 1, EVT_ADDR(N(defenseTable_80223B20)))
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_ADDR(N(idleAnimations_80223C40)))
            EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_80223EEC)))
