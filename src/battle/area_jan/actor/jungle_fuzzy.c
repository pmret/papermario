    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LVar0, DAMAGE_TYPE_ELECTRIC)
                ...
                EVT_SET_CONST(LVar1, NPC_ANIM_fuzzy_Palette_03_Anim_13)
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_fuzzy_Palette_03_Anim_8)
            EVT_END_IF
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_fuzzy_Palette_03_Anim_10)
            EVT_SET_CONST(LVar2, NPC_ANIM_fuzzy_Palette_03_Anim_12)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_fuzzy_Palette_03_Anim_12)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_fuzzy_Palette_03_Anim_3)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_fuzzy_Palette_03_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_fuzzy_Palette_03_Anim_3)
            EVT_SET_CONST(LVar2, NPC_ANIM_fuzzy_Palette_03_Anim_9)
...
EvtScript N(divide) = {
    ...
    EVT_END_THREAD
    EVT_WAIT(1)
    EVT_CALL(SetAnimation, LVar0, 1, NPC_ANIM_fuzzy_Palette_03_Anim_2)
    ...
    EVT_CALL(SetAnimation, LVar0, 1, NPC_ANIM_fuzzy_Palette_03_Anim_1)
