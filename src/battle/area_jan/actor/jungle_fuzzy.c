    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LocalVar(0), DAMAGE_TYPE_ELECTRIC)
                ...
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_03_Anim_13)
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_03_Anim_8)
            EVT_END_IF
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_03_Anim_10)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_fuzzy_Palette_03_Anim_12)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_03_Anim_12)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_03_Anim_3)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_03_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_fuzzy_Palette_03_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_fuzzy_Palette_03_Anim_9)
...
EvtScript N(divide) = {
    ...
    EVT_END_THREAD
    EVT_WAIT(1)
    EVT_CALL(SetAnimation, LocalVar(0), 1, NPC_ANIM_fuzzy_Palette_03_Anim_2)
    ...
    EVT_CALL(SetAnimation, LocalVar(0), 1, NPC_ANIM_fuzzy_Palette_03_Anim_1)
...
EvtScript N(leechAttack) = {
    ...
    EVT_IF_FLAG(LocalVar(1), STATUS_FLAG_STONE)
        EVT_WAIT(10)
        EVT_LOOP(2)
