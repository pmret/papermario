...
extern EvtScript N(init_802226A8);
extern EvtScript N(takeTurn_80223A8C);
extern EvtScript N(idle_8022274C);
extern EvtScript N(handleEvent_80222920);

s32 N(idleAnimations_80222550)[] = {
    STATUS_NORMAL,    NPC_ANIM_medi_guy_Palette_00_Anim_1,
    STATUS_STONE,     NPC_ANIM_medi_guy_Palette_00_Anim_0,
    STATUS_SLEEP,     NPC_ANIM_medi_guy_Palette_00_Anim_4,
    STATUS_POISON,    NPC_ANIM_medi_guy_Palette_00_Anim_1,
    STATUS_STOP,      NPC_ANIM_medi_guy_Palette_00_Anim_0,
    STATUS_STATIC,    NPC_ANIM_medi_guy_Palette_00_Anim_1,
    STATUS_PARALYZE,  NPC_ANIM_medi_guy_Palette_00_Anim_0,
    STATUS_DIZZY,     NPC_ANIM_medi_guy_Palette_00_Anim_A,
    STATUS_FEAR,      NPC_ANIM_medi_guy_Palette_00_Anim_A,
    STATUS_END,
};

s32 N(defenseTable_8022259C)[] = {
    ELEMENT_NORMAL, 0,
    ELEMENT_SHOCK, 0,
    ELEMENT_END,
};

s32 N(statusTable_802225B0)[] = {
    STATUS_NORMAL, 0,
    STATUS_DEFAULT, 0,
    STATUS_SLEEP, 70,
    STATUS_POISON, 50,
...
ActorPartBlueprint N(partsTable_8022265C)[] = {
    {
        ...
        .targetOffset = { -2, 38 },
        .opacity = 255,
        .idleAnimations = N(idleAnimations_80222550),
        .defenseTable = N(defenseTable_8022259C),
...
ActorBlueprint NAMESPACE = {
    ...
    .level = 14,
    .maxHP = 7,
    .partCount = ARRAY_COUNT(N(partsTable_8022265C)),
    .partsData = N(partsTable_8022265C),
    .script = N(init_802226A8),
    .statusTable = N(statusTable_802225B0),
    .escapeChance = 60,
    .airLiftChance = 90,
    .spookChance = 95,
    .baseStatusChance = 70,
...
EvtScript N(init_802226A8) = {
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_80223A8C)))
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_8022274C)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_80222920)))
...
EvtScript N(handleEvent_80222920) = {
    ...
    EVT_SWITCH(LW(0))
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_medi_guy_Palette_00_Anim_8)
            EVT_SET_CONST(LW(2), NPC_ANIM_medi_guy_Palette_00_Anim_9)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_medi_guy_Palette_00_Anim_9)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_medi_guy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_medi_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LW(2), NPC_ANIM_medi_guy_Palette_00_Anim_B)
...
EvtScript N(healOneAlly) = {
    ...
    EVT_THREAD
        ...
        EVT_CALL(HealActor, LW(10), LW(4), 0)
...
EvtScript N(takeTurn_80223A8C) = {
    EVT_EXEC_WAIT(N(802239AC))
    EVT_IF_EQ(LW(0), -1)
        EVT_EXEC_WAIT(N(flyingAttack))
    EVT_ELSE
        EVT_CALL(RandInt, 1000, LW(10))
        EVT_IF_LT(LW(10), 600)
