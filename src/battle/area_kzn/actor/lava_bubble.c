...
EvtScript N(idle_802191E4) = {
    ...
    EVT_LABEL(1)
    EVT_CALL(UpdateLerp)
    EVT_CALL(GetHomePos, ACTOR_SELF, LocalVar(2), LocalVar(3), LocalVar(4))
...
EvtScript N(handleEvent_80219500) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bubble_Palette_00_Anim_7)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bubble_Palette_00_Anim_8)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_bubble_Palette_00_Anim_9)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bubble_Palette_00_Anim_9)
        ...
        EVT_CASE_OR_EQ(EVENT_BURN_TAUNT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bubble_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_bubble_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_bubble_Palette_00_Anim_7)
...
EvtScript N(fireTackle) = {
    ...
    EVT_CALL(JumpToGoal, ACTOR_SELF, 10, FALSE, TRUE, FALSE)
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_FIRE, 0, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
            EVT_SET(LocalVar(0), 1)
            EVT_SET(LocalVar(1), 4587524)
            EVT_EXEC_WAIT(DoJumpBack)
            EVT_WAIT(5)
            EVT_EXEC_WAIT(N(80219464))
        EVT_END_CASE_GROUP
    ...
    EVT_LOOP(4)
        EVT_THREAD
            ...
            EVT_IF_FLAG(LVarA, STATUS_FLAG_SHRINK)
                EVT_CALL(SetPartScale, ACTOR_SELF, LocalVar(6), EVT_FLOAT(0.2), EVT_FLOAT(0.2), EVT_FLOAT(0.2))
            EVT_ELSE
                EVT_CALL(SetPartScale, ACTOR_SELF, LocalVar(6), EVT_FLOAT(0.5), EVT_FLOAT(0.5), EVT_FLOAT(0.5))
            EVT_END_IF
            EVT_CALL(SetPartPos, ACTOR_SELF, LocalVar(6), LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, LocalVar(6), ACTOR_PART_FLAG_INVISIBLE, 0)
            EVT_CALL(SetPartMoveSpeed, ACTOR_SELF, LocalVar(6), EVT_FLOAT(8.0))
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, LocalVar(6), EVT_FLOAT(0.01))
            EVT_CALL(SetPartSounds, ACTOR_SELF, LocalVar(6), 2, 720, 0)
            EVT_CALL(JumpPartTo, ACTOR_SELF, LocalVar(6), LocalVar(3), LocalVar(4), LocalVar(5), 0, 0)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, LocalVar(6), ACTOR_PART_FLAG_INVISIBLE, 1)
        EVT_END_THREAD
        EVT_WAIT(3)
...
EvtScript N(8021A218) = {
    EVT_EXEC(N(8021A074))
    EVT_CALL(GetDistanceToGoal, ACTOR_SELF, LocalVar(0))
...
EvtScript N(fireballs_Partner) = {
    ...
    EVT_EXEC_WAIT(N(8021A218))
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_FIRE | DAMAGE_TYPE_NO_CONTACT, 0, 0, 2, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_WAIT(20)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
...
EvtScript N(takeTurn_8021AEA4) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(1)
            ...
            EVT_IF_FLAG(LocalVar(0), STATUS_FLAG_KO)
                EVT_EXEC_WAIT(N(fireTackle))
            EVT_ELSE
