...
s32 N(idleAnimations)[] = {
    STATUS_NORMAL, ANIM_GeneralGuy_Anim2,
    STATUS_STONE, ANIM_GeneralGuy_Anim0,
    STATUS_SLEEP, ANIM_GeneralGuy_Anim0,
    STATUS_POISON, ANIM_GeneralGuy_Anim2,
    STATUS_STOP, ANIM_GeneralGuy_Anim0,
    STATUS_STATIC, ANIM_GeneralGuy_Anim0,
    STATUS_PARALYZE, ANIM_GeneralGuy_Anim0,
    STATUS_PARALYZE, ANIM_GeneralGuy_Anim0,
    STATUS_DIZZY, ANIM_GeneralGuy_Anim0,
    STATUS_DIZZY, ANIM_GeneralGuy_Anim0,
    STATUS_FEAR, ANIM_GeneralGuy_Anim0,
    STATUS_END,
};

s32 N(idleAnimations_bomb)[] = {
    STATUS_NORMAL, ANIM_GeneralGuyBomb_Anim0,
    STATUS_END,
};

s32 N(idleAnimations3)[] = {
    STATUS_NORMAL, ANIM_GeneralGuy_AnimE,
    STATUS_POISON, ANIM_GeneralGuy_AnimE,
    STATUS_STOP, ANIM_GeneralGuy_Anim0,
    STATUS_STATIC, ANIM_GeneralGuy_Anim0,
    STATUS_PARALYZE, ANIM_GeneralGuy_Anim0,
    STATUS_DIZZY, ANIM_GeneralGuy_Anim0,
...
EvtScript N(init) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GeneralGuy_Anim2)
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LVar1, ANIM_GeneralGuy_Anim5)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET(LVar0, 1)
            EVT_SET(LVar1, ANIM_GeneralGuy_Anim8)
            EVT_SET(LVar2, ANIM_GeneralGuy_Anim9)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_GeneralGuy_Anim9)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_GeneralGuy_AnimE)
            EVT_EXEC_WAIT(DoReturnHome)
        EVT_CASE_OR_EQ(EVENT_UNKNOWN_TRIGGER)
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_GeneralGuy_Anim2)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_GeneralGuy_Anim2)
            EVT_SET_CONST(LVar2, ANIM_GeneralGuy_Anim5)
...
EvtScript N(attack_throw_bomb) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_ENEMY0, 1, ANIM_GeneralGuy_AnimB)
    ...
    EVT_WAIT(20)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GeneralGuy_AnimB)
    EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_SUB(LVar0, 8)
    EVT_ADD(LVar1, 27)
    EVT_SUB(LVar2, 4)
    EVT_CALL(SetPartPos, ACTOR_SELF, 2, LVar0, LVar1, LVar2)
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_GeneralGuyBomb_Anim0)
    EVT_CALL(SetPartFlagBits, ACTOR_SELF, 2, ACTOR_PART_FLAG_INVISIBLE, 0)
    EVT_WAIT(15)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GeneralGuy_AnimA)
    ...
    EVT_ADD(LVar1, 20)
    EVT_CALL(SetPartPos, ACTOR_SELF, 2, LVar0, LVar1, LVar2)
    EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_GeneralGuyBomb_Anim1)
    EVT_CALL(SetPartFlagBits, ACTOR_SELF, 2, ACTOR_PART_FLAG_INVISIBLE, 0)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 2, EVT_FLOAT(0.1))
            EVT_CALL(FlyPartTo, ACTOR_SELF, 2, LVar0, LVar1, LVar2, 0, 30, 0)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 2, EVT_FLOAT(0.1))
            EVT_CALL(FlyPartTo, ACTOR_SELF, 2, LVar0, LVar1, LVar2, 0, 15, 0)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 2, ACTOR_PART_FLAG_INVISIBLE, 1)
            EVT_CALL(SetAnimation, ACTOR_ENEMY0, 1, ANIM_GeneralGuy_Anim2)
            EVT_CALL(SetPartFlagBits, ACTOR_ENEMY0, 1, ACTOR_PART_FLAG_INVISIBLE, 1)
            EVT_CALL(PlayModelAnimation, 0, EVT_PTR(toy_tank_as_close_hatch))
...
EvtScript N(attack_lightning_shot) = {
    ...
    EVT_END_IF
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_GeneralGuy_Anim3)
    EVT_WAIT(20)
