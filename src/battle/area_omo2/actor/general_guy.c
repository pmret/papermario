...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_general_guy_Palette_00_Anim_5)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET(LocalVar(0), 1)
            EVT_SET(LocalVar(1), NPC_ANIM_general_guy_Palette_00_Anim_8)
            EVT_SET(LocalVar(2), NPC_ANIM_general_guy_Palette_00_Anim_9)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_general_guy_Palette_00_Anim_9)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_general_guy_Palette_00_Anim_E)
            EVT_EXEC_WAIT(DoReturnHome)
        EVT_CASE_OR_EQ(EVENT_UNKNOWN_TRIGGER)
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_general_guy_Palette_00_Anim_2)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_general_guy_Palette_00_Anim_2)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_general_guy_Palette_00_Anim_5)
...
EvtScript N(takeTurn) = {
    ...
    EVT_IF_NE(LocalVar(0), FALSE)
        ...
        EVT_IF_NOT_FLAG(LocalVar(0), STATUS_FLAG_KO)
...
EvtScript N(attack_throw_bomb) = {
    ...
    EVT_CALL(PlayModelAnimation, 0, EVT_ADDR(toy_tank_as_open_hatch))
    EVT_WAIT(20)
    ...
    EVT_ADD(LocalVar(1), 27)
    EVT_SUB(LocalVar(2), 4)
    ...
    EVT_CALL(SetPartFlagBits, ACTOR_SELF, 2, ACTOR_PART_FLAG_INVISIBLE, 0)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 2, EVT_FLOAT(0.1))
            EVT_CALL(FlyPartTo, ACTOR_SELF, 2, LocalVar(0), LocalVar(1), LocalVar(2), 0, 30, 0)
            ...
            EVT_CALL(SetPartJumpGravity, ACTOR_SELF, 2, EVT_FLOAT(0.1))
            EVT_CALL(FlyPartTo, ACTOR_SELF, 2, LocalVar(0), LocalVar(1), LocalVar(2), 0, 15, 0)
            EVT_CALL(SetPartFlagBits, ACTOR_SELF, 2, ACTOR_PART_FLAG_INVISIBLE, 1)
            EVT_CALL(SetAnimation, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_2)
            EVT_CALL(SetPartFlagBits, ACTOR_ENEMY0, 1, ACTOR_PART_FLAG_INVISIBLE, 1)
            EVT_CALL(PlayModelAnimation, 0, EVT_ADDR(toy_tank_as_close_hatch))
    ...
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), DAMAGE_TYPE_BLAST | DAMAGE_TYPE_NO_CONTACT, 0, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
...
EvtScript N(attack_lightning_shot) = {
    ...
    EVT_CALL(PlayModelAnimation, 0, EVT_ADDR(toy_tank_as_open_hatch))
    EVT_WAIT(10)
    EVT_CALL(GetActorVar, ACTOR_ENEMY1, 7, LocalVar(0))
    ...
    EVT_THREAD
        EVT_LOOP(4)
            EVT_CALL(PlaySoundAtActor, LocalVar(8), SOUND_3D2)
            EVT_CALL(RandInt, 3, LocalVar(0))
            EVT_ADD(LocalVar(0), 3)
            EVT_WAIT(LocalVar(0))
        EVT_END_LOOP
    EVT_END_THREAD
    EVT_CALL(PlayEffect, EFFECT_SNAKING_STATIC, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 40, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(40)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_NO_CONTACT, 0, 5, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(HIT_RESULT_MISS)
            EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PLAYER)
            EVT_CALL(GetModelCenter, 39)
            ...
            EVT_CALL(PlayEffect, EFFECT_LIGHTNING_BOLT, 0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), LocalVar(4), LocalVar(5), EVT_FLOAT(1.0), 18, 0, 0, 0, 0)
            EVT_WAIT(12)
            EVT_CALL(SetTargetActor, ACTOR_SELF, ACTOR_PARTNER)
            EVT_CALL(EnemyTestTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_NO_CONTACT, 0, 2, BS_FLAGS1_SP_EVT_ACTIVE)
            EVT_IF_NE(LocalVar(0), HIT_RESULT_MISS)
                EVT_CALL(GetModelCenter, 39)
                EVT_CALL(SetGoalToTarget, ACTOR_SELF)
                ...
                EVT_WAIT(12)
                EVT_CALL(SetGoalToTarget, ACTOR_SELF)
                EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_NO_CONTACT, 0, 0, 2, BS_FLAGS1_SP_EVT_ACTIVE)
            EVT_ELSE
                EVT_CALL(SetActorVar, ACTOR_ENEMY1, 6, 0)
                EVT_WAIT(20)
            EVT_END_IF
    ...
    EVT_WAIT(12)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_NO_CONTACT, 0, 0, 5, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(15))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
        EVT_CASE_OR_EQ(HIT_RESULT_10)
