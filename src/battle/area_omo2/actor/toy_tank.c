...
EvtScript N(init) = {
    ...
    EVT_CALL(PlayModelAnimation, 0, EVT_ADDR(toy_tank_as_idle))
    ...
    EVT_CALL(PlayEffect, EFFECT_BULB_GLOW, 2, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), LocalVar(5), 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(SetActorVar, ACTOR_SELF, 5, LocalVar(5))
...
EvtScript N(idle) = {
    ...
    EVT_IF_NE(LocalVar(0), FALSE)
        ...
        EVT_IF_NE(LocalVar(0), 0)
            EVT_CALL(GetAnimatedNodePosition, 0, 62, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(SetActorPos, ACTOR_ENEMY0, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(GetAnimatedNodeRotation, 0, 62, LocalVar(0), LocalVar(1), LocalVar(2))
            EVT_CALL(SetActorRotation, ACTOR_ENEMY0, LocalVar(0), 0, LocalVar(2))
        EVT_END_IF
        EVT_CALL(GetActorVar, ACTOR_SELF, 5, LocalVar(5))
        EVT_IF_NE(LocalVar(5), 0)
            EVT_CALL(ActorExists, ACTOR_ENEMY2, LocalVar(0))
            EVT_IF_NE(LocalVar(0), FALSE)
                EVT_CALL(GetAnimatedNodeRotation, 0, 62, LocalVar(0), LocalVar(1), LocalVar(3))
                EVT_CALL(GetModelCenter, 39)
                EVT_CALL(GetActorVar, ACTOR_SELF, 6, LocalVar(6))
                EVT_IF_EQ(LocalVar(6), 0)
                    EVT_CALL(GetActorVar, ACTOR_SELF, 7, LocalVar(10))
                    EVT_IF_NE(LocalVar(10), 0)
                        EVT_SET(LocalVar(0), 1000)
                    EVT_END_IF
                EVT_END_IF
                EVT_CALL(N(UpdateBulbGlow), LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), LocalVar(5))
            EVT_END_IF
        EVT_END_IF
        EVT_WAIT(1)
        EVT_GOTO(0)
...
EvtScript N(onHit) = {
    ...
    EVT_CALL(func_80269E80, LocalVar(1))
    EVT_SWITCH(LocalVar(1))
        EVT_CASE_EQ(19)
            EVT_IF_NOT_FLAG(LocalVar(0), 0x2)
                EVT_BITWISE_OR_CONST(LocalVar(0), 0xE)
        ...
        EVT_CASE_OR_EQ(4)
            EVT_IF_NOT_FLAG(LocalVar(0), 0x4)
                EVT_BITWISE_OR_CONST(LocalVar(0), 0xC)
                EVT_CALL(SetActorVar, ACTOR_ENEMY0, 1, LocalVar(0))
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_19)
                EVT_CALL(SetBattleCamZoom, 260)
                EVT_CALL(SetBattleCamTarget, 85, 80, 0)
        ...
        EVT_END_CASE_GROUP
        EVT_CASE_DEFAULT
            EVT_IF_NOT_FLAG(LocalVar(0), 0x8)
                EVT_BITWISE_OR_CONST(LocalVar(0), 0xC)
                EVT_CALL(SetActorVar, ACTOR_ENEMY0, 1, LocalVar(0))
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_19)
                EVT_CALL(SetBattleCamZoom, 260)
...
EvtScript N(shake_tank) = {
    EVT_CALL(PlayModelAnimation, 0, EVT_ADDR(toy_tank_as_shake))
    EVT_WAIT(30)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(select_phase) = {
    ...
    EVT_IF_EQ(LocalVar(0), PARTNER_WATT)
        EVT_CALL(SetActorVar, ACTOR_SELF, 2, 3)
        EVT_CALL(SetActorVar, ACTOR_SELF, 3, 0)
        EVT_CALL(CancelEnemyTurn, 1)
        EVT_EXEC_WAIT(N(update_phase))
...
EvtScript N(update_phase) = {
    EVT_CALL(GetActorVar, ACTOR_ENEMY0, 2, LocalVar(0))
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(6)
            EVT_CALL(SetActorVar, ACTOR_ENEMY0, 2, 5)
        EVT_CASE_DEFAULT
            EVT_ADD(LocalVar(0), 1)
            EVT_CALL(SetActorVar, ACTOR_ENEMY0, 2, LocalVar(0))
    EVT_END_SWITCH
    EVT_RETURN
    EVT_END
};
...
EvtScript N(start_stilt_guys_phase) = {
    ...
    EVT_WAIT(30)
    EVT_CALL(GetActorVar, ACTOR_ENEMY0, 1, LocalVar(0))
    EVT_IF_NOT_FLAG(LocalVar(0), 0x1)
    ...
    EVT_WAIT(5)
    EVT_CALL(PlayModelAnimation, 0, EVT_ADDR(toy_tank_as_move_forward))
    ...
    EVT_WAIT(25)
    EVT_WAIT(2)
    EVT_CALL(SetOwnerTarget, LocalVar(0), 1)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(1), DAMAGE_TYPE_IGNORE_DEFENSE, 0, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
    ...
    EVT_CALL(SetHomePos, ACTOR_ENEMY0, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(start_shy_stack_phase) = {
    ...
    EVT_LABEL(0)
    EVT_CALL(GetActorVar, ACTOR_SELF, 2, LocalVar(0))
    EVT_IF_NE(LocalVar(0), 4)
        EVT_WAIT(1)
        EVT_GOTO(0)
    EVT_END_IF
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_19)
    EVT_CALL(GetActorPos, ACTOR_ENEMY4, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_THREAD
        EVT_CALL(GetActorPos, ACTOR_ENEMY3, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(SetActorJumpGravity, ACTOR_ENEMY3, EVT_FLOAT(1.5))
        EVT_CALL(SetGoalPos, ACTOR_ENEMY3, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_THREAD
        ...
        EVT_CALL(SetGoalPos, ACTOR_ENEMY4, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(summon_tank_squad) = {
    ...
    EVT_LOOP(15)
        EVT_CALL(RandInt, 3, LocalVar(1))
        EVT_SWITCH(LocalVar(1))
            EVT_CASE_EQ(0)
                EVT_SET(LocalVar(1), NPC_ANIM_tank_guy_Palette_00_Anim_8)
            EVT_CASE_EQ(1)
                EVT_SET(LocalVar(1), NPC_ANIM_tank_guy_Palette_00_Anim_9)
            EVT_CASE_EQ(2)
                EVT_SET(LocalVar(1), NPC_ANIM_tank_guy_Palette_00_Anim_A)
            EVT_CASE_DEFAULT
                EVT_SET(LocalVar(1), NPC_ANIM_tank_guy_Palette_00_Anim_6)
        EVT_END_SWITCH
        EVT_CALL(SetAnimation, ACTOR_ENEMY3, LocalVar(0), LocalVar(1))
        EVT_ADD(LocalVar(0), 1)
    EVT_END_LOOP
    EVT_CALL(SetAnimation, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_4)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    ...
    EVT_SET(LocalVar(0), 2)
    EVT_LOOP(15)
        EVT_CALL(SetAnimation, ACTOR_ENEMY3, LocalVar(0), NPC_ANIM_tank_guy_Palette_00_Anim_1)
        EVT_ADD(LocalVar(0), 1)
    EVT_END_LOOP
    EVT_CALL(func_8026BF48, 0)
    EVT_RETURN
...
EvtScript N(onDeath) = {
    ...
    EVT_CALL(PlayModelAnimation, 0, EVT_ADDR(toy_tank_as_fall_apart))
    ...
    EVT_END_THREAD
    EVT_CALL(SetGoalPos, ACTOR_ENEMY0, LocalVar(0), LocalVar(1), LocalVar(2))
    ...
    EVT_CALL(ForceHomePos, ACTOR_ENEMY0, LocalVar(0), LocalVar(1), LocalVar(2))
...
EvtScript N(8022F2BC) = {
    EVT_LABEL(0)
    EVT_CALL(ActorExists, ACTOR_SELF, LocalVar(0))
    EVT_IF_EQ(LocalVar(0), FALSE)
        EVT_RETURN
    EVT_END_IF
    EVT_CALL(func_802537C0, LocalVar(0), LocalVar(1))
    EVT_IF_EQ(LocalVar(0), 1)
        EVT_GOTO(10)
    EVT_END_IF
    EVT_CALL(GetActorVar, ACTOR_SELF, 7, LocalVar(0))
    ...
    EVT_ELSE
        ...
        EVT_END_IF
    EVT_END_IF
    EVT_CALL(func_802181F4_52B894, LocalVar(1))
    EVT_LABEL(10)
    EVT_WAIT(1)
    EVT_GOTO(0)
    EVT_RETURN
...
EvtScript N(8022F458) = {
    EVT_IF_NE(LocalVar(1), 0)
        EVT_SUB(LocalVar(1), 5)
        EVT_IF_LT(LocalVar(1), 0)
            EVT_SET(LocalVar(1), 0)
        EVT_END_IF
        EVT_CALL(SetActorVar, ACTOR_SELF, 8, LocalVar(1))
    EVT_END_IF
    EVT_RETURN
    EVT_END
};
...
EvtScript N(8022F4D0) = {
    EVT_IF_NE(LocalVar(1), 215)
        EVT_ADD(LocalVar(1), 5)
        EVT_IF_GT(LocalVar(1), 215)
            EVT_SET(LocalVar(1), 215)
        EVT_END_IF
        EVT_CALL(SetActorVar, ACTOR_SELF, 8, LocalVar(1))
    EVT_END_IF
    EVT_RETURN
