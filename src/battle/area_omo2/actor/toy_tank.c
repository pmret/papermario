...
EvtScript N(init) = {
    ...
    EVT_CALL(PlayEffect, EFFECT_BULB_GLOW, 2, LVar0, LVar1, LVar2, EVT_FLOAT(1.0), LVar5, 0, 0, 0, 0, 0, 0, 0)
    ...
    EVT_SWITCH(LVar1)
        EVT_CASE_EQ(19)
            EVT_IF_NOT_FLAG(LVar0, 0x2)
                ...
                EVT_WAIT(20)
                EVT_CALL(ActorSpeak, MESSAGE_ID_0F0072, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5, NPC_ANIM_general_guy_Palette_00_Anim_5)
        ...
        EVT_CASE_OR_EQ(4)
            EVT_IF_NOT_FLAG(LVar0, 0x4)
                ...
                EVT_CALL(MoveBattleCamOver, 20)
                EVT_WAIT(20)
                EVT_CALL(ActorSpeak, MESSAGE_ID_0F0073, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5, NPC_ANIM_general_guy_Palette_00_Anim_5)
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
                EVT_CALL(MoveBattleCamOver, 30)
            EVT_END_IF
        EVT_END_CASE_GROUP
        EVT_CASE_DEFAULT
            EVT_IF_NOT_FLAG(LVar0, 0x8)
                ...
                EVT_CALL(MoveBattleCamOver, 20)
                EVT_WAIT(20)
                EVT_CALL(ActorSpeak, MESSAGE_ID_0F0074, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5, NPC_ANIM_general_guy_Palette_00_Anim_5)
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
                EVT_CALL(MoveBattleCamOver, 30)
            EVT_END_IF
    EVT_END_SWITCH
...
EvtScript N(start_stilt_guys_phase) = {
    ...
    EVT_IF_NOT_FLAG(LVar0, 0x1)
        EVT_CALL(ActorSpeak, MESSAGE_ID_0F0069, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_0, NPC_ANIM_general_guy_Palette_00_Anim_0)
    EVT_ELSE // shy squad has fleed
        EVT_CALL(ActorSpeak, MESSAGE_ID_0F006A, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_END_IF
...
EvtScript N(start_shy_stack_phase) = {
    ...
    EVT_CALL(GetActorVar, ACTOR_ENEMY0, 2, LVar0)
    EVT_IF_EQ(LVar0, 2)
        EVT_CALL(ActorSpeak, MESSAGE_ID_0F006E, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_ELSE
    EVT_END_IF
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 30)
    ...
    EVT_CALL(MoveBattleCamOver, 40)
    EVT_WAIT(40)
    EVT_CALL(ActorSpeak, MESSAGE_ID_0F006F, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_THREAD
    ...
    EVT_END_THREAD
    EVT_CALL(ActorSpeak, MESSAGE_ID_0F0070, ACTOR_ENEMY4, 1, -1, -1)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 30)
    EVT_WAIT(30)
    EVT_CALL(func_802535B4, 1)
...
EvtScript N(summon_stilt_guys) = {
    ...
    EVT_CALL(GetActorVar, ACTOR_ENEMY0, 2, LVar0)
    EVT_IF_EQ(LVar0, 1)
        EVT_CALL(ActorSpeak, MESSAGE_ID_0F006B, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_ELSE
    EVT_END_IF
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 30)
    ...
    EVT_CALL(MoveBattleCamOver, 40)
    EVT_WAIT(40)
    EVT_CALL(ActorSpeak, MESSAGE_ID_0F006C, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_THREAD
        EVT_CALL(GetActorPos, ACTOR_ENEMY3, LVar0, LVar1, LVar2)
        EVT_CALL(SetActorJumpGravity, ACTOR_ENEMY3, EVT_FLOAT(1.5))
        EVT_CALL(SetGoalPos, ACTOR_ENEMY3, LVar0, LVar1, LVar2)
    ...
    EVT_THREAD
        ...
        EVT_CALL(JumpToGoal, ACTOR_ENEMY4, 10, FALSE, TRUE, FALSE)
    EVT_END_THREAD
    EVT_CALL(ActorSpeak, MESSAGE_ID_0F006D, ACTOR_ENEMY4, 1, -1, -1)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 30)
    EVT_CALL(func_8026BF48, 0)
    EVT_RETURN
...
EvtScript N(summon_tank_squad) = {
    ...
    EVT_LOOP(15)
        ...
        EVT_SWITCH(LVar1)
            EVT_CASE_EQ(0)
                EVT_SET(LVar1, NPC_ANIM_tank_guy_Palette_00_Anim_8)
            EVT_CASE_EQ(1)
                EVT_SET(LVar1, NPC_ANIM_tank_guy_Palette_00_Anim_9)
            EVT_CASE_EQ(2)
                EVT_SET(LVar1, NPC_ANIM_tank_guy_Palette_00_Anim_A)
            EVT_CASE_DEFAULT
                EVT_SET(LVar1, NPC_ANIM_tank_guy_Palette_00_Anim_6)
        EVT_END_SWITCH
    ...
    EVT_SET(LVar0, 2)
    EVT_LOOP(15)
        EVT_CALL(SetAnimation, ACTOR_ENEMY3, LVar0, NPC_ANIM_tank_guy_Palette_00_Anim_1)
        EVT_ADD(LVar0, 1)
    EVT_END_LOOP
    EVT_CALL(func_8026BF48, 0)
    EVT_RETURN
...
EvtScript N(start_battle_with_tank) = {
    ...
    EVT_WAIT(60)
    EVT_CALL(ActorSpeak, MESSAGE_ID_0F0071, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_0, NPC_ANIM_general_guy_Palette_00_Anim_0)
    EVT_CALL(SetAnimation, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5)
    EVT_CALL(EndActorSpeech, ACTOR_ENEMY0, 1, -1, -1)
