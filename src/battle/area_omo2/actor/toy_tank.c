    ...
    EVT_SWITCH(LVar1)
        EVT_CASE_EQ(19)
            EVT_IF_NOT_FLAG(LVar0, 0x2)
                ...
                EVT_WAIT(20)
                EVT_CALL(ActorSpeak, MSG_CH4_0072, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5, NPC_ANIM_general_guy_Palette_00_Anim_5)
        ...
        EVT_CASE_OR_EQ(4)
            EVT_IF_NOT_FLAG(LVar0, 0x4)
                ...
                EVT_CALL(MoveBattleCamOver, 20)
                EVT_WAIT(20)
                EVT_CALL(ActorSpeak, MSG_CH4_0073, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5, NPC_ANIM_general_guy_Palette_00_Anim_5)
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
                EVT_CALL(MoveBattleCamOver, 30)
            EVT_END_IF
        EVT_END_CASE_GROUP
        EVT_CASE_DEFAULT
            EVT_IF_NOT_FLAG(LVar0, 0x8)
                ...
                EVT_CALL(MoveBattleCamOver, 20)
                EVT_WAIT(20)
                EVT_CALL(ActorSpeak, MSG_CH4_0074, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5, NPC_ANIM_general_guy_Palette_00_Anim_5)
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
                EVT_CALL(MoveBattleCamOver, 30)
            EVT_END_IF
    EVT_END_SWITCH
...
EvtScript N(start_stilt_guys_phase) = {
    ...
    EVT_IF_NOT_FLAG(LVar0, 0x1)
        EVT_CALL(ActorSpeak, MSG_CH4_0069, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_0, NPC_ANIM_general_guy_Palette_00_Anim_0)
    EVT_ELSE // shy squad has fleed
        EVT_CALL(ActorSpeak, MSG_CH4_006A, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_END_IF
...
EvtScript N(start_shy_stack_phase) = {
    ...
    EVT_CALL(GetActorVar, ACTOR_ENEMY0, 2, LVar0)
    EVT_IF_EQ(LVar0, 2)
        EVT_CALL(ActorSpeak, MSG_CH4_006E, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_ELSE
    EVT_END_IF
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 30)
    ...
    EVT_CALL(MoveBattleCamOver, 40)
    EVT_WAIT(40)
    EVT_CALL(ActorSpeak, MSG_CH4_006F, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_THREAD
...
EvtScript N(summon_stilt_guys) = {
    ...
    EVT_CALL(GetActorVar, ACTOR_ENEMY0, 2, LVar0)
    EVT_IF_EQ(LVar0, 1)
        EVT_CALL(ActorSpeak, MSG_CH4_006B, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_ELSE
    EVT_END_IF
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 30)
    ...
    EVT_CALL(MoveBattleCamOver, 40)
    EVT_WAIT(40)
    EVT_CALL(ActorSpeak, MSG_CH4_006C, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_C, NPC_ANIM_general_guy_Palette_00_Anim_2)
    EVT_THREAD
        EVT_CALL(GetActorPos, ACTOR_ENEMY3, LVar0, LVar1, LVar2)
        EVT_CALL(SetActorJumpGravity, ACTOR_ENEMY3, EVT_FLOAT(1.5))
        EVT_CALL(SetGoalPos, ACTOR_ENEMY3, LVar0, LVar1, LVar2)
...
EvtScript N(start_battle_with_tank) = {
    ...
    EVT_WAIT(60)
    EVT_CALL(ActorSpeak, MSG_CH4_0071, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_0, NPC_ANIM_general_guy_Palette_00_Anim_0)
    EVT_CALL(SetAnimation, ACTOR_ENEMY0, 1, NPC_ANIM_general_guy_Palette_00_Anim_5)
    EVT_CALL(EndActorSpeech, ACTOR_ENEMY0, 1, -1, -1)
