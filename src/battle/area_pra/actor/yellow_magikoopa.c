...
s32 N(802251B0)[] = {
    ...
    STATUS_POISON, NPC_ANIM_magikoopa_Palette_02_Anim_1,
    STATUS_STOP, NPC_ANIM_magikoopa_Palette_02_Anim_0,
    STATUS_STATIC, NPC_ANIM_magikoopa_Palette_02_Anim_1,
    STATUS_PARALYZE, NPC_ANIM_magikoopa_Palette_02_Anim_0,
    STATUS_DIZZY, NPC_ANIM_magikoopa_Palette_02_Anim_7,
    STATUS_FEAR, NPC_ANIM_magikoopa_Palette_02_Anim_7,
    STATUS_END,
};
...
s32 N(802251FC)[] = {
    ...
    STATUS_POISON, NPC_ANIM_flying_magikoopa_Palette_02_Anim_1,
    STATUS_STOP, NPC_ANIM_flying_magikoopa_Palette_02_Anim_0,
    STATUS_STATIC, NPC_ANIM_flying_magikoopa_Palette_02_Anim_1,
    STATUS_PARALYZE, NPC_ANIM_flying_magikoopa_Palette_02_Anim_0,
    STATUS_DIZZY, NPC_ANIM_flying_magikoopa_Palette_02_Anim_7,
    STATUS_FEAR, NPC_ANIM_flying_magikoopa_Palette_02_Anim_7,
    STATUS_END,
};

s32 N(80225248)[] = {
    STATUS_NORMAL, NPC_ANIM_flying_magikoopa_Palette_02_Anim_A,
    STATUS_END,
};
...
EvtScript N(80225264) = {
    ...
    EVT_SWITCH(LW(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_02_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_02_Anim_5)
            EVT_SET_CONST(LW(2), NPC_ANIM_magikoopa_Palette_02_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_02_Anim_6)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_02_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_magikoopa_Palette_02_Anim_4)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.5))
            EVT_CALL(GetActorPos, ACTOR_SELF, LW(0), LW(1), LW(2))
            EVT_CALL(SetGoalPos, ACTOR_SELF, LW(0), LW(1), LW(2))
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
            EVT_WAIT_FRAMES(15)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_magikoopa_Palette_02_Anim_2)
            EVT_EXEC_WAIT(N(80227174))
            EVT_RETURN
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_02_Anim_2)
...
EvtScript N(80225E84) = {
    ...
    EVT_SWITCH(LW(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            EVT_EXEC_WAIT(N(8022577C))
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_02_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_CASE_OR_EQ(EVENT_HIT)
        EVT_CASE_OR_EQ(EVENT_FALL_TRIGGER)
            ...
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_02_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
            EVT_EXEC_WAIT(N(80225888))
        EVT_END_CASE_GROUP
        EVT_CASE_OR_EQ(EVENT_BURN_HIT)
        EVT_CASE_OR_EQ(EVENT_15)
            EVT_EXEC_WAIT(N(8022577C))
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_02_Anim_5)
            EVT_SET_CONST(LW(2), NPC_ANIM_flying_magikoopa_Palette_02_Anim_6)
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_EXEC_WAIT(N(80225888))
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_02_Anim_6)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SPIN_SMASH_HIT)
            EVT_SET_CONST(LW(0), 2)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_02_Anim_1)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_SET_CONST(LW(0), 2)
        ...
        EVT_CASE_EQ(EVENT_END_FIRST_STRIKE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, NPC_ANIM_flying_magikoopa_Palette_02_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_EXEC_WAIT(DoRecover)
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, NPC_ANIM_flying_magikoopa_Palette_02_Anim_4)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.5))
            EVT_CALL(GetActorPos, ACTOR_SELF, LW(0), LW(1), LW(2))
            EVT_CALL(SetGoalPos, ACTOR_SELF, LW(0), LW(1), LW(2))
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
            EVT_WAIT_FRAMES(15)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, NPC_ANIM_flying_magikoopa_Palette_02_Anim_2)
            EVT_EXEC_WAIT(N(80227174))
            EVT_RETURN
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_02_Anim_2)
            EVT_EXEC_WAIT(DoAirLift)
        EVT_CASE_EQ(EVENT_BLOW_AWAY)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LW(0))
            EVT_IF_NOT_FLAG(LW(0), STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
...
EvtScript N(802264E8) = {
    ...
    EVT_SWITCH(LW(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, NPC_ANIM_flying_magikoopa_Palette_02_Anim_3)
            EVT_WAIT_FRAMES(5)
            EVT_CALL(GetActorPos, ACTOR_SELF, LW(0), LW(1), LW(2))
            ...
            EVT_SUB(LW(3), 50)
            EVT_SET(LW(4), 0)
            EVT_CALL(N(802189E0), LW(0), LW(1), LW(5), LW(3), LW(4), LW(5), 25)
            EVT_WAIT_FRAMES(50)
    ...
    EVT_CALL(GetGoalPos, ACTOR_SELF, LW(3), LW(4), LW(5))
    EVT_SUB(LW(3), 10)
    EVT_CALL(N(802189E0), LW(0), LW(1), LW(5), LW(3), LW(4), LW(5), 20)
    EVT_WAIT_FRAMES(18)
    EVT_WAIT_FRAMES(2)
...
EvtScript N(80226B04) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_magikoopa_Palette_02_Anim_3)
    EVT_WAIT_FRAMES(11)
...
EvtScript N(802274E0) = {
    ...
    EVT_IF_FLAG(LW(0), ACTOR_FLAG_FLYING)
        EVT_EXEC_WAIT(N(802264E8))
    EVT_ELSE
        EVT_EXEC_WAIT(N(80226B04))
    EVT_END_IF
    EVT_RETURN
    EVT_LABEL(100)
    EVT_CALL(UseIdleAnimation, ACTOR_SELF, FALSE)
    ...
    EVT_IF_NOT_FLAG(LW(0), ACTOR_FLAG_FLYING)
        ...
        EVT_IF_FLAG(LW(10), STATUS_FLAG_SHRINK)
            ...
            EVT_ADD(LW(1), 12)
            EVT_SUB(LW(2), 2)
            EVT_CALL(PlayEffect, EFFECT_SNAKING_STATIC, 0, LW(0), LW(1), LW(2), EVT_FLOAT(0.12), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_ELSE
            EVT_SUB(LW(0), 16)
            EVT_ADD(LW(1), 31)
            EVT_SUB(LW(2), 2)
            EVT_CALL(PlayEffect, EFFECT_SNAKING_STATIC, 0, LW(0), LW(1), LW(2), EVT_FLOAT(0.3), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_END_IF
    EVT_ELSE
        EVT_CALL(GetActorPos, ACTOR_SELF, LW(0), LW(1), LW(2))
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LW(10))
    ...
    EVT_THREAD
        ...
        EVT_CALL(ElectrifyActor, LW(8), 3)
