...
EvtScript N(handleEvent_8021C9C4) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_paragoomba_hyper_pain)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_paragoomba_hyper_burn_pain)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_paragoomba_hyper_burn_dead)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_paragoomba_hyper_burn_dead)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, 2, EVT_ADDR(N(idleAnimations_8021C594)))
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_paragoomba_hyper_electrocute)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_DEATH)
            ...
            EVT_EXEC_WAIT(DoShockHit)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_paragoomba_hyper_dead)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_STAR_BEAM)
            ...
            EVT_END_IF
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_paragoomba_hyper_idle)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_paragoomba_hyper_run)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_paragoomba_hyper_pain)
