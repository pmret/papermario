...
s32 N(idleAnimations_80220C60)[] = {
    ...
    STATUS_POISON,    ANIM_Cleft_Hyper_Anim04,
    STATUS_STOP,      ANIM_Cleft_Hyper_Anim00,
    STATUS_STATIC,    ANIM_Cleft_Hyper_Anim04,
    STATUS_PARALYZE,  ANIM_Cleft_Hyper_Anim00,
    STATUS_DIZZY,     ANIM_Cleft_Hyper_Anim0E,
    STATUS_FEAR,      ANIM_Cleft_Hyper_Anim0E,
    STATUS_END,
};
...
s32 N(idleAnimations_80221CD4)[] = {
    ...
    STATUS_STONE,     ANIM_Cleft_Hyper_Anim00,
    STATUS_SLEEP,     ANIM_Cleft_Hyper_Anim0C,
    STATUS_POISON,    ANIM_Cleft_Hyper_Anim02,
    STATUS_STOP,      ANIM_Cleft_Hyper_Anim00,
    STATUS_STATIC,    ANIM_Cleft_Hyper_Anim02,
    STATUS_PARALYZE,  ANIM_Cleft_Hyper_Anim00,
    STATUS_DIZZY,     ANIM_Cleft_Hyper_Anim0E,
    STATUS_FEAR,      ANIM_Cleft_Hyper_Anim0E,
    STATUS_END,
...
s32 N(idleAnimations_80221D20)[] = {
    ...
    STATUS_POISON,    ANIM_Cleft_Hyper_Anim05,
    STATUS_STOP,      ANIM_Cleft_Hyper_Anim01,
    STATUS_STATIC,    ANIM_Cleft_Hyper_Anim05,
    STATUS_PARALYZE,  ANIM_Cleft_Hyper_Anim01,
    STATUS_DIZZY,     ANIM_Cleft_Hyper_Anim0F,
    STATUS_FEAR,      ANIM_Cleft_Hyper_Anim0F,
    STATUS_END,
};
...
EvtScript N(80222F1C) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Cleft_Hyper_Anim05)
    EVT_CALL(RemoveActorDecoration, ACTOR_SELF, 1, 0)
...
EvtScript N(80223310) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Cleft_Hyper_Anim08)
            EVT_WAIT(15)
            EVT_WAIT(8)
            EVT_CALL(ResetAllActorSounds, ACTOR_SELF)
            EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
