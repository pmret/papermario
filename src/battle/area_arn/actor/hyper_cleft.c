...
EvtScript N(handleEvent_80222140) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SWITCH(LVar0)
                ...
                EVT_CASE_DEFAULT
                    EVT_CALL(GetActorVar, ACTOR_SELF, 0, LVar0)
                    EVT_IF_EQ(LVar0, 1)
                        EVT_SET_CONST(LVar1, NPC_ANIM_cleft_hyper_Anim_9)
                    EVT_ELSE
                        EVT_SET_CONST(LVar1, NPC_ANIM_cleft_hyper_skid)
                    EVT_END_IF
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_cleft_hyper_run)
        ...
        EVT_CASE_EQ(EVENT_STAR_BEAM)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 0, LVar0)
            EVT_IF_EQ(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_cleft_hyper_inverted_idle)
            EVT_ELSE
                EVT_SET_CONST(LVar1, NPC_ANIM_cleft_hyper_idle)
            EVT_END_IF
            EVT_SET_CONST(LVar0, 1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_ELSE
                EVT_SET_CONST(LVar0, 1)
                EVT_SET_CONST(LVar1, NPC_ANIM_cleft_hyper_run)
                EVT_SET_CONST(LVar2, NPC_ANIM_cleft_hyper_skid)
                EVT_EXEC_WAIT(DoScareAway)
                EVT_RETURN
            EVT_END_IF
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_cleft_hyper_inverted_dizzy)
