...
EvtScript N(80220DC0) = {
    ...
    EVT_IF_EQ(LocalVar(0), 0)
        ...
        EVT_CALL(PlayEffect, EFFECT_ENERGY_IN_OUT, 6, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 45, 0, 0, 0, 0, 0, 0, 0)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                EVT_LOOP(30)
                    EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
                    EVT_CALL(PlayEffect, EFFECT_WALKING_DUST, 2, LocalVar(0), LocalVar(1), LocalVar(2), 0, 0, 0, 0, 0, 0, 0, 0, 0)
                    EVT_WAIT(1)
                EVT_END_LOOP
            EVT_END_THREAD
    ...
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 8, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_SWITCH(LocalVar(0))
...
EvtScript N(80221DE0) = {
    ...
    EVT_THREAD
        EVT_CALL(ShakeCam, 1, 0, 5, EVT_FLOAT(1.0))
    EVT_END_THREAD
    EVT_CALL(PlayEffect, EFFECT_SMOKE_IMPACT, 0, LocalVar(0), LocalVar(1), LocalVar(2), 40, 8, EVT_FLOAT(0.0), 20, 0, 0, 0, 0, 0)
...
EvtScript N(handleEvent_80222140) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SWITCH(LocalVar(0))
                ...
                EVT_CASE_DEFAULT
                    EVT_CALL(GetActorVar, ACTOR_SELF, 0, LocalVar(0))
                    EVT_IF_EQ(LocalVar(0), 1)
                        EVT_SET_CONST(LocalVar(1), NPC_ANIM_cleft_hyper_Anim_9)
                    EVT_ELSE
                        EVT_SET_CONST(LocalVar(1), NPC_ANIM_cleft_hyper_skid)
                    EVT_END_IF
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_cleft_hyper_run)
        ...
        EVT_CASE_EQ(EVENT_STAR_BEAM)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 0, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_cleft_hyper_inverted_idle)
            EVT_ELSE
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_cleft_hyper_idle)
            EVT_END_IF
            EVT_SET_CONST(LocalVar(0), 1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_cleft_hyper_run)
                EVT_SET_CONST(LocalVar(2), NPC_ANIM_cleft_hyper_skid)
                EVT_EXEC_WAIT(DoScareAway)
                EVT_RETURN
            EVT_END_IF
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_cleft_hyper_inverted_dizzy)
