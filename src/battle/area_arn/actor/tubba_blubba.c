...
EvtScript N(80225FD4) = {
    EVT_SET(LocalVar(1), 7012353)
    EVT_EXEC_WAIT(N(80225F8C))
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, LocalVar(1))
    EVT_CALL(SetGoalToHome, ACTOR_SELF)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(6.0))
    EVT_SET(LocalVar(1), 7012358)
    EVT_EXEC_WAIT(N(80225F8C))
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, LocalVar(1))
...
EvtScript N(handleEvent_802260D0) = {
    ...
    EVT_SWITCH(LocalVar(10))
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_tubba_Palette_00_Anim_1)
...
EvtScript N(80226558) = {
    ...
    EVT_END_IF
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), 0, 0, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_63)
...
EvtScript N(80226B88) = {
    ...
    EVT_IF_NOT_FLAG(LocalVar(5), STATUS_FLAG_SHRINK)
        ...
        EVT_CALL(PlaySoundAtActor, ACTOR_SELF, 0x20EA)
    EVT_END_IF
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(15), 0, 0, 0, 6, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_63)
    EVT_CALL(SetBattleCamZoom, 200)
    EVT_CALL(BattleCamTargetActor, ACTOR_SELF)
    EVT_CALL(func_8024ECF8, -1, 1, 0)
