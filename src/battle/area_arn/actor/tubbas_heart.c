...
EvtScript N(idle_80223E98) = {
    ...
    EVT_IF_NE(LocalVar(0), FALSE)
        ...
        EVT_IF_NE(LocalVar(0), 0)
            ...
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(4))
            EVT_IF_NOT_FLAG(LocalVar(4), STATUS_FLAG_SHRINK)
                EVT_ADD(LocalVar(2), 15)
                EVT_SETF(LocalVar(4), EVT_FLOAT(1.0))
            EVT_ELSE
                EVT_ADD(LocalVar(2), 6)
                EVT_SETF(LocalVar(4), EVT_FLOAT(0.4))
            EVT_END_IF
            EVT_CALL(func_80218680_4FF0D0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), LocalVar(4))
        EVT_END_IF
    EVT_END_IF
    EVT_WAIT(1)
    EVT_GOTO(0)
...
EvtScript N(80223FD8) = {
    EVT_SET(LocalVar(1), 7077902)
    EVT_CALL(GetActorVar, ACTOR_SELF, 1, LocalVar(0))
    EVT_IF_NE(LocalVar(0), 0)
        EVT_SET(LocalVar(1), 7077899)
    EVT_END_IF
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent_80224038) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_BURN_DEATH)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_tubbas_heart_Palette_00_Anim_10)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_tubbas_heart_Palette_00_Anim_11)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_tubbas_heart_Palette_00_Anim_1)
...
EvtScript N(takeTurn_802245C8) = {
    ...
    EVT_IF_NE(LocalVar(0), HIT_RESULT_MISS)
        ...
        EVT_IF_NOT_FLAG(LocalVar(0), 0x00000001)
            EVT_CALL(GetCurrentPartnerID, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 9)
                EVT_CALL(func_802535B4, 0)
                EVT_BITWISE_OR_CONST(LocalVar(0), 0x3)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(0)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 2, LocalVar(0))
            EVT_IF_FLAG(LocalVar(0), 0x00000002)
                EVT_CALL(func_802535B4, 1)
            EVT_END_IF
        EVT_CASE_EQ(1)
            ...
            EVT_CALL(GetActorVar, ACTOR_SELF, 1, LocalVar(0))
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_CALL(GetActorVar, ACTOR_SELF, 5, LocalVar(1))
                EVT_ADD(LocalVar(1), 1)
                EVT_CALL(SetActorVar, ACTOR_SELF, 5, LocalVar(1))
                EVT_IF_GE(LocalVar(1), 2)
    ...
    EVT_END_SWITCH
    EVT_CALL(GetActorVar, ACTOR_SELF, 2, LocalVar(0))
    EVT_BITWISE_AND_CONST(LocalVar(0), -3)
    EVT_CALL(SetActorVar, ACTOR_SELF, 2, LocalVar(0))
    EVT_CALL(UseIdleAnimation, ACTOR_SELF, TRUE)
    EVT_RETURN
    EVT_END
...
EvtScript N(80225258) = {
    ...
    EVT_END_IF
    EVT_CALL(PlayEffect, EFFECT_GATHER_MAGIC, 1, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 60, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(PlayEffect, EFFECT_ENERGY_IN_OUT, 6, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 60, 0, 0, 0, 0, 0, 0, 0)
...
EvtScript N(802255D8) = {
    ...
    EVT_ELSE
        EVT_ADD(LocalVar(1), 6)
    EVT_END_IF
    EVT_CALL(PlayEffect, EFFECT_GATHER_ENERGY_PINK, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 45, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(60)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_C)
    EVT_CALL(MoveBattleCamOver, 20)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_tubbas_heart_Palette_00_Anim_B)
    ...
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(1), 5)
    EVT_CALL(PlayEffect, EFFECT_TUBBA_HEART_ATTACK, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 200, 0, 0, 0, 0, 0, 0, 0)
    EVT_THREAD
        EVT_WAIT(160)
    ...
    EVT_WAIT(2)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 12, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_RETURN
    EVT_END
};
