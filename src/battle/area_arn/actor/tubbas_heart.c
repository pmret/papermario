...
EvtScript N(80224414) = {
    ...
    EVT_WAIT(40)
    EVT_CALL(ActorSpeak, MESSAGE_ID_0E00C6, ACTOR_SELF, 1, NPC_ANIM_tubbas_heart_Palette_00_Anim_D, NPC_ANIM_tubbas_heart_Palette_00_Anim_D)
    ...
    EVT_IF_NE(LVar0, HIT_RESULT_MISS)
        ...
        EVT_IF_NOT_FLAG(LVar0, 0x00000001)
            ...
            EVT_IF_EQ(LVar0, 9)
                ...
                EVT_CALL(MoveBattleCamOver, 40)
                EVT_WAIT(40)
                EVT_CALL(ActorSpeak, MESSAGE_ID_0E00C3, ACTOR_SELF, 1, NPC_ANIM_tubbas_heart_Palette_00_Anim_B, NPC_ANIM_tubbas_heart_Palette_00_Anim_1)
                EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_14)
                ...
                EVT_CALL(ActorSpeak, MESSAGE_ID_0E00C4, ACTOR_PARTNER, 1, NPC_ANIM_battle_bow_Palette_00_Anim_4, NPC_ANIM_battle_bow_Palette_00_Anim_1)
    ...
    EVT_SWITCH(LVar0)
        EVT_CASE_EQ(0)
            ...
            EVT_IF_EQ(LVar0, 0)
                ...
                EVT_CALL(MoveBattleCamOver, 40)
                EVT_WAIT(40)
                EVT_CALL(ActorSpeak, MESSAGE_ID_0E00C5, ACTOR_SELF, 1, NPC_ANIM_tubbas_heart_Palette_00_Anim_B, NPC_ANIM_tubbas_heart_Palette_00_Anim_1)
            EVT_END_IF
