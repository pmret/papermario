        ...
        EVT_CASE_EQ(EVENT_SPIKE_TAUNT)
            ...
            EVT_SWITCH(LocalVar(0))
                EVT_CASE_EQ(0)
                    ...
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_01_Anim_21)
                EVT_CASE_EQ(1)
                    EVT_SET(LocalVar(0), 0)
                    EVT_SET(LocalVar(1), 59)
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_01_Anim_22)
                EVT_CASE_EQ(2)
                    EVT_SET(LocalVar(0), 0)
                    EVT_SET(LocalVar(1), 41)
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_01_Anim_23)
                EVT_CASE_EQ(3)
                    EVT_SET(LocalVar(0), 0)
                    EVT_SET(LocalVar(1), 23)
                    EVT_SET_CONST(LocalVar(2), NPC_ANIM_pokey_Palette_01_Anim_24)
            EVT_END_SWITCH
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(3))
...
EvtScript N(takeTurn_80219D88) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 6, NPC_ANIM_pokey_Palette_01_Anim_16)
    EVT_CALL(JumpPartTo, ACTOR_SELF, 6, LocalVar(0), LocalVar(1), LocalVar(2), 0, 1)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0x00000008 | 0x00000020 | STATUS_FLAG_100 | STATUS_FLAG_200 | STATUS_FLAG_POISON | STATUS_FLAG_80000000, 2, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(GetActorVar, ACTOR_SELF, 2, LocalVar(1))
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, LocalVar(1))
    EVT_SWITCH(LocalVar(0))
...
EvtScript N(8021A6C8) = {
    ...
    EVT_WAIT(2)
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0x00000004 | 0x00000020 | 0x00000040 | STATUS_FLAG_100 | STATUS_FLAG_200 | STATUS_FLAG_POISON | STATUS_FLAG_80000000, 2, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_pokey_Palette_01_Anim_7)
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_OR_EQ(HIT_RESULT_HIT)
        EVT_CASE_OR_EQ(HIT_RESULT_QUAKE_IMMUNE)
