...
EvtScript N(8021C880) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_15)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_17)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_swooper_Palette_00_Anim_18)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_18)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_2)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_2)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_swooper_Palette_00_Anim_15)
...
EvtScript N(8021CD04) = {
    ...
    EVT_IF_EQ(LocalVar(10), -1)
        EVT_CALL(SetHomePos, ACTOR_SELF, LocalVar(0), 45, LocalVar(2))
    ...
    EVT_ELSE
        EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(0.8))
        EVT_CALL(SetGoalPos, ACTOR_SELF, LocalVar(0), 45, LocalVar(2))
        EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, FALSE, FALSE)
...
EvtScript N(handleEvent_8021D064) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_E)
                EVT_EXEC_WAIT(DoNormalHit)
            EVT_END_IF
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_11)
                EVT_SET_CONST(LocalVar(2), NPC_ANIM_swooper_Palette_00_Anim_12)
                EVT_EXEC_WAIT(DoBurnHit)
                EVT_EXEC_WAIT(N(8021CD04))
            EVT_END_IF
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_ELSE
                ...
                EVT_EXEC_WAIT(DoBurnHit)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_12)
                EVT_EXEC_WAIT(DoDeath)
            EVT_END_IF
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_swooper_Palette_00_Anim_C)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_CALL(GetBattlePhase, LocalVar(0))
