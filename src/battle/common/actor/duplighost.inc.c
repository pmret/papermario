...
EvtScript N(OnHitElectric) = {
    ...
    EVT_CALL(SetPartFlagBits, LVarA, 1, ACTOR_PART_FLAG_MULTI_TARGET, 1)
    EVT_CALL(SetPartFlagBits, LVarA, 1, ACTOR_PART_FLAG_INVISIBLE | ACTOR_PART_FLAG_NO_TARGET, 0)
    ...
    EVT_CALL(SetIdleAnimations, LVarA, 1, EVT_ADDR(N(idleAnimations2)))
    ...
    EVT_CALL(SetIdleAnimations, LVarA, 1, EVT_ADDR(N(idleAnimations)))
...
EvtScript N(OnShockHit) = {
    ...
    EVT_CALL(SetIdleAnimations, LVarA, 1, EVT_ADDR(N(idleAnimations3)))
...
EvtScript N(copyPartner) = {
    ...
    EVT_END_IF
    EVT_CALL(PlayEffect, EFFECT_GATHER_ENERGY_PINK, 1, LVar0, LVar1, LVar2, LVar3, 40, 0, 0, 0, 0, 0, 0, 0)
