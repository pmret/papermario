    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LocalVar(1), DAMAGE_TYPE_ELECTRIC)
                ...
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_parakarry_Palette_00_Anim_E)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_parakarry_Palette_00_Anim_F)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_parakarry_Palette_00_Anim_10)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_parakarry_Palette_00_Anim_10)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_DEATH)
            EVT_EXEC_WAIT(N(OnDeath))
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_parakarry_Palette_00_Anim_D)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_parakarry_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_parakarry_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_parakarry_Palette_00_Anim_E)
