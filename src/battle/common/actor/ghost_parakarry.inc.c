...
s32 N(parakarry_idleAnimations)[] = {
    STATUS_NORMAL, ANIM_BattleParakarry_Anim01,
    STATUS_STONE, ANIM_BattleParakarry_Anim00,
    STATUS_SLEEP, ANIM_BattleParakarry_Anim00,
    STATUS_POISON, ANIM_BattleParakarry_Anim01,
    STATUS_STOP, ANIM_BattleParakarry_Anim00,
    STATUS_STATIC, ANIM_BattleParakarry_Anim01,
    STATUS_PARALYZE, ANIM_BattleParakarry_Anim00,
    STATUS_DIZZY, ANIM_BattleParakarry_Anim01,
    STATUS_FEAR, ANIM_BattleParakarry_Anim01,
    STATUS_END,
};
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LVar1, DAMAGE_TYPE_ELECTRIC)
                ...
                EVT_SET_CONST(LVar1, ANIM_BattleParakarry_Anim0E)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleParakarry_Anim0F)
            EVT_SET_CONST(LVar2, ANIM_BattleParakarry_Anim10)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleParakarry_Anim10)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_DEATH)
            EVT_EXEC_WAIT(N(OnDeath))
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleParakarry_Anim0D)
            EVT_SET(LVar2, 22)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleParakarry_Anim01)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleParakarry_Anim03)
            EVT_SET_CONST(LVar2, ANIM_BattleParakarry_Anim0E)
...
EvtScript N(parakarry_doTakeTurn) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleParakarry_Anim03)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(AddGoalPos, ACTOR_SELF, 20, 0, 0)
    EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(4.0))
    EVT_CALL(FlyToGoal, ACTOR_SELF, 0, -10, 10)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleParakarry_Anim00)
    EVT_WAIT(3)
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleParakarry_Anim14)
    EVT_CALL(AddGoalPos, ACTOR_SELF, 0, 10, 0)
    EVT_CALL(FlyToGoal, ACTOR_SELF, 5, 0, 0)
    EVT_WAIT(2)
    EVT_THREAD
        EVT_WAIT(3)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleParakarry_Anim04)
    EVT_END_THREAD
    ...
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleParakarry_Anim05)
    EVT_CALL(FlyToGoal, ACTOR_SELF, 5, 0, 0)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                EVT_WAIT(5)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleParakarry_Anim01)
            EVT_END_THREAD
            EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    ...
    EVT_END_SWITCH
    EVT_CALL(EnableActorBlur, ACTOR_SELF, 0)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleParakarry_Anim06)
    EVT_WAIT(1)
