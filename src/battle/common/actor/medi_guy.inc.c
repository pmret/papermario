...
EvtScript N(init_8021F9E8) = {
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_80220DCC)))
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_8021FA8C)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_8021FC60)))
...
EvtScript N(handleEvent_8021FC60) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_medi_guy_Palette_00_Anim_6)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_medi_guy_Palette_00_Anim_8)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_medi_guy_Palette_00_Anim_9)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_medi_guy_Palette_00_Anim_9)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_medi_guy_Palette_00_Anim_7)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_medi_guy_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_medi_guy_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_medi_guy_Palette_00_Anim_B)
...
EvtScript N(flyingAttack) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(15)
            EVT_ADDF(LocalVar(0), EVT_FLOAT(2.0))
    ...
    EVT_SWITCH(LocalVar(10))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_THREAD
                ...
                EVT_LOOP(60)
                    EVT_CALL(N(MediGuySpriteRotationFunc), LocalVar(0), LocalVar(1), 15, 60, EVT_FLOAT(30.0))
                    EVT_CALL(SetPartRotation, ACTOR_SELF, 1, 0, 0, LocalVar(1))
...
EvtScript N(healOneAlly) = {
    ...
    EVT_CALL(PlayEffect, EFFECT_SPARKLES, 1, LocalVar(1), LocalVar(2), LocalVar(3), 10, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_CALL(PlayEffect, EFFECT_RECOVER, 2, LocalVar(1), LocalVar(2), LocalVar(3), 0, 0, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(30)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_medi_guy_Palette_00_Anim_1)
    EVT_WAIT(10)
    EVT_CALL(UseBattleCamPreset, BTL_CAM_PRESET_63)
    EVT_CALL(BattleCamTargetActor, LocalVar(10))
    EVT_CALL(GetEnemyMaxHP, LocalVar(10), LocalVar(4))
    EVT_MUL(LocalVar(4), 60)
    EVT_DIV(LocalVar(4), 100)
    EVT_THREAD
        EVT_WAIT(5)
        EVT_CALL(PlaySoundAtActor, LocalVar(10), 0x206D)
        EVT_CALL(PlaySoundAtActor, LocalVar(10), 0x214)
        EVT_WAIT(30)
        EVT_CALL(PlaySoundAtActor, LocalVar(10), SOUND_25C)
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(func_8026BF48, 1)
        EVT_CALL(HealActor, LocalVar(10), LocalVar(4), 0)
...
EvtScript N(takeTurn_80220DCC) = {
    ...
    EVT_ELSE
        EVT_CALL(RandInt, 1000, LocalVar(10))
        EVT_IF_LT(LocalVar(10), 600)
