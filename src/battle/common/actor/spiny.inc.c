...
EvtScript N(getAnimation) = {
    EVT_CALL(GetActorVar, ACTOR_SELF, AVAR_Unk_0, LVar3)
    EVT_IF_EQ(LVar3, 1)
        EVT_SET(LVar1, LVar2)
    EVT_END_IF
    EVT_RETURN
...
EvtScript N(EVS_TakeTurn) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, PRT_2, ANIM_Lakitu_Anim0C)
    EVT_WAIT(10)
    EVT_CALL(PlaySoundAtPart, ACTOR_SELF, PRT_2, SOUND_SPINY_SPIN_UP)
    EVT_CALL(SetActorSounds, ACTOR_SELF, ACTOR_SOUND_WALK, SOUND_NONE, SOUND_NONE)
    EVT_CALL(SetPartSounds, ACTOR_SELF, PRT_2, ACTOR_SOUND_WALK, SOUND_NONE, SOUND_NONE)
