    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LocalVar(1), DAMAGE_TYPE_ELECTRIC)
                ...
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_lakilester_Palette_00_Anim_A)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_lakilester_Palette_00_Anim_C)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_lakilester_Palette_00_Anim_D)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_lakilester_Palette_00_Anim_D)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_lakilester_Palette_00_Anim_B)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_lakilester_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_lakilester_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_lakilester_Palette_00_Anim_A)
...
EvtScript N(lakilester_takeTurn) = {
    ...
    EVT_CALL(SetGoalPos, ACTOR_SELF, 20, 30, LocalVar(2))
    EVT_CALL(FlyToGoal, ACTOR_SELF, 30, 0, 10)
    ...
    EVT_LOOP(4)
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(10))
        EVT_IF_FLAG(LocalVar(10), STATUS_FLAG_SHRINK)
            EVT_ADDF(LocalVar(1), EVT_FLOAT(2.4))
        EVT_ELSE
    ...
    EVT_END_IF
    EVT_CALL(PlayEffect, EFFECT_ENERGY_IN_OUT, 0, LocalVar(0), LocalVar(1), LocalVar(2), LocalVar(3), 30, 0, 0, 0, 0, 0, 0, 0)
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(JumpPartTo, ACTOR_SELF, 3, LocalVar(0), 0, LocalVar(2), 20, 1)
            EVT_THREAD
                EVT_ADD(LocalVar(0), -50)
                EVT_CALL(JumpPartTo, ACTOR_SELF, 3, LocalVar(0), 0, LocalVar(2), 15, 1)
    ...
    EVT_SWITCH(LocalVar(9))
        ...
        EVT_CASE_EQ(1)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_NO_CONTACT, 0, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
        EVT_CASE_EQ(2)
            EVT_WAIT(2)
