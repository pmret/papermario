...
s32 N(idleAnimations_8021B0A0)[] = {
    STATUS_NORMAL,    ANIM_LargePiranha_Putrid_Anim1,
    STATUS_STONE,     ANIM_LargePiranha_Putrid_Anim0,
    STATUS_SLEEP,     ANIM_LargePiranha_Putrid_Anim0,
    STATUS_POISON,    ANIM_LargePiranha_Putrid_Anim1,
    STATUS_STOP,      ANIM_LargePiranha_Putrid_Anim0,
    STATUS_STATIC,    ANIM_LargePiranha_Putrid_Anim0,
    STATUS_PARALYZE,  ANIM_LargePiranha_Putrid_Anim0,
    STATUS_PARALYZE,  ANIM_LargePiranha_Putrid_Anim0,
    STATUS_DIZZY,     ANIM_LargePiranha_Putrid_AnimF,
    STATUS_END,
};
...
EvtScript N(8021B354) = {
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim3)
    EVT_CALL(SetGoalToHome, ACTOR_SELF)
    EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim1)
...
EvtScript N(handleEvent_8021B3D0) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LVar1, ANIM_LargePiranha_Putrid_AnimE)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_LargePiranha_Putrid_Anim1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_LargePiranha_Putrid_Anim3)
            EVT_SET_CONST(LVar2, ANIM_LargePiranha_Putrid_AnimE)
...
EvtScript N(bite) = {
    ...
    EVT_SWITCH(LVarA)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim5)
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim6)
            EVT_WAIT(6)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim7)
...
EvtScript N(breath) = {
    ...
    EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim1)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim8)
    EVT_WAIT(11)
    ...
    EVT_WAIT(1)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_Anim9)
    EVT_WAIT(5)
    EVT_CALL(EnemyTestTarget, ACTOR_SELF, LVarA, 0, 0, 1, BS_FLAGS1_10)
    EVT_SWITCH(LVarA)
        EVT_CASE_OR_EQ(HIT_RESULT_MISS)
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            EVT_WAIT(10)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_LargePiranha_Putrid_AnimA)
            EVT_IF_EQ(LVarA, HIT_RESULT_LUCKY)
                EVT_CALL(EnemyTestTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_TRIGGER_LUCKY, 0, 0, 0)
            EVT_END_IF
            EVT_WAIT(14)
