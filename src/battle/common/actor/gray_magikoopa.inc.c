...
s32 N(IdleAnimations1)[] = {
    STATUS_NORMAL, ANIM_Magikoopa_Gray_Anim01,
    STATUS_STONE, ANIM_Magikoopa_Gray_Anim00,
    STATUS_SLEEP, ANIM_Magikoopa_Gray_Anim08,
    STATUS_POISON, ANIM_Magikoopa_Gray_Anim01,
    STATUS_STOP, ANIM_Magikoopa_Gray_Anim00,
    STATUS_STATIC, ANIM_Magikoopa_Gray_Anim01,
    STATUS_PARALYZE, ANIM_Magikoopa_Gray_Anim00,
...
s32 N(IdleAnimations2)[] = {
    STATUS_NORMAL, ANIM_FlyingMagikoopa_Gray_Anim01,
    STATUS_STONE, ANIM_FlyingMagikoopa_Gray_Anim00,
    STATUS_SLEEP, ANIM_FlyingMagikoopa_Gray_Anim08,
    STATUS_POISON, ANIM_FlyingMagikoopa_Gray_Anim01,
    STATUS_STOP, ANIM_FlyingMagikoopa_Gray_Anim00,
    STATUS_STATIC, ANIM_FlyingMagikoopa_Gray_Anim01,
    STATUS_PARALYZE, ANIM_FlyingMagikoopa_Gray_Anim00,
    STATUS_DIZZY, ANIM_FlyingMagikoopa_Gray_Anim07,
    STATUS_FEAR, ANIM_FlyingMagikoopa_Gray_Anim07,
    STATUS_END,
};
...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Magikoopa_Gray_Anim04)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.5))
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
            EVT_WAIT(15)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Magikoopa_Gray_Anim02)
...
EvtScript N(knockOff) = {
    ...
    EVT_END_LOOP
    EVT_CALL(SetPartFlagBits, ACTOR_SELF, 3, ACTOR_PART_FLAG_INVISIBLE, TRUE)
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Magikoopa_Gray_Anim01)
...
EvtScript N(handleEvent_flying) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_END_FIRST_STRIKE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_FlyingMagikoopa_Gray_Anim01)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_EXEC_WAIT(DoRecover)
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_FlyingMagikoopa_Gray_Anim04)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.5))
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
            EVT_WAIT(15)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_FlyingMagikoopa_Gray_Anim02)
            EVT_EXEC_WAIT(N(flee))
            EVT_RETURN
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LVar0, 2)
...
EvtScript N(attackMagicBlast) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_FlyingMagikoopa_Gray_Anim03)
            EVT_WAIT(5)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
...
EvtScript N(attackWandStrike) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_Magikoopa_Gray_Anim03)
    EVT_WAIT(11)
