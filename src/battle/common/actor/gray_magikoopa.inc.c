...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_magikoopa_Palette_05_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_magikoopa_Palette_05_Anim_5)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_magikoopa_Palette_05_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_magikoopa_Palette_05_Anim_6)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_magikoopa_Palette_05_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_magikoopa_Palette_05_Anim_2)
...
EvtScript N(handleEvent_flying) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_flying_magikoopa_Palette_05_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_CASE_OR_EQ(EVENT_HIT)
        ...
        EVT_CASE_OR_EQ(EVENT_15)
            EVT_EXEC_WAIT(N(canBeKnockedOff))
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_flying_magikoopa_Palette_05_Anim_5)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_flying_magikoopa_Palette_05_Anim_6)
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_EXEC_WAIT(N(knockOff))
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_flying_magikoopa_Palette_05_Anim_6)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SPIN_SMASH_HIT)
            EVT_SET_CONST(LocalVar(0), 2)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_flying_magikoopa_Palette_05_Anim_1)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_SET_CONST(LocalVar(0), 2)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_flying_magikoopa_Palette_05_Anim_2)
            EVT_EXEC_WAIT(DoAirLift)
        EVT_CASE_EQ(EVENT_BLOW_AWAY)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(0))
            EVT_IF_NOT_FLAG(LocalVar(0), STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
...
EvtScript N(takeTurn) = {
    ...
    EVT_IF_GT(LocalVar(1), LocalVar(2))
        ...
        EVT_IF_EQ(LocalVar(3), 0)
            ...
            EVT_IF_NOT_FLAG(LocalVar(4), STATUS_FLAG_STATIC | STATUS_FLAG_TRANSPARENT)
    ...
    EVT_IF_NOT_FLAG(LocalVar(0), ACTOR_FLAG_FLYING)
        ...
        EVT_IF_FLAG(LocalVar(10), STATUS_FLAG_SHRINK)
            ...
            EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 6, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(0.12), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_ELSE
            EVT_SUB(LocalVar(0), 16)
            EVT_ADD(LocalVar(1), 31)
            EVT_SUB(LocalVar(2), 2)
            EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 6, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(0.3), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_END_IF
    EVT_ELSE
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LocalVar(10))
    ...
    EVT_THREAD
        EVT_WAIT(10)
        EVT_CALL(PlaySoundAtActor, LocalVar(8), SOUND_2DB)
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(func_8026BF48, 1)
        EVT_CALL(VanishActor, LocalVar(8), 2)
