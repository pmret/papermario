    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LocalVar(1), DAMAGE_TYPE_ELECTRIC)
                ...
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bow_Palette_00_Anim_15)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bow_Palette_00_Anim_18)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_bow_Palette_00_Anim_19)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bow_Palette_00_Anim_19)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bow_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_bow_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_bow_Palette_00_Anim_15)
...
EvtScript N(bow_takeTurn) = {
    ...
    EVT_CALL(GetActorVar, ACTOR_SELF, 1, LocalVar(8))
    EVT_SWITCH(LocalVar(8))
        EVT_CASE_EQ(0)
            EVT_SET(LocalVar(8), 4)
        EVT_CASE_EQ(1)
            EVT_SET(LocalVar(8), 5)
        EVT_CASE_EQ(2)
            EVT_SET(LocalVar(8), 6)
    EVT_END_SWITCH
    EVT_SET(LocalVar(7), LocalVar(8))
    EVT_LOOP(LocalVar(7))
        ...
        EVT_IF_EQ(LocalFlag(0), 0)
            ...
            EVT_IF_EQ(LocalVar(10), LocalVar(8))
        ...
        EVT_WAIT(8)
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_battle_bow_Palette_00_Anim_1)
        EVT_CALL(GetActorHP, ACTOR_PLAYER, LocalVar(1))
