...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LVar1, NPC_ANIM_battle_clubba_Palette_01_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_battle_clubba_Palette_01_Anim_6)
            EVT_SET_CONST(LVar2, NPC_ANIM_battle_clubba_Palette_01_Anim_7)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_battle_clubba_Palette_01_Anim_7)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_battle_clubba_Palette_01_Anim_2)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_battle_clubba_Palette_01_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, NPC_ANIM_battle_clubba_Palette_01_Anim_2)
            EVT_SET_CONST(LVar2, NPC_ANIM_battle_clubba_Palette_01_Anim_4)
