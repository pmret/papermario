...
EvtScript N(8021EE84) = {
    EVT_IF_FLAG(LocalVar(1), 0x00041000)
...
EvtScript N(idle_8021EF5C) = {
    ...
    EVT_LOOP(LocalVar(0))
        ...
        EVT_IF_FLAG(LocalVar(1), STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
            EVT_WAIT(1)
            EVT_GOTO(0)
        EVT_END_IF
        EVT_WAIT(1)
...
EvtScript N(handleEvent_8021F2EC) = {
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_troopa_Palette_01_Anim_7)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_troopa_Palette_01_Anim_6)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_troopa_Palette_01_Anim_8)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_para_troopa_Palette_01_Anim_9)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_troopa_Palette_01_Anim_9)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        ...
        EVT_CASE_EQ(EVENT_UNKNOWN_TRIGGER)
            EVT_CALL(SetActorVar, ACTOR_SELF, 0, 1)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_troopa_Palette_01_Anim_B)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_troopa_Palette_01_Anim_1)
            EVT_EXEC_WAIT(DoRecover)
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_CALL(SetActorFlagBits, ACTOR_SELF, ACTOR_FLAG_FLYING, 0)
            EVT_SET_CONST(LocalVar(0), 2)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_para_troopa_Palette_01_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_para_troopa_Palette_01_Anim_7)
...
EvtScript N(idle_80220D40) = {
    EVT_LABEL(0)
    EVT_CALL(RandInt, 80, LocalVar(10))
    EVT_ADD(LocalVar(10), 80)
...
EvtScript N(handleEvent_80221228) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_B)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_C)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_koopa_troopa_Palette_01_Anim_D)
            EVT_EXEC_WAIT(DoBurnHit)
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_C)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_D)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SPIN_SMASH_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
        ...
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            ...
            EVT_CALL(JumpToGoal, ACTOR_SELF, 5, FALSE, TRUE, FALSE)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_4)
        ...
        EVT_CASE_OR_EQ(EVENT_IMMUNE)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_7)
                EVT_EXEC_WAIT(DoImmune)
            ...
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_F)
                EVT_EXEC_WAIT(DoImmune)
            EVT_END_IF
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_1)
                EVT_EXEC_WAIT(DoRecover)
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_F)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_4)
                EVT_SET_CONST(LocalVar(2), NPC_ANIM_koopa_troopa_Palette_01_Anim_B)
                EVT_EXEC_WAIT(DoScareAway)
                EVT_RETURN
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            ...
            EVT_IF_EQ(LocalVar(0), 0)
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_17)
            EVT_ELSE
                EVT_SET_CONST(LocalVar(0), 1)
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_koopa_troopa_Palette_01_Anim_F)
            EVT_END_IF
