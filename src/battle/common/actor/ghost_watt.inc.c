...
EvtScript N(watt_handleEvent) = {
    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_watt_Palette_00_Anim_C)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_watt_Palette_00_Anim_D)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_watt_Palette_00_Anim_E)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_watt_Palette_00_Anim_E)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_watt_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_watt_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_watt_Palette_00_Anim_C)
...
EvtScript N(watt_takeTurn) = {
    ...
    EVT_SET(LocalVar(10), 40)
    EVT_CALL(AddBattleCamZoom, -75)
    EVT_CALL(MoveBattleCamOver, LocalVar(10))
    ...
    EVT_IF_FLAG(LocalVar(0), STATUS_FLAG_SHRINK)
        ...
        EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 8, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(0.52), LocalVar(10), 0, 0, 0, 0, 0, 0, 0)
    EVT_ELSE
        EVT_CALL(GetActorPos, ACTOR_SELF, LocalVar(0), LocalVar(1), LocalVar(2))
        EVT_ADD(LocalVar(1), 12)
        EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 8, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.3), LocalVar(10), 0, 0, 0, 0, 0, 0, 0)
    EVT_END_IF
    ...
    EVT_LOOP(LocalVar(10))
        EVT_ADD(LocalVar(9), 3)
        EVT_IF_GT(LocalVar(9), 200)
            EVT_SET(LocalVar(9), 200)
        EVT_END_IF
        EVT_CALL(N(SetBackgroundAlpha), LocalVar(9))
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_battle_watt_Palette_00_Anim_1)
    ...
    EVT_SWITCH(LocalVar(9))
        EVT_CASE_EQ(0)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_IGNORE_DEFENSE, 65535, 0, 3, BS_FLAGS1_SP_EVT_ACTIVE)
        EVT_CASE_EQ(1)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_IGNORE_DEFENSE, 65535, 0, 4, BS_FLAGS1_SP_EVT_ACTIVE)
        EVT_CASE_EQ(2)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), DAMAGE_TYPE_ELECTRIC | DAMAGE_TYPE_IGNORE_DEFENSE, 65535, 0, 5, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_SWITCH
    EVT_SWITCH(LocalVar(0))
