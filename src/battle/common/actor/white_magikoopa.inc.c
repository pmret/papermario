...
EvtScript N(handleEvent_80223E24) = {
    ...
    EVT_SWITCH(LW(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_03_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_03_Anim_5)
            EVT_SET_CONST(LW(2), NPC_ANIM_magikoopa_Palette_03_Anim_6)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_03_Anim_6)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_03_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LW(0), 1)
            EVT_SET_CONST(LW(1), NPC_ANIM_magikoopa_Palette_03_Anim_2)
...
EvtScript N(handleEvent_80224A44) = {
    ...
    EVT_SWITCH(LW(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            ...
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_03_Anim_4)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_CASE_OR_EQ(EVENT_HIT)
        ...
        EVT_CASE_OR_EQ(EVENT_15)
            EVT_EXEC_WAIT(N(8022433C))
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_03_Anim_5)
            EVT_SET_CONST(LW(2), NPC_ANIM_flying_magikoopa_Palette_03_Anim_6)
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_EXEC_WAIT(N(80224448))
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_03_Anim_6)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SPIN_SMASH_HIT)
            EVT_SET_CONST(LW(0), 2)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_03_Anim_1)
            EVT_EXEC_WAIT(DoImmune)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_DEATH)
            EVT_SET_CONST(LW(0), 2)
        ...
        EVT_CASE_EQ(EVENT_BEGIN_AIR_LIFT)
            EVT_SET_CONST(LW(0), 2)
            EVT_SET_CONST(LW(1), NPC_ANIM_flying_magikoopa_Palette_03_Anim_2)
            EVT_EXEC_WAIT(DoAirLift)
        EVT_CASE_EQ(EVENT_BLOW_AWAY)
            EVT_CALL(GetStatusFlags, ACTOR_SELF, LW(0))
            EVT_IF_NOT_FLAG(LW(0), STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
...
EvtScript N(healOne) = {
    ...
    EVT_CALL(N(GetBootsHammerLevel), LW(3), LW(4))
    EVT_IF_GT(LW(3), LW(4))
        EVT_SET(LW(3), LW(4))
    EVT_END_IF
    EVT_CALL(N(UnkBattleFunc5), LW(0), LW(1), LW(5))
    EVT_CALL(GetActorDefenseBoost, LW(0), LW(6))
    EVT_ADD(LW(5), LW(6))
    EVT_SUB(LW(3), LW(5))
    EVT_SUB(LW(2), LW(3))
    EVT_CALL(N(UnkFunc52), LW(0), LW(10))
    EVT_IF_EQ(LW(10), 0)
        EVT_CALL(GetEnemyMaxHP, LW(0), LW(10))
        EVT_CALL(GetActorHP, LW(0), LW(11))
    ...
    EVT_SUB(LW(2), LW(4))
    EVT_SET(LF(0), 0)
    EVT_CALL(GetOriginalActorType, LW(0), LW(10))
    EVT_IF_EQ(LW(10), ACTOR_TYPE_DRY_BONES)
        EVT_CALL(GetActorVar, LW(0), 8, LW(10))
        EVT_IF_EQ(LW(10), 1)
            EVT_SET(LF(0), 1)
        EVT_END_IF
    EVT_END_IF
    EVT_CALL(GetOwnerID, LW(10))
    EVT_IF_NE(LW(10), LW(0))
        EVT_IF_EQ(LF(0), 0)
            EVT_CALL(GetEnemyMaxHP, LW(0), LW(10))
            EVT_CALL(GetActorHP, LW(0), LW(11))
            EVT_IF_NE(LW(10), LW(11))
    ...
    EVT_IF_NE(LW(0), -1)
        EVT_GOTO(2)
    EVT_END_IF
    EVT_CALL(GetEnemyMaxHP, ACTOR_SELF, LW(10))
    ...
    EVT_THREAD
        EVT_WAIT_FRAMES(5)
        EVT_CALL(PlaySoundAtActor, LW(8), 0x206D)
        EVT_CALL(PlaySoundAtActor, LW(8), 0x214)
        EVT_WAIT_FRAMES(30)
        EVT_CALL(PlaySoundAtActor, LW(8), SOUND_25C)
    EVT_END_THREAD
    EVT_THREAD
        EVT_CALL(func_8026BF48, 1)
        EVT_CALL(HealActor, LW(8), 5, 0)
...
EvtScript N(healAll) = {
    ...
    EVT_IF_EQ(LW(1), ACTOR_TYPE_DRY_BONES)
