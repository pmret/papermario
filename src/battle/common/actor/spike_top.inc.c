...
s32 N(GroundAnims)[] = {
    ...
    STATUS_KEY_POISON,    ANIM_SpikeTop_Idle,
    STATUS_KEY_STOP,      ANIM_SpikeTop_Still,
    STATUS_KEY_STATIC,    ANIM_SpikeTop_Idle,
    STATUS_KEY_PARALYZE,  ANIM_SpikeTop_Still,
    STATUS_KEY_DIZZY,     ANIM_SpikeTop_Dizzy,
    STATUS_KEY_UNUSED,    ANIM_SpikeTop_Dizzy,
    STATUS_END,
};
...
s32 N(CeilingAnims)[] = {
    ...
    STATUS_KEY_POISON,    ANIM_SpikeTop_IdleCeiling,
    STATUS_KEY_STOP,      ANIM_SpikeTop_StillCeiling,
    STATUS_KEY_STATIC,    ANIM_SpikeTop_IdleCeiling,
    STATUS_KEY_PARALYZE,  ANIM_SpikeTop_StillCeiling,
    STATUS_KEY_DIZZY,     ANIM_SpikeTop_DizzyCeiling,
    STATUS_KEY_UNUSED,    ANIM_SpikeTop_DizzyCeiling,
    STATUS_END,
};
...
s32 N(ToppledAnims)[] = {
    ...
    STATUS_KEY_POISON,    ANIM_SpikeTop_IdleTopple,
    STATUS_KEY_STOP,      ANIM_SpikeTop_StillTopple,
    STATUS_KEY_STATIC,    ANIM_SpikeTop_IdleTopple,
    STATUS_KEY_DIZZY,     ANIM_SpikeTop_DizzyTopple,
    STATUS_KEY_UNUSED,    ANIM_SpikeTop_DizzyTopple,
    STATUS_END,
};
...
EvtScript N(EVS_FallFromCeiling) = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_HurtTopple)
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_IdleTopple)
    Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
...
EvtScript N(EVS_Ceiling_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_BURN_DEATH)
            ...
            ExecWait(EVS_Enemy_BurnHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_SpikeTop_BurnStillCeiling)
        ...
        CaseEq(EVENT_SHOCK_HIT)
            ...
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_SpikeTop_Run)
        ...
        CaseEq(EVENT_ZERO_DAMAGE)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_SpikeTop_ShellEnterCeiling)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            ...
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_SpikeTop_RunCeiling)
            SetConst(LVar2, ANIM_SpikeTop_HurtCeiling)
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_BURN_HIT)
            ...
            IfNe(LVar0, AVAL_State_Toppled)
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_BurnHurt)
                SetConst(LVar2, ANIM_SpikeTop_BurnStill)
                ExecWait(EVS_Enemy_BurnHit)
            Else
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_BurnHurtTopple)
                SetConst(LVar2, ANIM_SpikeTop_BurnHurtTopple)
                ExecWait(EVS_Enemy_BurnHit)
            EndIf
        CaseEq(EVENT_BURN_DEATH)
            Call(GetActorVar, ACTOR_SELF, AVAR_ToppleState, LVar0)
            IfNe(LVar0, AVAL_State_Toppled)
                ...
                ExecWait(EVS_Enemy_BurnHit)
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_BurnStill)
                ExecWait(EVS_Enemy_Death)
            Else
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_BurnHurtTopple)
        ...
        CaseEq(EVENT_ZERO_DAMAGE)
            ...
            IfEq(LVar0, AVAL_State_Ground)
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_ShellEnter)
                ExecWait(EVS_Enemy_NoDamageHit)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_ShellExitCeiling)
                Wait(8)
            Else
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_IdleTopple)
                ExecWait(EVS_Enemy_NoDamageHit)
            EndIf
        CaseEq(EVENT_IMMUNE)
            Call(GetActorVar, ACTOR_SELF, AVAR_ToppleState, LVar0)
            IfEq(LVar0, AVAL_State_Ground)
                ...
                SetConst(LVar1, ANIM_SpikeTop_ShellEnter)
                ExecWait(EVS_Enemy_NoDamageHit)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_ShellExit)
                Wait(8)
            Else
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_IdleTopple)
        ...
        CaseEq(EVENT_RECOVER_STATUS)
            ...
            IfEq(LVar0, AVAL_State_Ground)
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_Idle)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            ...
            IfEq(LVar0, AVAL_State_Ground)
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_Run)
                SetConst(LVar2, ANIM_SpikeTop_Hurt)
                ExecWait(EVS_Enemy_ScareAway)
                Return
            Else
                SetConst(LVar0, PRT_MAIN)
        ...
        CaseEq(EVENT_BLOW_AWAY)
            ...
            Else
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_SpikeTop_HurtTopple)
            EndIf
...
EvtScript N(EVS_Ceiling_TakeTurn) = {
    ...
    IfEq(LVar0, PHASE_FIRST_STRIKE)
        ...
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_StillCeiling)
    Else
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_RunCeiling)
        Call(SetGoalToTarget, ACTOR_SELF)
        Call(GetActorPos, ACTOR_SELF, LVar3, LVar4, LVar5)
        Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Thread
                Wait(5)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_Still)
            EndThread
            Add(LVar0, 20)
            Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            ...
            Call(SetActorSpeed, ACTOR_SELF, Float(6.0))
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_Run)
            Call(AddActorDecoration, ACTOR_SELF, PRT_MAIN, 0, ACTOR_DECORATION_SWEAT)
            Call(RunToGoal, ACTOR_SELF, 0, false)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_Idle)
...
EvtScript N(EVS_TakeTurn) = {
    ...
    IfEq(LVar0, AVAL_State_Toppled)
        ...
        Else
            ...
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_SpikeTop_IdleTopple)
            SetConst(LVar2, ANIM_SpikeTop_Idle)
    ...
    Call(BattleCamTargetActor, ACTOR_SELF)
    Call(SetBattleCamTargetingModes, BTL_CAM_YADJ_TARGET, BTL_CAM_XADJ_AVG, false)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_ShellEnter)
    Wait(10)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_Shell)
    Thread
        Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_SpikeTop_ShellSpin)
    Wait(20)
