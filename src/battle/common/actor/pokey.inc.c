...
EvtScript N(takeTurn) = {
    ...
    EVT_CHILD_THREAD
        ...
        EVT_CALL(SetAnimation, ACTOR_SELF, PRT_6, ANIM_Pokey_Anim16)
...
EvtScript N(afterPartThrown) = {
    ...
    EVT_SWITCH(LVarA)
        EVT_CASE_EQ(0)
            ...
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, PRT_MAIN, EVT_PTR(N(IdleAnimations_3bodyParts)))
        ...
        EVT_CASE_EQ(1)
            ...
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, PRT_MAIN, EVT_PTR(N(IdleAnimations_2bodyParts)))
        ...
        EVT_CASE_EQ(2)
            ...
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, PRT_MAIN, EVT_PTR(N(IdleAnimations_1bodyPart)))
