...
s32 N(idleAnimations_8021E4B4)[] = {
    STATUS_NORMAL,    ANIM_SpikedGoomba_Anim01,
    STATUS_STONE,     ANIM_SpikedGoomba_Anim00,
    STATUS_SLEEP,     ANIM_SpikedGoomba_Anim0A,
    STATUS_POISON,    ANIM_SpikedGoomba_Anim01,
    STATUS_STOP,      ANIM_SpikedGoomba_Anim00,
    STATUS_STATIC,    ANIM_SpikedGoomba_Anim01,
    STATUS_PARALYZE,  ANIM_SpikedGoomba_Anim00,
    STATUS_DIZZY,     ANIM_SpikedGoomba_Anim09,
    STATUS_FEAR,      ANIM_SpikedGoomba_Anim09,
    STATUS_END,
};

s32 N(idleAnimations_8021E500)[] = {
    STATUS_NORMAL,    ANIM_SpikedGoomba_Anim03,
    STATUS_STONE,     ANIM_SpikedGoomba_Anim00,
    STATUS_SLEEP,     ANIM_SpikedGoomba_Anim0A,
    STATUS_POISON,    ANIM_SpikedGoomba_Anim01,
    STATUS_STOP,      ANIM_SpikedGoomba_Anim00,
    STATUS_STATIC,    ANIM_SpikedGoomba_Anim03,
    STATUS_PARALYZE,  ANIM_SpikedGoomba_Anim00,
    STATUS_DIZZY,     ANIM_SpikedGoomba_Anim09,
    STATUS_FEAR,      ANIM_SpikedGoomba_Anim09,
    STATUS_END,
...
EvtScript N(init_8021E54C) = {
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_PTR(N(takeTurn_8021F1BC)))
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_PTR(N(idle_8021E598)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_PTR(N(handleEvent_8021E874)))
    EVT_RETURN
    EVT_END
};
...
EvtScript N(idle_8021E598) = {
    ...
    EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_PTR(N(idleAnimations_8021E500)))
    EVT_CALL(SetIdleGoal, ACTOR_SELF, LVar0, LVar1, LVar2)
    EVT_CALL(IdleRunToGoal, ACTOR_SELF, 0)
    EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, EVT_PTR(N(idleAnimations_8021E4B4)))
    EVT_LOOP(20)
        EVT_LABEL(1)
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LVar1)
        EVT_IF_FLAG(LVar1, STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
...
EvtScript N(handleEvent_8021E874) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim06)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim07)
            EVT_SET_CONST(LVar2, ANIM_SpikedGoomba_Anim08)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim08)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim05)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim0C)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim09)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(8.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(1.0))
            EVT_WAIT(5)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim01)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim01)
        ...
        EVT_CASE_EQ(EVENT_END_FIRST_STRIKE)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(2.0))
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim03)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim03)
            EVT_SET_CONST(LVar2, ANIM_SpikedGoomba_Anim06)
        ...
        EVT_CASE_EQ(EVENT_SPIKE_TAUNT)
            ...
            EVT_IF_NOT_FLAG(LVar0, STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim0B)
            EVT_END_IF
            EVT_WAIT(10)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
...
EvtScript N(takeTurn_8021F1BC) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim04)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim0A)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim06)
            EVT_WAIT(5)
