...
s32 N(idleAnimations_8021E4B4)[] = {
    STATUS_NORMAL,    ANIM_SpikedGoomba_Anim1,
    STATUS_STONE,     ANIM_SpikedGoomba_Anim0,
    STATUS_SLEEP,     ANIM_SpikedGoomba_AnimA,
    STATUS_POISON,    ANIM_SpikedGoomba_Anim1,
    STATUS_STOP,      ANIM_SpikedGoomba_Anim0,
    STATUS_STATIC,    ANIM_SpikedGoomba_Anim1,
    STATUS_PARALYZE,  ANIM_SpikedGoomba_Anim0,
    STATUS_DIZZY,     ANIM_SpikedGoomba_Anim9,
    STATUS_FEAR,      ANIM_SpikedGoomba_Anim9,
    STATUS_END,
};

s32 N(idleAnimations_8021E500)[] = {
    STATUS_NORMAL,    ANIM_SpikedGoomba_Anim3,
    STATUS_STONE,     ANIM_SpikedGoomba_Anim0,
    STATUS_SLEEP,     ANIM_SpikedGoomba_AnimA,
    STATUS_POISON,    ANIM_SpikedGoomba_Anim1,
    STATUS_STOP,      ANIM_SpikedGoomba_Anim0,
    STATUS_STATIC,    ANIM_SpikedGoomba_Anim3,
    STATUS_PARALYZE,  ANIM_SpikedGoomba_Anim0,
    STATUS_DIZZY,     ANIM_SpikedGoomba_Anim9,
    STATUS_FEAR,      ANIM_SpikedGoomba_Anim9,
    STATUS_END,
...
EvtScript N(handleEvent_8021E874) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim6)
            EVT_EXEC_WAIT(DoNormalHit)
        EVT_END_CASE_GROUP
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim7)
            EVT_SET_CONST(LVar2, ANIM_SpikedGoomba_Anim8)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_EXEC_WAIT(DoBurnHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim8)
        ...
        EVT_CASE_EQ(EVENT_SPIN_SMASH_DEATH)
            ...
            EVT_EXEC_WAIT(DoSpinSmashHit)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim5)
            EVT_EXEC_WAIT(DoDeath)
            EVT_RETURN
        EVT_CASE_EQ(EVENT_SHOCK_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_AnimC)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim9)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
            EVT_CALL(SetActorSpeed, ACTOR_SELF, EVT_FLOAT(8.0))
            EVT_CALL(RunToGoal, ACTOR_SELF, 0, FALSE)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(1.0))
            EVT_WAIT(5)
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim1)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim1)
        ...
        EVT_CASE_EQ(EVENT_END_FIRST_STRIKE)
            EVT_CALL(SetAnimationRate, ACTOR_SELF, 1, EVT_FLOAT(2.0))
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim3)
            EVT_CALL(SetGoalToHome, ACTOR_SELF)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_SpikedGoomba_Anim3)
            EVT_SET_CONST(LVar2, ANIM_SpikedGoomba_Anim6)
        ...
        EVT_CASE_EQ(EVENT_SPIKE_TAUNT)
            ...
            EVT_IF_NOT_FLAG(LVar0, STATUS_FLAG_SLEEP | STATUS_FLAG_FROZEN | STATUS_FLAG_FEAR | STATUS_FLAG_PARALYZE | STATUS_FLAG_DIZZY | STATUS_FLAG_STONE | STATUS_FLAG_STOP)
                EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_AnimB)
            EVT_END_IF
            EVT_WAIT(10)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
...
EvtScript N(takeTurn_8021F1BC) = {
    ...
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim4)
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_AnimA)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_SpikedGoomba_Anim6)
            EVT_WAIT(5)
