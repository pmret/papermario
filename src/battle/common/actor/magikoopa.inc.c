...
EvtScript N(healOne) = {
    ...
    EVT_IF_NOT_FLAG(LVar0, ACTOR_FLAG_FLYING)
        ...
        EVT_IF_FLAG(LVarA, STATUS_FLAG_SHRINK)
            ...
            EVT_ADD(LVar1, 12)
            EVT_SUB(LVar2, 2)
            EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 7, LVar0, LVar1, LVar2, EVT_FLOAT(0.12), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_ELSE
            EVT_SUB(LVar0, 16)
            EVT_ADD(LVar1, 31)
            EVT_SUB(LVar2, 2)
            EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 7, LVar0, LVar1, LVar2, EVT_FLOAT(0.3), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_END_IF
    EVT_ELSE
        EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LVarA)
...
EvtScript N(makeClone) = {
    ...
    EVT_ELSE
        ...
        EVT_ADD(LVar1, 23)
    EVT_END_IF
    EVT_CALL(PlayEffect, EFFECT_ENERGY_IN_OUT, 1, LVar0, LVar1, LVar2, EVT_FLOAT(1.0), 30, 0, 0, 0, 0, 0, 0, 0)
    EVT_WAIT(10)
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 1)
    ...
    EVT_CALL(SetPartFlagBits, LVar9, 1, ACTOR_PART_FLAG_MULTI_TARGET, 0)
    ...
    EVT_END_IF
    EVT_CALL(SetPartFlagBits, LVar9, 1, ACTOR_PART_FLAG_MULTI_TARGET, 1)
...
EvtScript N(makeTransparent) = {
    ...
    EVT_IF_NOT_FLAG(LVar0, ACTOR_FLAG_FLYING)
        ...
        EVT_IF_FLAG(LVarA, STATUS_FLAG_SHRINK)
            ...
            EVT_ADD(LVar1, 12)
            EVT_SUB(LVar2, 2)
            EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 6, LVar0, LVar1, LVar2, EVT_FLOAT(0.12), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_ELSE
            EVT_SUB(LVar0, 16)
            EVT_ADD(LVar1, 31)
            EVT_SUB(LVar2, 2)
            EVT_CALL(PlayEffect, EFFECT_RADIAL_SHIMMER, 6, LVar0, LVar1, LVar2, EVT_FLOAT(0.3), 30, 0, 0, 0, 0, 0, 0, 0)
        EVT_END_IF
    EVT_ELSE
        EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        EVT_CALL(GetStatusFlags, ACTOR_SELF, LVarA)
