...
EvtScript N(goombario_handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleGoombario_Anim0B)
            EVT_SET_CONST(LVar2, ANIM_BattleGoombario_Anim0C)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleGoombario_Anim0C)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            ...
            EVT_SET_CONST(LVar2, ANIM_BattleGoombario_Anim0A)
...
EvtScript N(goombario_returnBack) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(15)
            ...
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleGoombario_Anim05)
    ...
    EVT_ELSE
        EVT_SET(LVar5, 18)
    EVT_END_IF
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleGoombario_Anim07)
...
EvtScript N(goombario_attack) = {
    ...
    EVT_CALL(SetJumpAnimations, ACTOR_SELF, 1, ANIM_BattleGoombario_Anim06, ANIM_BattleGoombario_Anim06, ANIM_BattleGoombario_Anim06)
