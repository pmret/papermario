...
EvtScript N(goombario_handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleGoombario_AnimB)
            EVT_SET_CONST(LVar2, ANIM_BattleGoombario_AnimC)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LVar0, 1)
            EVT_SET_CONST(LVar1, ANIM_BattleGoombario_AnimC)
...
EvtScript N(goombario_returnBack) = {
    ...
    EVT_THREAD
        ...
        EVT_LOOP(15)
            ...
            EVT_WAIT(1)
        EVT_END_LOOP
        EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleGoombario_Anim5)
    ...
    EVT_ELSE
        EVT_SET(LVar5, 18)
    EVT_END_IF
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, ANIM_BattleGoombario_Anim7)
...
EvtScript N(goombario_attack) = {
    ...
    EVT_CALL(SetJumpAnimations, ACTOR_SELF, 1, ANIM_BattleGoombario_Anim6, ANIM_BattleGoombario_Anim6, ANIM_BattleGoombario_Anim6)
...
EvtScript N(goombario_tattle) = {
    ...
    EVT_WAIT(10)
    EVT_CALL(ActorSpeak, MSG_EnemyTattle_Mario, ACTOR_SELF, 1, ANIM_BattleGoombario_AnimF, ANIM_BattleGoombario_Anim1)
