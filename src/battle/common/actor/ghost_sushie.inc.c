    ...
    EVT_SWITCH(LocalVar(0))
        ...
        EVT_CASE_OR_EQ(EVENT_HIT)
            ...
            EVT_IF_FLAG(LocalVar(1), DAMAGE_TYPE_ELECTRIC)
                ...
                EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_sushie_Palette_00_Anim_D)
        ...
        EVT_CASE_EQ(EVENT_BURN_HIT)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_sushie_Palette_00_Anim_E)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_sushie_Palette_00_Anim_F)
        ...
        EVT_CASE_EQ(EVENT_BURN_DEATH)
            ...
            EVT_WAIT(10)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_sushie_Palette_00_Anim_F)
        ...
        EVT_CASE_OR_EQ(EVENT_AIR_LIFT_FAILED)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_sushie_Palette_00_Anim_1)
        ...
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_SET_CONST(LocalVar(0), 1)
            EVT_SET_CONST(LocalVar(1), NPC_ANIM_battle_sushie_Palette_00_Anim_3)
            EVT_SET_CONST(LocalVar(2), NPC_ANIM_battle_sushie_Palette_00_Anim_D)
...
EvtScript N(sushie_takeTurn) = {
    ...
    EVT_DIV(LocalVar(3), EVT_FLOAT(3.0))
    EVT_SET(LocalVar(10), LocalVar(3))
    EVT_IF_LT(LocalVar(10), 0)
        EVT_MUL(LocalVar(10), -1)
    EVT_END_IF
    EVT_CALL(MoveBattleCamOver, LocalVar(10))
    EVT_CALL(SetAnimation, ACTOR_SELF, 1, NPC_ANIM_battle_sushie_Palette_00_Anim_3)
    EVT_CALL(RunToGoal, ACTOR_SELF, LocalVar(10), FALSE)
    ...
    EVT_SWITCH(LocalVar(10))
        ...
        EVT_CASE_EQ(2)
            EVT_WAIT(2)
            EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LocalVar(0), 0, 0, 0, 5, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_END_SWITCH
    EVT_SWITCH(LocalVar(0))
