...
s32 N(IdleAnimations1)[] = {
    ...
    STATUS_POISON, ANIM_Magikoopa_Red_Anim01,
    STATUS_STOP, ANIM_Magikoopa_Red_Anim00,
    STATUS_STATIC, ANIM_Magikoopa_Red_Anim01,
    STATUS_PARALYZE, ANIM_Magikoopa_Red_Anim00,
    STATUS_DIZZY, ANIM_Magikoopa_Red_Anim07,
    STATUS_FEAR, ANIM_Magikoopa_Red_Anim07,
    STATUS_END,
};
...
s32 N(IdleAnimations2)[] = {
    ...
    STATUS_STOP, ANIM_FlyingMagikoopa_Red_Anim00,
    STATUS_STATIC, ANIM_FlyingMagikoopa_Red_Anim01,
    STATUS_PARALYZE, ANIM_FlyingMagikoopa_Red_Anim00,
    STATUS_DIZZY, ANIM_FlyingMagikoopa_Red_Anim07,
    STATUS_FEAR, ANIM_FlyingMagikoopa_Red_Anim07,
    STATUS_END,
};
...
EvtScript N(handleEvent_flying) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_END_FIRST_STRIKE)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_FlyingMagikoopa_Red_Anim01)
        ...
        EVT_CASE_EQ(EVENT_RECOVER_STATUS)
            ...
            EVT_EXEC_WAIT(DoRecover)
        EVT_CASE_EQ(EVENT_SCARE_AWAY)
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_FlyingMagikoopa_Red_Anim04)
            EVT_CALL(SetActorJumpGravity, ACTOR_SELF, EVT_FLOAT(1.5))
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            EVT_CALL(JumpToGoal, ACTOR_SELF, 15, FALSE, TRUE, FALSE)
...
EvtScript N(attackMagicBlast) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_OR_EQ(HIT_RESULT_LUCKY)
            ...
            EVT_CALL(SetAnimation, ACTOR_SELF, 2, ANIM_FlyingMagikoopa_Red_Anim03)
            EVT_WAIT(5)
            EVT_CALL(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
