...
EvtScript N(usePower) = {
    ...
    EVT_SET_CONST(LocalVar(0), NPC_ANIM_battle_muskular_Palette_00_Anim_1)
    ...
    EVT_IF_EQ(LocalVar(0), 1)
        ...
        EVT_THREAD
            EVT_LOOP(5)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.0), EVT_FLOAT(1.0), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.1), EVT_FLOAT(1.0), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.2), EVT_FLOAT(0.95), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.3), EVT_FLOAT(0.9), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.35), EVT_FLOAT(0.85), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.38), EVT_FLOAT(0.8), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.4), EVT_FLOAT(0.8), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.3), EVT_FLOAT(0.85), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.2), EVT_FLOAT(0.9), EVT_FLOAT(1.0))
                EVT_WAIT(1)
                EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.1), EVT_FLOAT(0.95), EVT_FLOAT(1.0))
                EVT_WAIT(1)
            EVT_END_LOOP
            EVT_CALL(SetActorScaleModifier, LocalVar(10), EVT_FLOAT(1.0), EVT_FLOAT(1.0), EVT_FLOAT(1.0))
        EVT_END_THREAD
    ...
    EVT_ELSE
        EVT_CALL(PlayerDamageEnemy, LocalVar(0), 0, 65535, 0, 0, 2080)
    EVT_END_IF
    EVT_LABEL(1)
    EVT_WAIT(5)
    EVT_CALL(ChooseNextTarget, 0, LocalVar(0))
