...
EvtScript N(802A33A8) = {
    EVT_THREAD
        EVT_CALL(PlayEffect, 0x38, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 100, 0, 0, 0, 0, 0, 0, 0)
        EVT_WAIT(5)
        EVT_CALL(PlayEffect, 0x38, 0, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 100, 0, 0, 0, 0, 0, 0, 0)
    ...
    EVT_END_THREAD
    EVT_WAIT(20)
    EVT_CALL(PlayEffect, 0x52, 4, LocalVar(0), LocalVar(1), LocalVar(2), EVT_FLOAT(1.0), 30, 0, 0, 0, 0, 0, 0, 0)
    EVT_RETURN
    EVT_END
};
...
EvtScript N(usePower) = {
    ...
    EVT_LABEL(0)
    EVT_CALL(SetGoalToTarget, ACTOR_SELF)
    EVT_CALL(ItemDamageEnemy, LocalVar(0), 1077936128, 0, 0, 32)
