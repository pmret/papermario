...
EvtScript N(usePower) = {
    ...
    EVT_SET_CONST(LocalVar(0), NPC_ANIM_battle_eldstar_Palette_00_Anim_1)
    ...
    EVT_CALL(func_802A18E8_78BEE8, LocalVar(0), LocalVar(1), LocalVar(2), 5)
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(0), 20)
    EVT_ADD(LocalVar(1), 25)
    EVT_CALL(func_802A19A8_78BFA8, LocalVar(0), LocalVar(1), LocalVar(2), 5)
    EVT_CALL(GetActorPos, ACTOR_PLAYER, LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_ADD(LocalVar(1), 25)
