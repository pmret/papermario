...
EvtScript N(usePower) = {
    ...
    EVT_SET_CONST(LocalVar(0), NPC_ANIM_battle_kalmar_Palette_00_Anim_1)
    ...
    EVT_CALL(ItemCheckHit, LocalVar(1), 0, 0, 0, 0)
    EVT_IF_EQ(LocalVar(1), 6)
        EVT_SET(LocalVar(0), 0)
    ...
    EVT_SWITCH(LocalVar(0))
        EVT_CASE_GT(0)
            ...
            EVT_CALL(DispatchEvent, LocalVar(0), 61)
            EVT_CALL(SetActorRotationOffset, LocalVar(0), 0, 10, 0)
            EVT_THREAD
                EVT_CALL(GetOwnerTarget, LocalVar(11), LocalVar(1))
                EVT_WAIT(10)
                ...
                EVT_LOOP(5)
                    ...
                    EVT_CALL(SetVirtualEntityRotation, LocalVar(10), 0, LocalVar(0), 0)
                    EVT_WAIT(1)
                EVT_END_LOOP
                ...
                EVT_LOOP(50)
                    EVT_CALL(SetVirtualEntityPosition, LocalVar(10), LocalVar(0), LocalVar(1), LocalVar(2))
                    EVT_CALL(SetVirtualEntityRotation, LocalVar(10), 0, LocalVar(3), 0)
                    EVT_ADD(LocalVar(1), 6)
                    EVT_ADD(LocalVar(3), 45)
                    EVT_WAIT(1)
                EVT_END_LOOP
            EVT_END_THREAD
            EVT_THREAD
                EVT_CALL(PlaySound, 0x2071)
                EVT_CALL(GetOwnerTarget, LocalVar(10), LocalVar(1))
                EVT_CALL(SetActorFlagBits, LocalVar(10), 4, 1)
                EVT_SETF(LocalVar(0), EVT_FLOAT(1.0))
                EVT_LOOP(18)
                    EVT_SUBF(LocalVar(0), EVT_FLOAT(0.05))
                    EVT_CALL(SetActorScale, LocalVar(10), LocalVar(0), LocalVar(0), LocalVar(0))
                    EVT_WAIT(1)
                EVT_END_LOOP
                EVT_CALL(SetActorPos, LocalVar(10), 0, -1000, 0)
                EVT_CALL(GetActorPos, LocalVar(10), LocalVar(0), LocalVar(1), LocalVar(2))
                EVT_LOOP(10)
                    EVT_CALL(PlayEffect, 0x11, 1, LocalVar(0), LocalVar(1), LocalVar(2), 20, 0, 0, 0, 0, 0, 0, 0, 0)
