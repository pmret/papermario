...
EvtSource N(802A1630) = {
    ...
    EVT_IF_EQ(LW(10), 0)
        ...
        EVT_CALL(GetActorPos, ACTOR_PLAYER, LW(0), LW(1), LW(2))
        EVT_ADD(LW(1), 15)
        EVT_CALL(battle_star_focus_UnkStarFunc1, LW(0), LW(1), LW(2))
        EVT_CALL(battle_star_focus_FadeBackgroundToBlack)
        EVT_WAIT_FRAMES(20)
        EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_PRAY)
        EVT_WAIT_FRAMES(10)
        EVT_CALL(PlaySound, 0x2051)
        EVT_CALL(GetActorPos, ACTOR_PLAYER, LW(0), LW(1), LW(2))
        EVT_CALL(battle_star_focus_UnkStarFunc2, LW(0), LW(1), LW(2))
        EVT_WAIT_FRAMES(30)
        EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, 0x01002A)
    EVT_ELSE
        EVT_CALL(UseBattleCamPreset, 69)
        EVT_WAIT_FRAMES(10)
        EVT_CALL(battle_star_focus_UnkStarFunc, 0)
        ...
        EVT_CALL(battle_star_focus_UnkStarFunc, 4)
        EVT_WAIT_FRAMES(8)
        EVT_CALL(PlaySound, 0x241)
        EVT_CALL(battle_star_focus_UnkStarFunc, 1)
        EVT_CALL(GetActorPos, ACTOR_PARTNER, LW(0), LW(1), LW(2))
        EVT_ADD(LW(1), 15)
        EVT_CALL(battle_star_focus_UnkStarFunc1, LW(0), LW(1), LW(2))
        EVT_CALL(battle_star_focus_FadeBackgroundToBlack)
...
EvtSource N(802A19C8) = {
    ...
    EVT_IF_EQ(LW(10), 0)
        ...
        EVT_ADD(LW(1), 15)
        EVT_CALL(battle_star_focus_UnkStarFunc1, LW(0), LW(1), LW(2))
        EVT_CALL(battle_star_focus_UnkBackgroundFunc2)
        EVT_WAIT_FRAMES(20)
        EVT_CALL(SetAnimation, ACTOR_PLAYER, 0, ANIM_PRAY)
        EVT_WAIT_FRAMES(10)
        EVT_CALL(PlaySound, 0x2051)
    ...
    EVT_IF_EQ(LW(10), 0)
        ...
        EVT_THREAD
            EVT_LOOP(5)
                ...
                EVT_CALL(battle_star_focus_UnkStarFunc4, LW(0), LW(1), LW(2))
            EVT_END_LOOP
        EVT_END_THREAD
        EVT_CALL(EnableNpcBlur, 100, 1)
        EVT_THREAD
...
EvtSource N(802A23BC) = {
    EVT_CALL(GetOwnerID, LW(10))
    EVT_IF_EQ(LW(10), 0)
        EVT_CALL(battle_star_focus_UnkBackgroundFunc)
        EVT_WAIT_FRAMES(15)
    ...
    EVT_ELSE
        ...
        EVT_CALL(battle_star_focus_UnkStarFunc, 3)
