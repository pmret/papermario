...
EvtScript N(usePower) = {
    ...
    EVT_CALL(N(UnkStarFunc1), LocalVar(0), LocalVar(1), LocalVar(2))
    EVT_CALL(N(FadeBackgroundToBlack))
    EVT_CALL(GetActorVar, 256, 0, LocalVar(0))
    ...
    EVT_CALL(GetActorVar, ACTOR_PARTNER, 0, LocalVar(0))
    EVT_ADD(LocalVar(0), 1)
    EVT_CALL(SetActorVar, ACTOR_PARTNER, 0, LocalVar(0))
    EVT_CALL(ModifyActorDecoration, 256, 1, 0, LocalVar(0), 0, 0, 0)
    EVT_CALL(GetActorVar, ACTOR_PARTNER, 1, LocalVar(0))
