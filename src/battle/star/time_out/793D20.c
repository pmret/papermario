...
EvtScript N(usePower) = {
    ...
    EVT_SET_CONST(LVar0, ANIM_BattleKlevar_Anim1)
    EVT_EXEC_WAIT(N(802A1C50))
    EVT_CALL(SetNpcAnimation, 100, ANIM_BattleKlevar_Anim2)
    EVT_WAIT(16)
    ...
    EVT_IF_EQ(LVar0, 6)
        EVT_GOTO(1)
    EVT_END_IF
    EVT_CALL(ItemDamageEnemy, LVar0, 1879048192, 0x80200564, 0, 32)
    EVT_WAIT(5)
    EVT_LABEL(1)
