...
extern s32 N(idleAnimations_8021A120)[];
extern s32 N(idleAnimations_8021A16C)[];
extern s32 N(idleAnimations_8021A1B8)[];
extern EvtScript N(init_8021C308);
extern EvtScript N(init_8021C36C);
extern EvtScript N(takeTurn_8021D894);
extern EvtScript N(runAway);


s32 N(defenseTable_80219ED0)[] = {
    ELEMENT_NORMAL, 0,
    ELEMENT_END,
};

s32 N(defenseTable_80219EDC)[] = {
    ELEMENT_NORMAL, 0,
    ELEMENT_END,
};

s32 N(statusTable_80219EE8)[] = {
    STATUS_NORMAL, 0,
    STATUS_DEFAULT, 0,
    STATUS_SLEEP, 50,
    STATUS_POISON, 50,
...
ActorPartBlueprint N(partsTable_8021A040)[] = {
    {
        ...
        .targetOffset = { 2, 35 },
        .opacity = 255,
        .idleAnimations = N(idleAnimations_8021A120),
        .defenseTable = N(defenseTable_80219ED0),
...
ActorPartBlueprint N(partsTable_8021A064)[] = {
    {
        ...
        .opacity = 255,
        .idleAnimations = N(idleAnimations_8021A120),
        .defenseTable = N(defenseTable_80219EDC),
        .eventFlags = ACTOR_EVENT_FLAG_0,
        .elementImmunityFlags = 0,
        .unk_1C = -1036,
    },
    {
        ...
        .targetOffset = { -10, 35 },
        .opacity = 255,
        .idleAnimations = N(idleAnimations_8021A16C),
        .defenseTable = N(defenseTable_80219EDC),
    ...
    },
    {
        ...
        .targetOffset = { 0, 0 },
        .opacity = 255,
        .idleAnimations = N(idleAnimations_8021A1B8),
        .defenseTable = N(defenseTable_80219EDC),
        .eventFlags = ACTOR_EVENT_FLAG_0,
        .elementImmunityFlags = 0,
        .unk_1C = 0,
...
ActorBlueprint NAMESPACE = {
    ...
    .level = 21,
    .maxHP = 11,
    .partCount = ARRAY_COUNT(N(partsTable_8021A040)),
    .partsData = N(partsTable_8021A040),
    .script = N(init_8021C308),
    .statusTable = N(statusTable_80219EE8),
    .escapeChance = 40,
    .airLiftChance = 80,
    .spookChance = 70,
    .baseStatusChance = 40,
...
ActorBlueprint N(flying) = {
    ...
    .level = 21,
    .maxHP = 11,
    .partCount = ARRAY_COUNT(N(partsTable_8021A064)),
    .partsData = N(partsTable_8021A064),
    .script = N(init_8021C36C),
    .statusTable = N(statusTable_80219F94),
    .escapeChance = 40,
    .airLiftChance = 95,
    .spookChance = 75,
    .baseStatusChance = 40,
...
EvtScript N(idle_8021A1C4) = {
    EVT_RETURN
    EVT_END
};

EvtScript N(handleEvent_8021A1D4) = {
...
EvtScript N(8021A7F8) = {
    ...
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_8021A1D4)))
    EVT_CALL(SetActorType, ACTOR_SELF, ACTOR_TYPE_WHITE_MAGIKOOPA)
    EVT_CALL(SetStatusTable, ACTOR_SELF, EVT_ADDR(N(statusTable_80219EE8)))
...
EvtScript N(handleEvent_8021ADF4) = {
    EVT_CALL(UseIdleAnimation, ACTOR_SELF, FALSE)
    EVT_CALL(EnableIdleScript, ACTOR_SELF, 0)
    EVT_CALL(GetLastEvent, ACTOR_SELF, LW(0))
    EVT_SWITCH(LW(0))
        EVT_CASE_EQ(EVENT_HIT_COMBO)
            EVT_EXEC_WAIT(N(8021A6EC))
...
EvtScript N(init_8021C308) = {
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_8021A1C4)))
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_8021D894)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_8021A1D4)))
...
EvtScript N(init_8021C36C) = {
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_8021A1C4)))
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_8021D894)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_8021ADF4)))
    EVT_CALL(SetActorVar, ACTOR_SELF, 0, 0)
    EVT_RETURN
    EVT_END
};
