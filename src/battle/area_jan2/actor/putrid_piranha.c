...
extern EvtScript N(init_80218818);
extern EvtScript N(takeTurn_80218EC8);
extern EvtScript N(idle_80218864);
extern EvtScript N(handleEvent_802189F0);
extern EvtScript N(bite);
extern EvtScript N(breath);

s32 N(idleAnimations_802186C0)[] = {
...
s32 N(defenseTable_8021870C)[] = {
    ELEMENT_NORMAL, 0,
    ELEMENT_FIRE, 0,
    ELEMENT_END,
};

s32 N(statusTable_80218720)[] = {
    STATUS_NORMAL, 0,
    STATUS_DEFAULT, 0,
    STATUS_SLEEP, 95,
    STATUS_POISON, 0,
...
ActorPartBlueprint N(partsTable_802187CC)[] = {
    {
        ...
        .targetOffset = { -15, 50 },
        .opacity = 255,
        .idleAnimations = N(idleAnimations_802186C0),
        .defenseTable = N(defenseTable_8021870C),
...
ActorBlueprint NAMESPACE = {
    ...
    .level = 17,
    .maxHP = 12,
    .partCount = ARRAY_COUNT(N(partsTable_802187CC)),
    .partsData = N(partsTable_802187CC),
    .script = N(init_80218818),
    .statusTable = N(statusTable_80218720),
    .escapeChance = 60,
    .airLiftChance = 20,
    .spookChance = 20,
    .baseStatusChance = 30,
...
EvtScript N(init_80218818) = {
    EVT_CALL(BindTakeTurn, ACTOR_SELF, EVT_ADDR(N(takeTurn_80218EC8)))
    EVT_CALL(BindIdle, ACTOR_SELF, EVT_ADDR(N(idle_80218864)))
    EVT_CALL(BindHandleEvent, ACTOR_SELF, EVT_ADDR(N(handleEvent_802189F0)))
    EVT_RETURN
    EVT_END
};
...
EvtScript N(handleEvent_802189F0) = {
