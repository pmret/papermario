...
EvtScript N(handleEvent) = {
    ...
    EVT_SWITCH(LVar0)
        ...
        EVT_CASE_EQ(EVENT_FLIP_TRIGGER)
            ...
            EVT_CALL(SetDefenseTable, ACTOR_SELF, 1, N(defenseTable_flipped))
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, N(idleAnimations_flipped))
...
EvtScript N(takeTurn) = {
    ...
    EVT_IF_EQ(LVar0, 1)
        ...
        EVT_ELSE
            ...
            EVT_CALL(SetActorVar, ACTOR_SELF, 0, 0)
            EVT_CALL(SetDefenseTable, ACTOR_SELF, 1, N(defenseTable))
            EVT_CALL(SetIdleAnimations, ACTOR_SELF, 1, N(idleAnimations))
