...
EvtScript D_8029B494 = {
    ...
    EVT_SWITCH(LVar1)
        ...
        EVT_END_CASE_GROUP
    EVT_END_SWITCH
    EVT_CALL(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_IGNORE_DEFENSE | DAMAGE_TYPE_NO_OTHER_DAMAGE_POPUPS, EVENT_SUPPRESS_ALL, 0, 1, BS_FLAGS1_SP_EVT_ACTIVE)
    EVT_GOTO(1)
    EVT_LABEL(10)
    EVT_CHILD_THREAD
        EVT_WAIT(20)
