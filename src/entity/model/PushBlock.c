...
Vtx Entity_PushBlock_vtx[] = {
    {{{   -13,    25,   -13 }, 0, {     0,   512 }, { 255, 255, 255, 255 }}},
    {{{   -13,    25,    13 }, 0, {     0,  -512 }, { 255, 255, 255, 255 }}},
    {{{    13,    25,    13 }, 0, {  1024,  -512 }, { 255, 255, 255, 255 }}},
    {{{    13,    25,   -13 }, 0, {  1024,   512 }, { 255, 255, 255, 255 }}},
    {{{    13,     0,   -13 }, 0, {  1024,  -512 }, { 255, 255, 255, 255 }}},
    {{{   -13,     0,   -13 }, 0, {     0,  -512 }, { 255, 255, 255, 255 }}},
    {{{    13,    25,    13 }, 0, {     0,   512 }, { 255, 255, 255, 255 }}},
    {{{    13,     0,    13 }, 0, {     0,  -512 }, { 255, 255, 255, 255 }}},
    {{{   -13,     0,   -13 }, 0, {  1024,  -512 }, { 255, 255, 255, 255 }}},
    {{{   -13,     0,    13 }, 0, {     0,  -512 }, { 255, 255, 255, 255 }}},
...
#include "entity/model/PushBlock_face.png.inc.c"
#include "entity/model/PushBlock_face.pal.inc.c"
...
Gfx Entity_PushBlock_RenderFaces[] = {
    ...
    gsSPVertex(&Entity_PushBlock_vtx[0], 18, 0),
