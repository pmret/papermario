...
INCLUDE_IMG("entity/model/SuperBlockContent.png.bin", D_0A000000_E4A6A0);
INCLUDE_PAL("entity/model/SuperBlockContent.pal.bin", D_0A000200_E4A8A0);
INCLUDE_PAL("entity/model/SuperBlockContent.pal2.pal.bin", D_0A000220_E4A8C0);
INCLUDE_PAL("entity/model/SuperBlockContent.pal3.pal.bin", D_0A000240_E4A8E0);
INCLUDE_PAL("entity/model/SuperBlockContent.pal4.pal.bin", D_0A000260_E4A900);
