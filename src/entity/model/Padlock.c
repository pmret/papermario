...
INCLUDE_IMG("entity/model/Padlock_face.png.bin", D_0A000700_E5B250);
INCLUDE_PAL("entity/model/Padlock_face.pal.bin", D_0A000B00_E5B650);
...
INCLUDE_IMG("entity/model/Padlock_keyhole.png.bin", D_0A000DA8_E5B8F8);
INCLUDE_PAL("entity/model/Padlock_keyhole.pal.bin", D_0A0015A8_E5C0F8);
...
INCLUDE_IMG("entity/model/Padlock_body.png.bin", D_0A001850_E5C3A0);
INCLUDE_PAL("entity/model/Padlock_body.pal.bin", D_0A001C50_E5C7A0);
