...
INCLUDE_IMG("entity/model/PadlockRedFrame_keyhole.png.bin", D_0A000540_E5D2C0);
INCLUDE_PAL("entity/model/PadlockRedFrame_keyhole.pal.bin", D_0A000D40_E5DAC0);
...
INCLUDE_IMG("entity/model/PadlockRedFrame_face.png.bin", D_0A000FE8_E5DD68);
INCLUDE_PAL("entity/model/PadlockRedFrame_face.pal.bin", D_0A0013E8_E5E168);
