...
Gfx Entity_PadlockRedFace_RenderBody[] = {
    ...
    gsSPClearGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_CULL_BACK | G_SHADING_SMOOTH),
    gsSPVertex(D_0A000000_E5E730, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&D_0A000000_E5E730[1], 1, 1),
    gsSPVertex(&D_0A000000_E5E730[17], 1, 2),
    gsSPVertex(&D_0A000000_E5E730[23], 1, 3),
    gsSPVertex(&D_0A000000_E5E730[27], 2, 4),
    gsSPVertex(&D_0A000000_E5E730[30], 11, 6),
    gsSPVertex(&D_0A000000_E5E730[54], 13, 17),
    ...
    gsSPVertex(&D_0A000000_E5E730[6], 1, 0),
    gsSPVertex(&D_0A000000_E5E730[9], 1, 1),
    gsSPVertex(&D_0A000000_E5E730[19], 4, 2),
    gsSPVertex(&D_0A000000_E5E730[24], 3, 6),
    gsSPVertex(&D_0A000000_E5E730[29], 1, 9),
    gsSPVertex(&D_0A000000_E5E730[41], 9, 10),
    gsSPVertex(&D_0A000000_E5E730[67], 13, 19),
    ...
    gsSPVertex(&D_0A000000_E5E730[50], 4, 0),
    gsSPVertex(&D_0A000000_E5E730[80], 12, 4),
