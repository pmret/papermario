...
Vtx Entity_BrickBlock_vtx[] = {
    {{{    13,     0,   -13 }, 0, {  1024,     0 }, { 248, 175,  67, 255 }}},
    {{{    13,     0,    13 }, 0, {  1024,     0 }, { 248, 175,  67, 255 }}},
    {{{   -13,     0,    13 }, 0, {     0,     0 }, { 248, 175,  67, 255 }}},
    {{{   -13,     0,   -13 }, 0, {     0,     0 }, { 248, 175,  67, 255 }}},
    {{{   -13,    25,   -13 }, 0, {     0,  1024 }, { 255, 255, 255, 255 }}},
    {{{   -13,    25,    13 }, 0, {     0,  1024 }, { 255, 255, 255, 255 }}},
    {{{    13,    25,    13 }, 0, {  1024,  1024 }, { 255, 255, 255, 255 }}},
    {{{    13,    25,   -13 }, 0, {  1024,  1024 }, { 255, 255, 255, 255 }}},
    {{{    13,     0,   -13 }, 0, {  1024,     0 }, { 255, 255, 255, 255 }}},
    {{{   -13,     0,   -13 }, 0, {     0,     0 }, { 255, 255, 255, 255 }}},
    {{{   -13,     0,   -13 }, 0, {  1024,     0 }, { 193, 187, 163, 255 }}},
    {{{   -13,     0,    13 }, 0, {     0,     0 }, { 193, 187, 163, 255 }}},
    {{{   -13,    25,    13 }, 0, {     0,  1024 }, { 193, 187, 163, 255 }}},
    {{{   -13,    25,   -13 }, 0, {  1024,  1024 }, { 193, 187, 163, 255 }}},
    {{{   -13,     0,    13 }, 0, {     0,     0 }, { 255, 255, 255, 255 }}},
    {{{    13,     0,    13 }, 0, {  1024,     0 }, { 255, 255, 255, 255 }}},
    {{{    13,    25,   -13 }, 0, {  1024,  1024 }, { 193, 187, 163, 255 }}},
    {{{    13,    25,    13 }, 0, {     0,  1024 }, { 193, 187, 163, 255 }}},
...
Gfx Entity_BrickBlock_RenderFaces[] = {
    ...
    gsSPVertex(&Entity_BrickBlock_vtx[0], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPVertex(&Entity_BrickBlock_vtx[4], 16, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
