...
Vtx Entity_HitRedBlock_vtxBlock1[] = {
...
Vtx Entity_HitRedBlock_vtxBlock2[] = {
    {{{   -12,     0,   -12 }, 0, {     0,  1024 }, { 193, 187, 163, 255 }}},
    {{{   -12,     0,    12 }, 0, {  1024,  1024 }, { 193, 187, 163, 255 }}},
    {{{   -12,    25,    12 }, 0, {  1024,     0 }, { 193, 187, 163, 255 }}},
    {{{   -12,    25,   -12 }, 0, {     0,     0 }, { 193, 187, 163, 255 }}},
...
Gfx Entity_HitRedBlock_RenderBlock2[] = {
    ...
    gsSPVertex(Entity_HitRedBlock_vtxBlock2, 22, 0),
...
Gfx Entity_HitRedBlock_RenderBlock1[] = {
    ...
    gsDPSetTextureFilter(G_TF_BILERP),
    gsSPClearGeometryMode(G_LIGHTING),
    gsSPVertex(Entity_HitRedBlock_vtxBlock1, 22, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
