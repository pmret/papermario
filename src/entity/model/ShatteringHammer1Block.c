...
INCLUDE_IMG("entity/model/ShatteringHammer1Block_texture.png.bin", D_0A001060_E33480);
INCLUDE_PAL("entity/model/ShatteringHammer1Block_texture.pal.bin", D_0A001260_E33680);
