...
s32 btl_check_player_defeated(void) {
    ...
    // The original reference was &gBattleStatus + 0x474
    // That memory address was removed from the BattleStatus struct
    // I have no idea why this pointer addition works tbh
    D_800DC18D = gBattleState;
