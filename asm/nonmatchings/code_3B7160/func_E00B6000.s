...
/* 3B7190 E00B6030 3C02E00B */  lui       $v0, %hi(D_E00B6178)
/* 3B7194 E00B6034 24426178 */  addiu     $v0, $v0, %lo(D_E00B6178)
/* 3B7198 E00B6038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3B719C E00B603C 3C02E00B */  lui       $v0, %hi(D_E00B6180)
/* 3B71A0 E00B6040 24426180 */  addiu     $v0, $v0, %lo(D_E00B6180)
/* 3B71A4 E00B6044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3B71A8 E00B6048 3C02E00B */  lui       $v0, %hi(D_E00B629C)
/* 3B71AC E00B604C 2442629C */  addiu     $v0, $v0, %lo(D_E00B629C)
