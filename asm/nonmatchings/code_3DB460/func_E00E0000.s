...
/* 3DB498 E00E0038 3C02E00E */  lui       $v0, %hi(D_E00E01D0)
/* 3DB49C E00E003C 244201D0 */  addiu     $v0, $v0, %lo(D_E00E01D0)
/* 3DB4A0 E00E0040 AFA20018 */  sw        $v0, 0x18($sp)
/* 3DB4A4 E00E0044 3C02E00E */  lui       $v0, %hi(D_E00E01D8)
/* 3DB4A8 E00E0048 244201D8 */  addiu     $v0, $v0, %lo(D_E00E01D8)
/* 3DB4AC E00E004C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3DB4B0 E00E0050 3C02E00E */  lui       $v0, %hi(D_E00E05B0)
/* 3DB4B4 E00E0054 244205B0 */  addiu     $v0, $v0, %lo(D_E00E05B0)
