...
/* 3CF3E8 E00C8048 3C02E00D */  lui       $v0, %hi(D_E00C8218)
/* 3CF3EC E00C804C 24428218 */  addiu     $v0, $v0, %lo(D_E00C8218)
/* 3CF3F0 E00C8050 AFA20018 */  sw        $v0, 0x18($sp)
/* 3CF3F4 E00C8054 3C02E00D */  lui       $v0, %hi(D_E00C8220)
/* 3CF3F8 E00C8058 24428220 */  addiu     $v0, $v0, %lo(D_E00C8220)
/* 3CF3FC E00C805C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3CF400 E00C8060 3C02E00D */  lui       $v0, %hi(D_E00C8404)
/* 3CF404 E00C8064 24428404 */  addiu     $v0, $v0, %lo(D_E00C8404)
