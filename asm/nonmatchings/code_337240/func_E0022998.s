...
/* 337C5C E0022A1C 3C02DE00 */  lui       $v0, %hi(D_DE000F20)
/* 337C60 E0022A20 AC620008 */  sw        $v0, 8($v1)
/* 337C64 E0022A24 3C020900 */  lui       $v0, 0x900
/* 337C68 E0022A28 24420F20 */  addiu     $v0, $v0, %lo(D_DE000F20)
/* 337C6C E0022A2C AC62000C */  sw        $v0, 0xc($v1)
/* 337C70 E0022A30 3C028000 */  lui       $v0, %hi(D_7FFFFFFF)
...
/* 337C8C E0022A4C 2442FFFF */  addiu     $v0, $v0, %lo(D_7FFFFFFF)
...
/* 337CCC E0022A8C 3C01800B */  lui       $at, %hi(D_800B1DEC)
/* 337CD0 E0022A90 00220821 */  addu      $at, $at, $v0
/* 337CD4 E0022A94 C4201DEC */  lwc1      $f0, %lo(D_800B1DEC)($at)
...
/* 337E44 E0022C04 3C02DA38 */  lui       $v0, %hi(D_DA37A674)
...
/* 337E5C E0022C1C 8C42A674 */  lw        $v0, %lo(D_DA37A674)($v0)
