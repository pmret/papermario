...
/* 395BE0 E0098030 3C02E00A */  lui       $v0, %hi(D_E0098168)
/* 395BE4 E0098034 24428168 */  addiu     $v0, $v0, %lo(D_E0098168)
/* 395BE8 E0098038 AFA20018 */  sw        $v0, 0x18($sp)
/* 395BEC E009803C 3C02E00A */  lui       $v0, %hi(D_E0098170)
/* 395BF0 E0098040 24428170 */  addiu     $v0, $v0, %lo(D_E0098170)
/* 395BF4 E0098044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 395BF8 E0098048 3C02E00A */  lui       $v0, %hi(D_E009829C)
/* 395BFC E009804C 2442829C */  addiu     $v0, $v0, %lo(D_E009829C)
