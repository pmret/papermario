...
/* 3B7BB0 E00B8030 3C02E00C */  lui       $v0, %hi(func_E00B812C)
/* 3B7BB4 E00B8034 2442812C */  addiu     $v0, $v0, %lo(func_E00B812C)
/* 3B7BB8 E00B8038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3B7BBC E00B803C 3C02E00C */  lui       $v0, %hi(func_E00B8134)
/* 3B7BC0 E00B8040 24428134 */  addiu     $v0, $v0, %lo(func_E00B8134)
/* 3B7BC4 E00B8044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3B7BC8 E00B8048 3C02E00C */  lui       $v0, %hi(func_E00B81B8)
/* 3B7BCC E00B804C 244281B8 */  addiu     $v0, $v0, %lo(func_E00B81B8)
