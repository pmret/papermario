...
/* 355910 E00449B0 3C02DE00 */  lui       $v0, %hi(D_DE000F20)
/* 355914 E00449B4 AC620008 */  sw        $v0, 8($v1)
/* 355918 E00449B8 3C020900 */  lui       $v0, 0x900
/* 35591C E00449BC 24420F20 */  addiu     $v0, $v0, %lo(D_DE000F20)
/* 355920 E00449C0 AC62000C */  sw        $v0, 0xc($v1)
/* 355924 E00449C4 3C028000 */  lui       $v0, %hi(D_7FFFFFFF)
...
/* 355940 E00449E0 2442FFFF */  addiu     $v0, $v0, %lo(D_7FFFFFFF)
...
/* 355C30 E0044CD0 3C03DA38 */  lui       $v1, %hi(D_DA37A674)
...
/* 355C4C E0044CEC 8C63A674 */  lw        $v1, %lo(D_DA37A674)($v1)
