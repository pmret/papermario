...
/* 3A5578 E00A6028 3C02E00A */  lui       $v0, %hi(D_E00A611C)
/* 3A557C E00A602C 2442611C */  addiu     $v0, $v0, %lo(D_E00A611C)
/* 3A5580 E00A6030 AFA20018 */  sw        $v0, 0x18($sp)
/* 3A5584 E00A6034 3C02E00A */  lui       $v0, %hi(D_E00A6124)
/* 3A5588 E00A6038 24426124 */  addiu     $v0, $v0, %lo(D_E00A6124)
/* 3A558C E00A603C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3A5590 E00A6040 3C02E00A */  lui       $v0, %hi(D_E00A6358)
/* 3A5594 E00A6044 24426358 */  addiu     $v0, $v0, %lo(D_E00A6358)
