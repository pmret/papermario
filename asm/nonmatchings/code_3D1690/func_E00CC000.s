...
/* 3D16C0 E00CC030 3C02E00D */  lui       $v0, %hi(D_E00CC250)
/* 3D16C4 E00CC034 2442C250 */  addiu     $v0, $v0, %lo(D_E00CC250)
/* 3D16C8 E00CC038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D16CC E00CC03C 3C02E00D */  lui       $v0, %hi(D_E00CC258)
/* 3D16D0 E00CC040 2442C258 */  addiu     $v0, $v0, %lo(D_E00CC258)
/* 3D16D4 E00CC044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D16D8 E00CC048 3C02E00D */  lui       $v0, %hi(D_E00CC980)
