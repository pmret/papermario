...
/* 3569B0 E0048030 3C02E005 */  lui       $v0, %hi(D_E0048128)
/* 3569B4 E0048034 24428128 */  addiu     $v0, $v0, %lo(D_E0048128)
/* 3569B8 E0048038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3569BC E004803C 3C02E005 */  lui       $v0, %hi(D_E0048130)
/* 3569C0 E0048040 24428130 */  addiu     $v0, $v0, %lo(D_E0048130)
/* 3569C4 E0048044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3569C8 E0048048 3C02E005 */  lui       $v0, %hi(D_E00481D4)
/* 3569CC E004804C 244281D4 */  addiu     $v0, $v0, %lo(D_E00481D4)
