...
/* 6A37E4 8021C5E4 3C018023 */  lui       $at, %hi(D_80234830)
/* 6A37E8 8021C5E8 D4224830 */  ldc1      $f2, %lo(D_80234830)($at)
...
/* 6A3938 8021C738 3C018023 */  lui       $at, %hi(D_80234838)
/* 6A393C 8021C73C D4204838 */  ldc1      $f0, %lo(D_80234838)($at)
/* 6A3940 8021C740 4620103C */  c.lt.d    $f2, $f0
/* 6A3944 8021C744 3C018023 */  lui       $at, %hi(D_80234840)
/* 6A3948 8021C748 D4204840 */  ldc1      $f0, %lo(D_80234840)($at)
...
/* 6A3968 8021C768 3C018023 */  lui       $at, %hi(D_80234848)
/* 6A396C 8021C76C D4204848 */  ldc1      $f0, %lo(D_80234848)($at)
...
/* 6A39A4 8021C7A4 3C018023 */  lui       $at, %hi(D_80234850)
/* 6A39A8 8021C7A8 D4204850 */  ldc1      $f0, %lo(D_80234850)($at)
...
/* 6A39C8 8021C7C8 3C018023 */  lui       $at, %hi(D_80234858)
/* 6A39CC 8021C7CC D4204858 */  ldc1      $f0, %lo(D_80234858)($at)
...
/* 6A39EC 8021C7EC 3C018023 */  lui       $at, %hi(D_80234860)
/* 6A39F0 8021C7F0 D4204860 */  ldc1      $f0, %lo(D_80234860)($at)
/* 6A39F4 8021C7F4 45020004 */  bc1fl     .L8021C808
/* 6A39F8 8021C7F8 46201000 */   add.d    $f0, $f2, $f0
/* 6A39FC 8021C7FC 3C018023 */  lui       $at, %hi(D_80234868)
/* 6A3A00 8021C800 D4204868 */  ldc1      $f0, %lo(D_80234868)($at)
