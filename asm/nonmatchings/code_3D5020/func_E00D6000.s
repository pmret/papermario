...
/* 3D5084 E00D6064 3C02E00D */  lui       $v0, %hi(D_E00D6718)
/* 3D5088 E00D6068 24426718 */  addiu     $v0, $v0, %lo(D_E00D6718)
/* 3D508C E00D606C AFA20018 */  sw        $v0, 0x18($sp)
/* 3D5090 E00D6070 3C02E00D */  lui       $v0, %hi(D_E00D6720)
/* 3D5094 E00D6074 24426720 */  addiu     $v0, $v0, %lo(D_E00D6720)
/* 3D5098 E00D6078 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D509C E00D607C 3C02E00D */  lui       $v0, %hi(D_E00D693C)
/* 3D50A0 E00D6080 2442693C */  addiu     $v0, $v0, %lo(D_E00D693C)
...
/* 3D5210 E00D61F0 3C01E00D */  lui       $at, %hi(D_E00D6EB8)
/* 3D5214 E00D61F4 00220821 */  addu      $at, $at, $v0
/* 3D5218 E00D61F8 8C226EB8 */  lw        $v0, %lo(D_E00D6EB8)($at)
