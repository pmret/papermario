...
/* 3E16B0 E00E8020 3C02E00F */  lui       $v0, %hi(func_E00E825C)
/* 3E16B4 E00E8024 2442825C */  addiu     $v0, $v0, %lo(func_E00E825C)
/* 3E16B8 E00E8028 AFA20018 */  sw        $v0, 0x18($sp)
/* 3E16BC E00E802C 3C02E00F */  lui       $v0, %hi(func_E00E8264)
/* 3E16C0 E00E8030 24428264 */  addiu     $v0, $v0, %lo(func_E00E8264)
/* 3E16C4 E00E8034 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3E16C8 E00E8038 3C02E00F */  lui       $v0, %hi(func_E00E8374)
/* 3E16CC E00E803C 24428374 */  addiu     $v0, $v0, %lo(func_E00E8374)
