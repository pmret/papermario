...
/* 3B5D20 E00B4030 3C02E00B */  lui       $v0, %hi(D_E00B4134)
/* 3B5D24 E00B4034 24424134 */  addiu     $v0, $v0, %lo(D_E00B4134)
/* 3B5D28 E00B4038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3B5D2C E00B403C 3C02E00B */  lui       $v0, %hi(D_E00B413C)
/* 3B5D30 E00B4040 2442413C */  addiu     $v0, $v0, %lo(D_E00B413C)
/* 3B5D34 E00B4044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3B5D38 E00B4048 3C02E00B */  lui       $v0, %hi(D_E00B452C)
/* 3B5D3C E00B404C 2442452C */  addiu     $v0, $v0, %lo(D_E00B452C)
