...
/* FA62C 802D5C7C 0C0B1EAF */  jal       get_variable
/* FA630 802D5C80 8C450000 */   lw       $a1, ($v0)
/* FA634 802D5C84 0000282D */  daddu     $a1, $zero, $zero
/* FA638 802D5C88 3C04802E */  lui       $a0, 0x802e
/* FA63C 802D5C8C 2484B800 */  addiu     $a0, $a0, -0x4800
/* FA640 802D5C90 3C03802E */  lui       $v1, 0x802e
/* FA644 802D5C94 2463B7D8 */  addiu     $v1, $v1, -0x4828
/* FA648 802D5C98 3C01802E */  lui       $at, 0x802e
/* FA64C 802D5C9C AC22B7D0 */  sw        $v0, -0x4830($at)
.L802D5CA0:
...
/* FA66C 802D5CBC 3C04802E */  lui       $a0, 0x802e
/* FA670 802D5CC0 24849D34 */  addiu     $a0, $a0, -0x62cc
