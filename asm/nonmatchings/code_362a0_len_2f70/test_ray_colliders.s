...
/* 38178 8005CD78 E4264240 */  swc1      $f6, %lo(D_800A4240)($at)
/* 3817C 8005CD7C 3C01800A */  lui       $at, %hi(D_800A4244)
/* 38180 8005CD80 E42A4244 */  swc1      $f10, %lo(D_800A4244)($at)
/* 38184 8005CD84 3C01800A */  lui       $at, %hi(D_800A4230)
/* 38188 8005CD88 E4284230 */  swc1      $f8, %lo(D_800A4230)($at)
/* 3818C 8005CD8C 3C01800A */  lui       $at, %hi(D_800A4234)
/* 38190 8005CD90 E42C4234 */  swc1      $f12, %lo(D_800A4234)($at)
/* 38194 8005CD94 3C01800A */  lui       $at, %hi(D_800A4238)
/* 38198 8005CD98 E42E4238 */  swc1      $f14, %lo(D_800A4238)($at)
/* 3819C 8005CD9C C7C20000 */  lwc1      $f2, ($fp)
/* 381A0 8005CDA0 4600203C */  c.lt.s    $f4, $f0
/* 381A4 8005CDA4 3C01800A */  lui       $at, %hi(D_800A4254)
/* 381A8 8005CDA8 E4224254 */  swc1      $f2, %lo(D_800A4254)($at)
...
/* 381F0 8005CDF0 3C01800A */  lui       $at, %hi(D_800A4254)
/* 381F4 8005CDF4 C4204254 */  lwc1      $f0, %lo(D_800A4254)($at)
...
.L8005CE08:
/* 38208 8005CE08 3C01800A */  lui       $at, %hi(D_800A4254)
/* 3820C 8005CE0C C4204254 */  lwc1      $f0, %lo(D_800A4254)($at)
...
/* 38238 8005CE38 3C01800A */  lui       $at, %hi(D_800A4254)
/* 3823C 8005CE3C C4204254 */  lwc1      $f0, %lo(D_800A4254)($at)
...
.L8005CE50:
/* 38250 8005CE50 3C01800A */  lui       $at, %hi(D_800A4254)
/* 38254 8005CE54 C4204254 */  lwc1      $f0, %lo(D_800A4254)($at)
...
/* 38318 8005CF18 3C01800A */  lui       $at, %hi(D_800A423C)
/* 3831C 8005CF1C C420423C */  lwc1      $f0, %lo(D_800A423C)($at)
...
/* 38338 8005CF38 3C01800A */  lui       $at, %hi(D_800A4244)
/* 3833C 8005CF3C C4204244 */  lwc1      $f0, %lo(D_800A4244)($at)
...
/* 38350 8005CF50 3C01800A */  lui       $at, %hi(D_800A4240)
/* 38354 8005CF54 C4204240 */  lwc1      $f0, %lo(D_800A4240)($at)
...
.L8005CFB4:
/* 383B4 8005CFB4 3C01800A */  lui       $at, %hi(D_800A4240)
/* 383B8 8005CFB8 C4204240 */  lwc1      $f0, %lo(D_800A4240)($at)
...
/* 3846C 8005D06C 3C01800A */  lui       $at, %hi(D_800A4248)
/* 38470 8005D070 C4204248 */  lwc1      $f0, %lo(D_800A4248)($at)
/* 38474 8005D074 8FA20084 */  lw        $v0, 0x84($sp)
/* 38478 8005D078 E4400000 */  swc1      $f0, ($v0)
/* 3847C 8005D07C 3C01800A */  lui       $at, %hi(D_800A424C)
/* 38480 8005D080 C420424C */  lwc1      $f0, %lo(D_800A424C)($at)
/* 38484 8005D084 8FA20088 */  lw        $v0, 0x88($sp)
/* 38488 8005D088 E4400000 */  swc1      $f0, ($v0)
/* 3848C 8005D08C 3C01800A */  lui       $at, %hi(D_800A4250)
/* 38490 8005D090 C4204250 */  lwc1      $f0, %lo(D_800A4250)($at)
/* 38494 8005D094 8FA2008C */  lw        $v0, 0x8c($sp)
/* 38498 8005D098 E4400000 */  swc1      $f0, ($v0)
/* 3849C 8005D09C 3C01800A */  lui       $at, %hi(D_800A4254)
/* 384A0 8005D0A0 C4204254 */  lwc1      $f0, %lo(D_800A4254)($at)
/* 384A4 8005D0A4 E7C00000 */  swc1      $f0, ($fp)
/* 384A8 8005D0A8 3C01800A */  lui       $at, %hi(D_800A4258)
/* 384AC 8005D0AC C4204258 */  lwc1      $f0, %lo(D_800A4258)($at)
/* 384B0 8005D0B0 8FA20094 */  lw        $v0, 0x94($sp)
/* 384B4 8005D0B4 E4400000 */  swc1      $f0, ($v0)
/* 384B8 8005D0B8 3C01800A */  lui       $at, %hi(D_800A425C)
/* 384BC 8005D0BC C420425C */  lwc1      $f0, %lo(D_800A425C)($at)
/* 384C0 8005D0C0 8FA20098 */  lw        $v0, 0x98($sp)
/* 384C4 8005D0C4 E4400000 */  swc1      $f0, ($v0)
/* 384C8 8005D0C8 3C01800A */  lui       $at, %hi(D_800A4260)
/* 384CC 8005D0CC C4204260 */  lwc1      $f0, %lo(D_800A4260)($at)
