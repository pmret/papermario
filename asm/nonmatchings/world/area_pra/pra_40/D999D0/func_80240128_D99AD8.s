...
/* D99B44 80240194 3C04800A */  lui       $a0, %hi(D_8009A634)
/* D99B48 80240198 8484A634 */  lh        $a0, %lo(D_8009A634)($a0)
...
/* D99BD8 80240228 3C02802E */  lui       $v0, %hi(D_802D9D70)
/* D99BDC 8024022C 90429D70 */  lbu       $v0, %lo(D_802D9D70)($v0)
...
/* D99C48 80240298 3C01802E */  lui       $at, %hi(D_802D9D70)
/* D99C4C 8024029C A0229D70 */  sb        $v0, %lo(D_802D9D70)($at)
/* D99C50 802402A0 080900AD */  j         .L802402B4
/* D99C54 802402A4 0240202D */   daddu    $a0, $s2, $zero
.L802402A8:
/* D99C58 802402A8 3C01802E */  lui       $at, %hi(D_802D9D70)
/* D99C5C 802402AC A0209D70 */  sb        $zero, %lo(D_802D9D70)($at)
...
/* D99C70 802402C0 3C038024 */  lui       $v1, %hi(func_802402F0_D99B98)
/* D99C74 802402C4 246302F0 */  addiu     $v1, $v1, %lo(func_802402F0_D99B98)
