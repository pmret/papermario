...
/* E12D40 802405E0 3C028024 */  lui       $v0, %hi(D_80241AC8)
/* E12D44 802405E4 00431021 */  addu      $v0, $v0, $v1
/* E12D48 802405E8 80421AC8 */  lb        $v0, %lo(D_80241AC8)($v0)
...
/* E12D5C 802405FC 3C028024 */  lui       $v0, %hi(D_80241AD4)
/* E12D60 80240600 00431021 */  addu      $v0, $v0, $v1
/* E12D64 80240604 80421AD4 */  lb        $v0, %lo(D_80241AD4)($v0)
...
/* E12D98 80240638 3C018024 */  lui       $at, %hi(D_80241AE0)
/* E12D9C 8024063C 00230821 */  addu      $at, $at, $v1
/* E12DA0 80240640 80231AE0 */  lb        $v1, %lo(D_80241AE0)($at)
