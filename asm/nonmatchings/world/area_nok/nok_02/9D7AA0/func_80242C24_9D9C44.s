...
/* 9D9C58 80242C38 3C018025 */  lui       $at, %hi(D_802496F4)
/* 9D9C5C 80242C3C AC2296F4 */  sw        $v0, %lo(D_802496F4)($at)
/* 9D9C60 80242C40 24020002 */  addiu     $v0, $zero, 2
/* 9D9C64 80242C44 8FBF0010 */  lw        $ra, 0x10($sp)
/* 9D9C68 80242C48 24030001 */  addiu     $v1, $zero, 1
/* 9D9C6C 80242C4C 3C018025 */  lui       $at, %hi(D_802496F0)
/* 9D9C70 80242C50 AC2396F0 */  sw        $v1, %lo(D_802496F0)($at)
