...
/* D2C5C8 80240898 3C03800A */  lui       $v1, %hi(D_8009A634)
/* D2C5CC 8024089C 8463A634 */  lh        $v1, %lo(D_8009A634)($v1)
...
/* D2C654 80240924 3C018024 */  lui       $at, %hi(D_80243D80)
/* D2C658 80240928 D4223D80 */  ldc1      $f2, %lo(D_80243D80)($at)
...
.L802409C4:
/* D2C6F4 802409C4 3C038011 */  lui       $v1, %hi(D_8010EBB3)
/* D2C6F8 802409C8 8063EBB3 */  lb        $v1, %lo(D_8010EBB3)($v1)
