...
/* D2CEA4 80241174 3C01800B */  lui       $at, %hi(D_800B1DEC)
/* D2CEA8 80241178 00220821 */  addu      $at, $at, $v0
/* D2CEAC 8024117C C4201DEC */  lwc1      $f0, %lo(D_800B1DEC)($at)
...
/* D2CEE4 802411B4 3C01800B */  lui       $at, %hi(D_800B1DEC)
/* D2CEE8 802411B8 00220821 */  addu      $at, $at, $v0
/* D2CEEC 802411BC C4201DEC */  lwc1      $f0, %lo(D_800B1DEC)($at)
...
/* D2D008 802412D8 3C018024 */  lui       $at, %hi(D_80243F18)
/* D2D00C 802412DC D4243F18 */  ldc1      $f4, %lo(D_80243F18)($at)
...
/* D2D038 80241308 3C018024 */  lui       $at, %hi(D_80243F20)
/* D2D03C 8024130C D4223F20 */  ldc1      $f2, %lo(D_80243F20)($at)
...
/* D2D110 802413E0 3C018024 */  lui       $at, %hi(D_80243F28)
/* D2D114 802413E4 D4203F28 */  ldc1      $f0, %lo(D_80243F28)($at)
...
.L80241408:
/* D2D138 80241408 3C018024 */  lui       $at, %hi(D_80243F30)
/* D2D13C 8024140C D4203F30 */  ldc1      $f0, %lo(D_80243F30)($at)
...
/* D2D214 802414E4 3C018024 */  lui       $at, %hi(D_80243F38)
/* D2D218 802414E8 D4223F38 */  ldc1      $f2, %lo(D_80243F38)($at)
...
/* D2D72C 802419FC 3C018024 */  lui       $at, %hi(D_80243F40)
/* D2D730 80241A00 D4223F40 */  ldc1      $f2, %lo(D_80243F40)($at)
