...
/* A27AA4 80240BD4 3C038024 */  lui       $v1, %hi(D_80243258)
/* A27AA8 80240BD8 24633258 */  addiu     $v1, $v1, %lo(D_80243258)
...
.L80240C10:
/* A27AE0 80240C10 3C038024 */  lui       $v1, %hi(D_80243250)
/* A27AE4 80240C14 8C633250 */  lw        $v1, %lo(D_80243250)($v1)
/* A27AE8 80240C18 2C620005 */  sltiu     $v0, $v1, 5
/* A27AEC 80240C1C 10400050 */  beqz      $v0, .L80240D60
/* A27AF0 80240C20 00031080 */   sll      $v0, $v1, 2
/* A27AF4 80240C24 3C018024 */  lui       $at, %hi(D_80243358)
/* A27AF8 80240C28 00220821 */  addu      $at, $at, $v0
/* A27AFC 80240C2C 8C223358 */  lw        $v0, %lo(D_80243358)($at)
/* A27B00 80240C30 00400008 */  jr        $v0
/* A27B04 80240C34 00000000 */   nop      
/* A27B08 80240C38 3C048024 */  lui       $a0, %hi(D_80243258)
/* A27B0C 80240C3C 8C843258 */  lw        $a0, %lo(D_80243258)($a0)
...
.L80240C5C:
/* A27B2C 80240C5C 3C038024 */  lui       $v1, %hi(D_80243254)
/* A27B30 80240C60 24633254 */  addiu     $v1, $v1, %lo(D_80243254)
...
.L80240C8C:
/* A27B5C 80240C8C 3C018024 */  lui       $at, %hi(D_80243250)
/* A27B60 80240C90 AC223250 */  sw        $v0, %lo(D_80243250)($at)
/* A27B64 80240C94 3C018024 */  lui       $at, %hi(D_80243380)
/* A27B68 80240C98 AC233380 */  sw        $v1, %lo(D_80243380)($at)
/* A27B6C 80240C9C 08090359 */  j         .L80240D64
/* A27B70 80240CA0 24040001 */   addiu    $a0, $zero, 1
/* A27B74 80240CA4 3C038024 */  lui       $v1, %hi(D_80243380)
/* A27B78 80240CA8 24633380 */  addiu     $v1, $v1, %lo(D_80243380)
...
/* A27B8C 80240CBC 3C018024 */  lui       $at, %hi(D_80243250)
/* A27B90 80240CC0 AC223250 */  sw        $v0, %lo(D_80243250)($at)
/* A27B94 80240CC4 08090359 */  j         .L80240D64
/* A27B98 80240CC8 24040001 */   addiu    $a0, $zero, 1
/* A27B9C 80240CCC 3C048024 */  lui       $a0, %hi(D_80243254)
/* A27BA0 80240CD0 24843254 */  addiu     $a0, $a0, %lo(D_80243254)
...
/* A27BB4 80240CE4 3C028024 */  lui       $v0, %hi(D_80243258)
/* A27BB8 80240CE8 24423258 */  addiu     $v0, $v0, %lo(D_80243258)
...
/* A27BDC 80240D0C 3C038024 */  lui       $v1, %hi(D_80243380)
/* A27BE0 80240D10 24633380 */  addiu     $v1, $v1, %lo(D_80243380)
...
.L80240D28:
/* A27BF8 80240D28 3C028024 */  lui       $v0, %hi(D_80243258)
/* A27BFC 80240D2C 24423258 */  addiu     $v0, $v0, %lo(D_80243258)
...
/* A27C18 80240D48 3C018024 */  lui       $at, %hi(D_80243250)
/* A27C1C 80240D4C AC223250 */  sw        $v0, %lo(D_80243250)($at)
/* A27C20 80240D50 08090359 */  j         .L80240D64
/* A27C24 80240D54 24040001 */   addiu    $a0, $zero, 1
.L80240D58:
/* A27C28 80240D58 3C018024 */  lui       $at, %hi(D_80243250)
/* A27C2C 80240D5C AC203250 */  sw        $zero, %lo(D_80243250)($at)
.L80240D60:
...
/* A27C68 80240D98 3C018024 */  lui       $at, %hi(D_80243254)
/* A27C6C 80240D9C C4203254 */  lwc1      $f0, %lo(D_80243254)($at)
...
/* A27CA8 80240DD8 3C128024 */  lui       $s2, %hi(D_80243258)
/* A27CAC 80240DDC 26523258 */  addiu     $s2, $s2, %lo(D_80243258)
