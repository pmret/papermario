...
/* A2E310 802440D0 3C038025 */  lui       $v1, %hi(D_8024AAB0)
/* A2E314 802440D4 8C63AAB0 */  lw        $v1, %lo(D_8024AAB0)($v1)
/* A2E318 802440D8 27BDFFE8 */  addiu     $sp, $sp, -0x18
/* A2E31C 802440DC AFBF0014 */  sw        $ra, 0x14($sp)
/* A2E320 802440E0 2C620007 */  sltiu     $v0, $v1, 7
/* A2E324 802440E4 104000D4 */  beqz      $v0, .L80244438
/* A2E328 802440E8 AFB00010 */   sw       $s0, 0x10($sp)
/* A2E32C 802440EC 00031080 */  sll       $v0, $v1, 2
/* A2E330 802440F0 3C018025 */  lui       $at, %hi(D_8024F240)
/* A2E334 802440F4 00220821 */  addu      $at, $at, $v0
/* A2E338 802440F8 8C22F240 */  lw        $v0, %lo(D_8024F240)($at)
/* A2E33C 802440FC 00400008 */  jr        $v0
/* A2E340 80244100 00000000 */   nop      
/* A2E344 80244104 3C048025 */  lui       $a0, %hi(D_8024AAB0)
/* A2E348 80244108 2484AAB0 */  addiu     $a0, $a0, %lo(D_8024AAB0)
/* A2E34C 8024410C 3C038025 */  lui       $v1, %hi(D_8024AAB4)
/* A2E350 80244110 08091097 */  j         .L8024425C
/* A2E354 80244114 8C63AAB4 */   lw       $v1, %lo(D_8024AAB4)($v1)
/* A2E358 80244118 3C068025 */  lui       $a2, %hi(D_8024AAB8)
/* A2E35C 8024411C 24C6AAB8 */  addiu     $a2, $a2, %lo(D_8024AAB8)
...
/* A2E378 80244138 3C028025 */  lui       $v0, %hi(D_8024AAB0)
/* A2E37C 8024413C 2442AAB0 */  addiu     $v0, $v0, %lo(D_8024AAB0)
...
/* A2E390 80244150 0C05272D */  jal       play_sound
/* A2E394 80244154 AC430000 */   sw       $v1, ($v0)
/* A2E398 80244158 08091111 */  j         .L80244444
/* A2E39C 8024415C 0000102D */   daddu    $v0, $zero, $zero
/* A2E3A0 80244160 3C058025 */  lui       $a1, %hi(D_8024AAB8)
/* A2E3A4 80244164 24A5AAB8 */  addiu     $a1, $a1, %lo(D_8024AAB8)
/* A2E3A8 80244168 8CA30000 */  lw        $v1, ($a1)
/* A2E3AC 8024416C 10600008 */  beqz      $v1, .L80244190
/* A2E3B0 80244170 2463FFFF */   addiu    $v1, $v1, -1
/* A2E3B4 80244174 3C048025 */  lui       $a0, %hi(D_8024AA20)
/* A2E3B8 80244178 8C84AA20 */  lw        $a0, %lo(D_8024AA20)($a0)
...
.L80244190:
/* A2E3D0 80244190 3C038025 */  lui       $v1, %hi(D_8024AAB4)
/* A2E3D4 80244194 2463AAB4 */  addiu     $v1, $v1, %lo(D_8024AAB4)
...
/* A2E3F4 802441B4 3C108025 */  lui       $s0, %hi(D_8024AA20)
/* A2E3F8 802441B8 2610AA20 */  addiu     $s0, $s0, %lo(D_8024AA20)
...
/* A2E410 802441D0 3C018025 */  lui       $at, %hi(D_8024AAB0)
/* A2E414 802441D4 AC20AAB0 */  sw        $zero, %lo(D_8024AAB0)($at)
...
.L802441F4:
/* A2E434 802441F4 3C038025 */  lui       $v1, %hi(D_8024AA20)
/* A2E438 802441F8 8C63AA20 */  lw        $v1, %lo(D_8024AA20)($v1)
...
/* A2E460 80244220 3C058025 */  lui       $a1, %hi(D_8024AAB0)
/* A2E464 80244224 24A5AAB0 */  addiu     $a1, $a1, %lo(D_8024AAB0)
...
/* A2E484 80244244 3C038025 */  lui       $v1, %hi(D_8024AAB4)
/* A2E488 80244248 8C63AAB4 */  lw        $v1, %lo(D_8024AAB4)($v1)
/* A2E48C 8024424C 3C048025 */  lui       $a0, %hi(D_8024AAB0)
/* A2E490 80244250 2484AAB0 */  addiu     $a0, $a0, %lo(D_8024AAB0)
/* A2E494 80244254 3C018025 */  lui       $at, %hi(D_8024AABC)
/* A2E498 80244258 AC20AABC */  sw        $zero, %lo(D_8024AABC)($at)
.L8024425C:
/* A2E49C 8024425C 8C820000 */  lw        $v0, ($a0)
/* A2E4A0 80244260 00031880 */  sll       $v1, $v1, 2
/* A2E4A4 80244264 3C018025 */  lui       $at, %hi(D_8024AAC0)
/* A2E4A8 80244268 00230821 */  addu      $at, $at, $v1
/* A2E4AC 8024426C 8C23AAC0 */  lw        $v1, %lo(D_8024AAC0)($at)
/* A2E4B0 80244270 24420001 */  addiu     $v0, $v0, 1
/* A2E4B4 80244274 AC820000 */  sw        $v0, ($a0)
/* A2E4B8 80244278 3C018025 */  lui       $at, %hi(D_8024AAB8)
/* A2E4BC 8024427C AC23AAB8 */  sw        $v1, %lo(D_8024AAB8)($at)
/* A2E4C0 80244280 08091111 */  j         .L80244444
/* A2E4C4 80244284 0000102D */   daddu    $v0, $zero, $zero
/* A2E4C8 80244288 3C068025 */  lui       $a2, %hi(D_8024AAB8)
/* A2E4CC 8024428C 24C6AAB8 */  addiu     $a2, $a2, %lo(D_8024AAB8)
/* A2E4D0 80244290 8CC30000 */  lw        $v1, ($a2)
/* A2E4D4 80244294 10600038 */  beqz      $v1, .L80244378
/* A2E4D8 80244298 240400B0 */   addiu    $a0, $zero, 0xb0
/* A2E4DC 8024429C 3C028025 */  lui       $v0, %hi(D_8024AAB4)
/* A2E4E0 802442A0 8C42AAB4 */  lw        $v0, %lo(D_8024AAB4)($v0)
/* A2E4E4 802442A4 00021080 */  sll       $v0, $v0, 2
/* A2E4E8 802442A8 3C018025 */  lui       $at, %hi(D_8024AAC0)
/* A2E4EC 802442AC 00220821 */  addu      $at, $at, $v0
/* A2E4F0 802442B0 8C22AAC0 */  lw        $v0, %lo(D_8024AAC0)($at)
...
/* A2E504 802442C4 3C048025 */  lui       $a0, %hi(D_8024AABC)
/* A2E508 802442C8 8C84AABC */  lw        $a0, %lo(D_8024AABC)($a0)
...
/* A2E518 802442D8 3C028025 */  lui       $v0, %hi(D_8024AA20)
/* A2E51C 802442DC 8C42AA20 */  lw        $v0, %lo(D_8024AA20)($v0)
/* A2E520 802442E0 3C038025 */  lui       $v1, %hi(D_8024AC7C)
/* A2E524 802442E4 9463AC7C */  lhu       $v1, %lo(D_8024AC7C)($v1)
/* A2E528 802442E8 A4430044 */  sh        $v1, 0x44($v0)
/* A2E52C 802442EC 3C038025 */  lui       $v1, %hi(D_8024AB3C)
/* A2E530 802442F0 00641821 */  addu      $v1, $v1, $a0
/* A2E534 802442F4 9063AB3C */  lbu       $v1, %lo(D_8024AB3C)($v1)
...
/* A2E54C 8024430C 3C058025 */  lui       $a1, %hi(D_8024AA20)
/* A2E550 80244310 8CA5AA20 */  lw        $a1, %lo(D_8024AA20)($a1)
/* A2E554 80244314 3C028025 */  lui       $v0, %hi(D_8024AC7C)
/* A2E558 80244318 00441021 */  addu      $v0, $v0, $a0
/* A2E55C 8024431C 9442AC7C */  lhu       $v0, %lo(D_8024AC7C)($v0)
...
/* A2E570 80244330 3C028025 */  lui       $v0, %hi(D_8024AC7B)
/* A2E574 80244334 9042AC7B */  lbu       $v0, %lo(D_8024AC7B)($v0)
/* A2E578 80244338 3C038025 */  lui       $v1, %hi(D_8024AC9C)
/* A2E57C 8024433C 00641821 */  addu      $v1, $v1, $a0
/* A2E580 80244340 9463AC9C */  lhu       $v1, %lo(D_8024AC9C)($v1)
/* A2E584 80244344 00431021 */  addu      $v0, $v0, $v1
/* A2E588 80244348 A4A20046 */  sh        $v0, 0x46($a1)
.L8024434C:
/* A2E58C 8024434C 3C038025 */  lui       $v1, %hi(D_8024AABC)
/* A2E590 80244350 2463AABC */  addiu     $v1, $v1, %lo(D_8024AABC)
/* A2E594 80244354 8C620000 */  lw        $v0, ($v1)
/* A2E598 80244358 24420001 */  addiu     $v0, $v0, 1
/* A2E59C 8024435C AC620000 */  sw        $v0, ($v1)
.L80244360:
/* A2E5A0 80244360 3C038025 */  lui       $v1, %hi(D_8024AAB8)
/* A2E5A4 80244364 2463AAB8 */  addiu     $v1, $v1, %lo(D_8024AAB8)
...
.L80244378:
/* A2E5B8 80244378 3C058025 */  lui       $a1, %hi(D_8024AAB0)
/* A2E5BC 8024437C 24A5AAB0 */  addiu     $a1, $a1, %lo(D_8024AAB0)
...
/* A2E5D4 80244394 3C038025 */  lui       $v1, %hi(D_8024AA20)
/* A2E5D8 80244398 8C63AA20 */  lw        $v1, %lo(D_8024AA20)($v1)
/* A2E5DC 8024439C 240200FF */  addiu     $v0, $zero, 0xff
/* A2E5E0 802443A0 0C05272D */  jal       play_sound
/* A2E5E4 802443A4 A462005C */   sh       $v0, 0x5c($v1)
/* A2E5E8 802443A8 08091111 */  j         .L80244444
/* A2E5EC 802443AC 0000102D */   daddu    $v0, $zero, $zero
/* A2E5F0 802443B0 3C058025 */  lui       $a1, %hi(D_8024AAB8)
/* A2E5F4 802443B4 24A5AAB8 */  addiu     $a1, $a1, %lo(D_8024AAB8)
/* A2E5F8 802443B8 8CA30000 */  lw        $v1, ($a1)
/* A2E5FC 802443BC 10600018 */  beqz      $v1, .L80244420
/* A2E600 802443C0 2463FFFF */   addiu    $v1, $v1, -1
/* A2E604 802443C4 3C048025 */  lui       $a0, %hi(D_8024AA20)
/* A2E608 802443C8 8C84AA20 */  lw        $a0, %lo(D_8024AA20)($a0)
...
/* A2E624 802443E4 3C018025 */  lui       $at, %hi(D_8024AAD6)
/* A2E628 802443E8 00220821 */  addu      $at, $at, $v0
/* A2E62C 802443EC 9422AAD6 */  lhu       $v0, %lo(D_8024AAD6)($at)
...
/* A2E648 80244408 3C018025 */  lui       $at, %hi(D_8024AAD6)
/* A2E64C 8024440C 00220821 */  addu      $at, $at, $v0
/* A2E650 80244410 9422AAD6 */  lhu       $v0, %lo(D_8024AAD6)($at)
/* A2E654 80244414 A480003E */  sh        $zero, 0x3e($a0)
/* A2E658 80244418 08091110 */  j         .L80244440
/* A2E65C 8024441C A482003C */   sh       $v0, 0x3c($a0)
.L80244420:
/* A2E660 80244420 3C038025 */  lui       $v1, %hi(D_8024AAB0)
/* A2E664 80244424 2463AAB0 */  addiu     $v1, $v1, %lo(D_8024AAB0)
