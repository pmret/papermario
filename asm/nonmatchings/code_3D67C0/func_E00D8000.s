...
/* 3D67F0 E00D8030 3C02E00E */  lui       $v0, %hi(D_E00D8120)
/* 3D67F4 E00D8034 24428120 */  addiu     $v0, $v0, %lo(D_E00D8120)
/* 3D67F8 E00D8038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D67FC E00D803C 3C02E00E */  lui       $v0, %hi(D_E00D8128)
/* 3D6800 E00D8040 24428128 */  addiu     $v0, $v0, %lo(D_E00D8128)
/* 3D6804 E00D8044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D6808 E00D8048 3C02E00E */  lui       $v0, %hi(D_E00D825C)
/* 3D680C E00D804C 2442825C */  addiu     $v0, $v0, %lo(D_E00D825C)
/* 3D6810 E00D8050 AFA20020 */  sw        $v0, 0x20($sp)
/* 3D6814 E00D8054 3C02E00E */  lui       $v0, %hi(D_E00D8264)
/* 3D6818 E00D8058 24428264 */  addiu     $v0, $v0, %lo(D_E00D8264)
