...
.L802CD4F4:
/* F1EA4 802CD4F4 3C01802E */  lui       $at, %hi(gAnimatedMeshesPtr)
/* F1EA8 802CD4F8 AC22AE30 */  sw        $v0, %lo(gAnimatedMeshesPtr)($at)
...
/* F1EC0 802CD510 3C03802E */  lui       $v1, %hi(gAnimatedMeshesPtr)
/* F1EC4 802CD514 8C63AE30 */  lw        $v1, %lo(gAnimatedMeshesPtr)($v1)
...
.L802CD52C:
/* F1EDC 802CD52C 3C02802E */  lui       $v0, %hi(gAnimatedMeshesPtr)
/* F1EE0 802CD530 8C42AE30 */  lw        $v0, %lo(gAnimatedMeshesPtr)($v0)
