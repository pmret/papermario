...
/* F1E8C 802CD4DC 3C02802E */  lui       $v0, %hi(gWorldMeshAnimations)
/* F1E90 802CD4E0 2442ADF0 */  addiu     $v0, $v0, %lo(gWorldMeshAnimations)
/* F1E94 802CD4E4 080B353D */  j         .L802CD4F4
/* F1E98 802CD4E8 00000000 */   nop      
.L802CD4EC:
/* F1E9C 802CD4EC 3C02802E */  lui       $v0, %hi(gBattleMeshAnimations)
/* F1EA0 802CD4F0 2442ADB0 */  addiu     $v0, $v0, %lo(gBattleMeshAnimations)
.L802CD4F4:
/* F1EA4 802CD4F4 3C01802E */  lui       $at, %hi(gMeshAnimationsPtr)
/* F1EA8 802CD4F8 AC22AE30 */  sw        $v0, %lo(gMeshAnimationsPtr)($at)
...
/* F1EC0 802CD510 3C03802E */  lui       $v1, %hi(gMeshAnimationsPtr)
/* F1EC4 802CD514 8C63AE30 */  lw        $v1, %lo(gMeshAnimationsPtr)($v1)
...
.L802CD52C:
/* F1EDC 802CD52C 3C02802E */  lui       $v0, %hi(gMeshAnimationsPtr)
/* F1EE0 802CD530 8C42AE30 */  lw        $v0, %lo(gMeshAnimationsPtr)($v0)
