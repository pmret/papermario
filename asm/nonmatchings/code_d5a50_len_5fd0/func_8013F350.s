...
/* D5A78 8013F378 120000D8 */  beqz      $s0, .L8013F6DC
/* D5A7C 8013F37C AFB10014 */   sw       $s1, 0x14($sp)
/* D5A80 8013F380 0000982D */  daddu     $s3, $zero, $zero
/* D5A84 8013F384 3C168015 */  lui       $s6, 0x8015
/* D5A88 8013F388 26D6EFCC */  addiu     $s6, $s6, -0x1034
.L8013F38C:
...
/* D5AA0 8013F3A0 3C018015 */  lui       $at, 0x8015
/* D5AA4 8013F3A4 00220821 */  addu      $at, $at, $v0
/* D5AA8 8013F3A8 8C221140 */  lw        $v0, 0x1140($at)
...
/* D5AD4 8013F3D4 0804FCE3 */  j         .L8013F38C
...
/* D5B08 8013F408 0804FCE3 */  j         .L8013F38C
/* D5B0C 8013F40C A2A40051 */   sb       $a0, 0x51($s5)
/* D5B10 8013F410 0804FCE3 */  j         .L8013F38C
/* D5B14 8013F414 26100004 */   addiu    $s0, $s0, 4
/* D5B18 8013F418 0804FCE3 */  j         .L8013F38C
...
/* D5B54 8013F454 3C048015 */  lui       $a0, 0x8015
/* D5B58 8013F458 8C8412C8 */  lw        $a0, 0x12c8($a0)
...
/* D5B74 8013F474 3C038015 */  lui       $v1, 0x8015
/* D5B78 8013F478 8C63133C */  lw        $v1, 0x133c($v1)
/* D5B7C 8013F47C 3C028015 */  lui       $v0, 0x8015
...
/* D5BA8 8013F4A8 3C048015 */  lui       $a0, 0x8015
/* D5BAC 8013F4AC 0804FD32 */  j         .L8013F4C8
/* D5BB0 8013F4B0 8C84EFC4 */   lw       $a0, -0x103c($a0)
.L8013F4B4:
/* D5BB4 8013F4B4 3C028015 */  lui       $v0, 0x8015
/* D5BB8 8013F4B8 8C42EFC4 */  lw        $v0, -0x103c($v0)
/* D5BBC 8013F4BC 00021FC2 */  srl       $v1, $v0, 0x1f
/* D5BC0 8013F4C0 00431021 */  addu      $v0, $v0, $v1
/* D5BC4 8013F4C4 00022043 */  sra       $a0, $v0, 1
.L8013F4C8:
/* D5BC8 8013F4C8 3C028015 */  lui       $v0, 0x8015
/* D5BCC 8013F4CC 8C42133C */  lw        $v0, 0x133c($v0)
...
/* D5C08 8013F508 3C038015 */  lui       $v1, 0x8015
/* D5C0C 8013F50C 8C63133C */  lw        $v1, 0x133c($v1)
...
.L8013F59C:
/* D5C9C 8013F59C 3C048015 */  lui       $a0, 0x8015
/* D5CA0 8013F5A0 8C8412D0 */  lw        $a0, 0x12d0($a0)
...
/* D5CBC 8013F5BC 3C038015 */  lui       $v1, 0x8015
/* D5CC0 8013F5C0 8C63133C */  lw        $v1, 0x133c($v1)
/* D5CC4 8013F5C4 3C028015 */  lui       $v0, 0x8015
...
/* D5CF0 8013F5F0 3C048015 */  lui       $a0, 0x8015
/* D5CF4 8013F5F4 0804FD84 */  j         .L8013F610
/* D5CF8 8013F5F8 8C84EFC4 */   lw       $a0, -0x103c($a0)
.L8013F5FC:
/* D5CFC 8013F5FC 3C028015 */  lui       $v0, 0x8015
/* D5D00 8013F600 8C42EFC4 */  lw        $v0, -0x103c($v0)
/* D5D04 8013F604 00021FC2 */  srl       $v1, $v0, 0x1f
/* D5D08 8013F608 00431021 */  addu      $v0, $v0, $v1
/* D5D0C 8013F60C 00022043 */  sra       $a0, $v0, 1
.L8013F610:
/* D5D10 8013F610 3C028015 */  lui       $v0, 0x8015
/* D5D14 8013F614 8C42133C */  lw        $v0, 0x133c($v0)
...
/* D5D4C 8013F64C 3C038015 */  lui       $v1, 0x8015
/* D5D50 8013F650 8C63133C */  lw        $v1, 0x133c($v1)
...
/* D5DCC 8013F6CC 1440FF2F */  bnez      $v0, .L8013F38C
