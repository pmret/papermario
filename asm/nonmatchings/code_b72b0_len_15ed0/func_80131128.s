...
/* C786C 8013116C 3C108009 */  lui       $s0, 0x8009
/* C7870 80131170 02028021 */  addu      $s0, $s0, $v0
/* C7874 80131174 8E10DDD4 */  lw        $s0, -0x222c($s0)
...
/* C789C 8013119C 3C018015 */  lui       $at, 0x8015
/* C78A0 801311A0 00220821 */  addu      $at, $at, $v0
/* C78A4 801311A4 8C220A80 */  lw        $v0, 0xa80($at)
...
.L801311E4:
/* C78E4 801311E4 3C038015 */  lui       $v1, 0x8015
/* C78E8 801311E8 8C6312C8 */  lw        $v1, 0x12c8($v1)
...
/* C7904 80131204 3C048015 */  lui       $a0, 0x8015
/* C7908 80131208 8C84133C */  lw        $a0, 0x133c($a0)
/* C790C 8013120C 3C028015 */  lui       $v0, 0x8015
/* C7910 80131210 8C421314 */  lw        $v0, 0x1314($v0)
...
/* C794C 8013124C 3C038015 */  lui       $v1, 0x8015
/* C7950 80131250 8C63133C */  lw        $v1, 0x133c($v1)
/* C7954 80131254 8C620000 */  lw        $v0, ($v1)
/* C7958 80131258 00521021 */  addu      $v0, $v0, $s2
/* C795C 8013125C AC620000 */  sw        $v0, ($v1)
/* C7960 80131260 3C028007 */  lui       $v0, 0x8007
/* C7964 80131264 8C42419C */  lw        $v0, 0x419c($v0)
...
/* C7984 80131284 3C028007 */  lui       $v0, 0x8007
/* C7988 80131288 8C42419C */  lw        $v0, 0x419c($v0)
...
.L801312DC:
/* C79DC 801312DC 3C038015 */  lui       $v1, 0x8015
/* C79E0 801312E0 8C6312D0 */  lw        $v1, 0x12d0($v1)
...
/* C79F8 801312F8 3C048015 */  lui       $a0, 0x8015
/* C79FC 801312FC 8C84133C */  lw        $a0, 0x133c($a0)
/* C7A00 80131300 3C028015 */  lui       $v0, 0x8015
/* C7A04 80131304 8C421314 */  lw        $v0, 0x1314($v0)
...
/* C7A40 80131340 3C038015 */  lui       $v1, 0x8015
/* C7A44 80131344 8C63133C */  lw        $v1, 0x133c($v1)
/* C7A48 80131348 8C620000 */  lw        $v0, ($v1)
/* C7A4C 8013134C 24420020 */  addiu     $v0, $v0, 0x20
/* C7A50 80131350 AC620000 */  sw        $v0, ($v1)
/* C7A54 80131354 3C028007 */  lui       $v0, 0x8007
/* C7A58 80131358 8C42419C */  lw        $v0, 0x419c($v0)
...
/* C7A78 80131378 3C028007 */  lui       $v0, 0x8007
/* C7A7C 8013137C 8C42419C */  lw        $v0, 0x419c($v0)
