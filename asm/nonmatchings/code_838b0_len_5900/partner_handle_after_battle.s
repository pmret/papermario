...
/* 84B74 800EB6C4 3C028011 */  lui       $v0, 0x8011
/* 84B78 800EB6C8 8C42CFD8 */  lw        $v0, -0x3028($v0)
/* 84B7C 800EB6CC 27BDFFE0 */  addiu     $sp, $sp, -0x20
/* 84B80 800EB6D0 AFB10014 */  sw        $s1, 0x14($sp)
/* 84B84 800EB6D4 3C118011 */  lui       $s1, 0x8011
/* 84B88 800EB6D8 2631EBB0 */  addiu     $s1, $s1, -0x1450
/* 84B8C 800EB6DC AFBF0018 */  sw        $ra, 0x18($sp)
/* 84B90 800EB6E0 10400035 */  beqz      $v0, .L800EB7B8
/* 84B94 800EB6E4 AFB00010 */   sw       $s0, 0x10($sp)
/* 84B98 800EB6E8 3C108011 */  lui       $s0, 0x8011
/* 84B9C 800EB6EC 2610CFDC */  addiu     $s0, $s0, -0x3024
...
.L800EB708:
/* 84BB8 800EB708 3C028011 */  lui       $v0, 0x8011
/* 84BBC 800EB70C 8C42CFEC */  lw        $v0, -0x3014($v0)
...
/* 84BD0 800EB720 3C038011 */  lui       $v1, 0x8011
/* 84BD4 800EB724 8C63C930 */  lw        $v1, -0x36d0($v1)
/* 84BD8 800EB728 8C440144 */  lw        $a0, 0x144($v0)
/* 84BDC 800EB72C 3C018011 */  lui       $at, 0x8011
/* 84BE0 800EB730 AC22CFD4 */  sw        $v0, -0x302c($at)
...
/* 84BF8 800EB748 3C018011 */  lui       $at, 0x8011
/* 84BFC 800EB74C AC22CFE8 */  sw        $v0, -0x3018($at)
/* 84C00 800EB750 3C028011 */  lui       $v0, 0x8011
/* 84C04 800EB754 2442F290 */  addiu     $v0, $v0, -0xd70
...
/* 84C24 800EB774 3C04800F */  lui       $a0, 0x800f
/* 84C28 800EB778 8C847B30 */  lw        $a0, 0x7b30($a0)
...
.L800EB794:
/* 84C44 800EB794 3C028011 */  lui       $v0, 0x8011
/* 84C48 800EB798 8C42CFEC */  lw        $v0, -0x3014($v0)
/* 84C4C 800EB79C 8C420038 */  lw        $v0, 0x38($v0)
/* 84C50 800EB7A0 10400005 */  beqz      $v0, .L800EB7B8
/* 84C54 800EB7A4 00000000 */   nop      
/* 84C58 800EB7A8 3C048011 */  lui       $a0, 0x8011
/* 84C5C 800EB7AC 8C84C930 */  lw        $a0, -0x36d0($a0)
