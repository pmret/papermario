...
/* 867CC 800ED31C 3C048011 */  lui       $a0, 0x8011
/* 867D0 800ED320 2484CD38 */  addiu     $a0, $a0, -0x32c8
/* 867D4 800ED324 0000302D */  daddu     $a2, $zero, $zero
/* 867D8 800ED328 3C028010 */  lui       $v0, 0x8010
/* 867DC 800ED32C 2442833C */  addiu     $v0, $v0, -0x7cc4
/* 867E0 800ED330 0040482D */  daddu     $t1, $v0, $zero
/* 867E4 800ED334 3C028010 */  lui       $v0, 0x8010
/* 867E8 800ED338 24428340 */  addiu     $v0, $v0, -0x7cc0
/* 867EC 800ED33C 0040402D */  daddu     $t0, $v0, $zero
/* 867F0 800ED340 3C028010 */  lui       $v0, 0x8010
/* 867F4 800ED344 24428344 */  addiu     $v0, $v0, -0x7cbc
...
/* 8684C 800ED39C 3C018011 */  lui       $at, 0x8011
/* 86850 800ED3A0 AC20CFB8 */  sw        $zero, -0x3048($at)
/* 86854 800ED3A4 3C018011 */  lui       $at, 0x8011
/* 86858 800ED3A8 AC20CFBC */  sw        $zero, -0x3044($at)
/* 8685C 800ED3AC 14A00005 */  bnez      $a1, .L800ED3C4
/* 86860 800ED3B0 00000000 */   nop      
/* 86864 800ED3B4 3C018011 */  lui       $at, 0x8011
/* 86868 800ED3B8 A420CFC8 */  sh        $zero, -0x3038($at)
/* 8686C 800ED3BC 0803B50B */  j         .L800ED42C
/* 86870 800ED3C0 00000000 */   nop      
.L800ED3C4:
/* 86874 800ED3C4 3C048011 */  lui       $a0, 0x8011
/* 86878 800ED3C8 2484CFC4 */  addiu     $a0, $a0, -0x303c
...
/* 8688C 800ED3DC 3C018011 */  lui       $at, 0x8011
/* 86890 800ED3E0 A422CFC8 */  sh        $v0, -0x3038($at)
/* 86894 800ED3E4 24020002 */  addiu     $v0, $zero, 2
/* 86898 800ED3E8 3C018011 */  lui       $at, 0x8011
/* 8689C 800ED3EC A422CFCA */  sh        $v0, -0x3036($at)
...
/* 868BC 800ED40C 3C018011 */  lui       $at, 0x8011
/* 868C0 800ED410 A420CFC8 */  sh        $zero, -0x3038($at)
...
/* 868D4 800ED424 3C018011 */  lui       $at, 0x8011
/* 868D8 800ED428 A422CFC8 */  sh        $v0, -0x3038($at)
.L800ED42C:
/* 868DC 800ED42C 3C018011 */  lui       $at, 0x8011
/* 868E0 800ED430 A420CFCA */  sh        $zero, -0x3036($at)
.L800ED434:
/* 868E4 800ED434 3C038011 */  lui       $v1, 0x8011
/* 868E8 800ED438 8C63CFD8 */  lw        $v1, -0x3028($v1)
/* 868EC 800ED43C 3C014220 */  lui       $at, 0x4220
/* 868F0 800ED440 44810000 */  mtc1      $at, $f0
/* 868F4 800ED444 0200202D */  daddu     $a0, $s0, $zero
/* 868F8 800ED448 3C018011 */  lui       $at, 0x8011
/* 868FC 800ED44C A420CFCE */  sh        $zero, -0x3032($at)
/* 86900 800ED450 3C018011 */  lui       $at, 0x8011
/* 86904 800ED454 A420CFCC */  sh        $zero, -0x3034($at)
...
/* 8692C 800ED47C 3C018011 */  lui       $at, 0x8011
/* 86930 800ED480 E420CFC0 */  swc1      $f0, -0x3040($at)
