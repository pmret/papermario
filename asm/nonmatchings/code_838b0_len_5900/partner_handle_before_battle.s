...
/* 84B08 800EB658 3C028011 */  lui       $v0, %hi(D_8010CFD8)
/* 84B0C 800EB65C 8C42CFD8 */  lw        $v0, %lo(D_8010CFD8)($v0)
...
/* 84B20 800EB670 3C108011 */  lui       $s0, %hi(D_8010CFDC)
/* 84B24 800EB674 2610CFDC */  addiu     $s0, $s0, %lo(D_8010CFDC)
...
.L800EB690:
/* 84B40 800EB690 3C028011 */  lui       $v0, %hi(D_8010CFEC)
/* 84B44 800EB694 8C42CFEC */  lw        $v0, %lo(D_8010CFEC)($v0)
/* 84B48 800EB698 8C420034 */  lw        $v0, 0x34($v0)
/* 84B4C 800EB69C 10400005 */  beqz      $v0, .L800EB6B4
/* 84B50 800EB6A0 00000000 */   nop
/* 84B54 800EB6A4 3C048011 */  lui       $a0, %hi(D_8010C930)
/* 84B58 800EB6A8 8C84C930 */  lw        $a0, %lo(D_8010C930)($a0)
