...
/* 33B1B0 E0026030 3C02E002 */  lui       $v0, %hi(D_E0026184)
/* 33B1B4 E0026034 24426184 */  addiu     $v0, $v0, %lo(D_E0026184)
/* 33B1B8 E0026038 AFA20018 */  sw        $v0, 0x18($sp)
/* 33B1BC E002603C 3C02E002 */  lui       $v0, %hi(D_E002618C)
/* 33B1C0 E0026040 2442618C */  addiu     $v0, $v0, %lo(D_E002618C)
/* 33B1C4 E0026044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 33B1C8 E0026048 3C02E002 */  lui       $v0, %hi(D_E00264B0)
/* 33B1CC E002604C 244264B0 */  addiu     $v0, $v0, %lo(D_E00264B0)
