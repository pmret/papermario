...
/* 3D49A0 E00D2030 3C02E00D */  lui       $v0, %hi(func_E00D2118)
/* 3D49A4 E00D2034 24422118 */  addiu     $v0, $v0, %lo(func_E00D2118)
/* 3D49A8 E00D2038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D49AC E00D203C 3C02E00D */  lui       $v0, %hi(func_E00D2120)
/* 3D49B0 E00D2040 24422120 */  addiu     $v0, $v0, %lo(func_E00D2120)
/* 3D49B4 E00D2044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D49B8 E00D2048 3C02E00D */  lui       $v0, %hi(func_E00D2234)
/* 3D49BC E00D204C 24422234 */  addiu     $v0, $v0, %lo(func_E00D2234)
