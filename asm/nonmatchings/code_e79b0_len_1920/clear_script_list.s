...
/* E7B8C 802C31DC 3C028007 */  lui       $v0, 0x8007
/* E7B90 802C31E0 8C42419C */  lw        $v0, 0x419c($v0)
...
/* E7BA8 802C31F8 3C02802E */  lui       $v0, 0x802e
/* E7BAC 802C31FC 2442A490 */  addiu     $v0, $v0, -0x5b70
/* E7BB0 802C3200 3C01802E */  lui       $at, 0x802e
/* E7BB4 802C3204 AC22A890 */  sw        $v0, -0x5770($at)
/* E7BB8 802C3208 3C02802E */  lui       $v0, 0x802e
/* E7BBC 802C320C 2442BCA8 */  addiu     $v0, $v0, -0x4358
/* E7BC0 802C3210 3C01802E */  lui       $at, 0x802e
/* E7BC4 802C3214 AC22A484 */  sw        $v0, -0x5b7c($at)
...
.L802C3228:
/* E7BD8 802C3228 3C02802E */  lui       $v0, 0x802e
/* E7BDC 802C322C 2442A690 */  addiu     $v0, $v0, -0x5970
/* E7BE0 802C3230 3C01802E */  lui       $at, 0x802e
/* E7BE4 802C3234 AC22A890 */  sw        $v0, -0x5770($at)
/* E7BE8 802C3238 3C02802E */  lui       $v0, 0x802e
/* E7BEC 802C323C 2442BCE8 */  addiu     $v0, $v0, -0x4318
/* E7BF0 802C3240 3C01802E */  lui       $at, 0x802e
/* E7BF4 802C3244 AC22A484 */  sw        $v0, -0x5b7c($at)
/* E7BF8 802C3248 3C02802E */  lui       $v0, 0x802e
/* E7BFC 802C324C 2442BD34 */  addiu     $v0, $v0, -0x42cc
.L802C3250:
/* E7C00 802C3250 3C01802E */  lui       $at, 0x802e
/* E7C04 802C3254 AC22A480 */  sw        $v0, -0x5b80($at)
/* E7C08 802C3258 3C02802E */  lui       $v0, 0x802e
/* E7C0C 802C325C 8C42A890 */  lw        $v0, -0x5770($v0)
...
/* E7C28 802C3278 3C02802E */  lui       $v0, 0x802e
/* E7C2C 802C327C 8C42A484 */  lw        $v0, -0x5b7c($v0)
/* E7C30 802C3280 2403000F */  addiu     $v1, $zero, 0xf
/* E7C34 802C3284 3C01802E */  lui       $at, 0x802e
/* E7C38 802C3288 AC20A488 */  sw        $zero, -0x5b78($at)
/* E7C3C 802C328C 3C01802E */  lui       $at, 0x802e
/* E7C40 802C3290 AC20AC98 */  sw        $zero, -0x5368($at)
/* E7C44 802C3294 3C01802E */  lui       $at, 0x802e
/* E7C48 802C3298 AC209CA4 */  sw        $zero, -0x635c($at)
...
/* E7C60 802C32B0 3C02802E */  lui       $v0, 0x802e
/* E7C64 802C32B4 8C42A480 */  lw        $v0, -0x5b80($v0)
