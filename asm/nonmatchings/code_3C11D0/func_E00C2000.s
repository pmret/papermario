...
/* 3C1200 E00C2030 3C02E00C */  lui       $v0, %hi(D_E00C2124)
/* 3C1204 E00C2034 24422124 */  addiu     $v0, $v0, %lo(D_E00C2124)
/* 3C1208 E00C2038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3C120C E00C203C 3C02E00C */  lui       $v0, %hi(D_E00C212C)
/* 3C1210 E00C2040 2442212C */  addiu     $v0, $v0, %lo(D_E00C212C)
/* 3C1214 E00C2044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3C1218 E00C2048 3C02E00C */  lui       $v0, %hi(D_E00C21CC)
