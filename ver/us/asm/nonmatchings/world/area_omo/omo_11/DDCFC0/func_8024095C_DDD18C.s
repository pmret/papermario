...
/* DDD1DC 802409AC 3C148024 */  lui       $s4, %hi(omo_11_SuperBlockDataB)
/* DDD1E0 802409B0 26941E48 */  addiu     $s4, $s4, %lo(omo_11_SuperBlockDataB)
/* DDD1E4 802409B4 0260882D */  daddu     $s1, $s3, $zero
/* DDD1E8 802409B8 8EA200B4 */  lw        $v0, 0xb4($s5)
/* DDD1EC 802409BC 3C038024 */  lui       $v1, %hi(omo_11_SuperBlockDataA)
/* DDD1F0 802409C0 24631E40 */  addiu     $v1, $v1, %lo(omo_11_SuperBlockDataA)
...
/* DDD228 802409F8 3C068009 */  lui       $a2, %hi(gPartnerPopupProperties)
/* DDD22C 802409FC 24C6EF20 */  addiu     $a2, $a2, %lo(gPartnerPopupProperties)
...
/* DDD274 80240A44 3C068024 */  lui       $a2, %hi(omo_11_SuperBlockDataC)
/* DDD278 80240A48 24C61E58 */  addiu     $a2, $a2, %lo(omo_11_SuperBlockDataC)
...
/* DDD31C 80240AEC 0C03C4EC */  jal       hide_popup_menu
...
.L80240B14:
/* DDD344 80240B14 0C03C54E */  jal       destroy_popup_menu
...
/* DDD36C 80240B3C 3C038009 */  lui       $v1, %hi(gPartnerPopupProperties)
/* DDD370 80240B40 00621821 */  addu      $v1, $v1, $v0
/* DDD374 80240B44 8C63EF20 */  lw        $v1, %lo(gPartnerPopupProperties)($v1)
