...
/* 360FC 8005ACFC 3C0401E4 */  lui       $a0, %hi(mapfs_ROM_START + 0x20)
/* 36100 8005AD00 34840020 */  addiu     $a0, $a0, %lo(mapfs_ROM_START + 0x20)
/* 36104 8005AD04 3C0501E4 */  lui       $a1, %hi(mapfs_ROM_START + 0x3C)
/* 36108 8005AD08 34A5003C */  addiu     $a1, $a1, %lo(mapfs_ROM_START + 0x3C)
...
/* 36134 8005AD34 3C0201E4 */  lui       $v0, %hi(mapfs_ROM_START + 0x20)
/* 36138 8005AD38 34420020 */  addiu     $v0, $v0, %lo(mapfs_ROM_START + 0x20)
/* 3613C 8005AD3C 3C0401E4 */  lui       $a0, %hi(mapfs_ROM_START + 0x20)
/* 36140 8005AD40 34840020 */  addiu     $a0, $a0, %lo(mapfs_ROM_START + 0x20)
...
/* 36180 8005AD80 3C0301E4 */  lui       $v1, %hi(mapfs_ROM_START + 0x20)
/* 36184 8005AD84 34630020 */  addiu     $v1, $v1, %lo(mapfs_ROM_START + 0x20)
