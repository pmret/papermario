...
/* 361E4 8005ADE4 3C0401E4 */  lui       $a0, %hi(mapfs_ROM_START + 0x20)
/* 361E8 8005ADE8 34840020 */  addiu     $a0, $a0, %lo(mapfs_ROM_START + 0x20)
/* 361EC 8005ADEC 3C0501E4 */  lui       $a1, %hi(mapfs_ROM_START + 0x3C)
/* 361F0 8005ADF0 34A5003C */  addiu     $a1, $a1, %lo(mapfs_ROM_START + 0x3C)
...
/* 3621C 8005AE1C 3C0201E4 */  lui       $v0, %hi(mapfs_ROM_START + 0x20)
/* 36220 8005AE20 34420020 */  addiu     $v0, $v0, %lo(mapfs_ROM_START + 0x20)
/* 36224 8005AE24 3C0401E4 */  lui       $a0, %hi(mapfs_ROM_START + 0x20)
/* 36228 8005AE28 34840020 */  addiu     $a0, $a0, %lo(mapfs_ROM_START + 0x20)
...
/* 3624C 8005AE4C 3C0301E4 */   lui      $v1, %hi(mapfs_ROM_START + 0x20)
/* 36250 8005AE50 08016B8F */  j         .L8005AE3C
/* 36254 8005AE54 2610001C */   addiu    $s0, $s0, 0x1c
.L8005AE58:
/* 36258 8005AE58 8E020014 */  lw        $v0, 0x14($s0)
/* 3625C 8005AE5C 34630020 */  addiu     $v1, $v1, %lo(mapfs_ROM_START + 0x20)
