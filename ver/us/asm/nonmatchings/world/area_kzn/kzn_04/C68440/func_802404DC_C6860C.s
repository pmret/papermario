...
/* C6865C 8024052C 3C148024 */  lui       $s4, %hi(kzn_04_SuperBlockDataB)
/* C68660 80240530 26941C48 */  addiu     $s4, $s4, %lo(kzn_04_SuperBlockDataB)
/* C68664 80240534 0260882D */  daddu     $s1, $s3, $zero
/* C68668 80240538 8EA200B4 */  lw        $v0, 0xb4($s5)
/* C6866C 8024053C 3C038024 */  lui       $v1, %hi(kzn_04_SuperBlockDataA)
/* C68670 80240540 24631C40 */  addiu     $v1, $v1, %lo(kzn_04_SuperBlockDataA)
...
/* C686A8 80240578 3C068009 */  lui       $a2, %hi(gPartnerPopupProperties)
/* C686AC 8024057C 24C6EF20 */  addiu     $a2, $a2, %lo(gPartnerPopupProperties)
...
/* C686C4 80240594 0C0900F9 */  jal       kzn_04_UnkFunc37
...
/* C686F4 802405C4 3C068024 */  lui       $a2, %hi(kzn_04_SuperBlockDataC)
/* C686F8 802405C8 24C61C58 */  addiu     $a2, $a2, %lo(kzn_04_SuperBlockDataC)
...
/* C6879C 8024066C 0C03C4EC */  jal       hide_popup_menu
...
.L80240694:
/* C687C4 80240694 0C03C54E */  jal       destroy_popup_menu
...
/* C687EC 802406BC 3C038009 */  lui       $v1, %hi(gPartnerPopupProperties)
/* C687F0 802406C0 00621821 */  addu      $v1, $v1, $v0
/* C687F4 802406C4 8C63EF20 */  lw        $v1, %lo(gPartnerPopupProperties)($v1)
