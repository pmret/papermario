...
/* 940768 802411B8 0C0B1EAF */  jal       evt_get_variable
...
/* 940788 802411D8 3C058024 */  lui       $a1, %hi(btl_state_update_end_battle)
/* 94078C 802411DC 24A54A50 */  addiu     $a1, $a1, %lo(btl_state_update_end_battle)
.L802411E0:
...
.L802411FC:
/* 9407AC 802411FC 3C018024 */  lui       $at, %hi(btl_state_update_end_battle)
/* 9407B0 80241200 00220821 */  addu      $at, $at, $v0
/* 9407B4 80241204 AC204A50 */  sw        $zero, %lo(btl_state_update_end_battle)($at)
/* 9407B8 80241208 0809048E */  j         .L80241238
/* 9407BC 8024120C 00000000 */   nop
.L80241210:
/* 9407C0 80241210 3C038024 */  lui       $v1, %hi(btl_state_update_end_battle)
/* 9407C4 80241214 24634A50 */  addiu     $v1, $v1, %lo(btl_state_update_end_battle)
