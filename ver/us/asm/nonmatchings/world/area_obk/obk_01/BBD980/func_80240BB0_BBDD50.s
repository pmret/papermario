...
/* BBDD7C 80240BDC 3C058024 */  lui       $a1, %hi(obk_01_bss_sym)
/* BBDD80 80240BE0 24A558F0 */  addiu     $a1, $a1, %lo(obk_01_bss_sym)
.L80240BE4:
...
.L80240C00:
/* BBDDA0 80240C00 3C018024 */  lui       $at, %hi(obk_01_bss_sym)
/* BBDDA4 80240C04 00220821 */  addu      $at, $at, $v0
/* BBDDA8 80240C08 AC2058F0 */  sw        $zero, %lo(obk_01_bss_sym)($at)
/* BBDDAC 80240C0C 0809030F */  j         .L80240C3C
/* BBDDB0 80240C10 00000000 */   nop
.L80240C14:
/* BBDDB4 80240C14 3C038024 */  lui       $v1, %hi(obk_01_bss_sym)
/* BBDDB8 80240C18 246358F0 */  addiu     $v1, $v1, %lo(obk_01_bss_sym)
