...
/* B5EB2C 8024087C 3C148024 */  lui       $s4, %hi(jan_08_SuperBlockDataB)
/* B5EB30 80240880 26943E08 */  addiu     $s4, $s4, %lo(jan_08_SuperBlockDataB)
/* B5EB34 80240884 0260882D */  daddu     $s1, $s3, $zero
/* B5EB38 80240888 8EA200B4 */  lw        $v0, 0xb4($s5)
/* B5EB3C 8024088C 3C038024 */  lui       $v1, %hi(jan_08_SuperBlockDataA)
/* B5EB40 80240890 24633E00 */  addiu     $v1, $v1, %lo(jan_08_SuperBlockDataA)
...
/* B5EB78 802408C8 3C068009 */  lui       $a2, %hi(gPartnerPopupProperties)
/* B5EB7C 802408CC 24C6EF20 */  addiu     $a2, $a2, %lo(gPartnerPopupProperties)
...
/* B5EBA8 802408F8 3C06800F */  lui       $a2, %hi(wPartnerHudScripts)
/* B5EBAC 802408FC 24C67F00 */  addiu     $a2, $a2, %lo(wPartnerHudScripts)
...
/* B5EBC4 80240914 3C068024 */  lui       $a2, %hi(jan_08_SuperBlockDataC)
/* B5EBC8 80240918 24C63E18 */  addiu     $a2, $a2, %lo(jan_08_SuperBlockDataC)
...
.L80240938:
/* B5EBE8 80240938 3C06800F */  lui       $a2, %hi(wDisabledPartnerHudScripts)
/* B5EBEC 8024093C 24C67F40 */  addiu     $a2, $a2, %lo(wDisabledPartnerHudScripts)
...
/* B5EC6C 802409BC 0C03C4EC */  jal       hide_popup_menu
...
.L802409E4:
/* B5EC94 802409E4 0C03C54E */  jal       destroy_popup_menu
...
/* B5ECBC 80240A0C 3C038009 */  lui       $v1, %hi(gPartnerPopupProperties)
/* B5ECC0 80240A10 00621821 */  addu      $v1, $v1, $v0
/* B5ECC4 80240A14 8C63EF20 */  lw        $v1, %lo(gPartnerPopupProperties)($v1)
