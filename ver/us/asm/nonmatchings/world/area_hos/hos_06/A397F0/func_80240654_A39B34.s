...
/* A39B44 80240664 3C018024 */  lui       $at, %hi(hos_06_ItemChoice_HasSelectedItem)
/* A39B48 80240668 AC202C6C */  sw        $zero, %lo(hos_06_ItemChoice_HasSelectedItem)($at)
.L8024066C:
/* A39B4C 8024066C 3C038024 */  lui       $v1, %hi(hos_06_ItemChoice_HasSelectedItem)
/* A39B50 80240670 24632C6C */  addiu     $v1, $v1, %lo(hos_06_ItemChoice_HasSelectedItem)
...
/* A39B6C 8024068C 3C068024 */  lui       $a2, %hi(hos_06_ItemChoice_SelectedItemID)
/* A39B70 80240690 0C0B2026 */  jal       evt_set_variable
/* A39B74 80240694 8CC62C70 */   lw       $a2, %lo(hos_06_ItemChoice_SelectedItemID)($a2)
