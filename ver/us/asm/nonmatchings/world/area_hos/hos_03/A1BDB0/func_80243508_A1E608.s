...
glabel hos_03_Quizmo_UnkJ
/* A1E608 80243508 27BDFFE8 */  addiu     $sp, $sp, -0x18
/* A1E60C 8024350C 3C058024 */  lui       $a1, %hi(hos_03_Quizmo_UnkI)
/* A1E610 80243510 24A5349C */  addiu     $a1, $a1, %lo(hos_03_Quizmo_UnkI)
/* A1E614 80243514 AFBF0010 */  sw        $ra, 0x10($sp)
/* A1E618 80243518 0C048C8F */  jal       create_generic_entity_frontUI
/* A1E61C 8024351C 0000202D */   daddu    $a0, $zero, $zero
/* A1E620 80243520 8FBF0010 */  lw        $ra, 0x10($sp)
/* A1E624 80243524 3C018025 */  lui       $at, %hi(hos_03_Quizmo_Worker)
/* A1E628 80243528 AC22BDD0 */  sw        $v0, %lo(hos_03_Quizmo_Worker)($at)
