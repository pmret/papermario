...
/* 9D9C00 80242BE0 3C018025 */  lui       $at, %hi(dup_nok_02_ItemChoice_HasSelectedItem)
/* 9D9C04 80242BE4 AC2096F0 */  sw        $zero, %lo(dup_nok_02_ItemChoice_HasSelectedItem)($at)
.L80242BE8:
/* 9D9C08 80242BE8 3C038025 */  lui       $v1, %hi(dup_nok_02_ItemChoice_HasSelectedItem)
/* 9D9C0C 80242BEC 246396F0 */  addiu     $v1, $v1, %lo(dup_nok_02_ItemChoice_HasSelectedItem)
...
/* 9D9C28 80242C08 3C068025 */  lui       $a2, %hi(dup_nok_02_ItemChoice_SelectedItemID)
/* 9D9C2C 80242C0C 0C0B2026 */  jal       evt_set_variable
/* 9D9C30 80242C10 8CC696F4 */   lw       $a2, %lo(dup_nok_02_ItemChoice_SelectedItemID)($a2)
