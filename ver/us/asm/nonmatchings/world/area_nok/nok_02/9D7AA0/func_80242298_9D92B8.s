...
/* 9D92C4 802422A4 3C038025 */  lui       $v1, %hi(nok_02_Quizmo_AudienceEffect)
/* 9D92C8 802422A8 8C6349C4 */  lw        $v1, %lo(nok_02_Quizmo_AudienceEffect)($v1)
/* 9D92CC 802422AC 8C620000 */  lw        $v0, ($v1)
/* 9D92D0 802422B0 3C048025 */  lui       $a0, %hi(nok_02_Quizmo_VannaTEffect)
/* 9D92D4 802422B4 8C8449C8 */  lw        $a0, %lo(nok_02_Quizmo_VannaTEffect)($a0)
...
.L802422CC:
/* 9D92EC 802422CC 3C048025 */  lui       $a0, %hi(nok_02_Quizmo_StageEffect)
/* 9D92F0 802422D0 8C8449C0 */  lw        $a0, %lo(nok_02_Quizmo_StageEffect)($a0)
...
/* 9D934C 8024232C 3C048025 */  lui       $a0, %hi(nok_02_Quizmo_Worker)
/* 9D9350 80242330 8C8449A0 */  lw        $a0, %lo(nok_02_Quizmo_Worker)($a0)
/* 9D9354 80242334 0C048D70 */  jal       free_generic_entity
