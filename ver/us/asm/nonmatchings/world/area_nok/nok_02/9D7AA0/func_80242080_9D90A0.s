...
/* 9D9130 80242110 3C108025 */  lui       $s0, %hi(nok_02_Quizmo_StageEffect)
/* 9D9134 80242114 261049C0 */  addiu     $s0, $s0, %lo(nok_02_Quizmo_StageEffect)
...
/* 9D91A0 80242180 3C018025 */  lui       $at, %hi(nok_02_Quizmo_AudienceEffect)
/* 9D91A4 80242184 AC2249C4 */  sw        $v0, %lo(nok_02_Quizmo_AudienceEffect)($at)
...
/* 9D9220 80242200 3C018025 */  lui       $at, %hi(nok_02_Quizmo_VannaTEffect)
/* 9D9224 80242204 AC2249C8 */  sw        $v0, %lo(nok_02_Quizmo_VannaTEffect)($at)
...
.L8024221C:
/* 9D923C 8024221C 3C028025 */  lui       $v0, %hi(nok_02_Quizmo_StageEffect)
/* 9D9240 80242220 8C4249C0 */  lw        $v0, %lo(nok_02_Quizmo_StageEffect)($v0)
