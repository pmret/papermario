...
/* 9D7654 80240634 3C018024 */  lui       $at, %hi(nok_02_ItemChoice_HasSelectedItem)
/* 9D7658 80240638 AC205434 */  sw        $zero, %lo(nok_02_ItemChoice_HasSelectedItem)($at)
.L8024063C:
/* 9D765C 8024063C 3C038024 */  lui       $v1, %hi(nok_02_ItemChoice_HasSelectedItem)
/* 9D7660 80240640 24635434 */  addiu     $v1, $v1, %lo(nok_02_ItemChoice_HasSelectedItem)
...
/* 9D767C 8024065C 3C068024 */  lui       $a2, %hi(nok_02_ItemChoice_SelectedItemID)
/* 9D7680 80240660 0C0B2026 */  jal       evt_set_variable
/* 9D7684 80240664 8CC65438 */   lw       $a2, %lo(nok_02_ItemChoice_SelectedItemID)($a2)
