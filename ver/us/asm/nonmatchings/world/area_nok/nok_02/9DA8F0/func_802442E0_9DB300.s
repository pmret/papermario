...
/* 9DB314 802442F4 0C0B1EAF */  jal       evt_get_variable
...
/* 9DB32C 8024430C 3C048025 */  lui       $a0, %hi(D_8025279C_9E97BC)
/* 9DB330 80244310 00832021 */  addu      $a0, $a0, $v1
/* 9DB334 80244314 8C84279C */  lw        $a0, %lo(D_8025279C_9E97BC)($a0)
/* 9DB338 80244318 00041140 */  sll       $v0, $a0, 5
/* 9DB33C 8024431C 3C018025 */  lui       $at, %hi(D_802529B4_9E99D4)
/* 9DB340 80244320 AC2429B4 */  sw        $a0, %lo(D_802529B4_9E99D4)($at)
/* 9DB344 80244324 3C038008 */  lui       $v1, %hi(gItemTable+0x18)
/* 9DB348 80244328 00621821 */  addu      $v1, $v1, $v0
/* 9DB34C 8024432C 946378F8 */  lhu       $v1, %lo(gItemTable+0x18)($v1)
