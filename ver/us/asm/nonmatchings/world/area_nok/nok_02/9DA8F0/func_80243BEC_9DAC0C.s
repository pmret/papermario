...
/* 9DAC1C 80243BFC 3C018025 */  lui       $at, %hi(dup2_nok_02_ItemChoice_HasSelectedItem)
/* 9DAC20 80243C00 AC202400 */  sw        $zero, %lo(dup2_nok_02_ItemChoice_HasSelectedItem)($at)
.L80243C04:
/* 9DAC24 80243C04 3C038025 */  lui       $v1, %hi(dup2_nok_02_ItemChoice_HasSelectedItem)
/* 9DAC28 80243C08 24632400 */  addiu     $v1, $v1, %lo(dup2_nok_02_ItemChoice_HasSelectedItem)
...
/* 9DAC44 80243C24 3C068025 */  lui       $a2, %hi(dup2_nok_02_ItemChoice_SelectedItemID)
/* 9DAC48 80243C28 0C0B2026 */  jal       evt_set_variable
/* 9DAC4C 80243C2C 8CC62404 */   lw       $a2, %lo(dup2_nok_02_ItemChoice_SelectedItemID)($a2)
