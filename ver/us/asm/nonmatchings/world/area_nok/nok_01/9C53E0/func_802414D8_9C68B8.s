...
/* 9C68DC 802414FC 0C0B1EAF */  jal       evt_get_variable
...
/* 9C68F8 80241518 0C0B1EAF */  jal       evt_get_variable
...
/* 9C6914 80241534 0C0B1EAF */  jal       evt_get_variable
...
/* 9C6934 80241554 0C01C574 */  jal       fx_quizmo_stage
...
/* 9C6948 80241568 3C108025 */  lui       $s0, %hi(nok_01_Quizmo_StageEffect)
/* 9C694C 8024156C 26101C60 */  addiu     $s0, $s0, %lo(nok_01_Quizmo_StageEffect)
/* 9C6950 80241570 0C0B1EAF */  jal       evt_get_variable
...
/* 9C696C 8024158C 0C0B1EAF */  jal       evt_get_variable
...
/* 9C6988 802415A8 0C0B1EAF */  jal       evt_get_variable
...
/* 9C69A8 802415C8 0C01C604 */  jal       fx_quizmo_audience
...
/* 9C69B8 802415D8 3C018025 */  lui       $at, %hi(nok_01_Quizmo_AudienceEffect)
/* 9C69BC 802415DC AC221C64 */  sw        $v0, %lo(nok_01_Quizmo_AudienceEffect)($at)
/* 9C69C0 802415E0 0C0B1EAF */  jal       evt_get_variable
...
/* 9C69DC 802415FC 0C0B1EAF */  jal       evt_get_variable
...
/* 9C69F8 80241618 0C0B1EAF */  jal       evt_get_variable
...
/* 9C6A28 80241648 0C01CA24 */  jal       fx_quizmo_assistant
/* 9C6A2C 8024164C E7A00010 */   swc1     $f0, 0x10($sp)
/* 9C6A30 80241650 8E030000 */  lw        $v1, ($s0)
/* 9C6A34 80241654 8C64000C */  lw        $a0, 0xc($v1)
/* 9C6A38 80241658 3C018025 */  lui       $at, %hi(nok_01_Quizmo_VannaTEffect)
/* 9C6A3C 8024165C AC221C68 */  sw        $v0, %lo(nok_01_Quizmo_VannaTEffect)($at)
...
.L80241674:
/* 9C6A54 80241674 3C028025 */  lui       $v0, %hi(nok_01_Quizmo_StageEffect)
/* 9C6A58 80241678 8C421C60 */  lw        $v0, %lo(nok_01_Quizmo_StageEffect)($v0)
