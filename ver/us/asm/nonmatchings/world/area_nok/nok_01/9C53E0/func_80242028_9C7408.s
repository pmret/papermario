...
/* 9C7418 80242038 3C018025 */  lui       $at, %hi(nok_01_ItemChoice_HasSelectedItem)
/* 9C741C 8024203C AC20856C */  sw        $zero, %lo(nok_01_ItemChoice_HasSelectedItem)($at)
.L80242040:
/* 9C7420 80242040 3C038025 */  lui       $v1, %hi(nok_01_ItemChoice_HasSelectedItem)
/* 9C7424 80242044 2463856C */  addiu     $v1, $v1, %lo(nok_01_ItemChoice_HasSelectedItem)
...
/* 9C7440 80242060 3C068025 */  lui       $a2, %hi(nok_01_ItemChoice_SelectedItemID)
/* 9C7444 80242064 0C0B2026 */  jal       evt_set_variable
/* 9C7448 80242068 8CC68570 */   lw       $a2, %lo(nok_01_ItemChoice_SelectedItemID)($a2)
