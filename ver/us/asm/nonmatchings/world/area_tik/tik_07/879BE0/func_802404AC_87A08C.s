...
/* 87A0DC 802404FC 3C148024 */  lui       $s4, %hi(tik_07_SuperBlockDataB)
/* 87A0E0 80240500 269439F8 */  addiu     $s4, $s4, %lo(tik_07_SuperBlockDataB)
/* 87A0E4 80240504 0260882D */  daddu     $s1, $s3, $zero
/* 87A0E8 80240508 8EA200B4 */  lw        $v0, 0xb4($s5)
/* 87A0EC 8024050C 3C038024 */  lui       $v1, %hi(tik_07_SuperBlockDataA)
/* 87A0F0 80240510 246339F0 */  addiu     $v1, $v1, %lo(tik_07_SuperBlockDataA)
...
/* 87A128 80240548 3C068009 */  lui       $a2, %hi(gPartnerPopupProperties)
/* 87A12C 8024054C 24C6EF20 */  addiu     $a2, $a2, %lo(gPartnerPopupProperties)
...
/* 87A144 80240564 0C0900ED */  jal       tik_07_UnkFunc37
...
/* 87A158 80240578 3C06800F */  lui       $a2, %hi(wPartnerHudScripts)
/* 87A15C 8024057C 24C67F00 */  addiu     $a2, $a2, %lo(wPartnerHudScripts)
...
/* 87A174 80240594 3C068024 */  lui       $a2, %hi(tik_07_SuperBlockDataC)
/* 87A178 80240598 24C63A08 */  addiu     $a2, $a2, %lo(tik_07_SuperBlockDataC)
...
.L802405B8:
/* 87A198 802405B8 3C06800F */  lui       $a2, %hi(wDisabledPartnerHudScripts)
/* 87A19C 802405BC 24C67F40 */  addiu     $a2, $a2, %lo(wDisabledPartnerHudScripts)
...
/* 87A1F4 80240614 0C03D390 */  jal       create_popup_menu
...
/* 87A21C 8024063C 0C03C4EC */  jal       hide_popup_menu
...
.L80240664:
/* 87A244 80240664 0C03C54E */  jal       destroy_popup_menu
...
/* 87A26C 8024068C 3C038009 */  lui       $v1, %hi(gPartnerPopupProperties)
/* 87A270 80240690 00621821 */  addu      $v1, $v1, $v0
/* 87A274 80240694 8C63EF20 */  lw        $v1, %lo(gPartnerPopupProperties)($v1)
