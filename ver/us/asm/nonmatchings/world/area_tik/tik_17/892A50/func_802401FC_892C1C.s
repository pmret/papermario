...
/* 892C6C 8024024C 3C148024 */  lui       $s4, %hi(tik_17_SuperBlockDataB)
/* 892C70 80240250 26941428 */  addiu     $s4, $s4, %lo(tik_17_SuperBlockDataB)
/* 892C74 80240254 0260882D */  daddu     $s1, $s3, $zero
/* 892C78 80240258 8EA200B4 */  lw        $v0, 0xb4($s5)
/* 892C7C 8024025C 3C038024 */  lui       $v1, %hi(tik_17_SuperBlockDataA)
/* 892C80 80240260 24631420 */  addiu     $v1, $v1, %lo(tik_17_SuperBlockDataA)
...
/* 892CB8 80240298 3C068009 */  lui       $a2, %hi(gPartnerPopupProperties)
/* 892CBC 8024029C 24C6EF20 */  addiu     $a2, $a2, %lo(gPartnerPopupProperties)
...
/* 892CE8 802402C8 3C06800F */  lui       $a2, %hi(wPartnerHudScripts)
/* 892CEC 802402CC 24C67F00 */  addiu     $a2, $a2, %lo(wPartnerHudScripts)
...
/* 892D04 802402E4 3C068024 */  lui       $a2, %hi(tik_17_SuperBlockDataC)
/* 892D08 802402E8 24C61438 */  addiu     $a2, $a2, %lo(tik_17_SuperBlockDataC)
...
.L80240308:
/* 892D28 80240308 3C06800F */  lui       $a2, %hi(wDisabledPartnerHudScripts)
/* 892D2C 8024030C 24C67F40 */  addiu     $a2, $a2, %lo(wDisabledPartnerHudScripts)
...
/* 892DAC 8024038C 0C03C4EC */  jal       hide_popup_menu
...
.L802403B4:
/* 892DD4 802403B4 0C03C54E */  jal       destroy_popup_menu
...
/* 892DFC 802403DC 3C038009 */  lui       $v1, %hi(gPartnerPopupProperties)
/* 892E00 802403E0 00621821 */  addu      $v1, $v1, $v0
/* 892E04 802403E4 8C63EF20 */  lw        $v1, %lo(gPartnerPopupProperties)($v1)
