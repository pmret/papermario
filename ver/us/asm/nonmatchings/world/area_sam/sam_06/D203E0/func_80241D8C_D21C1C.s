...
/* D21C2C 80241D9C 3C018024 */  lui       $at, %hi(sam_06_ItemChoice_HasSelectedItem)
/* D21C30 80241DA0 AC204434 */  sw        $zero, %lo(sam_06_ItemChoice_HasSelectedItem)($at)
.L80241DA4:
/* D21C34 80241DA4 3C038024 */  lui       $v1, %hi(sam_06_ItemChoice_HasSelectedItem)
/* D21C38 80241DA8 24634434 */  addiu     $v1, $v1, %lo(sam_06_ItemChoice_HasSelectedItem)
...
/* D21C54 80241DC4 3C068024 */  lui       $a2, %hi(sam_06_ItemChoice_SelectedItemID)
/* D21C58 80241DC8 0C0B2026 */  jal       evt_set_variable
/* D21C5C 80241DCC 8CC64438 */   lw       $a2, %lo(sam_06_ItemChoice_SelectedItemID)($a2)
