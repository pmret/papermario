...
/* D2FE9C 8024021C 3C148024 */  lui       $s4, %hi(sam_08_SuperBlockDataB)
/* D2FEA0 80240220 26941AE8 */  addiu     $s4, $s4, %lo(sam_08_SuperBlockDataB)
/* D2FEA4 80240224 0260882D */  daddu     $s1, $s3, $zero
/* D2FEA8 80240228 8EA200B4 */  lw        $v0, 0xb4($s5)
/* D2FEAC 8024022C 3C038024 */  lui       $v1, %hi(sam_08_SuperBlockDataA)
/* D2FEB0 80240230 24631AE0 */  addiu     $v1, $v1, %lo(sam_08_SuperBlockDataA)
...
/* D2FEE8 80240268 3C068009 */  lui       $a2, %hi(gPartnerPopupProperties)
/* D2FEEC 8024026C 24C6EF20 */  addiu     $a2, $a2, %lo(gPartnerPopupProperties)
...
/* D2FF04 80240284 0C090035 */  jal       sam_08_UnkFunc37
...
/* D2FF18 80240298 3C06800F */  lui       $a2, %hi(wPartnerHudScripts)
/* D2FF1C 8024029C 24C67F00 */  addiu     $a2, $a2, %lo(wPartnerHudScripts)
...
/* D2FF34 802402B4 3C068024 */  lui       $a2, %hi(sam_08_SuperBlockDataC)
/* D2FF38 802402B8 24C61AF8 */  addiu     $a2, $a2, %lo(sam_08_SuperBlockDataC)
...
.L802402D8:
/* D2FF58 802402D8 3C06800F */  lui       $a2, %hi(wDisabledPartnerHudScripts)
/* D2FF5C 802402DC 24C67F40 */  addiu     $a2, $a2, %lo(wDisabledPartnerHudScripts)
...
/* D2FFB4 80240334 0C03D390 */  jal       create_popup_menu
...
/* D2FFDC 8024035C 0C03C4EC */  jal       hide_popup_menu
...
.L80240384:
/* D30004 80240384 0C03C54E */  jal       destroy_popup_menu
...
/* D3002C 802403AC 3C038009 */  lui       $v1, %hi(gPartnerPopupProperties)
/* D30030 802403B0 00621821 */  addu      $v1, $v1, $v0
/* D30034 802403B4 8C63EF20 */  lw        $v1, %lo(gPartnerPopupProperties)($v1)
