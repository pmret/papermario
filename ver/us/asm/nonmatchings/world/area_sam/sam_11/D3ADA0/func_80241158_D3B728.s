...
/* D3B734 80241164 3C038025 */  lui       $v1, %hi(sam_11_Quizmo_AudienceEffect)
/* D3B738 80241168 8C631474 */  lw        $v1, %lo(sam_11_Quizmo_AudienceEffect)($v1)
/* D3B73C 8024116C 8C620000 */  lw        $v0, ($v1)
/* D3B740 80241170 3C048025 */  lui       $a0, %hi(sam_11_Quizmo_VannaTEffect)
/* D3B744 80241174 8C841478 */  lw        $a0, %lo(sam_11_Quizmo_VannaTEffect)($a0)
...
.L8024118C:
/* D3B75C 8024118C 3C048025 */  lui       $a0, %hi(sam_11_Quizmo_StageEffect)
/* D3B760 80241190 8C841470 */  lw        $a0, %lo(sam_11_Quizmo_StageEffect)($a0)
...
/* D3B7BC 802411EC 3C048025 */  lui       $a0, %hi(sam_11_Quizmo_Worker)
/* D3B7C0 802411F0 8C841450 */  lw        $a0, %lo(sam_11_Quizmo_Worker)($a0)
