...
/* D3B534 80240F64 0C0B1EAF */  jal       evt_get_variable
...
/* D3B550 80240F80 0C0B1EAF */  jal       evt_get_variable
...
/* D3B56C 80240F9C 0C0B1EAF */  jal       evt_get_variable
...
/* D3B58C 80240FBC 0C01C574 */  jal       fx_quizmo_stage
...
/* D3B5A0 80240FD0 3C108025 */  lui       $s0, %hi(sam_11_Quizmo_StageEffect)
/* D3B5A4 80240FD4 26101470 */  addiu     $s0, $s0, %lo(sam_11_Quizmo_StageEffect)
/* D3B5A8 80240FD8 0C0B1EAF */  jal       evt_get_variable
...
/* D3B5C4 80240FF4 0C0B1EAF */  jal       evt_get_variable
...
/* D3B5E0 80241010 0C0B1EAF */  jal       evt_get_variable
...
/* D3B600 80241030 0C01C604 */  jal       fx_quizmo_audience
...
/* D3B610 80241040 3C018025 */  lui       $at, %hi(sam_11_Quizmo_AudienceEffect)
/* D3B614 80241044 AC221474 */  sw        $v0, %lo(sam_11_Quizmo_AudienceEffect)($at)
/* D3B618 80241048 0C0B1EAF */  jal       evt_get_variable
...
/* D3B634 80241064 0C0B1EAF */  jal       evt_get_variable
...
/* D3B650 80241080 0C0B1EAF */  jal       evt_get_variable
...
/* D3B680 802410B0 0C01CA24 */  jal       fx_quizmo_assistant
/* D3B684 802410B4 E7A00010 */   swc1     $f0, 0x10($sp)
/* D3B688 802410B8 8E030000 */  lw        $v1, ($s0)
/* D3B68C 802410BC 8C64000C */  lw        $a0, 0xc($v1)
/* D3B690 802410C0 3C018025 */  lui       $at, %hi(sam_11_Quizmo_VannaTEffect)
/* D3B694 802410C4 AC221478 */  sw        $v0, %lo(sam_11_Quizmo_VannaTEffect)($at)
...
.L802410DC:
/* D3B6AC 802410DC 3C028025 */  lui       $v0, %hi(sam_11_Quizmo_StageEffect)
/* D3B6B0 802410E0 8C421470 */  lw        $v0, %lo(sam_11_Quizmo_StageEffect)($v0)
