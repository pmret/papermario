...
/* CF8C04 80241094 3C038025 */  lui       $v1, %hi(sam_01_Quizmo_AudienceEffect)
/* CF8C08 80241098 8C63DF1C */  lw        $v1, %lo(sam_01_Quizmo_AudienceEffect)($v1)
/* CF8C0C 8024109C 8C620000 */  lw        $v0, ($v1)
/* CF8C10 802410A0 3C048025 */  lui       $a0, %hi(sam_01_Quizmo_VannaTEffect)
/* CF8C14 802410A4 8C84DF20 */  lw        $a0, %lo(sam_01_Quizmo_VannaTEffect)($a0)
...
.L802410BC:
/* CF8C2C 802410BC 3C048025 */  lui       $a0, %hi(sam_01_Quizmo_StageEffect)
/* CF8C30 802410C0 8C84DF18 */  lw        $a0, %lo(sam_01_Quizmo_StageEffect)($a0)
...
/* CF8C8C 8024111C 3C048025 */  lui       $a0, %hi(sam_01_Quizmo_Worker)
/* CF8C90 80241120 8C84DEF8 */  lw        $a0, %lo(sam_01_Quizmo_Worker)($a0)
