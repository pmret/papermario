...
/* D2C5C8 80240898 3C03800A */  lui       $v1, %hi(gCurrentCamID)
/* D2C5CC 8024089C 8463A634 */  lh        $v1, %lo(gCurrentCamID)($v1)
...
.L802409C4:
/* D2C6F4 802409C4 3C038011 */  lui       $v1, %hi(D_8010EBB0+0x3)
/* D2C6F8 802409C8 8063EBB3 */  lb        $v1, %lo(D_8010EBB0+0x3)($v1)
