...
/* 31F148 802BE3D8 3C148011 */  lui       $s4, %hi(gPartnerActionStatus)
/* 31F14C 802BE3DC 2694EBB0 */  addiu     $s4, $s4, %lo(gPartnerActionStatus)
...
/* 31F174 802BE404 3C01802C */  lui       $at, %hi(bullshit_802BFEFC)
/* 31F178 802BE408 AC20FEFC */  sw        $zero, %lo(bullshit_802BFEFC)($at)
...
/* 31F188 802BE418 AC20FF00 */  sw        $zero, %lo(D_802BFF00)($at)
/* 31F18C 802BE41C 3C01802C */  lui       $at, %hi(D_802BFF04)
/* 31F190 802BE420 AC20FF04 */  sw        $zero, %lo(D_802BFF04)($at)
/* 31F194 802BE424 3C01802C */  lui       $at, %hi(D_802BFF08)
/* 31F198 802BE428 AC20FF08 */  sw        $zero, %lo(D_802BFF08)($at)
...
/* 31F1C8 802BE458 10400425 */  beqz      $v0, .L802BF4F0_320260
...
/* 31F238 802BE4C8 080AFD3C */  j         .L802BF4F0_320260
...
/* 31F268 802BE4F8 3C01802C */  lui       $at, %hi(D_802BFEEC)
/* 31F26C 802BE4FC AC30FEEC */  sw        $s0, %lo(D_802BFEEC)($at)
/* 31F270 802BE500 34420008 */  ori       $v0, $v0, 8
/* 31F274 802BE504 00431024 */  and       $v0, $v0, $v1
/* 31F278 802BE508 34420100 */  ori       $v0, $v0, 0x100
/* 31F27C 802BE50C 0C037FDE */  jal       suggest_player_anim_setUnkFlag
...
/* 31F2E0 802BE570 3C01802C */  lui       $at, %hi(bullshit_802BFEE4)
/* 31F2E4 802BE574 AC20FEE4 */  sw        $zero, %lo(bullshit_802BFEE4)($at)
/* 31F2E8 802BE578 3C01802C */  lui       $at, %hi(bullshit_802BFEE8)
/* 31F2EC 802BE57C AC20FEE8 */  sw        $zero, %lo(bullshit_802BFEE8)($at)
...
/* 31F3CC 802BE65C 3C01802C */  lui       $at, %hi(D_802BFEEC)
/* 31F3D0 802BE660 AC22FEEC */  sw        $v0, %lo(D_802BFEEC)($at)
...
/* 31F59C 802BE82C 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 31F6AC 802BE93C 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 31F6F8 802BE988 0C01C16C */  jal       playFX_23
...
/* 31F740 802BE9D0 0C01C16C */  jal       playFX_23
...
/* 31F7A8 802BEA38 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 31F808 802BEA98 0C037FDE */  jal       suggest_player_anim_setUnkFlag
...
/* 31F86C 802BEAFC 3C01802C */  lui       $at, %hi(bullshit_802BFEE4)
/* 31F870 802BEB00 AC20FEE4 */  sw        $zero, %lo(bullshit_802BFEE4)($at)
/* 31F874 802BEB04 3C01802C */  lui       $at, %hi(bullshit_802BFEE8)
/* 31F878 802BEB08 AC20FEE8 */  sw        $zero, %lo(bullshit_802BFEE8)($at)
...
/* 31F8A0 802BEB30 3C10802C */  lui       $s0, %hi(bullshit_802BFEE4)
/* 31F8A4 802BEB34 2610FEE4 */  addiu     $s0, $s0, %lo(bullshit_802BFEE4)
...
/* 31F958 802BEBE8 C420FEF8 */  lwc1      $f0, %lo(D_802BFEF8)($at)
...
/* 31F9E8 802BEC78 0C01C16C */  jal       playFX_23
...
.L802BECAC:
/* 31FA1C 802BECAC 3C06802C */  lui       $a2, %hi(bullshit_802BFEE4)
/* 31FA20 802BECB0 8CC6FEE4 */  lw        $a2, %lo(bullshit_802BFEE4)($a2)
...
.L802BED5C:
/* 31FACC 802BED5C 3C01802C */  lui       $at, %hi(D_802BFEF8)
/* 31FAD0 802BED60 C420FEF8 */  lwc1      $f0, %lo(D_802BFEF8)($at)
...
.L802BEE1C:
/* 31FB8C 802BEE1C 0C01C16C */  jal       playFX_23
...
/* 31FBC4 802BEE54 3C02802C */  lui       $v0, %hi(bullshit_802BFEF0)
/* 31FBC8 802BEE58 8C42FEF0 */  lw        $v0, %lo(bullshit_802BFEF0)($v0)
...
.L802BEE68:
/* 31FBD8 802BEE68 3C02802C */  lui       $v0, %hi(bullshit_802BFEF4)
/* 31FBDC 802BEE6C 8C42FEF4 */  lw        $v0, %lo(bullshit_802BFEF4)($v0)
...
/* 31FC5C 802BEEEC 0C0376B9 */  jal       npc_test_move_taller_with_slipping
...
/* 31FC6C 802BEEFC 3C028011 */  lui       $v0, %hi(D_8010C97A)
/* 31FC70 802BEF00 9442C97A */  lhu       $v0, %lo(D_8010C97A)($v0)
...
.L802BEF3C:
/* 31FCAC 802BEF3C 3C03802C */  lui       $v1, %hi(bullshit_802BFEE4)
/* 31FCB0 802BEF40 8C63FEE4 */  lw        $v1, %lo(bullshit_802BFEE4)($v1)
...
/* 31FCC0 802BEF50 3C03802C */  lui       $v1, %hi(bullshit_802BFEE8)
/* 31FCC4 802BEF54 8C63FEE8 */  lw        $v1, %lo(bullshit_802BFEE8)($v1)
...
/* 31FD18 802BEFA8 3C01802C */  lui       $at, %hi(bullshit_802BFEF0)
/* 31FD1C 802BEFAC AC20FEF0 */  sw        $zero, %lo(bullshit_802BFEF0)($at)
...
/* 31FF48 802BF1D8 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 31FF6C 802BF1FC 080AFD3C */  j         .L802BF4F0_320260
/* 31FF70 802BF200 AEA20070 */   sw       $v0, 0x70($s5)
.L802BF204_31FF74:
/* 31FF74 802BF204 3C040001 */  lui       $a0, 1
/* 31FF78 802BF208 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 31FFA0 802BF230 45000006 */  bc1f      .L802BF24C_31FFBC
/* 31FFA4 802BF234 3C040001 */   lui      $a0, 1
/* 31FFA8 802BF238 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 31FFD8 802BF268 0C038D45 */  jal       player_check_collision_below
...
/* 31FFF4 802BF284 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 32006C 802BF2FC 0440007C */  bltz      $v0, .L802BF4F0_320260
...
/* 320088 802BF318 0C037FBF */  jal       suggest_player_anim_clearUnkFlag
...
/* 320168 802BF3F8 080AFD3C */  j         .L802BF4F0_320260
...
/* 3201D0 802BF460 0C03BD17 */  jal       partner_clear_player_tracking
...
/* 3201FC 802BF48C 3C01802C */  lui       $at, %hi(D_802BFEEC)
/* 320200 802BF490 AC20FEEC */  sw        $zero, %lo(D_802BFEEC)($at)
