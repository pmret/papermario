...
/* 8B0D94 80240D24 3C038025 */  lui       $v1, %hi(kmr_02_Quizmo_AudienceEffect)
/* 8B0D98 80240D28 8C637F4C */  lw        $v1, %lo(kmr_02_Quizmo_AudienceEffect)($v1)
/* 8B0D9C 80240D2C 8C620000 */  lw        $v0, ($v1)
/* 8B0DA0 80240D30 3C048025 */  lui       $a0, %hi(kmr_02_Quizmo_VannaTEffect)
/* 8B0DA4 80240D34 8C847F50 */  lw        $a0, %lo(kmr_02_Quizmo_VannaTEffect)($a0)
...
.L80240D4C:
/* 8B0DBC 80240D4C 3C048025 */  lui       $a0, %hi(kmr_02_Quizmo_StageEffect)
/* 8B0DC0 80240D50 8C847F48 */  lw        $a0, %lo(kmr_02_Quizmo_StageEffect)($a0)
...
/* 8B0E1C 80240DAC 3C048025 */  lui       $a0, %hi(kmr_02_Quizmo_Worker)
/* 8B0E20 80240DB0 8C847F2C */  lw        $a0, %lo(kmr_02_Quizmo_Worker)($a0)
/* 8B0E24 80240DB4 0C048D70 */  jal       free_generic_entity
