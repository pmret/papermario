...
/* 8B0B94 80240B24 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0BB0 80240B40 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0BCC 80240B5C 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0BEC 80240B7C 0C01C574 */  jal       fx_quizmo_stage
...
/* 8B0C00 80240B90 3C108025 */  lui       $s0, %hi(kmr_02_Quizmo_StageEffect)
/* 8B0C04 80240B94 26107F48 */  addiu     $s0, $s0, %lo(kmr_02_Quizmo_StageEffect)
/* 8B0C08 80240B98 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0C24 80240BB4 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0C40 80240BD0 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0C60 80240BF0 0C01C604 */  jal       fx_quizmo_audience
...
/* 8B0C70 80240C00 3C018025 */  lui       $at, %hi(kmr_02_Quizmo_AudienceEffect)
/* 8B0C74 80240C04 AC227F4C */  sw        $v0, %lo(kmr_02_Quizmo_AudienceEffect)($at)
/* 8B0C78 80240C08 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0C94 80240C24 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0CB0 80240C40 0C0B1EAF */  jal       evt_get_variable
...
/* 8B0CE0 80240C70 0C01CA24 */  jal       fx_quizmo_assistant
/* 8B0CE4 80240C74 E7A00010 */   swc1     $f0, 0x10($sp)
/* 8B0CE8 80240C78 8E030000 */  lw        $v1, ($s0)
/* 8B0CEC 80240C7C 8C64000C */  lw        $a0, 0xc($v1)
/* 8B0CF0 80240C80 3C018025 */  lui       $at, %hi(kmr_02_Quizmo_VannaTEffect)
/* 8B0CF4 80240C84 AC227F50 */  sw        $v0, %lo(kmr_02_Quizmo_VannaTEffect)($at)
...
.L80240C9C:
/* 8B0D0C 80240C9C 3C028025 */  lui       $v0, %hi(kmr_02_Quizmo_StageEffect)
/* 8B0D10 80240CA0 8C427F48 */  lw        $v0, %lo(kmr_02_Quizmo_StageEffect)($v0)
