...
/* 8B2A5C 802429EC 3C048025 */  lui       $a0, %hi(kmr_02_savedColR)
/* 8B2A60 802429F0 24847F20 */  addiu     $a0, $a0, %lo(kmr_02_savedColR)
/* 8B2A64 802429F4 3C058025 */  lui       $a1, %hi(kmr_02_savedColG)
/* 8B2A68 802429F8 24A57F21 */  addiu     $a1, $a1, %lo(kmr_02_savedColG)
/* 8B2A6C 802429FC 3C068025 */  lui       $a2, %hi(kmr_02_savedColB)
/* 8B2A70 80242A00 24C67F22 */  addiu     $a2, $a2, %lo(kmr_02_savedColB)
/* 8B2A74 80242A04 3C078025 */  lui       $a3, %hi(kmr_02_savedColA)
/* 8B2A78 80242A08 0C046FA0 */  jal       get_background_color_blend
/* 8B2A7C 80242A0C 24E77F23 */   addiu    $a3, $a3, %lo(kmr_02_savedColA)
...
/* 8B2A8C 80242A1C 3C048025 */  lui       $a0, %hi(kmr_02_savedColR)
/* 8B2A90 80242A20 90847F20 */  lbu       $a0, %lo(kmr_02_savedColR)($a0)
...
/* 8B2AD0 80242A60 3C058025 */  lui       $a1, %hi(kmr_02_savedColG)
/* 8B2AD4 80242A64 90A57F21 */  lbu       $a1, %lo(kmr_02_savedColG)($a1)
...
/* 8B2B10 80242AA0 3C068025 */  lui       $a2, %hi(kmr_02_savedColB)
/* 8B2B14 80242AA4 90C67F22 */  lbu       $a2, %lo(kmr_02_savedColB)($a2)
...
/* 8B2B50 80242AE0 3C078025 */  lui       $a3, %hi(kmr_02_savedColA)
/* 8B2B54 80242AE4 90E77F23 */  lbu       $a3, %lo(kmr_02_savedColA)($a3)
