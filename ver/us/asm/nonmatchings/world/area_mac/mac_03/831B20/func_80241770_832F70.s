...
/* 832F80 80241780 3C018025 */  lui       $at, %hi(mac_03_ItemChoice_HasSelectedItem)
/* 832F84 80241784 AC208C6C */  sw        $zero, %lo(mac_03_ItemChoice_HasSelectedItem)($at)
.L80241788:
/* 832F88 80241788 3C038025 */  lui       $v1, %hi(mac_03_ItemChoice_HasSelectedItem)
/* 832F8C 8024178C 24638C6C */  addiu     $v1, $v1, %lo(mac_03_ItemChoice_HasSelectedItem)
...
/* 832FA8 802417A8 3C068025 */  lui       $a2, %hi(mac_03_ItemChoice_SelectedItemID)
/* 832FAC 802417AC 0C0B2026 */  jal       evt_set_variable
/* 832FB0 802417B0 8CC68C70 */   lw       $a2, %lo(mac_03_ItemChoice_SelectedItemID)($a2)
