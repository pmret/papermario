...
/* 825D50 80242A90 3C018025 */  lui       $at, %hi(mac_02_ItemChoice_HasSelectedItem)
/* 825D54 80242A94 AC208778 */  sw        $zero, %lo(mac_02_ItemChoice_HasSelectedItem)($at)
.L80242A98:
/* 825D58 80242A98 3C038025 */  lui       $v1, %hi(mac_02_ItemChoice_HasSelectedItem)
/* 825D5C 80242A9C 24638778 */  addiu     $v1, $v1, %lo(mac_02_ItemChoice_HasSelectedItem)
...
/* 825D78 80242AB8 3C068025 */  lui       $a2, %hi(mac_02_ItemChoice_SelectedItemID)
/* 825D7C 80242ABC 0C0B2026 */  jal       evt_set_variable
/* 825D80 80242AC0 8CC6877C */   lw       $a2, %lo(mac_02_ItemChoice_SelectedItemID)($a2)
