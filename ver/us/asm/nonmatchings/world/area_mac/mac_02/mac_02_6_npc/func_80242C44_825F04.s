...
/* 825FC0 80242D00 3C068025 */  lui       $a2, %hi(MysteryResultOptions)
/* 825FC4 80242D04 00C23021 */  addu      $a2, $a2, $v0
/* 825FC8 80242D08 8CC6909C */  lw        $a2, %lo(MysteryResultOptions)($a2)
/* 825FCC 80242D0C 08090B61 */  j         .L80242D84
/* 825FD0 80242D10 0220202D */   daddu    $a0, $s1, $zero
.L80242D14:
/* 825FD4 80242D14 3C038025 */  lui       $v1, %hi(CookingIngredients)
/* 825FD8 80242D18 24638A98 */  addiu     $v1, $v1, %lo(CookingIngredients)
.L80242D1C:
...
/* 82600C 80242D4C 3C018025 */  lui       $at, %hi(SingleRecipesWithCookbook)
/* 826010 80242D50 00240821 */  addu      $at, $at, $a0
/* 826014 80242D54 08090B5A */  j         .L80242D68
/* 826018 80242D58 80248CD0 */   lb       $a0, %lo(SingleRecipesWithCookbook)($at)
.L80242D5C:
/* 82601C 80242D5C 3C018025 */  lui       $at, %hi(SingleRecipesWithoutCookbook)
/* 826020 80242D60 00240821 */  addu      $at, $at, $a0
/* 826024 80242D64 80248CB0 */  lb        $a0, %lo(SingleRecipesWithoutCookbook)($at)
.L80242D68:
/* 826028 80242D68 3C038025 */  lui       $v1, %hi(CookingResults)
/* 82602C 80242D6C 24638B10 */  addiu     $v1, $v1, %lo(CookingResults)
