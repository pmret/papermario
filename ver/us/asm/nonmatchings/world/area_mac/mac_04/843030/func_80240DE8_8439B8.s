...
/* 8439C4 80240DF4 3C038025 */  lui       $v1, %hi(mac_04_Quizmo_AudienceEffect)
/* 8439C8 80240DF8 8C63F5C4 */  lw        $v1, %lo(mac_04_Quizmo_AudienceEffect)($v1)
/* 8439CC 80240DFC 8C620000 */  lw        $v0, ($v1)
/* 8439D0 80240E00 3C048025 */  lui       $a0, %hi(mac_04_Quizmo_VannaTEffect)
/* 8439D4 80240E04 8C84F5C8 */  lw        $a0, %lo(mac_04_Quizmo_VannaTEffect)($a0)
...
.L80240E1C:
/* 8439EC 80240E1C 3C048025 */  lui       $a0, %hi(mac_04_Quizmo_StageEffect)
/* 8439F0 80240E20 8C84F5C0 */  lw        $a0, %lo(mac_04_Quizmo_StageEffect)($a0)
...
/* 843A4C 80240E7C 3C048025 */  lui       $a0, %hi(mac_04_Quizmo_Worker)
/* 843A50 80240E80 8C84F5A0 */  lw        $a0, %lo(mac_04_Quizmo_Worker)($a0)
