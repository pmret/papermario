...
/* 84381C 80240C4C 0C01C574 */  jal       fx_quizmo_stage
...
/* 843830 80240C60 3C108025 */  lui       $s0, %hi(mac_04_Quizmo_StageEffect)
/* 843834 80240C64 2610F5C0 */  addiu     $s0, $s0, %lo(mac_04_Quizmo_StageEffect)
...
/* 843890 80240CC0 0C01C604 */  jal       fx_quizmo_audience
...
/* 8438A0 80240CD0 3C018025 */  lui       $at, %hi(mac_04_Quizmo_AudienceEffect)
/* 8438A4 80240CD4 AC22F5C4 */  sw        $v0, %lo(mac_04_Quizmo_AudienceEffect)($at)
...
/* 843910 80240D40 0C01CA24 */  jal       fx_quizmo_assistant
/* 843914 80240D44 E7A00010 */   swc1     $f0, 0x10($sp)
/* 843918 80240D48 8E030000 */  lw        $v1, ($s0)
/* 84391C 80240D4C 8C64000C */  lw        $a0, 0xc($v1)
/* 843920 80240D50 3C018025 */  lui       $at, %hi(mac_04_Quizmo_VannaTEffect)
/* 843924 80240D54 AC22F5C8 */  sw        $v0, %lo(mac_04_Quizmo_VannaTEffect)($at)
...
.L80240D6C:
/* 84393C 80240D6C 3C028025 */  lui       $v0, %hi(mac_04_Quizmo_StageEffect)
/* 843940 80240D70 8C42F5C0 */  lw        $v0, %lo(mac_04_Quizmo_StageEffect)($v0)
