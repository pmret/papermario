...
/* 7EC610 80241900 3C018025 */  lui       $at, %hi(mac_00_ItemChoice_HasSelectedItem)
/* 7EC614 80241904 AC2083E8 */  sw        $zero, %lo(mac_00_ItemChoice_HasSelectedItem)($at)
.L80241908:
/* 7EC618 80241908 3C038025 */  lui       $v1, %hi(mac_00_ItemChoice_HasSelectedItem)
/* 7EC61C 8024190C 246383E8 */  addiu     $v1, $v1, %lo(mac_00_ItemChoice_HasSelectedItem)
...
/* 7EC638 80241928 3C068025 */  lui       $a2, %hi(mac_00_ItemChoice_SelectedItemID)
/* 7EC63C 8024192C 0C0B2026 */  jal       evt_set_variable
/* 7EC640 80241930 8CC683EC */   lw       $a2, %lo(mac_00_ItemChoice_SelectedItemID)($a2)
