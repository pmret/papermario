...
/* 7EE468 80243758 AC20ED4C */  sw        $zero, %lo(dup_mac_00_ItemChoice_HasSelectedItem)($at)
.L8024375C:
/* 7EE46C 8024375C 3C038025 */  lui       $v1, %hi(dup_mac_00_ItemChoice_HasSelectedItem)
/* 7EE470 80243760 2463ED4C */  addiu     $v1, $v1, %lo(dup_mac_00_ItemChoice_HasSelectedItem)
...
/* 7EE48C 8024377C 3C068025 */  lui       $a2, %hi(dup_mac_00_ItemChoice_SelectedItemID)
/* 7EE490 80243780 0C0B2026 */  jal       evt_set_variable
/* 7EE494 80243784 8CC6ED50 */   lw       $a2, %lo(dup_mac_00_ItemChoice_SelectedItemID)($a2)
