...
/* 853E24 80241CB4 3C038025 */  lui       $v1, %hi(mac_05_Quizmo_AudienceEffect)
/* 853E28 80241CB8 8C6329F4 */  lw        $v1, %lo(mac_05_Quizmo_AudienceEffect)($v1)
/* 853E2C 80241CBC 8C620000 */  lw        $v0, ($v1)
/* 853E30 80241CC0 3C048025 */  lui       $a0, %hi(mac_05_Quizmo_VannaTEffect)
/* 853E34 80241CC4 8C8429F8 */  lw        $a0, %lo(mac_05_Quizmo_VannaTEffect)($a0)
...
.L80241CDC:
/* 853E4C 80241CDC 3C048025 */  lui       $a0, %hi(mac_05_Quizmo_StageEffect)
/* 853E50 80241CE0 8C8429F0 */  lw        $a0, %lo(mac_05_Quizmo_StageEffect)($a0)
...
/* 853EAC 80241D3C 3C048025 */  lui       $a0, %hi(mac_05_Quizmo_Worker)
/* 853EB0 80241D40 8C8429D0 */  lw        $a0, %lo(mac_05_Quizmo_Worker)($a0)
