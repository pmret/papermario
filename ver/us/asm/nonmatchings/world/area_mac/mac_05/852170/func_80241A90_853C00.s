...
/* 853C24 80241AB4 0C0B1EAF */  jal       evt_get_variable
...
/* 853C40 80241AD0 0C0B1EAF */  jal       evt_get_variable
...
/* 853C5C 80241AEC 0C0B1EAF */  jal       evt_get_variable
...
/* 853C7C 80241B0C 0C01C574 */  jal       fx_quizmo_stage
...
/* 853C90 80241B20 3C108025 */  lui       $s0, %hi(mac_05_Quizmo_StageEffect)
/* 853C94 80241B24 261029F0 */  addiu     $s0, $s0, %lo(mac_05_Quizmo_StageEffect)
/* 853C98 80241B28 0C0B1EAF */  jal       evt_get_variable
...
/* 853CB4 80241B44 0C0B1EAF */  jal       evt_get_variable
...
/* 853CD0 80241B60 0C0B1EAF */  jal       evt_get_variable
...
/* 853CF0 80241B80 0C01C604 */  jal       fx_quizmo_audience
...
/* 853D00 80241B90 3C018025 */  lui       $at, %hi(mac_05_Quizmo_AudienceEffect)
/* 853D04 80241B94 AC2229F4 */  sw        $v0, %lo(mac_05_Quizmo_AudienceEffect)($at)
/* 853D08 80241B98 0C0B1EAF */  jal       evt_get_variable
...
/* 853D24 80241BB4 0C0B1EAF */  jal       evt_get_variable
...
/* 853D40 80241BD0 0C0B1EAF */  jal       evt_get_variable
...
/* 853D70 80241C00 0C01CA24 */  jal       fx_quizmo_assistant
/* 853D74 80241C04 E7A00010 */   swc1     $f0, 0x10($sp)
/* 853D78 80241C08 8E030000 */  lw        $v1, ($s0)
/* 853D7C 80241C0C 8C64000C */  lw        $a0, 0xc($v1)
/* 853D80 80241C10 3C018025 */  lui       $at, %hi(mac_05_Quizmo_VannaTEffect)
/* 853D84 80241C14 AC2229F8 */  sw        $v0, %lo(mac_05_Quizmo_VannaTEffect)($at)
...
.L80241C2C:
/* 853D9C 80241C2C 3C028025 */  lui       $v0, %hi(mac_05_Quizmo_StageEffect)
/* 853DA0 80241C30 8C4229F0 */  lw        $v0, %lo(mac_05_Quizmo_StageEffect)($v0)
