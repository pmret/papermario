...
/* 803124 802428A4 3C038026 */  lui       $v1, %hi(mac_01_Quizmo_AudienceEffect)
/* 803128 802428A8 8C632A64 */  lw        $v1, %lo(mac_01_Quizmo_AudienceEffect)($v1)
/* 80312C 802428AC 8C620000 */  lw        $v0, ($v1)
/* 803130 802428B0 3C048026 */  lui       $a0, %hi(mac_01_Quizmo_VannaTEffect)
/* 803134 802428B4 8C842A68 */  lw        $a0, %lo(mac_01_Quizmo_VannaTEffect)($a0)
...
.L802428CC:
/* 80314C 802428CC 3C048026 */  lui       $a0, %hi(mac_01_Quizmo_StageEffect)
/* 803150 802428D0 8C842A60 */  lw        $a0, %lo(mac_01_Quizmo_StageEffect)($a0)
...
/* 8031AC 8024292C 3C048026 */  lui       $a0, %hi(mac_01_Quizmo_Worker)
/* 8031B0 80242930 8C842A40 */  lw        $a0, %lo(mac_01_Quizmo_Worker)($a0)
/* 8031B4 80242934 0C048D70 */  jal       free_generic_entity
