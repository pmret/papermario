...
/* 802F24 802426A4 0C0B1EAF */  jal       evt_get_variable
...
/* 802F40 802426C0 0C0B1EAF */  jal       evt_get_variable
...
/* 802F5C 802426DC 0C0B1EAF */  jal       evt_get_variable
...
/* 802F7C 802426FC 0C01C574 */  jal       fx_quizmo_stage
...
/* 802F90 80242710 3C108026 */  lui       $s0, %hi(mac_01_Quizmo_StageEffect)
/* 802F94 80242714 26102A60 */  addiu     $s0, $s0, %lo(mac_01_Quizmo_StageEffect)
/* 802F98 80242718 0C0B1EAF */  jal       evt_get_variable
...
/* 802FB4 80242734 0C0B1EAF */  jal       evt_get_variable
...
/* 802FD0 80242750 0C0B1EAF */  jal       evt_get_variable
...
/* 802FF0 80242770 0C01C604 */  jal       fx_quizmo_audience
...
/* 803000 80242780 3C018026 */  lui       $at, %hi(mac_01_Quizmo_AudienceEffect)
/* 803004 80242784 AC222A64 */  sw        $v0, %lo(mac_01_Quizmo_AudienceEffect)($at)
/* 803008 80242788 0C0B1EAF */  jal       evt_get_variable
...
/* 803024 802427A4 0C0B1EAF */  jal       evt_get_variable
...
/* 803040 802427C0 0C0B1EAF */  jal       evt_get_variable
...
/* 803070 802427F0 0C01CA24 */  jal       fx_quizmo_assistant
/* 803074 802427F4 E7A00010 */   swc1     $f0, 0x10($sp)
/* 803078 802427F8 8E030000 */  lw        $v1, ($s0)
/* 80307C 802427FC 8C64000C */  lw        $a0, 0xc($v1)
/* 803080 80242800 3C018026 */  lui       $at, %hi(mac_01_Quizmo_VannaTEffect)
/* 803084 80242804 AC222A68 */  sw        $v0, %lo(mac_01_Quizmo_VannaTEffect)($at)
...
.L8024281C:
/* 80309C 8024281C 3C028026 */  lui       $v0, %hi(mac_01_Quizmo_StageEffect)
/* 8030A0 80242820 8C422A60 */  lw        $v0, %lo(mac_01_Quizmo_StageEffect)($v0)
