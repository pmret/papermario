...
/* D59A94 80241204 3C058024 */  lui       $a1, %hi(pra_09_bss_sym)
/* D59A98 80241208 24A56A20 */  addiu     $a1, $a1, %lo(pra_09_bss_sym)
.L8024120C:
...
.L80241228:
/* D59AB8 80241228 3C018024 */  lui       $at, %hi(pra_09_bss_sym)
/* D59ABC 8024122C 00220821 */  addu      $at, $at, $v0
/* D59AC0 80241230 AC206A20 */  sw        $zero, %lo(pra_09_bss_sym)($at)
/* D59AC4 80241234 08090499 */  j         .L80241264
/* D59AC8 80241238 00000000 */   nop
.L8024123C:
/* D59ACC 8024123C 3C038024 */  lui       $v1, %hi(pra_09_bss_sym)
/* D59AD0 80241240 24636A20 */  addiu     $v1, $v1, %lo(pra_09_bss_sym)
