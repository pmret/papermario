...
/* D6573C 8024115C 3C018024 */  lui       $at, %hi(pra_13_ItemChoice_HasSelectedItem)
/* D65740 80241160 AC2022CC */  sw        $zero, %lo(pra_13_ItemChoice_HasSelectedItem)($at)
.L80241164:
/* D65744 80241164 3C038024 */  lui       $v1, %hi(pra_13_ItemChoice_HasSelectedItem)
/* D65748 80241168 246322CC */  addiu     $v1, $v1, %lo(pra_13_ItemChoice_HasSelectedItem)
...
/* D65764 80241184 3C068024 */  lui       $a2, %hi(pra_13_ItemChoice_SelectedItemID)
/* D65768 80241188 0C0B2026 */  jal       evt_set_variable
/* D6576C 8024118C 8CC622D0 */   lw       $a2, %lo(pra_13_ItemChoice_SelectedItemID)($a2)
