...
/* D64AA8 802404C8 0C048C56 */  jal       create_dynamic_entity_world
/* D64AAC 802404CC 0000202D */   daddu    $a0, $zero, $zero
/* D64AB0 802404D0 8E03013C */  lw        $v1, 0x13c($s0)
/* D64AB4 802404D4 AC620000 */  sw        $v0, ($v1)
/* D64AB8 802404D8 3C03800A */  lui       $v1, %hi(gOverrideFlags)
/* D64ABC 802404DC 2463A650 */  addiu     $v1, $v1, %lo(gOverrideFlags)
