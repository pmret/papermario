...
/* D55D14 80240164 0C048B77 */  jal       get_entity_model
...
/* D55D44 80240194 3C04800A */  lui       $a0, %hi(gCurrentCamID)
/* D55D48 80240198 8484A634 */  lh        $a0, %lo(gCurrentCamID)($a0)
...
/* D55DD8 80240228 3C02802E */  lui       $v0, %hi(D_802D9D70)
/* D55DDC 8024022C 90429D70 */  lbu       $v0, %lo(D_802D9D70)($v0)
...
/* D55E48 80240298 3C01802E */  lui       $at, %hi(D_802D9D70)
/* D55E4C 8024029C A0229D70 */  sb        $v0, %lo(D_802D9D70)($at)
/* D55E50 802402A0 080900AD */  j         .L802402B4
/* D55E54 802402A4 0240202D */   daddu    $a0, $s2, $zero
.L802402A8:
/* D55E58 802402A8 3C01802E */  lui       $at, %hi(D_802D9D70)
/* D55E5C 802402AC A0209D70 */  sb        $zero, %lo(D_802D9D70)($at)
