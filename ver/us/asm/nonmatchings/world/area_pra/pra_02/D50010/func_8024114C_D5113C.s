...
/* D5114C 8024115C 3C018024 */  lui       $at, %hi(pra_02_ItemChoice_HasSelectedItem)
/* D51150 80241160 AC202ACC */  sw        $zero, %lo(pra_02_ItemChoice_HasSelectedItem)($at)
.L80241164:
/* D51154 80241164 3C038024 */  lui       $v1, %hi(pra_02_ItemChoice_HasSelectedItem)
/* D51158 80241168 24632ACC */  addiu     $v1, $v1, %lo(pra_02_ItemChoice_HasSelectedItem)
...
/* D51174 80241184 3C068024 */  lui       $a2, %hi(pra_02_ItemChoice_SelectedItemID)
/* D51178 80241188 0C0B2026 */  jal       evt_set_variable
/* D5117C 8024118C 8CC62AD0 */   lw       $a2, %lo(pra_02_ItemChoice_SelectedItemID)($a2)
