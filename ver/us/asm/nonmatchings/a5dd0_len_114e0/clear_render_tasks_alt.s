...
/* B3FDC 8011D8DC 3C02802C */  lui       $v0, %hi(mdl_renderTasks2)
/* B3FE0 8011D8E0 24429E00 */  addiu     $v0, $v0, %lo(mdl_renderTasks2)
.L8011D8E4:
...
/* B3FF8 8011D8F8 3C018015 */  lui       $at, %hi(mdl_renderTaskMode)
/* B3FFC 8011D8FC AC2033AC */  sw        $zero, %lo(mdl_renderTaskMode)($at)
/* B4000 8011D900 3C018015 */  lui       $at, %hi(mdl_renderTaskCount)
/* B4004 8011D904 AC2033B0 */  sw        $zero, %lo(mdl_renderTaskCount)($at)
