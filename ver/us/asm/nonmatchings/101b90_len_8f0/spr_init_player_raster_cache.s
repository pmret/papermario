...
/* 101E64 802DED74 3C040194 */  lui       $a0, %hi(_1943000_ROM_START + 0x10)
/* 101E68 802DED78 34843010 */  addiu     $a0, $a0, %lo(_1943000_ROM_START + 0x10)
/* 101E6C 802DED7C AFB00010 */  sw        $s0, 0x10($sp)
/* 101E70 802DED80 3C10802E */  lui       $s0, %hi(SpriteDataHeader)
/* 101E74 802DED84 26100C60 */  addiu     $s0, $s0, %lo(SpriteDataHeader)
...
/* 101EA4 802DEDB4 AC310C58 */  sw        $s1, %lo(PlayerRasterCacheSize)($at)
/* 101EA8 802DEDB8 3C11802E */  lui       $s1, %hi(PlayerRasterMaxSize)
/* 101EAC 802DEDBC 26310C5C */  addiu     $s1, $s1, %lo(PlayerRasterMaxSize)
...
/* 101EE8 802DEDF8 3C03802E */  lui       $v1, %hi(PlayerRasterCache)
/* 101EEC 802DEDFC 24630C70 */  addiu     $v1, $v1, %lo(PlayerRasterCache)
...
/* 101F1C 802DEE2C 3C02802E */  lui       $v0, %hi(PlayerRasterBufferSetOffsets+0x30)
/* 101F20 802DEE30 24420080 */  addiu     $v0, $v0, %lo(PlayerRasterBufferSetOffsets+0x30)
.L802DEE34:
...
/* 101F34 802DEE44 3C11802E */  lui       $s1, %hi(PlayerRasterHeader)
/* 101F38 802DEE48 26310C10 */  addiu     $s1, $s1, %lo(PlayerRasterHeader)
/* 101F3C 802DEE4C 0220282D */  daddu     $a1, $s1, $zero
/* 101F40 802DEE50 3C10802E */  lui       $s0, %hi(SpriteDataHeader)
/* 101F44 802DEE54 26100C60 */  addiu     $s0, $s0, %lo(SpriteDataHeader)
/* 101F48 802DEE58 8E040000 */  lw        $a0, ($s0)
/* 101F4C 802DEE5C 3C01802E */  lui       $at, %hi(PlayerRasterSetsLoaded)
/* 101F50 802DEE60 AC20004C */  sw        $zero, %lo(PlayerRasterSetsLoaded)($at)
