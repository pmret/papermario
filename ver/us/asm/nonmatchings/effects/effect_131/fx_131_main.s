...
/* 40C5D0 E0122030 3C02E012 */  lui       $v0, %hi(fx_131_init)
/* 40C5D4 E0122034 24422174 */  addiu     $v0, $v0, %lo(fx_131_init)
/* 40C5D8 E0122038 AFA20018 */  sw        $v0, 0x18($sp)
/* 40C5DC E012203C 3C02E012 */  lui       $v0, %hi(fx_131_update)
/* 40C5E0 E0122040 2442217C */  addiu     $v0, $v0, %lo(fx_131_update)
/* 40C5E4 E0122044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 40C5E8 E0122048 3C02E012 */  lui       $v0, %hi(fx_131_render)
/* 40C5EC E012204C 244226C4 */  addiu     $v0, $v0, %lo(fx_131_render)
