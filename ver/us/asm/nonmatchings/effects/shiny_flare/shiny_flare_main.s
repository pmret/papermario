...
/* 3D7268 E00DA028 3C02E00E */  lui       $v0, %hi(shiny_flare_init)
/* 3D726C E00DA02C 2442A0FC */  addiu     $v0, $v0, %lo(shiny_flare_init)
/* 3D7270 E00DA030 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D7274 E00DA034 3C02E00E */  lui       $v0, %hi(shiny_flare_update)
/* 3D7278 E00DA038 2442A104 */  addiu     $v0, $v0, %lo(shiny_flare_update)
/* 3D727C E00DA03C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D7280 E00DA040 3C02E00E */  lui       $v0, %hi(shiny_flare_render)
/* 3D7284 E00DA044 2442A1E0 */  addiu     $v0, $v0, %lo(shiny_flare_render)
