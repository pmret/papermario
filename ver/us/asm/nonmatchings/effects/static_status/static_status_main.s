...
/* 3E0968 E00E6038 3C02E00E */  lui       $v0, %hi(static_status_init)
/* 3E096C E00E603C 2442617C */  addiu     $v0, $v0, %lo(static_status_init)
/* 3E0970 E00E6040 AFA20018 */  sw        $v0, 0x18($sp)
/* 3E0974 E00E6044 3C02E00E */  lui       $v0, %hi(static_status_update)
/* 3E0978 E00E6048 24426184 */  addiu     $v0, $v0, %lo(static_status_update)
/* 3E097C E00E604C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3E0980 E00E6050 3C02E00E */  lui       $v0, %hi(static_status_render)
/* 3E0984 E00E6054 244264D4 */  addiu     $v0, $v0, %lo(static_status_render)
