...
/* 34DE44 E0038124 3C02E004 */  lui       $v0, %hi(spiky_white_aura_init)
/* 34DE48 E0038128 2442841C */  addiu     $v0, $v0, %lo(spiky_white_aura_init)
/* 34DE4C E003812C AC820008 */  sw        $v0, 8($a0)
/* 34DE50 E0038130 4600D682 */  mul.s     $f26, $f26, $f0
/* 34DE54 E0038134 00000000 */  nop
/* 34DE58 E0038138 3C02E004 */  lui       $v0, %hi(spiky_white_aura_update)
/* 34DE5C E003813C 24428424 */  addiu     $v0, $v0, %lo(spiky_white_aura_update)
/* 34DE60 E0038140 AC82000C */  sw        $v0, 0xc($a0)
/* 34DE64 E0038144 3C02E004 */  lui       $v0, %hi(spiky_white_aura_render)
/* 34DE68 E0038148 24428704 */  addiu     $v0, $v0, %lo(spiky_white_aura_render)
