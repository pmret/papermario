...
/* 35BA00 E004E030 3C02E005 */  lui       $v0, %hi(fx_39_init)
/* 35BA04 E004E034 2442E15C */  addiu     $v0, $v0, %lo(fx_39_init)
/* 35BA08 E004E038 AFA20018 */  sw        $v0, 0x18($sp)
/* 35BA0C E004E03C 3C02E005 */  lui       $v0, %hi(fx_39_update)
/* 35BA10 E004E040 2442E164 */  addiu     $v0, $v0, %lo(fx_39_update)
/* 35BA14 E004E044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 35BA18 E004E048 3C02E005 */  lui       $v0, %hi(fx_39_render)
/* 35BA1C E004E04C 2442E1D0 */  addiu     $v0, $v0, %lo(fx_39_render)
