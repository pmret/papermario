...
glabel fire_flower_attacking_main
...
/* 37F748 E007E028 3C02E008 */  lui       $v0, %hi(fire_flower_attacking_init)
/* 37F74C E007E02C 2442E1FC */  addiu     $v0, $v0, %lo(fire_flower_attacking_init)
/* 37F750 E007E030 AFA20018 */  sw        $v0, 0x18($sp)
/* 37F754 E007E034 3C02E008 */  lui       $v0, %hi(fire_flower_attacking_update)
/* 37F758 E007E038 2442E204 */  addiu     $v0, $v0, %lo(fire_flower_attacking_update)
/* 37F75C E007E03C AFA2001C */  sw        $v0, 0x1c($sp)
/* 37F760 E007E040 3C02E008 */  lui       $v0, %hi(fire_flower_attacking_render)
/* 37F764 E007E044 2442E508 */  addiu     $v0, $v0, %lo(fire_flower_attacking_render)
