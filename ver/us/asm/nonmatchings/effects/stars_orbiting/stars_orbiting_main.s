...
/* 3625F0 E005E030 3C02E006 */  lui       $v0, %hi(stars_orbiting_init)
/* 3625F4 E005E034 2442E1B0 */  addiu     $v0, $v0, %lo(stars_orbiting_init)
/* 3625F8 E005E038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3625FC E005E03C 3C02E006 */  lui       $v0, %hi(stars_orbiting_update)
/* 362600 E005E040 2442E1B8 */  addiu     $v0, $v0, %lo(stars_orbiting_update)
/* 362604 E005E044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 362608 E005E048 3C02E006 */  lui       $v0, %hi(stars_orbiting_render)
/* 36260C E005E04C 2442E310 */  addiu     $v0, $v0, %lo(stars_orbiting_render)
