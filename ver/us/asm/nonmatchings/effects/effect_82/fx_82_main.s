...
/* 3A3818 E00A4038 3C02E00A */  lui       $v0, %hi(fx_82_init)
/* 3A381C E00A403C 244241A4 */  addiu     $v0, $v0, %lo(fx_82_init)
/* 3A3820 E00A4040 AFA20018 */  sw        $v0, 0x18($sp)
/* 3A3824 E00A4044 3C02E00A */  lui       $v0, %hi(fx_82_update)
/* 3A3828 E00A4048 244241AC */  addiu     $v0, $v0, %lo(fx_82_update)
/* 3A382C E00A404C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3A3830 E00A4050 3C02E00A */  lui       $v0, %hi(fx_82_render)
/* 3A3834 E00A4054 244245DC */  addiu     $v0, $v0, %lo(fx_82_render)
