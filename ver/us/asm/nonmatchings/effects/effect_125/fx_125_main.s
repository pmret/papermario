...
/* 402678 E0116038 3C02E011 */  lui       $v0, %hi(fx_125_init)
/* 40267C E011603C 24426184 */  addiu     $v0, $v0, %lo(fx_125_init)
/* 402680 E0116040 AFA20018 */  sw        $v0, 0x18($sp)
/* 402684 E0116044 3C02E011 */  lui       $v0, %hi(fx_125_update)
/* 402688 E0116048 2442618C */  addiu     $v0, $v0, %lo(fx_125_update)
/* 40268C E011604C AFA2001C */  sw        $v0, 0x1c($sp)
/* 402690 E0116050 3C02E011 */  lui       $v0, %hi(fx_125_render)
/* 402694 E0116054 244266A0 */  addiu     $v0, $v0, %lo(fx_125_render)
