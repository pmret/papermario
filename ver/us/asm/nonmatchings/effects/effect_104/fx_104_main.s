...
/* 3D3E74 E00D0054 3C02E00D */  lui       $v0, %hi(fx_104_init)
/* 3D3E78 E00D0058 2442018C */  addiu     $v0, $v0, %lo(fx_104_init)
/* 3D3E7C E00D005C AFA00010 */  sw        $zero, 0x10($sp)
/* 3D3E80 E00D0060 AC820008 */  sw        $v0, 8($a0)
/* 3D3E84 E00D0064 3C02E00D */  lui       $v0, %hi(fx_104_update)
/* 3D3E88 E00D0068 24420194 */  addiu     $v0, $v0, %lo(fx_104_update)
/* 3D3E8C E00D006C AC82000C */  sw        $v0, 0xc($a0)
/* 3D3E90 E00D0070 3C02E00D */  lui       $v0, %hi(fx_104_render)
/* 3D3E94 E00D0074 24420448 */  addiu     $v0, $v0, %lo(fx_104_render)
