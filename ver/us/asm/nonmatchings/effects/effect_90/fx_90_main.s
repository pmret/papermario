...
/* 3B5D20 E00B4030 3C02E00B */  lui       $v0, %hi(fx_90_init)
/* 3B5D24 E00B4034 24424134 */  addiu     $v0, $v0, %lo(fx_90_init)
/* 3B5D28 E00B4038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3B5D2C E00B403C 3C02E00B */  lui       $v0, %hi(fx_90_update)
/* 3B5D30 E00B4040 2442413C */  addiu     $v0, $v0, %lo(fx_90_update)
/* 3B5D34 E00B4044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3B5D38 E00B4048 3C02E00B */  lui       $v0, %hi(fx_90_render)
/* 3B5D3C E00B404C 2442452C */  addiu     $v0, $v0, %lo(fx_90_render)
