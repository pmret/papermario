...
/* 3727E0 E006E050 3C02E007 */  lui       $v0, %hi(fx_55_init)
/* 3727E4 E006E054 2442E354 */  addiu     $v0, $v0, %lo(fx_55_init)
/* 3727E8 E006E058 AFA20018 */  sw        $v0, 0x18($sp)
/* 3727EC E006E05C 3C02E007 */  lui       $v0, %hi(fx_55_update)
/* 3727F0 E006E060 2442E35C */  addiu     $v0, $v0, %lo(fx_55_update)
/* 3727F4 E006E064 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3727F8 E006E068 3C02E007 */  lui       $v0, %hi(fx_55_render)
/* 3727FC E006E06C 2442E6E4 */  addiu     $v0, $v0, %lo(fx_55_render)
