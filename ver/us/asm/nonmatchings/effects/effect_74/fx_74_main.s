...
/* 3928F8 E0094028 3C02E009 */  lui       $v0, %hi(fx_74_init)
/* 3928FC E009402C 24424190 */  addiu     $v0, $v0, %lo(fx_74_init)
/* 392900 E0094030 AFA20018 */  sw        $v0, 0x18($sp)
/* 392904 E0094034 3C02E009 */  lui       $v0, %hi(fx_74_update)
/* 392908 E0094038 24424198 */  addiu     $v0, $v0, %lo(fx_74_update)
/* 39290C E009403C AFA2001C */  sw        $v0, 0x1c($sp)
/* 392910 E0094040 3C02E009 */  lui       $v0, %hi(fx_74_render)
/* 392914 E0094044 244242C0 */  addiu     $v0, $v0, %lo(fx_74_render)
