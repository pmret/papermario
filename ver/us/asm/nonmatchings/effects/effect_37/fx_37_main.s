...
.LE004A0D4:
/* 358594 E004A0D4 3C02E005 */  lui       $v0, %hi(fx_37_init)
/* 358598 E004A0D8 2442A328 */  addiu     $v0, $v0, %lo(fx_37_init)
/* 35859C E004A0DC AC820008 */  sw        $v0, 8($a0)
/* 3585A0 E004A0E0 3C02E005 */  lui       $v0, %hi(fx_37_update)
/* 3585A4 E004A0E4 2442A330 */  addiu     $v0, $v0, %lo(fx_37_update)
/* 3585A8 E004A0E8 AC82000C */  sw        $v0, 0xc($a0)
/* 3585AC E004A0EC 3C02E005 */  lui       $v0, %hi(fx_37_render)
/* 3585B0 E004A0F0 2442A748 */  addiu     $v0, $v0, %lo(fx_37_render)
