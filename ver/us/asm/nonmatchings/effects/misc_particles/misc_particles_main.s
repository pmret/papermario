...
/* 3DE038 E00E4038 3C02E00E */  lui       $v0, %hi(misc_particles_init)
/* 3DE03C E00E403C 24424288 */  addiu     $v0, $v0, %lo(misc_particles_init)
/* 3DE040 E00E4040 AFA20018 */  sw        $v0, 0x18($sp)
/* 3DE044 E00E4044 3C02E00E */  lui       $v0, %hi(misc_particles_update)
/* 3DE048 E00E4048 24424290 */  addiu     $v0, $v0, %lo(misc_particles_update)
/* 3DE04C E00E404C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3DE050 E00E4050 3C02E00E */  lui       $v0, %hi(misc_particles_render)
/* 3DE054 E00E4054 2442490C */  addiu     $v0, $v0, %lo(misc_particles_render)
