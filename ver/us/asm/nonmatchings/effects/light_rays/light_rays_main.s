...
.LE006A248:
/* 36D268 E006A248 3C02E007 */  lui       $v0, %hi(light_rays_init)
/* 36D26C E006A24C 2442A45C */  addiu     $v0, $v0, %lo(light_rays_init)
/* 36D270 E006A250 AFA20018 */  sw        $v0, 0x18($sp)
/* 36D274 E006A254 3C02E007 */  lui       $v0, %hi(light_rays_update)
/* 36D278 E006A258 2442A580 */  addiu     $v0, $v0, %lo(light_rays_update)
/* 36D27C E006A25C AFA2001C */  sw        $v0, 0x1c($sp)
/* 36D280 E006A260 3C02E007 */  lui       $v0, %hi(light_rays_render)
/* 36D284 E006A264 2442A814 */  addiu     $v0, $v0, %lo(light_rays_render)
