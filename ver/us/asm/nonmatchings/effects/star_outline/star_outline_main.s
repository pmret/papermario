...
/* 413390 E0126030 3C02E012 */  lui       $v0, %hi(star_outline_init)
/* 413394 E0126034 2442612C */  addiu     $v0, $v0, %lo(star_outline_init)
/* 413398 E0126038 AFA20018 */  sw        $v0, 0x18($sp)
/* 41339C E012603C 3C02E012 */  lui       $v0, %hi(star_outline_update)
/* 4133A0 E0126040 24426134 */  addiu     $v0, $v0, %lo(star_outline_update)
/* 4133A4 E0126044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 4133A8 E0126048 3C02E012 */  lui       $v0, %hi(star_outline_render)
/* 4133AC E012604C 244264A4 */  addiu     $v0, $v0, %lo(star_outline_render)
