...
/* 363188 E0060028 3C02E006 */  lui       $v0, %hi(big_snowflakes_init)
/* 36318C E006002C 244201D8 */  addiu     $v0, $v0, %lo(big_snowflakes_init)
/* 363190 E0060030 AFA20018 */  sw        $v0, 0x18($sp)
/* 363194 E0060034 3C02E006 */  lui       $v0, %hi(big_snowflakes_update)
/* 363198 E0060038 244201E0 */  addiu     $v0, $v0, %lo(big_snowflakes_update)
/* 36319C E006003C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3631A0 E0060040 3C02E006 */  lui       $v0, %hi(big_snowflakes_render)
/* 3631A4 E0060044 2442040C */  addiu     $v0, $v0, %lo(big_snowflakes_render)
