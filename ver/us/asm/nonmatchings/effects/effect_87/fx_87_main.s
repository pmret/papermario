...
/* 3B2380 E00AE030 3C02E00B */  lui       $v0, %hi(fx_87_init)
/* 3B2384 E00AE034 2442E1AC */  addiu     $v0, $v0, %lo(fx_87_init)
/* 3B2388 E00AE038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3B238C E00AE03C 3C02E00B */  lui       $v0, %hi(fx_87_update)
/* 3B2390 E00AE040 2442E1B4 */  addiu     $v0, $v0, %lo(fx_87_update)
/* 3B2394 E00AE044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3B2398 E00AE048 3C02E00B */  lui       $v0, %hi(fx_87_render)
/* 3B239C E00AE04C 2442E4FC */  addiu     $v0, $v0, %lo(fx_87_render)
