...
/* 3D5084 E00D6064 3C02E00D */  lui       $v0, %hi(fx_107_init)
/* 3D5088 E00D6068 24426718 */  addiu     $v0, $v0, %lo(fx_107_init)
/* 3D508C E00D606C AFA20018 */  sw        $v0, 0x18($sp)
/* 3D5090 E00D6070 3C02E00D */  lui       $v0, %hi(fx_107_update)
/* 3D5094 E00D6074 24426720 */  addiu     $v0, $v0, %lo(fx_107_update)
/* 3D5098 E00D6078 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D509C E00D607C 3C02E00D */  lui       $v0, %hi(fx_107_render)
/* 3D50A0 E00D6080 2442693C */  addiu     $v0, $v0, %lo(fx_107_render)
