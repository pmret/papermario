...
/* 354F90 E0044030 3C02E004 */  lui       $v0, %hi(fx_34_init)
/* 354F94 E0044034 2442441C */  addiu     $v0, $v0, %lo(fx_34_init)
/* 354F98 E0044038 AFA20018 */  sw        $v0, 0x18($sp)
/* 354F9C E004403C 3C02E004 */  lui       $v0, %hi(fx_34_update)
/* 354FA0 E0044040 24424424 */  addiu     $v0, $v0, %lo(fx_34_update)
/* 354FA4 E0044044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 354FA8 E0044048 3C02E004 */  lui       $v0, %hi(fx_34_render)
/* 354FAC E004404C 244248E4 */  addiu     $v0, $v0, %lo(fx_34_render)
