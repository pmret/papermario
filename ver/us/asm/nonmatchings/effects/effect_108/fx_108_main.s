...
/* 3D67F0 E00D8030 3C02E00E */  lui       $v0, %hi(fx_108_init)
/* 3D67F4 E00D8034 24428120 */  addiu     $v0, $v0, %lo(fx_108_init)
/* 3D67F8 E00D8038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D67FC E00D803C 3C02E00E */  lui       $v0, %hi(fx_108_update)
/* 3D6800 E00D8040 24428128 */  addiu     $v0, $v0, %lo(fx_108_update)
/* 3D6804 E00D8044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D6808 E00D8048 3C02E00E */  lui       $v0, %hi(fx_108_render)
/* 3D680C E00D804C 2442825C */  addiu     $v0, $v0, %lo(fx_108_render)
