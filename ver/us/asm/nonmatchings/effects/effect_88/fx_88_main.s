...
/* 3B3EE0 E00B0030 3C02E00B */  lui       $v0, %hi(fx_88_init)
/* 3B3EE4 E00B0034 2442011C */  addiu     $v0, $v0, %lo(fx_88_init)
/* 3B3EE8 E00B0038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3B3EEC E00B003C 3C02E00B */  lui       $v0, %hi(fx_88_update)
/* 3B3EF0 E00B0040 24420124 */  addiu     $v0, $v0, %lo(fx_88_update)
/* 3B3EF4 E00B0044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3B3EF8 E00B0048 3C02E00B */  lui       $v0, %hi(fx_88_render)
/* 3B3EFC E00B004C 244201F8 */  addiu     $v0, $v0, %lo(fx_88_render)
