...
/* 398218 E009C028 3C02E00A */  lui       $v0, %hi(quizmo_stage_init)
/* 39821C E009C02C 2442C100 */  addiu     $v0, $v0, %lo(quizmo_stage_init)
/* 398220 E009C030 AFA20018 */  sw        $v0, 0x18($sp)
/* 398224 E009C034 3C02E00A */  lui       $v0, %hi(quizmo_stage_update)
/* 398228 E009C038 2442C108 */  addiu     $v0, $v0, %lo(quizmo_stage_update)
/* 39822C E009C03C AFA2001C */  sw        $v0, 0x1c($sp)
/* 398230 E009C040 3C02E00A */  lui       $v0, %hi(quizmo_stage_render)
/* 398234 E009C044 2442C1DC */  addiu     $v0, $v0, %lo(quizmo_stage_render)
