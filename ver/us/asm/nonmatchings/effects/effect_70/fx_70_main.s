...
/* 38DE1C E008C01C 3C02E009 */  lui       $v0, %hi(fx_70_init)
/* 38DE20 E008C020 2442C3F4 */  addiu     $v0, $v0, %lo(fx_70_init)
/* 38DE24 E008C024 AFA20018 */  sw        $v0, 0x18($sp)
/* 38DE28 E008C028 3C02E009 */  lui       $v0, %hi(fx_70_update)
/* 38DE2C E008C02C 2442C3FC */  addiu     $v0, $v0, %lo(fx_70_update)
/* 38DE30 E008C030 AFA2001C */  sw        $v0, 0x1c($sp)
/* 38DE34 E008C034 3C02E009 */  lui       $v0, %hi(fx_70_render)
/* 38DE38 E008C038 2442C6B8 */  addiu     $v0, $v0, %lo(fx_70_render)
