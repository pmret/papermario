...
/* 3AA948 E00AA028 3C02E00B */  lui       $v0, %hi(butterflies_init)
/* 3AA94C E00AA02C 2442A104 */  addiu     $v0, $v0, %lo(butterflies_init)
/* 3AA950 E00AA030 AFA20018 */  sw        $v0, 0x18($sp)
/* 3AA954 E00AA034 3C02E00B */  lui       $v0, %hi(butterflies_update)
/* 3AA958 E00AA038 2442A10C */  addiu     $v0, $v0, %lo(butterflies_update)
/* 3AA95C E00AA03C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3AA960 E00AA040 3C02E00B */  lui       $v0, %hi(butterflies_render)
/* 3AA964 E00AA044 2442A3C0 */  addiu     $v0, $v0, %lo(butterflies_render)
