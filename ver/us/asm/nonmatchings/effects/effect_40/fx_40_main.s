...
/* 35C000 E0050030 3C02E005 */  lui       $v0, %hi(fx_40_init)
/* 35C004 E0050034 244201D0 */  addiu     $v0, $v0, %lo(fx_40_init)
/* 35C008 E0050038 AFA20020 */  sw        $v0, 0x20($sp)
/* 35C00C E005003C 3C02E005 */  lui       $v0, %hi(fx_40_update)
/* 35C010 E0050040 244201D8 */  addiu     $v0, $v0, %lo(fx_40_update)
/* 35C014 E0050044 AFA20024 */  sw        $v0, 0x24($sp)
/* 35C018 E0050048 3C02E005 */  lui       $v0, %hi(fx_40_render)
/* 35C01C E005004C 244202C4 */  addiu     $v0, $v0, %lo(fx_40_render)
