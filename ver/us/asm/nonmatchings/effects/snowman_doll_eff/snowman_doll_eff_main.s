...
/* 3BCD90 E00C0030 3C02E00C */  lui       $v0, %hi(snowman_doll_eff_init)
/* 3BCD94 E00C0034 24420158 */  addiu     $v0, $v0, %lo(snowman_doll_eff_init)
/* 3BCD98 E00C0038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3BCD9C E00C003C 3C02E00C */  lui       $v0, %hi(snowman_doll_eff_update)
/* 3BCDA0 E00C0040 24420160 */  addiu     $v0, $v0, %lo(snowman_doll_eff_update)
/* 3BCDA4 E00C0044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3BCDA8 E00C0048 3C02E00C */  lui       $v0, %hi(snowman_doll_eff_render)
/* 3BCDAC E00C004C 24420710 */  addiu     $v0, $v0, %lo(snowman_doll_eff_render)
