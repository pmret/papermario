...
/* 3E43D0 E010A030 3C02E011 */  lui       $v0, %hi(fx_119_init)
/* 3E43D4 E010A034 2442A184 */  addiu     $v0, $v0, %lo(fx_119_init)
/* 3E43D8 E010A038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3E43DC E010A03C 3C02E011 */  lui       $v0, %hi(fx_119_update)
/* 3E43E0 E010A040 2442A18C */  addiu     $v0, $v0, %lo(fx_119_update)
/* 3E43E4 E010A044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3E43E8 E010A048 3C02E011 */  lui       $v0, %hi(fx_119_render)
/* 3E43EC E010A04C 2442A4A0 */  addiu     $v0, $v0, %lo(fx_119_render)
