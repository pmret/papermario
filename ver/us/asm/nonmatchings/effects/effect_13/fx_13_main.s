...
/* 32FE60 E001A030 3C02E002 */  lui       $v0, %hi(fx_13_init)
/* 32FE64 E001A034 2442A21C */  addiu     $v0, $v0, %lo(fx_13_init)
/* 32FE68 E001A038 AFA20018 */  sw        $v0, 0x18($sp)
/* 32FE6C E001A03C 3C02E002 */  lui       $v0, %hi(fx_13_update)
/* 32FE70 E001A040 2442A224 */  addiu     $v0, $v0, %lo(fx_13_update)
/* 32FE74 E001A044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 32FE78 E001A048 3C02E002 */  lui       $v0, %hi(fx_13_render)
/* 32FE7C E001A04C 2442A3FC */  addiu     $v0, $v0, %lo(fx_13_render)
