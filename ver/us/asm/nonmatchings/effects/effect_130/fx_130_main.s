...
/* 40B420 E0120030 3C02E012 */  lui       $v0, %hi(fx_130_init)
/* 40B424 E0120034 24420134 */  addiu     $v0, $v0, %lo(fx_130_init)
/* 40B428 E0120038 AFA20018 */  sw        $v0, 0x18($sp)
/* 40B42C E012003C 3C02E012 */  lui       $v0, %hi(fx_130_update)
/* 40B430 E0120040 2442013C */  addiu     $v0, $v0, %lo(fx_130_update)
/* 40B434 E0120044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 40B438 E0120048 3C02E012 */  lui       $v0, %hi(fx_130_render)
/* 40B43C E012004C 2442039C */  addiu     $v0, $v0, %lo(fx_130_render)
