...
/* 3DC340 E00E2030 3C02E00E */  lui       $v0, %hi(fx_113_init)
/* 3DC344 E00E2034 2442212C */  addiu     $v0, $v0, %lo(fx_113_init)
/* 3DC348 E00E2038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3DC34C E00E203C 3C02E00E */  lui       $v0, %hi(fx_113_update)
/* 3DC350 E00E2040 24422134 */  addiu     $v0, $v0, %lo(fx_113_update)
/* 3DC354 E00E2044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3DC358 E00E2048 3C02E00E */  lui       $v0, %hi(fx_113_render)
/* 3DC35C E00E204C 244221C8 */  addiu     $v0, $v0, %lo(fx_113_render)
