...
/* 34F520 E003C060 3C02E004 */  lui       $v0, %hi(damage_indicator_init)
/* 34F524 E003C064 2442C23C */  addiu     $v0, $v0, %lo(damage_indicator_init)
/* 34F528 E003C068 AFA20018 */  sw        $v0, 0x18($sp)
/* 34F52C E003C06C 3C02E004 */  lui       $v0, %hi(damage_indicator_update)
/* 34F530 E003C070 2442C244 */  addiu     $v0, $v0, %lo(damage_indicator_update)
/* 34F534 E003C074 AFA2001C */  sw        $v0, 0x1c($sp)
/* 34F538 E003C078 3C02E004 */  lui       $v0, %hi(damage_indicator_render)
/* 34F53C E003C07C 2442C474 */  addiu     $v0, $v0, %lo(damage_indicator_render)
