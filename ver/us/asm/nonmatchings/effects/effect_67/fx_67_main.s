...
/* 389884 E0086034 3C02E008 */  lui       $v0, %hi(fx_67_init)
/* 389888 E0086038 24426270 */  addiu     $v0, $v0, %lo(fx_67_init)
/* 38988C E008603C AFA20018 */  sw        $v0, 0x18($sp)
/* 389890 E0086040 3C02E008 */  lui       $v0, %hi(fx_67_update)
/* 389894 E0086044 24426278 */  addiu     $v0, $v0, %lo(fx_67_update)
/* 389898 E0086048 AFA2001C */  sw        $v0, 0x1c($sp)
/* 38989C E008604C 3C02E008 */  lui       $v0, %hi(fx_67_render)
/* 3898A0 E0086050 24426390 */  addiu     $v0, $v0, %lo(fx_67_render)
