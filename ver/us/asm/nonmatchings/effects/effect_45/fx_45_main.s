...
/* 3602F8 E005A038 3C02E006 */  lui       $v0, %hi(fx_45_init)
/* 3602FC E005A03C 2442A1F4 */  addiu     $v0, $v0, %lo(fx_45_init)
/* 360300 E005A040 AFA20018 */  sw        $v0, 0x18($sp)
/* 360304 E005A044 3C02E006 */  lui       $v0, %hi(fx_45_update)
/* 360308 E005A048 2442A1FC */  addiu     $v0, $v0, %lo(fx_45_update)
/* 36030C E005A04C AFA2001C */  sw        $v0, 0x1c($sp)
/* 360310 E005A050 3C02E006 */  lui       $v0, %hi(fx_45_render)
/* 360314 E005A054 2442A3B0 */  addiu     $v0, $v0, %lo(fx_45_render)
