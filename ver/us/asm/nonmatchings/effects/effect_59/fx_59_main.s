...
/* 3770A0 E0076030 3C02E007 */  lui       $v0, %hi(fx_59_init)
/* 3770A4 E0076034 24426370 */  addiu     $v0, $v0, %lo(fx_59_init)
/* 3770A8 E0076038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3770AC E007603C 3C02E007 */  lui       $v0, %hi(fx_59_update)
/* 3770B0 E0076040 24426378 */  addiu     $v0, $v0, %lo(fx_59_update)
/* 3770B4 E0076044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3770B8 E0076048 3C02E007 */  lui       $v0, %hi(fx_59_render)
/* 3770BC E007604C 24426808 */  addiu     $v0, $v0, %lo(fx_59_render)
