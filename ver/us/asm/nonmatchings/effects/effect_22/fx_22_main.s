...
/* 33FEA0 E002C020 3C02E003 */  lui       $v0, %hi(fx_22_init)
/* 33FEA4 E002C024 2442C234 */  addiu     $v0, $v0, %lo(fx_22_init)
/* 33FEA8 E002C028 AFA20018 */  sw        $v0, 0x18($sp)
/* 33FEAC E002C02C 3C02E003 */  lui       $v0, %hi(fx_22_update)
/* 33FEB0 E002C030 2442C23C */  addiu     $v0, $v0, %lo(fx_22_update)
/* 33FEB4 E002C034 AFA2001C */  sw        $v0, 0x1c($sp)
/* 33FEB8 E002C038 3C02E003 */  lui       $v0, %hi(fx_22_render)
/* 33FEBC E002C03C 2442C3D0 */  addiu     $v0, $v0, %lo(fx_22_render)
