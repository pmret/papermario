...
/* 36E1F8 E006C028 3C02E007 */  lui       $v0, %hi(fx_54_init)
/* 36E1FC E006C02C 2442C298 */  addiu     $v0, $v0, %lo(fx_54_init)
/* 36E200 E006C030 AFA20020 */  sw        $v0, 0x20($sp)
/* 36E204 E006C034 3C02E007 */  lui       $v0, %hi(fx_54_update)
/* 36E208 E006C038 2442C2A0 */  addiu     $v0, $v0, %lo(fx_54_update)
/* 36E20C E006C03C AFA20024 */  sw        $v0, 0x24($sp)
/* 36E210 E006C040 3C02E007 */  lui       $v0, %hi(fx_54_render)
/* 36E214 E006C044 2442C5A0 */  addiu     $v0, $v0, %lo(fx_54_render)
