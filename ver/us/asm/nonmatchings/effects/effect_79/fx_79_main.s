...
/* 39FF50 E009E030 3C02E00A */  lui       $v0, %hi(fx_79_init)
/* 39FF54 E009E034 2442E1DC */  addiu     $v0, $v0, %lo(fx_79_init)
/* 39FF58 E009E038 AFA20018 */  sw        $v0, 0x18($sp)
/* 39FF5C E009E03C 3C02E00A */  lui       $v0, %hi(fx_79_update)
/* 39FF60 E009E040 2442E1E4 */  addiu     $v0, $v0, %lo(fx_79_update)
/* 39FF64 E009E044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 39FF68 E009E048 3C02E00A */  lui       $v0, %hi(fx_79_render)
/* 39FF6C E009E04C 2442E3DC */  addiu     $v0, $v0, %lo(fx_79_render)
