...
/* 404238 E011A018 3C02E012 */  lui       $v0, %hi(fx_127_init)
/* 40423C E011A01C 2442A0FC */  addiu     $v0, $v0, %lo(fx_127_init)
/* 404240 E011A020 AFA20018 */  sw        $v0, 0x18($sp)
/* 404244 E011A024 3C02E012 */  lui       $v0, %hi(fx_127_update)
/* 404248 E011A028 2442A104 */  addiu     $v0, $v0, %lo(fx_127_update)
/* 40424C E011A02C AFA2001C */  sw        $v0, 0x1c($sp)
/* 404250 E011A030 3C02E012 */  lui       $v0, %hi(fx_127_render)
/* 404254 E011A034 2442A398 */  addiu     $v0, $v0, %lo(fx_127_render)
