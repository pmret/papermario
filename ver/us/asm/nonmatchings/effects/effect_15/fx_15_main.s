...
/* 331970 E001E030 3C02E002 */  lui       $v0, %hi(fx_15_init)
/* 331974 E001E034 2442E370 */  addiu     $v0, $v0, %lo(fx_15_init)
/* 331978 E001E038 AFA20018 */  sw        $v0, 0x18($sp)
/* 33197C E001E03C 3C02E002 */  lui       $v0, %hi(fx_15_update)
/* 331980 E001E040 2442E378 */  addiu     $v0, $v0, %lo(fx_15_update)
/* 331984 E001E044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 331988 E001E048 3C02E002 */  lui       $v0, %hi(fx_15_render)
/* 33198C E001E04C 2442E6E8 */  addiu     $v0, $v0, %lo(fx_15_render)
