...
/* 406B70 E011C030 3C02E012 */  lui       $v0, %hi(fx_128_init)
/* 406B74 E011C034 2442C0F4 */  addiu     $v0, $v0, %lo(fx_128_init)
/* 406B78 E011C038 AFA20018 */  sw        $v0, 0x18($sp)
/* 406B7C E011C03C 3C02E012 */  lui       $v0, %hi(fx_128_update)
/* 406B80 E011C040 2442C0FC */  addiu     $v0, $v0, %lo(fx_128_update)
/* 406B84 E011C044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 406B88 E011C048 3C02E012 */  lui       $v0, %hi(fx_128_render)
/* 406B8C E011C04C 2442C17C */  addiu     $v0, $v0, %lo(fx_128_render)
