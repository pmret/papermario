...
/* 3BA078 E00BC048 3C02E00C */  lui       $v0, %hi(lightning_bolt_init)
/* 3BA07C E00BC04C 2442C1D0 */  addiu     $v0, $v0, %lo(lightning_bolt_init)
/* 3BA080 E00BC050 AFA20018 */  sw        $v0, 0x18($sp)
/* 3BA084 E00BC054 3C02E00C */  lui       $v0, %hi(lightning_bolt_update)
/* 3BA088 E00BC058 2442C238 */  addiu     $v0, $v0, %lo(lightning_bolt_update)
/* 3BA08C E00BC05C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3BA090 E00BC060 3C02E00C */  lui       $v0, %hi(lightning_bolt_render)
/* 3BA094 E00BC064 2442C2E8 */  addiu     $v0, $v0, %lo(lightning_bolt_render)
