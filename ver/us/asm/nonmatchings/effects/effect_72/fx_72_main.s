...
/* 38F938 E0090038 3C02E009 */  lui       $v0, %hi(fx_72_init)
/* 38F93C E009003C 244201C0 */  addiu     $v0, $v0, %lo(fx_72_init)
/* 38F940 E0090040 AFA20018 */  sw        $v0, 0x18($sp)
/* 38F944 E0090044 3C02E009 */  lui       $v0, %hi(fx_72_update)
/* 38F948 E0090048 244201C8 */  addiu     $v0, $v0, %lo(fx_72_update)
/* 38F94C E009004C AFA2001C */  sw        $v0, 0x1c($sp)
/* 38F950 E0090050 3C02E009 */  lui       $v0, %hi(fx_72_render)
/* 38F954 E0090054 24420420 */  addiu     $v0, $v0, %lo(fx_72_render)
