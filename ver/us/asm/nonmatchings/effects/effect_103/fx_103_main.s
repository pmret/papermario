...
/* 3D2AE8 E00CE028 3C02E00D */  lui       $v0, %hi(fx_103_init)
/* 3D2AEC E00CE02C 2442E21C */  addiu     $v0, $v0, %lo(fx_103_init)
/* 3D2AF0 E00CE030 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D2AF4 E00CE034 3C02E00D */  lui       $v0, %hi(fx_103_update)
/* 3D2AF8 E00CE038 2442E224 */  addiu     $v0, $v0, %lo(fx_103_update)
/* 3D2AFC E00CE03C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D2B00 E00CE040 3C02E00D */  lui       $v0, %hi(fx_103_render)
/* 3D2B04 E00CE044 2442E428 */  addiu     $v0, $v0, %lo(fx_103_render)
