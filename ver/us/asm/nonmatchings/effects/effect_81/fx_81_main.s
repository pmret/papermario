...
/* 3A29C0 E00A2030 3C02E00A */  lui       $v0, %hi(func_E00A2118)
/* 3A29C4 E00A2034 24422118 */  addiu     $v0, $v0, %lo(func_E00A2118)
/* 3A29C8 E00A2038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3A29CC E00A203C 3C02E00A */  lui       $v0, %hi(func_E00A2120)
/* 3A29D0 E00A2040 24422120 */  addiu     $v0, $v0, %lo(func_E00A2120)
/* 3A29D4 E00A2044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3A29D8 E00A2048 3C02E00A */  lui       $v0, %hi(func_E00A21EC)
/* 3A29DC E00A204C 244221EC */  addiu     $v0, $v0, %lo(func_E00A21EC)
