...
/* 3D8754 E00DE034 2442E11C */  addiu     $v0, $v0, %lo(fx_111_init)
/* 3D8758 E00DE038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D875C E00DE03C 3C02E00E */  lui       $v0, %hi(fx_111_update)
/* 3D8760 E00DE040 2442E124 */  addiu     $v0, $v0, %lo(fx_111_update)
/* 3D8764 E00DE044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D8768 E00DE048 3C02E00E */  lui       $v0, %hi(fx_111_render)
/* 3D876C E00DE04C 2442E260 */  addiu     $v0, $v0, %lo(fx_111_render)
