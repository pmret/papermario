...
/* 37D4C0 E007C030 3C02E008 */  lui       $v0, %hi(fx_62_init)
/* 37D4C4 E007C034 2442C128 */  addiu     $v0, $v0, %lo(fx_62_init)
/* 37D4C8 E007C038 AFA20018 */  sw        $v0, 0x18($sp)
/* 37D4CC E007C03C 3C02E008 */  lui       $v0, %hi(fx_62_update)
/* 37D4D0 E007C040 2442C130 */  addiu     $v0, $v0, %lo(fx_62_update)
/* 37D4D4 E007C044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 37D4D8 E007C048 3C02E008 */  lui       $v0, %hi(fx_62_render)
/* 37D4DC E007C04C 2442C1B0 */  addiu     $v0, $v0, %lo(fx_62_render)
