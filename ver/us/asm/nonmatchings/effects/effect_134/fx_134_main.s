...
/* 414BD0 E0128030 3C02E013 */  lui       $v0, %hi(fx_134_init)
/* 414BD4 E0128034 24428128 */  addiu     $v0, $v0, %lo(fx_134_init)
/* 414BD8 E0128038 AFA20018 */  sw        $v0, 0x18($sp)
/* 414BDC E012803C 3C02E013 */  lui       $v0, %hi(fx_134_update)
/* 414BE0 E0128040 24428130 */  addiu     $v0, $v0, %lo(fx_134_update)
/* 414BE4 E0128044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 414BE8 E0128048 3C02E013 */  lui       $v0, %hi(fx_134_render)
/* 414BEC E012804C 24428198 */  addiu     $v0, $v0, %lo(fx_134_render)
...
/* 414C08 E0128068 0C080124 */  jal       shim_create_effect_instance
