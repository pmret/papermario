...
/* 388BB0 E00841E0 3C02E008 */  lui       $v0, %hi(bombette_breaking_init)
/* 388BB4 E00841E4 24424658 */  addiu     $v0, $v0, %lo(bombette_breaking_init)
/* 388BB8 E00841E8 AFA20028 */  sw        $v0, 0x28($sp)
/* 388BBC E00841EC 02530018 */  mult      $s2, $s3
/* 388BC0 E00841F0 3C02E008 */  lui       $v0, %hi(bombette_breaking_update)
/* 388BC4 E00841F4 24424660 */  addiu     $v0, $v0, %lo(bombette_breaking_update)
/* 388BC8 E00841F8 AFA2002C */  sw        $v0, 0x2c($sp)
/* 388BCC E00841FC 3C02E008 */  lui       $v0, %hi(bombette_breaking_render)
/* 388BD0 E0084200 244248E4 */  addiu     $v0, $v0, %lo(bombette_breaking_render)
