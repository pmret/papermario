...
/* 3812F0 E0080030 3C02E008 */  lui       $v0, %hi(fx_64_init)
/* 3812F4 E0080034 244201C8 */  addiu     $v0, $v0, %lo(fx_64_init)
/* 3812F8 E0080038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3812FC E008003C 3C02E008 */  lui       $v0, %hi(fx_64_update)
/* 381300 E0080040 244201D0 */  addiu     $v0, $v0, %lo(fx_64_update)
/* 381304 E0080044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 381308 E0080048 3C02E008 */  lui       $v0, %hi(fx_64_render)
/* 38130C E008004C 24420424 */  addiu     $v0, $v0, %lo(fx_64_render)
