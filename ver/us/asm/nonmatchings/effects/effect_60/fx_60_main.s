...
/* 37A418 E0078028 3C02E008 */  lui       $v0, %hi(fx_60_init)
/* 37A41C E007802C 24428124 */  addiu     $v0, $v0, %lo(fx_60_init)
/* 37A420 E0078030 AFA20018 */  sw        $v0, 0x18($sp)
/* 37A424 E0078034 3C02E008 */  lui       $v0, %hi(fx_60_update)
/* 37A428 E0078038 2442812C */  addiu     $v0, $v0, %lo(fx_60_update)
/* 37A42C E007803C AFA2001C */  sw        $v0, 0x1c($sp)
/* 37A430 E0078040 3C02E008 */  lui       $v0, %hi(fx_60_render)
/* 37A434 E0078044 24428210 */  addiu     $v0, $v0, %lo(fx_60_render)
