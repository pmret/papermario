...
/* 3965E8 E009A038 3C02E00A */  lui       $v0, %hi(fx_77_init)
/* 3965EC E009A03C 2442A138 */  addiu     $v0, $v0, %lo(fx_77_init)
/* 3965F0 E009A040 AFA20018 */  sw        $v0, 0x18($sp)
/* 3965F4 E009A044 3C02E00A */  lui       $v0, %hi(fx_77_update)
/* 3965F8 E009A048 2442A140 */  addiu     $v0, $v0, %lo(fx_77_update)
/* 3965FC E009A04C AFA2001C */  sw        $v0, 0x1c($sp)
/* 396600 E009A050 3C02E00A */  lui       $v0, %hi(fx_77_render)
/* 396604 E009A054 2442A398 */  addiu     $v0, $v0, %lo(fx_77_render)
