...
/* 3D0530 E00CA030 3C02E00D */  lui       $v0, %hi(fx_101_init)
/* 3D0534 E00CA034 2442A240 */  addiu     $v0, $v0, %lo(fx_101_init)
/* 3D0538 E00CA038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D053C E00CA03C 3C02E00D */  lui       $v0, %hi(fx_101_update)
/* 3D0540 E00CA040 2442A248 */  addiu     $v0, $v0, %lo(fx_101_update)
/* 3D0544 E00CA044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D0548 E00CA048 3C02E00D */  lui       $v0, %hi(fx_101_render)
/* 3D054C E00CA04C 2442A484 */  addiu     $v0, $v0, %lo(fx_101_render)
