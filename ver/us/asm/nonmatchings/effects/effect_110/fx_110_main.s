...
/* 3D7AA0 E00DC030 3C02E00E */  lui       $v0, %hi(fx_110_init)
/* 3D7AA4 E00DC034 2442C190 */  addiu     $v0, $v0, %lo(fx_110_init)
/* 3D7AA8 E00DC038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3D7AAC E00DC03C 3C02E00E */  lui       $v0, %hi(fx_110_update)
/* 3D7AB0 E00DC040 2442C198 */  addiu     $v0, $v0, %lo(fx_110_update)
/* 3D7AB4 E00DC044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3D7AB8 E00DC048 3C02E00E */  lui       $v0, %hi(fx_110_render)
/* 3D7ABC E00DC04C 2442C2C0 */  addiu     $v0, $v0, %lo(fx_110_render)
