...
/* 3A7118 E00A8028 3C02E00B */  lui       $v0, %hi(quizmo_audience_init)
/* 3A711C E00A802C 244280FC */  addiu     $v0, $v0, %lo(quizmo_audience_init)
/* 3A7120 E00A8030 AFA20018 */  sw        $v0, 0x18($sp)
/* 3A7124 E00A8034 3C02E00B */  lui       $v0, %hi(quizmo_audience_update)
/* 3A7128 E00A8038 24428104 */  addiu     $v0, $v0, %lo(quizmo_audience_update)
/* 3A712C E00A803C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3A7130 E00A8040 3C02E00B */  lui       $v0, %hi(quizmo_audience_render)
/* 3A7134 E00A8044 244282D4 */  addiu     $v0, $v0, %lo(quizmo_audience_render)
...
/* 3A7150 E00A8060 0C080124 */  jal       shim_create_effect_instance
