...
/* 360F70 E005C030 3C02E006 */  lui       $v0, %hi(fx_46_init)
/* 360F74 E005C034 2442C178 */  addiu     $v0, $v0, %lo(fx_46_init)
/* 360F78 E005C038 AFA20018 */  sw        $v0, 0x18($sp)
/* 360F7C E005C03C 3C02E006 */  lui       $v0, %hi(fx_46_update)
/* 360F80 E005C040 2442C180 */  addiu     $v0, $v0, %lo(fx_46_update)
/* 360F84 E005C044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 360F88 E005C048 3C02E006 */  lui       $v0, %hi(fx_46_render)
/* 360F8C E005C04C 2442C2B4 */  addiu     $v0, $v0, %lo(fx_46_render)
