...
/* 3E1F10 E00EA030 3C02E00F */  lui       $v0, %hi(fx_117_init)
/* 3E1F14 E00EA034 2442A190 */  addiu     $v0, $v0, %lo(fx_117_init)
/* 3E1F18 E00EA038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3E1F1C E00EA03C 3C02E00F */  lui       $v0, %hi(fx_117_update)
/* 3E1F20 E00EA040 2442A198 */  addiu     $v0, $v0, %lo(fx_117_update)
/* 3E1F24 E00EA044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3E1F28 E00EA048 3C02E00F */  lui       $v0, %hi(fx_117_render)
/* 3E1F2C E00EA04C 2442A520 */  addiu     $v0, $v0, %lo(fx_117_render)
