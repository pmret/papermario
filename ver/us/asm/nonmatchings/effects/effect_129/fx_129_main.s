...
/* 4099C8 E011E038 3C02E012 */  lui       $v0, %hi(fx_129_init)
/* 4099CC E011E03C 2442E18C */  addiu     $v0, $v0, %lo(fx_129_init)
/* 4099D0 E011E040 AFA20030 */  sw        $v0, 0x30($sp)
/* 4099D4 E011E044 3C02E012 */  lui       $v0, %hi(fx_129_update)
/* 4099D8 E011E048 2442E194 */  addiu     $v0, $v0, %lo(fx_129_update)
/* 4099DC E011E04C AFA20034 */  sw        $v0, 0x34($sp)
/* 4099E0 E011E050 3C02E012 */  lui       $v0, %hi(fx_129_render)
/* 4099E4 E011E054 2442E530 */  addiu     $v0, $v0, %lo(fx_129_render)
...
/* 409AD8 E011E148 0C039000 */  jal       fx_114_main
