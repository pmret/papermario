...
/* 3CAE20 E00C4030 3C02E00C */  lui       $v0, %hi(stop_watch_eff_init)
/* 3CAE24 E00C4034 24424170 */  addiu     $v0, $v0, %lo(stop_watch_eff_init)
/* 3CAE28 E00C4038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3CAE2C E00C403C 3C02E00C */  lui       $v0, %hi(stop_watch_eff_update)
/* 3CAE30 E00C4040 24424178 */  addiu     $v0, $v0, %lo(stop_watch_eff_update)
/* 3CAE34 E00C4044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3CAE38 E00C4048 3C02E00C */  lui       $v0, %hi(stop_watch_eff_render)
/* 3CAE3C E00C404C 244242C4 */  addiu     $v0, $v0, %lo(stop_watch_eff_render)
