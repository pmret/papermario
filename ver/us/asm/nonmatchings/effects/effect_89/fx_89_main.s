...
/* 3B47C0 E00B2030 3C02E00B */  lui       $v0, %hi(fx_89_init)
/* 3B47C4 E00B2034 244221DC */  addiu     $v0, $v0, %lo(fx_89_init)
/* 3B47C8 E00B2038 AFA20018 */  sw        $v0, 0x18($sp)
/* 3B47CC E00B203C 3C02E00B */  lui       $v0, %hi(fx_89_update)
/* 3B47D0 E00B2040 244221E4 */  addiu     $v0, $v0, %lo(fx_89_update)
/* 3B47D4 E00B2044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 3B47D8 E00B2048 3C02E00B */  lui       $v0, %hi(fx_89_render)
/* 3B47DC E00B204C 24422460 */  addiu     $v0, $v0, %lo(fx_89_render)
