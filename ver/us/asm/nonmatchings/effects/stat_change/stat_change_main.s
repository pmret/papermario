...
/* 3AEE48 E00AC028 3C02E00B */  lui       $v0, %hi(stat_change_init)
/* 3AEE4C E00AC02C 2442C11C */  addiu     $v0, $v0, %lo(stat_change_init)
/* 3AEE50 E00AC030 AFA20018 */  sw        $v0, 0x18($sp)
/* 3AEE54 E00AC034 3C02E00B */  lui       $v0, %hi(stat_change_update)
/* 3AEE58 E00AC038 2442C124 */  addiu     $v0, $v0, %lo(stat_change_update)
/* 3AEE5C E00AC03C AFA2001C */  sw        $v0, 0x1c($sp)
/* 3AEE60 E00AC040 3C02E00B */  lui       $v0, %hi(stat_change_render)
/* 3AEE64 E00AC044 2442C280 */  addiu     $v0, $v0, %lo(stat_change_render)
...
/* 3AEE88 E00AC068 0C080124 */  jal       shim_create_effect_instance
