...
/* 355F10 E0046030 3C02E004 */  lui       $v0, %hi(fx_35_init)
/* 355F14 E0046034 24426158 */  addiu     $v0, $v0, %lo(fx_35_init)
/* 355F18 E0046038 AFA20018 */  sw        $v0, 0x18($sp)
/* 355F1C E004603C 3C02E004 */  lui       $v0, %hi(fx_35_update)
/* 355F20 E0046040 24426160 */  addiu     $v0, $v0, %lo(fx_35_update)
/* 355F24 E0046044 AFA2001C */  sw        $v0, 0x1c($sp)
/* 355F28 E0046048 3C02E004 */  lui       $v0, %hi(fx_35_render)
/* 355F2C E004604C 2442627C */  addiu     $v0, $v0, %lo(fx_35_render)
