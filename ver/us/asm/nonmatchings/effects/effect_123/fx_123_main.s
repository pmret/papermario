...
/* 3F9E88 E0112038 3C02E011 */  lui       $v0, %hi(fx_123_init)
/* 3F9E8C E011203C 244221B8 */  addiu     $v0, $v0, %lo(fx_123_init)
/* 3F9E90 E0112040 AFA20030 */  sw        $v0, 0x30($sp)
/* 3F9E94 E0112044 3C02E011 */  lui       $v0, %hi(fx_123_update)
/* 3F9E98 E0112048 244221C0 */  addiu     $v0, $v0, %lo(fx_123_update)
/* 3F9E9C E011204C AFA20034 */  sw        $v0, 0x34($sp)
/* 3F9EA0 E0112050 3C02E011 */  lui       $v0, %hi(fx_123_render)
/* 3F9EA4 E0112054 244222E8 */  addiu     $v0, $v0, %lo(fx_123_render)
