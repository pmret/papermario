...
.LE00BE068:
/* 3BBFC8 E00BE068 3C02E00C */  lui       $v0, %hi(fx_95_init)
/* 3BBFCC E00BE06C 2442E39C */  addiu     $v0, $v0, %lo(fx_95_init)
/* 3BBFD0 E00BE070 AC820008 */  sw        $v0, 8($a0)
/* 3BBFD4 E00BE074 3C02E00C */  lui       $v0, %hi(fx_95_update)
/* 3BBFD8 E00BE078 2442E3A4 */  addiu     $v0, $v0, %lo(fx_95_update)
/* 3BBFDC E00BE07C AC82000C */  sw        $v0, 0xc($a0)
/* 3BBFE0 E00BE080 3C02E00C */  lui       $v0, %hi(fx_95_render)
/* 3BBFE4 E00BE084 2442E578 */  addiu     $v0, $v0, %lo(fx_95_render)
