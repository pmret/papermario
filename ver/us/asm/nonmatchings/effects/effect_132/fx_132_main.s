...
/* 412754 E0124024 3C02E012 */  lui       $v0, %hi(fx_132_init)
/* 412758 E0124028 244242FC */  addiu     $v0, $v0, %lo(fx_132_init)
/* 41275C E012402C AFA20018 */  sw        $v0, 0x18($sp)
/* 412760 E0124030 3C02E012 */  lui       $v0, %hi(fx_132_update)
/* 412764 E0124034 24424304 */  addiu     $v0, $v0, %lo(fx_132_update)
/* 412768 E0124038 AFA2001C */  sw        $v0, 0x1c($sp)
/* 41276C E012403C 3C02E012 */  lui       $v0, %hi(fx_132_render)
/* 412770 E0124040 2442448C */  addiu     $v0, $v0, %lo(fx_132_render)
