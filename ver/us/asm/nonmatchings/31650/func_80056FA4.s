...
/* 32534 80057134 3C018008 */  lui       $at, %hi(AlCosineBlend)
/* 32538 80057138 00220821 */  addu      $at, $at, $v0
/* 3253C 8005713C 94228E60 */  lhu       $v0, %lo(AlCosineBlend)($at)
/* 32540 80057140 00A31804 */  sllv      $v1, $v1, $a1
/* 32544 80057144 A602000C */  sh        $v0, 0xc($s0)
/* 32548 80057148 3C028008 */  lui       $v0, %hi(AlCosineBlend)
/* 3254C 8005714C 00431021 */  addu      $v0, $v0, $v1
/* 32550 80057150 94428E60 */  lhu       $v0, %lo(AlCosineBlend)($v0)
/* 32554 80057154 A602000E */  sh        $v0, 0xe($s0)
/* 32558 80057158 8E020020 */  lw        $v0, 0x20($s0)
/* 3255C 8005715C 3C048008 */  lui       $a0, %hi(AlCosineBlend)
/* 32560 80057160 24848E60 */  addiu     $a0, $a0, %lo(AlCosineBlend)
