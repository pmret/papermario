...
/* 24B8 800270B8 3C02800A */  lui       $v0, %hi(gOverrideFlags)
/* 24BC 800270BC 2442A650 */  addiu     $v0, $v0, %lo(gOverrideFlags)
...
/* 24E8 800270E8 3C02800A */  lui       $v0, %hi(gOverrideFlags)
/* 24EC 800270EC 2442A650 */  addiu     $v0, $v0, %lo(gOverrideFlags)
...
/* 2510 80027110 3C02800A */  lui       $v0, %hi(gOverrideFlags)
/* 2514 80027114 2442A650 */  addiu     $v0, $v0, %lo(gOverrideFlags)
...
/* 2538 80027138 3C02800A */  lui       $v0, %hi(gOverrideFlags)
/* 253C 8002713C 2442A650 */  addiu     $v0, $v0, %lo(gOverrideFlags)
...
/* 2568 80027168 3C03800A */  lui       $v1, %hi(gOverrideFlags)
/* 256C 8002716C 2463A650 */  addiu     $v1, $v1, %lo(gOverrideFlags)
