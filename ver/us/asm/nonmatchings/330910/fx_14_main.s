...
/* 330938 E001C028 3C02E002 */  lui       $v0, %hi(func_E001C120)
/* 33093C E001C02C 2442C120 */  addiu     $v0, $v0, %lo(func_E001C120)
/* 330940 E001C030 AFA20018 */  sw        $v0, 0x18($sp)
/* 330944 E001C034 3C02E002 */  lui       $v0, %hi(func_E001C128)
/* 330948 E001C038 2442C128 */  addiu     $v0, $v0, %lo(func_E001C128)
/* 33094C E001C03C AFA2001C */  sw        $v0, 0x1c($sp)
/* 330950 E001C040 3C02E002 */  lui       $v0, %hi(func_E001C200)
/* 330954 E001C044 2442C200 */  addiu     $v0, $v0, %lo(func_E001C200)
