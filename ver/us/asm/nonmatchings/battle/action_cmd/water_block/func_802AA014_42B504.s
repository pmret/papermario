...
/* 42B524 802AA034 0C0511EA */  jal       draw_hud_element_clipped
/* 42B528 802AA038 8E040008 */   lw       $a0, 8($s0)
/* 42B52C 802AA03C 0C0511EA */  jal       draw_hud_element_clipped
/* 42B530 802AA040 8E04000C */   lw       $a0, 0xc($s0)
/* 42B534 802AA044 0C0511EA */  jal       draw_hud_element_clipped
/* 42B538 802AA048 8E040010 */   lw       $a0, 0x10($s0)
/* 42B53C 802AA04C 0C0511EA */  jal       draw_hud_element_clipped
/* 42B540 802AA050 8E040014 */   lw       $a0, 0x14($s0)
/* 42B544 802AA054 0C0511EA */  jal       draw_hud_element_clipped
/* 42B548 802AA058 8E04001C */   lw       $a0, 0x1c($s0)
/* 42B54C 802AA05C 0C0511EA */  jal       draw_hud_element_clipped
/* 42B550 802AA060 8E040020 */   lw       $a0, 0x20($s0)
/* 42B554 802AA064 0C0511EA */  jal       draw_hud_element_clipped
/* 42B558 802AA068 8E040024 */   lw       $a0, 0x24($s0)
/* 42B55C 802AA06C 0C0511EA */  jal       draw_hud_element_clipped
/* 42B560 802AA070 8E040038 */   lw       $a0, 0x38($s0)
/* 42B564 802AA074 8E11002C */  lw        $s1, 0x2c($s0)
/* 42B568 802AA078 0C05122C */  jal       get_hud_element_script
...
/* 42B590 802AA0A0 0C0511FF */  jal       set_hud_element_script
/* 42B594 802AA0A4 0220202D */   daddu    $a0, $s1, $zero
.L802AA0A8:
/* 42B598 802AA0A8 0C0511EA */  jal       draw_hud_element_clipped
/* 42B59C 802AA0AC 0220202D */   daddu    $a0, $s1, $zero
/* 42B5A0 802AA0B0 8E040030 */  lw        $a0, 0x30($s0)
/* 42B5A4 802AA0B4 0C0511EA */  jal       draw_hud_element_clipped
/* 42B5A8 802AA0B8 00000000 */   nop
/* 42B5AC 802AA0BC 0C0511EA */  jal       draw_hud_element_clipped
