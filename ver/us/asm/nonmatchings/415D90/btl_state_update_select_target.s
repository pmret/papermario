...
glabel btl_state_update_select_target
/* 41F418 802AA688 27BDFFD0 */  addiu     $sp, $sp, -0x30
/* 41F41C 802AA68C AFB40020 */  sw        $s4, 0x20($sp)
/* 41F420 802AA690 3C14800E */  lui       $s4, %hi(gBattleStatus)
/* 41F424 802AA694 2694C070 */  addiu     $s4, $s4, %lo(gBattleStatus)
...
/* 41F4C8 802AA738 3C01802B */  lui       $at, %hi(D_802ACC64)
/* 41F4CC 802AA73C AC22CC64 */  sw        $v0, %lo(D_802ACC64)($at)
/* 41F4D0 802AA740 2402FF9C */  addiu     $v0, $zero, -0x64
/* 41F4D4 802AA744 3C10800E */  lui       $s0, %hi(gBattleStatus)
/* 41F4D8 802AA748 2610C070 */  addiu     $s0, $s0, %lo(gBattleStatus)
/* 41F4DC 802AA74C 3C01802B */  lui       $at, %hi(D_802ACC68)
/* 41F4E0 802AA750 AC22CC68 */  sw        $v0, %lo(D_802ACC68)($at)
...
/* 41F5C4 802AA834 3C04800E */  lui       $a0, %hi(gBattleStatus)
/* 41F5C8 802AA838 2484C070 */  addiu     $a0, $a0, %lo(gBattleStatus)
...
/* 41F61C 802AA88C 3C04800E */  lui       $a0, %hi(gBattleStatus)
/* 41F620 802AA890 2484C070 */  addiu     $a0, $a0, %lo(gBattleStatus)
...
.L802AA8BC:
/* 41F64C 802AA8BC 3C048008 */  lui       $a0, %hi(D_8007FF20)
/* 41F650 802AA8C0 2484FF20 */  addiu     $a0, $a0, %lo(D_8007FF20)
...
.L802AA910:
/* 41F6A0 802AA910 3C03802B */  lui       $v1, %hi(D_802ACC68)
/* 41F6A4 802AA914 2463CC68 */  addiu     $v1, $v1, %lo(D_802ACC68)
...
/* 41F704 802AA974 AC22CC60 */  sw        $v0, %lo(D_802ACC60)($at)
...
.L802AA998:
/* 41F728 802AA998 3C04800E */  lui       $a0, %hi(gBattleStatus)
/* 41F72C 802AA99C 2484C070 */  addiu     $a0, $a0, %lo(gBattleStatus)
...
/* 41F7C8 802AAA38 3C11802B */  lui       $s1, %hi(D_802ACC70)
/* 41F7CC 802AAA3C 8E31CC70 */  lw        $s1, %lo(D_802ACC70)($s1)
...
/* 41F7DC 802AAA4C 3C058008 */  lui       $a1, %hi(D_80080208)
/* 41F7E0 802AAA50 24A50208 */  addiu     $a1, $a1, %lo(D_80080208)
...
.L802AAA7C:
/* 41F80C 802AAA7C 3C04800E */  lui       $a0, %hi(gBattleStatus)
/* 41F810 802AAA80 2484C070 */  addiu     $a0, $a0, %lo(gBattleStatus)
...
/* 41F85C 802AAACC 3C11802B */  lui       $s1, %hi(D_802ACC70)
/* 41F860 802AAAD0 2631CC70 */  addiu     $s1, $s1, %lo(D_802ACC70)
.L802AAAD4:
...
/* 41F880 802AAAF0 3C04800E */  lui       $a0, %hi(gBattleStatus)
/* 41F884 802AAAF4 2484C070 */  addiu     $a0, $a0, %lo(gBattleStatus)
.L802AAAF8:
...
.L802AAB38:
/* 41F8C8 802AAB38 0C0A9662 */  jal       btl_state_update_player_menu
/* 41F8CC 802AAB3C 00000000 */   nop
.L802AAB40:
/* 41F8D0 802AAB40 0C090464 */  jal       btl_set_state
...
.L802AAB6C:
/* 41F8FC 802AAB6C 0C0AA82E */  jal       btl_state_update_twink_menu
/* 41F900 802AAB70 00000000 */   nop
/* 41F904 802AAB74 080AAAE1 */  j         .L802AAB84
/* 41F908 802AAB78 00000000 */   nop
.L802AAB7C:
/* 41F90C 802AAB7C 0C0AA072 */  jal       btl_state_update_partner_menu
/* 41F910 802AAB80 00000000 */   nop
.L802AAB84:
/* 41F914 802AAB84 0C090464 */  jal       btl_set_state
...
/* 41F92C 802AAB9C 3C11802B */  lui       $s1, %hi(D_802ACC70)
/* 41F930 802AABA0 2631CC70 */  addiu     $s1, $s1, %lo(D_802ACC70)
.L802AABA4:
...
/* 41F954 802AABC4 3C10800E */  lui       $s0, %hi(gBattleStatus)
/* 41F958 802AABC8 2610C070 */  addiu     $s0, $s0, %lo(gBattleStatus)
...
/* 41F988 802AABF8 0C090464 */  jal       btl_set_state
...
/* 41F9C4 802AAC34 0C090464 */  jal       btl_set_state
...
.L802AACAC:
/* 41FA3C 802AACAC 0C0AA072 */  jal       btl_state_update_partner_menu
