...
/* B4A48 8011E348 3C018015 */  lui       $at, %hi(gAnimModelFogR)
/* B4A4C 8011E34C AC223A48 */  sw        $v0, %lo(gAnimModelFogR)($at)
/* B4A50 8011E350 3C018015 */  lui       $at, %hi(gAnimModelFogG)
/* B4A54 8011E354 AC223A4C */  sw        $v0, %lo(gAnimModelFogG)($at)
/* B4A58 8011E358 3C018015 */  lui       $at, %hi(gAnimModelFogB)
/* B4A5C 8011E35C AC223A50 */  sw        $v0, %lo(gAnimModelFogB)($at)
/* B4A60 8011E360 3C018015 */  lui       $at, %hi(gAnimModelFogA)
/* B4A64 8011E364 AC223A54 */  sw        $v0, %lo(gAnimModelFogA)($at)
/* B4A68 8011E368 24020320 */  addiu     $v0, $zero, 0x320
/* B4A6C 8011E36C 3C018015 */  lui       $at, %hi(gAnimModelFogStart)
/* B4A70 8011E370 AC223A58 */  sw        $v0, %lo(gAnimModelFogStart)($at)
...
/* B4A80 8011E380 3C018015 */  lui       $at, %hi(gAnimModelFogEnabled)
/* B4A84 8011E384 AC203A44 */  sw        $zero, %lo(gAnimModelFogEnabled)($at)
/* B4A88 8011E388 3C018015 */  lui       $at, %hi(gAnimModelFogEnd)
/* B4A8C 8011E38C AC223A5C */  sw        $v0, %lo(gAnimModelFogEnd)($at)
