...
/* D238C 8013BC8C 3C068015 */  lui       $a2, %hi(sprfx_currentImage)
/* D2390 8013BC90 24C6EE10 */  addiu     $a2, $a2, %lo(sprfx_currentImage)
...
/* D23E0 8013BCE0 3C028015 */  lui       $v0, %hi(sprfx_vtxCount)
/* D23E4 8013BCE4 2442EE14 */  addiu     $v0, $v0, %lo(sprfx_vtxCount)
/* D23E8 8013BCE8 0040482D */  daddu     $t1, $v0, $zero
/* D23EC 8013BCEC 3C068015 */  lui       $a2, %hi(sprfx_vtxBuf)
/* D23F0 8013BCF0 24C66950 */  addiu     $a2, $a2, %lo(sprfx_vtxBuf)
...
.L8013C00C:
/* D270C 8013C00C 3C028015 */  lui       $v0, %hi(sprfx_vtxCount)
/* D2710 8013C010 9442EE14 */  lhu       $v0, %lo(sprfx_vtxCount)($v0)
