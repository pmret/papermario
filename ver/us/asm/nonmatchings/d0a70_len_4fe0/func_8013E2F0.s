...
/* D4B28 8013E428 3C038015 */  lui       $v1, %hi(sprfx_currentImage)
/* D4B2C 8013E42C 8C63EE10 */  lw        $v1, %lo(sprfx_currentImage)($v1)
...
/* D4C1C 8013E51C 3C068015 */  lui       $a2, %hi(sprfx_currentImage)
/* D4C20 8013E520 8CC6EE10 */  lw        $a2, %lo(sprfx_currentImage)($a2)
...
.L8013E6F8:
/* D4DF8 8013E6F8 3C028015 */  lui       $v0, %hi(sprfx_currentImage)
/* D4DFC 8013E6FC 8C42EE10 */  lw        $v0, %lo(sprfx_currentImage)($v0)
...
/* D4E60 8013E760 3C068015 */  lui       $a2, %hi(sprfx_currentImage)
/* D4E64 8013E764 8CC6EE10 */  lw        $a2, %lo(sprfx_currentImage)($a2)
