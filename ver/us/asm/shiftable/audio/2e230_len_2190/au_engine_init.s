...
/* 2E26C 80052E6C 3C028008 */  lui       $v0, %hi(gSynDriverPtr)
/* 2E270 80052E70 8C428E54 */  lw        $v0, %lo(gSynDriverPtr)($v0)
...
/* 2E2B0 80052EB0 3C12800A */  lui       $s2, %hi(gSoundGlobals)
/* 2E2B4 80052EB4 2652A5C0 */  addiu     $s2, $s2, %lo(gSoundGlobals)
...
/* 2E2CC 80052ECC 3C11800A */  lui       $s1, %hi(gBGMPlayerA)
/* 2E2D0 80052ED0 2631A664 */  addiu     $s1, $s1, %lo(gBGMPlayerA)
...
/* 2E2E4 80052EE4 3C01800A */  lui       $at, %hi(gBGMPlayerB)
/* 2E2E8 80052EE8 AC22A5FC */  sw        $v0, %lo(gBGMPlayerB)($at)
...
/* 2E2FC 80052EFC 3C01800A */  lui       $at, %hi(gBGMPlayerC)
/* 2E300 80052F00 AC22A5CC */  sw        $v0, %lo(gBGMPlayerC)($at)
...
/* 2E31C 80052F1C 2610A640 */  addiu     $s0, $s0, %lo(gSoundManager)
...
/* 2E340 80052F40 3C01800A */  lui       $at, %hi(gAuAmbienceManager)
/* 2E344 80052F44 AC22A628 */  sw        $v0, %lo(gAuAmbienceManager)($at)
...
/* 2E414 80053014 0C014CDC */  jal       au_reset_drum_entry
...
/* 2E4C0 800530C0 A0400044 */  sh        $zero, 0x44($v0)
/* 2E4C4 800530C4 A0400045 */  lui       $a1, %hi(SBN_ROM_START)
...
/* 2E4D8 800530D8 3C0500F0 */  addiu     $a1, %lo(SBN_ROM_START)
/* 2E4DC 800530DC 0C0150AF */  jal       au_load_INIT
...
/* 2E518 80053118 3C10800A */  lui       $s0, %hi(gBGMPlayerA)
/* 2E51C 8005311C 2610A664 */  addiu     $s0, $s0, %lo(gBGMPlayerA)
/* 2E520 80053120 8E040000 */  lw        $a0, ($s0)
/* 2E524 80053124 0C013856 */  jal       au_bgm_player_init
...
/* 2E54C 8005314C 0C0138D1 */  jal       au_bgm_set_effect_indices
/* 2E550 80053150 A3B00023 */   sb       $s0, 0x23($sp)
/* 2E554 80053154 24050002 */  addiu     $a1, $zero, 2
/* 2E558 80053158 00A0302D */  daddu     $a2, $a1, $zero
/* 2E55C 8005315C 3C11800A */  lui       $s1, %hi(gBGMPlayerB)
/* 2E560 80053160 2631A5FC */  addiu     $s1, $s1, %lo(gBGMPlayerB)
/* 2E564 80053164 8E240000 */  lw        $a0, ($s1)
/* 2E568 80053168 0C013856 */  jal       au_bgm_player_init
...
/* 2E588 80053188 0C0138D1 */  jal       au_bgm_set_effect_indices
...
/* 2E59C 8005319C 3C10800A */  lui       $s0, %hi(gSoundManager)
/* 2E5A0 800531A0 2610A640 */  addiu     $s0, $s0, %lo(gSoundManager)
/* 2E5A4 800531A4 8E040000 */  lw        $a0, ($s0)
/* 2E5A8 800531A8 24020010 */  addiu     $v0, $zero, 0x10
/* 2E5AC 800531AC 0C012D10 */  jal       au_sfx_init
...
/* 2E5EC 800531EC 0C01511F */  jal       au_fetch_SBN_file
...
/* 2E60C 8005320C 0C015380 */  jal       au_read_rom
...
/* 2E654 80053254 0C01511F */  jal       au_fetch_SBN_file
...
/* 2E668 80053268 0C01516D */  jal       au_load_PRG
