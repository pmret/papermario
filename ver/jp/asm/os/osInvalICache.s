...
/* 3CBC4 800617C4 10200008 */  beqz      $at, .LJP_800617E8
...
.LJP_800617D8:
/* 3CBD8 800617D8 BD100000 */  cache     0x10, 0x0($t0) # handwritten instruction
/* 3CBDC 800617DC 0109082B */  sltu      $at, $t0, $t1
/* 3CBE0 800617E0 1420FFFD */  bnez      $at, .LJP_800617D8
...
.LJP_800617FC:
/* 3CBFC 800617FC BD000000 */  cache     0x00, 0x0($t0) # handwritten instruction
/* 3CC00 80061800 0109082B */  sltu      $at, $t0, $t1
/* 3CC04 80061804 1420FFFD */  bnez      $at, .LJP_800617FC
/* 3CC08 80061808 25080020 */   addiu    $t0, $t0, (0x80000020 & 0xFFFF)
