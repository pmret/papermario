...
/* 112C4 80035EC4 3C108007 */  lui       $s0, %hi(gGameStatusPtr)
/* 112C8 80035EC8 2610417C */  addiu     $s0, $s0, %lo(gGameStatusPtr)
...
.L80035FB8:
/* 113B8 80035FB8 3C028007 */  lui       $v0, %hi(gGameStatusPtr)
/* 113BC 80035FBC 8C42417C */  lw        $v0, %lo(gGameStatusPtr)($v0)
...
/* 11438 80036038 3C028007 */  lui       $v0, %hi(gGameStatusPtr)
/* 1143C 8003603C 8C42417C */  lw        $v0, %lo(gGameStatusPtr)($v0)
