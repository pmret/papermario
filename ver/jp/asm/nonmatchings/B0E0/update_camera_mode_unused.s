...
/* AD98 8002F998 86020006 */  lh        $v0, 0x6($s0)
/* AD9C 8002F99C 3C038011 */  lui       $v1, %hi(gPlayerStatus)
/* ADA0 8002F9A0 2463F188 */  addiu     $v1, $v1, %lo(gPlayerStatus)
/* ADA4 8002F9A4 14400004 */  bnez      $v0, .LJP_8002F9B8
/* ADA8 8002F9A8 00000000 */   nop
/* ADAC 8002F9AC 86020008 */  lh        $v0, 0x8($s0)
/* ADB0 8002F9B0 1040000F */  beqz      $v0, .LJP_8002F9F0
...
/* ADC8 8002F9C8 A6000006 */  sh        $zero, 0x6($s0)
/* ADCC 8002F9CC A6000008 */  sh        $zero, 0x8($s0)
...
.LJP_8002F9F0:
/* ADF0 8002F9F0 8C620000 */  lw        $v0, 0x0($v1)
/* ADF4 8002F9F4 30420006 */  andi      $v0, $v0, 0x6
/* ADF8 8002F9F8 14400007 */  bnez      $v0, .LJP_8002FA18
/* ADFC 8002F9FC 00000000 */   nop
/* AE00 8002FA00 C460002C */  lwc1      $f0, 0x2C($v1)
/* AE04 8002FA04 3C014270 */  lui       $at, (0x42700000 >> 16)
...
/* AE1C 8002FA1C 3C0143C8 */  lui       $at, (0x43C80000 >> 16)
...
/* AE34 8002FA34 14400062 */  bnez      $v0, .LJP_8002FBC0
/* AE38 8002FA38 E600005C */   swc1     $f0, 0x5C($s0)
/* AE3C 8002FA3C 86030020 */  lh        $v1, 0x20($s0)
/* AE40 8002FA40 24022710 */  addiu     $v0, $zero, 0x2710
/* AE44 8002FA44 14600002 */  bnez      $v1, .LJP_8002FA50
/* AE48 8002FA48 0043001A */   div      $zero, $v0, $v1
/* AE4C 8002FA4C 0007000D */  break     7
.LJP_8002FA50:
/* AE50 8002FA50 2401FFFF */  addiu     $at, $zero, -0x1
/* AE54 8002FA54 14610004 */  bne       $v1, $at, .LJP_8002FA68
/* AE58 8002FA58 3C018000 */   lui      $at, (0x80000000 >> 16)
/* AE5C 8002FA5C 14410002 */  bne       $v0, $at, .LJP_8002FA68
...
/* AEBC 8002FABC 04810002 */  bgez      $a0, .LJP_8002FAC8
/* AEC0 8002FAC0 E6000078 */   swc1     $f0, 0x78($s0)
/* AEC4 8002FAC4 24840003 */  addiu     $a0, $a0, 0x3
.LJP_8002FAC8:
/* AEC8 8002FAC8 C6020074 */  lwc1      $f2, 0x74($s0)
/* AECC 8002FACC 3C0140C9 */  lui       $at, (0x40C90FD0 >> 16)
/* AED0 8002FAD0 34210FD0 */  ori       $at, $at, (0x40C90FD0 & 0xFFFF)
...
/* AEE8 8002FAE8 3C0143B4 */  lui       $at, (0x43B40000 >> 16)
...
/* AFCC 8002FBCC 0C00A710 */  jal       atan2
...
/* B00C 8002FC0C 0C00A710 */  jal       atan2
...
/* B03C 8002FC3C 45030004 */  bc1tl     .LJP_8002FC50
/* B040 8002FC40 4600B306 */   mov.s    $f12, $f22
/* B044 8002FC44 0C0187B0 */  jal       sqrtf
...
/* B05C 8002FC5C 0C00A710 */  jal       atan2
