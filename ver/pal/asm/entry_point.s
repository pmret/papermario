...
glabel func_PAL_80025C00
/* 1000 80025C00 3C088009 */  lui       $t0, %hi(nuScPreNMIFlag)
/* 1004 80025C04 25086980 */  addiu     $t0, $t0, %lo(nuScPreNMIFlag)
/* 1008 80025C08 3C090004 */  lui       $t1, %hi(D_422F0)
/* 100C 80025C0C 252922F0 */  addiu     $t1, $t1, %lo(D_422F0)
.LPAL_80025C10:
...
/* 1020 80025C20 1520FFFB */  bnez      $t1, .LPAL_80025C10
/* 1024 80025C24 00000000 */   nop
/* 1028 80025C28 3C1D800B */  lui       $sp, %hi(nuBootStack + 0x2000)
/* 102C 80025C2C 27BD4C70 */  addiu     $sp, $sp, %lo(nuBootStack + 0x2000)
/* 1030 80025C30 3C0A8006 */  lui       $t2, %hi(nuBoot)
/* 1034 80025C34 254AEFD0 */  addiu     $t2, $t2, %lo(nuBoot)
