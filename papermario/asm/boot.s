...
/* 000090 00000050 34090040 */  li    $t1, 64
/* 000094 00000054 AD090004 */  sw    $t1, 4($t0)
/* 000098 00000058 24112260 */  li    $s1, 8800
.L0000005C:
...
/* 0000B0 00000070 34090014 */  li    $t1, 20
...
/* 0000D0 00000090 3409000E */  li    $t1, 14
D_00000094:
...
/* 0000E4 000000A4 3409010F */   li    $t1, 271
...
/* 000140 00000100 3C110101 */  lui   $s1, %hi(D_01010101) # $s1, 0x101
/* 000144 00000104 26310101 */  addiu $s1, %lo(D_01010101) # addiu $s1, $s1, 0x101
...
/* 000464 00000424 3C090010 */  lui   $t1, %hi(D_000FFFFF) # $t1, 0x10
/* 000468 00000428 014B5024 */  and   $t2, $t2, $t3
/* 00046C 0000042C 3C08A400 */  lui   $t0, %hi(D_A40004C0) # $t0, 0xa400
/* 000470 00000430 2529FFFF */  addiu $t1, %lo(D_000FFFFF) # addiu $t1, $t1, -1
/* 000474 00000434 3C0BA400 */  lui   $t3, %hi(D_A4000768) # $t3, 0xa400
/* 000478 00000438 250804C0 */  addiu $t0, %lo(D_A40004C0) # addiu $t0, $t0, 0x4c0
/* 00047C 0000043C 256B0768 */  addiu $t3, %lo(D_A4000768) # addiu $t3, $t3, 0x768
...
/* 0004E4 000004A4 3C08A460 */  lui   $t0, %hi(D_A4600010) # $t0, 0xa460
.L000004A8:
...
/* 000504 000004C4 3C01A460 */  lui   $at, %hi(D_A4600004) # $at, 0xa460
/* 000508 000004C8 AC280004 */  sw    $t0, %lo(D_A4600004)($at)
/* 00050C 000004CC 3C0A0010 */  lui   $t2, %hi(D_00100003) # $t2, 0x10
/* 000510 000004D0 254A0003 */  addiu $t2, %lo(D_00100003) # addiu $t2, $t2, 3
/* 000514 000004D4 3C01A460 */  lui   $at, %hi(D_A460000C) # $at, 0xa460
/* 000518 000004D8 AC2A000C */  sw    $t2, %lo(D_A460000C)($at)
.L000004DC:
...
/* 00054C 0000050C 3C0BA460 */  lui   $t3, %hi(D_A4600010) # $t3, 0xa460
/* 000550 00000510 8D6B0010 */  lw    $t3, %lo(D_A4600010)($t3)
/* 000554 00000514 316B0001 */  andi  $t3, $t3, 1
/* 000558 00000518 1560FFF0 */  bnez  $t3, .L000004DC
/* 00055C 0000051C 00000000 */   nop   
/* 000560 00000520 3C0BB000 */  lui   $t3, %hi(D_B0000008) # $t3, 0xb000
/* 000564 00000524 8D640008 */  lw    $a0, %lo(D_B0000008)($t3)
/* 000568 00000528 3C010010 */  lui   $at, 0x10
/* 00056C 0000052C 02C02825 */  move  $a1, $s6
/* 000570 00000530 00812023 */  subu  $a0, $a0, $at
/* 000574 00000534 3C016C07 */  lui   $at, (0x6C078965 >> 16) # lui $at, 0x6c07
/* 000578 00000538 34218965 */  ori   $at, (0x6C078965 & 0xFFFF) # ori $at, $at, 0x8965
...
/* 00059C 0000055C 240D0020 */  li    $t5, 32
...
/* 000634 000005F4 3C0BB000 */  lui   $t3, %hi(D_B0000014) # $t3, 0xb000
/* 000638 000005F8 8D680010 */  lw    $t0, %lo(D_B0000010)($t3)
/* 00063C 000005FC 14E80006 */  bne   $a3, $t0, .L00000618
/* 000640 00000600 00000000 */   nop   
/* 000644 00000604 8D680014 */  lw    $t0, %lo(D_B0000014)($t3)
...
/* 000678 00000638 240A0041 */  li    $t2, 65
/* 00067C 0000063C 3C01A404 */  lui   $at, %hi(D_A4040010) # $at, 0xa404
/* 000680 00000640 AC2A0010 */  sw    $t2, %lo(D_A4040010)($at)
/* 000684 00000644 3C01A408 */  lui   $at, 0xa408
/* 000688 00000648 AC200000 */  sw    $zero, ($at)
.L0000064C:
/* 00068C 0000064C 3C0B00AA */  lui   $t3, (0x00AAAAAE >> 16) # lui $t3, 0xaa
/* 000690 00000650 356BAAAE */  ori   $t3, (0x00AAAAAE & 0xFFFF) # ori $t3, $t3, 0xaaae
/* 000694 00000654 3C01A404 */  lui   $at, %hi(D_A4040010) # $at, 0xa404
/* 000698 00000658 AC2B0010 */  sw    $t3, %lo(D_A4040010)($at)
/* 00069C 0000065C 3C01A430 */  lui   $at, %hi(D_A430000C) # $at, 0xa430
/* 0006A0 00000660 24080555 */  li    $t0, 1365
/* 0006A4 00000664 AC28000C */  sw    $t0, %lo(D_A430000C)($at)
/* 0006A8 00000668 3C01A480 */  lui   $at, %hi(D_A4800018) # $at, 0xa480
/* 0006AC 0000066C AC200018 */  sw    $zero, %lo(D_A4800018)($at)
/* 0006B0 00000670 3C01A450 */  lui   $at, %hi(D_A450000C) # $at, 0xa450
/* 0006B4 00000674 AC20000C */  sw    $zero, %lo(D_A450000C)($at)
/* 0006B8 00000678 3C01A430 */  lui   $at, 0xa430
/* 0006BC 0000067C 24090800 */  li    $t1, 2048
/* 0006C0 00000680 AC290000 */  sw    $t1, ($at)
/* 0006C4 00000684 24090002 */  li    $t1, 2
/* 0006C8 00000688 3C01A460 */  lui   $at, %hi(D_A4600010) # $at, 0xa460
/* 0006CC 0000068C AC290010 */  sw    $t1, %lo(D_A4600010)($at)
/* 0006D0 00000690 3C08A000 */  lui   $t0, %hi(D_A0000008) # $t0, 0xa000
/* 0006D4 00000694 35080300 */  ori   $t0, (0xA0000300 & 0xFFFF) # ori $t0, $t0, 0x300
/* 0006D8 00000698 240917D7 */  li    $t1, 6103
/* 0006DC 0000069C AD090010 */  sw    $t1, %lo(D_A0000010)($t0)
/* 0006E0 000006A0 AD140000 */  sw    $s4, ($t0)
/* 0006E4 000006A4 AD130004 */  sw    $s3, %lo(D_A0000004)($t0)
/* 0006E8 000006A8 AD15000C */  sw    $s5, %lo(D_A000000C)($t0)
/* 0006EC 000006AC 12600004 */  beqz  $s3, .L000006C0
/* 0006F0 000006B0 AD170014 */   sw    $s7, %lo(D_A0000014)($t0)
...
/* 000740 00000700 3C0AA400 */  lui   $t2, %hi(D_A4001000) # $t2, 0xa400
/* 000744 00000704 240B17D7 */  li    $t3, 6103
/* 000748 00000708 AD4B1000 */  sw    $t3, %lo(D_A4001000)($t2)
/* 00074C 0000070C 3C0BB000 */  lui   $t3, %hi(D_B0000008) # $t3, 0xb000
/* 000750 00000710 254A1000 */  addiu $t2, %lo(D_A4001000) # addiu $t2, $t2, 0x1000
/* 000754 00000714 8D690008 */  lw    $t1, %lo(D_B0000008)($t3)
...
/* 000800 000007C0 24050001 */   li    $a1, 1
...
/* 000910 000008D0 24050002 */   li    $a1, 2
/* 000914 000008D4 0000F025 */  move  $fp, $zero
/* 000918 000008D8 241AFFFF */  li    $k0, -1
.L000008DC:
...
/* 00098C 0000094C 340DC800 */  li    $t5, 51200
...
/* 0009B0 00000970 24050001 */   li    $a1, 1
...
/* 0009C8 00000988 241B0320 */  li    $k1, 800
...
/* 000A3C 000009FC 241B0001 */  li    $k1, 1
...
/* 000AA0 00000A60 241B0001 */  li    $k1, 1
...
/* 000ACC 00000A8C 241A2000 */  li    $k0, 8192
...
/* 000AE0 00000AA0 241A1000 */  li    $k0, 4096
/* 000AE4 00000AA4 AF7A0000 */  sw    $k0, ($k1)
/* 000AE8 00000AA8 241B0040 */  li    $k1, 64
...
/* 000AFC 00000ABC 241B4000 */  li    $k1, 16384
