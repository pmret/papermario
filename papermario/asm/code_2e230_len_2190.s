...
/* 02E264 80052E64 0080B02D */  move  $s6, $a0
...
/* 02E298 80052E98 0000982D */  move  $s3, $zero
/* 02E29C 80052E9C 0C015FE4 */  jal   func_80057F90
/* 02E2A0 80052EA0 02A0202D */   move  $a0, $s5
/* 02E2A4 80052EA4 02A0202D */  move  $a0, $s5
...
/* 02E2C0 80052EC0 02A0202D */  move  $a0, $s5
...
/* 02E2DC 80052EDC 02A0202D */  move  $a0, $s5
...
/* 02E2F4 80052EF4 02A0202D */  move  $a0, $s5
...
/* 02E30C 80052F0C 02A0202D */  move  $a0, $s5
...
/* 02E328 80052F28 02A0202D */  move  $a0, $s5
...
.L80052F74:
/* 02E374 80052F74 02A0202D */  move  $a0, $s5
...
/* 02E394 80052F94 02A0202D */  move  $a0, $s5
...
/* 02E3A4 80052FA4 02A0202D */  move  $a0, $s5
...
/* 02E3B8 80052FB8 02A0202D */  move  $a0, $s5
...
/* 02E3CC 80052FCC 02A0202D */  move  $a0, $s5
...
/* 02E3E0 80052FE0 02A0202D */  move  $a0, $s5
...
/* 02E3F4 80052FF4 0000982D */  move  $s3, $zero
...
/* 02E42C 8005302C 0280102D */  move  $v0, $s4
...
/* 02E44C 8005304C 0000982D */  move  $s3, $zero
/* 02E450 80053050 0280182D */  move  $v1, $s4
.L80053054:
...
/* 02E46C 8005306C 0000982D */  move  $s3, $zero
...
/* 02E480 80053080 0200202D */  move  $a0, $s0
/* 02E484 80053084 0C015BB0 */  jal   func_80056EC0
/* 02E488 80053088 0000282D */   move  $a1, $zero
/* 02E48C 8005308C 0200202D */  move  $a0, $s0
...
/* 02E4D4 800530D4 0280202D */  move  $a0, $s4
/* 02E4D8 800530D8 3C0500F0 */  lui   $a1, 0xf0
/* 02E4DC 800530DC 0C0150AF */  jal   func_800542BC
/* 02E4E0 800530E0 02A0302D */   move  $a2, $s5
/* 02E4E4 800530E4 0000982D */  move  $s3, $zero
/* 02E4E8 800530E8 0280802D */  move  $s0, $s4
.L800530EC:
/* 02E4EC 800530EC 02A0202D */  move  $a0, $s5
...
/* 02E514 80053114 0000302D */  move  $a2, $zero
...
/* 02E528 80053128 0280382D */   move  $a3, $s4
/* 02E52C 8005312C 27B20020 */  addiu $s2, $sp, 0x20
/* 02E530 80053130 0240282D */  move  $a1, $s2
...
/* 02E558 80053158 00A0302D */  move  $a2, $a1
...
/* 02E56C 8005316C 0280382D */   move  $a3, $s4
/* 02E570 80053170 0240282D */  move  $a1, $s2
...
/* 02E598 80053198 0280382D */  move  $a3, $s4
...
/* 02E5C8 800531C8 0280382D */   move  $a3, $s4
/* 02E5CC 800531CC 0C014985 */  jal   func_80052614
/* 02E5D0 800531D0 0280202D */   move  $a0, $s4
/* 02E5D4 800531D4 0280202D */  move  $a0, $s4
/* 02E5D8 800531D8 0C0153F0 */  jal   func_80054FC0
/* 02E5DC 800531DC 02A0282D */   move  $a1, $s5
...
/* 02E644 80053244 0280202D */   move  $a0, $s4
.L80053248:
...
/* 02E660 80053260 0000202D */   move  $a0, $zero
/* 02E664 80053264 8FA50018 */  lw    $a1, 0x18($sp)
/* 02E668 80053268 0C01516D */  jal   func_800545B4
/* 02E66C 8005326C 0280202D */   move  $a0, $s4
/* 02E670 80053270 0000202D */  move  $a0, $zero
.L80053274:
...
/* 02E6C8 800532C8 02A0202D */   move  $a0, $s5
...
/* 02E800 80053400 0240202D */   move  $a0, $s2
...
/* 02E81C 8005341C 0200202D */  move  $a0, $s0
...
/* 02E868 80053468 0220202D */  move  $a0, $s1
...
/* 02E8A8 800534A8 0200202D */   move  $a0, $s0
.L800534AC:
...
/* 02E8DC 800534DC 0200202D */  move  $a0, $s0
...
/* 02E90C 8005350C 0240202D */   move  $a0, $s2
.L80053510:
...
/* 02E93C 8005353C 0200202D */   move  $a0, $s0
...
/* 02E958 80053558 0200202D */   move  $a0, $s0
func_8005355C:
.L8005355C:
...
/* 02E98C 8005358C 0200202D */  move  $a0, $s0
...
/* 02E9A4 800535A4 0240202D */   move  $a0, $s2
...
/* 02EA20 80053620 0200202D */   move  $a0, $s0
...
/* 02EA38 80053638 0240202D */   move  $a0, $s2
...
/* 02EA5C 8005365C 0080982D */  move  $s3, $a0
...
/* 02EB14 80053714 0000202D */   move  $a0, $zero
...
/* 02EB5C 8005375C 0000902D */   move  $s2, $zero
...
/* 02EB70 80053770 0000902D */  move  $s2, $zero
.L80053774:
...
/* 02EBA8 800537A8 0200202D */   move  $a0, $s0
...
/* 02ECAC 800538AC 0000282D */  move  $a1, $zero
...
/* 02ECE0 800538E0 0000282D */  move  $a1, $zero
...
func_800538F8:
/* 02ECF8 800538F8 0080282D */  move  $a1, $a0
...
func_80053974:
/* 02ED74 80053974 0080402D */  move  $t0, $a0
...
/* 02EDBC 800539BC 00C0102D */  move  $v0, $a2
...
/* 02EE30 80053A30 0080802D */  move  $s0, $a0
...
/* 02EF18 80053B18 0080382D */   move  $a3, $a0
...
/* 02F054 80053C54 00C0102D */   move  $v0, $a2
...
/* 02F10C 80053D0C 0080B02D */  move  $s6, $a0
/* 02F110 80053D10 AFB3002C */  sw    $s3, 0x2c($sp)
/* 02F114 80053D14 00C0982D */  move  $s3, $a2
...
/* 02F144 80053D44 00A0B82D */   move  $s7, $a1
...
/* 02F170 80053D70 0260202D */   move  $a0, $s3
...
/* 02F1EC 80053DEC 0060202D */  move  $a0, $v1
/* 02F1F0 80053DF0 0C015313 */  jal   func_80054C4C
/* 02F1F4 80053DF4 0200282D */   move  $a1, $s0
...
/* 02F260 80053E60 00A0802D */  move  $s0, $a1
...
/* 02F2A0 80053EA0 0040982D */  move  $s3, $v0
/* 02F2A4 80053EA4 16600026 */  bnez  $s3, .L80053F40
/* 02F2A8 80053EA8 0260102D */   move  $v0, $s3
/* 02F2AC 80053EAC 3C0200FF */  lui   $v0, 0xff
/* 02F2B0 80053EB0 3442FFFF */  ori   $v0, $v0, 0xffff
/* 02F2B4 80053EB4 0200282D */  move  $a1, $s0
/* 02F2B8 80053EB8 0000802D */  move  $s0, $zero
...
/* 02F318 80053F18 0060202D */  move  $a0, $v1
/* 02F31C 80053F1C 0C015313 */  jal   func_80054C4C
/* 02F320 80053F20 0200282D */   move  $a1, $s0
...
/* 02F33C 80053F3C 0260102D */   move  $v0, $s3
.L80053F40:
...
/* 02F368 80053F68 0000102D */   move  $v0, $zero
...
/* 02F394 80053F94 0080A82D */  move  $s5, $a0
...
/* 02F46C 8005406C 0000182D */   move  $v1, $zero
/* 02F470 80054070 A2400020 */  sb    $zero, 0x20($s2)
/* 02F474 80054074 0240202D */  move  $a0, $s2
.L80054078:
...
/* 02F4CC 800540CC 0200282D */  move  $a1, $s0
...
/* 02F520 80054120 0200282D */  move  $a1, $s0
...
/* 02F574 80054174 0200282D */  move  $a1, $s0
...
/* 02F5C8 800541C8 0200282D */  move  $a1, $s0
...
/* 02F63C 8005423C 0000102D */  move  $v0, $zero
...
/* 02F664 80054264 0000102D */   move  $v0, $zero
...
/* 02F678 80054278 0000102D */   move  $v0, $zero
...
/* 02F6C4 800542C4 0080982D */  move  $s3, $a0
/* 02F6C8 800542C8 AFB10074 */  sw    $s1, 0x74($sp)
/* 02F6CC 800542CC 00A0882D */  move  $s1, $a1
/* 02F6D0 800542D0 AFB40080 */  sw    $s4, 0x80($sp)
/* 02F6D4 800542D4 00C0A02D */  move  $s4, $a2
/* 02F6D8 800542D8 0220202D */  move  $a0, $s1
...
/* 02F6FC 800542FC 0280202D */  move  $a0, $s4
...
/* 02F744 80054344 0040182D */  move  $v1, $v0
...
/* 02F78C 8005438C 0040182D */  move  $v1, $v0
...
/* 02F7B8 800543B8 0220202D */   move  $a0, $s1
/* 02F7BC 800543BC 0280202D */  move  $a0, $s4
...
/* 02F7D4 800543D4 0240302D */  move  $a2, $s2
/* 02F7D8 800543D8 0C015FE4 */  jal   func_80057F90
/* 02F7DC 800543DC 02308021 */   addu  $s0, $s1, $s0
/* 02F7E0 800543E0 0200202D */  move  $a0, $s0
/* 02F7E4 800543E4 0040282D */  move  $a1, $v0
/* 02F7E8 800543E8 0240302D */  move  $a2, $s2
/* 02F7EC 800543EC 0C015380 */  jal   func_80054E00
/* 02F7F0 800543F0 AE65002C */   sw    $a1, 0x2c($s3)
/* 02F7F4 800543F4 0280202D */  move  $a0, $s4
...
/* 02F80C 8005440C 0240302D */  move  $a2, $s2
/* 02F810 80054410 0C015FE4 */  jal   func_80057F90
/* 02F814 80054414 02308021 */   addu  $s0, $s1, $s0
/* 02F818 80054418 0200202D */  move  $a0, $s0
/* 02F81C 8005441C 0040282D */  move  $a1, $v0
/* 02F820 80054420 0240302D */  move  $a2, $s2
...
func_800544EC:
.L800544EC:
/* 02F8EC 800544EC 0100102D */  move  $v0, $t0
...
/* 02F900 80054500 0080902D */  move  $s2, $a0
/* 02F904 80054504 AFB00020 */  sw    $s0, 0x20($sp)
/* 02F908 80054508 00A0802D */  move  $s0, $a1
/* 02F90C 8005450C 0200202D */  move  $a0, $s0
...
/* 02F938 80054538 0200302D */   move  $a2, $s0
...
/* 02F97C 8005457C 0200282D */   move  $a1, $s0
/* 02F980 80054580 0200202D */  move  $a0, $s0
...
/* 02F9BC 800545BC 0080902D */  move  $s2, $a0
/* 02F9C0 800545C0 AFB00020 */  sw    $s0, 0x20($sp)
/* 02F9C4 800545C4 00A0802D */  move  $s0, $a1
/* 02F9C8 800545C8 0200202D */  move  $a0, $s0
...
/* 02FA00 80054600 0220302D */   move  $a2, $s1
...
/* 02FA2C 8005462C 0200282D */   move  $a1, $s0
/* 02FA30 80054630 0200202D */  move  $a0, $s0
...
/* 02FA64 80054664 0000982D */  move  $s3, $zero
...
/* 02FAA4 800546A4 0260102D */   move  $v0, $s3
/* 02FAA8 800546A8 5444FFFC */  bnel  $v0, $a0, .L8005469C
/* 02FAAC 800546AC 24630008 */   addiu $v1, $v1, 8
/* 02FAB0 800546B0 0000802D */  move  $s0, $zero
/* 02FAB4 800546B4 0060882D */  move  $s1, $v1
.L800546B8:
...
/* 02FAF8 800546F8 0060202D */  move  $a0, $v1
/* 02FAFC 800546FC 0C015313 */  jal   func_80054C4C
/* 02FB00 80054700 0200282D */   move  $a1, $s0
...
/* 02FB1C 8005471C 0260102D */   move  $v0, $s3
.L80054720:
...
func_80054744:
/* 02FB44 80054744 0000182D */  move  $v1, $zero
...
/* 02FC4C 8005484C 0000902D */   move  $s2, $zero
...
/* 02FC68 80054868 0000902D */   move  $s2, $zero
...
/* 02FCBC 800548BC 0000902D */   move  $s2, $zero
...
/* 02FD0C 8005490C 02C0202D */  move  $a0, $s6
/* 02FD10 80054910 24050001 */  addiu $a1, $zero, 1
/* 02FD14 80054914 0C015FE4 */  jal   func_80057F90
/* 02FD18 80054918 0200302D */   move  $a2, $s0
/* 02FD1C 8005491C 0040A02D */  move  $s4, $v0
.L80054920:
/* 02FD20 80054920 02A0202D */  move  $a0, $s5
/* 02FD24 80054924 0280282D */  move  $a1, $s4
/* 02FD28 80054928 0C015380 */  jal   func_80054E00
/* 02FD2C 8005492C 0200302D */   move  $a2, $s0
/* 02FD30 80054930 03C0202D */  move  $a0, $fp
/* 02FD34 80054934 0C0151D1 */  jal   func_80054744
/* 02FD38 80054938 02E0282D */   move  $a1, $s7
/* 02FD3C 8005493C 0040802D */  move  $s0, $v0
/* 02FD40 80054940 0200182D */  move  $v1, $s0
/* 02FD44 80054944 0000302D */  move  $a2, $zero
/* 02FD48 80054948 00C0282D */  move  $a1, $a2
/* 02FD4C 8005494C 0220202D */  move  $a0, $s1
.L80054950:
...
/* 02FD84 80054984 0000902D */   move  $s2, $zero
...
/* 02FD98 80054998 02A0202D */  move  $a0, $s5
/* 02FD9C 8005499C 0280282D */  move  $a1, $s4
/* 02FDA0 800549A0 0200302D */  move  $a2, $s0
...
/* 02FDB0 800549B0 0000982D */   move  $s3, $zero

.L800549B4:
/* 02FDB4 800549B4 0000902D */  move  $s2, $zero
func_800549B8:
.L800549B8:
...
/* 02FDC4 800549C4 0280102D */  move  $v0, $s4
...
func_800549F8:
/* 02FDF8 800549F8 00A0582D */  move  $t3, $a1
...
/* 02FE1C 80054A1C 0000402D */   move  $t0, $zero
.L80054A20:
...
/* 02FF08 80054B08 0000902D */   move  $s2, $zero
...
/* 02FF24 80054B24 0000902D */   move  $s2, $zero
...
/* 02FF44 80054B44 0000902D */   move  $s2, $zero
...
/* 02FF5C 80054B5C 0000902D */   move  $s2, $zero
...
/* 02FFE4 80054BE4 0000902D */   move  $s2, $zero
/* 02FFE8 80054BE8 08015304 */  j     func_80054C10
/* 02FFEC 80054BEC 2411001F */   addiu $s1, $zero, 0x1f

.L80054BF0:
/* 02FFF0 80054BF0 0260202D */  move  $a0, $s3
/* 02FFF4 80054BF4 0260282D */  move  $a1, $s3
/* 02FFF8 80054BF8 02A0302D */  move  $a2, $s5
...
/* 030008 80054C08 0000882D */   move  $s1, $zero

.L80054C0C:
/* 03000C 80054C0C 0000902D */  move  $s2, $zero
func_80054C10:
.L80054C10:
/* 030010 80054C10 1640FFBA */  bnez  $s2, .L80054AFC
/* 030014 80054C14 2402000B */   addiu $v0, $zero, 0xb
/* 030018 80054C18 0260102D */  move  $v0, $s3
...
/* 03005C 80054C5C 00A0302D */  move  $a2, $a1
...
/* 0300A8 80054CA8 0060282D */   move  $a1, $v1
/* 0300AC 80054CAC 0040182D */  move  $v1, $v0
/* 0300B0 80054CB0 10600007 */  beqz  $v1, .L80054CD0
/* 0300B4 80054CB4 00000000 */   nop   
/* 0300B8 80054CB8 0000202D */  move  $a0, $zero
.L80054CBC:
...
/* 0300E8 80054CE8 0080882D */  move  $s1, $a0
...
/* 030188 80054D88 0000102D */   move  $v0, $zero
...
/* 030268 80054E68 0C017D24 */  jal   func_8005F490
/* 03026C 80054E6C 0240302D */   move  $a2, $s2
.L80054E70:
...
/* 03029C 80054E9C 00A0102D */   move  $v0, $a1
...
/* 0302B0 80054EB0 00A0102D */  move  $v0, $a1
...
func_80054EE4:
/* 0302E4 80054EE4 00E0102D */  move  $v0, $a3
...
func_80054F14:
/* 030314 80054F14 00E0102D */  move  $v0, $a3
...
/* 030334 80054F34 00E0102D */  move  $v0, $a3
...
/* 030358 80054F58 00C0182D */  move  $v1, $a2
...
/* 030378 80054F78 00C0102D */   move  $v0, $a2
...
/* 0303A0 80054FA0 00C0182D */  move  $v1, $a2
