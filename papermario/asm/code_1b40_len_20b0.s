...
/* 001D14 80026914 0000202D */   move  $a0, $zero
...
/* 001E70 80026A70 0060202D */  move  $a0, $v1
...
/* 001EC0 80026AC0 0000302D */  move  $a2, $zero
/* 001EC4 80026AC4 00C0382D */  move  $a3, $a2
...
/* 001F9C 80026B9C 0000202D */   move  $a0, $zero
.L80026BA0:
...
/* 00210C 80026D0C 0000302D */   move  $a2, $zero
.L80026D10:
...
/* 002134 80026D34 0000302D */   move  $a2, $zero
func_80026D38:
...
/* 00215C 80026D5C 0060482D */  move  $t1, $v1
...
/* 002370 80026F70 0000202D */   move  $a0, $zero
...
/* 0023D0 80026FD0 0000202D */   move  $a0, $zero
...
/* 002434 80027034 0000182D */  move  $v1, $zero
...
/* 002468 80027068 0000202D */  move  $a0, $zero
...
/* 00248C 8002708C 0080282D */  move  $a1, $a0
...
/* 0025B0 800271B0 0060282D */  move  $a1, $v1
...
/* 002660 80027260 0080582D */  move  $t3, $a0
/* 002664 80027264 AFA5007C */  sw    $a1, 0x7c($sp)
/* 002668 80027268 0000282D */  move  $a1, $zero
...
/* 0026BC 800272BC 0000282D */  move  $a1, $zero
...
/* 0026D0 800272D0 0160202D */  move  $a0, $t3
.L800272D4:
...
/* 002728 80027328 0000282D */  move  $a1, $zero
...
.L80027394:
/* 002794 80027394 0000282D */  move  $a1, $zero
...
.L80027400:
/* 002800 80027400 0000282D */  move  $a1, $zero
...
/* 002A04 80027604 0080502D */  move  $t2, $a0
/* 002A08 80027608 0000302D */  move  $a2, $zero
...
/* 002A9C 8002769C 0000182D */  move  $v1, $zero
/* 002AA0 800276A0 0060302D */  move  $a2, $v1
...
.L800276D4:
/* 002AD4 800276D4 0000182D */  move  $v1, $zero
/* 002AD8 800276D8 0060302D */  move  $a2, $v1
...
.L8002770C:
/* 002B0C 8002770C 0000182D */  move  $v1, $zero
/* 002B10 80027710 0060302D */  move  $a2, $v1
...
/* 002B7C 8002777C 0080A02D */  move  $s4, $a0
/* 002B80 80027780 AFB5005C */  sw    $s5, 0x5c($sp)
/* 002B84 80027784 00A0A82D */  move  $s5, $a1
...
/* 002BF0 800277F0 0280202D */   move  $a0, $s4
...
/* 002C08 80027808 0280202D */   move  $a0, $s4
...
/* 002C20 80027820 0280202D */   move  $a0, $s4
.L80027824:
/* 002C24 80027824 02A0282D */  move  $a1, $s5
/* 002C28 80027828 03C0302D */  move  $a2, $fp
/* 002C2C 8002782C 2650FFFF */  addiu $s0, $s2, -1
/* 002C30 80027830 8FA80040 */  lw    $t0, 0x40($sp)
/* 002C34 80027834 0200382D */  move  $a3, $s0
/* 002C38 80027838 0C009C7F */  jal   func_800271FC
/* 002C3C 8002783C AFA80010 */   sw    $t0, 0x10($sp)
/* 002C40 80027840 0280202D */  move  $a0, $s4
/* 002C44 80027844 02A0282D */  move  $a1, $s5
/* 002C48 80027848 03C0302D */  move  $a2, $fp
/* 002C4C 8002784C 0240382D */  move  $a3, $s2
...
/* 002C5C 8002785C 0280202D */  move  $a0, $s4
/* 002C60 80027860 02A0282D */  move  $a1, $s5
/* 002C64 80027864 03C0302D */  move  $a2, $fp
/* 002C68 80027868 26510001 */  addiu $s1, $s2, 1
/* 002C6C 8002786C 0220382D */  move  $a3, $s1
...
/* 002C7C 8002787C 0280202D */  move  $a0, $s4
/* 002C80 80027880 02A0282D */  move  $a1, $s5
/* 002C84 80027884 0260302D */  move  $a2, $s3
/* 002C88 80027888 0200382D */  move  $a3, $s0
...
/* 002C98 80027898 0280202D */  move  $a0, $s4
/* 002C9C 8002789C 02A0282D */  move  $a1, $s5
/* 002CA0 800278A0 0260302D */  move  $a2, $s3
/* 002CA4 800278A4 0240382D */  move  $a3, $s2
...
/* 002CB4 800278B4 0280202D */  move  $a0, $s4
/* 002CB8 800278B8 02A0282D */  move  $a1, $s5
/* 002CBC 800278BC 0260302D */  move  $a2, $s3
/* 002CC0 800278C0 0220382D */  move  $a3, $s1
...
/* 002CD0 800278D0 0280202D */  move  $a0, $s4
/* 002CD4 800278D4 02A0282D */  move  $a1, $s5
/* 002CD8 800278D8 02E0302D */  move  $a2, $s7
/* 002CDC 800278DC 0200382D */  move  $a3, $s0
...
/* 002CEC 800278EC 0280202D */  move  $a0, $s4
/* 002CF0 800278F0 02A0282D */  move  $a1, $s5
/* 002CF4 800278F4 02E0302D */  move  $a2, $s7
/* 002CF8 800278F8 0240382D */  move  $a3, $s2
...
/* 002D08 80027908 0280202D */  move  $a0, $s4
/* 002D0C 8002790C 02A0282D */  move  $a1, $s5
/* 002D10 80027910 02E0302D */  move  $a2, $s7
/* 002D14 80027914 0220382D */  move  $a3, $s1
...
/* 002DBC 800279BC 0080A82D */  move  $s5, $a0
/* 002DC0 800279C0 AFB60058 */  sw    $s6, 0x58($sp)
/* 002DC4 800279C4 00A0B02D */  move  $s6, $a1
...
/* 002E30 80027A30 02A0202D */   move  $a0, $s5
/* 002E34 80027A34 02C0282D */  move  $a1, $s6
/* 002E38 80027A38 03C0302D */  move  $a2, $fp
/* 002E3C 80027A3C 2650FFFF */  addiu $s0, $s2, -1
/* 002E40 80027A40 8FA80038 */  lw    $t0, 0x38($sp)
/* 002E44 80027A44 0200382D */  move  $a3, $s0
/* 002E48 80027A48 0C009C7F */  jal   func_800271FC
/* 002E4C 80027A4C AFA80010 */   sw    $t0, 0x10($sp)
/* 002E50 80027A50 02A0202D */  move  $a0, $s5
/* 002E54 80027A54 02C0282D */  move  $a1, $s6
/* 002E58 80027A58 03C0302D */  move  $a2, $fp
/* 002E5C 80027A5C 26510001 */  addiu $s1, $s2, 1
/* 002E60 80027A60 0220382D */  move  $a3, $s1
...
/* 002E70 80027A70 02A0202D */  move  $a0, $s5
/* 002E74 80027A74 02C0282D */  move  $a1, $s6
/* 002E78 80027A78 0260302D */  move  $a2, $s3
...
/* 002E8C 80027A8C 02A0202D */  move  $a0, $s5
/* 002E90 80027A90 02C0282D */  move  $a1, $s6
/* 002E94 80027A94 0260302D */  move  $a2, $s3
...
/* 002EA8 80027AA8 02A0202D */  move  $a0, $s5
/* 002EAC 80027AAC 02C0282D */  move  $a1, $s6
/* 002EB0 80027AB0 02E0302D */  move  $a2, $s7
/* 002EB4 80027AB4 0200382D */  move  $a3, $s0
...
/* 002EC4 80027AC4 02A0202D */  move  $a0, $s5
/* 002EC8 80027AC8 02C0282D */  move  $a1, $s6
/* 002ECC 80027ACC 02E0302D */  move  $a2, $s7
/* 002ED0 80027AD0 0220382D */  move  $a3, $s1
...
/* 002EE0 80027AE0 02A0202D */  move  $a0, $s5
/* 002EE4 80027AE4 02C0282D */  move  $a1, $s6
/* 002EE8 80027AE8 0260302D */  move  $a2, $s3
/* 002EEC 80027AEC 0240382D */  move  $a3, $s2
...
/* 003054 80027C54 0320C02D */  move  $t8, $t9
/* 003058 80027C58 240F0014 */  addiu $t7, $zero, 0x14
/* 00305C 80027C5C 0080702D */  move  $t6, $a0
/* 003060 80027C60 8DA20000 */  lw    $v0, ($t5)
/* 003064 80027C64 0220182D */  move  $v1, $s1
/* 003068 80027C68 0040202D */  move  $a0, $v0
...
/* 003118 80027D18 0040182D */  move  $v1, $v0
...
/* 00325C 80027E5C 0160182D */  move  $v1, $t3
...
/* 0034EC 800280EC 0320C02D */  move  $t8, $t9
/* 0034F0 800280F0 24140018 */  addiu $s4, $zero, 0x18
/* 0034F4 800280F4 0320982D */  move  $s3, $t9
/* 0034F8 800280F8 AFAE0014 */  sw    $t6, 0x14($sp)
/* 0034FC 800280FC 8E420000 */  lw    $v0, ($s2)
/* 003500 80028100 02E0182D */  move  $v1, $s7
/* 003504 80028104 0040202D */  move  $a0, $v0
...
/* 003634 80028234 0060202D */  move  $a0, $v1
...
/* 003758 80028358 0040802D */  move  $s0, $v0
/* 00375C 8002835C 24420008 */  addiu $v0, $v0, 8
/* 003760 80028360 AC620000 */  sw    $v0, ($v1)
/* 003764 80028364 0C0187A4 */  jal   func_80061E90
...
/* 0037B4 800283B4 0200282D */  move  $a1, $s0
...
/* 0038FC 800284FC 0060A02D */   move  $s4, $v1
.L80028500:
...
/* 003910 80028510 0060902D */   move  $s2, $v1
.L80028514:
/* 003914 80028514 06020001 */  bltzl $s0, .L8002851C
/* 003918 80028518 0000802D */   move  $s0, $zero
.L8002851C:
/* 00391C 8002851C 06220001 */  bltzl $s1, .L80028524
/* 003920 80028520 0000882D */   move  $s1, $zero
.L80028524:
...
/* 003988 80028588 0040282D */  move  $a1, $v0
...
/* 003A04 80028604 00E0102D */  move  $v0, $a3
...
/* 003AD0 800286D0 00A0302D */  move  $a2, $a1
...
/* 003B20 80028720 0080282D */  move  $a1, $a0
...
/* 003B64 80028764 0060202D */  move  $a0, $v1
...
/* 003B9C 8002879C 0040202D */  move  $a0, $v0
