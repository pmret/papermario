...
/* 00734C 8002BF4C 0000202D */  move  $a0, $zero
/* 007350 8002BF50 0000282D */  move  $a1, $zero
...
/* 007368 8002BF68 0C0198CC */  jal   func_80066330
/* 00736C 8002BF6C 00000000 */   nop   
.L8002BF70:
/* 007370 8002BF70 0C0198A8 */  jal   func_800662A0
/* 007374 8002BF74 00000000 */   nop   
/* 007378 8002BF78 0040202D */  move  $a0, $v0
/* 00737C 8002BF7C 0060282D */  move  $a1, $v1
...
/* 0073E0 8002BFE0 0000282D */  move  $a1, $zero
...
/* 007404 8002C004 0000182D */   move  $v1, $zero
.L8002C008:
...
/* 007460 8002C060 0080382D */  move  $a3, $a0
...
/* 0074BC 8002C0BC 0060102D */  move  $v0, $v1
/* 0074C0 8002C0C0 00450018 */  mult  $v0, $a1
/* 0074C4 8002C0C4 0000482D */  move  $t1, $zero
/* 0074C8 8002C0C8 3C0D8000 */  lui   $t5, 0x8000
/* 0074CC 8002C0CC 0080582D */  move  $t3, $a0
...
.L8002C0F8:
/* 0074F8 8002C0F8 00A0382D */  move  $a3, $a1
...
/* 00754C 8002C14C 0000482D */   move  $t1, $zero
...
/* 00757C 8002C17C 0000302D */  move  $a2, $zero
...
/* 0075DC 8002C1DC 0080882D */  move  $s1, $a0
/* 0075E0 8002C1E0 AFB00010 */  sw    $s0, 0x10($sp)
/* 0075E4 8002C1E4 AFBF0018 */  sw    $ra, 0x18($sp)
/* 0075E8 8002C1E8 0C01929D */  jal   func_80064A74
/* 0075EC 8002C1EC 00C0802D */   move  $s0, $a2
...
/* 007618 8002C218 0080902D */  move  $s2, $a0
/* 00761C 8002C21C AFB50124 */  sw    $s5, 0x124($sp)
/* 007620 8002C220 00A0A82D */  move  $s5, $a1
...
/* 007644 8002C244 0C0192A8 */  jal   func_80064AA0
/* 007648 8002C248 AFB00110 */   sw    $s0, 0x110($sp)
/* 00764C 8002C24C 0040802D */  move  $s0, $v0
...
/* 007678 8002C278 0240202D */   move  $a0, $s2
/* 00767C 8002C27C 0C00B015 */  jal   func_8002C054
/* 007680 8002C280 02A0282D */   move  $a1, $s5
.L8002C284:
...
/* 0076D8 8002C2D8 00C0402D */   move  $t0, $a2
...
/* 0076FC 8002C2FC 0100382D */   move  $a3, $t0
...
/* 007714 8002C314 0100382D */   move  $a3, $t0
func_8002C318:
...
/* 00772C 8002C32C 0080882D */  move  $s1, $a0
...
/* 007750 8002C350 0220382D */   move  $a3, $s1
/* 007754 8002C354 0000182D */  move  $v1, $zero
...
/* 0077B8 8002C3B8 0080882D */  move  $s1, $a0
...
/* 0077E0 8002C3E0 0040802D */   move  $s0, $v0
...
.L8002C3F4:
/* 0077F4 8002C3F4 0C018634 */  jal   func_800618D0
...
/* 00780C 8002C40C 0080382D */   move  $a3, $a0
...
/* 00786C 8002C46C 0C019CE0 */  jal   func_80067380
/* 007870 8002C470 0000202D */   move  $a0, $zero
/* 007874 8002C474 0C019CF8 */  jal   func_800673E0
/* 007878 8002C478 0000202D */   move  $a0, $zero
/* 00787C 8002C47C 3C04800A */  lui   $a0, 0x800a
/* 007880 8002C480 8C84C4FC */  lw    $a0, -0x3b04($a0)
/* 007884 8002C484 0C019C08 */  jal   func_80067020
...
/* 007A3C 8002C63C 0000302D */  move  $a2, $zero
...
/* 007B50 8002C750 0080282D */  move  $a1, $a0
...
/* 007B68 8002C768 0080302D */  move  $a2, $a0
...
/* 007BB8 8002C7B8 0C0198A4 */  jal   func_80066290
/* 007BBC 8002C7BC 00000000 */   nop   
/* 007BC0 8002C7C0 0040202D */  move  $a0, $v0
/* 007BC4 8002C7C4 8C830004 */  lw    $v1, 4($a0)
/* 007BC8 8002C7C8 2402FFFF */  addiu $v0, $zero, -1
/* 007BCC 8002C7CC 50620010 */  beql  $v1, $v0, .L8002C810
/* 007BD0 8002C7D0 0000102D */   move  $v0, $zero
/* 007BD4 8002C7D4 0040182D */  move  $v1, $v0
...
/* 007BF8 8002C7F8 0080102D */   move  $v0, $a0
.L8002C7FC:
...
/* 007C0C 8002C80C 0000102D */  move  $v0, $zero
.L8002C810:
...
/* 007C30 8002C830 0200282D */  move  $a1, $s0
/* 007C34 8002C834 AFBF001C */  sw    $ra, 0x1c($sp)
/* 007C38 8002C838 0C019654 */  jal   func_80065950
/* 007C3C 8002C83C 24060001 */   addiu $a2, $zero, 1
/* 007C40 8002C840 2404000C */  addiu $a0, $zero, 0xc
/* 007C44 8002C844 0200282D */  move  $a1, $s0
/* 007C48 8002C848 0C019654 */  jal   func_80065950
...
/* 007CD0 8002C8D0 0220202D */  move  $a0, $s1
...
/* 007D04 8002C904 0C019560 */  jal   func_80065580
/* 007D08 8002C908 AE0209CC */   sw    $v0, 0x9cc($s0)
/* 007D0C 8002C90C 0200202D */  move  $a0, $s0
...
/* 007D20 8002C920 0000382D */  move  $a3, $zero
/* 007D24 8002C924 AFB10010 */  sw    $s1, 0x10($sp)
/* 007D28 8002C928 0C019798 */  jal   func_80065E60
/* 007D2C 8002C92C AFA20014 */   sw    $v0, 0x14($sp)
/* 007D30 8002C930 0C019808 */  jal   func_80066020
/* 007D34 8002C934 0200202D */   move  $a0, $s0
...
/* 007D5C 8002C95C 0080902D */  move  $s2, $a0
/* 007D60 8002C960 AFB00110 */  sw    $s0, 0x110($sp)
/* 007D64 8002C964 00A0802D */  move  $s0, $a1
/* 007D68 8002C968 AFB3011C */  sw    $s3, 0x11c($sp)
/* 007D6C 8002C96C 0240982D */  move  $s3, $s2
...
/* 007D8C 8002C98C 0C0192A8 */  jal   func_80064AA0
/* 007D90 8002C990 AFB10114 */   sw    $s1, 0x114($sp)
/* 007D94 8002C994 0040882D */  move  $s1, $v0
