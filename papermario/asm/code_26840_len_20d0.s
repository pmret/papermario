...
/* 026848 8004B448 0080802D */  move  $s0, $a0
...
func_8004B498:
/* 026898 8004B498 0000202D */  move  $a0, $zero
...
/* 026920 8004B520 0000202D */  move  $a0, $zero
/* 026924 8004B524 0200182D */  move  $v1, $s0
.L8004B528:
...
/* 02693C 8004B53C 0000202D */  move  $a0, $zero
/* 026940 8004B540 0200182D */  move  $v1, $s0
.L8004B544:
...
/* 026958 8004B558 0200202D */  move  $a0, $s0
/* 02695C 8004B55C 0000282D */  move  $a1, $zero
...
/* 026994 8004B594 0200202D */  move  $a0, $s0
/* 026998 8004B598 0000282D */  move  $a1, $zero
...
/* 026A34 8004B634 0000382D */  move  $a3, $zero
/* 026A38 8004B638 8C4500A0 */  lw    $a1, 0xa0($v0)
/* 026A3C 8004B63C 0080302D */  move  $a2, $a0
/* 026A40 8004B640 00A0182D */  move  $v1, $a1
...
func_8004B698:
/* 026A98 8004B698 0000282D */  move  $a1, $zero
/* 026A9C 8004B69C 0080182D */  move  $v1, $a0
.L8004B6A0:
...
/* 026AF8 8004B6F8 0060402D */   move  $t0, $v1
...
/* 026B38 8004B738 0000402D */  move  $t0, $zero
.L8004B73C:
...
/* 026B50 8004B750 0080A02D */  move  $s4, $a0
...
.L8004B78C:
/* 026B8C 8004B78C 0280802D */  move  $s0, $s4
.L8004B790:
...
/* 026BC0 8004B7C0 0000882D */   move  $s1, $zero
/* 026BC4 8004B7C4 0040282D */  move  $a1, $v0
/* 026BC8 8004B7C8 0200202D */  move  $a0, $s0
/* 026BCC 8004B7CC 0280182D */  move  $v1, $s4
.L8004B7D0:
...
/* 026CF4 8004B8F4 0060882D */   move  $s1, $v1
/* 026CF8 8004B8F8 12A0002F */  beqz  $s5, .L8004B9B8
/* 026CFC 8004B8FC 0000902D */   move  $s2, $zero
...
/* 026D30 8004B930 0280202D */   move  $a0, $s4
...
/* 026D48 8004B948 0280202D */  move  $a0, $s4
/* 026D4C 8004B94C 0200282D */  move  $a1, $s0
/* 026D50 8004B950 0C012E9D */  jal   func_8004BA74
/* 026D54 8004B954 0000302D */   move  $a2, $zero
...
/* 026DA4 8004B9A4 0000882D */  move  $s1, $zero
.L8004B9A8:
...
/* 026E7C 8004BA7C 0080A02D */  move  $s4, $a0
/* 026E80 8004BA80 AFB70034 */  sw    $s7, 0x34($sp)
/* 026E84 8004BA84 00A0B82D */  move  $s7, $a1
...
/* 026F10 8004BB10 0280202D */   move  $a0, $s4
...
/* 026F54 8004BB54 00C0902D */   move  $s2, $a2
...
/* 026FC4 8004BBC4 0280202D */   move  $a0, $s4
...
/* 026FEC 8004BBEC 0280202D */   move  $a0, $s4
.L8004BBF0:
/* 026FF0 8004BBF0 00E0282D */  move  $a1, $a3
/* 026FF4 8004BBF4 0240302D */  move  $a2, $s2
/* 026FF8 8004BBF8 02E0382D */  move  $a3, $s7
...
/* 027014 8004BC14 00C0902D */   move  $s2, $a2
...
/* 027078 8004BC78 0000802D */  move  $s0, $zero
/* 02707C 8004BC7C 0040282D */  move  $a1, $v0
...
/* 0270AC 8004BCAC 0280202D */   move  $a0, $s4
...
/* 027118 8004BD18 0280202D */   move  $a0, $s4
...
/* 027164 8004BD64 0280202D */   move  $a0, $s4
...
/* 0271AC 8004BDAC 0280202D */   move  $a0, $s4
...
/* 0271F8 8004BDF8 0280202D */   move  $a0, $s4
...
/* 027238 8004BE38 0280202D */   move  $a0, $s4
.L8004BE3C:
/* 02723C 8004BE3C 00E0282D */  move  $a1, $a3
.L8004BE40:
/* 027240 8004BE40 96420000 */  lhu   $v0, ($s2)
/* 027244 8004BE44 8C860008 */  lw    $a2, 8($a0)
/* 027248 8004BE48 02E0382D */  move  $a3, $s7
...
/* 02727C 8004BE7C 0280202D */   move  $a0, $s4
/* 027280 8004BE80 0C0130C0 */  jal   func_8004C300
/* 027284 8004BE84 02C0282D */   move  $a1, $s6
...
/* 027298 8004BE98 0280202D */   move  $a0, $s4
...
/* 0272D4 8004BED4 0280202D */  move  $a0, $s4
/* 0272D8 8004BED8 00E0282D */  move  $a1, $a3
/* 0272DC 8004BEDC 02E0382D */  move  $a3, $s7
...
/* 027340 8004BF40 0280202D */  move  $a0, $s4
/* 027344 8004BF44 00E0282D */  move  $a1, $a3
/* 027348 8004BF48 02E0382D */  move  $a3, $s7
...
/* 0273CC 8004BFCC 0280202D */  move  $a0, $s4
/* 0273D0 8004BFD0 00E0282D */  move  $a1, $a3
/* 0273D4 8004BFD4 02E0382D */  move  $a3, $s7
...
/* 027420 8004C020 0000982D */   move  $s3, $zero
.L8004C024:
...
.L8004C07C:
/* 02747C 8004C07C 0280202D */  move  $a0, $s4
/* 027480 8004C080 00E0282D */  move  $a1, $a3
/* 027484 8004C084 96420000 */  lhu   $v0, ($s2)
/* 027488 8004C088 8E860008 */  lw    $a2, 8($s4)
/* 02748C 8004C08C 02E0382D */  move  $a3, $s7
...
/* 0275CC 8004C1CC 0040202D */  move  $a0, $v0
...
/* 0275EC 8004C1EC 00A0202D */   move  $a0, $a1
...
/* 027604 8004C204 00A0202D */   move  $a0, $a1
...
func_8004C250:
/* 027650 8004C250 00A0202D */  move  $a0, $a1
func_8004C254:
/* 027654 8004C254 0C0130F5 */  jal   func_8004C3D4
/* 027658 8004C258 00E0282D */   move  $a1, $a3
.L8004C25C:
...
/* 027670 8004C270 0000382D */  move  $a3, $zero
...
func_8004C2A4:
/* 0276A4 8004C2A4 0000382D */  move  $a3, $zero
...
func_8004C300:
/* 027700 8004C300 0000382D */  move  $a3, $zero
...
/* 027760 8004C360 0080A02D */  move  $s4, $a0
/* 027764 8004C364 AFB20018 */  sw    $s2, 0x18($sp)
/* 027768 8004C368 00A0902D */  move  $s2, $a1
/* 02776C 8004C36C AFB10014 */  sw    $s1, 0x14($sp)
/* 027770 8004C370 0000882D */  move  $s1, $zero
...
/* 0277A0 8004C3A0 0240282D */   move  $a1, $s2
...
/* 02784C 8004C44C 0080802D */  move  $s0, $a0
...
/* 02786C 8004C46C 0060882D */  move  $s1, $v1
...
/* 027890 8004C490 0060902D */  move  $s2, $v1
.L8004C494:
...
/* 02796C 8004C56C 0000102D */  move  $v0, $zero
...
/* 027980 8004C580 0080902D */  move  $s2, $a0
/* 027984 8004C584 AFB00010 */  sw    $s0, 0x10($sp)
/* 027988 8004C588 00A0802D */  move  $s0, $a1
/* 02798C 8004C58C AFB10014 */  sw    $s1, 0x14($sp)
/* 027990 8004C590 00C0882D */  move  $s1, $a2
...
/* 027A4C 8004C64C 0040182D */   move  $v1, $v0
.L8004C650:
...
/* 027A5C 8004C65C 0240202D */   move  $a0, $s2
...
/* 027A74 8004C674 0200282D */   move  $a1, $s0
/* 027A78 8004C678 0040202D */  move  $a0, $v0
...
/* 027AA8 8004C6A8 0200282D */   move  $a1, $s0
/* 027AAC 8004C6AC 0240202D */  move  $a0, $s2
/* 027AB0 8004C6B0 0C01339C */  jal   func_8004CE70
/* 027AB4 8004C6B4 0200282D */   move  $a1, $s0
/* 027AB8 8004C6B8 0240202D */  move  $a0, $s2
/* 027ABC 8004C6BC 0C0133A9 */  jal   func_8004CEA4
/* 027AC0 8004C6C0 0200282D */   move  $a1, $s0
/* 027AC4 8004C6C4 0240202D */  move  $a0, $s2
/* 027AC8 8004C6C8 0C0133C3 */  jal   func_8004CF0C
/* 027ACC 8004C6CC 0200282D */   move  $a1, $s0
...
/* 027B68 8004C768 00C0202D */   move  $a0, $a2
...
/* 027B94 8004C794 0220202D */  move  $a0, $s1
...
.L8004C7C4:
/* 027BC4 8004C7C4 0240202D */  move  $a0, $s2
/* 027BC8 8004C7C8 9202009C */  lbu   $v0, 0x9c($s0)
/* 027BCC 8004C7CC 0200282D */  move  $a1, $s0
...
/* 027C8C 8004C88C 0080902D */  move  $s2, $a0
/* 027C90 8004C890 AFB00010 */  sw    $s0, 0x10($sp)
/* 027C94 8004C894 00A0802D */  move  $s0, $a1
/* 027C98 8004C898 AFB10014 */  sw    $s1, 0x14($sp)
/* 027C9C 8004C89C 00C0882D */  move  $s1, $a2
/* 027CA0 8004C8A0 AFB3001C */  sw    $s3, 0x1c($sp)
/* 027CA4 8004C8A4 0000982D */  move  $s3, $zero
...
/* 027CC0 8004C8C0 00E0A02D */   move  $s4, $a3
...
/* 027CD4 8004C8D4 0220202D */   move  $a0, $s1
...
/* 027D78 8004C978 0220202D */  move  $a0, $s1
...
/* 027EB4 8004CAB4 0220202D */   move  $a0, $s1
...
.L8004CAE4:
/* 027EE4 8004CAE4 0220202D */  move  $a0, $s1
/* 027EE8 8004CAE8 0240282D */  move  $a1, $s2
/* 027EEC 8004CAEC 9202009C */  lbu   $v0, 0x9c($s0)
/* 027EF0 8004CAF0 0200302D */  move  $a2, $s0
...
/* 027F68 8004CB68 0200282D */  move  $a1, $s0
func_8004CB6C:
.L8004CB6C:
...
/* 02809C 8004CC9C 0220202D */   move  $a0, $s1
/* 0280A0 8004CCA0 0240282D */  move  $a1, $s2
/* 0280A4 8004CCA4 0C013365 */  jal   func_8004CD94
/* 0280A8 8004CCA8 0200302D */   move  $a2, $s0
...
/* 02825C 8004CE5C 0000282D */   move  $a1, $zero
...
/* 0282CC 8004CECC 00A0802D */  move  $s0, $a1
...
/* 0283D0 8004CFD0 0040182D */  move  $v1, $v0
...
/* 02847C 8004D07C 00A0382D */  move  $a3, $a1
...
/* 0284A0 8004D0A0 00A0302D */  move  $a2, $a1
...
/* 0285D8 8004D1D8 0080302D */   move  $a2, $a0
...
/* 02863C 8004D23C 00A0382D */  move  $a3, $a1
...
/* 0286D4 8004D2D4 00C0202D */   move  $a0, $a2
.L8004D2D8:
...
/* 0287A4 8004D3A4 0000182D */  move  $v1, $zero
.L8004D3A8:
...
func_8004D4BC:
/* 0288BC 8004D4BC 0000282D */  move  $a1, $zero
