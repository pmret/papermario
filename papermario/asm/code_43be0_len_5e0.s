...
/* 043BF0 800687F0 00808021 */  move  $s0, $a0
/* 043BF4 800687F4 AFB50154 */  sw    $s5, 0x154($sp)
/* 043BF8 800687F8 00A0A821 */  move  $s5, $a1
/* 043BFC 800687FC AFB10144 */  sw    $s1, 0x144($sp)
/* 043C00 80068800 00E08821 */  move  $s1, $a3
...
/* 043C2C 8006882C 00C0A021 */   move  $s4, $a2
...
/* 043C60 80068860 0C01A775 */  jal   func_80069DD4
/* 043C64 80068864 02002021 */   move  $a0, $s0
...
/* 043C7C 8006887C 02002021 */   move  $a0, $s0
/* 043C80 80068880 0C01A5B4 */  jal   func_800696D0
/* 043C84 80068884 00002821 */   move  $a1, $zero
/* 043C88 80068888 00401821 */  move  $v1, $v0
...
/* 043CA8 800688A8 0C01A874 */  jal   func_8006A1D0
/* 043CAC 800688AC 30C6FFFF */   andi  $a2, $a2, 0xffff
/* 043CB0 800688B0 00401821 */  move  $v1, $v0
...
.L80068950:
/* 043D50 80068950 02203821 */  move  $a3, $s1
...
/* 043D74 80068974 02C01021 */   move  $v0, $s6
...
/* 043D90 80068990 02002021 */   move  $a0, $s0
/* 043D94 80068994 A3A30138 */  sb    $v1, 0x138($sp)
/* 043D98 80068998 02402821 */  move  $a1, $s2
/* 043D9C 8006899C 0C01A7A3 */  jal   func_80069E8C
/* 043DA0 800689A0 00003021 */   move  $a2, $zero
/* 043DA4 800689A4 1440001A */  bnez  $v0, .L80068A10
/* 043DA8 800689A8 00401821 */   move  $v1, $v0
.L800689AC:
...
/* 043DFC 800689FC 00001821 */   move  $v1, $zero
.L80068A00:
...
/* 043E20 80068A20 02C01021 */   move  $v0, $s6
.L80068A24:
...
/* 043E64 80068A64 02002021 */  move  $a0, $s0
/* 043E68 80068A68 02202821 */  move  $a1, $s1
/* 043E6C 80068A6C 0C01A7A3 */  jal   func_80069E8C
/* 043E70 80068A70 00003021 */   move  $a2, $zero
/* 043E74 80068A74 1440001A */  bnez  $v0, .L80068AE0
/* 043E78 80068A78 00401821 */   move  $v1, $v0
.L80068A7C:
...
/* 043ECC 80068ACC 00001821 */   move  $v1, $zero
.L80068AD0:
...
/* 043EE4 80068AE4 00008821 */   move  $s1, $zero
.L80068AE8:
...
/* 043EF8 80068AF8 0C01A5B4 */  jal   func_800696D0
/* 043EFC 80068AFC 02002021 */   move  $a0, $s0
/* 043F00 80068B00 00401821 */  move  $v1, $v0
/* 043F04 80068B04 1460003C */  bnez  $v1, .L80068BF8
/* 043F08 80068B08 00601021 */   move  $v0, $v1
.L80068B0C:
...
/* 043F30 80068B30 0C01A874 */  jal   func_8006A1D0
/* 043F34 80068B34 02403821 */   move  $a3, $s2
/* 043F38 80068B38 0801A2D6 */  j     func_80068B58
/* 043F3C 80068B3C 00401821 */   move  $v1, $v0

.L80068B40:
/* 043F40 80068B40 8E040004 */  lw    $a0, 4($s0)
/* 043F44 80068B44 8E050008 */  lw    $a1, 8($s0)
/* 043F48 80068B48 30C6FFFF */  andi  $a2, $a2, 0xffff
/* 043F4C 80068B4C 0C01A8F0 */  jal   func_8006A3C0
/* 043F50 80068B50 02403821 */   move  $a3, $s2
/* 043F54 80068B54 00401821 */  move  $v1, $v0
func_80068B58:
...
/* 043F98 80068B98 02002021 */   move  $a0, $s0
/* 043F9C 80068B9C 0C01A5B4 */  jal   func_800696D0
/* 043FA0 80068BA0 00002821 */   move  $a1, $zero
/* 043FA4 80068BA4 00401821 */  move  $v1, $v0
...
/* 043FC8 80068BC8 0C01A8F0 */  jal   func_8006A3C0
/* 043FCC 80068BCC 30C6FFFF */   andi  $a2, $a2, 0xffff
/* 043FD0 80068BD0 00401821 */  move  $v1, $v0
...
/* 043FE8 80068BE8 00601021 */   move  $v0, $v1

.L80068BEC:
/* 043FEC 80068BEC 8E040004 */  lw    $a0, 4($s0)
/* 043FF0 80068BF0 0C01A530 */  jal   func_800694C0
...
/* 044028 80068C28 00808821 */  move  $s1, $a0
/* 04402C 80068C2C AFB00130 */  sw    $s0, 0x130($sp)
/* 044030 80068C30 00A08021 */  move  $s0, $a1
...
/* 044060 80068C60 00C0A021 */   move  $s4, $a2
...
/* 044074 80068C74 0C01A775 */  jal   func_80069DD4
/* 044078 80068C78 02202021 */   move  $a0, $s1
...
/* 04408C 80068C8C 02202021 */   move  $a0, $s1
/* 044090 80068C90 0C01A5B4 */  jal   func_800696D0
/* 044094 80068C94 00002821 */   move  $a1, $zero
...
/* 0440B4 80068CB4 0C01A874 */  jal   func_8006A1D0
...
/* 0440D8 80068CD8 00009821 */   move  $s3, $zero
.L80068CDC:
...
/* 04410C 80068D0C 02202021 */   move  $a0, $s1
/* 044110 80068D10 00409021 */  move  $s2, $v0
/* 044114 80068D14 27A50010 */  addiu $a1, $sp, 0x10
/* 044118 80068D18 0C01A7A3 */  jal   func_80069E8C
/* 04411C 80068D1C 00003021 */   move  $a2, $zero
