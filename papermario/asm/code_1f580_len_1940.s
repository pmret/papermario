...
/* 01F5AC 800441AC 0220902D */   move  $s2, $s1
...
/* 01F5F8 800441F8 0080802D */  move  $s0, $a0
...
/* 01F610 80044210 0200202D */  move  $a0, $s0
/* 01F614 80044214 0040302D */  move  $a2, $v0
/* 01F618 80044218 0C0B2026 */  jal   func_802C8098
/* 01F61C 8004421C 0220282D */   move  $a1, $s1
...
/* 01F650 80044250 0040202D */   move  $a0, $v0
...
/* 01F67C 8004427C 0040202D */   move  $a0, $v0
...
/* 01F6A0 800442A0 0080882D */  move  $s1, $a0
...
/* 01F6C8 800442C8 0000102D */   move  $v0, $zero
...
func_80044328:
/* 01F728 80044328 0000102D */  move  $v0, $zero
func_8004432C:
.L8004432C:
...
/* 01F748 80044348 0080902D */  move  $s2, $a0
...
/* 01F774 80044374 0040882D */  move  $s1, $v0
...
/* 01F7A8 800443A8 0240202D */   move  $a0, $s2
func_800443AC:
...
/* 01F7BC 800443BC 0040202D */   move  $a0, $v0
...
/* 01F7D8 800443D8 0200202D */   move  $a0, $s0
/* 01F7DC 800443DC 08011116 */  j     func_80044458
/* 01F7E0 800443E0 0260102D */   move  $v0, $s3

.L800443E4:
/* 01F7E4 800443E4 0C00FB3A */  jal   func_8003ECE8
/* 01F7E8 800443E8 0220202D */   move  $a0, $s1
func_800443EC:
.L800443EC:
/* 01F7EC 800443EC 8282001C */  lb    $v0, 0x1c($s4)
/* 01F7F0 800443F0 18400018 */  blez  $v0, .L80044454
/* 01F7F4 800443F4 0000282D */   move  $a1, $zero
/* 01F7F8 800443F8 0040402D */  move  $t0, $v0
/* 01F7FC 800443FC 0280382D */  move  $a3, $s4
.L80044400:
...
/* 01F814 80044414 0000202D */   move  $a0, $zero
/* 01F818 80044418 0060302D */  move  $a2, $v1
/* 01F81C 8004441C 0040182D */  move  $v1, $v0
.L80044420:
...
.L80044454:
/* 01F854 80044454 0260102D */  move  $v0, $s3
func_80044458:
...
/* 01F8A4 800444A4 0040882D */  move  $s1, $v0
...
/* 01F8E0 800444E0 0200202D */   move  $a0, $s0
/* 01F8E4 800444E4 08011158 */  j     func_80044560
/* 01F8E8 800444E8 0240102D */   move  $v0, $s2

.L800444EC:
/* 01F8EC 800444EC 0C00FB3A */  jal   func_8003ECE8
/* 01F8F0 800444F0 0220202D */   move  $a0, $s1
func_800444F4:
/* 01F8F4 800444F4 8262001C */  lb    $v0, 0x1c($s3)
/* 01F8F8 800444F8 18400018 */  blez  $v0, .L8004455C
/* 01F8FC 800444FC 0000282D */   move  $a1, $zero
/* 01F900 80044500 0040402D */  move  $t0, $v0
/* 01F904 80044504 0260382D */  move  $a3, $s3
.L80044508:
...
/* 01F91C 8004451C 0000202D */   move  $a0, $zero
/* 01F920 80044520 0060302D */  move  $a2, $v1
/* 01F924 80044524 0040182D */  move  $v1, $v0
.L80044528:
...
.L8004455C:
/* 01F95C 8004455C 0240102D */  move  $v0, $s2
func_80044560:
...
/* 01FA34 80044634 0080882D */  move  $s1, $a0
...
/* 01FA4C 8004464C 0220202D */  move  $a0, $s1
/* 01FA50 80044650 0C0B0FCF */  jal   func_802C3F3C
/* 01FA54 80044654 0040882D */   move  $s1, $v0
...
/* 01FABC 800446BC 00A0802D */  move  $s0, $a1
...
/* 01FB50 80044750 0000802D */   move  $s0, $zero
...
/* 01FB6C 8004476C 0280902D */  move  $s2, $s4
.L80044770:
...
/* 01FC68 80044868 0080802D */  move  $s0, $a0
...
/* 01FC7C 8004487C 0200202D */  move  $a0, $s0
/* 01FC80 80044880 0C0111AD */  jal   func_800446B4
/* 01FC84 80044884 0040282D */   move  $a1, $v0
...
/* 01FCD4 800448D4 0040802D */   move  $s0, $v0
...
/* 01FD44 80044944 0000802D */   move  $s0, $zero
...
/* 01FD60 80044960 0280902D */  move  $s2, $s4
.L80044964:
...
/* 01FDE4 800449E4 0040182D */  move  $v1, $v0
...
/* 01FE1C 80044A1C 0040182D */  move  $v1, $v0
...
/* 01FE80 80044A80 0080802D */  move  $s0, $a0
...
/* 01FEB4 80044AB4 0040982D */  move  $s3, $v0
/* 01FEB8 80044AB8 8E250000 */  lw    $a1, ($s1)
/* 01FEBC 80044ABC 0C0B1EAF */  jal   func_802C7ABC
/* 01FEC0 80044AC0 0200202D */   move  $a0, $s0
/* 01FEC4 80044AC4 0040A02D */  move  $s4, $v0
...
/* 01FEFC 80044AFC 0040802D */   move  $s0, $v0
...
/* 01FF18 80044B18 0260202D */   move  $a0, $s3
/* 01FF1C 80044B1C 0040902D */  move  $s2, $v0
func_80044B20:
.L80044B20:
...
/* 01FFB4 80044BB4 0080882D */  move  $s1, $a0
...
/* 01FFDC 80044BDC 0040902D */  move  $s2, $v0
/* 01FFE0 80044BE0 8E050000 */  lw    $a1, ($s0)
/* 01FFE4 80044BE4 0C0B1EAF */  jal   func_802C7ABC
/* 01FFE8 80044BE8 0220202D */   move  $a0, $s1
/* 01FFEC 80044BEC 0040802D */  move  $s0, $v0
...
/* 020004 80044C04 0240202D */   move  $a0, $s2
...
/* 020034 80044C34 0080882D */  move  $s1, $a0
...
/* 020054 80044C54 0040202D */  move  $a0, $v0
...
/* 020070 80044C70 0040802D */  move  $s0, $v0
...
/* 0200F8 80044CF8 0080882D */  move  $s1, $a0
...
/* 020120 80044D20 0040902D */  move  $s2, $v0
/* 020124 80044D24 8E050000 */  lw    $a1, ($s0)
/* 020128 80044D28 0C0B1EAF */  jal   func_802C7ABC
/* 02012C 80044D2C 0220202D */   move  $a0, $s1
/* 020130 80044D30 0040802D */  move  $s0, $v0
...
/* 020148 80044D48 0240202D */   move  $a0, $s2
/* 02014C 80044D4C 12000008 */  beqz  $s0, .L80044D70
/* 020150 80044D50 0040982D */   move  $s3, $v0
...
/* 0201AC 80044DAC 0080982D */  move  $s3, $a0
...
/* 020224 80044E24 0040182D */   move  $v1, $v0
...
/* 020240 80044E40 0240202D */   move  $a0, $s2
/* 020244 80044E44 0040882D */  move  $s1, $v0
...
.L80044E94:
/* 020294 80044E94 0280102D */  move  $v0, $s4
...
/* 0202C0 80044EC0 0080882D */  move  $s1, $a0
...
/* 0202E8 80044EE8 0040902D */  move  $s2, $v0
/* 0202EC 80044EEC 8E050000 */  lw    $a1, ($s0)
/* 0202F0 80044EF0 0C0B1EAF */  jal   func_802C7ABC
/* 0202F4 80044EF4 0220202D */   move  $a0, $s1
/* 0202F8 80044EF8 0040802D */  move  $s0, $v0
...
/* 020310 80044F10 0240202D */   move  $a0, $s2
...
/* 02035C 80044F5C 0040882D */  move  $s1, $v0
...
/* 020374 80044F74 0220202D */   move  $a0, $s1
/* 020378 80044F78 0040802D */  move  $s0, $v0
...
/* 0203B4 80044FB4 0000302D */   move  $a2, $zero
/* 0203B8 80044FB8 0040182D */  move  $v1, $v0
...
/* 0203F8 80044FF8 0080882D */  move  $s1, $a0
...
/* 020420 80045020 0040902D */  move  $s2, $v0
/* 020424 80045024 8E050000 */  lw    $a1, ($s0)
/* 020428 80045028 0C0B1EAF */  jal   func_802C7ABC
/* 02042C 8004502C 0220202D */   move  $a0, $s1
/* 020430 80045030 0040802D */  move  $s0, $v0
...
/* 020448 80045048 0240202D */   move  $a0, $s2
/* 02044C 8004504C 12000008 */  beqz  $s0, .L80045070
/* 020450 80045050 0040982D */   move  $s3, $v0
...
/* 0204AC 800450AC 0080882D */  move  $s1, $a0
...
/* 0204D4 800450D4 0040902D */  move  $s2, $v0
/* 0204D8 800450D8 8E050000 */  lw    $a1, ($s0)
/* 0204DC 800450DC 0C0B1EAF */  jal   func_802C7ABC
/* 0204E0 800450E0 0220202D */   move  $a0, $s1
/* 0204E4 800450E4 0040802D */  move  $s0, $v0
...
/* 0204FC 800450FC 0240202D */   move  $a0, $s2
/* 020500 80045100 0040982D */  move  $s3, $v0
...
/* 020548 80045148 0080882D */  move  $s1, $a0
...
/* 020570 80045170 0040902D */  move  $s2, $v0
/* 020574 80045174 8E050000 */  lw    $a1, ($s0)
/* 020578 80045178 0C0B1EAF */  jal   func_802C7ABC
/* 02057C 8004517C 0220202D */   move  $a0, $s1
/* 020580 80045180 0040802D */  move  $s0, $v0
...
/* 020598 80045198 0240202D */   move  $a0, $s2
/* 02059C 8004519C 0040982D */  move  $s3, $v0
...
/* 0205E4 800451E4 0080882D */  move  $s1, $a0
...
/* 02060C 8004520C 0040902D */  move  $s2, $v0
/* 020610 80045210 8E050000 */  lw    $a1, ($s0)
/* 020614 80045214 0C0B1EAF */  jal   func_802C7ABC
/* 020618 80045218 0220202D */   move  $a0, $s1
/* 02061C 8004521C 0040802D */  move  $s0, $v0
...
/* 020634 80045234 0240202D */   move  $a0, $s2
...
/* 020664 80045264 0080802D */  move  $s0, $a0
...
/* 0206C8 800452C8 0080902D */  move  $s2, $a0
...
/* 020700 80045300 0240202D */   move  $a0, $s2
...
/* 020728 80045328 0080882D */  move  $s1, $a0
...
/* 02078C 8004538C 0240202D */   move  $a0, $s2
...
/* 0207C4 800453C4 0080982D */  move  $s3, $a0
...
/* 02081C 8004541C 0220202D */   move  $a0, $s1
/* 020820 80045420 0260202D */  move  $a0, $s3
...
/* 020834 80045434 0200282D */   move  $a1, $s0
...
/* 020864 80045464 0080882D */  move  $s1, $a0
...
/* 020988 80045588 0080802D */  move  $s0, $a0
...
/* 020A48 80045648 0000302D */  move  $a2, $zero
/* 020A4C 8004564C 00C0282D */  move  $a1, $a2
.L80045650:
/* 020A50 80045650 0000202D */  move  $a0, $zero
/* 020A54 80045654 00A0182D */  move  $v1, $a1
.L80045658:
...
/* 020A90 80045690 0080882D */  move  $s1, $a0
...
/* 020AE4 800456E4 0240202D */   move  $a0, $s2
/* 020AE8 800456E8 12200004 */  beqz  $s1, .L800456FC
/* 020AEC 800456EC 0040982D */   move  $s3, $v0
...
/* 020B3C 8004573C 0080882D */  move  $s1, $a0
...
/* 020B78 80045778 0220202D */   move  $a0, $s1
...
/* 020C40 80045840 0080882D */  move  $s1, $a0
...
/* 020C6C 8004586C 0220202D */  move  $a0, $s1
/* 020C70 80045870 0C0B1EAF */  jal   func_802C7ABC
/* 020C74 80045874 0040902D */   move  $s2, $v0
/* 020C78 80045878 0220202D */  move  $a0, $s1
/* 020C7C 8004587C 8E050000 */  lw    $a1, ($s0)
/* 020C80 80045880 0C0B1EAF */  jal   func_802C7ABC
/* 020C84 80045884 0040982D */   move  $s3, $v0
/* 020C88 80045888 0220202D */  move  $a0, $s1
/* 020C8C 8004588C 0240282D */  move  $a1, $s2
/* 020C90 80045890 0C0B36B0 */  jal   func_802CDAC0
/* 020C94 80045894 0040802D */   move  $s0, $v0
/* 020C98 80045898 10400004 */  beqz  $v0, .L800458AC
/* 020C9C 8004589C 0040202D */   move  $a0, $v0
/* 020CA0 800458A0 0260282D */  move  $a1, $s3
/* 020CA4 800458A4 0C012530 */  jal   func_800494C0
/* 020CA8 800458A8 0200302D */   move  $a2, $s0
.L800458AC:
...
/* 020D08 80045908 0080802D */  move  $s0, $a0
...
/* 020D6C 8004596C 0200282D */  move  $a1, $s0
...
/* 020E60 80045A60 0080882D */  move  $s1, $a0
...
/* 020E7C 80045A7C 0220202D */  move  $a0, $s1
/* 020E80 80045A80 8E050000 */  lw    $a1, ($s0)
/* 020E84 80045A84 0C0B1EAF */  jal   func_802C7ABC
/* 020E88 80045A88 0040802D */   move  $s0, $v0
/* 020E8C 80045A8C 0200202D */  move  $a0, $s0
/* 020E90 80045A90 0C00FB3A */  jal   func_8003ECE8
/* 020E94 80045A94 0040802D */   move  $s0, $v0
