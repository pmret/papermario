...
s32 INCLUDE_ASM(os/code_3cd00_len_5f0, osContStartQuery, OSMesgQueue *queue);

void INCLUDE_ASM(os/code_3cd00_len_5f0, osContGetQuery, OSContStatus *status);

s32 INCLUDE_ASM(os/code_3cd00_len_5f0, osContStartReadData, OSMesgQueue *queue);
